:PROPERTIES:
:ID: FC3A5F66-708A-4387-A3A6-85EC43C9B3B3
:END:
#+title: Task: Format pass: qt
#+description: Apply clang-format to ores.qt (1014 files).
#+type: task
#+level: s1
#+filetags: :clang_format_setup:sprint_19:v0:
#+owner: marco
#+branch: feature/format-pass-group-13-qt
#+pr:
#+blocked_on:
#+blocked_since:
#+created: 2026-06-04
