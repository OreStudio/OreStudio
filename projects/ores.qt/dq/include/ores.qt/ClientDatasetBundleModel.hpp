 ...
 *
 * This model extends AbstractClientModel and fetches dataset bundle
...
public:
    ...
    /**
     * @brief Get dataset bundle at the specified row.
     *
     * @param row The row index.
     * @return The dataset bundle, or nullptr if row is invalid.
     */
...
private:
    ...
    struct FetchResult {
        bool success;
        std::vector<dq::domain::dataset_bundle>;
    ...
    std::vector<dq::domain::dataset_bundle> _;
