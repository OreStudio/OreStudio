...
payment_frequency_type_mapper::map(const payment_frequency_type_entity& v) {
...
payment_frequency_type_entity
payment_frequency_type_mapper::map(const domain::payment_frequency_type& v) {
    BOOST_LOG_SEV(lg(), trace) << "Mapping domain entity: " << v;

    payment_frequency_type_entity r;
    r.code = v.code;
