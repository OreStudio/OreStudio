...
register_calendar_event_mapping(ev::service::postgres_event_source& event_source,
    ...
    event_source.register_entity_event_mapping<refdata::messaging::calendar_event>(
        "ores_refdata_calendars");

    return event_bus.subscribe<refdata::messaging::calendar_event>(
        [&nats](const refdata::messaging::calendar_event& e) {
            ...
            ev::service::publish_entity_event(
                nats, ev::domain::event_subject<refdata::messaging::calendar_event>(e.action), e);
        });
}
