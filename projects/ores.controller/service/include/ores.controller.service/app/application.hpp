 ...
 *
 */
#ifndef ORES_CONTROLLER_SERVICE_APP_APPLICATION_HPP
#define ORES_CONTROLLER_SERVICE_APP_APPLICATION_HPP
...
/**
 * @brief Entry point for the ores.controller.service service.
 */
class application final {
private:
    inline static std::string_view logger_name = "ores.controller.service.app.application";
