...
- A knowledge doc exists at [[proj:doc/knowledge/architecture/badge_system_wiring.org][=doc/knowledge/architecture/badge_system_wiring.org=]]
  covering the three-layer structure (=ores.dq=, =ores.sql=, =ores.qt.api=)
  with =account_type= as the worked example.
- A thin recipe at [[proj:doc/recipes/qt/how_do_i_add_a_badge_in_qt.org][=doc/recipes/qt/how_do_i_add_a_badge_in_qt.org=]]
