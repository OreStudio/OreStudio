 ...
 *
 */
#ifndef ORES_REFDATA_API_DOMAIN_DEPOSIT_CONVENTION_TABLE_IO_HPP
#define ORES_REFDATA_API_DOMAIN_DEPOSIT_CONVENTION_TABLE_IO_HPP
...
ORES_REFDATA_API_EXPORT std::ostream& operator<<(std::ostream& s,
                                                 const std::vector<deposit_convention>& v);
