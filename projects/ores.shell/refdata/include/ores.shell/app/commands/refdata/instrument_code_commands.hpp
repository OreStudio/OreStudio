 ...
 */
#ifndef ORES_SHELL_APP_COMMANDS_INSTRUMENT_CODE_COMMANDS_HPP
#define ORES_SHELL_APP_COMMANDS_INSTRUMENT_CODE_COMMANDS_HPP
...
/**
 * @brief Every verb instrument codes answer, as one command each.
 *
 ...
 */
class instrument_code_commands {
private:
    inline static std::string_view logger_name =
        "ores.shell.app.commands.refdata.instrument_code_commands";
...
public:
    /**
     * @brief Register the instrument codes submenu.
     */
    ...
    /**
     * @brief add <code> <name> <description> <asset_class> <ore_trade_type> <display_order>
    ...
    /**
     * @brief set <code> <name> <description> <asset_class> <ore_trade_type> <display_order>
    ...
    /**
     * @brief put-many --count <n> <code> <name> <description> <asset_class> <ore_trade_type>
