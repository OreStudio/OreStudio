 ...
 *
 */
#ifndef ORES_IAM_EVENTING_CHANGE_REASON_CATEGORY_CHANGED_EVENT_HPP
#define ORES_IAM_EVENTING_CHANGE_REASON_CATEGORY_CHANGED_EVENT_HPP
 ...
 */
template<>
struct event_traits<ores::iam::eventing::change_reason_category_changed_event> {
    static constexpr std::string_view name =
        "ores.iam.change_reason_category_changed";
};
