...
using ores::shell::app::commands::session_samples_operations_commands;
...
TEST_CASE("session_samples_operations_registers_every_declared_command", tags) {
    ...
    BOOST_LOG_SEV(lg, debug) << "Registered  command(s).";
    CHECK(true);
}

TEST_CASE("session_samples_operations_process_get_session_samples_requires_a_session", tags) {
    auto lg(make_logger(test_suite));
...
TEST_CASE("session_samples_operations_process_get_session_samples_reports_the_expected_count",
          tags) {
    auto lg(make_logger(test_suite));
    ...
    command_feedback::reset();
    session_samples_operations_commands::process_get_session_samples(out, session, {});
...
TEST_CASE("session_samples_operations_process_get_session_samples_reaches_the_transport", tags) {
    auto lg(make_logger(test_suite));
