 ...
 *
 */
#ifndef ORES_TRADING_CORE_PRESENTATION_EQUITY_ACCUMULATOR_INSTRUMENT_HISTORY_FIELD_MAPPER_HPP
#define ORES_TRADING_CORE_PRESENTATION_EQUITY_ACCUMULATOR_INSTRUMENT_HISTORY_FIELD_MAPPER_HPP
...
/**
 * @brief Renders a equity_accumulator_instrument to an ordered field list for
