...
| [[id:E5EC80BB-789B-4BD6-B6E5-DC7AA790692A][Synthetic data librarian support: FX foundation]] | BACKLOG | | | Librarian gives each new party a usable synthetic data configuration; FX only for now, but db tables/publishing built generically via codegen for future asset classes. |
