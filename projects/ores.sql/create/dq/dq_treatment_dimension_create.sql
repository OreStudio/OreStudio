...
create unique index if not exists treatment_dimensions_version_uniq_idx
on "ores_dq_treatment_dimensions_tbl" (tenant_id, code, version)
where valid_to = ores_utility_infinity_timestamp_fn();

create unique index if not exists treatment_dimensions_code_uniq_idx
on "ores_dq_treatment_dimensions_tbl" (tenant_id, code)
where valid_to = ores_utility_infinity_timestamp_fn();

create index if not exists treatment_dimensions_tenant_idx
on "ores_dq_treatment_dimensions_tbl" (tenant_id)
where valid_to = ores_utility_infinity_timestamp_fn();
