 ...
 *
 */
#include "ores.trading/repository/fpml_event_type_repository.hpp"

#include <sqlgen/postgres.hpp>
#include "ores.database/repository/helpers.hpp"
#include "ores.database/repository/bitemporal_operations.hpp"
#include "ores.trading/domain/fpml_event_type_json_io.hpp" // IWYU pragma: keep.
#include "ores.trading/repository/fpml_event_type_entity.hpp"
#include "ores.trading/repository/fpml_event_type_mapper.hpp"
...
std::string fpml_event_type_repository::sql() {
    return generate_create_table_sql<fpml_event_type_entity>(lg());
}
...
std::vector<domain::fpml_event_type>
fpml_event_type_repository::read_latest(context ctx, const std::string& code) {
