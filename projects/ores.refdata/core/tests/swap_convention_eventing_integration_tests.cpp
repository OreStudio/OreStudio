...
#include "ores.refdata.api/eventing/swap_convention_event.hpp"
...
TEST_CASE("write_swap_convention_publishes_an_event", tags) {
    ...
    using event_type = ores::refdata::messaging::swap_convention_event;
    ...
    event_source.register_entity_event_mapping<event_type>("ores_refdata_swap_conventions");
