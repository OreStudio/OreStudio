 ...
 *
 */
#ifndef ORES_ACCOUNTS_DOMAIN_EVENTS_ROLE_ASSIGNED_EVENT_HPP
#define ORES_ACCOUNTS_DOMAIN_EVENTS_ROLE_ASSIGNED_EVENT_HPP
 ...
 */
template<>
struct event_traits<ores::accounts::domain::events::role_assigned_event> {
    static constexpr std::string_view name = "ores.accounts.role_assigned";
};
