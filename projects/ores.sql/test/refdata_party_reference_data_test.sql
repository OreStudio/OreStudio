...
select throws_ok(
    $$select ores_refdata_validate_party_type_fn(ores_utility_system_tenant_id_fn(), NULL)$$,
    '23502',
    NULL,
...
select throws_ok(
    $$select ores_refdata_validate_party_type_fn(ores_utility_system_tenant_id_fn(), '')$$,
    '23502',
    NULL,
...
select is(
    ores_refdata_validate_party_type_fn(ores_utility_system_tenant_id_fn(), 'Bank'),
    'Bank',
...
select throws_ok(
    $$select ores_refdata_validate_party_type_fn(ores_utility_system_tenant_id_fn(), 'INVALID')$$,
    '23503',
    NULL,
...
select throws_ok(
    $$select ores_refdata_validate_party_status_fn(ores_utility_system_tenant_id_fn(), NULL)$$,
    '23502',
    NULL,
...
select is(
    ores_refdata_validate_party_status_fn(ores_utility_system_tenant_id_fn(), 'Active'),
    'Active',
...
select is(
    ores_refdata_validate_party_status_fn(ores_utility_system_tenant_id_fn(), 'Suspended'),
    'Suspended',
...
select throws_ok(
    $$select ores_refdata_validate_party_status_fn(ores_utility_system_tenant_id_fn(), 'INVALID')$$,
    '23503',
    NULL,
...
select throws_ok(
    $$select ores_refdata_validate_party_id_scheme_fn(ores_utility_system_tenant_id_fn(), NULL)$$,
    '23502',
    NULL,
...
select is(
    ores_refdata_validate_party_id_scheme_fn(ores_utility_system_tenant_id_fn(), 'LEI'),
    'LEI',
...
select is(
    ores_refdata_validate_party_id_scheme_fn(ores_utility_system_tenant_id_fn(), 'BIC'),
    'BIC',
...
select throws_ok(
    $$select ores_refdata_validate_party_id_scheme_fn(ores_utility_system_tenant_id_fn(), 'INVALID')$$,
    '23503',
    NULL,
...
select throws_ok(
    $$select ores_refdata_validate_contact_type_fn(ores_utility_system_tenant_id_fn(), NULL)$$,
    '23502',
    NULL,
...
select is(
    ores_refdata_validate_contact_type_fn(ores_utility_system_tenant_id_fn(), 'Legal'),
    'Legal',
...
select is(
    ores_refdata_validate_contact_type_fn(ores_utility_system_tenant_id_fn(), 'Settlement'),
    'Settlement',
...
select throws_ok(
    $$select ores_refdata_validate_contact_type_fn(ores_utility_system_tenant_id_fn(), 'INVALID')$$,
    '23503',
    NULL,
