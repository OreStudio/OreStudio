 ...
 */
#ifndef ORES_SHELL_APP_COMMANDS_CRM_TOPOLOGY_CONFIG_COMMANDS_HPP
#define ORES_SHELL_APP_COMMANDS_CRM_TOPOLOGY_CONFIG_COMMANDS_HPP
...
/**
 * @brief Every verb CRM topology configs answer, as one command each.
 *
 ...
 */
class crm_topology_config_commands {
private:
    inline static std::string_view logger_name =
        "ores.shell.app.commands.refdata.crm_topology_config_commands";
...
public:
    /**
     * @brief Register the CRM topology configs submenu.
     */
    ...
    /**
     * @brief add <id> <name> <pivot_currency_code> <enabled> <reason> <commentary>
     */
