 ...
 *
 */
#ifndef ORES_UTILITY_EXCEPTION_EXCEPTION_HPP
#define ORES_UTILITY_EXCEPTION_EXCEPTION_HPP

/**
 * @brief Contains exception types for non-library specific use cases.
 */
