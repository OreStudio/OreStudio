...
#+CAPTION: Clock summary at [2024-07-07 Sun 21:54]
|       | <75>                                              |         |       |      |       |
| Tags  | Headline                                          | Time    |       |      |     % |
|-------+---------------------------------------------------+---------+-------+------+-------|
|       | *Total time*                                      | *49:10* |       |      | 100.0 |
|-------+---------------------------------------------------+---------+-------+------+-------|
|       | Stories                                           | 49:10   |       |      | 100.0 |
|       | Active                                            |         | 49:10 |      | 100.0 |
...
| infra | Setup vcpkg and cmake                             |         |       | 1:21 |   2.7 |
| infra | Setup github actions                              |         |       | 1:21 |   2.7 |
...
| doc   | Copy domain notes on core concepts                |         |       | 4:41 |   9.5 |
...
| code  | Add XML parsing support for currency              |         |       | 3:22 |   6.8 |
| code  | Update C++ standard                               |         |       | 0:05 |   0.2 |
...
*** STARTED Update C++ standard                                        :code:
    :LOGBOOK:
