...
*** STARTED Consider renaming =ores.nats= to =ores.messaging=          :code:
    :LOGBOOK:
    CLOCK: [2026-03-15 Sun 17:30]--[2026-03-15 Sun 20:04] =>  2:34
    :END:

We should have implementation agnostic classes for this which hide NATS as the
implementation detail.

Notes:

- rename ores.comms.shell to just ores.shell
- rename ores.nats to ores.messaging.
