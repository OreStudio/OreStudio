...
{{#has_as_of_lookup}}
     ...
     * @param {{primary_key.column}} Optional key filter; empty reads every key
     */
    /**@{*/
    std::vector<domain::{{entity_singular}}>
...
{{/read_only}}
     ...
     */
    std::vector<domain::{{name_singular}}>
    read_latest(const {{left.cpp_type}}& {{left.column}},
    ...
    std::vector<domain::{{name_singular}}>
    read_latest_by_{{left.column_short}}(const {{left.cpp_type}}& {{left.column}});
{{#left.list_by}}
    /**
...
{{/left.list_by}}
    ...
    std::vector<domain::{{name_singular}}>
    read_latest_by_{{right.column_short}}(const {{right.cpp_type}}& {{right.column}});
{{#right.list_by}}
    /**
