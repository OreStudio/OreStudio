...
#+description: Use compass add to create a v2 doc (story/task/sprint/recipe/...) via ores.codegen, with parent-dir defaulted from where we are.
#+type: recipe
#+version: 2
#+level: cross
...
which imports =ores.codegen='s =v2_doc_generate= and calls
=v2_doc_generate.main(["--type", <type>, …])=. Needs =pystache= (in
...
- [[id:3153AA4B-23D4-4111-9710-5A4971102EDC][How do I create a new v2 doc?]] — every flag, per document type.
