...
#+CAPTION: Clock summary at [2024-07-20 Sat 22:51]
|       | <75>                                               |         |       |      |       |
| Tags  | Headline                                           | Time    |       |      |     % |
|-------+----------------------------------------------------+---------+-------+------+-------|
...
| infra | Setup laptop for development                       |         |       | 3:47 |   5.1 |
| infra | Add database support for currency                  |         |       | 1:19 |   1.8 |
...
| code  | Investigate other Qt Applications with similar UIs |         |       | 2:09 |   2.9 |
