...
void DataDomainHistoryDialog::loadHistory() {
    ...
    auto task = [self, name = name_.toStdString()]() -> HistoryResult {
        ...
        comms::messaging::frame request_frame(
            comms::messaging::message_type::get_data_domain_history_request, 0, std::move(payload));
        ...
        auto response = dq::messaging::get_data_domain_history_response::deserialize(*payload_result);
