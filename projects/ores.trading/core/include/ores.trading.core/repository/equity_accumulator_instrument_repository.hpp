 ...
 *
 */
#ifndef ORES_TRADING_CORE_REPOSITORY_EQUITY_ACCUMULATOR_INSTRUMENT_REPOSITORY_HPP
#define ORES_TRADING_CORE_REPOSITORY_EQUITY_ACCUMULATOR_INSTRUMENT_REPOSITORY_HPP
 ...
 */
class ORES_TRADING_CORE_EXPORT equity_accumulator_instrument_repository {
private:
...
public:
    ...
    /**
     * @brief Writes Equity Accumulator instruments to database.
     */
    /**@{*/
    ...
    /**
     * @brief Reads latest Equity Accumulator instruments, possibly filtered by primary key.
     */
    /**@{*/
    ...
    /**
     * @brief Reads all Equity Accumulator instruments, possibly filtered by primary key.
     */
    std::vector<domain::equity_accumulator_instrument> read_all(context ctx,
                                                                const std::string& instrument_id);

    /**
     * @brief Reads a single Equity Accumulator instrument as it stood at a specific
    ...
    /**
     * @brief Reads latest Equity Accumulator instruments with pagination support.
     * @param ctx Repository context with database connection
     ...
     */
    std::uint32_t get_total_equity_accumulator_instrument_count(context ctx);

    /**
     * @brief Deletes a Equity Accumulator instrument by closing its temporal validity.
     */
    void remove(context ctx, const std::string& instrument_id);

    /**
     * @brief Deletes Equity Accumulator instruments by closing their temporal validity.
     */
