...
void BookPurposeTypeController::showHistoryWindow(const QString& code) {
    ...
    auto* historyDialog =
        new HistoryDialog(std::string(entity_type_of(refdata::domain::book_purpose_type{})),
                          code.toStdString(),
                          clientManager_,
                          mainWindow_);
    ...
    connect(historyDialog,
            ...
            this,
            [self = QPointer<BookPurposeTypeController>(this)](
...
void BookPurposeTypeController::fetchBookPurposeTypeHistory(
    ...
    using FetchResult = std::expected<std::vector<refdata::domain::book_purpose_type>, QString>;
...
void BookPurposeTypeController::onOpenHistoryVersion(const QString& entityId, int versionNumber) {
    QPointer<BookPurposeTypeController> self = this;
    fetchBookPurposeTypeHistory(
        entityId,
        [self, entityId, versionNumber](
            std::expected<std::vector<refdata::domain::book_purpose_type>, QString> result) {
            if (!self)
                return;
            if (!result) {
...
void BookPurposeTypeController::onRevertHistoryVersion(const QString& entityId, int versionNumber) {
    QPointer<BookPurposeTypeController> self = this;
    fetchBookPurposeTypeHistory(
        entityId,
        [self, entityId, versionNumber](
