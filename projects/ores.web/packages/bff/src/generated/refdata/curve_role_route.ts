 ...
 */
/**
 * How the BFF reaches the curve_role service.
 *
 ...
 */
import { subjects } from '@ores/wire-protocol/generated/refdata/protocol/curve_role_protocol';
...
export const curveRoleRoute: EntityRouteDescriptor = {
  ...
  subjects: {
    ...
    save: subjects.put_curve_role_request,
    remove: subjects.delete_curve_role_request,
