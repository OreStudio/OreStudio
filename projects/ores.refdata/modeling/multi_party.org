:PROPERTIES:
:ID: 268AED29-2107-48C3-AF55-335CD5477C84
:END:
...
isolation separates organisations from each other, party isolation separates
business units within an organisation. This document describes how party context
flows through the system from user authentication to database queries.
