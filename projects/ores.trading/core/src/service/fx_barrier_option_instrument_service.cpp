...
fx_barrier_option_instrument_service::get_fx_barrier_option_instrument(const std::string& id) {
    BOOST_LOG_SEV(lg(), debug) << "Getting fx_barrier_option_instrument: " << id;
