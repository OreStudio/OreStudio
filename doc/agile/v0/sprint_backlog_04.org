...
#+CAPTION: Clock summary at [2025-11-08 Sat 23:46], for Saturday, November 08, 2025.
|       | <75>                                    |         |       |       |       |
| Tags  | Headline                                | Time    |       |       |     % |
|-------+-----------------------------------------+---------+-------+-------+-------|
...
|       | Stories                                 | 16:53   |       |       | 100.0 |
|       | Active                                  |         | 16:53 |       | 100.0 |
| agile | Sprint and product backlog refinement   |         |       |  0:09 |   0.9 |
| code  | Use fluent icons                        |         |       |  0:27 |   2.7 |
| code  | Add export functionality for currencies |         |       |  1:30 |   8.9 |
| code  | Add currency editing support            |         |       |  2:45 |  16.3 |
| code  | Make UI/UX look more professional       |         |       | 11:07 |  65.8 |
| code  | Add about to menu                       |         |       |  0:55 |   5.4 |
#+end:

#+begin: clocktable :maxlevel 3 :scope subtree :tags t :indent nil :emphasize nil :scope file :narrow 75 :formula %
#+TBLNAME: sprint_summary
#+CAPTION: Clock summary at [2025-11-08 Sat 23:46]
|       | <75>                                                   |         |       |       |       |
| Tags  | Headline                                               | Time    |       |       |     % |
|-------+--------------------------------------------------------+---------+-------+-------+-------|
...
|       | Stories                                                | 24:28   |       |       | 100.0 |
|       | Active                                                 |         | 24:28 |       | 100.0 |
| agile | Sprint and product backlog refinement                  |         |       |  0:43 |   2.9 |
| code  | Clean up client parser                                 |         |       |  0:10 |   0.7 |
| code  | Add connect command line argument                      |         |       |  1:19 |   5.4 |
| infra | Install Windows package on Windows machine             |         |       |  2:09 |   8.8 |
| code  | Ignore warnings on windows and osx                     |         |       |  0:33 |   2.2 |
| code  | Ensure applications work under OSX using github images |         |       |  0:14 |   1.0 |
| infra | Create a splash screen and gray background             |         |       |  2:26 |   9.9 |
| code  | Use fluent icons                                       |         |       |  0:37 |   2.5 |
| code  | Add export functionality for currencies                |         |       |  1:30 |   6.1 |
| code  | Add currency editing support                           |         |       |  2:45 |  11.2 |
| code  | Make UI/UX look more professional                      |         |       | 11:07 |  45.4 |
| code  | Add about to menu                                      |         |       |  0:55 |   3.7 |
#+end:
...
*** STARTED Add about to menu                                          :code:
    :LOGBOOK:
...
*** Create a history dialog for currencies                             :code:
