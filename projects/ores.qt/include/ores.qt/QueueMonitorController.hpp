...
/**
 * @brief Controller for the read-only queue monitor window.
 *
 * Manages the lifecycle of the QueueMonitorMdiWindow. There are no detail or
 * history sub-windows — this is a monitoring-only screen.
 */
class QueueMonitorController final : public EntityController {
    Q_OBJECT
