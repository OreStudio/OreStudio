 ...
 *
 */
#ifndef ORES_TRADE_MESSAGING_TRADE_PROTOCOL_HPP
#define ORES_TRADE_MESSAGING_TRADE_PROTOCOL_HPP
...
// Trade traits
template<>
struct message_traits<trade::messaging::get_trades_request> {
    using request_type = trade::messaging::get_trades_request;
    using response_type = trade::messaging::get_trades_response;
    static constexpr message_type request_message_type =
        message_type::get_trades_request;
};

template<>
struct message_traits<trade::messaging::save_trade_request> {
    using request_type = trade::messaging::save_trade_request;
    using response_type = trade::messaging::save_trade_response;
    static constexpr message_type request_message_type =
        message_type::save_trade_request;
};

template<>
struct message_traits<trade::messaging::delete_trade_request> {
    using request_type = trade::messaging::delete_trade_request;
    using response_type = trade::messaging::delete_trade_response;
    static constexpr message_type request_message_type =
        message_type::delete_trade_request;
};

template<>
struct message_traits<trade::messaging::get_trade_history_request> {
    using request_type = trade::messaging::get_trade_history_request;
    using response_type = trade::messaging::get_trade_history_response;
    static constexpr message_type request_message_type =
