 ...
 *
 */
#ifndef ORES_TELEMETRY_CORE_DOMAIN_TRACE_ID_HPP
#define ORES_TELEMETRY_CORE_DOMAIN_TRACE_ID_HPP
 ...
 */
struct ORES_TELEMETRY_CORE_EXPORT trace_id final {
    /**
 ...
 */
ORES_TELEMETRY_CORE_EXPORT std::ostream& operator<<(std::ostream& os, const trace_id& id);
