 ...
 */
std::vector<domain::pricing_engine_type> read_one(repository::pricing_engine_type_repository& repo,
                                                  const ores::database::context& ctx,
                                                  const messaging::pricing_engine_type_key& key) {
 ...
 */
messaging::pricing_engine_type_key key_from(const domain::pricing_engine_type& v) {
    messaging::pricing_engine_type_key key;
    key.code = v.code;
    return key;
}
 ...
 */
domain::pricing_engine_type to_domain(const messaging::pricing_engine_type_write& write) {
    domain::pricing_engine_type v;
    v.code = write.code;
    v.description = write.description;
    v.instrument_type_code = write.instrument_type_code;
    return v;
}
...
pricing_engine_type_service::list_pricing_engine_types(
    const messaging::list_pricing_engine_types_request& request) {
    messaging::list_pricing_engine_types_response response;
...
messaging::get_pricing_engine_type_response pricing_engine_type_service::get_pricing_engine_type(
    const messaging::get_pricing_engine_type_request& request) {
    messaging::get_pricing_engine_type_response response;
    ...
    response.pricing_engine_type = std::move(found.front());
    return response;
}

messaging::get_many_pricing_engine_types_response
pricing_engine_type_service::get_many_pricing_engine_types(
    const messaging::get_many_pricing_engine_types_request& request) {
    messaging::get_many_pricing_engine_types_response response;
    // One entry per requested key, in the order asked for, so the reply is
    // positional and a caller reads absence from an empty entry rather than
    // from a missing one.
    response.entries.reserve(request.keys.size());
    for (const auto& k : request.keys) {
        messaging::pricing_engine_type_lookup entry;
        entry.key = k;
        auto found = read_one(repo_, ctx_, k);
        if (!found.empty())
            entry.pricing_engine_type = std::move(found.front());
        response.entries.push_back(std::move(entry));
    }
    return response;
}

messaging::put_pricing_engine_type_response pricing_engine_type_service::put_pricing_engine_type(
    const messaging::put_pricing_engine_type_request& request) {
    messaging::put_pricing_engine_type_response response;
    domain::pricing_engine_type value;
    ...
    if (!written.empty())
        response.pricing_engine_type = std::move(written.front());
    return response;
}

messaging::put_many_pricing_engine_types_response
pricing_engine_type_service::put_many_pricing_engine_types(
    const messaging::put_many_pricing_engine_types_request& request) {
    messaging::put_many_pricing_engine_types_response response;
    std::vector<domain::pricing_engine_type> batch;
...
pricing_engine_type_service::delete_pricing_engine_type(
    const messaging::delete_pricing_engine_type_request& request) {
    messaging::delete_pricing_engine_type_response response;
    ...
    switch (repo_.remove(ctx_, request.removal.key.code, expected)) {
        case repository::pricing_engine_type_repository::remove_status::removed:
            break;
        case repository::pricing_engine_type_repository::remove_status::missing:
            response.result.outcome = outcome::missing;
            response.result.code = "not_found";
            break;
        case repository::pricing_engine_type_repository::remove_status::conflicting:
            response.result.outcome = outcome::conflict;
            response.result.code = "version_conflict";
            break;
        case repository::pricing_engine_type_repository::remove_status::unsupported:
            response.result.outcome = outcome::invalid;
            response.result.code = "precondition_not_supported";
...
messaging::delete_many_pricing_engine_types_response
pricing_engine_type_service::delete_many_pricing_engine_types(
    const messaging::delete_many_pricing_engine_types_request& request) {
    messaging::delete_many_pricing_engine_types_response response;
    using ores::utility::domain::outcome;
    using ores::utility::domain::precondition_kind;
...
messaging::list_pricing_engine_type_versions_response
pricing_engine_type_service::list_pricing_engine_type_versions(
    const messaging::list_pricing_engine_type_versions_request& request) {
    messaging::list_pricing_engine_type_versions_response response;
    if (!request.order.field.empty() || request.order.descending) {
        response.result.outcome = ores::utility::domain::outcome::invalid;
        response.result.code = "order_not_supported";
        response.result.message =
...
messaging::get_pricing_engine_type_version_response
pricing_engine_type_service::get_pricing_engine_type_version(
    const messaging::get_pricing_engine_type_version_request& request) {
    messaging::get_pricing_engine_type_version_response response;
    auto found =
        repo_.read_at_version(ctx_, request.key.pricing_engine_type.code, request.key.version);
    if (!found) {
        response.result.outcome = ores::utility::domain::outcome::missing;
        response.result.code = "not_found";
        return response;
...
pricing_engine_type_service::prepare_change(const messaging::pricing_engine_type_change& change,
...
std::vector<domain::pricing_engine_type>
pricing_engine_type_service::get_types(const std::vector<std::string>& codes) {
