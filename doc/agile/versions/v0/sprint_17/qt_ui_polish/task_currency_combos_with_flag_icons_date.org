...
:END:
#+title: Task: Currency combos with flag icons, date pickers, and dialog polish
...
Add OreCurrencyComboBox and OreDateEdit custom widgets, wire flag icons into all currency combo boxes via ImageCache, and polish date pickers in the trade detail dialog.
...
- Add OreCurrencyComboBox and OreDateEdit custom widgets, wire flag icons into all currency combo boxes via ImageCache, and polish date pickers in the trade detail dialog.
- PR #726 merged and landed on main.
