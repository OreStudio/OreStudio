...
| Now           | Hierarchy SQL/NATS layer done (task 4); task 3's blocker is resolved. |
| Waiting on    | Nothing.                               |
| Next          | Bind composite child-entity and hierarchy widgets to party and counterparty (task 3). |
