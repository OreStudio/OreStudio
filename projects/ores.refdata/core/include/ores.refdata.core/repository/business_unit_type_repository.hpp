 ...
 */
#ifndef ORES_REFDATA_CORE_REPOSITORY_BUSINESS_UNIT_TYPE_REPOSITORY_HPP
#define ORES_REFDATA_CORE_REPOSITORY_BUSINESS_UNIT_TYPE_REPOSITORY_HPP
...
/**
 * @brief Reads and writes business unit types to data storage.
 */
class ORES_REFDATA_CORE_EXPORT business_unit_type_repository {
private:
    inline static std::string_view logger_name =
        "ores.refdata.repository.business_unit_type_repository";
...
public:
    ...
    /**
     * @brief Writes a business unit type, honouring the claim it states.
     *
    ...
    /**
     * @brief Writes a set of business unit types, each honouring its own
    ...
    /**
     * @brief Reads latest business unit types, possibly filtered by primary key.
     */
    /**@{*/
    ...
    /**
     * @brief Removes a business unit type, refusing a row that moved on.
     *
...
private:
     ...
     */
    domain::business_unit_type apply_claim(context ctx,
                                           const domain::business_unit_type& v,
                                           const ores::utility::domain::precondition& claim);
};
