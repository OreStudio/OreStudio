...
#+CAPTION: Clock summary at [2025-11-15 Sat 06:25], for Saturday, November 15, 2025.
|      | <75>                                           |        |      |      |       |
| Tags | Headline                                       | Time   |      |      |     % |
|------+------------------------------------------------+--------+------+------+-------|
|      | *Total time*                                   | *3:22* |      |      | 100.0 |
|------+------------------------------------------------+--------+------+------+-------|
|      | Stories                                        | 3:22   |      |      | 100.0 |
|      | Active                                         |        | 3:22 |      | 100.0 |
| code | Split JSON based =operator<<= from domain type |        |      | 0:53 |  26.2 |
| code | Add a table representation of domain types     |        |      | 2:05 |  61.9 |
| code | Add a comint based emacs mode for the client   |        |      | 0:24 |  11.9 |
#+end:

#+begin: clocktable :maxlevel 3 :scope subtree :tags t :indent nil :emphasize nil :scope file :narrow 75 :formula %
#+TBLNAME: sprint_summary
#+CAPTION: Clock summary at [2025-11-15 Sat 06:25]
|          | <75>                                                   |         |       |       |       |
| Tags     | Headline                                               | Time    |       |       |     % |
|----------+--------------------------------------------------------+---------+-------+-------+-------|
|          | *Total time*                                           | *69:59* |       |       | 100.0 |
|----------+--------------------------------------------------------+---------+-------+-------+-------|
|          | Stories                                                | 69:59   |       |       | 100.0 |
|          | Active                                                 |         | 69:59 |       | 100.0 |
| agile    | Sprint and product backlog refinement                  |         |       |  2:49 |   4.0 |
| code     | Clean up client parser                                 |         |       |  0:10 |   0.2 |
| code     | Add connect command line argument                      |         |       |  1:19 |   1.9 |
| infra    | Install Windows package on Windows machine             |         |       |  2:09 |   3.1 |
| code     | Ignore warnings on windows and osx                     |         |       |  0:33 |   0.8 |
| code     | Ensure applications work under OSX using github images |         |       |  0:14 |   0.3 |
| infra    | Create a splash screen and gray background             |         |       |  2:26 |   3.5 |
| code     | Use fluent icons                                       |         |       |  0:37 |   0.9 |
| code     | Add export functionality for currencies                |         |       |  1:30 |   2.1 |
| code     | Add currency editing support                           |         |       |  2:45 |   3.9 |
| code     | Add about to menu                                      |         |       |  1:02 |   1.5 |
| code     | Create a history dialog for currencies                 |         |       |  1:27 |   2.1 |
| code     | Allow MDI windows outside main window                  |         |       |  1:35 |   2.3 |
| code     | Add edit menu and export menu                          |         |       |  0:34 |   0.8 |
| code     | Implement adding new currencies                        |         |       |  3:17 |   4.7 |
| code     | Clean up product website                               |         |       |  4:42 |   6.7 |
| code     | Create a skill for plant uml documentation             |         |       |  2:48 |   4.0 |
| infra    | Add CMake targets for site and skills                  |         |       |  0:17 |   0.4 |
| infra    | Generalise the skill setup for ORE Studio              |         |       |  3:45 |   5.4 |
| infra    | Restructure components to follow the dogen approach    |         |       |  2:54 |   4.1 |
| infra    | Generate PlantUML diagrams for all components          |         |       |  1:05 |   1.5 |
| analysis | Weaving skills and documentation together              |         |       |  0:46 |   1.1 |
| code     | Consider adding tags to catch2 tests                   |         |       |  0:34 |   0.8 |
| code     | Split JSON based =operator<<= from domain type         |         |       |  0:53 |   1.3 |
| code     | Add a table representation of domain types             |         |       |  2:05 |   3.0 |
| code     | Add a comint based emacs mode for the client           |         |       |  0:24 |   0.6 |
| code     | Fix the valgrind leaks reported on sqlgen              |         |       |  4:54 |   7.0 |
| code     | Make UI/UX look more professional                      |         |       | 11:07 |  15.9 |
| code     | Current issues with package install in debian          |         |       |  0:40 |   1.0 |
| code     | Resolve crash on shutdown problem                      |         |       |  0:50 |   1.2 |
| code     | Review all code created so far with an LLM             |         |       |  9:48 |  14.0 |
#+end:
