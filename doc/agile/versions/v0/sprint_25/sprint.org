...
| [[id:6C5EE3F6-0DE6-48C2-9325-21D818C7FD6B][Retire Qt and emit the UI metadata to TypeScript]] | STARTED | 2026-09-19 | | Delete the ores.qt and ores.wt trees. Keep the entity models' presentation drawer, renamed, and project it into a new ores.ts.ui facet so the TypeScript screens and the C++ headers read one model. |
