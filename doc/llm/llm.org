...
time. Runbooks live under =doc/runbooks/= and are S2
(Orchestrator)-owned.

Current runbooks:
- [[id:4F01E2FF-69AB-4839-88D1-4D8C21D99D3C][Start work on a new story]] — scaffold → branch → mark STARTED → PR.
- [[id:2EA7FF1B-CC23-4275-9ADA-8C43103E3103][Work a task through to merged PR]] — pickup → implement → PR → review → merge.

List with =compass list --type runbook=; scaffold with
=compass add runbook=.
