...
#+CAPTION: Clock summary at [2025-09-25 Thu 23:57], for Thursday, September 25, 2025.
|          | <75>                                |        |      |      |       |
| Tags     | Headline                            | Time   |      |      |     % |
|----------+-------------------------------------+--------+------+------+-------|
...
|          | Stories                             | 3:49   |      |      | 100.0 |
|          | Active                              |        | 3:49 |      | 100.0 |
| analysis | White-boarding for new architecture |        |      | 1:52 |  48.9 |
| code     | Use sqlgen for postgres             |        |      | 1:57 |  51.1 |
#+end:

#+begin: clocktable :maxlevel 3 :scope subtree :tags t :indent nil :emphasize nil :scope file :narrow 75 :formula %
#+TBLNAME: sprint_summary
#+CAPTION: Clock summary at [2025-09-25 Thu 23:57]
|          | <75>                                               |         |       |      |       |
| Tags     | Headline                                           | Time    |       |      |     % |
|----------+----------------------------------------------------+---------+-------+------+-------|
...
|          | Stories                                            | 41:46   |       |      | 100.0 |
|          | Active                                             |         | 41:46 |      | 100.0 |
| agile    | Sprint and product backlog refinement              |         |       | 2:15 |   5.4 |
| infra    | Fix broken builds                                  |         |       | 0:36 |   1.4 |
| code     | Create a containing structure for data             |         |       | 0:35 |   1.4 |
| code     | Add temporal support to currencies                 |         |       | 2:59 |   7.1 |
| code     | Add command to dump currencies                     |         |       | 4:18 |  10.3 |
| code     | Refactor code for currencies                       |         |       | 3:52 |   9.3 |
| code     | Restore qt setup                                   |         |       | 2:20 |   5.6 |
| code     | Add gemini action                                  |         |       | 0:05 |   0.2 |
| code     | Remove ImGui support                               |         |       | 0:08 |   0.3 |
| code     | Create a GRPC based service                        |         |       | 2:09 |   5.1 |
| code     | Implement a 0MQ based RPC service and client       |         |       | 3:55 |   9.4 |
| code     | Fix misspell fixer errors                          |         |       | 0:08 |   0.3 |
| code     | Remove URL support from prog mode in emacs         |         |       | 0:14 |   0.6 |
| code     | Remove GRPC support                                |         |       | 0:16 |   0.6 |
| code     | Implement a cobalt based server and client         |         |       | 2:53 |   6.9 |
| code     | Add serialisation support for reflect-cpp          |         |       | 3:07 |   7.5 |
| analysis | White-boarding for new architecture                |         |       | 1:52 |   4.5 |
| code     | Use sqlgen for postgres                            |         |       | 2:50 |   6.8 |
| code     | Completions in emacs org mode are incorrect        |         |       | 1:02 |   2.5 |
| infra    | Investigate build warning for vcpkg binary caching |         |       | 0:25 |   1.0 |
| infra    | Investigate build warning for qtbase               |         |       | 0:10 |   0.4 |
| analysis | Investigate bitemporal support from Postgres 18    |         |       | 1:47 |   4.3 |
| code     | Fix windows and osx builds                         |         |       | 0:27 |   1.1 |
| code     | Fix gemini cli action                              |         |       | 0:45 |   1.8 |
| infra    | vcpkg caching seems disabled                       |         |       | 0:15 |   0.6 |
| code     | Create a =comms= library                           |         |       | 1:10 |   2.8 |
