...
#+CAPTION: Clock summary at [2024-07-27 Sat 00:23]
|       | <75>                                               |         |       |       |       |
| Tags  | Headline                                           | Time    |       |       |     % |
|-------+----------------------------------------------------+---------+-------+-------+-------|
|       | *Total time*                                       | *79:44* |       |       | 100.0 |
|-------+----------------------------------------------------+---------+-------+-------+-------|
|       | Stories                                            | 79:44   |       |       | 100.0 |
|       | Active                                             |         | 79:44 |       | 100.0 |
...
| doc   | Copy domain notes on core concepts                 |         |       |  4:41 |   5.9 |
...
| code  | Add XML parsing support for currency               |         |       |  6:32 |   8.2 |
