 ...
 *
 */
#ifndef ORES_TRADE_MESSAGING_TRADE_PARTY_ROLE_PROTOCOL_HPP
#define ORES_TRADE_MESSAGING_TRADE_PARTY_ROLE_PROTOCOL_HPP
...
/**
 * @brief Request to save a trade party role (create or update).
 */
struct save_trade_party_role_request final {
    domain::trade_party_role role;
...
/**
 * @brief Response confirming trade party role save operation.
 */
...
/**
 * @brief Result for a single trade party role deletion.
 */
struct delete_trade_party_role_result final {
...
struct delete_trade_party_role_response final {
    std::vector<delete_trade_party_role_result> results;
...
template<>
struct message_traits<trade::messaging::get_trade_party_roles_request> {
    using request_type = trade::messaging::get_trade_party_roles_request;
    using response_type = trade::messaging::get_trade_party_roles_response;
    static constexpr message_type request_message_type =
        message_type::get_trade_party_roles_request;
};

template<>
struct message_traits<trade::messaging::save_trade_party_role_request> {
    using request_type = trade::messaging::save_trade_party_role_request;
    using response_type = trade::messaging::save_trade_party_role_response;
    static constexpr message_type request_message_type =
        message_type::save_trade_party_role_request;
};

template<>
struct message_traits<trade::messaging::delete_trade_party_role_request> {
    using request_type = trade::messaging::delete_trade_party_role_request;
    using response_type = trade::messaging::delete_trade_party_role_response;
    static constexpr message_type request_message_type =
        message_type::delete_trade_party_role_request;
};

template<>
struct message_traits<trade::messaging::get_trade_party_role_history_request> {
    using request_type = trade::messaging::get_trade_party_role_history_request;
    using response_type = trade::messaging::get_trade_party_role_history_response;
    static constexpr message_type request_message_type =
