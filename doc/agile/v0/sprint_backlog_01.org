...
#+CAPTION: Clock summary at [2024-06-26 Wed 19:44]
| <75>                                    |         |       |      |       |
| Headline                                | Time    |       |      |     % |
|-----------------------------------------+---------+-------+------+-------|
| *Total time*                            | *15:55* |       |      | 100.0 |
|-----------------------------------------+---------+-------+------+-------|
| Stories                                 | 15:55   |       |      | 100.0 |
| Active                                  |         | 15:55 |      | 100.0 |
| Sprint and product backlog refinement   |         |       | 0:31 |   3.2 |
| Create a basic git hub repository       |         |       | 0:35 |   3.7 |
| Setup a discord channel for the project |         |       | 0:14 |   1.5 |
| Setup vcpkg and cmake                   |         |       | 1:21 |   8.5 |
| Setup github actions                    |         |       | 1:21 |   8.5 |
| Create and upload a package             |         |       | 3:28 |  21.8 |
| Create a basic project structure        |         |       | 2:10 |  13.6 |
| Add a Qt hello world                    |         |       | 3:08 |  19.7 |
| Add a splash screen to applciation      |         |       | 0:41 |   4.3 |
| Add nightly support with memcheck       |         |       | 0:41 |   4.3 |
| Add XML parsing support for currency    |         |       | 1:24 |   8.8 |
| Create a containing structure for data  |         |       | 0:21 |   2.2 |
#+end:
...
inputs to output other elements.
