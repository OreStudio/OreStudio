...
business_day_convention_type_mapper::map(const business_day_convention_type_entity& v) {
...
business_day_convention_type_entity
business_day_convention_type_mapper::map(const domain::business_day_convention_type& v) {
    BOOST_LOG_SEV(lg(), trace) << "Mapping domain entity: " << v;

    business_day_convention_type_entity r;
    r.code = v.code;
