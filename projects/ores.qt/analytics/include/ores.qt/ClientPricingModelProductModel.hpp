...
private:
    inline static std::string_view logger_name = "ores.qt.client_pricing_model_product_model";
...
private:
    ...
    using PricingModelProductKeyExtractor =
        std::string (*)(const analytics::domain::pricing_model_product&);
    RecencyTracker<analytics::domain::pricing_model_product, PricingModelProductKeyExtractor>
        recencyTracker_;
