 ...
 *
 */
#ifndef ORES_DQ_SERVICE_APP_APPLICATION_HPP
#define ORES_DQ_SERVICE_APP_APPLICATION_HPP
...
/**
 * @brief Entry point for the ores.dq.service service.
 */
class application final {
private:
    inline static std::string_view logger_name = "ores.dq.service.app.application";
