...
/**
 * @brief Detail dialog for viewing and editing compute batch records.
 *
 * This dialog allows viewing, creating, and editing compute batches.
 * It supports both create mode (for new records) and edit mode (for
 * existing records).
 */
class BatchDetailDialog final : public DetailDialogBase {
    Q_OBJECT
...
public:
    explicit BatchDetailDialog(QWidget* parent = nullptr);
    ~BatchDetailDialog() override;

    void setClientManager(ClientManager* clientManager);
    void setUsername(const std::string& username);
    void setBatch(const compute::domain::batch& batch);
