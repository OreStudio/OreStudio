...
#+begin_quote
Error:   Target "ores.refdata.lib" links to:
...
## 📊 **Time Summary**
- **Total effort**: 90h 59m
- **Code**: 68% | **Infra**: 12% | **Agile/Analysis**: 5%
- Top tasks: `comms` library (8h), risk messaging (8h), accounts/login (7.7h), sqlgen integration (7.4h), CLI refactor (4.8h)

---

*Next sprint: Focus on completing authentication (session management, account
 lockout), stabilizing builds, and enabling database isolation for testing.*
#+end_src
