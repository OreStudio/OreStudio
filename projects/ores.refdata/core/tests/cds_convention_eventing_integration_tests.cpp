...
#include "ores.refdata.api/eventing/cds_convention_event.hpp"
...
TEST_CASE("write_cds_convention_publishes_an_event", tags) {
    ...
    using event_type = ores::refdata::messaging::cds_convention_event;
    ...
    event_source.register_entity_event_mapping<event_type>("ores_refdata_cds_conventions");
