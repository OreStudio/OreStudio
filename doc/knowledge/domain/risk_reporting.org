...
- All /configuration parameters/ (bump sizes, smile model, roll method,
  [[id:ACB7ED8A-0E01-47D5-8A3B-FE59FDF7C000][display currency]], aggregation level, etc.)
...
Each book belongs to one [[id:F5675BE6-EDDD-48C2-85B1-A10C1F00F7F8][business unit]] and carries one [[id:A7338353-8D2F-4784-92C0-B6E338C0D9C4][aggregation
currency]]. Risk figures at book level and above are converted to the
...
*Purpose*: Spot ladder at trade level where the [[id:1E27EF8E-FBA2-4D3F-B4E5-5B1C81F07522][premium currency]] is the
...
- [[id:ACB7ED8A-0E01-47D5-8A3B-FE59FDF7C000][Display currency]], [[id:A7338353-8D2F-4784-92C0-B6E338C0D9C4][aggregation currency]], aggregation mode.
...
- [[id:B50355E0-F016-4CA1-9932-404DAF83EA7A][P&L Attribution]] — P&L attribution methodology.
- [[id:EDAE3C87-7733-4D0C-881F-5AA65DD832AC][Pricing Configuration]] — the pricing configuration each report draws on.
- [[id:3407B8DF-D446-4658-8B5D-3368FFA44AD8][Currency]] — hub note for display/aggregation currency and the
  wider currency-role vocabulary this document uses.
- [[id:F5675BE6-EDDD-48C2-85B1-A10C1F00F7F8][Business Unit]] — the organisational hierarchy the aggregation
  level rolls up through.
