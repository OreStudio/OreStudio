 ...
 */
#ifndef ORES_SHELL_APP_COMMANDS_TAG_COMMANDS_HPP
#define ORES_SHELL_APP_COMMANDS_TAG_COMMANDS_HPP
...
/**
 * @brief Every verb asset tags answer, as one command each.
 *
...
class tag_commands {
private:
    inline static std::string_view logger_name = "ores.shell.app.commands.assets.tag_commands";
...
public:
    /**
     * @brief Register the asset tags submenu.
     */
