 ...
 */
#ifndef ORES_SHELL_APP_COMMANDS_YIELD_CURVE_PROCESS_TYPE_COMMANDS_HPP
#define ORES_SHELL_APP_COMMANDS_YIELD_CURVE_PROCESS_TYPE_COMMANDS_HPP
...
/**
 * @brief Every verb yield curve process types answer, as one command each.
 *
 ...
 */
class yield_curve_process_type_commands {
private:
    inline static std::string_view logger_name =
        "ores.shell.app.commands.synthetic.yield_curve_process_type_commands";
...
public:
    /**
     * @brief Register the yield curve process types submenu.
     */
