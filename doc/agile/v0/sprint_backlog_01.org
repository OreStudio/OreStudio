...
#+CAPTION: Clock summary at [2024-07-22 Mon 23:27]
|       | <75>                                               |         |       |      |       |
| Tags  | Headline                                           | Time    |       |      |     % |
|-------+----------------------------------------------------+---------+-------+------+-------|
|       | *Total time*                                       | *75:54* |       |      | 100.0 |
|-------+----------------------------------------------------+---------+-------+------+-------|
|       | Stories                                            | 75:54   |       |      | 100.0 |
|       | Active                                             |         | 75:54 |      | 100.0 |
| agile | Sprint and product backlog refinement              |         |       | 3:26 |   4.5 |
| infra | Create a basic git hub repository                  |         |       | 0:35 |   0.8 |
| infra | Setup a discord channel for the project            |         |       | 0:14 |   0.3 |
| infra | Setup vcpkg and cmake                              |         |       | 1:21 |   1.8 |
| infra | Setup github actions                               |         |       | 1:21 |   1.8 |
| infra | Create and upload a package                        |         |       | 3:28 |   4.6 |
| code  | Create a basic project structure                   |         |       | 2:10 |   2.9 |
| code  | Add a Qt hello world                               |         |       | 3:08 |   4.1 |
| code  | Add a splash screen to applciation                 |         |       | 0:41 |   0.9 |
| infra | Add basic site                                     |         |       | 0:34 |   0.7 |
| code  | Add modeling infrastructure                        |         |       | 1:30 |   2.0 |
| infra | Fix code syntax highlighting in site               |         |       | 0:10 |   0.2 |
| doc   | Merge index with readme                            |         |       | 0:42 |   0.9 |
| doc   | Add project objective to readme                    |         |       | 2:24 |   3.2 |
| code  | Add basic logging support                          |         |       | 1:14 |   1.6 |
| infra | Add nightly support with memcheck                  |         |       | 3:21 |   4.4 |
| code  | Clean up toolchains and presets                    |         |       | 1:53 |   2.5 |
| doc   | Generate Doxygen documentation and add it to site  |         |       | 0:51 |   1.1 |
| doc   | Copy domain notes on core concepts                 |         |       | 4:41 |   6.2 |
| infra | Valgrind fails to run unit tests                   |         |       | 1:12 |   1.6 |
| infra | Initial sanity test generated packages             |         |       | 0:25 |   0.5 |
| code  | Add command line options support                   |         |       | 5:45 |   7.6 |
| infra | Unit tests show up twice in nightlies              |         |       | 0:13 |   0.3 |
| doc   | Add recipes for command line                       |         |       | 0:51 |   1.1 |
| agile | Use a bar chart for sprint resourcing cost         |         |       | 2:57 |   3.9 |
| agile | Classify stories by type                           |         |       | 0:34 |   0.7 |
| code  | Update C++ standard                                |         |       | 0:29 |   0.6 |
| infra | Setup laptop for development                       |         |       | 3:47 |   5.0 |
| infra | Add database support for currency                  |         |       | 1:19 |   1.7 |
| code  | Add XML parsing support for currency               |         |       | 6:32 |   8.6 |
| code  | Add JSON support for currency                      |         |       | 2:03 |   2.7 |
...
| infra | Setup code quality actions                         |         |       | 0:58 |   1.3 |
| code  | Refactor Qt UI                                     |         |       | 8:59 |  11.8 |
#+end:
