...
/**
 * @brief Handles assets.v1.*.publish-from-dq workflow step commands.
 *
 * Calls ores_assets_publish_*_from_dq_fn SECURITY DEFINER functions,
 * which read DQ artefact tables and write to ores_assets_* tables.
 */
