 ...
 *
 */
#ifndef ORES_RISK_MESSAGING_COUNTRY_PROTOCOL_HPP
#define ORES_RISK_MESSAGING_COUNTRY_PROTOCOL_HPP
 ...
 */
template<>
struct message_traits<risk::messaging::get_countries_request> {
    using request_type = risk::messaging::get_countries_request;
    using response_type = risk::messaging::get_countries_response;
 ...
 */
template<>
struct message_traits<risk::messaging::save_country_request> {
    using request_type = risk::messaging::save_country_request;
    using response_type = risk::messaging::save_country_response;
    static constexpr message_type request_message_type =
 ...
 */
template<>
struct message_traits<risk::messaging::delete_country_request> {
    using request_type = risk::messaging::delete_country_request;
    using response_type = risk::messaging::delete_country_response;
    static constexpr message_type request_message_type =
 ...
 */
template<>
struct message_traits<risk::messaging::get_country_history_request> {
    using request_type = risk::messaging::get_country_history_request;
    using response_type = risk::messaging::get_country_history_response;
    static constexpr message_type request_message_type =
