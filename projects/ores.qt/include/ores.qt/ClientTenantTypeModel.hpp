...
/**
 * @brief Model for displaying tenant types fetched from the server.
 *
 * This model extends QAbstractTableModel and fetches tenant type
 * data asynchronously using the ores.comms client.
 */
class ClientTenantTypeModel final : public QAbstractTableModel {
    Q_OBJECT
...
public:
     ...
     */
    static constexpr std::string_view kSettingsGroup = "TenantTypeListWindow";
    /**
    ...
    /**
     * @brief Get tenant type at the specified row.
     *
     * @param row The row index.
     * @return The tenant type, or nullptr if row is invalid.
     */
...
private:
    ...
    struct FetchResult {
        bool success;
        std::vector<iam::domain::tenant_type> tenant_types;
        QString error_message;
        QString error_details;
    };

    ClientManager* clientManager_;
    std::vector<iam::domain::tenant_type> tenant_types_;
