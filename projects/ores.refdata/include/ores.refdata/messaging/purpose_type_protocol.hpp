...
struct get_purpose_types_request {
    ...
    static constexpr std::string_view nats_subject = "ores.refdata.v1.purpose-types.list";
    int offset = 0;
    int limit = 100;
};
...
struct save_purpose_type_request {
    ...
    static constexpr std::string_view nats_subject = "ores.refdata.v1.purpose-types.save";
...
struct delete_purpose_type_request {
    ...
    static constexpr std::string_view nats_subject = "ores.refdata.v1.purpose-types.delete";
    std::string type;
};
...
struct get_purpose_type_history_request {
    ...
    static constexpr std::string_view nats_subject = "ores.refdata.v1.purpose-types.history";
    std::string type;
};
