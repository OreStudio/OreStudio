 ...
 *
 */
#ifndef ORES_ASSETS_REPOSITORY_COUNTRY_IMAGE_ENTITY_HPP
#define ORES_ASSETS_REPOSITORY_COUNTRY_IMAGE_ENTITY_HPP
...
/**
 * @brief Represents a country-image association in the database.
 *
 * Each country has one primary image (typically a flag).
 */
struct country_image_entity {
    constexpr static const char* schema = "ores";
    constexpr static const char* tablename = "country_images";
...
std::ostream& operator<<(std::ostream& s, const country_image_entity& v);
