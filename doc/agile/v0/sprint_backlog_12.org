...
#+CAPTION: Clock summary at [2026-02-19 Thu 18:10], for Thursday, February 19, 2026.
|      | <75>                                          |        |      |      |       |
| Tags | Headline                                      | Time   |      |      |     % |
|------+-----------------------------------------------+--------+------+------+-------|
...
|      | Stories                                       | 5:00   |      |      | 100.0 |
|      | Active                                        |        | 5:00 |      | 100.0 |
| code | Improve column handling in list widgets in Qt |        |      | 4:00 |  80.0 |
| code | Add trade envelope support                    |        |      | 1:00 |  20.0 |
#+end:

#+begin: clocktable :maxlevel 3 :scope subtree :tags t :indent nil :emphasize nil :scope file :narrow 75 :formula %
#+TBLNAME: sprint_summary
#+CAPTION: Clock summary at [2026-02-19 Thu 18:10]
|       | <75>                                               |         |       |       |       |
| Tags  | Headline                                           | Time    |       |       |     % |
|-------+----------------------------------------------------+---------+-------+-------+-------|
|       | *Total time*                                       | *66:21* |       |       | 100.0 |
|-------+----------------------------------------------------+---------+-------+-------+-------|
|       | Stories                                            | 66:21   |       |       | 100.0 |
|       | Active                                             |         | 66:21 |       | 100.0 |
| agile | Sprint and product backlog refinement              |         |       |  3:13 |   4.8 |
| code  | Add bound parameters to sqlgen                     |         |       |  0:51 |   1.3 |
| code  | Add roles to account via codes                     |         |       |  0:34 |   0.9 |
| code  | Implement party related entities at database level |         |       |  4:23 |   6.6 |
| code  | Add party related support at the domain level      |         |       |  0:23 |   0.6 |
| code  | Add party related support to Qt                    |         |       |  6:41 |  10.1 |
| code  | Add GLEIF data to datasets                         |         |       |  6:41 |  10.1 |
| code  | Brainstorm on multi-party support                  |         |       |  4:00 |   6.0 |
| code  | Improve code coverage                              |         |       |  0:14 |   0.4 |
| code  | Improve generators with FK-aware test data         |         |       |  1:44 |   2.6 |
| code  | Enable all skipped tests                           |         |       |  0:29 |   0.7 |
| code  | Add central bank related LEIs                      |         |       |  0:35 |   0.9 |
| code  | Expand unit test coverage for ORE codegened types  |         |       |  0:49 |   1.2 |
| code  | Add system party support                           |         |       |  3:58 |   6.0 |
| code  | Add customer party support                         |         |       |  1:33 |   2.3 |
| code  | Fix OSX build                                      |         |       |  0:19 |   0.5 |
| code  | Add pagination to counterparty                     |         |       |  0:58 |   1.5 |
| code  | Add support for business centres                   |         |       |  3:47 |   5.7 |
| code  | Add LEI to BIC dataset                             |         |       |  0:27 |   0.7 |
| code  | Add proper party short-codes                       |         |       |  2:18 |   3.5 |
| code  | Polish party and counterparty list UI              |         |       |  1:25 |   2.1 |
| code  | Implement party-level RLS isolation                |         |       |  2:33 |   3.8 |
| code  | Add a setup new tenant wizard                      |         |       |  1:27 |   2.2 |
| code  | Advanced counterparty dialog                       |         |       | 10:46 |  16.2 |
| code  | Improve column handling in list widgets in Qt      |         |       |  4:00 |   6.0 |
| code  | Analyse caching at dialog level                    |         |       |  1:13 |   1.8 |
| code  | Add trade envelope support                         |         |       |  1:00 |   1.5 |
#+end:
...
*** STARTED Add FSM support to postgres                                :code:
...
*** STARTED Add trade envelope support                                 :code:
    :LOGBOOK:
