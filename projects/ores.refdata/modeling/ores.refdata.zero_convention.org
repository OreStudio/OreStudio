...
#+description: Codegen entity model for the refdata =zero_convention= table. Drives the C++ domain class, mapper, repository, service, generator, and SQL schema generation from a single literate source.
