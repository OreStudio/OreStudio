...
domain::scripted_instrument scripted_instrument_mapper::map(const scripted_instrument_entity& v) {
...
scripted_instrument_entity scripted_instrument_mapper::map(const domain::scripted_instrument& v) {
