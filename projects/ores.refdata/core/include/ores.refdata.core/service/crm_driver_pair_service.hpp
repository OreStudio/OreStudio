 ...
 */
#ifndef ORES_REFDATA_CORE_SERVICE_CRM_DRIVER_PAIR_SERVICE_HPP
#define ORES_REFDATA_CORE_SERVICE_CRM_DRIVER_PAIR_SERVICE_HPP
 ...
 */
class ORES_REFDATA_CORE_EXPORT crm_driver_pair_service {
private:
    inline static std::string_view logger_name = "ores.refdata.service.crm_driver_pair_service";
...
public:
     ...
     */
    /**@{*/
    messaging::list_crm_driver_pairs_response
    list_crm_driver_pairs(const messaging::list_crm_driver_pairs_request& request);
    messaging::get_crm_driver_pair_response
    get_crm_driver_pair(const messaging::get_crm_driver_pair_request& request);
    messaging::get_many_crm_driver_pairs_response
    get_many_crm_driver_pairs(const messaging::get_many_crm_driver_pairs_request& request);
    messaging::put_crm_driver_pair_response
    put_crm_driver_pair(const messaging::put_crm_driver_pair_request& request);
    messaging::put_many_crm_driver_pairs_response
    put_many_crm_driver_pairs(const messaging::put_many_crm_driver_pairs_request& request);
    messaging::delete_crm_driver_pair_response
    delete_crm_driver_pair(const messaging::delete_crm_driver_pair_request& request);
    messaging::delete_many_crm_driver_pairs_response
    delete_many_crm_driver_pairs(const messaging::delete_many_crm_driver_pairs_request& request);
    messaging::list_crm_driver_pair_versions_response
    list_crm_driver_pair_versions(const messaging::list_crm_driver_pair_versions_request& request);
    messaging::get_crm_driver_pair_version_response
    get_crm_driver_pair_version(const messaging::get_crm_driver_pair_version_request& request);
    /**@}*/
     ...
     */
    std::vector<domain::crm_driver_pair> get_crm_driver_pairs(const std::vector<std::string>& ids);
...
private:
     ...
     */
    ores::utility::domain::result prepare_change(const messaging::crm_driver_pair_change& change,
