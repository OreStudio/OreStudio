...
#+description: Codegen entity model for the refdata business_day_convention_type table. Drives the C++ domain class, mapper, repository, service, generator, and SQL schema generation from a single literate source.
