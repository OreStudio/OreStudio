 ...
 *
 */
#ifndef ORES_TRADING_GENERATOR_PAYMENT_FREQUENCY_TYPE_GENERATOR_HPP
#define ORES_TRADING_GENERATOR_PAYMENT_FREQUENCY_TYPE_GENERATOR_HPP
 ...
 */
ORES_TRADING_API_EXPORT domain::payment_frequency_type
