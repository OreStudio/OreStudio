...
7. /Build the project/ — required before services can start or the
...
8. /Provision the Barclays tenant via the shell/ — run the full
...
9. /Verify/ — bearings clean. Do not start services as part of this
