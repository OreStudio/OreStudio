...
#+TBLNAME: summary
#+CAPTION: Clock summary at [2024-07-07 Sun 10:16]
| <75>                                              |         |       |      |       |
| Headline                                          | Time    |       |      |     % |
|---------------------------------------------------+---------+-------+------+-------|
...
| Stories                                           | 45:50   |       |      | 100.0 |
| Active                                            |         | 45:50 |      | 100.0 |
| Sprint and product backlog refinement             |         |       | 1:18 |   2.8 |
| Create a basic git hub repository                 |         |       | 0:35 |   1.3 |
| Setup a discord channel for the project           |         |       | 0:14 |   0.5 |
| Setup vcpkg and cmake                             |         |       | 1:21 |   2.9 |
| Setup github actions                              |         |       | 1:21 |   2.9 |
| Create and upload a package                       |         |       | 3:28 |   7.6 |
| Create a basic project structure                  |         |       | 2:10 |   4.7 |
| Add a Qt hello world                              |         |       | 3:08 |   6.8 |
| Add a splash screen to applciation                |         |       | 0:41 |   1.5 |
| Add basic site                                    |         |       | 0:34 |   1.2 |
| Add modeling infrastructure                       |         |       | 1:30 |   3.3 |
| Fix code syntax highlighting in site              |         |       | 0:10 |   0.4 |
| Merge index with readme                           |         |       | 0:42 |   1.5 |
| Add project objective to readme                   |         |       | 2:24 |   5.2 |
| Add basic logging support                         |         |       | 1:14 |   2.7 |
| Add nightly support with memcheck                 |         |       | 3:21 |   7.3 |
| Clean up toolchains and presets                   |         |       | 1:53 |   4.1 |
| Generate Doxygen documentation and add it to site |         |       | 0:51 |   1.9 |
| Copy domain notes on core concepts                |         |       | 4:41 |  10.2 |
| Valgrind fails to run unit tests                  |         |       | 1:12 |   2.6 |
| Initial sanity test generated packages            |         |       | 0:25 |   0.9 |
| Add command line options support                  |         |       | 5:45 |  12.5 |
| Unit tests show up twice in nightlies             |         |       | 0:13 |   0.5 |
| Add recipes for command line                      |         |       | 0:51 |   1.9 |
| Pie charts considered harmful                     |         |       | 0:31 |   1.1 |
| Add XML parsing support for currency              |         |       | 3:18 |   7.2 |
| Create a containing structure for data            |         |       | 0:28 |   1.0 |
| Add basic widgets to display currencies           |         |       | 0:26 |   0.9 |
| Convert plantuml diagrams to org-babel            |         |       | 1:05 |   2.4 |
#+end:
...
pie(as.numeric(clean[,5]), labels = clean[,1], radius = 1, cex = 0.8)
#+end_src
...
*** STARTED Pie charts considered harmful                             :story:
    :LOGBOOK:
