...
- [[id:05661A18-616C-4C39-8A88-BFBB4C68FD2E][Codegen SQL Debt]] — cleared all ~*_create.sql~ hand-written files;
  this plan extends codegen coverage to the populate layer for IAM permissions
  and roles.
- [[id:DC79D8CE-FBEB-4FC9-9DB5-D39724F2DF86][Service RBAC Design]] — original design for per-service IAM role assignments;
