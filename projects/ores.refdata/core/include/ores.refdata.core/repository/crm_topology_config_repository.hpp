 ...
 */
#ifndef ORES_REFDATA_CORE_REPOSITORY_CRM_TOPOLOGY_CONFIG_REPOSITORY_HPP
#define ORES_REFDATA_CORE_REPOSITORY_CRM_TOPOLOGY_CONFIG_REPOSITORY_HPP
 ...
 */
class ORES_REFDATA_CORE_EXPORT crm_topology_config_repository {
private:
    inline static std::string_view logger_name =
        "ores.refdata.repository.crm_topology_config_repository";
...
public:
    ...
    /**
     * @brief Writes a CRM topology config, honouring the claim it states.
     *
    ...
    /**
     * @brief Writes a set of CRM topology configs, each honouring its own
    ...
    /**
     * @brief Reads latest CRM topology configs filtered by name.
     */
    std::vector<domain::crm_topology_config> read_latest_by_name(context ctx,
                                                                 const std::string& name);

    /**
     * @brief Reads the newest CRM topology configs filtered by name, current or not.
     *
     ...
     */
    std::vector<domain::crm_topology_config> read_any_by_name(context ctx, const std::string& name);
    ...
    /**
     * @brief Removes a CRM topology config, refusing a row that moved on.
     *
...
private:
     ...
     */
    domain::crm_topology_config apply_claim(context ctx,
                                            const domain::crm_topology_config& v,
                                            const ores::utility::domain::precondition& claim);
};
