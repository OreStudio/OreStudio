...
/**
 * @brief MDI window for displaying and managing subject areas.
 *
 * Provides a table view of subject areas with toolbar actions
 * for reload, add, edit, delete, and viewing history.
 */
class SubjectAreaMdiWindow final : public EntityListMdiWindow {
    Q_OBJECT
...
public:
    explicit SubjectAreaMdiWindow(ClientManager* clientManager,
                                  const QString& username,
                                  QWidget* parent = nullptr);
    ~SubjectAreaMdiWindow() override = default;

signals:
    void statusChanged(const QString& message);
    void errorOccurred(const QString& error_message);
    void showAreaDetails(const&);
    void addNewRequested();
    void Deleted(const QString& code);
    void showAreaHistory(const&);
...
protected:
    QString normalRefreshTooltip() const override {
        return tr("Refresh subject areas");
    }
