 ...
 *
 */
#ifndef ORES_SHELL_APP_COMMANDS_LIFECYCLE_EVENT_COMMANDS_HPP
#define ORES_SHELL_APP_COMMANDS_LIFECYCLE_EVENT_COMMANDS_HPP
...
public:
    ...
    /**
     * @brief Process the lifecycle event history request.
     *
