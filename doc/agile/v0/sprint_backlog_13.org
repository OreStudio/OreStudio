...
#+CAPTION: Clock summary at [2026-02-26 Thu 10:39], for Thursday, February 26, 2026.
|      | <75>         |        |     |
| Tags | Headline     | Time   |   % |
|------+--------------+--------+-----|
|      | *Total time* | *0:00* | 0.0 |
...
#+CAPTION: Clock summary at [2026-02-26 Thu 10:39]
|       | <75>                                                  |         |       |       |       |
| Tags  | Headline                                              | Time    |       |       |     % |
|-------+-------------------------------------------------------+---------+-------+-------+-------|
|       | *Total time*                                          | *46:16* |       |       | 100.0 |
|-------+-------------------------------------------------------+---------+-------+-------+-------|
|       | Stories                                               | 46:16   |       |       | 100.0 |
|       | Active                                                |         | 46:16 |       | 100.0 |
| agile | Sprint and product backlog refinement                 |         |       |  0:26 |   0.9 |
| infra | Generate release notes for previous sprint            |         |       |  1:16 |   2.7 |
| code  | Merge FSM into DQ                                     |         |       |  0:34 |   1.2 |
| code  | Make all details dialogs tabbed                       |         |       |  2:26 |   5.3 |
| code  | Provenance: Fix performed by and modified by stamping |         |       |  3:17 |   7.1 |
| code  | Add plotting of session data                          |         |       |  1:19 |   2.8 |
| code  | Add account-party management and login support        |         |       | 13:43 |  29.6 |
| code  | Add rounding type entity                              |         |       |  1:40 |   3.6 |
| code  | Polish business centre UI and data quality            |         |       |  0:58 |   2.1 |
| code  | Enhance currency taxonomy                             |         |       |  2:06 |   4.5 |
| code  | Books, portfolios and trades are not party specific   |         |       |  2:59 |   6.4 |
| code  | Minor improvements to connection browser              |         |       |  1:17 |   2.8 |
| code  | Rename currency asset classes                         |         |       |  1:05 |   2.3 |
| code  | Remove toolbars from detail dialogs                   |         |       |  5:57 |  12.9 |
| code  | Add portfolio explorer                                |         |       |  5:19 |  11.5 |
| code  | Add party level currency and country restrictions     |         |       |  0:46 |   1.7 |
| code  | Analyse ORE trade import mapping requirements         |         |       |  1:08 |   2.4 |
#+end:
