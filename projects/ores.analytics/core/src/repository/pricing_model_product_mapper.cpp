...
pricing_model_product_mapper::map(const pricing_model_product_entity& v) {
...
pricing_model_product_entity
pricing_model_product_mapper::map(const domain::pricing_model_product& v) {
    BOOST_LOG_SEV(lg(), trace) << "Mapping domain entity: " << v;

    pricing_model_product_entity r;
