...
private:
    inline static std::string_view logger_name = "ores.qt.overnight_index_convention_mdi_window";
...
public:
    explicit OvernightIndexConventionMdiWindow(ClientManager* clientManager,
