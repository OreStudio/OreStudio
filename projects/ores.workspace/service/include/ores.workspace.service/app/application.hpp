 ...
 *
 */
#ifndef ORES_WORKSPACE_SERVICE_APP_APPLICATION_HPP
#define ORES_WORKSPACE_SERVICE_APP_APPLICATION_HPP
...
/**
 * @brief Entry point for the ores.workspace.service service.
 */
class application final {
private:
    inline static std::string_view logger_name = "ores.workspace.service.app.application";
