...
#+CAPTION: Clock summary at [2025-11-02 Sun 20:35], for Sunday, November 02, 2025.
|      | <75>                  |        |      |      |       |
| Tags | Headline              | Time   |      |      |     % |
|------+-----------------------+--------+------+------+-------|
...
|      | Stories               | 4:15   |      |      | 100.0 |
|      | Active                |        | 4:15 |      | 100.0 |
| code | Improve code coverage |        |      | 4:15 | 100.0 |
#+end:

#+begin: clocktable :maxlevel 3 :scope subtree :tags t :indent nil :emphasize nil :scope file :narrow 75 :formula %
#+TBLNAME: sprint_summary
#+CAPTION: Clock summary at [2025-11-02 Sun 20:35]
|       | <75>                                                   |         |       |       |       |
| Tags  | Headline                                               | Time    |       |       |     % |
|-------+--------------------------------------------------------+---------+-------+-------+-------|
...
|       | Stories                                                | 56:42   |       |       | 100.0 |
|       | Active                                                 |         | 56:42 |       | 100.0 |
| agile | Sprint and product backlog refinement                  |         |       |  1:24 |   2.5 |
| code  | Add locking up logic                                   |         |       |  1:28 |   2.6 |
| code  | Build using dynamic libraries                          |         |       |  7:24 |  13.1 |
| code  | Enable qt gui                                          |         |       |  4:13 |   7.4 |
| code  | Add locking up logic                                   |         |       |  1:28 |   2.6 |
| code  | Build using dynamic libraries                          |         |       |  7:24 |  13.1 |
| code  | Implement logging according to correct boost.log usage |         |       |  8:02 |  14.2 |
| code  | Fix broken Linux and OSX tests                         |         |       |  0:10 |   0.3 |
| code  | Fix broken windows builds                              |         |       |  2:35 |   4.6 |
| code  | Investigate leaks from valgrind                        |         |       |  0:51 |   1.5 |
| code  | Consider adding a postgres database to CI              |         |       | 14:13 |  25.1 |
| code  | Fix misspell that causes build to break                |         |       |  0:12 |   0.4 |
| code  | Improve code coverage                                  |         |       |  4:15 |   7.5 |
| code  | Add support for feature flags                          |         |       |  1:25 |   2.5 |
...
*** Separate test database usage from application                      :code:
