 ...
 *
 */
#ifndef ORES_MARKETDATA_CORE_PRESENTATION_TENOR_ANCHOR_HISTORY_FIELD_MAPPER_HPP
#define ORES_MARKETDATA_CORE_PRESENTATION_TENOR_ANCHOR_HISTORY_FIELD_MAPPER_HPP
...
/**
 * @brief Renders a tenor_anchor to an ordered field list for
