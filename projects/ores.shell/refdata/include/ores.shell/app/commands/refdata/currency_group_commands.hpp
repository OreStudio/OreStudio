 ...
 */
#ifndef ORES_SHELL_APP_COMMANDS_CURRENCY_GROUP_COMMANDS_HPP
#define ORES_SHELL_APP_COMMANDS_CURRENCY_GROUP_COMMANDS_HPP
...
/**
 * @brief Every verb currency groups answer, as one command each.
 *
 ...
 */
class currency_group_commands {
private:
    inline static std::string_view logger_name =
        "ores.shell.app.commands.refdata.currency_group_commands";
...
public:
    /**
     * @brief Register the currency groups submenu.
     */
