...
| — | Still open: the core eventing tests have never executed, because they need the fleet and NATS is down. Two suites pass, one is empty, one cannot run. H01 to H03 and S02 are unexamined. | =ctest -R assets= |
