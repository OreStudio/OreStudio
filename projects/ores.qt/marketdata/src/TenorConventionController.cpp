...
constexpr std::string_view convention_event_name =
    eventing::domain::event_traits<marketdata::eventing::tenor_convention_changed_event>::name;
}
...
void TenorConventionController::onShowDetails(
...
void TenorConventionController::onShowHistory(
    const marketdata::domain::tenor_convention& convention) {
...
void TenorConventionController::onOpenVersion(
    const marketdata::domain::tenor_convention& convention, int versionNumber) {
