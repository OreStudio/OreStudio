...
#+CAPTION: Clock summary at [2026-01-11 Sun 02:34], for Sunday, January 11, 2026.
|      | <75>                    |        |      |      |       |
| Tags | Headline                | Time   |      |      |     % |
|------+-------------------------+--------+------+------+-------|
...
|      | Stories                 | 2:32   |      |      | 100.0 |
|      | Active                  |        | 2:32 |      | 100.0 |
| code | Change reasons UI fixes |        |      | 0:57 |  37.5 |
| code | Add UI for log viewing  |        |      | 1:35 |  62.5 |
#+end:

#+begin: clocktable :maxlevel 3 :scope subtree :tags t :indent nil :emphasize nil :scope file :narrow 75 :formula %
#+TBLNAME: sprint_summary
#+CAPTION: Clock summary at [2026-01-11 Sun 02:34]
|       | <75>                                         |         |       |       |       |
| Tags  | Headline                                     | Time    |       |       |     % |
|-------+----------------------------------------------+---------+-------+-------+-------|
...
| code  | Rerun SQL scripts from scratch               |         |       |  7:52 |  11.5 |
| code  | Run qt client and validate all new features  |         |       |  1:19 |   1.9 |
| code  | Refactor options and parser                  |         |       |  0:27 |   0.7 |
| code  | Check functionality in =ores.wt=             |         |       |  2:03 |   3.0 |
| code  | Rename =ores.shell= to =ores.comms.shell=    |         |       |  1:30 |   2.2 |
| code  | Review HTTP service                          |         |       |  7:24 |  10.8 |
| code  | Assorted fixes to currency dialog            |         |       |  4:19 |   6.3 |
| code  | Add support for offsets in pagination        |         |       |  1:46 |   2.6 |
| code  | Assorted fixes to feature flags dialog       |         |       |  2:52 |   4.2 |
| code  | Add country support                          |         |       |  6:31 |   9.5 |
| code  | Amend and delete reasons base infrastructure |         |       |  5:58 |   8.7 |
| code  | Change reasons UI fixes                      |         |       |  3:34 |   5.2 |
| code  | Assorted fixes to currencies dialog          |         |       |  7:52 |  11.5 |
| code  | Add UI for log viewing                       |         |       |  1:35 |   2.3 |
| code  | Assorted fixes to accounts dialog            |         |       |  1:10 |   1.7 |
| code  | Review comms analyser work                   |         |       |  0:27 |   0.7 |
| code  | Review telemetry work                        |         |       | 10:11 |  14.8 |
#+end:
