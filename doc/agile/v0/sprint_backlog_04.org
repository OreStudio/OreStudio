...
#+CAPTION: Clock summary at [2025-11-08 Sat 01:26], for Saturday, November 08, 2025.
|      | <75>                         |        |      |      |       |
| Tags | Headline                     | Time   |      |      |     % |
|------+------------------------------+--------+------+------+-------|
|      | *Total time*                 | *1:25* |      |      | 100.0 |
|------+------------------------------+--------+------+------+-------|
|      | Stories                      | 1:25   |      |      | 100.0 |
|      | Active                       |        | 1:25 |      | 100.0 |
| code | Use fluent icons             |        |      | 0:27 |  31.8 |
| code | Add currency editing support |        |      | 0:58 |  68.2 |
#+end:

#+begin: clocktable :maxlevel 3 :scope subtree :tags t :indent nil :emphasize nil :scope file :narrow 75 :formula %
#+TBLNAME: sprint_summary
#+CAPTION: Clock summary at [2025-11-08 Sat 01:26]
|       | <75>                                                   |        |      |      |       |
| Tags  | Headline                                               | Time   |      |      |     % |
|-------+--------------------------------------------------------+--------+------+------+-------|
|       | *Total time*                                           | *9:00* |      |      | 100.0 |
|-------+--------------------------------------------------------+--------+------+------+-------|
|       | Stories                                                | 9:00   |      |      | 100.0 |
|       | Active                                                 |        | 9:00 |      | 100.0 |
| agile | Sprint and product backlog refinement                  |        |      | 0:34 |   6.3 |
| code  | Clean up client parser                                 |        |      | 0:10 |   1.9 |
| code  | Add connect command line argument                      |        |      | 1:19 |  14.6 |
| infra | Install Windows package on Windows machine             |        |      | 2:09 |  23.9 |
| code  | Ignore warnings on windows and osx                     |        |      | 0:33 |   6.1 |
| code  | Ensure applications work under OSX using github images |        |      | 0:14 |   2.6 |
| infra | Create a splash screen and gray background             |        |      | 2:26 |  27.0 |
| code  | Use fluent icons                                       |        |      | 0:37 |   6.9 |
| code  | Add currency editing support                           |        |      | 0:58 |  10.7 |
#+end:
