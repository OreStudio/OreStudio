...
- [x] Add ~system.admin_reset~ to the system change reasons population
  script ([[proj:projects/ores.sql/populate/dq][~projects/ores.sql/populate/dq/~]]).  The reason should be
...
| File | Change |
|------+--------|
| [[proj:projects/ores.sql/populate/dq/dq_change_reasons_populate.sql][~projects/ores.sql/populate/dq/dq_change_reasons_populate.sql~]] | Add ~system.admin_reset~ reason |
| [[proj:projects/ores.sql/create/iam/iam_tenant_bootstrap_reset_create.sql][~projects/ores.sql/create/iam/iam_tenant_bootstrap_reset_create.sql~]] | SECURITY DEFINER + correct reason code |
| [[proj:projects/ores.sql/create/iam/iam_system_reset_create.sql][~projects/ores.sql/create/iam/iam_system_reset_create.sql~]] | SECURITY DEFINER + correct reason code |
