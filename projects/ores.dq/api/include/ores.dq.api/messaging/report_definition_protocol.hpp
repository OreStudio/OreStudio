 ...
 *
 */
#ifndef ORES_DQ_API_MESSAGING_REPORT_DEFINITION_PROTOCOL_HPP
#define ORES_DQ_API_MESSAGING_REPORT_DEFINITION_PROTOCOL_HPP
...
struct get_report_definitions_request {
    ...
    static constexpr std::string_view nats_subject = "dq.v1.report_definitions.list";
...
struct save_report_definition_request {
    ...
    static constexpr std::string_view nats_subject = "dq.v1.report_definitions.save";
    ores::dq::domain::report_definition data;

    static save_report_definition_request from(ores::dq::domain::report_definition v) {
...
struct get_report_definition_history_request {
    ...
    static constexpr std::string_view nats_subject = "dq.v1.report_definitions.history";
    std::string id;
};

struct get_report_definition_history_response {
    std::vector<ores::dq::domain::report_definition> history;
    bool success = false;
    std::string message;
};
