...
begin
    ...
    from (values
        ...
        ('ABD', 'Abyssal Abyss', 10051, 'S/', '¢', 100, 'standard', 2, 'S/#,##0.00', 'fiat.emerging', 'ab'),
        ('ADD', 'Adorian Aureus', 10052, '฿', 'ส', 100, 'standard', 2, '฿#,##0.00', 'fiat.emerging', 'ad'),
        ('AGA', 'Agrarian Agri', 10053, '$', '¢', 100, 'standard', 2, '$#,##0.00', 'fiat.emerging', 'ag'),
        ('AKA', 'Akorian Akka', 10054, '€', 'c', 100, 'standard', 2, '€#,##0.00', 'fiat.major', 'ak'),
        ('AMA', 'Amethian Amethyst', 10055, '£', 'p', 100, 'standard', 2, '£#,##0.00', 'fiat.major', 'am'),
        ('ANA', 'Andorian Andar', 10056, '¥', '', 0, 'standard', 0, '¥#,##0', 'fiat.emerging', 'an'),
        ('AOA', 'Aorlandian Aureole', 10057, 'kr', 'ø', 100, 'standard', 2, 'kr #,##0.00', 'fiat.major', 'ao'),
        ('APA', 'Apollonian Apex', 10058, 'zł', 'gr', 100, 'standard', 2, '#,##0.00 zł', 'fiat.emerging', 'ap'),
        ('ASA', 'Astralian Astra', 10059, '₹', 'p', 100, 'standard', 2, '₹#,##0.00', 'fiat.emerging', 'as'),
        ('ATA', 'Atlantian Atlante', 10060, 'د.إ', 'ف', 100, 'standard', 2, 'د.إ#,##0.00', 'fiat.emerging', 'at'),
        ('AVA', 'Avalonian Avalon', 10061, 'R', 'c', 100, 'standard', 2, 'R#,##0.00', 'fiat.emerging', 'av'),
        ('AZA', 'Azurian Azure', 10062, 'ƒ', '¢', 100, 'standard', 2, 'ƒ#,##0.00', 'fiat.emerging', 'az'),
        ('BIB', 'Birelian Bit', 10063, 'د.ك', 'ف', 1000, 'standard', 3, 'د.ك#,##0.000', 'fiat.emerging', 'bi'),
        ('BLB', 'Blightorian Blight', 10064, 'S/', '¢', 100, 'standard', 2, 'S/#,##0.00', 'fiat.emerging', 'bl'),
        ('BOB', 'Borandian Bora', 10065, '฿', 'ส', 100, 'standard', 2, '฿#,##0.00', 'fiat.emerging', 'bo'),
        ('BRB', 'Bravurian Bravo', 10066, '$', '¢', 100, 'standard', 2, '$#,##0.00', 'fiat.emerging', 'br'),
        ('BUB', 'Burandian Bur', 10067, '€', 'c', 100, 'standard', 2, '€#,##0.00', 'fiat.major', 'bu'),
        ('BYB', 'Byzantian Byzant', 10068, '£', 'p', 100, 'standard', 2, '£#,##0.00', 'fiat.major', 'by'),
        ('CEC', 'Celestian Celestial', 10069, '¥', '', 0, 'standard', 0, '¥#,##0', 'fiat.emerging', 'ce'),
        ('CHC', 'Chronian Chron', 10070, 'kr', 'ø', 100, 'standard', 2, 'kr #,##0.00', 'fiat.major', 'ch'),
        ('CIC', 'Ciridian Cirrus', 10071, 'zł', 'gr', 100, 'standard', 2, '#,##0.00 zł', 'fiat.emerging', 'ci'),
        ('CLC', 'Clarionian Clarion', 10072, '₹', 'p', 100, 'standard', 2, '₹#,##0.00', 'fiat.emerging', 'cl'),
        ('COC', 'Corvusian Corvus', 10073, 'د.إ', 'ف', 100, 'standard', 2, 'د.إ#,##0.00', 'fiat.emerging', 'co'),
        ('CRC', 'Crystalian Crystal', 10074, 'R', 'c', 100, 'standard', 2, 'R#,##0.00', 'fiat.emerging', 'cr'),
        ('CUC', 'Cumbrian Cumbr', 10075, 'ƒ', '¢', 100, 'standard', 2, 'ƒ#,##0.00', 'fiat.emerging', 'cu'),
        ('CYC', 'Cymerian Cymbal', 10076, 'د.ك', 'ف', 1000, 'standard', 3, 'د.ك#,##0.000', 'fiat.emerging', 'cy'),
        ('DID', 'Divinian Divine', 10077, 'S/', '¢', 100, 'standard', 2, 'S/#,##0.00', 'fiat.emerging', 'di'),
        ('DOD', 'Doravian Dora', 10078, '฿', 'ส', 100, 'standard', 2, '฿#,##0.00', 'fiat.emerging', 'do'),
        ('DRD', 'Drakonian Dragon', 10079, '$', '¢', 100, 'standard', 2, '$#,##0.00', 'fiat.emerging', 'dr'),
        ('DUD', 'Dulcorian Dulce', 10080, '€', 'c', 100, 'standard', 2, '€#,##0.00', 'fiat.major', 'du'),
        ('DYD', 'Dystopian Dyst', 10081, '£', 'p', 100, 'standard', 2, '£#,##0.00', 'fiat.major', 'dy'),
        ('EBE', 'Ebonian Ebony', 10082, '¥', '', 0, 'standard', 0, '¥#,##0', 'fiat.emerging', 'eb'),
        ('ECE', 'Echorian Echo', 10083, 'kr', 'ø', 100, 'standard', 2, 'kr #,##0.00', 'fiat.major', 'ec'),
        ('EDE', 'Edenian Eden', 10084, 'zł', 'gr', 100, 'standard', 2, '#,##0.00 zł', 'fiat.emerging', 'ed'),
        ('EFE', 'Effluvian Efflux', 10085, '₹', 'p', 100, 'standard', 2, '₹#,##0.00', 'fiat.emerging', 'ef'),
        ('EGE', 'Eglorian Eglantine', 10086, 'د.إ', 'ف', 100, 'standard', 2, 'د.إ#,##0.00', 'fiat.emerging', 'eg'),
        ('EIE', 'Eiridian Eir', 10087, 'R', 'c', 100, 'standard', 2, 'R#,##0.00', 'fiat.emerging', 'ei'),
        ('ELE', 'Eldorian Elder', 10088, 'ƒ', '¢', 100, 'standard', 2, 'ƒ#,##0.00', 'fiat.emerging', 'el'),
        ('EME', 'Emberian Ember', 10089, 'د.ك', 'ف', 1000, 'standard', 3, 'د.ك#,##0.000', 'fiat.emerging', 'em'),
        ('ENE', 'Enigman Enigma', 10090, 'S/', '¢', 100, 'standard', 2, 'S/#,##0.00', 'fiat.emerging', 'en'),
        ('EOE', 'Eolandian Eon', 10091, '฿', 'ส', 100, 'standard', 2, '฿#,##0.00', 'fiat.emerging', 'eo'),
        ('EPE', 'Ephemeran Eph', 10092, '$', '¢', 100, 'standard', 2, '$#,##0.00', 'fiat.emerging', 'ep'),
        ('EQE', 'Equatorian Equus', 10093, '€', 'c', 100, 'standard', 2, '€#,##0.00', 'fiat.major', 'eq'),
        ('ETE', 'Etherian Ether', 10094, '£', 'p', 100, 'standard', 2, '£#,##0.00', 'fiat.major', 'et'),
        ('EUE', 'Eudorian Eudox', 10095, '¥', '', 0, 'standard', 0, '¥#,##0', 'fiat.emerging', 'eu'),
        ('EVE', 'Everonian Ever', 10096, 'kr', 'ø', 100, 'standard', 2, 'kr #,##0.00', 'fiat.major', 'ev'),
        ('EXE', 'Exandian Exalt', 10097, 'zł', 'gr', 100, 'standard', 2, '#,##0.00 zł', 'fiat.emerging', 'ex'),
        ('EYE', 'Elysian Elyse', 10098, '₹', 'p', 100, 'standard', 2, '₹#,##0.00', 'fiat.emerging', 'ey'),
        ('EZE', 'Ezorian Eze', 10099, 'د.إ', 'ف', 100, 'standard', 2, 'د.إ#,##0.00', 'fiat.emerging', 'ez'),
        ('FAF', 'Faelandian Fae', 10100, 'R', 'c', 100, 'standard', 2, 'R#,##0.00', 'fiat.emerging', 'fa')
