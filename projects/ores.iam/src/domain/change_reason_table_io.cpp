...
#include <ostream>
#include "ores.iam/domain/change_reason_table.hpp"

namespace ores::iam::domain {

namespace {

void print_change_reason_table(std::ostream& s, const std::vector<change_reason>& v) {
