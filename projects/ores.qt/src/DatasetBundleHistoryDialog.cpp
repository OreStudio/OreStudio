...
void DatasetBundleHistoryDialog::setupConnections() {
    connect(ui_->versionListWidget, &QTableWidget::itemSelectionChanged,
            this, &DatasetBundleHistoryDialog::onVersionSelected);
...
void DatasetBundleHistoryDialog::loadHistory() {
    ...
    auto task = [self, id = id_]() -> HistoryResult {
        ...
        comms::messaging::frame request_frame(
            comms::messaging::message_type::get_dataset_bundle_history_request,
            0, std::move(payload)
        );
        ...
        auto response = dq::messaging::get_dataset_bundle_history_response::
