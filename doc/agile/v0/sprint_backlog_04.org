...
#+CAPTION: Clock summary at [2025-11-11 Tue 02:31], for Tuesday, November 11, 2025.
|      | <75>                                       |        |      |      |       |
| Tags | Headline                                   | Time   |      |      |     % |
|------+--------------------------------------------+--------+------+------+-------|
...
|      | Stories                                    | 2:31   |      |      | 100.0 |
|      | Active                                     |        | 2:31 |      | 100.0 |
| code | Create a skill for plant uml documentation |        |      | 2:31 | 100.0 |
#+end:

#+begin: clocktable :maxlevel 3 :scope subtree :tags t :indent nil :emphasize nil :scope file :narrow 75 :formula %
#+TBLNAME: sprint_summary
#+CAPTION: Clock summary at [2025-11-11 Tue 02:31]
|          | <75>                                                   |         |       |       |       |
| Tags     | Headline                                               | Time    |       |       |     % |
|----------+--------------------------------------------------------+---------+-------+-------+-------|
...
|          | Stories                                                | 42:31   |       |       | 100.0 |
|          | Active                                                 |         | 42:31 |       | 100.0 |
| agile    | Sprint and product backlog refinement                  |         |       |  2:00 |   4.7 |
| code     | Clean up client parser                                 |         |       |  0:10 |   0.4 |
| code     | Add connect command line argument                      |         |       |  1:19 |   3.1 |
| infra    | Install Windows package on Windows machine             |         |       |  2:09 |   5.1 |
| code     | Ignore warnings on windows and osx                     |         |       |  0:33 |   1.3 |
| code     | Ensure applications work under OSX using github images |         |       |  0:14 |   0.5 |
| infra    | Create a splash screen and gray background             |         |       |  2:26 |   5.7 |
| code     | Use fluent icons                                       |         |       |  0:37 |   1.5 |
| code     | Add export functionality for currencies                |         |       |  1:30 |   3.5 |
| code     | Add currency editing support                           |         |       |  2:45 |   6.5 |
| code     | Add about to menu                                      |         |       |  1:02 |   2.4 |
| code     | Create a history dialog for currencies                 |         |       |  1:27 |   3.4 |
| code     | Allow MDI windows outside main window                  |         |       |  1:35 |   3.7 |
| code     | Add edit menu and export menu                          |         |       |  0:34 |   1.3 |
| code     | Implement adding new currencies                        |         |       |  3:17 |   7.7 |
| code     | Clean up product website                               |         |       |  4:42 |  11.1 |
| code     | Create a skill for plant uml documentation             |         |       |  2:48 |   6.6 |
| code     | Make UI/UX look more professional                      |         |       | 11:07 |  26.1 |
| code     | Current issues with package install in debian          |         |       |  0:40 |   1.6 |
| code     | Resolve crash on shutdown problem                      |         |       |  0:50 |   2.0 |
| analysis | Weaving skills and documentation together              |         |       |  0:46 |   1.8 |
#+end:
