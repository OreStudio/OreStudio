...
| Now          | Unblocked ([[id:464B5EC6-0F5A-4B6F-B77E-02806CBEAE94][464B5EC6]] merged). All five entities migrated from lookup_entity to domain_entity org models, SQL-verified. |
| Waiting on   | Nothing.                               |
| Next         | Regenerate C++ for real, diff against the hand-written core/repository/service/handler/protocol, swap over, delete hand-written equivalents, build and test green. |
