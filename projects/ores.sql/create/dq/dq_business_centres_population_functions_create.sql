 ...
 *   SELECT * FROM metadata.dq_preview_business_centre_population_fn(dataset_id);
 *
 ...
 */
create or replace function metadata.dq_preview_business_centre_population_fn(p_dataset_id uuid)
returns table (
    action text,
    code text,
