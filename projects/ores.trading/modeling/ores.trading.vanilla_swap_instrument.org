...
#+description: Codegen entity model for the trading =vanilla_swap_instrument= table. Drives the C++ domain class, mapper, repository, service, generator, TypeScript UI metadata, and SQL schema generation from a single literate source.
...
| "settlement_lag" is null or "settlement_lag" >= 0 |
