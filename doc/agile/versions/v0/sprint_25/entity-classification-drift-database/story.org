...
|------+-------+-------+-----+-------------|
| [[id:6E463DC4-2E12-4564-91C1-55A28D1E1AD3][Bind ores.database entities to profiles; verify zero-diff regen]] | ABANDONED | | 2026-09-23 | Implement profile binding for the database-cpp catalogue entry, rebind every matching entity, regenerate, and confirm byte-identical output, following the compass-codegen-fix-drift skill. Known starting point: no model changes expected, smallest component (7 files). |
