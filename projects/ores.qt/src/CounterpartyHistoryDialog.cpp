...
void CounterpartyHistoryDialog::setupConnections() {
    connect(ui_->versionListWidget, &QTableWidget::itemSelectionChanged,
            this, &CounterpartyHistoryDialog::onVersionSelected);
    connect(openVersionAction_, &QAction::triggered,
            this, &CounterpartyHistoryDialog::onOpenVersionClicked);
    connect(revertAction_, &QAction::triggered,
            this, &CounterpartyHistoryDialog::onRevertClicked);
...
void CounterpartyHistoryDialog::loadHistory() {
    ...
    auto task = [self, id = id_]() -> HistoryResult {
        ...
        comms::messaging::frame request_frame(
            comms::messaging::message_type::get_counterparty_history_request,
            0, std::move(payload)
        );
        ...
        auto response = refdata::messaging::get_counterparty_history_response::
