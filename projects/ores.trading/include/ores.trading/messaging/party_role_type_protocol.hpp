 ...
 *
 */
#ifndef ORES_TRADING_MESSAGING_PARTY_ROLE_TYPE_PROTOCOL_HPP
#define ORES_TRADING_MESSAGING_PARTY_ROLE_TYPE_PROTOCOL_HPP
...
template<>
struct message_traits<trading::messaging::get_party_role_types_request> {
    using request_type = trading::messaging::get_party_role_types_request;
    using response_type = trading::messaging::get_party_role_types_response;
    static constexpr message_type request_message_type =
        message_type::get_party_role_types_request;
};

template<>
struct message_traits<trading::messaging::save_party_role_type_request> {
    using request_type = trading::messaging::save_party_role_type_request;
    using response_type = trading::messaging::save_party_role_type_response;
    static constexpr message_type request_message_type =
        message_type::save_party_role_type_request;
};

template<>
struct message_traits<trading::messaging::delete_party_role_type_request> {
    using request_type = trading::messaging::delete_party_role_type_request;
    using response_type = trading::messaging::delete_party_role_type_response;
    static constexpr message_type request_message_type =
        message_type::delete_party_role_type_request;
};

template<>
struct message_traits<trading::messaging::get_party_role_type_history_request> {
    using request_type = trading::messaging::get_party_role_type_history_request;
    using response_type = trading::messaging::get_party_role_type_history_response;
    static constexpr message_type request_message_type =
