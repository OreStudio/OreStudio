 ...
 *
 */
#ifndef ORES_REFDATA_CORE_PRESENTATION_CALENDAR_EVENT_HISTORY_FIELD_MAPPER_HPP
#define ORES_REFDATA_CORE_PRESENTATION_CALENDAR_EVENT_HISTORY_FIELD_MAPPER_HPP
...
/**
 * @brief Renders a calendar_event to an ordered field list for
