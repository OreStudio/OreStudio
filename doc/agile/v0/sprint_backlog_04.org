...
#+CAPTION: Clock summary at [2025-11-09 Sun 13:29], for Sunday, November 09, 2025.
|      | <75>                                          |        |      |      |       |
| Tags | Headline                                      | Time   |      |      |     % |
|------+-----------------------------------------------+--------+------+------+-------|
...
|      | Stories                                       | 5:07   |      |      | 100.0 |
|      | Active                                        |        | 5:07 |      | 100.0 |
| code | Add about to menu                             |        |      | 0:07 |   2.3 |
| code | Create a history dialog for currencies        |        |      | 1:27 |  28.3 |
| code | Allow MDI windows outside main window         |        |      | 1:35 |  30.9 |
| code | Add edit menu and export menu                 |        |      | 0:34 |  11.1 |
| code | Current issues with package install in debian |        |      | 0:26 |   8.5 |
| code | Implement adding new currencies               |        |      | 0:58 |  18.9 |
#+end:

#+begin: clocktable :maxlevel 3 :scope subtree :tags t :indent nil :emphasize nil :scope file :narrow 75 :formula %
#+TBLNAME: sprint_summary
#+CAPTION: Clock summary at [2025-11-09 Sun 13:29]
|       | <75>                                                   |         |       |       |       |
| Tags  | Headline                                               | Time    |       |       |     % |
|-------+--------------------------------------------------------+---------+-------+-------+-------|
|       | *Total time*                                           | *29:35* |       |       | 100.0 |
|-------+--------------------------------------------------------+---------+-------+-------+-------|
|       | Stories                                                | 29:35   |       |       | 100.0 |
|       | Active                                                 |         | 29:35 |       | 100.0 |
| agile | Sprint and product backlog refinement                  |         |       |  0:43 |   2.4 |
| code  | Clean up client parser                                 |         |       |  0:10 |   0.6 |
| code  | Add connect command line argument                      |         |       |  1:19 |   4.5 |
| infra | Install Windows package on Windows machine             |         |       |  2:09 |   7.3 |
| code  | Ignore warnings on windows and osx                     |         |       |  0:33 |   1.9 |
| code  | Ensure applications work under OSX using github images |         |       |  0:14 |   0.8 |
| infra | Create a splash screen and gray background             |         |       |  2:26 |   8.2 |
| code  | Use fluent icons                                       |         |       |  0:37 |   2.1 |
| code  | Add export functionality for currencies                |         |       |  1:30 |   5.1 |
| code  | Add currency editing support                           |         |       |  2:45 |   9.3 |
| code  | Add about to menu                                      |         |       |  1:02 |   3.5 |
| code  | Create a history dialog for currencies                 |         |       |  1:27 |   4.9 |
| code  | Allow MDI windows outside main window                  |         |       |  1:35 |   5.4 |
| code  | Add edit menu and export menu                          |         |       |  0:34 |   1.9 |
| code  | Make UI/UX look more professional                      |         |       | 11:07 |  37.6 |
| code  | Current issues with package install in debian          |         |       |  0:26 |   1.5 |
| code  | Implement adding new currencies                        |         |       |  0:58 |   3.3 |
#+end:
...
*** STARTED Implement adding new currencies                            :code:
    :LOGBOOK:
...
- UI goes black if you close and reopen.
...
- disabled menu options are not properly greyed out.
...
*** Listen for changes in currencies                                   :code:
