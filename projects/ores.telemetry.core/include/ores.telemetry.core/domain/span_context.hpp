 ...
 *
 */
#ifndef ORES_TELEMETRY_CORE_DOMAIN_SPAN_CONTEXT_HPP
#define ORES_TELEMETRY_CORE_DOMAIN_SPAN_CONTEXT_HPP
 ...
 */
struct ORES_TELEMETRY_CORE_EXPORT span_context final {
    /**
