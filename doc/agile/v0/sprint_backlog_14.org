...
#+CAPTION: Clock summary at [2026-03-14 Sat 23:22], for Saturday, March 14, 2026.
|      | <75>                   |        |      |      |       |
| Tags | Headline               | Time   |      |      |     % |
|------+------------------------+--------+------+------+-------|
...
|      | Stories                | 3:29   |      |      | 100.0 |
|      | Active                 |        | 3:29 |      | 100.0 |
| code | Implement NATS support |        |      | 3:29 | 100.0 |
#+end:

#+begin: clocktable :maxlevel 3 :scope subtree :tags t :indent nil :emphasize nil :scope file :narrow 75 :formula %
#+TBLNAME: sprint_summary
#+CAPTION: Clock summary at [2026-03-14 Sat 23:22]
|       | <75>                                                    |         |       |      |       |
| Tags  | Headline                                                | Time    |       |      |     % |
|-------+---------------------------------------------------------+---------+-------+------+-------|
...
|       | Stories                                                 | 59:30   |       |      | 100.0 |
|       | Active                                                  |         | 59:30 |      | 100.0 |
| agile | Sprint and product backlog refinement                   |         |       | 3:23 |   5.7 |
| code  | Add ORE Import Wizard                                   |         |       | 3:00 |   5.0 |
| code  | Add reporting component design document                 |         |       | 1:30 |   2.5 |
| code  | Add ores.reporting SQL schema                           |         |       | 1:20 |   2.2 |
| code  | Reporting: Add domain types, messaging and repository   |         |       | 1:50 |   3.1 |
| code  | Trading: Implement trade status state machine           |         |       | 0:59 |   1.7 |
| code  | Cli: Add domain sub-menu layer to CLI command syntax    |         |       | 1:35 |   2.7 |
| code  | Add pgmq queue management and messaging UI              |         |       | 0:34 |   1.0 |
| code  | Reporting UI: cron widget, and party codename plan      |         |       | 8:19 |  14.0 |
| code  | Add party codename and report scheduling UI             |         |       | 7:19 |  12.3 |
| code  | Replace pgmq + pg_cron with custom tables and scheduler |         |       | 2:54 |   4.9 |
| code  | Fix TOCTOU race in party codename generation trigger    |         |       | 1:10 |   2.0 |
| code  | Migrate JWT to ores.security with RS256 support         |         |       | 0:07 |   0.2 |
| code  | Implement NNG message broker                            |         |       | 8:55 |  15.0 |
| code  | Add build tool suffix to all CMake presets              |         |       | 2:10 |   3.6 |
| code  | Fix codename with sequence-based unique suffix          |         |       | 0:45 |   1.3 |
| code  | Hook up broker and comms service                        |         |       | 0:47 |   1.3 |
| code  | Add trade import mapping dialog to Qt UI                |         |       | 4:39 |   7.8 |
| code  | Implement NATS support                                  |         |       | 8:14 |  13.8 |
#+end:
