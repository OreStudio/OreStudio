 ...
 *
 */
#ifndef ORES_REFDATA_API_DOMAIN_CRM_ENABLED_DERIVED_PAIR_HPP
#define ORES_REFDATA_API_DOMAIN_CRM_ENABLED_DERIVED_PAIR_HPP
...
[[nodiscard]] constexpr std::string_view entity_type_of(const crm_enabled_derived_pair&) {
    return "ores.refdata.crm_enabled_derived_pair";
}
