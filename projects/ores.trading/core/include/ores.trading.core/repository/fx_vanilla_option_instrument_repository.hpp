 ...
 *
 */
#ifndef ORES_TRADING_CORE_REPOSITORY_FX_VANILLA_OPTION_INSTRUMENT_REPOSITORY_HPP
#define ORES_TRADING_CORE_REPOSITORY_FX_VANILLA_OPTION_INSTRUMENT_REPOSITORY_HPP
 ...
 */
class ORES_TRADING_CORE_EXPORT fx_vanilla_option_instrument_repository {
private:
...
public:
    ...
    /**
     * @brief Writes FX vanilla option instruments to database.
     */
    /**@{*/
    ...
    /**
     * @brief Reads latest FX vanilla option instruments, possibly filtered by primary key.
     */
    /**@{*/
     ...
     */
    std::vector<domain::fx_vanilla_option_instrument> read_all(context ctx,
                                                               const std::string& instrument_id);

    /**
     * @brief Reads a single FX vanilla option instrument as it stood at a specific
    ...
    /**
     * @brief Reads latest FX vanilla option instruments with pagination support.
     * @param ctx Repository context with database connection
     ...
     */
    std::uint32_t get_total_fx_vanilla_option_instrument_count(context ctx);

    /**
     * @brief Deletes a FX vanilla option instrument by closing its temporal validity.
     */
    void remove(context ctx, const std::string& instrument_id);

    /**
     * @brief Deletes FX vanilla option instruments by closing their temporal validity.
     */
