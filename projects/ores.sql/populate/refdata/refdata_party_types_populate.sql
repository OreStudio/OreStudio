...
values
    ...
    (ores_utility_system_tenant_id_fn(), 'Bank', 0, 'Bank',
    ...
    (ores_utility_system_tenant_id_fn(), 'CorporateGroup', 0, 'Corporate Group',
    ...
    (ores_utility_system_tenant_id_fn(), 'HedgeFund', 0, 'Hedge Fund',
    ...
    (ores_utility_system_tenant_id_fn(), 'Corporate', 0, 'Corporate',
    ...
    (ores_utility_system_tenant_id_fn(), 'CentralBank', 0, 'Central Bank',
    ...
    (ores_utility_system_tenant_id_fn(), 'Exchange', 0, 'Exchange',
    ...
    (ores_utility_system_tenant_id_fn(), 'Individual', 0, 'Individual',
