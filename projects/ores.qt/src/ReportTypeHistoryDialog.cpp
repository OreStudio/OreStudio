...
void ReportTypeHistoryDialog::setupConnections() {
    connect(ui_->versionListWidget, &QTableWidget::itemSelectionChanged,
            this, &ReportTypeHistoryDialog::onVersionSelected);
    connect(openVersionAction_, &QAction::triggered,
            this, &ReportTypeHistoryDialog::onOpenVersionClicked);
    connect(revertAction_, &QAction::triggered,
            this, &ReportTypeHistoryDialog::onRevertClicked);
...
void ReportTypeHistoryDialog::loadHistory() {
    ...
    auto task = [self, code = code_.toStdString()]() -> HistoryResult {
        ...
        comms::messaging::frame request_frame(
            comms::messaging::message_type::get_report_type_history_request,
            0, std::move(payload)
        );
        ...
        auto response = reporting::messaging::get_report_type_history_response::
