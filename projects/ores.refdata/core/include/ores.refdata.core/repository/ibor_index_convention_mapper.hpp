 ...
 *
 */
#ifndef ORES_REFDATA_CORE_REPOSITORY_IBOR_INDEX_CONVENTION_MAPPER_HPP
#define ORES_REFDATA_CORE_REPOSITORY_IBOR_INDEX_CONVENTION_MAPPER_HPP
 ...
 */
class ORES_REFDATA_CORE_EXPORT ibor_index_convention_mapper {
private:
