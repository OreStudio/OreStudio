 ...
 *
 */
#include "ores.trading.core/presentation/bond_issue_conversion_target_history_field_mapper.hpp"
...
render_bond_issue_conversion_target_fields(const domain::bond_issue_conversion_target& v) {
    ...
    fields.push_back({.name = "Underlying ID", .value = v.underlying_id});
    fields.push_back({.name = "Conversion Ratio", .value = std::to_string(v.conversion_ratio)});
