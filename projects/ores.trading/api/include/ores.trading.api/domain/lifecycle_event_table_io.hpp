 ...
 *
 */
#ifndef ORES_TRADING_API_DOMAIN_LIFECYCLE_EVENT_TABLE_IO_HPP
#define ORES_TRADING_API_DOMAIN_LIFECYCLE_EVENT_TABLE_IO_HPP
...
ORES_TRADING_API_EXPORT std::ostream& operator<<(std::ostream& s,
                                                 const std::vector<lifecycle_event>& v);
