 ...
 *
 */
#ifndef ORES_REFDATA_API_DOMAIN_CURRENCY_VERSION_HISTORY_TABLE_IO_HPP
#define ORES_REFDATA_API_DOMAIN_CURRENCY_VERSION_HISTORY_TABLE_IO_HPP
...
ORES_REFDATA_API_EXPORT std::ostream& operator<<(std::ostream& s,
                                                 const std::vector<currency_version_history>& v);
