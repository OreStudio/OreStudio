 ...
 */
/**
 * Where the party_status screens live and what they can do.
 *
 ...
 */
import { partyStatusMeta } from '../ui/party_status_ui.js';
import type { EntityDescriptor } from '../../../entity/descriptor.js';

export const partyStatusDescriptor: EntityDescriptor = {
    component: 'refdata',
    entity: 'party_status',
    meta: partyStatusMeta,
    routeSegment: 'party-status',
