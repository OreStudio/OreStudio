...
#include "ores.refdata.api/eventing/payment_frequency_event.hpp"
...
TEST_CASE("write_payment_frequency_publishes_an_event", tags) {
    ...
    using event_type = ores::refdata::messaging::payment_frequency_event;
    ...
    event_source.register_entity_event_mapping<event_type>("ores_refdata_payment_frequencies");
