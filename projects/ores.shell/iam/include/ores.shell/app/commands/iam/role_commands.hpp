 ...
 */
#ifndef ORES_SHELL_APP_COMMANDS_ROLE_COMMANDS_HPP
#define ORES_SHELL_APP_COMMANDS_ROLE_COMMANDS_HPP
...
/**
 * @brief Every verb roles answer, as one command each.
 *
...
class role_commands {
private:
    inline static std::string_view logger_name = "ores.shell.app.commands.iam.role_commands";
...
public:
    /**
     * @brief Register the roles submenu.
     */
