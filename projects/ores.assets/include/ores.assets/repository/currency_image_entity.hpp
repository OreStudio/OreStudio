 ...
 *
 */
#ifndef ORES_ASSETS_REPOSITORY_CURRENCY_IMAGE_ENTITY_HPP
#define ORES_ASSETS_REPOSITORY_CURRENCY_IMAGE_ENTITY_HPP
...
/**
 * @brief Represents a currency-image association in the database.
 *
...
std::ostream& operator<<(std::ostream& s, const currency_image_entity& v);
