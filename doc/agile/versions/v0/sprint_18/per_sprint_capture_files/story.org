...
- =compass capture --note "..."= scaffolds a new capture in [[proj:doc/agile/product_backlog/inbox][=doc/agile/product_backlog/inbox/=]] and prints the path.
...
- Four buckets exist under [[proj:doc/agile/product_backlog][=doc/agile/product_backlog/=]]: =inbox/=, =next/=, =deferred/=, and =discarded/=, each with an index doc.
