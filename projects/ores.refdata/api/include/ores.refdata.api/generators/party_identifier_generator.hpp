 ...
 *
 */
#ifndef ORES_REFDATA_CORE_GENERATORS_PARTY_IDENTIFIER_GENERATOR_HPP
#define ORES_REFDATA_CORE_GENERATORS_PARTY_IDENTIFIER_GENERATOR_HPP
 ...
 */
ORES_REFDATA_API_EXPORT domain::party_identifier
