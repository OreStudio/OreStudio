...
| Now           | Blocked. Not yet started.               |
| Waiting on    | [[id:560DB730-99F5-4C75-9415-9DC62BB0A6E8][Verify party Qt UI end-to-end post-NATS]] to land — party is the reference case for the target composite versioning model. |
| Next          | Once that PR lands, break this story into tasks and start the architecture doc. |
