 ...
 *
 */
#ifndef ORES_QT_CLIENT_BOOK_MODEL_HPP
#define ORES_QT_CLIENT_BOOK_MODEL_HPP
 ...
 */
class ClientBookModel final : public QAbstractTableModel {
    Q_OBJECT

private:
    inline static std::string_view logger_name =
        "ores.qt.client_book_model";
...
public:
    ...
    /**
     * @brief Get book at the specified row.
     *
...
private:
    ...
    using BookKeyExtractor = std::string(*)(const refdata::domain::book&);
    RecencyTracker<refdata::domain::book, BookKeyExtractor> recencyTracker_;
