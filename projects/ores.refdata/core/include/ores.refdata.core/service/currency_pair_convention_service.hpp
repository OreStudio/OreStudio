...
public:
     ...
     */
    /**@{*/
    messaging::list_currency_pair_conventions_response list_currency_pair_conventions(
        const messaging::list_currency_pair_conventions_request& request);
    messaging::get_currency_pair_convention_response
    get_currency_pair_convention(const messaging::get_currency_pair_convention_request& request);
    messaging::get_many_currency_pair_conventions_response get_many_currency_pair_conventions(
        const messaging::get_many_currency_pair_conventions_request& request);
    messaging::put_currency_pair_convention_response
    put_currency_pair_convention(const messaging::put_currency_pair_convention_request& request);
    messaging::put_many_currency_pair_conventions_response put_many_currency_pair_conventions(
        const messaging::put_many_currency_pair_conventions_request& request);
    messaging::delete_currency_pair_convention_response delete_currency_pair_convention(
        const messaging::delete_currency_pair_convention_request& request);
    messaging::delete_many_currency_pair_conventions_response delete_many_currency_pair_conventions(
    ...
    list_currency_pair_convention_versions(
        const messaging::list_currency_pair_convention_versions_request& request);
    messaging::get_currency_pair_convention_version_response get_currency_pair_convention_version(
    ...
    /**
     * @brief Retrieves a batch of currency pair conventions by primary key.
     */
    std::vector<domain::currency_pair_convention>
    get_conventions(const std::vector<std::string>& pair_codes);
...
private:
    ...
    prepare_change(const messaging::currency_pair_convention_change& change,
