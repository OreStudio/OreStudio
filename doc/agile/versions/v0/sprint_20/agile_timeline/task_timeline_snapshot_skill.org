...
Add a =compass timeline snapshot= command and an =compass-agile-add-timeline-snapshot=
...
- Created =doc/llm/skills/compass-agile-add-timeline-snapshot/SKILL.org= and deployed
