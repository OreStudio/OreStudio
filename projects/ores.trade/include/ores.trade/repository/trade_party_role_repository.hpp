 ...
 *
 */
#ifndef ORES_TRADE_REPOSITORY_TRADE_PARTY_ROLE_REPOSITORY_HPP
#define ORES_TRADE_REPOSITORY_TRADE_PARTY_ROLE_REPOSITORY_HPP
 ...
 */
class trade_party_role_repository {
private:
    inline static std::string_view logger_name =
        "ores.trade.repository.trade_party_role_repository";
