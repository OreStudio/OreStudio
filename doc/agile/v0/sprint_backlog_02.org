...
#+CAPTION: Clock summary at [2025-09-21 Sun 01:16]
|       | <75>                                         |         |       |      |       |
| Tags  | Headline                                     | Time    |       |      |     % |
|-------+----------------------------------------------+---------+-------+------+-------|
|       | *Total time*                                 | *30:23* |       |      | 100.0 |
|-------+----------------------------------------------+---------+-------+------+-------|
|       | Stories                                      | 30:23   |       |      | 100.0 |
|       | Active                                       |         | 30:23 |      | 100.0 |
| agile | Sprint and product backlog refinement        |         |       | 1:43 |   5.7 |
| infra | Fix broken builds                            |         |       | 0:36 |   2.0 |
| code  | Create a containing structure for data       |         |       | 0:35 |   1.9 |
| code  | Add temporal support to currencies           |         |       | 2:59 |   9.8 |
| code  | Add command to dump currencies               |         |       | 4:18 |  14.2 |
| code  | Refactor code for currencies                 |         |       | 3:52 |  12.7 |
| code  | Restore qt setup                             |         |       | 2:20 |   7.7 |
| code  | Add gemini action                            |         |       | 0:05 |   0.3 |
| code  | Remove ImGui support                         |         |       | 0:08 |   0.4 |
| code  | Create a GRPC based service                  |         |       | 2:09 |   7.1 |
| code  | Implement a 0MQ based RPC service and client |         |       | 3:55 |  12.9 |
...
| code  | Implement a cobalt based server and client   |         |       | 2:53 |   9.5 |
| code  | Use bitemporal support from Postgres 18      |         |       | 1:47 |   5.9 |
