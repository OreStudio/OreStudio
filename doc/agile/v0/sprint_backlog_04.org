...
#+CAPTION: Clock summary at [2025-11-15 Sat 23:57], for Saturday, November 15, 2025.
|       | <75>                                           |         |       |      |       |
| Tags  | Headline                                       | Time    |       |      |     % |
|-------+------------------------------------------------+---------+-------+------+-------|
...
|       | Stories                                        | 11:51   |       |      | 100.0 |
|       | Active                                         |         | 11:51 |      | 100.0 |
| agile | Sprint and product backlog refinement          |         |       | 0:52 |   7.3 |
| code  | Split JSON based =operator<<= from domain type |         |       | 0:53 |   7.5 |
| code  | Add a table representation of domain types     |         |       | 2:05 |  17.6 |
| code  | Add a comint based emacs mode for the client   |         |       | 0:24 |   3.4 |
| code  | Review all code created so far with an LLM     |         |       | 6:25 |  54.1 |
| code  | Fix broken windows build due to local time     |         |       | 0:24 |   3.4 |
| code  | Split main window class                        |         |       | 0:48 |   6.8 |
#+end:

#+begin: clocktable :maxlevel 3 :scope subtree :tags t :indent nil :emphasize nil :scope file :narrow 75 :formula %
#+TBLNAME: sprint_summary
#+CAPTION: Clock summary at [2025-11-15 Sat 23:58]
|          | <75>                                                   |         |       |       |       |
| Tags     | Headline                                               | Time    |       |       |     % |
|----------+--------------------------------------------------------+---------+-------+-------+-------|
...
|          | Stories                                                | 78:28   |       |       | 100.0 |
|          | Active                                                 |         | 78:28 |       | 100.0 |
| agile    | Sprint and product backlog refinement                  |         |       |  3:41 |   4.7 |
...
| code     | Add currency editing support                           |         |       |  2:45 |   3.5 |
...
| code     | Implement adding new currencies                        |         |       |  3:17 |   4.2 |
| code     | Clean up product website                               |         |       |  4:42 |   6.0 |
| code     | Create a skill for plant uml documentation             |         |       |  2:48 |   3.6 |
| infra    | Add CMake targets for site and skills                  |         |       |  0:17 |   0.4 |
| infra    | Generalise the skill setup for ORE Studio              |         |       |  3:45 |   4.8 |
| infra    | Restructure components to follow the dogen approach    |         |       |  2:54 |   3.7 |
...
| code     | Fix the valgrind leaks reported on sqlgen              |         |       |  4:54 |   6.2 |
| code     | Review all code created so far with an LLM             |         |       | 16:13 |  20.7 |
...
| code     | Make UI/UX look more professional                      |         |       | 11:07 |  14.2 |
