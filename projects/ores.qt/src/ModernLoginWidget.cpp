...
ModernLoginWidget::ModernLoginWidget(QWidget* parent)
    : QWidget(parent) {
    setupUI();
...
ModernLoginWidget::~ModernLoginWidget() = default;

QSize ModernLoginWidget::sizeHint() const {
    return {400, 520};
}

void ModernLoginWidget::keyPressEvent(QKeyEvent* event) {
...
void ModernLoginWidget::setSavedConnections(const QStringList& connectionNames) {
...
void ModernLoginWidget::setServer(const QString& server) {
    hostEdit_->setText(server);
}

void ModernLoginWidget::setPort(int port) {
    portSpinBox_->setValue(port);
}

void ModernLoginWidget::setUsername(const QString& username) {
    usernameEdit_->setText(username);
}

void ModernLoginWidget::setPassword(const QString& password) {
    passwordEdit_->setText(password);
}

void ModernLoginWidget::setClientManager(ClientManager* clientManager) {
    clientManager_ = clientManager;
}

QString ModernLoginWidget::getUsername() const {
...
void ModernLoginWidget::setupUI() {
...
void ModernLoginWidget::setupLeftPanel(QWidget*) {
    // No longer used - single panel design
}

void ModernLoginWidget::setupRightPanel(QWidget* parent) {
    ...
    connect(showPasswordCheck_, &QCheckBox::toggled,
            this, &ModernLoginWidget::onShowPasswordToggled);
    ...
    connect(loginButton_, &QPushButton::clicked,
            this, &ModernLoginWidget::onLoginClicked);
    ...
    connect(signUpButton_, &QPushButton::clicked,
            this, &ModernLoginWidget::onSignUpClicked);
...
void ModernLoginWidget::onLoginClicked() {
...
void ModernLoginWidget::onLoginResult(const LoginResult& result) {
...
void ModernLoginWidget::onSignUpClicked() {
    emit signUpRequested();
}

void ModernLoginWidget::onGetStartedClicked() {
    usernameEdit_->setFocus();
}

void ModernLoginWidget::onShowPasswordToggled(bool checked) {
