...
void PartyIdSchemeController::showHistoryWindow(const QString& code) {
    ...
    connect(historyDialog,
            &PartyIdSchemeHistoryDialog::statusChanged,
            this,
    ...
    connect(historyDialog,
            &PartyIdSchemeHistoryDialog::errorOccurred,
            this,
            [self = QPointer<PartyIdSchemeController>(this)](const QString& message) {
                if (!self)
                    return;
    ...
    connect(historyDialog,
            &PartyIdSchemeHistoryDialog::revertVersionRequested,
            this,
            &PartyIdSchemeController::onRevertVersion);
    connect(historyDialog,
            &PartyIdSchemeHistoryDialog::openVersionRequested,
            this,
            &PartyIdSchemeController::onOpenVersion);
