...
#+begin_src cpp :name generator
// "X-0" is the first code the synthetic currency generator emits: the
...
#+begin_src cpp :name generator
// "X-1" is the second code the synthetic currency generator emits,
...
#+begin_src cpp :name generator
// "CD-0" is the first code the synthetic classification generator
...
:nullable:      false
:error_message: Invalid base_currency: %. No active currency found with this code.
:END:
...
:target_column: iso_code
:nullable:      false
:error_message: Invalid quote_currency: %. No active currency found with this code.
:END:
