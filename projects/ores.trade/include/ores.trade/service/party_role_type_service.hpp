 ...
 *
 */
#ifndef ORES_TRADE_SERVICE_PARTY_ROLE_TYPE_SERVICE_HPP
#define ORES_TRADE_SERVICE_PARTY_ROLE_TYPE_SERVICE_HPP
...
#include "ores.trade/repository/party_role_type_repository.hpp"
...
private:
    inline static std::string_view logger_name =
        "ores.trade.service.party_role_type_service";
