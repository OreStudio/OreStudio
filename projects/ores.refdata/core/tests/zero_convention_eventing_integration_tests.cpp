...
TEST_CASE("write_zero_convention_publishes_an_event", tags) {
    ...
    using event_type = ores::refdata::messaging::zero_convention_event;
    ...
    event_source.register_entity_event_mapping<event_type>("ores_refdata_zero_conventions");
