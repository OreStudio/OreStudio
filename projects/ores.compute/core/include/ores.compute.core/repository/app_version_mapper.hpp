 ...
 *
 */
#ifndef ORES_COMPUTE_CORE_REPOSITORY_APP_VERSION_MAPPER_HPP
#define ORES_COMPUTE_CORE_REPOSITORY_APP_VERSION_MAPPER_HPP
 ...
 */
class ORES_COMPUTE_CORE_EXPORT app_version_mapper {
private:
