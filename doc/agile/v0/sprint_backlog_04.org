...
#+CAPTION: Clock summary at [2025-11-10 Mon 10:32], for Monday, November 10, 2025.
|          | <75>                                      |        |      |      |       |
| Tags     | Headline                                  | Time   |      |      |     % |
|----------+-------------------------------------------+--------+------+------+-------|
|          | *Total time*                              | *1:28* |      |      | 100.0 |
|----------+-------------------------------------------+--------+------+------+-------|
|          | Stories                                   | 1:28   |      |      | 100.0 |
|          | Active                                    |        | 1:28 |      | 100.0 |
| agile    | Sprint and product backlog refinement     |        |      | 0:42 |  47.7 |
| analysis | Weaving skills and documentation together |        |      | 0:46 |  52.3 |
#+end:

#+begin: clocktable :maxlevel 3 :scope subtree :tags t :indent nil :emphasize nil :scope file :narrow 75 :formula %
#+TBLNAME: sprint_summary
#+CAPTION: Clock summary at [2025-11-10 Mon 10:32]
|          | <75>                                                   |         |       |       |       |
| Tags     | Headline                                               | Time    |       |       |     % |
|----------+--------------------------------------------------------+---------+-------+-------+-------|
|          | *Total time*                                           | *35:01* |       |       | 100.0 |
|----------+--------------------------------------------------------+---------+-------+-------+-------|
|          | Stories                                                | 35:01   |       |       | 100.0 |
|          | Active                                                 |         | 35:01 |       | 100.0 |
| agile    | Sprint and product backlog refinement                  |         |       |  2:00 |   5.7 |
| code     | Clean up client parser                                 |         |       |  0:10 |   0.5 |
| code     | Add connect command line argument                      |         |       |  1:19 |   3.8 |
| infra    | Install Windows package on Windows machine             |         |       |  2:09 |   6.1 |
| code     | Ignore warnings on windows and osx                     |         |       |  0:33 |   1.6 |
| code     | Ensure applications work under OSX using github images |         |       |  0:14 |   0.7 |
| infra    | Create a splash screen and gray background             |         |       |  2:26 |   6.9 |
| code     | Use fluent icons                                       |         |       |  0:37 |   1.8 |
| code     | Add export functionality for currencies                |         |       |  1:30 |   4.3 |
| code     | Add currency editing support                           |         |       |  2:45 |   7.9 |
| code     | Add about to menu                                      |         |       |  1:02 |   3.0 |
| code     | Create a history dialog for currencies                 |         |       |  1:27 |   4.1 |
| code     | Allow MDI windows outside main window                  |         |       |  1:35 |   4.5 |
| code     | Add edit menu and export menu                          |         |       |  0:34 |   1.6 |
| code     | Implement adding new currencies                        |         |       |  3:17 |   9.4 |
| code     | Make UI/UX look more professional                      |         |       | 11:07 |  31.7 |
| code     | Current issues with package install in debian          |         |       |  0:40 |   1.9 |
| code     | Resolve crash on shutdown problem                      |         |       |  0:50 |   2.4 |
| analysis | Weaving skills and documentation together              |         |       |  0:46 |   2.2 |
#+end:
