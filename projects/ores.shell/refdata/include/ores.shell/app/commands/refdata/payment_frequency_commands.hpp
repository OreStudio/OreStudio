 ...
 */
#ifndef ORES_SHELL_APP_COMMANDS_PAYMENT_FREQUENCY_COMMANDS_HPP
#define ORES_SHELL_APP_COMMANDS_PAYMENT_FREQUENCY_COMMANDS_HPP
...
/**
 * @brief Every verb payment frequencies answer, as one command each.
 *
 ...
 */
class payment_frequency_commands {
private:
    inline static std::string_view logger_name =
        "ores.shell.app.commands.refdata.payment_frequency_commands";
...
public:
    /**
     * @brief Register the payment frequencies submenu.
     */
    ...
    /**
     * @brief add <code> <name> <description> <period_unit> <period_multiplier> <display_order>
     * <reason> <commentary>
     */
    ...
    /**
     * @brief set <code> <name> <description> <period_unit> <period_multiplier> <display_order>
    ...
    /**
     * @brief put-many --count <n> <code> <name> <description> <period_unit> <period_multiplier>
