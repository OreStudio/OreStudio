...
#+TBLNAME: summary
#+CAPTION: Clock summary at [2024-07-06 Sat 13:12]
| <75>                                              |         |       |      |       |
| Headline                                          | Time    |       |      |     % |
|---------------------------------------------------+---------+-------+------+-------|
| *Total time*                                      | *40:40* |       |      | 100.0 |
|---------------------------------------------------+---------+-------+------+-------|
| Stories                                           | 40:40   |       |      | 100.0 |
| Active                                            |         | 40:40 |      | 100.0 |
...
| Create and upload a package                       |         |       | 3:28 |   8.5 |
| Create a basic project structure                  |         |       | 2:10 |   5.3 |
| Add a Qt hello world                              |         |       | 3:08 |   7.7 |
...
| Add project objective to readme                   |         |       | 2:24 |   5.9 |
...
| Copy domain notes on core concepts                |         |       | 4:30 |  11.1 |
