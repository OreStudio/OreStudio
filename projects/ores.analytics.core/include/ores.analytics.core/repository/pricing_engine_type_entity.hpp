...
/**
 * @brief Represents a pricing engine type in the database.
 */
struct pricing_engine_type_entity {
    constexpr static const char* schema = "public";
    constexpr static const char* tablename = "ores_analytics_pricing_engine_types_tbl";
...
std::ostream& operator<<(std::ostream& s, const pricing_engine_type_entity& v);
