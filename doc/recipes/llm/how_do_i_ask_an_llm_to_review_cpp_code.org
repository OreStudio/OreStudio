...
- [[id:F663DF66-4F62-0884-DB23-BB2D6A42B644][Skills]] — if using Claude Code, the code-add-tests and
  code-add-domain-type skills encode the project's coding conventions.
