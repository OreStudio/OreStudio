 ...
 */
#ifndef ORES_QT_CURRENCY_PAIR_MDI_WINDOW_HPP
#define ORES_QT_CURRENCY_PAIR_MDI_WINDOW_HPP
...
/**
 * @brief MDI window for displaying and managing currency pairs.
 *
 * Provides a table view of currency pairs with toolbar actions
 * for reload, add, edit, delete, and viewing history.
 */
class CurrencyPairMdiWindow final : public EntityListMdiWindow {
    Q_OBJECT

private:
    inline static std::string_view logger_name = "ores.qt.currency_pair_mdi_window";
...
signals:
    ...
    void showPairDetails(const refdata::domain::currency_pair& pair);
...
protected:
    QString normalRefreshTooltip() const override {
        return tr("Refresh currency pairs");
    }
...
private:
    ...
    ClientCurrencyPairModel* model_;
