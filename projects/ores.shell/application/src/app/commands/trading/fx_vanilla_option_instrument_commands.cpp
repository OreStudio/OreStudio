...
void fx_vanilla_option_instrument_commands::register_commands(cli::Menu& root_menu,
    ...
    fx_vanilla_option_instruments_menu->Insert(
        ...
        [&session](std::ostream& out,
            ...
            process_add_fx_vanilla_option_instrument(std::ref(out),
                                                     std::ref(session),
                                                     ...
                                                     std::move(exercise_style),
                                                     std::move(settlement),
                                                     std::move(description),
                                                     std::move(change_reason_code),
                                                     std::move(change_commentary));
        },
        "Add an FX vanilla option instrument (trade_type_code bought_currency bought_amount "
        "sold_currency sold_amount option_type expiry_date exercise_style [settlement] "
        ...
        {"trade_type_code bought_currency bought_amount sold_currency sold_amount option_type "
         "expiry_date exercise_style settlement description change_reason_code change_commentary"});
...
void fx_vanilla_option_instrument_commands::process_get_fx_vanilla_option_instruments(
    ...
    BOOST_LOG_SEV(lg(), debug) << "Initiating get FX vanilla option instruments request.";
...
void fx_vanilla_option_instrument_commands::process_add_fx_vanilla_option_instrument(
    ...
    if (!session.is_logged_in()) {
        fail(out) << "You must be logged in to add an FX vanilla option instrument." << std::endl;
        return;
    }
    ...
    v.exercise_style = std::move(exercise_style);
