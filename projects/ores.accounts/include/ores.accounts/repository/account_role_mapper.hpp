 ...
 *
 */
#ifndef ORES_ACCOUNTS_REPOSITORY_ACCOUNT_ROLE_MAPPER_HPP
#define ORES_ACCOUNTS_REPOSITORY_ACCOUNT_ROLE_MAPPER_HPP
...
/**
 * @brief Maps account_role domain entities to data storage layer and vice-versa.
 */
class account_role_mapper {
private:
    inline static std::string_view logger_name =
        "ores.accounts.repository.account_role_mapper";
