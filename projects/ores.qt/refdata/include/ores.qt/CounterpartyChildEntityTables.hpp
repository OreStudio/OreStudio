 ...
 *
 */
#ifndef ORES_QT_COUNTERPARTY_CHILD_ENTITY_TABLES_HPP
#define ORES_QT_COUNTERPARTY_CHILD_ENTITY_TABLES_HPP
...
public:
    explicit CounterpartyChildEntityTables(QWidget* dialogParent);
