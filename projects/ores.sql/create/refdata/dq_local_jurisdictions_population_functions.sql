 ...
 *   SELECT * FROM ores_dq_preview_local_jurisdiction_population(dataset_id);
 *
 *   -- Publish to production
 *   SELECT * FROM ores_dq_populate_local_jurisdictions(dataset_id, 'upsert');
 */
 ...
 */
create or replace function ores_dq_preview_local_jurisdiction_population(p_dataset_id uuid)
returns table (
    action text,
    code text,
...
/**
 * Populate ores_refdata_local_jurisdictions_tbl from a DQ local_jurisdictions dataset.
 *
 * @param p_dataset_id  The DQ dataset to populate from.
 * @param p_mode        Population mode: 'upsert', 'insert_only', or 'replace_all'.
 */
create or replace function ores_dq_populate_local_jurisdictions(
    p_dataset_id uuid,
