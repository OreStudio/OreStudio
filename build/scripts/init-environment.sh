...
# ---------------------------------------------------------------------------
# .env format version — increment when any variable consumed by recreate_database.sh
# or setup_database.sh is added, removed, or renamed.  Add a changelog entry
# below (in validate_env_version.sh) at the same time.
#
# Changelog:
...
ORES_DB_COMPUTE_WRAPPER_USER="ores_${LABEL_LOWER}_compute_wrapper_user"
...
# ---------------------------------------------------------------------------
{
    ...
    echo "# ---------------------------------------------------------------------------"
    echo "ORES_DB_COMPUTE_WRAPPER_USER=${ORES_DB_COMPUTE_WRAPPER_USER}"
    echo ""
    echo "# ---------------------------------------------------------------------------"
