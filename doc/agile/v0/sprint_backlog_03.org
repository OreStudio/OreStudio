...
#+CAPTION: Clock summary at [2025-11-05 Wed 23:45], for Wednesday, November 05, 2025.
|       | <75>                                          |        |      |      |       |
| Tags  | Headline                                      | Time   |      |      |     % |
|-------+-----------------------------------------------+--------+------+------+-------|
|       | *Total time*                                  | *6:55* |      |      | 100.0 |
|-------+-----------------------------------------------+--------+------+------+-------|
|       | Stories                                       | 6:55   |      |      | 100.0 |
|       | Active                                        |        | 6:55 |      | 100.0 |
| agile | Sprint and product backlog refinement         |        |      | 0:06 |   1.4 |
| infra | vcpkg cannot apply patch on windowws          |        |      | 0:07 |   1.7 |
| code  | Update prodigy to use tags                    |        |      | 0:26 |   6.3 |
| code  | Resolve all of the OpenSSL leaks in valgrind  |        |      | 0:15 |   3.6 |
| code  | Separate test database usage from application |        |      | 1:20 |  19.3 |
| code  | Split test code from utility                  |        |      | 4:41 |  67.7 |
#+end:

#+begin: clocktable :maxlevel 3 :scope subtree :tags t :indent nil :emphasize nil :scope file :narrow 75 :formula %
#+TBLNAME: sprint_summary
#+CAPTION: Clock summary at [2025-11-05 Wed 23:45]
|       | <75>                                                   |         |       |       |       |
| Tags  | Headline                                               | Time    |       |       |     % |
|-------+--------------------------------------------------------+---------+-------+-------+-------|
|       | *Total time*                                           | *71:03* |       |       | 100.0 |
|-------+--------------------------------------------------------+---------+-------+-------+-------|
|       | Stories                                                | 71:03   |       |       | 100.0 |
|       | Active                                                 |         | 71:03 |       | 100.0 |
