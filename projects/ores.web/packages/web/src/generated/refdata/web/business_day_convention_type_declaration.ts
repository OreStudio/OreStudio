 ...
 */
/**
 * Where the business_day_convention_type screens live and what they can do.
 *
 ...
 */
import { businessDayConventionTypeMeta } from '../ui/business_day_convention_type_ui.js';
import type { EntityDescriptor } from '../../../entity/descriptor.js';

export const businessDayConventionTypeDescriptor: EntityDescriptor = {
    component: 'refdata',
    entity: 'business_day_convention_type',
    meta: businessDayConventionTypeMeta,
    routeSegment: 'business-day-convention-type',
    apiBase: '/api/types',
    keyFields: [
        'code',
    ],
