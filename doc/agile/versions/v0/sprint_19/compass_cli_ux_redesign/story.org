...
- All compass references in [[proj:doc/recipes][=doc/recipes/=]], [[proj:doc/llm/skills][=doc/llm/skills/=]], and
  [[proj:doc/llm/runbooks][=doc/llm/runbooks/=]] are consistent with the new taxonomy and description.
