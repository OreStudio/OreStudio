...
commodity_instrument_mapper::map(const commodity_instrument_entity& v) {
    ...
    r.fixed_price = v.fixed_price.value_or(0.0);
    ...
    r.spread_amount = v.spread_amount.value_or(0.0);
...
commodity_instrument_mapper::map(const domain::commodity_instrument& v) {
    ...
    r.fixed_price = v.fixed_price == 0.0 ? std::nullopt : std::optional(v.fixed_price);
    ...
    r.spread_amount = v.spread_amount == 0.0 ? std::nullopt : std::optional(v.spread_amount);
