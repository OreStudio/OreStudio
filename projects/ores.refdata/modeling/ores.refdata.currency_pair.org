...
:parent_entity:   currency
:seed_value:      EUR
:skip_check:      true
:nullable:        false
:error_message:   Invalid base_currency: %. No active currency found with this iso code.
:END:
...
:skip_check:      true
:nullable:        false
:error_message:   Invalid quote_currency: %. No active currency found with this iso code.
:END:

** classification
:PROPERTIES:
:table:           ores_refdata_currency_pair_classifications_tbl
:target_column:   code
:parent_entity:   currency_pair_classification
:seed_value:      major
:skip_check:      true
:nullable:        false
:error_message:   Invalid classification: %. No active currency pair classification found with this code.
:END:
