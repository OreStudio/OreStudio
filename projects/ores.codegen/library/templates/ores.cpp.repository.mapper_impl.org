...
{{/is_required_inet}}
{{#is_base64}}
    r.{{{group_prefix}}}{{name}} = utility::converter::base64_converter::convert(v.{{name}});
{{/is_base64}}
{{^render_is_enum}}
{{#is_nullable_string}}
...
{{/is_required_inet}}
{{#is_base64}}
    r.{{name}} = utility::converter::base64_converter::convert(v.{{{group_prefix}}}{{name}});
{{/is_base64}}
{{^render_is_enum}}
{{#is_nullable_string}}
{{#render_is_optional_string}}
...
{{/is_date}}
{{#is_base64}}
    r.{{name}} = utility::converter::base64_converter::convert(v.{{name}});
{{/is_base64}}
