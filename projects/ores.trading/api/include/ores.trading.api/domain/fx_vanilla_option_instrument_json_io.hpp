 ...
 *
 */
#ifndef ORES_TRADING_API_DOMAIN_FX_VANILLA_OPTION_INSTRUMENT_JSON_IO_HPP
#define ORES_TRADING_API_DOMAIN_FX_VANILLA_OPTION_INSTRUMENT_JSON_IO_HPP
...
ORES_TRADING_API_EXPORT std::ostream& operator<<(std::ostream& s,
                                                 const fx_vanilla_option_instrument& v);
