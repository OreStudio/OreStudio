 ...
 *
 */
#ifndef ORES_TRADING_SERVICE_APP_APPLICATION_HPP
#define ORES_TRADING_SERVICE_APP_APPLICATION_HPP
...
/**
 * @brief Entry point for the ores.trading.service service.
 */
class application final {
private:
    inline static std::string_view logger_name = "ores.trading.service.app.application";
