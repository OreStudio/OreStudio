...
accepted as payment/ \marginpar{Money} for goods and services /and repayment of
debts/, such as taxes, in /a particular country/ or /socio-economic context/.
#+end_quote
...
permeates this entire text. We will attempt to make the kernel more explicit at
the rear end of this part's domain survey.
...
much less rigorous way, we'll try our best to avoid it.
...
analysing the /kinds/ of money in existence, which we shall do later on in this
part.
