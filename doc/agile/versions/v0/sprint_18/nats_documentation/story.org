...
- [ ] [[proj:doc/knowledge/external/nats.org][=doc/knowledge/external/nats.org=]] exists, describes NATS as a
...
- [ ] [[proj:doc/knowledge/external/external.org][=doc/knowledge/external/external.org=]] has a new "Messaging
