...
#include "ores.refdata.api/eventing/ledger_feed_type_event.hpp"
...
TEST_CASE("write_ledger_feed_type_publishes_an_event", tags) {
    ...
    using event_type = ores::refdata::messaging::ledger_feed_type_event;
    ...
    event_source.register_entity_event_mapping<event_type>("ores_refdata_ledger_feed_types");
