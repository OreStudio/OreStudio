...
/**
 * @brief Represents a composite leg in the database.
 */
struct composite_leg_entity {
    constexpr static const char* schema = "public";
    constexpr static const char* tablename = "ores_trading_composite_legs_tbl";
...
std::ostream& operator<<(std::ostream& s, const composite_leg_entity& v);
