...
#+CAPTION: Clock summary at [2025-11-02 Sun 10:42], for Sunday, November 02, 2025.
|      | <75>                  |        |      |      |       |
| Tags | Headline              | Time   |      |      |     % |
|------+-----------------------+--------+------+------+-------|
...
|      | Stories               | 1:22   |      |      | 100.0 |
|      | Active                |        | 1:22 |      | 100.0 |
| code | Improve code coverage |        |      | 1:22 | 100.0 |
#+end:

#+begin: clocktable :maxlevel 3 :scope subtree :tags t :indent nil :emphasize nil :scope file :narrow 75 :formula %
#+TBLNAME: sprint_summary
#+CAPTION: Clock summary at [2025-11-02 Sun 10:42]
|       | <75>                                                   |         |       |       |       |
| Tags  | Headline                                               | Time    |       |       |     % |
|-------+--------------------------------------------------------+---------+-------+-------+-------|
...
|       | Stories                                                | 53:49   |       |       | 100.0 |
|       | Active                                                 |         | 53:49 |       | 100.0 |
| agile | Sprint and product backlog refinement                  |         |       |  1:24 |   2.6 |
| code  | Add locking up logic                                   |         |       |  1:28 |   2.7 |
| code  | Build using dynamic libraries                          |         |       |  7:24 |  13.8 |
| code  | Enable qt gui                                          |         |       |  4:13 |   7.8 |
| code  | Add locking up logic                                   |         |       |  1:28 |   2.7 |
| code  | Build using dynamic libraries                          |         |       |  7:24 |  13.8 |
| code  | Implement logging according to correct boost.log usage |         |       |  8:02 |  14.9 |
| code  | Fix broken Linux and OSX tests                         |         |       |  0:10 |   0.3 |
| code  | Fix broken windows builds                              |         |       |  2:35 |   4.8 |
| code  | Investigate leaks from valgrind                        |         |       |  0:51 |   1.6 |
| code  | Consider adding a postgres database to CI              |         |       | 14:13 |  26.4 |
...
| code  | Improve code coverage                                  |         |       |  1:22 |   2.5 |
