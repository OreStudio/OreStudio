...
#+CAPTION: Clock summary at [2024-06-22 Sat 22:44]
| <75>                                    |        |      |      |       |
| Headline                                | Time   |      |      |     % |
|-----------------------------------------+--------+------+------+-------|
...
| Stories                                 | 8:50   |      |      | 100.0 |
| Active                                  |        | 8:50 |      | 100.0 |
| Create a basic git hub repository       |        |      | 0:35 |   6.6 |
| Sprint and product backlog refinement   |        |      | 0:05 |   0.9 |
| Setup a discord channel for the project |        |      | 0:14 |   2.6 |
| Setup vcpkg and cmake                   |        |      | 1:21 |  15.3 |
| Setup github actions                    |        |      | 1:21 |  15.3 |
| Create and upload a package             |        |      | 3:04 |  34.7 |
| Create a basic project structure        |        |      | 2:10 |  24.5 |
#+end:
