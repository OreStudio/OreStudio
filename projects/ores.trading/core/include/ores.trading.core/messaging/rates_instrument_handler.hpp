...
inline auto& rates_instrument_handler_lg() {
    static auto instance =
        ores::logging::make_logger("ores.trading.messaging.rates_instrument_handler");
    return instance;
}
} // namespace
    ...
    void list_fra(ores::nats::message msg) {
        ...
        try {
            if (auto req = decode<get_fra_instruments_request>(msg)) {
                resp.instruments = svc.list_fra_instruments(static_cast<std::uint32_t>(req->offset),
    ...
    void save_fra(ores::nats::message msg) {
        ...
        if (auto req = decode<save_fra_instrument_request>(msg)) {
            try {
                ...
                reply(nats_,
                      msg,
                      save_fra_instrument_response{.success = false, .message = e.what()});
            }
        }
    }
    ...
    void history_fra(ores::nats::message msg) {
        ...
        if (auto req = decode<get_fra_instrument_history_request>(msg)) {
            try {
                reply(nats_,
                      msg,
                      get_fra_instrument_history_response{
                          .success = true, .history = svc.get_fra_instrument_history(req->id)});
            } catch (const std::exception& e) {
                reply(nats_,
                      msg,
                      get_fra_instrument_history_response{.success = false, .message = e.what()});
            }
        }
    }
    ...
    void list_vanilla_swap(ores::nats::message msg) {
        ...
        try {
            if (auto req = decode<get_vanilla_swap_instruments_request>(msg)) {
                resp.instruments =
                    svc.list_vanilla_swap_instruments(static_cast<std::uint32_t>(req->offset),
                                                      static_cast<std::uint32_t>(req->limit));
    ...
    void save_vanilla_swap(ores::nats::message msg) {
        ...
        if (auto req = decode<save_vanilla_swap_instrument_request>(msg)) {
            try {
                ...
                reply(nats_,
                      msg,
                      save_vanilla_swap_instrument_response{.success = false, .message = e.what()});
            }
        }
    }
    ...
    void history_vanilla_swap(ores::nats::message msg) {
        ...
        if (auto req = decode<get_vanilla_swap_instrument_history_request>(msg)) {
            try {
                reply(nats_,
                      msg,
                      get_vanilla_swap_instrument_history_response{
                          .success = true,
                          .history = svc.get_vanilla_swap_instrument_history(req->id)});
            } catch (const std::exception& e) {
                reply(nats_,
                      msg,
                      get_vanilla_swap_instrument_history_response{.success = false,
                                                                   .message = e.what()});
            }
        }
    }
    ...
    void list_cap_floor(ores::nats::message msg) {
        ...
        try {
            if (auto req = decode<get_cap_floor_instruments_request>(msg)) {
                resp.instruments =
                    svc.list_cap_floor_instruments(static_cast<std::uint32_t>(req->offset),
                                                   static_cast<std::uint32_t>(req->limit));
    ...
    void save_cap_floor(ores::nats::message msg) {
        ...
        if (auto req = decode<save_cap_floor_instrument_request>(msg)) {
            try {
                ...
                reply(nats_,
                      msg,
                      save_cap_floor_instrument_response{.success = false, .message = e.what()});
            }
        }
    }
        ...
        if (auto req = decode<get_cap_floor_instrument_history_request>(msg)) {
            try {
                reply(
                    nats_,
                    msg,
                    get_cap_floor_instrument_history_response{
                        .success = true, .history = svc.get_cap_floor_instrument_history(req->id)});
            } catch (const std::exception& e) {
                reply(nats_,
                      msg,
                      get_cap_floor_instrument_history_response{.success = false,
                                                                .message = e.what()});
            }
        }
    }
    ...
    void list_swaption(ores::nats::message msg) {
        ...
        try {
            if (auto req = decode<get_swaption_instruments_request>(msg)) {
                resp.instruments =
                    svc.list_swaption_instruments(static_cast<std::uint32_t>(req->offset),
                                                  static_cast<std::uint32_t>(req->limit));
    ...
    void save_swaption(ores::nats::message msg) {
        ...
        if (auto req = decode<save_swaption_instrument_request>(msg)) {
            try {
                ...
                reply(nats_,
                      msg,
                      save_swaption_instrument_response{.success = false, .message = e.what()});
            }
        }
    }
        ...
        if (auto req = decode<get_swaption_instrument_history_request>(msg)) {
            try {
                reply(
                    nats_,
                    msg,
                    get_swaption_instrument_history_response{
                        .success = true, .history = svc.get_swaption_instrument_history(req->id)});
            } catch (const std::exception& e) {
                reply(nats_,
                      msg,
                      get_swaption_instrument_history_response{.success = false,
                                                               .message = e.what()});
            }
        }
    }
        ...
        try {
            if (auto req = decode<get_balance_guaranteed_swap_instruments_request>(msg)) {
                ...
                resp.total_available_count =
                    static_cast<int>(svc.count_balance_guaranteed_swap_instruments());
            }
        } catch (const std::exception& e) {
            resp.success = false;
            resp.message = e.what();
    ...
    void save_balance_guaranteed_swap(ores::nats::message msg) {
        ...
        if (auto req = decode<save_balance_guaranteed_swap_instrument_request>(msg)) {
            try {
                ...
                reply(nats_,
                      msg,
                      save_balance_guaranteed_swap_instrument_response{.success = false,
                                                                       .message = e.what()});
            }
        }
    }
    ...
    void history_balance_guaranteed_swap(ores::nats::message msg) {
        ...
        if (auto req = decode<get_balance_guaranteed_swap_instrument_history_request>(msg)) {
            try {
                reply(nats_,
                      msg,
                      get_balance_guaranteed_swap_instrument_history_response{
                          .success = true,
                          .history = svc.get_balance_guaranteed_swap_instrument_history(req->id)});
            } catch (const std::exception& e) {
                reply(nats_,
                      msg,
                      get_balance_guaranteed_swap_instrument_history_response{.success = false,
                                                                              .message = e.what()});
            }
        }
    }
    ...
    void list_callable_swap(ores::nats::message msg) {
        ...
        try {
            if (auto req = decode<get_callable_swap_instruments_request>(msg)) {
                resp.instruments =
                    svc.list_callable_swap_instruments(static_cast<std::uint32_t>(req->offset),
                                                       static_cast<std::uint32_t>(req->limit));
                resp.total_available_count =
                    static_cast<int>(svc.count_callable_swap_instruments());
            }
        } catch (const std::exception& e) {
            resp.success = false;
            resp.message = e.what();
        ...
        if (auto req = decode<save_callable_swap_instrument_request>(msg)) {
            try {
                ...
                reply(
                    nats_,
                    msg,
                    save_callable_swap_instrument_response{.success = false, .message = e.what()});
            }
        }
    }
    ...
    void history_callable_swap(ores::nats::message msg) {
        ...
        if (auto req = decode<get_callable_swap_instrument_history_request>(msg)) {
            try {
                reply(nats_,
                      msg,
                      get_callable_swap_instrument_history_response{
                          .success = true,
                          .history = svc.get_callable_swap_instrument_history(req->id)});
            } catch (const std::exception& e) {
                reply(nats_,
                      msg,
                      get_callable_swap_instrument_history_response{.success = false,
                                                                    .message = e.what()});
            }
        }
    }
    ...
    void list_knock_out_swap(ores::nats::message msg) {
        ...
        try {
            if (auto req = decode<get_knock_out_swap_instruments_request>(msg)) {
                resp.instruments =
                    svc.list_knock_out_swap_instruments(static_cast<std::uint32_t>(req->offset),
                                                        static_cast<std::uint32_t>(req->limit));
                resp.total_available_count =
                    static_cast<int>(svc.count_knock_out_swap_instruments());
            }
        } catch (const std::exception& e) {
            resp.success = false;
            resp.message = e.what();
        ...
        if (auto req = decode<save_knock_out_swap_instrument_request>(msg)) {
            try {
                ...
                reply(
                    nats_,
                    msg,
                    save_knock_out_swap_instrument_response{.success = false, .message = e.what()});
            }
        }
    }
    ...
    void history_knock_out_swap(ores::nats::message msg) {
        ...
        if (auto req = decode<get_knock_out_swap_instrument_history_request>(msg)) {
            try {
                reply(nats_,
                      msg,
                      get_knock_out_swap_instrument_history_response{
                          .success = true,
                          .history = svc.get_knock_out_swap_instrument_history(req->id)});
            } catch (const std::exception& e) {
                reply(nats_,
                      msg,
                      get_knock_out_swap_instrument_history_response{.success = false,
                                                                     .message = e.what()});
            }
        }
    }
    ...
    void list_inflation_swap(ores::nats::message msg) {
        ...
        try {
            if (auto req = decode<get_inflation_swap_instruments_request>(msg)) {
                resp.instruments =
                    svc.list_inflation_swap_instruments(static_cast<std::uint32_t>(req->offset),
                                                        static_cast<std::uint32_t>(req->limit));
                resp.total_available_count =
                    static_cast<int>(svc.count_inflation_swap_instruments());
            }
        } catch (const std::exception& e) {
            resp.success = false;
            resp.message = e.what();
        ...
        if (auto req = decode<save_inflation_swap_instrument_request>(msg)) {
            try {
                ...
                reply(
                    nats_,
                    msg,
                    save_inflation_swap_instrument_response{.success = false, .message = e.what()});
            }
        }
    }
    ...
    void history_inflation_swap(ores::nats::message msg) {
        ...
        if (auto req = decode<get_inflation_swap_instrument_history_request>(msg)) {
            try {
                reply(nats_,
                      msg,
                      get_inflation_swap_instrument_history_response{
                          .success = true,
                          .history = svc.get_inflation_swap_instrument_history(req->id)});
            } catch (const std::exception& e) {
                reply(nats_,
                      msg,
                      get_inflation_swap_instrument_history_response{.success = false,
                                                                     .message = e.what()});
            }
        }
    }
    ...
    void list_rpa(ores::nats::message msg) {
        ...
        try {
            if (auto req = decode<get_rpa_instruments_request>(msg)) {
                resp.instruments = svc.list_rpa_instruments(static_cast<std::uint32_t>(req->offset),
                                                            static_cast<std::uint32_t>(req->limit));
    ...
    void save_rpa(ores::nats::message msg) {
        ...
        if (auto req = decode<save_rpa_instrument_request>(msg)) {
            try {
                ...
                reply(nats_,
                      msg,
                      save_rpa_instrument_response{.success = false, .message = e.what()});
            }
        }
    }
    ...
    void history_rpa(ores::nats::message msg) {
        ...
        if (auto req = decode<get_rpa_instrument_history_request>(msg)) {
            try {
                reply(nats_,
                      msg,
                      get_rpa_instrument_history_response{
                          .success = true, .history = svc.get_rpa_instrument_history(req->id)});
            } catch (const std::exception& e) {
                reply(nats_,
                      msg,
                      get_rpa_instrument_history_response{.success = false, .message = e.what()});
            }
        }
    }
