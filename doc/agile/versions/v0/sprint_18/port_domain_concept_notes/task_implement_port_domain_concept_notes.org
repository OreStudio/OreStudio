...
Read all nine source notes under =/home/marco/Development/Notebooks/summaries/=, produce a document split plan, then create the v2 knowledge documents under [[proj:doc/knowledge/domain][=doc/knowledge/domain/=]] with correct frontmatter, cross-links, and ORE Studio-aligned terminology.
...
8 v2 knowledge documents created under [[proj:doc/knowledge/domain][=doc/knowledge/domain/=]]:
