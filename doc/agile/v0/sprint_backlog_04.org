...
#+CAPTION: Clock summary at [2025-11-11 Tue 13:07], for Tuesday, November 11, 2025.
|       | <75>                                       |        |      |      |       |
| Tags  | Headline                                   | Time   |      |      |     % |
|-------+--------------------------------------------+--------+------+------+-------|
...
|       | Stories                                    | 6:33   |      |      | 100.0 |
|       | Active                                     |        | 6:33 |      | 100.0 |
| code  | Create a skill for plant uml documentation |        |      | 2:31 |  38.4 |
| infra | Add CMake targets for site and skills      |        |      | 0:17 |   4.3 |
| infra | Generalise the skill setup for ORE Studio  |        |      | 3:45 |  57.3 |
#+end:

#+begin: clocktable :maxlevel 3 :scope subtree :tags t :indent nil :emphasize nil :scope file :narrow 75 :formula %
#+TBLNAME: sprint_summary
#+CAPTION: Clock summary at [2025-11-11 Tue 13:07]
|          | <75>                                                   |         |       |       |       |
| Tags     | Headline                                               | Time    |       |       |     % |
|----------+--------------------------------------------------------+---------+-------+-------+-------|
|          | *Total time*                                           | *46:33* |       |       | 100.0 |
|----------+--------------------------------------------------------+---------+-------+-------+-------|
|          | Stories                                                | 46:33   |       |       | 100.0 |
|          | Active                                                 |         | 46:33 |       | 100.0 |
| agile    | Sprint and product backlog refinement                  |         |       |  2:00 |   4.3 |
| code     | Clean up client parser                                 |         |       |  0:10 |   0.4 |
| code     | Add connect command line argument                      |         |       |  1:19 |   2.8 |
| infra    | Install Windows package on Windows machine             |         |       |  2:09 |   4.6 |
| code     | Ignore warnings on windows and osx                     |         |       |  0:33 |   1.2 |
| code     | Ensure applications work under OSX using github images |         |       |  0:14 |   0.5 |
| infra    | Create a splash screen and gray background             |         |       |  2:26 |   5.2 |
| code     | Use fluent icons                                       |         |       |  0:37 |   1.3 |
| code     | Add export functionality for currencies                |         |       |  1:30 |   3.2 |
| code     | Add currency editing support                           |         |       |  2:45 |   5.9 |
| code     | Add about to menu                                      |         |       |  1:02 |   2.2 |
| code     | Create a history dialog for currencies                 |         |       |  1:27 |   3.1 |
| code     | Allow MDI windows outside main window                  |         |       |  1:35 |   3.4 |
| code     | Add edit menu and export menu                          |         |       |  0:34 |   1.2 |
| code     | Implement adding new currencies                        |         |       |  3:17 |   7.1 |
| code     | Clean up product website                               |         |       |  4:42 |  10.1 |
| code     | Create a skill for plant uml documentation             |         |       |  2:48 |   6.0 |
| infra    | Add CMake targets for site and skills                  |         |       |  0:17 |   0.6 |
| infra    | Generalise the skill setup for ORE Studio              |         |       |  3:45 |   8.1 |
| code     | Make UI/UX look more professional                      |         |       | 11:07 |  23.9 |
| code     | Current issues with package install in debian          |         |       |  0:40 |   1.4 |
| code     | Resolve crash on shutdown problem                      |         |       |  0:50 |   1.8 |
| analysis | Weaving skills and documentation together              |         |       |  0:46 |   1.6 |
#+end:
