...
private:
    inline static std::string_view logger_name = "ores.qt.client_ois_convention_model";
...
public:
    ...
    explicit ClientOisConventionModel(ClientManager* clientManager, QObject* parent = nullptr);
