 ...
 */
#ifndef ORES_SHELL_APP_COMMANDS_SWAP_CONVENTION_COMMANDS_HPP
#define ORES_SHELL_APP_COMMANDS_SWAP_CONVENTION_COMMANDS_HPP
...
/**
 * @brief Every verb swap conventions answer, as one command each.
 *
 ...
 */
class swap_convention_commands {
private:
    inline static std::string_view logger_name =
        "ores.shell.app.commands.refdata.swap_convention_commands";
...
public:
    /**
     * @brief Register the swap conventions submenu.
     */
