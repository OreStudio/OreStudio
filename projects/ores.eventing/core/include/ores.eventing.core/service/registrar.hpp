 ...
 *
 */
#ifndef ORES_EVENTING_CORE_SERVICE_REGISTRAR_HPP
#define ORES_EVENTING_CORE_SERVICE_REGISTRAR_HPP

#include "ores.eventing.api/domain/event_traits.hpp"
#include "ores.eventing.api/service/event_channel_registry.hpp"
