...
| [[id:E01D5A91-F3ED-4223-A2ED-E331DD4EF4DB][Port keeper entries to the org memory system]] | BACKLOG | | | For each entry classified as 'port' in the audit, scaffold an org memory file under doc/llm/memory/ using compass remember; resolve any contradictions with existing org memories. |
