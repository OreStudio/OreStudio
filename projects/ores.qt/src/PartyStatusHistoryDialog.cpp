...
void PartyStatusHistoryDialog::setupConnections() {
    connect(ui_->versionListWidget, &QTableWidget::itemSelectionChanged,
            this, &PartyStatusHistoryDialog::onVersionSelected);
    connect(openVersionAction_, &QAction::triggered,
            this, &PartyStatusHistoryDialog::onOpenVersionClicked);
    connect(revertAction_, &QAction::triggered,
            this, &PartyStatusHistoryDialog::onRevertClicked);
...
void PartyStatusHistoryDialog::loadHistory() {
    ...
    auto task = [self, code = code_.toStdString()]() -> HistoryResult {
        ...
        comms::messaging::frame request_frame(
            comms::messaging::message_type::get_party_status_history_request,
            0, std::move(payload)
        );
        ...
        auto response = refdata::messaging::get_party_status_history_response::
