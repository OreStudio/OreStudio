...
current templates produce for every entity in [[proj:projects/ores.sql/create][=projects/ores.sql/create/=]]. Logical
...
- Running =codegen.py= for all refdata entities produces zero logical diff against the
  current SQL files in [[proj:projects/ores.sql/create/refdata][=projects/ores.sql/create/refdata/=]].
...
| [[id:ADBAD96B-264D-4850-B812-E4ADF544AD81][Implement unified SQL template]] | DONE | 2026-05-29 | 2026-05-29 | Write =sql_schema_create.mustache=; add =table= model-type support in generator; verify parity for all refdata entities. |
| [[id:05730114-2017-432B-B7E8-70F8ED9BB172][Migrate refdata entity models to new format]] | DONE | 2026-05-29 | 2026-05-30 | Convert all =_entity.json= models to =_table.json=; retire =refdata-table= component alias; run parity check. |
| [[id:3F9A4145-E8D5-4D6E-AF7B-1BB17D0E34B2][Retire =generate_refdata_schema.sh=]] | DONE | 2026-05-30 | 2026-05-30 | Delete script; update any CI or Makefile references; document replacement in =architecture.org=. |
...
[[proj:projects/ores.refdata][=projects/ores.refdata/=]] directory rather than to =projects/ores.refdata.api/= and
