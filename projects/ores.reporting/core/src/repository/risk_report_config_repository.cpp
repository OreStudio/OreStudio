...
struct book_scope_entity {
    ...
    std::string book_id;
    std::optional<ores::database::repository::db_timestamp> valid_from = "9999-12-31 23:59:59";
    std::optional<ores::database::repository::db_timestamp> valid_to = "9999-12-31 23:59:59";
};
