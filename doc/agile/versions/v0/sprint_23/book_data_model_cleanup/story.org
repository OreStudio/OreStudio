...
| Now           | 5/9 tasks done. book_purpose_type and ledger_feed_type lookup entities shipped and QA'd. |
| Waiting on    | Nothing.                               |
| Next          | Pick up the next BACKLOG task (is_sweepable, or one of the investigation/rename tasks). |
...
| [[id:FA28F852-012F-47A7-94E7-FEDAEF2F2DF9][Add is_sweepable flag to book]] | STARTED | 2026-07-13 | | Add the is_sweepable boolean (spot-sweep eligibility only, unrelated to ledger sweep), rendered as a yes/no badge in the Book list consistent with the regulatory_book_type badge combo. |
