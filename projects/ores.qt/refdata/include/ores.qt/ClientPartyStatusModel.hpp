 ...
 *
 * This model extends AbstractClientModel and fetches party status
 * data asynchronously using the ores.comms client.
 */
class ClientPartyStatusModel final : public AbstractClientModel {
    Q_OBJECT

private:
    inline static std::string_view logger_name = "ores.qt.client_party_status_model";
...
public:
    ...
    explicit ClientPartyStatusModel(ClientManager* clientManager, QObject* parent = nullptr);
