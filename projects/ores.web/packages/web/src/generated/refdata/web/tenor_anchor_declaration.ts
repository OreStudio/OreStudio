 ...
 */
/**
 * Where the tenor_anchor screens live and what they can do.
 *
 ...
 */
import { tenorAnchorMeta } from '../ui/tenor_anchor_ui.js';
import type { EntityDescriptor } from '../../../entity/descriptor.js';

export const tenorAnchorDescriptor: EntityDescriptor = {
    component: 'refdata',
    entity: 'tenor_anchor',
    meta: tenorAnchorMeta,
    routeSegment: 'tenor-anchor',
    apiBase: '/api/anchors',
    keyParam: 'id',
    icon: 'lockClosed',
    capabilities: {
