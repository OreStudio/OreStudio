...
namespace {
inline auto& synthetic_fx_spot_config_handler_lg() {
    static auto instance =
        ores::logging::make_logger("ores.dq.messaging.synthetic_fx_spot_config_handler");
    return instance;
}
} // namespace
...
/**
 * @brief NATS message handler for synthetic FX spot config operations.
 */
class synthetic_fx_spot_config_handler {
public:
    synthetic_fx_spot_config_handler(ores::nats::service::client& nats,
