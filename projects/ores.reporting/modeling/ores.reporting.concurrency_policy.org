...
#+description: Codegen entity model for the reporting =concurrency_policy= table. Drives the C++ domain class, mapper, repository, service, generator, and SQL schema generation from a single literate source.
