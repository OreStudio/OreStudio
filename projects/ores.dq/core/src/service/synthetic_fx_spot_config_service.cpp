...
synthetic_fx_spot_config_service::get_config_at_version(const std::string& id,
                                                        std::uint32_t version) {
    BOOST_LOG_SEV(lg(), debug) << "Getting synthetic FX spot config at version. " << "id: " << id
                               << " version: " << version;
    return repo_.read_at_version(ctx_, id, version);
}

std::optional<domain::synthetic_fx_spot_config>
synthetic_fx_spot_config_service::get_config(const std::string& id) {
...
void synthetic_fx_spot_config_service::delete_config(const std::string& id) {
...
std::vector<domain::synthetic_fx_spot_config>
synthetic_fx_spot_config_service::get_config_history(const std::string& id) {
    BOOST_LOG_SEV(lg(), debug) << "Getting history for synthetic FX spot config. " << "id: " << id;
