...
- All NATS operations are request-reply — no push/fan-out subjects exist for market
  data today.
- FX spot observations all carry =point_id= =SPOT=, the default its series type names.
...
[[id:3D56DB59-8075-42BB-8139-A7440C9786B2][Market Data Identifier]]: lowercase the ORE key and replace =/= with =.=,
  ...
  service/
    ...
    src/
      ...
      processes/
        ...
        gbm_process.cpp/.hpp
        ornstein_uhlenbeck_process.cpp/.hpp
        gaussian_mixture_model_process.cpp/.hpp
...
- [[id:F3010EA7-6A0E-405C-81FA-1EF051749B5E][External market data identifiers]] — RIC, Bloomberg, ORE canonical key comparative analysis.
- [[id:3D56DB59-8075-42BB-8139-A7440C9786B2][Market Data Identifier]] — NATS subject mapping, two-level subscription model.
