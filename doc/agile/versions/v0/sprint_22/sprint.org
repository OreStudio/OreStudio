...
| Story | State | Start | End | Description |
|-------+-------+-------+-----+-------------|
| [[id:A85B16E3-5A42-4484-A570-13EE7CFA9F50][ores.orgmode: C++ org-mode parsing and org-roam link resolution]] | BACKLOG | | | New component: parse org-mode docs into a C++ structure, resolve id: links via the existing org-roam SQLite index. Pure C++, usable from ores.shell; ports dogen.org's entity model. |
