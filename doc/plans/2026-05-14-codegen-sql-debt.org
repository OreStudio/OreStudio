...
[[id:7BBA5627-F13D-4BFC-9E03-C15B61A11AD5][2026-05-13-identifier-length-cleanup]]) a cross-check was run between
~projects/ores.codegen/models/~ and [[proj:projects/ores.sql/create][~projects/ores.sql/create/~]].  Two classes
of debt were found:
...
[[proj:projects/ores.sql/create][~projects/ores.sql/create/~]] for entities that have a codegen model is now
