 ...
 *
 */
#ifndef ORES_MARKETDATA_SERVICE_APP_HOST_HPP
#define ORES_MARKETDATA_SERVICE_APP_HOST_HPP
...
private:
    inline static std::string_view logger_name = "ores.marketdata.service.app.host";
