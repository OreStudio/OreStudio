...
| Now           | Mapping-browser task's blocker (D4DE4138) landed and merged (PR #1608); resumed the mapping-browser task (98AC38DD) to re-verify against real tenant-scoped data and close it out. Still blocking [[id:72E90BAE-657B-4AA8-8F18-CB5AB6B5F57C][Commission: portfolio]]'s manual-chapter task -- Portfolios screens render wrong badge colours until this story lands. |
| Waiting on    | Nothing.                               |
| Next          | Re-verify and close the badge_mapping browser UI task, then move to the palette-swatch/self-badging/coverage-audit tasks. |
