 ...
 *
 */
#ifndef ORES_ORE_SERVICE_APP_APPLICATION_HPP
#define ORES_ORE_SERVICE_APP_APPLICATION_HPP
...
/**
 * @brief Entry point for ores.ore.service.
 */
class application final {
private:
    inline static std::string_view logger_name = "ores.ore.service.app.application";
