 ...
 *
 */
#ifndef ORES_DQ_API_GENERATORS_CHANGE_REASON_CATEGORY_GENERATOR_HPP
#define ORES_DQ_API_GENERATORS_CHANGE_REASON_CATEGORY_GENERATOR_HPP
 ...
 */
ORES_DQ_API_EXPORT domain::change_reason_category
