 ...
 */
#ifndef ORES_QT_APP_VERSION_MDI_WINDOW_HPP
#define ORES_QT_APP_VERSION_MDI_WINDOW_HPP
 ...
 *
 * Provides a table view of app versions with toolbar actions
 * for reload, add, edit, delete, and viewing history.
 */
class AppVersionMdiWindow final : public EntityListMdiWindow {
    Q_OBJECT

private:
    inline static std::string_view logger_name = "ores.qt.app_version_mdi_window";
...
public:
    explicit AppVersionMdiWindow(ClientManager* clientManager,
...
signals:
    ...
    void showVersionDetails(const compute::domain::app_version& app_version);
...
protected:
    QString normalRefreshTooltip() const override {
        return tr("Refresh app versions");
    }
