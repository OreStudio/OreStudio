...
registrar::register_handlers(ores::nats::service::client& nats,
    ...
    // Service definitions
    subs.push_back(nats.queue_subscribe(std::string(list_service_definitions_request::nats_subject),
                                        queue,
    ...
    subs.push_back(nats.queue_subscribe(std::string(save_service_definition_request::nats_subject),
                                        queue,
                                        [&nats, ctx, verifier](ores::nats::message msg) mutable {
                                            service_definition_handler h(nats, ctx, verifier);
                                            h.save(std::move(msg));
    ...
    // Service instances
    subs.push_back(
        nats.queue_subscribe(std::string(list_service_instances_request::nats_subject),
                             queue,
    ...
    subs.push_back(
        nats.queue_subscribe(std::string(start_service_request::nats_subject),
                             queue,
                             [&nats, ctx, verifier, supervisor](ores::nats::message msg) mutable {
                                 service_instance_handler h(nats, ctx, verifier, supervisor);
    ...
    subs.push_back(
        nats.queue_subscribe(std::string(stop_service_request::nats_subject),
                             queue,
                             [&nats, ctx, verifier, supervisor](ores::nats::message msg) mutable {
                                 service_instance_handler h(nats, ctx, verifier, supervisor);
                                 h.stop(std::move(msg));
    ...
    subs.push_back(
        nats.queue_subscribe(std::string(restart_service_request::nats_subject),
                             queue,
                             [&nats, ctx, verifier, supervisor](ores::nats::message msg) mutable {
                                 service_instance_handler h(nats, ctx, verifier, supervisor);
    ...
    // Service events
    subs.push_back(nats.queue_subscribe(std::string(list_service_events_request::nats_subject),
                                        queue,
                                        [&nats, ctx, verifier](ores::nats::message msg) mutable {
