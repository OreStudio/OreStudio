...
export const crmEnabledDerivedPairRoute: EntityRouteDescriptor = {
  ...
  subjects: {
    ...
    save: subjects.put_crm_enabled_derived_pair_request,
    remove: subjects.delete_crm_enabled_derived_pair_request,
    history: subjects.list_crm_enabled_derived_pair_versions_request,
  },
  rowsField: 'crm_enabled_derived_pairs',
  getRowField: 'crm_enabled_derived_pair',
