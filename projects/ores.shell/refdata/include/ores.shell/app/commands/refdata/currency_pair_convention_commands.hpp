 ...
 */
#ifndef ORES_SHELL_APP_COMMANDS_CURRENCY_PAIR_CONVENTION_COMMANDS_HPP
#define ORES_SHELL_APP_COMMANDS_CURRENCY_PAIR_CONVENTION_COMMANDS_HPP
...
/**
 * @brief Every verb currency pair conventions answer, as one command each.
 *
 ...
 */
class currency_pair_convention_commands {
private:
    inline static std::string_view logger_name =
        "ores.shell.app.commands.refdata.currency_pair_convention_commands";
...
public:
    /**
     * @brief Register the currency pair conventions submenu.
     */
    ...
    /**
     * @brief add <pair_code> <pip_factor> <tick_size> <decimal_places> <business_day_convention>
    ...
    /**
     * @brief set <pair_code> <pip_factor> <tick_size> <decimal_places> <business_day_convention>
    ...
    /**
     * @brief put-many --count <n> <pair_code> <pip_factor> <tick_size> <decimal_places>
    ...
    /**
     * @brief delete <pair_code> <reason> <commentary> [--version <n>]
     */
    ...
    /**
     * @brief delete-many <pair_code> <reason> <commentary>
     */
    ...
    /**
     * @brief versions <pair_code> [--offset <n>] [--limit <n>] [--order <field>] [--desc]
     */
    ...
    /**
     * @brief version <pair_code> --version <n>
     */
