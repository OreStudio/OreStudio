 ...
 *   SELECT * FROM metadata.dq_preview_benchmark_rate_population(dataset_id);
 *
 ...
 */
create or replace function metadata.dq_preview_benchmark_rate_population(p_dataset_id uuid)
returns table (
    action text,
    code text,
