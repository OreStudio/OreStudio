...
/**
 * @brief Dumps the currency_currency_group to a stream in JSON format.
 */
ORES_REFDATA_API_EXPORT std::ostream& operator<<(std::ostream& s, const currency_currency_group& v);
