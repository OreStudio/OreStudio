...
#include "ores.refdata.api/eventing/monetary_nature_event.hpp"
...
TEST_CASE("write_monetary_nature_publishes_an_event", tags) {
    ...
    using event_type = ores::refdata::messaging::monetary_nature_event;
    ...
    event_source.register_entity_event_mapping<event_type>("ores_refdata_monetary_natures");
