...
private:
    inline static std::string_view logger_name = "ores.qt.client_fx_convention_model";
...
public:
    ...
    explicit ClientFxConventionModel(ClientManager* clientManager, QObject* parent = nullptr);
