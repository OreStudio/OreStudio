 ...
 */
#ifndef ORES_QT_GMM_COMPONENT_MDI_WINDOW_HPP
#define ORES_QT_GMM_COMPONENT_MDI_WINDOW_HPP
...
private:
    inline static std::string_view logger_name = "ores.qt.gmm_component_mdi_window";
...
public:
    explicit GmmComponentMdiWindow(ClientManager* clientManager,
                                   const QString& username,
                                   QWidget* parent = nullptr);
    ~GmmComponentMdiWindow() override = default;
...
protected:
    QString normalRefreshTooltip() const override {
        return tr("Refresh GMM components");
    }
...
private:
    ...
    ClientGmmComponentModel* model_;
