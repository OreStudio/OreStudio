 ...
 */
#ifndef ORES_SHELL_APP_COMMANDS_DERIVATION_KIND_COMMANDS_HPP
#define ORES_SHELL_APP_COMMANDS_DERIVATION_KIND_COMMANDS_HPP
...
/**
 * @brief Every verb derivation kinds answer, as one command each.
 *
 ...
 */
class derivation_kind_commands {
private:
    inline static std::string_view logger_name =
        "ores.shell.app.commands.refdata.derivation_kind_commands";
...
public:
    /**
     * @brief Register the derivation kinds submenu.
     */
