...
#+description: Commission business_unit: verify Qt UI post-NATS, implement shell and CLI commands, fix regressions, add manual chapter, capture Wt/HTTP backlog.
#+type: story
#+level: s2
