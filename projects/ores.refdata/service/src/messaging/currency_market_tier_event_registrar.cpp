...
register_currency_market_tier_event_mapping(ev::service::postgres_event_source& event_source,
    ...
    ev::service::registrar::register_mapping<refdata::eventing::currency_market_tier_changed_event>(
        event_source, "ores.refdata.currency_market_tier", "ores_refdata_currency_market_tiers");

    return event_bus.subscribe<refdata::eventing::currency_market_tier_changed_event>(
        [&nats](const refdata::eventing::currency_market_tier_changed_event& e) {
            ev::service::publish_entity_event(
                nats,
                std::string(ev::domain::event_traits<
                            refdata::eventing::currency_market_tier_changed_event>::name),
