...
A full-stack ORE Studio entity spans five layers: a domain type, a
SQL schema, and three surface layers (HTTP REST, CLI, shell REPL).
...
that is still moving, and the SQL schema is what fixes that shape. The three
