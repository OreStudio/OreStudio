...
create or replace trigger ores_refdata_portfolios_notify_trg
after insert or update or delete on ores_refdata_portfolios_tbl
for each row execute function ores_refdata_portfolios_notify_fn();
