 ...
 */
#ifndef ORES_SHELL_APP_COMMANDS_BUSINESS_CENTRE_COMMANDS_HPP
#define ORES_SHELL_APP_COMMANDS_BUSINESS_CENTRE_COMMANDS_HPP
...
/**
 * @brief Every verb business centres answer, as one command each.
 *
 ...
 */
class business_centre_commands {
private:
    inline static std::string_view logger_name =
        "ores.shell.app.commands.refdata.business_centre_commands";
...
public:
    /**
     * @brief Register the business centres submenu.
     */
    ...
    /**
     * @brief add <code> <source> <description> <city_name> <country_alpha2_code>
    ...
    /**
     * @brief set <code> <source> <description> <city_name> <country_alpha2_code>
    ...
    /**
     * @brief put-many --count <n> <code> <source> <description> <city_name> <country_alpha2_code>
     * <coding_scheme_code> <reason> <commentary>
     */
