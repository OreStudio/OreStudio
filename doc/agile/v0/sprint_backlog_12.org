...
#+CAPTION: Clock summary at [2026-02-18 Wed 01:06], for Wednesday, February 18, 2026.
|      | <75>                         |        |      |      |       |
| Tags | Headline                     | Time   |      |      |     % |
|------+------------------------------+--------+------+------+-------|
...
|      | Stories                      | 1:06   |      |      | 100.0 |
|      | Active                       |        | 1:06 |      | 100.0 |
| code | Advanced counterparty dialog |        |      | 1:06 | 100.0 |
#+end:

#+begin: clocktable :maxlevel 3 :scope subtree :tags t :indent nil :emphasize nil :scope file :narrow 75 :formula %
#+TBLNAME: sprint_summary
#+CAPTION: Clock summary at [2026-02-18 Wed 01:06]
|       | <75>                                               |         |       |       |       |
| Tags  | Headline                                           | Time    |       |       |     % |
|-------+----------------------------------------------------+---------+-------+-------+-------|
...
| code  | Implement party related entities at database level |         |       |  4:23 |   7.3 |
| code  | Add party related support at the domain level      |         |       |  0:23 |   0.6 |
| code  | Add party related support to Qt                    |         |       |  6:41 |  11.1 |
| code  | Add GLEIF data to datasets                         |         |       |  6:41 |  11.1 |
| code  | Brainstorm on multi-party support                  |         |       |  4:00 |   6.6 |
| code  | Improve code coverage                              |         |       |  0:14 |   0.4 |
| code  | Improve generators with FK-aware test data         |         |       |  1:44 |   2.9 |
| code  | Enable all skipped tests                           |         |       |  0:29 |   0.8 |
| code  | Add central bank related LEIs                      |         |       |  0:35 |   1.0 |
| code  | Expand unit test coverage for ORE codegened types  |         |       |  0:49 |   1.4 |
| code  | Add system party support                           |         |       |  3:58 |   6.6 |
| code  | Add customer party support                         |         |       |  1:33 |   2.6 |
| code  | Fix OSX build                                      |         |       |  0:19 |   0.5 |
| code  | Add pagination to counterparty                     |         |       |  0:58 |   1.6 |
| code  | Add support for business centres                   |         |       |  3:47 |   6.3 |
...
| code  | Advanced counterparty dialog                       |         |       | 10:18 |  17.1 |
