...
- Components: [[id:00E33570-F7BE-7F94-FD83-2FDC9CB04463][ores.utility]], [[id:7F3A2E81-B5C9-4D6A-8E12-9C4B3F5A7D0E][ores.platform]], [[id:8A2B3C4D-5E6F-7A8B-9C0D-1E2F3A4B5C6D][ores.telemetry]], [[id:3A8F2E91-D4C7-8AB4-5E23-91D6F8C04A72][ores.database]], [[id:1EE1B07C-3EC4-9BC4-1C4B-5BD458A8B2E5][ores.variability]], [[id:8A1C5E2D-9B4F-4E8A-A7C3-6F2D1E0B9A5C][ores.geo]].
- *Utility*: UUID generation, base32/base64 encoding, string conversion,
  faker utilities. No ores dependencies.
- *Platform*: Filesystem utilities, environment variables, network info,
  cross-platform time utilities. Depends on: utility.
- *Telemetry*: Logging infrastructure (Boost.Log integration), distributed
  tracing (trace_id, span_id), log record export, severity levels.
  Depends on: platform.
...
- *Geo*: IP-to-location geolocation using MaxMind GeoLite2-City database.
  Provides country, city, and coordinate lookups for session tracking.
- Dependency order: utility → platform → telemetry → database.

** Infrastructure Layer

- Components: [[id:361A6093-D24C-9BC4-0543-6540461EDBB6][ores.comms]], [[id:7F58FF13-5A85-49C4-09BB-EED86B874ABB][ores.testing]], [[id:DDBC94C4-F350-478B-9E4C-643DEEA803B0][ores.eventing]], ores.assets.
...
- *Testing*: Catch2 integration with database isolation and logging listeners.
...
- *Assets*: Asset management for images and visual resources. Binary image
...
- Components: [[id:1EE1B07C-3EC4-9BC4-1C4B-5BD458A8B2E5][ores.client]], [[id:F0DAACD0-8EAB-46C4-6B53-640921E3F225][ores.cli]], [[id:25812E6F-7AD1-36E4-697B-EEC8015C4F1F][ores.qt]], [[id:7141E32C-80E2-6B74-F273-C80DAA42D727][ores.comms.service]], [[id:D0876A24-69BA-F484-ED9B-71CD3AA8710C][ores.shell]].
- Client: REPL client.
