 ...
 *
 */
#ifndef ORES_MARKETDATA_CORE_SERVICE_TENOR_ANCHOR_SERVICE_HPP
#define ORES_MARKETDATA_CORE_SERVICE_TENOR_ANCHOR_SERVICE_HPP
 ...
 */
class ORES_MARKETDATA_CORE_EXPORT tenor_anchor_service {
private:
    inline static std::string_view logger_name = "ores.marketdata.service.tenor_anchor_service";
