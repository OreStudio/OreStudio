...
create table if not exists "ores_refdata_counterparty_identifiers_tbl" (
    "id" uuid not null,
...
create unique index if not exists ores_refdata_counterparty_identifiers_counterparty_scheme_uniq_idx
on "ores_refdata_counterparty_identifiers_tbl" (tenant_id, counterparty_id, id_scheme)
where valid_to = ores_utility_infinity_timestamp_fn();
...
create or replace trigger ores_refdata_counterparty_identifiers_insert_trg
before insert on "ores_refdata_counterparty_identifiers_tbl"
