 ...
 */
#ifndef ORES_QT_BUSINESS_DAY_CONVENTION_TYPE_MDI_WINDOW_HPP
#define ORES_QT_BUSINESS_DAY_CONVENTION_TYPE_MDI_WINDOW_HPP
 ...
 *
 * Provides a table view of business day convention types with toolbar actions
 * for reload, add, edit, delete, and viewing history.
 */
class BusinessDayConventionTypeMdiWindow final : public EntityListMdiWindow {
    Q_OBJECT

private:
    inline static std::string_view logger_name = "ores.qt.business_day_convention_type_mdi_window";
...
public:
    explicit BusinessDayConventionTypeMdiWindow(ClientManager* clientManager,
...
protected:
    QString normalRefreshTooltip() const override {
        return tr("Refresh business day convention types");
    }
...
private:
    ...
    ClientBusinessDayConventionTypeModel* model_;
