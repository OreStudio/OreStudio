...
#include "ores.refdata.api/eventing/regulatory_book_type_event.hpp"
...
TEST_CASE("write_regulatory_book_type_publishes_an_event", tags) {
    ...
    using event_type = ores::refdata::messaging::regulatory_book_type_event;
    ...
    event_source.register_entity_event_mapping<event_type>("ores_refdata_regulatory_book_types");
