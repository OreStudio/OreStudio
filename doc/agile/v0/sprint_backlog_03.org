...
#+CAPTION: Clock summary at [2025-11-07 Fri 07:55], for Friday, November 07, 2025.
|      | <75>                              |        |      |      |       |
| Tags | Headline                          | Time   |      |      |     % |
|------+-----------------------------------+--------+------+------+-------|
...
#+CAPTION: Clock summary at [2025-11-07 Fri 07:55]
|       | <75>                                                   |         |       |       |       |
| Tags  | Headline                                               | Time    |       |       |     % |
|-------+--------------------------------------------------------+---------+-------+-------+-------|
...
#+begin_src markdown
# **OreStudio Sprint3 – Release Notes***November2025*
...
## 📊 **Time Summary**
- **Total effort**:71h45m- **Code**:70% | **Infra**:12% | **Agile**:3%- Top tasks: PostgreSQL in CI (14h), Boost.Log refactor (8h), dynamic library investigation (7h), test data generation (8h)

---

*Next sprint: Focus on finalizing login workflow, UI integration with new socket code, and stabilizing packaging across platforms.*
#+end_src
