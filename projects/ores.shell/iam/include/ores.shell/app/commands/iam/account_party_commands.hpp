 ...
 */
#ifndef ORES_SHELL_APP_COMMANDS_ACCOUNT_PARTY_COMMANDS_HPP
#define ORES_SHELL_APP_COMMANDS_ACCOUNT_PARTY_COMMANDS_HPP
 ...
 */
class account_party_commands {
private:
    inline static std::string_view logger_name =
        "ores.shell.app.commands.iam.account_party_commands";
...
public:
    ...
    /**
     * @brief get-many <account_id> <party_id>
     */
    ...
    /**
     * @brief add <account_id> <party_id> <reason> <commentary>
     */
    ...
    /**
     * @brief set <account_id> <party_id> <reason> <commentary> [--version <n>]
     */
    ...
    /**
     * @brief put-many --count <n> <account_id> <party_id> <reason> <commentary>
     */
    ...
    /**
     * @brief delete <account_id> <party_id> <reason> <commentary> [--version <n>]
     */
    ...
    /**
     * @brief delete-many <account_id> <party_id> <reason> <commentary>
     */
