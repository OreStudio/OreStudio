...
#include "ores.trading.core/presentation/trade_party_role_history_field_mapper.hpp"
#include "ores.trading.core/service/trade_party_role_service.hpp"

namespace ores::trading::messaging {

void register_trade_party_role_history_provider(
    ores::history::service::dispatch_registry& registry) {
    registry.register_history_provider(
        "ores.trading.trade_party_role",
        [](const ores::database::context& scoped_ctx, const std::string& entity_id) {
            service::trade_party_role_service svc(scoped_ctx);
            auto versions = svc.get_role_history(entity_id);
            return ores::history::service::build_entity_history_versions(
                versions, presentation::render_trade_party_role_fields);
        });
}
