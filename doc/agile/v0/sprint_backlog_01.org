...
#+CAPTION: Clock summary at [2024-07-28 Sun 23:09]
|       | <75>                                               |         |       |       |       |
| Tags  | Headline                                           | Time    |       |       |     % |
|-------+----------------------------------------------------+---------+-------+-------+-------|
...
*** CANCELLED Use Qt SQL classes                                      :infra:
    :LOGBOOK:
    CLOCK: [2024-07-26 Fri 23:02]--[2024-07-27 Sat 00:22] =>  1:20
...
#+begin_src markdown
# **OreStudio Sprint 1 – Release Notes**
*July 2024*
...
- Created GitHub organization and repository: [github.com/OreStudio/OreStudio](https://github.com/OreStudio/OreStudio)
...
- Launched project website: [orestudio.github.io/OreStudio](https://orestudio.github.io/OreStudio)
...
## 📊 **Time Summary**
- **Total effort**: 80h 13m
- **Code**: 38% | **Infra**: 27% | **Doc**: 12% | **Agile**: 8%
- Top tasks: Qt UI refactor (10h), XML parsing (6.5h), command line options (5.8h), nightly/memcheck setup (3.4h)

---

*Next sprint: Focus on project structuring, core refactoring, and exploring advanced UI frameworks like ImGui.*
#+end_src
