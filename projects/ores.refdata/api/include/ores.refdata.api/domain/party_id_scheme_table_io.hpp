 ...
 *
 */
#ifndef ORES_REFDATA_API_DOMAIN_PARTY_ID_SCHEME_TABLE_IO_HPP
#define ORES_REFDATA_API_DOMAIN_PARTY_ID_SCHEME_TABLE_IO_HPP
...
ORES_REFDATA_API_EXPORT std::ostream& operator<<(std::ostream& s,
                                                 const std::vector<party_id_scheme>& v);
