...
| [[id:5C03F6C1-AEC8-4C62-9ECF-C2EE1F31BA3F][Delete harness files and lock out auto-memory]] | BACKLOG | | | Delete all MEMORY.md and *.md files from all OreStudio harness memory dirs; update CLAUDE.md and LLM instructions with an explicit prohibition; disable auto-memory in Claude Code settings. |
