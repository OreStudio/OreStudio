...
| File | Action |
|------|--------|
| [[proj:projects/ores.service/src/service/request_context.cpp][=projects/ores.service/src/service/request_context.cpp=]] | *UPDATE* — return error on JWT failure instead of falling back |
| [[proj:projects/ores.service/include/ores.service/error_code.hpp][=projects/ores.service/include/ores.service/error_code.hpp=]] | *UPDATE* — add =token_expired= to =error_code= enum |
