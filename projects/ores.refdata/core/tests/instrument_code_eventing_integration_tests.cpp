...
#include "ores.refdata.api/eventing/instrument_code_event.hpp"
...
TEST_CASE("write_instrument_code_publishes_an_event", tags) {
    ...
    using event_type = ores::refdata::messaging::instrument_code_event;
    ...
    event_source.register_entity_event_mapping<event_type>("ores_refdata_instrument_codes");
