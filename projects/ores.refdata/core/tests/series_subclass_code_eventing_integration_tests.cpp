...
#include "ores.refdata.api/eventing/series_subclass_code_event.hpp"
...
TEST_CASE("write_series_subclass_code_publishes_an_event", tags) {
    ...
    using event_type = ores::refdata::messaging::series_subclass_code_event;
    ...
    event_source.register_entity_event_mapping<event_type>("ores_refdata_series_subclass_codes");
