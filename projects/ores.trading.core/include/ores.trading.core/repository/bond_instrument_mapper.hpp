...
public:
    ...
    static std::vector<domain::bond_instrument>
    map(const std::vector<bond_instrument_entity>& v);
    static std::vector<bond_instrument_entity>
    map(const std::vector<domain::bond_instrument>& v);
};
