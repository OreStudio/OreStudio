...
register_day_count_fraction_type_event_mapping(ev::service::postgres_event_source& event_source,
    ...
    ev::service::registrar::register_mapping<
        refdata::eventing::day_count_fraction_type_changed_event>(
        event_source,
        "ores.refdata.day_count_fraction_type",
        "ores_refdata_day_count_fraction_types");

    return event_bus.subscribe<refdata::eventing::day_count_fraction_type_changed_event>(
        [&nats](const refdata::eventing::day_count_fraction_type_changed_event& e) {
            ev::service::publish_entity_event(
                nats,
                std::string(ev::domain::event_traits<
                            refdata::eventing::day_count_fraction_type_changed_event>::name),
