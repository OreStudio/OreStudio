...
#+description: Codegen entity model for the refdata =contact_type= table. Drives the C++ domain class, mapper, repository, service, generator, and SQL schema generation from a single literate source.
