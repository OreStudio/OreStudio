...
#include "ores.refdata.api/eventing/purpose_type_event.hpp"
...
TEST_CASE("write_purpose_type_publishes_an_event", tags) {
    ...
    using event_type = ores::refdata::messaging::purpose_type_event;
    ...
    event_source.register_entity_event_mapping<event_type>("ores_refdata_purpose_types");
