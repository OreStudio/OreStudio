 ...
 */
/**
 * Where the curve_role screens live and what they can do.
 *
 ...
 */
import { curveRoleMeta } from '../ui/curve_role_ui.js';
import type { EntityDescriptor } from '../../../entity/descriptor.js';

export const curveRoleDescriptor: EntityDescriptor = {
    component: 'refdata',
    entity: 'curve_role',
    meta: curveRoleMeta,
    routeSegment: 'curve-role',
    apiBase: '/api/roles',
    keyFields: [
        'code',
    ],
