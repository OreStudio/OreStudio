...
File storage endpoints for the distributed compute grid. All paths are under
=/api/v1/compute/=. No JWT authentication is required — these endpoints are
intended for internal use by the compute wrapper service.
...
| app_version_id | UUID of a compute app version          | 11111111-2222-3333-4444-555555555555 |
| workunit_id    | UUID of a compute workunit             | aaaaaaaa-bbbb-cccc-dddd-eeeeeeeeeeee |
| result_id      | UUID of a compute result               | 99999999-8888-7777-6666-555555555555 |
