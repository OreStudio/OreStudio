 ...
 *
 */
#ifndef ORES_COMPUTE_SERVICE_APP_APPLICATION_HPP
#define ORES_COMPUTE_SERVICE_APP_APPLICATION_HPP
...
/**
 * @brief Entry point for the ores.compute.service service.
 */
class application final {
private:
    inline static std::string_view logger_name = "ores.compute.service.app.application";
