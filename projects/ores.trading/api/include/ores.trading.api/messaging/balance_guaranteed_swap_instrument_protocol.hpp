 ...
 *
 */
#ifndef ORES_TRADING_API_MESSAGING_BALANCE_GUARANTEED_SWAP_INSTRUMENT_PROTOCOL_HPP
#define ORES_TRADING_API_MESSAGING_BALANCE_GUARANTEED_SWAP_INSTRUMENT_PROTOCOL_HPP
...
struct get_balance_guaranteed_swap_instruments_response {
    std::vector<ores::trading::domain::balance_guaranteed_swap_instrument>
...
struct save_balance_guaranteed_swap_instrument_request {
    ...
    static save_balance_guaranteed_swap_instrument_request
    from(ores::trading::domain::balance_guaranteed_swap_instrument v) {
