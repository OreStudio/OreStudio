...
| Risk        | 0x1000 - 0x1FFF | currencies, currency history, countries                                 |
| IAM         | 0x2000 - 0x2FFF | login, accounts, lock/unlock, rbac, signup, sessions, change management |
...
| Provides | Description                                              |
|----------+----------------------------------------------------------|
| =name=   | The event type name (e.g., "ores.risk.currency_changed") |
