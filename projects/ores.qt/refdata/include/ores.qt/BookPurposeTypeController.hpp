 ...
 */
#ifndef ORES_QT_BOOK_PURPOSE_TYPE_CONTROLLER_HPP
#define ORES_QT_BOOK_PURPOSE_TYPE_CONTROLLER_HPP
...
class BookPurposeTypeMdiWindow;
class BookPurposeTypeDetailDialog;
class DetachableMdiSubWindow;
class BadgeCache;
class ChangeReasonCache;

/**
 * @brief Controller for managing book purpose type windows and operations.
 *
 * Manages the lifecycle of book purpose type list, detail, and history windows.
 * Handles event subscriptions and coordinates between windows.
 */
class ORES_QT_REFDATA_EXPORT BookPurposeTypeController final : public EntityController {
    Q_OBJECT

private:
    inline static std::string_view logger_name = "ores.qt.book_purpose_type_controller";
...
public:
    BookPurposeTypeController(QMainWindow* mainWindow,
                              QMdiArea* mdiArea,
...
private slots:
    void onShowDetails(const refdata::domain::book_purpose_type& type);
...
private:
     ...
     * BookPurposeTypeDetailDialog needs regardless of which
     * window opened it (add/edit/history-version/revert) -- kept in one
     * place so those four call sites can't drift from each other.
     */
    void wireDetailDialogCommon(BookPurposeTypeDetailDialog* detailDialog);
