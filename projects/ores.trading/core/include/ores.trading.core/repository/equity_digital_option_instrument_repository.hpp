 ...
 *
 */
#ifndef ORES_TRADING_CORE_REPOSITORY_EQUITY_DIGITAL_OPTION_INSTRUMENT_REPOSITORY_HPP
#define ORES_TRADING_CORE_REPOSITORY_EQUITY_DIGITAL_OPTION_INSTRUMENT_REPOSITORY_HPP
...
public:
    ...
    /**
     * @brief Writes Equity Digital Option instruments to database.
     */
    /**@{*/
    ...
    /**
     * @brief Reads latest Equity Digital Option instruments, possibly filtered by primary key.
     */
    /**@{*/
    ...
    /**
     * @brief Reads all Equity Digital Option instruments, possibly filtered by primary key.
     */
    std::vector<domain::equity_digital_option_instrument>
    read_all(context ctx, const std::string& instrument_id);

    /**
     * @brief Reads a single Equity Digital Option instrument as it stood at a specific
    ...
    /**
     * @brief Reads latest Equity Digital Option instruments with pagination support.
     * @param ctx Repository context with database connection
     ...
     */
    std::uint32_t get_total_equity_digital_option_instrument_count(context ctx);

    /**
     * @brief Deletes a Equity Digital Option instrument by closing its temporal validity.
     */
    void remove(context ctx, const std::string& instrument_id);

    /**
     * @brief Deletes Equity Digital Option instruments by closing their temporal validity.
     */
