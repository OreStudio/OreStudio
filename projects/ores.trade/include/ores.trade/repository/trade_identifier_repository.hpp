 ...
 *
 */
#ifndef ORES_TRADE_REPOSITORY_TRADE_IDENTIFIER_REPOSITORY_HPP
#define ORES_TRADE_REPOSITORY_TRADE_IDENTIFIER_REPOSITORY_HPP
 ...
 */
class trade_identifier_repository {
private:
    inline static std::string_view logger_name =
        "ores.trade.repository.trade_identifier_repository";
