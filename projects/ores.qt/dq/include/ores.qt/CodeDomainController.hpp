...
/**
 * @brief Controller for managing code domain windows and operations.
 *
 * Manages the lifecycle of code domain list, detail, and history windows.
 * Handles event subscriptions and coordinates between windows.
 */
class CodeDomainController final : public EntityController {
    Q_OBJECT

private:
    inline static std::string_view logger_name = "ores.qt.code_domain_controller";
