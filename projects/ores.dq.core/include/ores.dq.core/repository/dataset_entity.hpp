 ...
 *
 */
#ifndef ORES_DQ_CORE_REPOSITORY_DATASET_ENTITY_HPP
#define ORES_DQ_CORE_REPOSITORY_DATASET_ENTITY_HPP
...
struct dataset_entity {
    ...
    constexpr static const char* tablename = "ores_dq_datasets_tbl";
