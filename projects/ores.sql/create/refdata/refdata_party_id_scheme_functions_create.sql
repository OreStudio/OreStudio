...
-- Validate coding_scheme_code is a known DQ coding scheme (optional soft FK).
-- Null/empty is allowed (coding_scheme_code is optional).
...
create or replace function ores_refdata_validate_party_id_scheme_coding_scheme_fn(
    p_tenant_id uuid,
    p_value text
) returns text as $$
begin
