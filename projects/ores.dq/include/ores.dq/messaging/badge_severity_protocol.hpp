...
// Badge Severity traits
template<>
struct message_traits<dq::messaging::get_badge_severities_request> {
    using request_type = dq::messaging::get_badge_severities_request;
    using response_type = dq::messaging::get_badge_severities_response;
    static constexpr message_type request_message_type =
        message_type::get_badge_severities_request;
};

template<>
struct message_traits<dq::messaging::save_badge_severity_request> {
    using request_type = dq::messaging::save_badge_severity_request;
    using response_type = dq::messaging::save_badge_severity_response;
    static constexpr message_type request_message_type =
        message_type::save_badge_severity_request;
};

template<>
struct message_traits<dq::messaging::delete_badge_severity_request> {
    using request_type = dq::messaging::delete_badge_severity_request;
    using response_type = dq::messaging::delete_badge_severity_response;
    static constexpr message_type request_message_type =
        message_type::delete_badge_severity_request;
};

template<>
struct message_traits<dq::messaging::get_badge_severity_history_request> {
    using request_type = dq::messaging::get_badge_severity_history_request;
    using response_type = dq::messaging::get_badge_severity_history_response;
    static constexpr message_type request_message_type =
        message_type::get_badge_severity_history_request;
};
