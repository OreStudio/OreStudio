...
| [[id:7FEA4D7A-E1A6-4FC4-B684-297FB7EA4FF7][Analyse temporal commands end-to-end for conceptual coherence]] | STARTED | 2026-06-07 | | Coherent model for fleet/journal/timeline; analysis doc gates implementation. |
...
- /One temporal model/ :: See the
  ...
  missing "everyone × past" quadrant — journal log for the fleet. One
  event stream (journals + agile-doc git history + gh) underlies all of
  them; snapshots are LLM-curated materialised views of it.
