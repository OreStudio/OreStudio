 ...
 */
#ifndef ORES_SHELL_APP_COMMANDS_COUNTERPARTY_IDENTIFIER_COMMANDS_HPP
#define ORES_SHELL_APP_COMMANDS_COUNTERPARTY_IDENTIFIER_COMMANDS_HPP
...
/**
 * @brief Every verb counterparty identifiers answer, as one command each.
 *
 ...
 */
class counterparty_identifier_commands {
private:
    inline static std::string_view logger_name =
        "ores.shell.app.commands.refdata.counterparty_identifier_commands";
...
public:
    /**
     * @brief Register the counterparty identifiers submenu.
     */
    ...
    /**
     * @brief add <id> <counterparty_id> <id_scheme> <id_value> <description> <reason> <commentary>
     */
