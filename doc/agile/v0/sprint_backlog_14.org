...
#+CAPTION: Clock summary at [2026-03-17 Tue 19:45], for Tuesday, March 17, 2026.
|      | <75>                   |        |      |      |       |
| Tags | Headline               | Time   |      |      |     % |
|------+------------------------+--------+------+------+-------|
...
|      | Stories                | 7:01   |      |      | 100.0 |
|      | Active                 |        | 7:01 |      | 100.0 |
| code | Remaining NATS changes |        |      | 7:01 | 100.0 |
#+end:

#+begin: clocktable :maxlevel 3 :scope subtree :tags t :indent nil :emphasize nil :scope file :narrow 75 :formula %
#+TBLNAME: sprint_summary
#+CAPTION: Clock summary at [2026-03-17 Tue 19:45]
|       | <75>                                                    |         |       |       |       |
| Tags  | Headline                                                | Time    |       |       |     % |
|-------+---------------------------------------------------------+---------+-------+-------+-------|
|       | *Total time*                                            | *79:48* |       |       | 100.0 |
|-------+---------------------------------------------------------+---------+-------+-------+-------|
|       | Stories                                                 | 79:48   |       |       | 100.0 |
|       | Active                                                  |         | 79:48 |       | 100.0 |
| agile | Sprint and product backlog refinement                   |         |       |  3:23 |   4.2 |
| code  | Add ORE Import Wizard                                   |         |       |  3:00 |   3.8 |
| code  | Add reporting component design document                 |         |       |  1:30 |   1.9 |
| code  | Add ores.reporting SQL schema                           |         |       |  1:20 |   1.7 |
| code  | Reporting: Add domain types, messaging and repository   |         |       |  1:50 |   2.3 |
| code  | Trading: Implement trade status state machine           |         |       |  0:59 |   1.2 |
| code  | Cli: Add domain sub-menu layer to CLI command syntax    |         |       |  1:35 |   2.0 |
| code  | Add pgmq queue management and messaging UI              |         |       |  0:34 |   0.7 |
| code  | Reporting UI: cron widget, and party codename plan      |         |       |  8:19 |  10.4 |
| code  | Add party codename and report scheduling UI             |         |       |  7:19 |   9.2 |
| code  | Replace pgmq + pg_cron with custom tables and scheduler |         |       |  2:54 |   3.6 |
| code  | Fix TOCTOU race in party codename generation trigger    |         |       |  1:10 |   1.5 |
| code  | Migrate JWT to ores.security with RS256 support         |         |       |  0:07 |   0.1 |
| code  | Implement NNG message broker                            |         |       |  8:55 |  11.2 |
| code  | Add build tool suffix to all CMake presets              |         |       |  2:10 |   2.7 |
| code  | Fix codename with sequence-based unique suffix          |         |       |  0:45 |   0.9 |
| code  | Hook up broker and comms service                        |         |       |  0:47 |   1.0 |
| code  | Implement NATS support                                  |         |       | 11:55 |  14.9 |
| code  | Rename =ores.comms.shell= to =ores.shell=               |         |       |  3:25 |   4.3 |
| code  | Add NATS telemetry sampling                             |         |       |  2:30 |   3.1 |
| code  | Add trade import mapping dialog to Qt UI                |         |       |  4:39 |   5.8 |
| code  | Remaining NATS changes                                  |         |       | 10:42 |  13.4 |
#+end:
...
*** STARTED Remaining NATS changes                                     :code:
    :LOGBOOK:
    CLOCK: [2026-03-17 Tue 23:21]
