...
Optional soft FK to business_centres by code (e.g. "GBLO", "USNY"),
reusing the same location reference already used by
...
| rates_centre_code    | Rates Centre          | ratesCentreCodeCombo    | flagged_combo |        |             |                               | business_centre   | true               | fetch_business_centre_codes | | ores.qt/LookupFetcher.hpp  |                               |                           |                   |                      |                   |                        |                           |                       |
