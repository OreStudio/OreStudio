:PROPERTIES:
:ID: F96D0CE0-0CFA-4250-9633-A1B6980E041B
:END:
#+title: Feature: soft_fk_validations
#+description: Soft foreign-key validations to emit in the insert trigger.
#+type: feature
#+level: cross
...
| Field | Value |
|-------+-------|
| Literal name | =:soft_fk_validations:= |
...
Soft foreign-key validations to emit in the insert trigger, validating a referenced row exists without a real FK constraint.

* Structural consequence

Yes — adds validation calls to the generated insert-trigger function.
