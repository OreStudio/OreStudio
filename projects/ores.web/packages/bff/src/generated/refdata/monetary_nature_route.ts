 ...
 */
/**
 * How the BFF reaches the monetary_nature service.
 *
 ...
 */
import { subjects } from '@ores/wire-protocol/generated/refdata/protocol/monetary_nature_protocol';
...
export const monetaryNatureRoute: EntityRouteDescriptor = {
  ...
  subjects: {
    ...
    save: subjects.put_monetary_nature_request,
    remove: subjects.delete_monetary_nature_request,
