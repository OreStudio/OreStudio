...
| Now           | Restructuring the agile process into per-concept pages; roadmap page in flight on its own branch. |
| Waiting on    | Nothing.                               |
| Next          | Land the restructure PR; then the smaller additions. |
