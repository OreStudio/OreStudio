...
The =ores_admin= database contains cluster-level utilities for database
management. These must be set up before using the list/delete recipes below.

*** Setup Admin Database

One-time setup to create the =ores_admin= database with management utilities:
...
This creates:
- Whimsical name generation functions
- Database listing and creation helpers
- Cleanup views and functions

** Database Management

All database management recipes require =ores_admin= to be set up first.
