 ...
 *   SELECT * FROM metadata.dq_preview_coding_scheme_population_fn(dataset_id);
 *
 ...
 */
create or replace function metadata.dq_preview_coding_scheme_population_fn(p_dataset_id uuid)
returns table (
    action text,
    code text,
    name text,
