 ...
 */
#ifndef ORES_QT_TENOR_KIND_CONTROLLER_HPP
#define ORES_QT_TENOR_KIND_CONTROLLER_HPP
...
class TenorKindMdiWindow;
class TenorKindDetailDialog;
class DetachableMdiSubWindow;
class ChangeReasonCache;

/**
 * @brief Controller for managing tenor kind windows and operations.
 *
 * Manages the lifecycle of tenor kind list, detail, and history windows.
 * Handles event subscriptions and coordinates between windows.
 */
class ORES_QT_REFDATA_EXPORT TenorKindController final : public EntityController {
    Q_OBJECT

private:
    inline static std::string_view logger_name = "ores.qt.tenor_kind_controller";
...
public:
    TenorKindController(QMainWindow* mainWindow,
                        QMdiArea* mdiArea,
...
private slots:
    void onShowDetails(const refdata::domain::tenor_kind& kind);
