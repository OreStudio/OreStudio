 ...
 */
#ifndef ORES_SHELL_APP_COMMANDS_CURRENCY_PAIR_COMMANDS_HPP
#define ORES_SHELL_APP_COMMANDS_CURRENCY_PAIR_COMMANDS_HPP
...
/**
 * @brief Every verb currency pairs answer, as one command each.
 *
 ...
 */
class currency_pair_commands {
private:
    inline static std::string_view logger_name =
        "ores.shell.app.commands.refdata.currency_pair_commands";
...
public:
    /**
     * @brief Register the currency pairs submenu.
     */
    ...
    /**
     * @brief add <pair_code> <base_currency> <quote_currency> <classification> <reason>
     * <commentary>
     */
    ...
    /**
     * @brief set <pair_code> <base_currency> <quote_currency> <classification> <reason>
    ...
    /**
     * @brief put-many --count <n> <pair_code> <base_currency> <quote_currency> <classification>
     * <reason> <commentary>
     */
