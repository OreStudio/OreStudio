 ...
 *   SELECT * FROM metadata.dq_preview_person_role_population_fn(dataset_id);
 *
 *   -- Publish to production
 *   SELECT * FROM metadata.dq_populate_person_roles_fn(dataset_id, 'upsert');
 */
 ...
 */
create or replace function metadata.dq_preview_person_role_population_fn(p_dataset_id uuid)
returns table (
    action text,
    code text,
 ...
 */
create or replace function metadata.dq_populate_person_roles_fn(
    p_dataset_id uuid,
