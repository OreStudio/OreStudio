 ...
 *
 */
#ifndef ORES_TRADING_API_MESSAGING_VANILLA_SWAP_INSTRUMENT_PROTOCOL_HPP
#define ORES_TRADING_API_MESSAGING_VANILLA_SWAP_INSTRUMENT_PROTOCOL_HPP
...
struct get_vanilla_swap_instruments_response {
    std::vector<ores::trading::domain::vanilla_swap_instrument> vanilla_swap_instruments;
...
struct save_vanilla_swap_instrument_request {
    ...
    static save_vanilla_swap_instrument_request
    from(ores::trading::domain::vanilla_swap_instrument v) {
