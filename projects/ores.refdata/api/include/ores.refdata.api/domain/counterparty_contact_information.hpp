 ...
 *
 */
#ifndef ORES_REFDATA_API_DOMAIN_COUNTERPARTY_CONTACT_INFORMATION_HPP
#define ORES_REFDATA_API_DOMAIN_COUNTERPARTY_CONTACT_INFORMATION_HPP
 ...
 */
struct counterparty_contact_information final {
    /**
    ...
    /**
     * @brief The counterparty this contact information belongs to.
     *
...
/**
 * @brief Dispatch-key identifier for counterparty_contact_information, e.g. for the
 * generic history-diff request and action registries. Single source
 * of truth: every call site spells entity_type_of(value) regardless
 * of which entity it holds.
 */
[[nodiscard]] constexpr std::string_view entity_type_of(const counterparty_contact_information&) {
    return "ores.refdata.counterparty_contact_information";
}
