...
set(files
    ...
    "service/processes/affine_term_structure_process.cpp"
    "service/processes/arithmetic_gaussian_mixture_model_process.cpp"
    "service/processes/black_derman_toy_process.cpp"
    "service/processes/black_karasinski_process.cpp"
    "service/processes/cox_ingersoll_ross_process.cpp"
    "service/processes/gaussian_mixture_model_process.cpp"
    "service/processes/heath_jarrow_morton_process.cpp"
    "service/processes/hull_white_process.cpp"
    "service/processes/libor_market_model_process.cpp"
    "service/processes/ornstein_uhlenbeck_process.cpp"
    "service/processes/quadratic_gaussian_process.cpp"
    "service/processes/two_factor_gaussian_process.cpp"
...
set(HEADERS
    ...
    "${CMAKE_CURRENT_SOURCE_DIR}/../include/ores.analytics.quant/math/psd_matrix.hpp"
    ...
    "${CMAKE_CURRENT_SOURCE_DIR}/../include/ores.analytics.quant/service/processes/affine_term_structure_params.hpp"
    "${CMAKE_CURRENT_SOURCE_DIR}/../include/ores.analytics.quant/service/processes/affine_term_structure_process.hpp"
    "${CMAKE_CURRENT_SOURCE_DIR}/../include/ores.analytics.quant/service/processes/arithmetic_gaussian_mixture_model_process.hpp"
    "${CMAKE_CURRENT_SOURCE_DIR}/../include/ores.analytics.quant/service/processes/black_derman_toy_params.hpp"
    "${CMAKE_CURRENT_SOURCE_DIR}/../include/ores.analytics.quant/service/processes/black_derman_toy_process.hpp"
    "${CMAKE_CURRENT_SOURCE_DIR}/../include/ores.analytics.quant/service/processes/black_karasinski_params.hpp"
    "${CMAKE_CURRENT_SOURCE_DIR}/../include/ores.analytics.quant/service/processes/black_karasinski_process.hpp"
    "${CMAKE_CURRENT_SOURCE_DIR}/../include/ores.analytics.quant/service/processes/cox_ingersoll_ross_params.hpp"
    ...
    "${CMAKE_CURRENT_SOURCE_DIR}/../include/ores.analytics.quant/service/processes/heath_jarrow_morton_params.hpp"
    "${CMAKE_CURRENT_SOURCE_DIR}/../include/ores.analytics.quant/service/processes/heath_jarrow_morton_process.hpp"
    "${CMAKE_CURRENT_SOURCE_DIR}/../include/ores.analytics.quant/service/processes/hull_white_params.hpp"
    "${CMAKE_CURRENT_SOURCE_DIR}/../include/ores.analytics.quant/service/processes/hull_white_process.hpp"
    "${CMAKE_CURRENT_SOURCE_DIR}/../include/ores.analytics.quant/service/processes/libor_market_model_params.hpp"
    "${CMAKE_CURRENT_SOURCE_DIR}/../include/ores.analytics.quant/service/processes/libor_market_model_process.hpp"
    "${CMAKE_CURRENT_SOURCE_DIR}/../include/ores.analytics.quant/service/processes/ornstein_uhlenbeck_process.hpp"
    "${CMAKE_CURRENT_SOURCE_DIR}/../include/ores.analytics.quant/service/processes/quadratic_gaussian_params.hpp"
    "${CMAKE_CURRENT_SOURCE_DIR}/../include/ores.analytics.quant/service/processes/quadratic_gaussian_process.hpp"
    "${CMAKE_CURRENT_SOURCE_DIR}/../include/ores.analytics.quant/service/processes/two_factor_gaussian_params.hpp"
    "${CMAKE_CURRENT_SOURCE_DIR}/../include/ores.analytics.quant/service/processes/two_factor_gaussian_process.hpp"
    "${CMAKE_CURRENT_SOURCE_DIR}/../include/ores.analytics.quant/service/processes/vasicek_params.hpp"
