...
#+level: cross
#+filetags: :llm:memory:reference:bearings:
#+created: 2026-05-28
#+updated: 2026-08-10

The =compass.sh= wrapper lives at [[proj:projects/ores.compass/compass.sh][=./projects/ores.compass/compass.sh=]].
Core commands:
...
- *Show* (read a doc by title or UUID prefix):
  ...
  Use =--full= to see the complete body contents; without it, show
  prints only metadata and links:
  =compass.sh show <id> --full=
