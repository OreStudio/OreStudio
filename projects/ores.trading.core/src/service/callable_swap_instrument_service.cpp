...
callable_swap_instrument_service::list_callable_swap_instruments(
    ...
    BOOST_LOG_SEV(lg(), debug) << "Listing callable_swap_instruments with offset="
                               << offset << ", limit=" << limit;
...
std::uint32_t
callable_swap_instrument_service::count_callable_swap_instruments() {
...
callable_swap_instrument_service::get_callable_swap_instrument_history(
    ...
    BOOST_LOG_SEV(lg(), debug)
        << "Getting history for callable_swap_instrument: " << id;
