...
#+CAPTION: Clock summary at [2024-07-04 Thu 09:01]
| <75>                                    |         |       |      |       |
| Headline                                | Time    |       |      |     % |
|-----------------------------------------+---------+-------+------+-------|
...
| Create and upload a package             |         |       | 3:28 |  10.3 |
| Create a basic project structure        |         |       | 2:10 |   6.5 |
| Add a Qt hello world                    |         |       | 3:08 |   9.3 |
...
| Add nightly support with memcheck       |         |       | 3:21 |  10.0 |
| Clean up toolchains and presets         |         |       | 1:53 |   5.6 |
...
| Copy domain notes on core concepts      |         |       | 2:51 |   8.5 |
#+end:
