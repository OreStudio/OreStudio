...
- =calendar_dates= starts empty on a fresh database -- it is only
  materialised by the *Regenerate* action, never by provisioning.
  Click *Regenerate*, accept the default end year, and confirm the
  dialog reports success with a nonzero rows-written count.
