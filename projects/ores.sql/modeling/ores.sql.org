...
- =currency_images_populate.sql= - Sets image_id on currencies to link to flag images
...
| Script                            | Purpose                                    |
|-----------------------------------+--------------------------------------------|
| =setup_extensions.sql=            | Install PostgreSQL extensions              |
| =setup_user.sql=                  | Create application user                    |
