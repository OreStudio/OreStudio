 ...
 *
 */
#include "ores.trading.core/presentation/equity_option_instrument_history_field_mapper.hpp"
...
render_equity_option_instrument_fields(const domain::equity_option_instrument& v) {
    ...
    fields.push_back({.name = "Cliquet Frequency", .value = v.cliquet_frequency});
