 ...
 *
 */
#ifndef ORES_DQ_API_EVENTING_REPORT_DEFINITION_CHANGED_EVENT_HPP
#define ORES_DQ_API_EVENTING_REPORT_DEFINITION_CHANGED_EVENT_HPP
 ...
 */
template <>
struct event_traits<ores::dq::eventing::report_definition_changed_event> {
    static constexpr std::string_view name = "ores.dq.report_definition_changed";
};
