...
#+CAPTION: Clock summary at [2025-09-27 Sat 00:11], for Saturday, September 27, 2025.
|      | <75>                                          |        |      |      |       |
| Tags | Headline                                      | Time   |      |      |     % |
|------+-----------------------------------------------+--------+------+------+-------|
...
|      | Stories                                       | 0:11   |      |      | 100.0 |
|      | Active                                        |        | 0:11 |      | 100.0 |
| code | Refactor code to follow new project structure |        |      | 0:11 | 100.0 |
#+end:

#+begin: clocktable :maxlevel 3 :scope subtree :tags t :indent nil :emphasize nil :scope file :narrow 75 :formula %
#+TBLNAME: sprint_summary
#+CAPTION: Clock summary at [2025-09-27 Sat 00:11]
|          | <75>                                               |         |       |      |       |
| Tags     | Headline                                           | Time    |       |      |     % |
|----------+----------------------------------------------------+---------+-------+------+-------|
|          | *Total time*                                       | *49:44* |       |      | 100.0 |
|----------+----------------------------------------------------+---------+-------+------+-------|
|          | Stories                                            | 49:44   |       |      | 100.0 |
|          | Active                                             |         | 49:44 |      | 100.0 |
| agile    | Sprint and product backlog refinement              |         |       | 2:15 |   4.5 |
| infra    | Fix broken builds                                  |         |       | 0:36 |   1.2 |
| code     | Create a containing structure for data             |         |       | 0:35 |   1.2 |
| code     | Add temporal support to currencies                 |         |       | 2:59 |   6.0 |
| code     | Add command to dump currencies                     |         |       | 4:18 |   8.6 |
| code     | Refactor code for currencies                       |         |       | 3:52 |   7.8 |
| code     | Restore qt setup                                   |         |       | 2:20 |   4.7 |
| code     | Add gemini action                                  |         |       | 0:05 |   0.2 |
| code     | Remove ImGui support                               |         |       | 0:08 |   0.3 |
| code     | Create a GRPC based service                        |         |       | 2:09 |   4.3 |
| code     | Implement a 0MQ based RPC service and client       |         |       | 3:55 |   7.9 |
| code     | Fix misspell fixer errors                          |         |       | 0:08 |   0.3 |
| code     | Remove URL support from prog mode in emacs         |         |       | 0:14 |   0.5 |
| code     | Remove GRPC support                                |         |       | 0:16 |   0.5 |
| code     | Implement a cobalt based server and client         |         |       | 2:53 |   5.8 |
| code     | Add serialisation support for reflect-cpp          |         |       | 3:07 |   6.3 |
| analysis | White-boarding for new architecture                |         |       | 1:52 |   3.8 |
| code     | Use sqlgen for postgres                            |         |       | 7:23 |  14.8 |
| code     | Completions in emacs org mode are incorrect        |         |       | 1:02 |   2.1 |
| infra    | Investigate build warning for vcpkg binary caching |         |       | 0:25 |   0.8 |
| infra    | Investigate build warning for qtbase               |         |       | 0:10 |   0.3 |
| analysis | Investigate bitemporal support from Postgres 18    |         |       | 1:47 |   3.6 |
| code     | Fix windows and osx builds                         |         |       | 0:27 |   0.9 |
| code     | Fix gemini cli action                              |         |       | 0:45 |   1.5 |
| infra    | vcpkg caching seems disabled                       |         |       | 0:15 |   0.5 |
| code     | Create a =comms= library                           |         |       | 1:10 |   2.3 |
| code     | Refactor code to follow new project structure      |         |       | 3:25 |   6.9 |
| code     | Add workspace as a container                       |         |       | 1:13 |   2.4 |
#+end:
...
*** STARTED Refactor code to follow new project structure              :code:
    :LOGBOOK:
...
As defined in analysis story.

- refactor CLI with new approach.
