 ...
 *
 */
#ifndef ORES_REFDATA_REPOSITORY_PURPOSE_TYPE_REPOSITORY_HPP
#define ORES_REFDATA_REPOSITORY_PURPOSE_TYPE_REPOSITORY_HPP
...
private:
    inline static std::string_view logger_name =
        "ores.refdata.repository.purpose_type_repository";
