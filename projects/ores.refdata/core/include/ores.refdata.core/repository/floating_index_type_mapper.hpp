 ...
 *
 */
#ifndef ORES_REFDATA_CORE_REPOSITORY_FLOATING_INDEX_TYPE_MAPPER_HPP
#define ORES_REFDATA_CORE_REPOSITORY_FLOATING_INDEX_TYPE_MAPPER_HPP
 ...
 */
class ORES_REFDATA_CORE_EXPORT floating_index_type_mapper {
private:
    inline static std::string_view logger_name =
        "ores.refdata.repository.floating_index_type_mapper";
