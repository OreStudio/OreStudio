...
| [[id:C0B2C614-5743-4826-967B-A5FCC91504EF][Curve review/sign-off UI: approve a bootstrapped generation before it goes official]] | ABANDONED | | 2026-09-23 | A human review gate between a curve bootstrap run and its publish to output_series_id -- QC checks, diff vs prior generation, pillar-quote override, and an explicit approve action -- so pricers only ever read an approved generation, matching how production trading systems gate bootstrapped curves before desks consume them. |
...
Closed at sprint 25 close. The acceptance is met: the bootstrap engine, the official curve republish, the derivation lineage and the bootstrap config all shipped. The open UI tasks targeted the Qt client, which was removed. The capture [[id:2120576C-C1D1-4F94-875B-D44984EADD9E][Refactor the IR rates implementation before more IR features land]] carries the curve templates and the sign-off step forward as ores.web screens.
