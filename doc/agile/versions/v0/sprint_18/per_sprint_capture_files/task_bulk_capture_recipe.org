...
- Recipe =how_do_i_bulk_capture_from_freeform_text.org= exists in [[proj:doc/recipes/compass][=doc/recipes/compass/=]].
...
Created [[proj:doc/recipes/compass/how_do_i_bulk_capture_from_freeform_text.org][=doc/recipes/compass/how_do_i_bulk_capture_from_freeform_text.org=]] with workflow, example, and post-capture guidance. Updated =how_do_i_create_a_pr.org= and =how_do_i_commit_to_git_using_ore_studio_conventions.org= with Story-ID/Task-ID conventions. Merged in PR #876.
