...
Create [[proj:doc/downloads.org][=doc/downloads.org=]] — a hand-maintained release index listing
...
- [[proj:doc/downloads.org][=doc/downloads.org=]] exists with =#+type: knowledge= frontmatter and a
