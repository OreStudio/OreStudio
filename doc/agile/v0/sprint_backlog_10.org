...
#+CAPTION: Clock summary at [2026-01-25 Sun 03:55], for Sunday, January 25, 2026.
|       | <75>                                         |        |      |      |       |
| Tags  | Headline                                     | Time   |      |      |     % |
|-------+----------------------------------------------+--------+------+------+-------|
...
|       | Stories                                      | 5:20   |      |      | 100.0 |
|       | Active                                       |        | 5:20 |      | 100.0 |
| agile | Sprint and product backlog refinement        |        |      | 0:13 |   4.1 |
| code  | Add mapping artefact to population functions |        |      | 0:30 |   9.4 |
| code  | Add a ORE component for import/export        |        |      | 4:00 |  75.0 |
| code  | Add FPML export and import                   |        |      | 0:19 |   5.9 |
| code  | Base the compute approach on BOINC           |        |      | 0:18 |   5.6 |
#+end:

#+begin: clocktable :maxlevel 3 :scope subtree :tags t :indent nil :emphasize nil :scope file :narrow 75 :formula %
#+TBLNAME: sprint_summary
#+CAPTION: Clock summary at [2026-01-25 Sun 03:55]
|       | <75>                                                |         |       |      |       |
| Tags  | Headline                                            | Time    |       |      |     % |
|-------+-----------------------------------------------------+---------+-------+------+-------|
|       | *Total time*                                        | *46:22* |       |      | 100.0 |
|-------+-----------------------------------------------------+---------+-------+------+-------|
|       | Stories                                             | 46:22   |       |      | 100.0 |
|       | Active                                              |         | 46:22 |      | 100.0 |
| agile | Sprint and product backlog refinement               |         |       | 1:17 |   2.8 |
| infra | OCR scan notebooks for this sprint                  |         |       | 6:20 |  13.7 |
| code  | Create a simple code generator                      |         |       | 7:38 |  16.5 |
| code  | Party related schemes                               |         |       | 5:20 |  11.5 |
| code  | Image cache not reloading on new datasets           |         |       | 1:43 |   3.7 |
| code  | Create a script to download and split GLEIF data    |         |       | 0:25 |   0.9 |
| code  | Incremental image cache loading with modified_since |         |       | 0:31 |   1.1 |
| code  | Fix issues with misspell action                     |         |       | 2:47 |   6.0 |
| code  | Tidy-up external data storage                       |         |       | 3:33 |   7.7 |
| code  | Coding schemes are in production tables             |         |       | 1:39 |   3.6 |
| code  | Refactor SQL directories                            |         |       | 3:24 |   7.3 |
| code  | Code-generate ER diagram                            |         |       | 3:01 |   6.5 |
| code  | Add "words" to icons                                |         |       | 0:28 |   1.0 |
| code  | Add mapping artefact to population functions        |         |       | 2:19 |   5.0 |
| code  | Add a ORE component for import/export               |         |       | 4:00 |   8.6 |
| code  | Add code generation support for domain types SQL    |         |       | 1:20 |   2.9 |
