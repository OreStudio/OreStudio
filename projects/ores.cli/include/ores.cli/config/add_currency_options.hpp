 ...
 *
 */
#ifndef ORES_CLI_CONFIG_ADD_CURRENCY_OPTIONS_HPP
#define ORES_CLI_CONFIG_ADD_CURRENCY_OPTIONS_HPP
...
/**
 * @brief Configuration for adding a currency entity via command-line arguments.
 */
struct add_currency_options final {
    std::string iso_code;
    std::string name;
    ...
    std::optional<std::string> monetary_nature;
