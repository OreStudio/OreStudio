 ...
 *   SELECT * FROM metadata.dq_populate_regulatory_corporate_sectors(dataset_id, 'upsert');
 */
 ...
 */
create or replace function metadata.dq_populate_regulatory_corporate_sectors(
    p_dataset_id uuid,
