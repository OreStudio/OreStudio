 ...
 *
 */
#include "ores.mq.service/app/application.hpp"

#include <boost/throw_exception.hpp>
#include "ores.database/service/context_factory.hpp"
#include "ores.utility/version/version.hpp"
#include "ores.mq.service/app/application_exception.hpp"
...
application::run(boost::asio::io_context& /*io_ctx*/,
    ...
    BOOST_LOG_SEV(lg(), warn) << "ores.mq.service service is not yet implemented.";
    co_return;
}
