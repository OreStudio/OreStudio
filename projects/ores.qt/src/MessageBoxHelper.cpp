...
QMessageBox::StandardButton MessageBoxHelper::question(
    ...
    QIcon questionIcon = createColoredIcon(":/icons/ic_fluent_question_20_filled.svg", iconColor);
    ...
    if (buttons & QMessageBox::Yes) {
        ...
        if (yesButton) {
            QIcon checkIcon = createColoredIcon(":/icons/ic_fluent_checkmark_20_filled.svg", iconColor);
            if (!checkIcon.isNull()) {
    ...
    if (buttons & QMessageBox::No) {
        ...
        if (noButton) {
            QIcon dismissIcon = createColoredIcon(":/icons/ic_fluent_dismiss_20_filled.svg", iconColor);
...
void MessageBoxHelper::warning(
    ...
    // Use warning icon
    const QColor iconColor(220, 220, 220);
    QIcon warningIcon = createColoredIcon(":/icons/ic_fluent_warning_20_filled.svg", iconColor);
...
void MessageBoxHelper::critical(
    ...
    const QColor iconColor(220, 220, 220);
    QIcon criticalIcon = createColoredIcon(":/icons/ic_fluent_error_circle_20_filled.svg", iconColor);
...
void MessageBoxHelper::information(
    ...
    const QColor iconColor(220, 220, 220);
    QIcon infoIcon = createColoredIcon(":/icons/ic_fluent_info_20_filled.svg", iconColor);
    if (!infoIcon.isNull()) {
