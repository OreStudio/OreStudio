 ...
 */
#ifndef ORES_SHELL_APP_COMMANDS_CURRENCY_MARKET_TIER_COMMANDS_HPP
#define ORES_SHELL_APP_COMMANDS_CURRENCY_MARKET_TIER_COMMANDS_HPP
...
/**
 * @brief Every verb currency market tiers answer, as one command each.
 *
 ...
 */
class currency_market_tier_commands {
private:
    inline static std::string_view logger_name =
        "ores.shell.app.commands.refdata.currency_market_tier_commands";
...
public:
    /**
     * @brief Register the currency market tiers submenu.
     */
