...
#+CAPTION: Clock summary at [2026-02-24 Tue 22:55], for Tuesday, February 24, 2026.
|      | <75>                                                |         |       |      |       |
| Tags | Headline                                            | Time    |       |      |     % |
|------+-----------------------------------------------------+---------+-------+------+-------|
|      | *Total time*                                        | *12:03* |       |      | 100.0 |
|------+-----------------------------------------------------+---------+-------+------+-------|
|      | Stories                                             | 12:03   |       |      | 100.0 |
|      | Active                                              |         | 12:03 |      | 100.0 |
| code | Enhance currency taxonomy                           |         |       | 2:06 |  17.4 |
| code | Books, portfolios and trades are not party specific |         |       | 2:59 |  24.8 |
| code | Minor improvements to connection browser            |         |       | 1:17 |  10.7 |
| code | Add portfolio explorer                              |         |       | 3:50 |  31.8 |
| code | Add party level currency and country restrictions   |         |       | 0:46 |   6.4 |
| code | Rename currency asset classes                       |         |       | 1:05 |   9.0 |
#+end:

#+begin: clocktable :maxlevel 3 :scope subtree :tags t :indent nil :emphasize nil :scope file :narrow 75 :formula %
#+TBLNAME: sprint_summary
#+CAPTION: Clock summary at [2026-02-24 Tue 22:55]
|       | <75>                                                  |         |       |       |       |
| Tags  | Headline                                              | Time    |       |       |     % |
|-------+-------------------------------------------------------+---------+-------+-------+-------|
|       | *Total time*                                          | *38:05* |       |       | 100.0 |
|-------+-------------------------------------------------------+---------+-------+-------+-------|
|       | Stories                                               | 38:05   |       |       | 100.0 |
|       | Active                                                |         | 38:05 |       | 100.0 |
| agile | Sprint and product backlog refinement                 |         |       |  0:26 |   1.1 |
| infra | Generate release notes for previous sprint            |         |       |  1:16 |   3.3 |
| code  | Merge FSM into DQ                                     |         |       |  0:34 |   1.5 |
| code  | Make all details dialogs tabbed                       |         |       |  2:26 |   6.4 |
| code  | Provenance: Fix performed by and modified by stamping |         |       |  3:17 |   8.6 |
| code  | Add plotting of session data                          |         |       |  1:19 |   3.5 |
| code  | Add account-party management and login support        |         |       | 13:43 |  36.0 |
| code  | Add rounding type entity                              |         |       |  1:40 |   4.4 |
| code  | Polish business centre UI and data quality            |         |       |  0:58 |   2.5 |
| code  | Enhance currency taxonomy                             |         |       |  2:06 |   5.5 |
| code  | Books, portfolios and trades are not party specific   |         |       |  2:59 |   7.8 |
| code  | Minor improvements to connection browser              |         |       |  1:17 |   3.4 |
| code  | Add portfolio explorer                                |         |       |  4:13 |  11.1 |
| code  | Add party level currency and country restrictions     |         |       |  0:46 |   2.0 |
| code  | Rename currency asset classes                         |         |       |  1:05 |   2.8 |
#+end:
...
*** STARTED Add portfolio explorer                                     :code:
    ...
    CLOCK: [2026-02-24 Tue 18:37]--[2026-02-24 Tue 19:30] =>  0:53
...
*** STARTED Rename currency asset classes                              :code:
    :LOGBOOK:
...
*** Remove toolbars from detail dialogs                                :code:
