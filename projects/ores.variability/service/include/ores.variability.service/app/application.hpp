 ...
 *
 */
#ifndef ORES_VARIABILITY_SERVICE_APP_APPLICATION_HPP
#define ORES_VARIABILITY_SERVICE_APP_APPLICATION_HPP
...
/**
 * @brief Entry point for the ores.variability.service service.
 */
class application final {
private:
    inline static std::string_view logger_name = "ores.variability.service.app.application";
