...
register_fx_spot_generation_config_event_mapping(ev::service::postgres_event_source& event_source,
    ...
    ev::service::registrar::register_mapping<
        synthetic::eventing::fx_spot_generation_config_changed_event>(
        event_source,
        "ores.synthetic.fx_spot_generation_config",
        "ores_synthetic_fx_spot_generation_configs");

    return event_bus.subscribe<synthetic::eventing::fx_spot_generation_config_changed_event>(
        [&nats](const synthetic::eventing::fx_spot_generation_config_changed_event& e) {
