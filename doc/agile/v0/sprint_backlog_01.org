...
#+CAPTION: Clock summary at [2024-07-26 Fri 00:12]
|       | <75>                                               |         |       |       |       |
| Tags  | Headline                                           | Time    |       |       |     % |
|-------+----------------------------------------------------+---------+-------+-------+-------|
|       | *Total time*                                       | *78:24* |       |       | 100.0 |
|-------+----------------------------------------------------+---------+-------+-------+-------|
|       | Stories                                            | 78:24   |       |       | 100.0 |
|       | Active                                             |         | 78:24 |       | 100.0 |
...
| infra | Create and upload a package                        |         |       |  3:28 |   4.4 |
...
| code  | Add command line options support                   |         |       |  5:45 |   7.3 |
...
| infra | Setup laptop for development                       |         |       |  3:47 |   4.8 |
| infra | Add database support for currency                  |         |       |  1:19 |   1.7 |
| code  | Add XML parsing support for currency               |         |       |  6:32 |   8.3 |
...
| code  | Refactor Qt UI                                     |         |       | 10:05 |  12.9 |
...
| infra | Use Qt SQL classes                                 |         |       |  1:24 |   1.8 |
#+end:
...
*** STARTED Use Qt SQL classes                                        :infra:
    :LOGBOOK:
    CLOCK: [2024-07-25 Thu 23:24]--[2024-07-26 Fri 00:12] =>  0:48
