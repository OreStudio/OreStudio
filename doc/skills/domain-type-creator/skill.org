...
Creating a complete domain type involves significant work across multiple files. To
keep PRs reviewable, the implementation is split into phases with designated
checkpoints.
...
6. Rebase your branch onto =origin/main= before starting the next phase.
...
5. Rebase onto =origin/main= after merge.
