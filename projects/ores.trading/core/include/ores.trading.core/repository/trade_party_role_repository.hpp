 ...
 *
 */
#ifndef ORES_TRADING_CORE_REPOSITORY_TRADE_PARTY_ROLE_REPOSITORY_HPP
#define ORES_TRADING_CORE_REPOSITORY_TRADE_PARTY_ROLE_REPOSITORY_HPP
...
/**
 * @brief Reads and writes trade party roles to data storage.
 */
class ORES_TRADING_CORE_EXPORT trade_party_role_repository {
private:
    inline static std::string_view logger_name =
        "ores.trading.repository.trade_party_role_repository";
...
public:
    ...
    /**
     * @brief Writes trade party roles to database.
     */
    /**@{*/
    void write(context ctx, const domain::trade_party_role& v);
    void write(context ctx, const std::vector<domain::trade_party_role>& v);
    /**@}*/

    /**
     * @brief Reads latest trade party roles, possibly filtered by primary key.
     */
    /**@{*/
    ...
    /**
     * @brief Reads latest trade party roles with pagination support.
     * @param ctx Repository context with database connection
