 ...
 */
#ifndef ORES_SHELL_APP_COMMANDS_WORKFLOW_INSTANCE_COMMANDS_HPP
#define ORES_SHELL_APP_COMMANDS_WORKFLOW_INSTANCE_COMMANDS_HPP
...
/**
 * @brief Every verb workflow instances answer, as one command each.
 *
 ...
 */
class workflow_instance_commands {
private:
    inline static std::string_view logger_name =
        "ores.shell.app.commands.workflow.workflow_instance_commands";
...
public:
    /**
     * @brief Register the workflow instances submenu.
     */
