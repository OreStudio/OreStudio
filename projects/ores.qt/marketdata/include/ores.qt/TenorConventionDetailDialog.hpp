 ...
 *
 */
#ifndef ORES_QT_TENOR_CONVENTION_DETAIL_DIALOG_HPP
#define ORES_QT_TENOR_CONVENTION_DETAIL_DIALOG_HPP
...
/**
 * @brief Detail dialog for viewing and editing tenor convention records.
 *
 * This dialog allows viewing, creating, and editing tenor conventions.
 * It supports both create mode (for new records) and edit mode (for
 * existing records).
 */
class TenorConventionDetailDialog final : public DetailDialogBase {
    Q_OBJECT

private:
    inline static std::string_view logger_name = "ores.qt.tenor_convention_detail_dialog";
...
public:
    explicit TenorConventionDetailDialog(QWidget* parent = nullptr);
    ~TenorConventionDetailDialog() override;

    void setClientManager(ClientManager* clientManager);
    void setUsername(const std::string& username);
    void setConvention(const marketdata::domain::tenor_convention& convention);
...
private:
    ...
    marketdata::domain::tenor_convention convention_;
