:PROPERTIES:
:ID: F54C24B8-6CC0-43EA-A26B-2F196B978254
:END:
#+title: ores.cpp.non-temporal-domain
#+description: Non-temporal domain type variant.
#+type: facet
...
This page is the literate source for the =ores.cpp.non-temporal-domain= facet of the
...
* The ores.cpp.non-temporal-domain facet
...
|-----------+-------------|
| [[id:F517A28E-3298-4402-AA7F-05BB5D9BC5C2][ores.cpp.non-temporal-domain.class_non_temporal_header]] | Value type without temporal columns. =non-temporal-domain= profile. |
| [[id:737825CF-48E7-40E7-A626-142FE5406495][ores.cpp.non-temporal-domain.json_io_header]] | JSON IO declarations. =domain= and =non-temporal-domain= profiles. |
| [[id:346AC3FF-9EB4-45B5-8E51-6DA6A7144D0B][ores.cpp.non-temporal-domain.json_io_impl]] | reflect-cpp JSON round-trip implementation. =domain= and =non-temporal-domain= profiles. |
