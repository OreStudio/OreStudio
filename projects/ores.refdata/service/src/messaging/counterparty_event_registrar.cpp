...
register_counterparty_event_mapping(ev::service::postgres_event_source& event_source,
    ...
    ev::service::registrar::register_mapping<refdata::eventing::counterparty_changed_event>(
        event_source, "ores.refdata.counterparty", "ores_refdata_counterparties");

    return event_bus.subscribe<refdata::eventing::counterparty_changed_event>(
        [&nats](const refdata::eventing::counterparty_changed_event& e) {
            ev::service::publish_entity_event(
                nats,
                std::string(
                    ev::domain::event_traits<refdata::eventing::counterparty_changed_event>::name),
