...
create or replace function ores_trading_swap_legs_notify_fn()
returns trigger as $$
declare
    notification_payload jsonb;
    entity_name text := 'ores.trading.swap_leg';
...
create or replace trigger ores_trading_swap_legs_notify_trg
after insert or update or delete on ores_trading_swap_legs_tbl
for each row execute function ores_trading_swap_legs_notify_fn();
