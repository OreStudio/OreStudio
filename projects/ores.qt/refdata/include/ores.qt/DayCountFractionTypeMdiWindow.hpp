 ...
 *
 * Provides a table view of day count fraction types with toolbar actions
 * for reload, add, edit, delete, and viewing history.
 */
class DayCountFractionTypeMdiWindow final : public EntityListMdiWindow {
    Q_OBJECT
...
protected:
    QString normalRefreshTooltip() const override {
        return tr("Refresh day count fraction types");
    }
...
private:
    ...
    ClientDayCountFractionTypeModel* model_;
