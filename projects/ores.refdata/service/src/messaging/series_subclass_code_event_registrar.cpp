...
register_series_subclass_code_event_mapping(ev::service::postgres_event_source& event_source,
    ...
    event_source.register_entity_event_mapping<refdata::messaging::series_subclass_code_event>(
        "ores_refdata_series_subclass_codes");

    return event_bus.subscribe<refdata::messaging::series_subclass_code_event>(
        [&nats](const refdata::messaging::series_subclass_code_event& e) {
            ...
            ev::service::publish_entity_event(
                nats,
                ev::domain::event_subject<refdata::messaging::series_subclass_code_event>(e.action),
                e);
        });
}
