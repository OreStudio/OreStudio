 ...
 */
#ifndef ORES_SHELL_APP_COMMANDS_MONETARY_NATURE_COMMANDS_HPP
#define ORES_SHELL_APP_COMMANDS_MONETARY_NATURE_COMMANDS_HPP
...
/**
 * @brief Every verb monetary natures answer, as one command each.
 *
 ...
 */
class monetary_nature_commands {
private:
    inline static std::string_view logger_name =
        "ores.shell.app.commands.refdata.monetary_nature_commands";
...
public:
    /**
     * @brief Register the monetary natures submenu.
     */
