 ...
 */
/**
 * How the BFF reaches the leg_type service.
 *
 ...
 */
import { subjects } from '@ores/wire-protocol/generated/refdata/protocol/leg_type_protocol';
...
export const legTypeRoute: EntityRouteDescriptor = {
  ...
  subjects: {
    ...
    save: subjects.put_leg_type_request,
    remove: subjects.delete_leg_type_request,
