 ...
 */
#ifndef ORES_SHELL_APP_COMMANDS_CALENDAR_TYPE_COMMANDS_HPP
#define ORES_SHELL_APP_COMMANDS_CALENDAR_TYPE_COMMANDS_HPP
...
/**
 * @brief Every verb calendar types answer, as one command each.
 *
 ...
 */
class calendar_type_commands {
private:
    inline static std::string_view logger_name =
        "ores.shell.app.commands.refdata.calendar_type_commands";
...
public:
    /**
     * @brief Register the calendar types submenu.
     */
