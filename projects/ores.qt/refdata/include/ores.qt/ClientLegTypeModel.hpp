 ...
 *
 */
#ifndef ORES_QT_CLIENT_LEG_TYPE_MODEL_HPP
#define ORES_QT_CLIENT_LEG_TYPE_MODEL_HPP
...
private:
    inline static std::string_view logger_name = "ores.qt.client_leg_type_model";
...
public:
    ...
    explicit ClientLegTypeModel(ClientManager* clientManager, QObject* parent = nullptr);
    ~ClientLegTypeModel() override = default;
    ...
    /**
     * @brief Refresh leg type data from server asynchronously.
     */
    void refresh();

    /**
     * @brief Get leg type at the specified row.
     *
