...
#include "ores.refdata.api/eventing/currency_pair_classification_event.hpp"
...
TEST_CASE("write_currency_pair_classification_publishes_an_event", tags) {
    ...
    using event_type = ores::refdata::messaging::currency_pair_classification_event;
