...
*Resolved (deep backlog refinement, 2026-07-11)*: The capture's own 2026-07-02 update note states the storage/DQ side is done (ores_reporting_publish_report_definitions_from_dq_fn, reporting.v1.report-definitions.publish-from-dq, SQL schema, artefact table, seed data, ore_analytics bundle all exist per the DQ Publish Pattern refactor, id 98B3572E-A9F9-45F5-A4C5-3DC23F3CFF70). Remaining consumption-side work is now tracked separately as id 81CBF56B-0E5F-491B-A5C5-BFE5FCA3B219 ('Unify report definitions provisioning onto the standard publish-from-dq path').
