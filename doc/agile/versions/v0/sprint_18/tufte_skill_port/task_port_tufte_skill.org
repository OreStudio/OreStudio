...
#+owner: marco
#+branch: feature/tufte-viz-skill
#+pr: 833
#+blocked_on: none
#+blocked_since:
#+created: 2026-05-25
...
The three files currently sitting in [[proj:tmp][=tmp/=]] are:
...
update the catalogue, and delete the originals from [[proj:tmp][=tmp/=]].
...
- =doc/llm/skills/tufte-viz/references/analytical-design.org= —
  ...
  attribution line.
- [[proj:doc/llm/skills/claude_code_skills.org][=doc/llm/skills/claude_code_skills.org=]] =* Design= section gains:
...
| PR                                                                                 | Title                                                                |
|------------------------------------------------------------------------------------+----------------------------------------------------------------------|
| [[https://github.com/OreStudio/OreStudio/pull/833][#833]] | [skills,doc] Port tufte-viz skill and reference docs into ORE Studio |
