 ...
 */
/**
 * How the BFF reaches the diary_entry_type service.
 *
 ...
 */
import { subjects } from '@ores/wire-protocol/generated/refdata/protocol/diary_entry_type_protocol';
...
export const diaryEntryTypeRoute: EntityRouteDescriptor = {
  ...
  subjects: {
    ...
    save: subjects.put_diary_entry_type_request,
    remove: subjects.delete_diary_entry_type_request,
