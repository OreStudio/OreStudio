...
#+level: cross
#+filetags: :orgmode:foundation:component:
#+created: 2026-07-06
#+updated: 2026-09-26
#+name: orgmode
...
sprint, etc. Pure C++, no UI/database/NATS dependency: usable directly
from =ores.shell= and from any future consumer. Entity model is ported
