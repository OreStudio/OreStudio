...
register_country_event_mapping(ev::service::postgres_event_source& event_source,
    ...
    ev::service::registrar::register_mapping<refdata::eventing::country_changed_event>(
        event_source, "ores.refdata.country", "ores_refdata_countries");

    return event_bus.subscribe<refdata::eventing::country_changed_event>(
        [&nats](const refdata::eventing::country_changed_event& e) {
            ev::service::publish_entity_event(
                nats,
                std::string(
                    ev::domain::event_traits<refdata::eventing::country_changed_event>::name),
