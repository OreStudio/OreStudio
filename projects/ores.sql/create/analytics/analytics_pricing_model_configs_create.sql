 ...
 *
 * Pricing Model Configuration Table
 *
...
create table if not exists "ores_analytics_pricing_model_configs_tbl" (
    "id" uuid not null,
...
create or replace function ores_analytics_pricing_model_configs_insert_fn()
returns trigger as $$
declare
...
begin
    ...
    from "ores_analytics_pricing_model_configs_tbl"
    ...
    if found then
        ...
        update "ores_analytics_pricing_model_configs_tbl"
...
create or replace trigger ores_analytics_pricing_model_configs_insert_trg
before insert on "ores_analytics_pricing_model_configs_tbl"
for each row execute function ores_analytics_pricing_model_configs_insert_fn();

create or replace rule ores_analytics_pricing_model_configs_delete_rule as
on delete to "ores_analytics_pricing_model_configs_tbl" do instead (
    update "ores_analytics_pricing_model_configs_tbl"
    set valid_to = clock_timestamp()
