...
task, story, sprint, version, component, recipe, knowledge, or
skill — without hand-writing the frontmatter?
...
an initial =* Status= headline at the type's default TODO state (where
applicable), and the skeleton sections — leaving only the content for
you to fill in.
...
=doc/v2/versions/v0/sprint_17/audit_tooling/story.org=.
