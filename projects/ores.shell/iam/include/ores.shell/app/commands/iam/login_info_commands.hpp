 ...
 */
#ifndef ORES_SHELL_APP_COMMANDS_LOGIN_INFO_COMMANDS_HPP
#define ORES_SHELL_APP_COMMANDS_LOGIN_INFO_COMMANDS_HPP
...
/**
 * @brief Every verb login info answer, as one command each.
 *
 ...
 */
class login_info_commands {
private:
    inline static std::string_view logger_name = "ores.shell.app.commands.iam.login_info_commands";
...
public:
    /**
     * @brief Register the login info submenu.
     */
