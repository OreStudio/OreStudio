 ...
 */
/**
 * Where the rounding_type screens live and what they can do.
 *
 ...
 */
import { roundingTypeMeta } from '../ui/rounding_type_ui.js';
import type { EntityDescriptor } from '../../../entity/descriptor.js';

export const roundingTypeDescriptor: EntityDescriptor = {
    component: 'refdata',
    entity: 'rounding_type',
    meta: roundingTypeMeta,
    routeSegment: 'rounding-type',
    apiBase: '/api/types',
    keyFields: [
        'code',
    ],
