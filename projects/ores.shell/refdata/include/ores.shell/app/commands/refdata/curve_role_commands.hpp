 ...
 */
#ifndef ORES_SHELL_APP_COMMANDS_CURVE_ROLE_COMMANDS_HPP
#define ORES_SHELL_APP_COMMANDS_CURVE_ROLE_COMMANDS_HPP
...
/**
 * @brief Every verb curve roles answer, as one command each.
 *
 ...
 */
class curve_role_commands {
private:
    inline static std::string_view logger_name =
        "ores.shell.app.commands.refdata.curve_role_commands";
...
public:
    /**
     * @brief Register the curve roles submenu.
     */
