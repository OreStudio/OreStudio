 ...
 *
 */
#ifndef ORES_REFDATA_CORE_REPOSITORY_CRM_DRIVER_PAIR_MAPPER_HPP
#define ORES_REFDATA_CORE_REPOSITORY_CRM_DRIVER_PAIR_MAPPER_HPP
 ...
 */
class ORES_REFDATA_CORE_EXPORT crm_driver_pair_mapper {
private:
    inline static std::string_view logger_name = "ores.refdata.repository.crm_driver_pair_mapper";
