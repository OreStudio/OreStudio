...
/**
 * @brief Controller for the unified compute console window.
 *
 * Manages lifetime and MDI placement of a single ComputeConsoleWindow.
 * Call showConsole() to open or raise the window.
 */
class ComputeConsoleController final : public QObject {
    Q_OBJECT
