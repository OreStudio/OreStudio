...
| Story | State | Start | End | Description |
|-------+-------+-------+-----+-------------|
| [[id:FFD4CA8C-13DE-4DFB-B242-F423B6D39796][Environment provisioning overhaul]] | BACKLOG | | | GCP-style naming, genesis env, light env type, direct-emacs compass commands, env type through the stack, bootstrap docs. |
