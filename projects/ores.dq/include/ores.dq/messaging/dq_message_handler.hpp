...
public:
     ...
     * @param auth_service Authorization service for permission checks
     */
...
private:
     ...
     * @param permission The required permission (e.g., "change_reasons:write")
     * @param operation_name Human-readable name for logging (e.g., "Save change reason")
