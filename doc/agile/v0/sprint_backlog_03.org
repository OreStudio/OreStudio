...
#+CAPTION: Clock summary at [2025-11-05 Wed 14:02], for Wednesday, November 05, 2025.
|       | <75>                                  |        |      |      |       |
| Tags  | Headline                              | Time   |      |      |     % |
|-------+---------------------------------------+--------+------+------+-------|
...
|       | Stories                               | 0:39   |      |      | 100.0 |
|       | Active                                |        | 0:39 |      | 100.0 |
| agile | Sprint and product backlog refinement |        |      | 0:06 |  15.4 |
| infra | vcpkg cannot apply patch on windowws  |        |      | 0:07 |  17.9 |
| code  | Update prodigy to use tags            |        |      | 0:26 |  66.7 |
#+end:

#+begin: clocktable :maxlevel 3 :scope subtree :tags t :indent nil :emphasize nil :scope file :narrow 75 :formula %
#+TBLNAME: sprint_summary
#+CAPTION: Clock summary at [2025-11-05 Wed 14:02]
|       | <75>                                                   |         |       |       |       |
| Tags  | Headline                                               | Time    |       |       |     % |
|-------+--------------------------------------------------------+---------+-------+-------+-------|
...
|       | Stories                                                | 64:47   |       |       | 100.0 |
|       | Active                                                 |         | 64:47 |       | 100.0 |
| agile | Sprint and product backlog refinement                  |         |       |  1:30 |   2.3 |
| code  | Add locking up logic                                   |         |       |  1:28 |   2.3 |
| code  | Build using dynamic libraries                          |         |       |  7:24 |  11.4 |
| code  | Enable qt gui                                          |         |       |  4:13 |   6.5 |
| code  | Add locking up logic                                   |         |       |  1:28 |   2.3 |
| code  | Build using dynamic libraries                          |         |       |  7:24 |  11.4 |
| code  | Implement logging according to correct boost.log usage |         |       |  8:02 |  12.4 |
| code  | Fix broken Linux and OSX tests                         |         |       |  0:10 |   0.3 |
| code  | Fix broken windows builds                              |         |       |  2:35 |   4.0 |
| code  | Investigate leaks from valgrind                        |         |       |  0:51 |   1.3 |
| code  | Consider adding a postgres database to CI              |         |       | 14:13 |  21.9 |
| code  | Fix misspell that causes build to break                |         |       |  0:12 |   0.3 |
| code  | Improve code coverage                                  |         |       |  4:15 |   6.6 |
| infra | vcpkg cannot apply patch on windowws                   |         |       |  1:46 |   2.7 |
| code  | Update prodigy to use tags                             |         |       |  0:26 |   0.7 |
| code  | Add command line arguments for database to service     |         |       |  3:34 |   5.5 |
| code  | Add support for feature flags                          |         |       |  1:25 |   2.2 |
| code  | Implement authentication bootstrap workflow            |         |       |  0:25 |   0.6 |
| code  | Separate test database usage from application          |         |       |  2:13 |   3.4 |
...
*** STARTED Separate test database usage from application              :code:
    :LOGBOOK:
