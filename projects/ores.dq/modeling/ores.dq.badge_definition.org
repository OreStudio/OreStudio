...
#+description: Codegen entity model for the dq =badge_definition= table. Drives the C++ domain class, mapper, repository, service, generator, TypeScript UI metadata, and SQL schema generation from a single literate source.
