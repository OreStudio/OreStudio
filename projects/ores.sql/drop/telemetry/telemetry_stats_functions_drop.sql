...
drop materialized view if exists "production"."telemetry_stats_aggregate_daily";
drop materialized view if exists "production"."telemetry_stats_daily";
drop materialized view if exists "production"."telemetry_stats_hourly";
