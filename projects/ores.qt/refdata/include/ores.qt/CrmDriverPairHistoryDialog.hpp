...
signals:
    void openVersionRequested(const refdata::domain::crm_driver_pair& pair, int versionNumber);
    void revertVersionRequested(const refdata::domain::crm_driver_pair& pair);
...
private:
    ...
    std::vector<refdata::domain::crm_driver_pair> versions_;
};
