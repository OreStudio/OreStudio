...
| Now           | Bind task 62B120E9 in progress.        |
| Waiting on    | Nothing.                               |
| Next          | Complete the bind task.                |
...
|------+-------+-------+-----+-------------|
| [[id:62B120E9-AE25-4786-B90B-1BDE8A4ACC34][Bind ores.trading entities to profiles; verify zero-diff regen]] | STARTED | 2026-09-06 | | Implement profile binding for ores.trading's org-mode entity set (trade and trading-cpp catalogue entries share the same modeling_dir), rebind every matching entity, regenerate, and confirm byte-identical output, following the ores.refdata pilot method exactly. |
