...
document. Today [[proj:projects/ores.codegen/library/templates][=projects/ores.codegen/library/templates/=]] holds 116
...
pattern — [[proj:doc/knowledge/architecture/clang_format_config.org][=doc/knowledge/architecture/clang_format_config.org=]] tangles
to =.clang-format=, [[proj:doc/llm/claude_code_settings.org][=doc/llm/claude_code_settings.org=]] tangles to
[[proj:.claude/settings.json][=.claude/settings.json=]] — and this story extends it to the codegen
template library.
...
- All templates under [[proj:projects/ores.codegen/library/templates][=projects/ores.codegen/library/templates/=]] have
