...
| Story | State | Start | End | Description |
|-------+-------+-------+-----+-------------|
| [[id:7F9C0F29-4268-4B62-A1BB-2153ECF0A858][Commission: currency]] | STARTED | | | 7/8 tasks done; Qt verification carried from sprint 20. |
...
| [[id:FA87AB1F-E0ED-4AC3-A41E-43321626B77C][Commission: party]] | STARTED | 2026-07-02 | | Verify Qt; implement shell + CLI; manual; Wt/HTTP captures. |
...
| [[id:8B3D478B-DD68-44B7-A8BF-DB50F76C9506][Commission: party_status]] | STARTED | 2026-07-06 | | Verify Qt; implement shell + CLI; manual; Wt/HTTP captures. |
...
| [[id:38F1C14C-517C-4EE9-B541-AEA47B252687][Commission: counterparty]] | STARTED | | | 3/3 codegen-hardening tasks done; Qt/shell/CLI/manual scope still open. |
| [[id:04BE9B6F-B43C-426B-96D1-AED89F88FA93][Commission: book]] | STARTED | 2026-07-02 | | Verify Qt; implement shell + CLI; manual; Wt/HTTP captures. |
| [[id:1D582DC3-E5E4-466F-9F8D-C4E16227FA8A][Commission: book_status]] | STARTED | 2026-07-06 | | Verify Qt; implement shell + CLI; manual; Wt/HTTP captures. |
...
| [[id:DCB5D77C-3BDA-40C1-A74A-F11F9A8C7FEC][Commission: purpose_type]] | STARTED | 2026-07-02 | | Verify Qt; implement shell + CLI; manual; Wt/HTTP captures. |
...
| [[id:2BD6DBBF-6F05-47F3-87E8-2F4E179BB08B][Implement temporal composite entity versioning]] | STARTED | 2026-07-07 | | Implement the target state: SQL touch-function mechanism, as-of window-join read-side composition, Qt composite history dialog. Party/counterparty are the reference case. |
...
| [[id:D1234E9D-D79A-4C59-991C-988D1D8F515F][Synthetic data collections: Basic and Realistic]] | STARTED | 2026-07-03 | | Two sample FX collections seeded from real ORE reference data (2016-02-05 vintage), Market Simulator grouping by collection, feed namespacing, vintage-availability guard. |
...
| [[id:57DB2B98-0013-4AED-BA7A-315DC8BD8623][Move trade import orchestration to service layer]] | BACKLOG | | | Move ImportTradeDialog's ~300 lines of trade-import orchestration (XML parse, per-trade save, 30-way instrument dispatch) into a server-side trade_import_service + import_trades_request, so ores.shell's future trade import command doesn't duplicate it. |
| [[id:04A121FA-00D6-43EB-9B21-04EDC1FA493D][Currency pair support in reference data]] | STARTED | 2026-07-06 | | Knowledge-base foundation (conventions, quoting, cross rates) followed by domain/db/codegen support for currency pairs as reference data. |
...
| [[id:3B8F2A1D-7C4E-4B6A-9E5D-2F1A8C3B7D9E][Refactor ores.codegen C++ generation]] | STARTED | 2026-07-06 | | Audit/resolve template-production drift; carried from sprint 21. |
...
| [[id:FA93094D-718E-42B0-A41A-434051CC6275][Resolve codegen model unification blockers]] | STARTED | 2026-07-06 | | Carried from sprint 21. |
| [[id:131C2E23-F41F-4F7A-B9EC-378710AF055B][Composite child-entity and hierarchy Qt widgets for codegen]] | STARTED | 2026-07-04 | | Handcrafted HierarchyTreeWidget + child-entity table facet, paste-block-bound, so party/counterparty can retire their hand-maintained EntityDetailDialog. Overlaps with solid_dirac's Commission: party work — compare approaches before implementing. |
...
| [[id:20998FA2-2073-4956-AE46-EFDD44C0CFD1][Fix orphan documents and tag taxonomy]] | STARTED | 2026-07-06 | | Fix orphaned docs in org-roam graph; create tag inventory; add compass tag validation. |
...
| [[id:E4A4D94A-C9B9-4075-931E-94AA5D8044FE][QA Validation Runner: in-app test tracking for the multi-worktree fleet]] | STARTED | 2026-07-06 | | Qt panel, built on ores.orgmode, turning a test_scenario org doc's checklist into a guided test session; results and story/task context rendered in-app, not a standalone JSON file. |
...
| [[id:D628C0F8-C916-43CC-ADBE-FCC6758E1B88][Upgrade Qt to latest supported version to fix macOS 15 AGL removal]] | STARTED | 2026-07-06 | | Qt 6.8.x references -framework AGL (removed in macOS 15); the latest supported Qt drops that dependency. CI pinned to macos-14 as stopgap. |
