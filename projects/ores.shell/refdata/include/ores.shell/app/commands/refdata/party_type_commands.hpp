 ...
 */
#ifndef ORES_SHELL_APP_COMMANDS_PARTY_TYPE_COMMANDS_HPP
#define ORES_SHELL_APP_COMMANDS_PARTY_TYPE_COMMANDS_HPP
...
/**
 * @brief Every verb party types answer, as one command each.
 *
 ...
 */
class party_type_commands {
private:
    inline static std::string_view logger_name =
        "ores.shell.app.commands.refdata.party_type_commands";
...
public:
    /**
     * @brief Register the party types submenu.
     */
