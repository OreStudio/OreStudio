...
#+CAPTION: Clock summary at [2025-09-20 Sat 08:44]
|       | <75>                                         |         |       |      |       |
| Tags  | Headline                                     | Time    |       |      |     % |
|-------+----------------------------------------------+---------+-------+------+-------|
|       | *Total time*                                 | *25:40* |       |      | 100.0 |
|-------+----------------------------------------------+---------+-------+------+-------|
|       | Stories                                      | 25:40   |       |      | 100.0 |
|       | Active                                       |         | 25:40 |      | 100.0 |
| agile | Sprint and product backlog refinement        |         |       | 1:43 |   6.7 |
| infra | Fix broken builds                            |         |       | 0:36 |   2.3 |
| code  | Create a containing structure for data       |         |       | 0:35 |   2.3 |
| code  | Add temporal support to currencies           |         |       | 2:59 |  11.6 |
| code  | Add command to dump currencies               |         |       | 4:18 |  16.8 |
| code  | Refactor code for currencies                 |         |       | 3:52 |  15.1 |
| code  | Restore qt setup                             |         |       | 2:20 |   9.1 |
| code  | Add gemini action                            |         |       | 0:05 |   0.3 |
| code  | Remove ImGui support                         |         |       | 0:08 |   0.5 |
| code  | Create a GRPC based service                  |         |       | 2:09 |   8.4 |
| code  | Implement a 0MQ based RPC service and client |         |       | 3:55 |  15.3 |
| code  | Use bitemporal support from Postgres 18      |         |       | 1:47 |   6.9 |
| code  | Add workspace as a container                 |         |       | 1:13 |   4.7 |
#+end:
...
*** Implement a cobalt based server and client                         :code:
...
- [[https://www.depesz.com/2024/10/03/waiting-for-postgresql-18-add-temporal-foreign-key-contraints/][Waiting for PostgreSQL 18 – Add temporal FOREIGN KEY constraints]]
