...
drop policy if exists tenor_resolution_algorithms_tbl_tenant_isolation_policy on ores_refdata_tenor_resolution_algorithms_tbl;
drop policy if exists payment_frequencies_tbl_tenant_isolation_policy on ores_refdata_payment_frequencies_tbl;
...
drop policy if exists crm_topology_configs_tbl_marketdata_cross_tenant_read_policy on ores_refdata_crm_topology_configs_tbl;
drop policy if exists crm_topology_configs_tbl_party_isolation_policy on ores_refdata_crm_topology_configs_tbl;
drop policy if exists crm_driver_pairs_tbl_tenant_isolation_policy on ores_refdata_crm_driver_pairs_tbl;
drop policy if exists crm_driver_pairs_tbl_marketdata_cross_tenant_read_policy on ores_refdata_crm_driver_pairs_tbl;
drop policy if exists crm_driver_pairs_tbl_party_isolation_policy on ores_refdata_crm_driver_pairs_tbl;
...
drop policy if exists crm_enabled_derived_pairs_tbl_marketdata_cross_tenant_read_policy on ores_refdata_crm_enabled_derived_pairs_tbl;
drop policy if exists crm_enabled_derived_pairs_tbl_party_isolation_policy on ores_refdata_crm_enabled_derived_pairs_tbl;

drop policy if exists curve_roles_tbl_tenant_isolation_policy on ores_refdata_curve_roles_tbl;
