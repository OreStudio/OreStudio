 ...
 */
#ifndef ORES_QT_COUNTERPARTY_CONTACT_INFORMATION_CONTROLLER_HPP
#define ORES_QT_COUNTERPARTY_CONTACT_INFORMATION_CONTROLLER_HPP
...
class CounterpartyContactInformationMdiWindow;
...
/**
 * @brief Controller for managing counterparty contact information windows and operations.
 *
 * Manages the lifecycle of counterparty contact information list, detail, and history windows.
 * Handles event subscriptions and coordinates between windows.
 */
class CounterpartyContactInformationController final : public EntityController {
    Q_OBJECT

private:
    inline static std::string_view logger_name =
        "ores.qt.counterparty_contact_information_controller";
...
public:
    CounterpartyContactInformationController(QMainWindow* mainWindow,
                                             QMdiArea* mdiArea,
...
private:
     ...
     * CounterpartyContactInformationDetailDialog needs regardless of which
     * window opened it (add/edit/history-version/revert) -- kept in one
     * place so those four call sites can't drift from each other.
     */
    void wireDetailDialogCommon(CounterpartyContactInformationDetailDialog* detailDialog);
