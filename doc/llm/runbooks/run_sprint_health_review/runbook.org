...
7. /Perform shape completeness fixes./ For every DONE task in the
   ...
   Apply fixes in the same commit as the review (step 10) or in a
   follow-up commit on the same branch.

8. /Mark the task DONE./ Set =State: DONE= and =Now: Complete.= in
   the task's =* Status= table.

9. /Update the story if all tasks are DONE./ If every task in
...
11. /Push and raise a PR/ targeting =main=.
...
12. /Handle review comments/ per the [[id:5373A4E5-172B-44FD-BAE0-07E25BBD3292][Handle a PR review round]] runbook.
