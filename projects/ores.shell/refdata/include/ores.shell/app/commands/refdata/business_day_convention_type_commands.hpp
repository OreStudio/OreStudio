 ...
 */
#ifndef ORES_SHELL_APP_COMMANDS_BUSINESS_DAY_CONVENTION_TYPE_COMMANDS_HPP
#define ORES_SHELL_APP_COMMANDS_BUSINESS_DAY_CONVENTION_TYPE_COMMANDS_HPP
...
/**
 * @brief Every verb business day convention types answer, as one command each.
 *
 ...
 */
class business_day_convention_type_commands {
private:
    inline static std::string_view logger_name =
        "ores.shell.app.commands.refdata.business_day_convention_type_commands";
...
public:
    /**
     * @brief Register the business day convention types submenu.
     */
