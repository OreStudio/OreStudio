...
#+CAPTION: Clock summary at [2024-07-07 Sun 18:42]
|       | <75>                                              |         |       |      |       |
| Tags  | Headline                                          | Time    |       |      |     % |
|-------+---------------------------------------------------+---------+-------+------+-------|
...
|       | Stories                                           | 49:01   |       |      | 100.0 |
|       | Active                                            |         | 49:01 |      | 100.0 |
| agile | Sprint and product backlog refinement             |         |       | 1:29 |   3.0 |
| infra | Create a basic git hub repository                 |         |       | 0:35 |   1.2 |
| infra | Setup a discord channel for the project           |         |       | 0:14 |   0.5 |
| infra | Setup vcpkg and cmake                             |         |       | 1:21 |   2.8 |
| infra | Setup github actions                              |         |       | 1:21 |   2.8 |
| infra | Create and upload a package                       |         |       | 3:28 |   7.1 |
| code  | Create a basic project structure                  |         |       | 2:10 |   4.4 |
| code  | Add a Qt hello world                              |         |       | 3:08 |   6.4 |
| code  | Add a splash screen to applciation                |         |       | 0:41 |   1.4 |
| infra | Add basic site                                    |         |       | 0:34 |   1.2 |
| code  | Add modeling infrastructure                       |         |       | 1:30 |   3.1 |
| infra | Fix code syntax highlighting in site              |         |       | 0:10 |   0.3 |
| doc   | Merge index with readme                           |         |       | 0:42 |   1.4 |
| doc   | Add project objective to readme                   |         |       | 2:24 |   4.9 |
| code  | Add basic logging support                         |         |       | 1:14 |   2.5 |
| infra | Add nightly support with memcheck                 |         |       | 3:21 |   6.8 |
| code  | Clean up toolchains and presets                   |         |       | 1:53 |   3.8 |
| doc   | Generate Doxygen documentation and add it to site |         |       | 0:51 |   1.7 |
| doc   | Copy domain notes on core concepts                |         |       | 4:41 |   9.6 |
| infra | Valgrind fails to run unit tests                  |         |       | 1:12 |   2.4 |
| infra | Initial sanity test generated packages            |         |       | 0:25 |   0.9 |
| code  | Add command line options support                  |         |       | 5:45 |  11.7 |
| infra | Unit tests show up twice in nightlies             |         |       | 0:13 |   0.4 |
| doc   | Add recipes for command line                      |         |       | 0:51 |   1.7 |
| agile | Use a bar chart for sprint resourcing cost        |         |       | 2:57 |   6.0 |
| agile | Classify stories by type                          |         |       | 0:34 |   1.2 |
| code  | Add XML parsing support for currency              |         |       | 3:18 |   6.7 |
| code  | Create a containing structure for data            |         |       | 0:28 |   1.0 |
| code  | Add basic widgets to display currencies           |         |       | 0:26 |   0.9 |
| doc   | Convert plantuml diagrams to org-babel            |         |       | 1:05 |   2.2 |
#+end:
...
*** BLOCKED Unit tests show up twice in nightlies                     :infra:
    :LOGBOOK:
