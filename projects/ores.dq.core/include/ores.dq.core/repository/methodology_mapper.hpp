 ...
 *
 */
#ifndef ORES_DQ_CORE_REPOSITORY_METHODOLOGY_MAPPER_HPP
#define ORES_DQ_CORE_REPOSITORY_METHODOLOGY_MAPPER_HPP
...
/**
 * @brief Maps methodology domain entities to data storage layer and vice-versa.
 */
