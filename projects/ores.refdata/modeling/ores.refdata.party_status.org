...
#+description: Codegen entity model for the refdata =party_status= table. Drives the C++ domain class, mapper, repository, service, generator, TypeScript UI metadata, and SQL schema generation from a single literate source.
...
** Presentation
:PROPERTIES:
:domain_include:         ores.refdata.api/domain/party_status.hpp
:domain_class:           refdata::domain::party_status
:protocol_include:       ores.refdata.api/messaging/party_status_protocol.hpp
...
|---------------+---------------+------------------+-----------+--------+-------------+----------------------|
| code          | Code          | codeEdit         | line_edit | true   | true        | Enter status code    |
| name          | Name          | nameEdit         | line_edit |        | true        | Enter status name    |
