...
/**
 * @brief Detail dialog for viewing and editing compute app records.
 *
 * This dialog allows viewing, creating, and editing compute apps.
 * It supports both create mode (for new records) and edit mode (for
 * existing records).
 */
class AppDetailDialog final : public DetailDialogBase {
    Q_OBJECT
...
public:
    explicit AppDetailDialog(QWidget* parent = nullptr);
    ~AppDetailDialog() override;

    void setClientManager(ClientManager* clientManager);
    void setUsername(const std::string& username);
    void setApp(const compute::domain::app& app);
