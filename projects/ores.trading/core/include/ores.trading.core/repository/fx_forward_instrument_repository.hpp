 ...
 *
 */
#ifndef ORES_TRADING_CORE_REPOSITORY_FX_FORWARD_INSTRUMENT_REPOSITORY_HPP
#define ORES_TRADING_CORE_REPOSITORY_FX_FORWARD_INSTRUMENT_REPOSITORY_HPP
 ...
 */
class ORES_TRADING_CORE_EXPORT fx_forward_instrument_repository {
private:
...
public:
    ...
    /**
     * @brief Writes FX forward instruments to database.
     */
    /**@{*/
    ...
    /**
     * @brief Reads latest FX forward instruments, possibly filtered by primary key.
     */
    /**@{*/
    ...
    /**
     * @brief Reads all FX forward instruments, possibly filtered by primary key.
     */
    std::vector<domain::fx_forward_instrument> read_all(context ctx,
                                                        const std::string& instrument_id);

    /**
     * @brief Reads a single FX forward instrument as it stood at a specific
    ...
    /**
     * @brief Reads latest FX forward instruments with pagination support.
     * @param ctx Repository context with database connection
     ...
     */
    std::uint32_t get_total_fx_forward_instrument_count(context ctx);
    ...
    /**
     * @brief Deletes FX forward instruments by closing their temporal validity.
     */
