...
|------+-------+-------+-----+-------------|
| [[id:3F3559A2-5E98-44EA-A87A-E5DA7CF5BA23][Update history field mapper codegen template to use provenance_fields constants]] | STARTED | 2026-09-04 | | cpp_history_field_mapper.cpp.mustache hardcodes audit-column labels ("Modified By", etc.) as string literals, but currency_history_field_mapper.cpp on main uses the shared ores::history::domain::provenance_fields constants instead -- the template needs to be updated to match and every entity's generated mapper regenerated. |
