 ...
 *
 */
#ifndef ORES_IAM_GENERATORS_ACCOUNT_ROLE_GENERATOR_HPP
 ...
 */
ORES_IAM_API_EXPORT domain::account_role
generate_synthetic_account_role(utility::generation::generation_context& ctx);
