...
#+CAPTION: Clock summary at [2026-04-18 Sat 00:00], for Saturday, April 18, 2026.
|      | <75>         |        |     |
| Tags | Headline     | Time   |   % |
|------+--------------+--------+-----|
|      | *Total time* | *0:00* | 0.0 |
...
#+CAPTION: Clock summary at [2026-04-18 Sat 00:00]
|      | <75>         |        |     |
| Tags | Headline     | Time   |   % |
|------+--------------+--------+-----|
|      | *Total time* | *0:00* | 0.0 |
...
#+begin_src R :var sprint_summary=sprint_summary :colnames yes :results file graphics :exports results :file sprint_backlog_17_stories_pie_sorted.png :width 1920 :height 1080
library(conflicted)
library(ggplot2)
library(tidyverse)
library(tibble)
...
p <- ggplot(df, aes(x = "", y = percent, fill = stories)) +
  ...
  ggtitle("Sprint 17: Resourcing per Story")  +
...
[[file:sprint_backlog_17_stories_pie_sorted.png]]

#+name: stories-chart
#+begin_src R :var sprint_summary=sprint_summary :colnames yes :results file graphics :exports results :file sprint_backlog_17_stories.png :width 1200 :height 650
library(conflicted)
library(grid)
library(tidyverse)
library(tibble)
...
[[file:sprint_backlog_17_stories.png]]

#+name: tags-chart
#+begin_src R :var sprint_summary=sprint_summary :colnames yes :results file graphics :exports results :file sprint_backlog_17_tags.png :width 600 :height 400
library(conflicted)
library(grid)
library(tidyverse)
library(tibble)
...
p <- ggplot(df2) +
  aes(x = cost, y = tags) +
  geom_col(fill = blue, width = 0.6) +
  ggtitle("Sprint 17: Resourcing per Tag") +
...
| Previous: [[id:e6fd30ed-963e-4705-b414-91bf471c23d0][Version Zero]] |
