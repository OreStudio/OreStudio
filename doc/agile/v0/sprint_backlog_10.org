...
#+CAPTION: Clock summary at [2026-01-26 Mon 17:42], for Monday, January 26, 2026.
|       | <75>                                            |        |      |      |       |
| Tags  | Headline                                        | Time   |      |      |     % |
|-------+-------------------------------------------------+--------+------+------+-------|
...
|       | Stories                                         | 7:29   |      |      | 100.0 |
|       | Active                                          |        | 7:29 |      | 100.0 |
| infra | OCR scan notebooks for this sprint              |        |      | 0:46 |  10.2 |
| code  | Generate C++ code for ORE                       |        |      | 1:10 |  15.6 |
| code  | Fix windows CI break due to XSD code generation |        |      | 0:18 |   4.0 |
| code  | Clean up data layers                            |        |      | 1:21 |  18.0 |
| code  | Add rounding type table                         |        |      | 1:37 |  21.6 |
| code  | Add dataset bundles                             |        |      | 2:17 |  30.5 |
#+end:

#+begin: clocktable :maxlevel 3 :scope subtree :tags t :indent nil :emphasize nil :scope file :narrow 75 :formula %
#+TBLNAME: sprint_summary
#+CAPTION: Clock summary at [2026-01-26 Mon 17:42]
|       | <75>                                                |         |       |      |       |
| Tags  | Headline                                            | Time    |       |      |     % |
|-------+-----------------------------------------------------+---------+-------+------+-------|
...
|       | Stories                                             | 59:24   |       |      | 100.0 |
|       | Active                                              |         | 59:24 |      | 100.0 |
| agile | Sprint and product backlog refinement               |         |       | 1:17 |   2.2 |
| infra | OCR scan notebooks for this sprint                  |         |       | 7:06 |  12.0 |
| code  | Create a simple code generator                      |         |       | 7:38 |  12.9 |
| code  | Party related schemes                               |         |       | 5:20 |   9.0 |
| code  | Image cache not reloading on new datasets           |         |       | 1:43 |   2.9 |
| code  | Create a script to download and split GLEIF data    |         |       | 0:25 |   0.7 |
| code  | Incremental image cache loading with modified_since |         |       | 0:31 |   0.9 |
| code  | Fix issues with misspell action                     |         |       | 2:47 |   4.7 |
| code  | Tidy-up external data storage                       |         |       | 3:33 |   6.0 |
| code  | Coding schemes are in production tables             |         |       | 1:39 |   2.8 |
| code  | Refactor SQL directories                            |         |       | 3:24 |   5.7 |
| code  | Code-generate ER diagram                            |         |       | 3:01 |   5.1 |
| code  | Add "words" to icons                                |         |       | 0:28 |   0.8 |
| code  | Add mapping artefact to population functions        |         |       | 2:19 |   3.9 |
| code  | Add a ORE component for import/export               |         |       | 4:00 |   6.7 |
| code  | Generate C++ code for ORE                           |         |       | 6:43 |  11.3 |
| code  | Fix windows CI break due to XSD code generation     |         |       | 0:18 |   0.5 |
| code  | Clean up data layers                                |         |       | 1:21 |   2.3 |
| code  | Add rounding type table                             |         |       | 1:37 |   2.7 |
| code  | Add code generation support for domain types SQL    |         |       | 1:20 |   2.2 |
| code  | Add FPML export and import                          |         |       | 0:19 |   0.5 |
| code  | Base the compute approach on BOINC                  |         |       | 0:18 |   0.5 |
| code  | Add dataset bundles                                 |         |       | 2:17 |   3.8 |
#+end:
...
*** STARTED Separate catalog metadata schema from production data      :code:
    :LOGBOOK:
    CLOCK: [2026-01-26 Mon 23:45]
    :END:
