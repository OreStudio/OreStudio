...
No gaps found. The auxiliary types (rounding_type, monetary_nature, currency_market_tier)
follow an identical structural pattern; currency is richer with entity-specific soft-FK
validations in its insert trigger.
