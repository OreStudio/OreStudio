...
register_report_instance_event_mapping(ev::service::postgres_event_source& event_source,
                                       ev::service::event_bus& event_bus,
                                       ores::nats::service::client& nats) {
    ev::service::registrar::register_mapping<reporting::eventing::report_instance_changed_event>(
        event_source, "ores.reporting.report_instance", "ores_reporting_report_instances");

    return event_bus.subscribe<reporting::eventing::report_instance_changed_event>(
        [&nats](const reporting::eventing::report_instance_changed_event& e) {
            ev::service::publish_entity_event(
                nats,
                std::string(ev::domain::event_traits<
                            reporting::eventing::report_instance_changed_event>::name),
