 ...
 *
 */
#ifndef ORES_DQ_REPOSITORY_CODING_SCHEME_MAPPER_HPP
#define ORES_DQ_REPOSITORY_CODING_SCHEME_MAPPER_HPP
...
/**
 * @brief Maps coding_scheme domain entities to data storage layer and vice-versa.
 */
