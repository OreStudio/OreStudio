...
void write_party_type(std::vector<std::byte>& buffer,
    ...
    writer::write_string(buffer, pt.recorded_by);
    writer::write_string(buffer, pt.performed_by);
