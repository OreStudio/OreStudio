...
void BusinessUnitHistoryDialog::setupConnections() {
    connect(ui_->versionListWidget, &QTableWidget::itemSelectionChanged,
            this, &BusinessUnitHistoryDialog::onVersionSelected);
...
void BusinessUnitHistoryDialog::loadHistory() {
    ...
    auto task = [self, id = id_]() -> HistoryResult {
        ...
        comms::messaging::frame request_frame(
            comms::messaging::message_type::get_business_unit_history_request,
            0, std::move(payload)
        );
        ...
        auto response = refdata::messaging::get_business_unit_history_response::
