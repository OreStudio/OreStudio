...
#+CAPTION: Clock summary at [2026-01-07 Wed 10:13], for Wednesday, January 07, 2026.
|      | <75>                  |        |      |      |       |
| Tags | Headline              | Time   |      |      |     % |
|------+-----------------------+--------+------+------+-------|
...
|      | Stories               | 1:02   |      |      | 100.0 |
|      | Active                |        | 1:02 |      | 100.0 |
| code | Review telemetry work |        |      | 1:02 | 100.0 |
#+end:

#+begin: clocktable :maxlevel 3 :scope subtree :tags t :indent nil :emphasize nil :scope file :narrow 75 :formula %
#+TBLNAME: sprint_summary
#+CAPTION: Clock summary at [2026-01-07 Wed 10:13]
|       | <75>                                        |         |       |      |       |
| Tags  | Headline                                    | Time    |       |      |     % |
|-------+---------------------------------------------+---------+-------+------+-------|
|       | *Total time*                                | *33:25* |       |      | 100.0 |
|-------+---------------------------------------------+---------+-------+------+-------|
|       | Stories                                     | 33:25   |       |      | 100.0 |
|       | Active                                      |         | 33:25 |      | 100.0 |
| agile | Sprint and product backlog refinement       |         |       | 1:17 |   3.8 |
| code  | Rerun SQL scripts from scratch              |         |       | 7:52 |  23.5 |
| code  | Run qt client and validate all new features |         |       | 1:19 |   3.9 |
| code  | Refactor options and parser                 |         |       | 0:27 |   1.3 |
| code  | Check functionality in =ores.wt=            |         |       | 2:03 |   6.1 |
| code  | Rename =ores.shell= to =ores.comms.shell=   |         |       | 1:30 |   4.5 |
| code  | Review HTTP service                         |         |       | 7:24 |  22.1 |
| code  | Assorted fixes to currency dialog           |         |       | 4:19 |  12.9 |
| code  | Review comms analyser work                  |         |       | 0:27 |   1.3 |
| code  | Review telemetry work                       |         |       | 6:47 |  20.3 |
#+end:
...
*** Add support for offsets in pagination                              :code:
