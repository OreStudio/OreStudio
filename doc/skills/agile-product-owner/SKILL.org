...
When planning a new sprint (typically done using the [[id:C5EEF144-BB9D-2F44-453B-4B7338D8A457][new-sprint]] skill):
...
The major version manifest =doc/agile/v0/version_zero.org= should be updated
when:
