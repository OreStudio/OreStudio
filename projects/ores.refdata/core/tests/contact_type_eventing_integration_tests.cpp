...
#include "ores.refdata.api/eventing/contact_type_event.hpp"
...
TEST_CASE("write_contact_type_publishes_an_event", tags) {
    ...
    using event_type = ores::refdata::messaging::contact_type_event;
    ...
    event_source.register_entity_event_mapping<event_type>("ores_refdata_contact_types");
