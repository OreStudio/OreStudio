...
domain::treatment_dimension treatment_dimension_mapper::map(const treatment_dimension_entity& v) {
...
treatment_dimension_entity treatment_dimension_mapper::map(const domain::treatment_dimension& v) {
