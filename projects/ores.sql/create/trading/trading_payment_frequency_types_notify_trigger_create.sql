...
declare
    ...
    entity_name text := 'ores.trading.payment_frequency_type';
...
create or replace trigger ores_trading_payment_frequency_types_notify_trg
after insert or update or delete on ores_trading_payment_frequency_types_tbl
for each row execute function ores_trading_payment_frequency_types_notify_fn();
