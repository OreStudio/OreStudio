...
| [[id:98E44999-1CA1-4C50-AEDA-AF2B2E42496E][Restore the code generation methodology the slovaris removal took]] | BACKLOG | | | Database recreation fails on main: a shared methodology row left with the retired slovaris dataset, but ten seed scripts still name it. |
