...
create index if not exists payment_frequencies_artefact_dataset_idx
on "ores_dq_payment_frequencies_artefact_tbl" (dataset_id);

create index if not exists payment_frequencies_artefact_tenant_idx
on "ores_dq_payment_frequencies_artefact_tbl" (tenant_id);

create index if not exists payment_frequencies_artefact_code_idx
