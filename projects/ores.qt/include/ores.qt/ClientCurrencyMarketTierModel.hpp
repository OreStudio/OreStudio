 ...
 */
class ClientCurrencyMarketTierModel final : public QAbstractTableModel {
    Q_OBJECT
...
public:
    ...
    /**
     * @brief Get currency market tier at the specified row.
     *
     * @param row The row index.
     * @return The currency market tier, or nullptr if row is invalid.
     */
...
private:
    ...
    std::vector<refdata::domain::currency_market_tier> types_;
