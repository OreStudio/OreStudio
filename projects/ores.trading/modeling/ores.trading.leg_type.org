...
:END:
#+title: ores.trading.leg_type
#+description: Codegen entity model for the trading =leg_type= table. Drives the C++ domain class, mapper, repository, service, generator, Qt UI, and SQL schema generation from a single literate source.
...
:protocol_include:       ores.trading.api/messaging/leg_type_protocol.hpp
...
:save_request_class:     trading::messaging::save_leg_type_request
:save_response_class:    trading::messaging::save_leg_type_response
:save_message_type:      save_leg_type_request
:delete_request_class:   trading::messaging::delete_leg_type_request
:delete_response_class:  trading::messaging::delete_leg_type_response
