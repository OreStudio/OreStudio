...
using ores::shell::app::commands::account_commands;
...
TEST_CASE("account_commands_registers_every_derived_verb", tags) {
...
TEST_CASE("account_commands_process_list_requires_a_session", tags) {
    ...
    account_commands::process_list(out, session, tokens(0));
...
TEST_CASE("account_commands_process_get_requires_a_session", tags) {
    auto lg(make_logger(test_suite));
    ...
    command_feedback::reset();
    account_commands::process_get(out, session, tokens(1));
...
TEST_CASE("account_commands_process_get_reports_the_expected_count", tags) {
    auto lg(make_logger(test_suite));
...
TEST_CASE("account_commands_process_get_many_requires_a_session", tags) {
    auto lg(make_logger(test_suite));
    ...
    command_feedback::reset();
    account_commands::process_get_many(out, session, tokens(1));
...
TEST_CASE("account_commands_process_versions_requires_a_session", tags) {
    auto lg(make_logger(test_suite));
    ...
    command_feedback::reset();
    account_commands::process_versions(out, session, tokens(1));
...
TEST_CASE("account_commands_process_versions_reports_the_expected_count", tags) {
    auto lg(make_logger(test_suite));
...
TEST_CASE("account_commands_process_version_requires_a_session", tags) {
    auto lg(make_logger(test_suite));
    ...
    command_feedback::reset();
    account_commands::process_version(out, session, tokens(1));
...
TEST_CASE("account_commands_process_version_reports_the_expected_count", tags) {
    auto lg(make_logger(test_suite));
