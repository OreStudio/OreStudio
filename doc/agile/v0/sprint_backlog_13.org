...
#+CAPTION: Clock summary at [2026-02-27 Fri 01:53], for Friday, February 27, 2026.
|      | <75>                                     |        |      |      |       |
| Tags | Headline                                 | Time   |      |      |     % |
|------+------------------------------------------+--------+------+------+-------|
...
#+CAPTION: Clock summary at [2026-02-27 Fri 01:53]
|       | <75>                                                  |         |       |       |       |
| Tags  | Headline                                              | Time    |       |       |     % |
|-------+-------------------------------------------------------+---------+-------+-------+-------|
|       | *Total time*                                          | *61:29* |       |       | 100.0 |
|-------+-------------------------------------------------------+---------+-------+-------+-------|
|       | Stories                                               | 61:29   |       |       | 100.0 |
|       | Active                                                |         | 61:29 |       | 100.0 |
| agile | Sprint and product backlog refinement                 |         |       |  0:26 |   0.7 |
| infra | Generate release notes for previous sprint            |         |       |  1:16 |   2.1 |
| code  | Merge FSM into DQ                                     |         |       |  0:34 |   0.9 |
| code  | Make all details dialogs tabbed                       |         |       |  2:26 |   4.0 |
| code  | Provenance: Fix performed by and modified by stamping |         |       |  3:17 |   5.3 |
| code  | Add plotting of session data                          |         |       |  1:19 |   2.1 |
| code  | Add account-party management and login support        |         |       | 13:43 |  22.3 |
| code  | Add rounding type entity                              |         |       |  1:40 |   2.7 |
| code  | Polish business centre UI and data quality            |         |       |  0:58 |   1.6 |
| code  | Enhance currency taxonomy                             |         |       |  2:06 |   3.4 |
| code  | Books, portfolios and trades are not party specific   |         |       |  2:59 |   4.9 |
| code  | Minor improvements to connection browser              |         |       |  1:17 |   2.1 |
| code  | Rename currency asset classes                         |         |       |  1:05 |   1.8 |
| code  | Remove toolbars from detail dialogs                   |         |       |  5:57 |   9.7 |
| code  | Add portfolio explorer                                |         |       |  5:19 |   8.6 |
| code  | Analyse ORE trade import mapping requirements         |         |       |  1:08 |   1.8 |
| code  | Add scheduler binary protocol                         |         |       |  3:00 |   4.9 |
| code  | Add party level currency and country restrictions     |         |       |  0:46 |   1.2 |
| code  | Add scheduling support                                |         |       |  6:06 |   9.9 |
| code  | Add trade import mapping dialog to Qt UI              |         |       |  6:07 |   9.9 |
#+end:
...
*** STARTED Add a message queue                                        :code:
    :LOGBOOK:
    CLOCK: [2026-02-27 Fri 10:28]
    :END:
