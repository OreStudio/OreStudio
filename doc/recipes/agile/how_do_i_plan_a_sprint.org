...
#+description: Procedure for a sprint planning session: set the mission, score next-backlog captures against sprint goals, and promote winners into stories.
#+type: recipe
#+level: cross
...
[[id:D4219199-7B17-4A89-B4BC-6019738642DA][product backlog]]. For automated orchestration, use the [[id:FB451B15-9674-4B61-A9F8-7DAEEB4B365A][compass-agile-plan-sprint]]
...
No single script — the [[id:FB451B15-9674-4B61-A9F8-7DAEEB4B365A][compass-agile-plan-sprint]] Claude Code skill orchestrates
...
- [[id:3153AA4B-23D4-4111-9710-5A4971102EDC][How do I create a new doc?]] — full codegen reference for all doc types.
