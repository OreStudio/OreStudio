...
Charts generated from git history and gh API data via =cmake --build ... --target sprint_charts -DSPRINT=18=.

#+attr_html: :width 100%
[[file:assets/images/sprint_prs_commits_sprint_18.png]]

#+attr_html: :width 100%
[[file:assets/images/sprint_line_churn_sprint_18.png]]

#+attr_html: :width 100%
[[file:assets/images/sprint_pr_cycle_sprint_18.png]]

#+attr_html: :width 100%
[[file:assets/images/sprint_stories_done_sprint_18.png]]

- Sprint Activity — PRs & Commits per day (top), PR cycle time (middle), daily line churn (bottom).
- Sprint Progress — cumulative stories done (top), PR cycle time per PR (bottom).
