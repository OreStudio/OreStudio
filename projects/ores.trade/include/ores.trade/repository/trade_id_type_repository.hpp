 ...
 *
 */
#ifndef ORES_TRADE_REPOSITORY_TRADE_ID_TYPE_REPOSITORY_HPP
#define ORES_TRADE_REPOSITORY_TRADE_ID_TYPE_REPOSITORY_HPP
...
private:
    inline static std::string_view logger_name =
        "ores.trade.repository.trade_id_type_repository";
