 ...
 */
#ifndef ORES_REFDATA_CORE_REPOSITORY_TENOR_CONVENTION_REPOSITORY_HPP
#define ORES_REFDATA_CORE_REPOSITORY_TENOR_CONVENTION_REPOSITORY_HPP
...
/**
 * @brief Reads and writes tenor conventions to data storage.
 */
class ORES_REFDATA_CORE_EXPORT tenor_convention_repository {
private:
    inline static std::string_view logger_name =
        "ores.refdata.repository.tenor_convention_repository";
...
public:
    ...
    /**
     * @brief Writes tenor conventions to database.
     *
     ...
     */
    /**@{*/
    void write(context ctx, const domain::tenor_convention& v);
    void write(context ctx, const std::vector<domain::tenor_convention>& v);
    /**@}*/

    /**
     * @brief Writes a tenor convention, honouring the claim it states.
     *
    ...
    /**
     * @brief Writes a set of tenor conventions, each honouring its own
    ...
    /**
     * @brief Reads latest tenor conventions, possibly filtered by primary key.
     */
    /**@{*/
    std::vector<domain::tenor_convention> read_latest(context ctx);
     ...
     */
    std::vector<domain::tenor_convention> read_all(context ctx, const std::string& code);

    /**
     * @brief Reads a single tenor convention as it stood at a specific
    ...
    /**
     * @brief Deletes a tenor convention by closing its temporal validity.
     */
    ...
    /**
     * @brief Removes a tenor convention, refusing a row that moved on.
     *
    ...
    /**
     * @brief Deletes tenor conventions by closing their temporal validity.
     */
...
private:
     ...
     */
    domain::tenor_convention apply_claim(context ctx,
                                         const domain::tenor_convention& v,
                                         const ores::utility::domain::precondition& claim);
};
