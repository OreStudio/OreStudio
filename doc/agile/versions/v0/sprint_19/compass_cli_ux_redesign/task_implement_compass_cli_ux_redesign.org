...
#+owner: marco
#+branch: feature/compass-ux-analysis
#+pr: 964
#+blocked_on: none
#+blocked_since:
#+created: 2026-05-31
...
| Now          | Nothing.                                      |
| Waiting on   | Nothing.                                      |
| Next         | Done. T2–T4 can proceed in parallel.          |
...
| [[https://github.com/OreStudio/OreStudio/pull/964][#964]] | [agile] Task 1: Compass CLI UX analysis and taxonomy |
...
- Design document written: [[proj:doc/plans/2026-06-01-compass-cli-ux-taxonomy.org][=doc/plans/2026-06-01-compass-cli-ux-taxonomy.org=]]
- Five pillars defined: Orient, Search, Scaffold, Capture, Journal.
- No hard renames this sprint — 34 existing references are safe.
- New commands scoped to =compass sprint status= and =compass story status=.
- =--help= grouping via epilog (Option 2) chosen for low risk.
- Tool description updated to "developer toolkit for ORE Studio".
- Implementation order confirmed: T2–T4 can run after this; T3/T4 in parallel.
