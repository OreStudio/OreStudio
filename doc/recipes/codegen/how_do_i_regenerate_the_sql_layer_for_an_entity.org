...
Runs the =sql= profile via =compass codegen regenerate=, which writes SQL DDL create/drop scripts and notify-trigger scripts. See [[id:E39C0E47-768F-4DE2-8436-08C4A8A06CFA][ores.sql.schema]] for the template list and [[id:B3CBBDED-7CD9-423B-94D8-F5C4C0488CEA][Component catalogue]] for component-to-model-root mapping.
...
The =sql= profile supports =domain_entity=, =junction=, =schema=, and =table= model types. All =refdata= entity types (table and domain_entity) are discovered by the single =refdata= component:
...
- [[id:E39C0E47-768F-4DE2-8436-08C4A8A06CFA][ores.sql.schema]] — =sql= profile entry with template → output path table.
- [[id:B3CBBDED-7CD9-423B-94D8-F5C4C0488CEA][Component catalogue]] — =refdata= component definition.
