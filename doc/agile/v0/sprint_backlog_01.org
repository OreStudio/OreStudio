...
#+TBLNAME: summary
#+CAPTION: Clock summary at [2024-07-05 Fri 21:00]
| <75>                                              |         |       |      |       |
| Headline                                          | Time    |       |      |     % |
|---------------------------------------------------+---------+-------+------+-------|
...
| Create and upload a package                       |         |       | 3:28 |   9.5 |
| Create a basic project structure                  |         |       | 2:10 |   6.0 |
| Add a Qt hello world                              |         |       | 3:08 |   8.6 |
...
| Add project objective to readme                   |         |       | 2:24 |   6.6 |
| Add basic logging support                         |         |       | 1:14 |   3.4 |
| Add nightly support with memcheck                 |         |       | 3:21 |   9.2 |
| Clean up toolchains and presets                   |         |       | 1:53 |   5.2 |
| Valgrind fails to run unit tests                  |         |       | 1:05 |   3.0 |
| Add command line options support                  |         |       | 1:47 |   4.9 |
| Generate Doxygen documentation and add it to site |         |       | 0:33 |   1.5 |
...
| Copy domain notes on core concepts                |         |       | 3:45 |  10.3 |
#+end:
