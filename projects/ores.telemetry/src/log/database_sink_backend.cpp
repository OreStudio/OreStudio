 ...
 */
std::string severity_to_string(logging::boost_severity sev) {
    switch(sev) {
        case logging::boost_severity::trace: return "trace";
        case logging::boost_severity::debug: return "debug";
        case logging::boost_severity::info: return "info";
        case logging::boost_severity::warn: return "warn";
        case logging::boost_severity::error: return "error";
        default: return "info";
    }
}
