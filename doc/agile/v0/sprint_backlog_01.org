...
#+CAPTION: Clock summary at [2024-06-27 Thu 22:59]
| <75>                                    |         |       |      |       |
| Headline                                | Time    |       |      |     % |
|-----------------------------------------+---------+-------+------+-------|
...
| Stories                                 | 16:56   |       |      | 100.0 |
| Active                                  |         | 16:56 |      | 100.0 |
| Sprint and product backlog refinement   |         |       | 0:47 |   4.6 |
| Create a basic git hub repository       |         |       | 0:35 |   3.4 |
| Setup a discord channel for the project |         |       | 0:14 |   1.4 |
| Setup vcpkg and cmake                   |         |       | 1:21 |   8.0 |
| Setup github actions                    |         |       | 1:21 |   8.0 |
| Create and upload a package             |         |       | 3:28 |  20.5 |
| Create a basic project structure        |         |       | 2:10 |  12.8 |
| Add a Qt hello world                    |         |       | 3:08 |  18.5 |
| Add a splash screen to applciation      |         |       | 0:41 |   4.0 |
| Add nightly support with memcheck       |         |       | 1:00 |   5.9 |
| Add XML parsing support for currency    |         |       | 1:24 |   8.3 |
| Create a containing structure for data  |         |       | 0:21 |   2.1 |
| Add basic widgets to display currencies |         |       | 0:26 |   2.6 |
#+end:
