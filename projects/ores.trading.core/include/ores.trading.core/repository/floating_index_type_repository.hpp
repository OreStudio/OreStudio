 ...
 *
 */
#ifndef ORES_TRADING_REPOSITORY_FLOATING_INDEX_TYPE_REPOSITORY_HPP
#define ORES_TRADING_REPOSITORY_FLOATING_INDEX_TYPE_REPOSITORY_HPP
 ...
 */
class ORES_TRADING_CORE_EXPORT floating_index_type_repository {
private:
    inline static std::string_view logger_name =
        "ores.trading.repository.floating_index_type_repository";
