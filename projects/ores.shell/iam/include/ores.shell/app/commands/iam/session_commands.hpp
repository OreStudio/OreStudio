 ...
 */
#ifndef ORES_SHELL_APP_COMMANDS_SESSION_COMMANDS_HPP
#define ORES_SHELL_APP_COMMANDS_SESSION_COMMANDS_HPP
...
/**
 * @brief Every verb sessions answer, as one command each.
 *
...
private:
    inline static std::string_view logger_name = "ores.shell.app.commands.iam.session_commands";
...
public:
    /**
     * @brief Register the sessions submenu.
     */
    ...
    /**
     * @brief set <id> <start_time> <account_id> <end_time> <client_ip> <client_identifier>
     * <client_version_major> <client_version_minor> <bytes_sent> <bytes_received> <country_code>
     * <protocol> <reason> <commentary> [--version <n>]
     */
    ...
    /**
     * @brief put-many --count <n> <id> <start_time> <account_id> <end_time> <client_ip>
    ...
    /**
     * @brief delete <id> <start_time> <reason> <commentary> [--version <n>]
     */
    ...
    /**
     * @brief delete-many <id> <start_time> <reason> <commentary>
     */
