 ...
 *
 */
#ifndef ORES_REFDATA_CORE_REPOSITORY_CURRENCY_COUNTRY_ENTITY_HPP
#define ORES_REFDATA_CORE_REPOSITORY_CURRENCY_COUNTRY_ENTITY_HPP
...
std::ostream& operator<<(std::ostream& s, const currency_country_entity& v);
