...
#+TBLNAME: summary
#+CAPTION: Clock summary at [2024-07-06 Sat 22:17]
| <75>                                              |         |       |      |       |
| Headline                                          | Time    |       |      |     % |
|---------------------------------------------------+---------+-------+------+-------|
...
| Stories                                           | 42:01   |       |      | 100.0 |
| Active                                            |         | 42:01 |      | 100.0 |
| Sprint and product backlog refinement             |         |       | 1:18 |   3.1 |
| Create a basic git hub repository                 |         |       | 0:35 |   1.4 |
| Setup a discord channel for the project           |         |       | 0:14 |   0.6 |
| Setup vcpkg and cmake                             |         |       | 1:21 |   3.2 |
| Setup github actions                              |         |       | 1:21 |   3.2 |
| Create and upload a package                       |         |       | 3:28 |   8.3 |
| Create a basic project structure                  |         |       | 2:10 |   5.2 |
| Add a Qt hello world                              |         |       | 3:08 |   7.5 |
| Add a splash screen to applciation                |         |       | 0:41 |   1.6 |
| Add basic site                                    |         |       | 0:34 |   1.3 |
| Add modeling infrastructure                       |         |       | 1:30 |   3.6 |
| Fix code syntax highlighting in site              |         |       | 0:10 |   0.4 |
| Merge index with readme                           |         |       | 0:42 |   1.7 |
| Add project objective to readme                   |         |       | 2:24 |   5.7 |
| Add basic logging support                         |         |       | 1:14 |   2.9 |
| Add nightly support with memcheck                 |         |       | 3:21 |   8.0 |
| Clean up toolchains and presets                   |         |       | 1:53 |   4.5 |
| Generate Doxygen documentation and add it to site |         |       | 0:51 |   2.0 |
| Copy domain notes on core concepts                |         |       | 4:41 |  11.1 |
...
| Add command line options support                  |         |       | 3:27 |   8.2 |
| Add XML parsing support for currency              |         |       | 3:18 |   7.9 |
