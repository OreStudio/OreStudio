...
/**
 * @brief Reads and writes credit instruments to data storage.
 */
class ORES_TRADING_CORE_EXPORT credit_instrument_repository {
private:
    inline static std::string_view logger_name =
        "ores.trading.repository.credit_instrument_repository";
...
public:
    ...
    void write(context ctx, const domain::credit_instrument& v);
    void write(context ctx, const std::vector<domain::credit_instrument>& v);
