 ...
 *
 */
#ifndef ORES_TRADE_SERVICE_LIFECYCLE_EVENT_SERVICE_HPP
#define ORES_TRADE_SERVICE_LIFECYCLE_EVENT_SERVICE_HPP
 ...
 */
class lifecycle_event_service {
private:
    inline static std::string_view logger_name =
        "ores.trade.service.lifecycle_event_service";
