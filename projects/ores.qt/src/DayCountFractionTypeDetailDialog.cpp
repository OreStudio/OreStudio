...
DayCountFractionTypeDetailDialog::DayCountFractionTypeDetailDialog(QWidget* parent)
    : DetailDialogBase(parent),
      ui_(new Ui::DayCountFractionTypeDetailDialog),
...
QTabWidget* DayCountFractionTypeDetailDialog::tabWidget() const {
    return ui_->tabWidget;
}

QWidget* DayCountFractionTypeDetailDialog::provenanceTab() const {
...
void DayCountFractionTypeDetailDialog::setupConnections() {
    connect(ui_->saveButton, &QPushButton::clicked, this,
            &DayCountFractionTypeDetailDialog::onSaveClicked);
    connect(ui_->deleteButton, &QPushButton::clicked, this,
            &DayCountFractionTypeDetailDialog::onDeleteClicked);
    connect(ui_->closeButton, &QPushButton::clicked, this,
            &DayCountFractionTypeDetailDialog::onCloseClicked);
...
void DayCountFractionTypeDetailDialog::setUsername(const std::string& username) {
    username_ = username;
}
...
void DayCountFractionTypeDetailDialog::setCreateMode(bool createMode) {
...
void DayCountFractionTypeDetailDialog::updateTypeFromUi() {
    if (createMode_) {
...
void DayCountFractionTypeDetailDialog::onFieldChanged() {
    hasChanges_ = true;
    updateSaveButtonState();
}

void DayCountFractionTypeDetailDialog::updateSaveButtonState() {
...
void DayCountFractionTypeDetailDialog::onSaveClicked() {
    if (!clientManager_ || !clientManager_->isConnected()) {
        MessageBoxHelper::warning(this, "Disconnected",
            "Cannot save day count fraction type while disconnected from server.");
        return;
    }
    ...
    BOOST_LOG_SEV(lg(), info) << "Saving day count fraction type: " << type_.code;
...
void DayCountFractionTypeDetailDialog::onDeleteClicked() {
    if (!clientManager_ || !clientManager_->isConnected()) {
        MessageBoxHelper::warning(this, "Disconnected",
            "Cannot delete day count fraction type while disconnected from server.");
        return;
    }

    QString code = QString::fromStdString(type_.code);
    auto reply = MessageBoxHelper::question(this, "Delete Day Count Fraction Type",
        QString("Are you sure you want to delete day count fraction type '%1'?").arg(code),
    ...
    connect(watcher, &QFutureWatcher<DeleteResult>::finished,
        ...
        if (result.success) {
            BOOST_LOG_SEV(lg(), info) << "Day Count Fraction Type deleted successfully";
            emit self->statusMessage(QString("Day Count Fraction Type '%1' deleted").arg(code));
