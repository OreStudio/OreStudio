...
| [[id:10E43A2D-3388-4F4F-A949-736B2A291B76][Entity classification and drift baseline: ores.synthetic]] | DONE | 2026-09-07 | 2026-09-08 | Run the codegen-fix-drift method: bind synthetic entities to profiles, verify zero-diff regen, extend the drift gate. Closed by the post-merge live system test (9-entity CRUD via ores.shell); the tpl/ppv table-display defect it caught was fixed at source. |
| [[id:649C97F1-EB47-4CA8-A3AE-AA7D78FCD46D][Entity classification and drift baseline: ores.marketdata]] | BACKLOG | | | Run the codegen-fix-drift method: bind marketdata entities to profiles, verify zero-diff regen, extend the drift gate. |
| [[id:9ABCB932-9501-4519-BECA-A30A93646770][Entity classification and drift baseline: ores.analytics]] | BACKLOG | | | Run the codegen-fix-drift method: bind analytics-cpp entities to profiles, verify zero-diff regen, extend the drift gate. |
...
| [[id:62193FDE-57C0-40BB-83B7-0B3D6F8C38AA][Entity classification and drift baseline: ores.database]] | BACKLOG | | | Run the codegen-fix-drift method: bind database-cpp entities to profiles, verify zero-diff regen, extend the drift gate. |
| [[id:3E49EAF7-0545-4A4C-9DD8-34608FC41293][Entity classification and drift baseline: ores.reporting]] | BACKLOG | | | Run the codegen-fix-drift method: bind reporting-cpp entities to profiles, verify zero-diff regen, extend the drift gate. |
| [[id:040527BC-58FA-4A5E-9ADC-3814FA319F5C][Entity classification and drift baseline: ores.scheduler]] | BACKLOG | | | Run the codegen-fix-drift method: bind scheduler-cpp entities to profiles, verify zero-diff regen, extend the drift gate. |
| [[id:8D56EA57-1963-41D6-90C1-335F64275644][Entity classification and drift baseline: ores.workflow]] | BACKLOG | | | Run the codegen-fix-drift method: bind workflow-cpp entities to profiles, verify zero-diff regen, extend the drift gate. |
| [[id:6ADAA56E-EFA0-4E30-B381-4F20E3C9BA13][Entity classification and drift baseline: ores.workspace]] | BACKLOG | | | Run the codegen-fix-drift method: bind workspace-cpp entities to profiles, verify zero-diff regen, extend the drift gate. |
...
| [[id:688959F0-A1AB-4021-A57E-1103AD92773A][Redesign ores.trading on data-oriented principles]] | BACKLOG | | | Program: review the whole ores.trading data model with the data-oriented criteria and move it to the correct data-oriented shape across several PRs -- model every persisted family in the modeling orgs, grow the org grammar to express nested domain groups, column mapping, custom service methods and wire consolidation, then align the service layer and the wire to the atomised model. First PR: the in-depth analysis. |
