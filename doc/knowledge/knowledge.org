...
- [[id:C3E053CA-0D4B-480B-9119-E11530160EC1][ORE Studio Market Data URN]] — a proposed canonical, structured
  identifier (=mdurn:<scope>:<index_family>:<tenor>:<curve_role>:<instrument_type>[:<point>]=)
  with deterministic projection rules into ORE's index name, curve key,
  and quote key, closing the tenor-index and curve-role gaps.
