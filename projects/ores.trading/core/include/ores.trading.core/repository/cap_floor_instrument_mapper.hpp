 ...
 *
 */
#ifndef ORES_TRADING_CORE_REPOSITORY_CAP_FLOOR_INSTRUMENT_MAPPER_HPP
#define ORES_TRADING_CORE_REPOSITORY_CAP_FLOOR_INSTRUMENT_MAPPER_HPP
...
public:
    ...
    static std::vector<domain::cap_floor_instrument>
    map(const std::vector<cap_floor_instrument_entity>& v);
    static std::vector<cap_floor_instrument_entity>
    map(const std::vector<domain::cap_floor_instrument>& v);
};
