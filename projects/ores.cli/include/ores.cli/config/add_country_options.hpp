 ...
 *
 */
#ifndef ORES_CLI_CONFIG_ADD_COUNTRY_OPTIONS_HPP
#define ORES_CLI_CONFIG_ADD_COUNTRY_OPTIONS_HPP
...
/**
 * @brief Configuration for adding a country entity via command-line arguments.
 */
struct add_country_options final {
