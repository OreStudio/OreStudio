...
| [[id:2E5F5DB5-7417-45B8-8D0B-C71650127D32][Compass bearings command]] | BACKLOG | | | Single-command LLM orientation (compass bearings): where, last session, memory pointer, and command cheat-sheet. |
...
| [[id:166E8E44-1573-4DE2-825F-A6037A302AE9][Add PR management support to compass]] | STARTED | 2026-06-05 | | compass review list/reply/resolve wrapping gh; namespace open for checks/create/merge. Promotes the sprint-18 capture. |
...
| [[id:5104ADAF-390D-4ADB-B005-CE726B553123][Introduce ores.seeder component]] | STARTED | 2026-06-02 | | New tooling component owning SQL INSERT populate scripts. Slovaris is its first dataset; closes out the codegen org-mode migration story. |
...
| [[id:BD519FC9-6B29-4055-877F-861E46043A06][Investigate the API/core split]] | BACKLOG | | | Inventory api vs core across all 17 split components; flag heavy apis (ores.dq.api links ores.database.lib); decide refactor so apis are standard types or other apis only. |
...
| [[id:73D162FD-92D6-4567-8D94-4368C97F96E4][System 2 health review]] | DONE | 2026-05-31 | 2026-06-03 | Periodic System 2 health checks: goal alignment, load, PR velocity, story/task balance, focus, verdict. |
...
| [[id:6111FDF8-96E6-4C40-88BD-C756B6841F85][Create a user guide for ores.qt]] | STARTED | 2026-06-05 | | Single home for manual-content work; next: accounts/roles/tenants administration chapter from the 2026-06-04 screenshots. |
...
| Story | State | Start | End | Description |
|-------+-------+-------+-----+-------------|
| [[id:7763D0EE-A500-4497-9B2D-973C02ADC739][Fix rfl complexity failure]] | STARTED | 2026-05-30 | | Fix ClientManagerTradeDetail.cpp rfl::Literal 502-field compile failure; restore CI builds. |
