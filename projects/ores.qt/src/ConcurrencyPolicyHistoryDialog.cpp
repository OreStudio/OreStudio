...
void ConcurrencyPolicyHistoryDialog::setupConnections() {
    connect(ui_->versionListWidget, &QTableWidget::itemSelectionChanged,
            this, &ConcurrencyPolicyHistoryDialog::onVersionSelected);
    connect(openVersionAction_, &QAction::triggered,
            this, &ConcurrencyPolicyHistoryDialog::onOpenVersionClicked);
    connect(revertAction_, &QAction::triggered,
            this, &ConcurrencyPolicyHistoryDialog::onRevertClicked);
...
void ConcurrencyPolicyHistoryDialog::loadHistory() {
    ...
    auto task = [self, code = code_.toStdString()]() -> HistoryResult {
        ...
        comms::messaging::frame request_frame(
            comms::messaging::message_type::get_concurrency_policy_history_request,
            0, std::move(payload)
        );
        ...
        auto response = reporting::messaging::get_concurrency_policy_history_response::
