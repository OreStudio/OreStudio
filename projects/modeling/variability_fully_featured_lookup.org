...
#+description: Text natural key, rich presentation tier exercising CSV/XML export and version navigation.
#+type: profile
#+level: cross
...
warrant the full UI surface: bulk CSV/XML import-export for
...
per-layer criteria are derived from; every optional UI feature is
