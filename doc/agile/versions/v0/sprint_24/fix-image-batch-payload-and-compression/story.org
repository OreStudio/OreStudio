...
- Decompressing =jetstream_admin= peek payloads -- unrelated to this
  story's own goal (it's an admin-tooling gap exposed as a side effect
  of the compression this story introduced, not something blocking
  the fix itself) -- split into its own story at close:
  [[id:5CB963BE-9B73-49A0-A834-AC7D47DD49BC][Fix jetstream_admin missing gzip decompression]].
