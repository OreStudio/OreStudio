 ...
 *
 */
#include "ores.assets.service/app/application.hpp"
...
namespace {
constexpr std::string_view service_name = "ores.assets.service";
...
ores::database::context application::make_context(
    ...
    context_factory::configuration cfg {
        ...
        .service_account = std::string(ores::database::service::service_accounts::assets_service)
    };
...
application::run(boost::asio::io_context& io_ctx,
    ...
    co_await ores::service::service::run(
        io_ctx, nats, make_context(cfg.database), "ores.assets.service",
        [](auto& n, auto c, auto v) {
            return ores::assets::messaging::registrar::register_handlers(
