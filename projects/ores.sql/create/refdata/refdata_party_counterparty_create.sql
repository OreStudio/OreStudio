...
create table if not exists "ores_refdata_party_counterparties_tbl" (
    ...
    primary key (tenant_id, party_id, counterparty_id, valid_from),
    exclude using gist (
        tenant_id WITH =,
        party_id WITH =,
...
create or replace function ores_refdata_party_counterparties_insert_fn()
returns trigger as $$
declare
...
begin
    ...
    from "ores_refdata_party_counterparties_tbl"
    ...
    if found then
        ...
        update "ores_refdata_party_counterparties_tbl"
...
create or replace trigger ores_refdata_party_counterparties_insert_trg
before insert on "ores_refdata_party_counterparties_tbl"
for each row
execute function ores_refdata_party_counterparties_insert_fn();

create or replace rule ores_refdata_party_counterparties_delete_rule as
on delete to "ores_refdata_party_counterparties_tbl"
do instead
  update "ores_refdata_party_counterparties_tbl"
  set valid_to = current_timestamp
