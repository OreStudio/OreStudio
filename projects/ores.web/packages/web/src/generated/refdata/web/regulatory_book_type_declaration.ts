 ...
 */
/**
 * Where the regulatory_book_type screens live and what they can do.
 *
 ...
 */
import { regulatoryBookTypeMeta } from '../ui/regulatory_book_type_ui.js';
import type { EntityDescriptor } from '../../../entity/descriptor.js';

export const regulatoryBookTypeDescriptor: EntityDescriptor = {
    component: 'refdata',
    entity: 'regulatory_book_type',
    meta: regulatoryBookTypeMeta,
    routeSegment: 'regulatory-book-type',
    apiBase: '/api/types',
    keyFields: [
        'code',
    ],
