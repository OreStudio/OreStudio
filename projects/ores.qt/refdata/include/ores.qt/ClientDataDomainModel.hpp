...
public:
    enum Column { Name, Description, Version, ModifiedBy, RecordedAt, ColumnCount };
    ...
    /**
     * @brief Default window size for the data domain list window.
     */
     ...
     */
    static constexpr std::string_view kSettingsGroup = "DataDomainMdiWindow";
    /**
