...
#+CAPTION: Clock summary at [2026-02-24 Tue 00:00], for Tuesday, February 24, 2026.
|      | <75>         |        |     |
| Tags | Headline     | Time   |   % |
|------+--------------+--------+-----|
|      | *Total time* | *0:00* | 0.0 |
...
#+CAPTION: Clock summary at [2026-02-24 Tue 00:01]
|       | <75>                                                  |         |       |       |       |
| Tags  | Headline                                              | Time    |       |       |     % |
|-------+-------------------------------------------------------+---------+-------+-------+-------|
|       | *Total time*                                          | *26:02* |       |       | 100.0 |
|-------+-------------------------------------------------------+---------+-------+-------+-------|
|       | Stories                                               | 26:02   |       |       | 100.0 |
|       | Active                                                |         | 26:02 |       | 100.0 |
| agile | Sprint and product backlog refinement                 |         |       |  0:26 |   1.7 |
| infra | Generate release notes for previous sprint            |         |       |  1:16 |   4.9 |
| code  | Merge FSM into DQ                                     |         |       |  0:34 |   2.2 |
| code  | Make all details dialogs tabbed                       |         |       |  2:26 |   9.3 |
| code  | Provenance: Fix performed by and modified by stamping |         |       |  3:17 |  12.6 |
| code  | Add plotting of session data                          |         |       |  1:19 |   5.1 |
| code  | Add account-party management and login support        |         |       | 13:43 |  52.7 |
| code  | Add rounding type entity                              |         |       |  1:40 |   6.4 |
| code  | Polish business centre UI and data quality            |         |       |  0:58 |   3.7 |
| code  | Add portfolio book tree widget                        |         |       |  0:23 |   1.5 |
#+end:
...
#+end_quote
*** STARTED Enhance currency taxonomy                                  :code:
    :LOGBOOK:
...
*** STARTED Books, portfolios and trades are not party specific        :code:
    :LOGBOOK:
