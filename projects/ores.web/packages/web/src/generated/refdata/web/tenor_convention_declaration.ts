 ...
 */
/**
 * Where the tenor_convention screens live and what they can do.
 *
 ...
 */
import { tenorConventionMeta } from '../ui/tenor_convention_ui.js';
import type { EntityDescriptor } from '../../../entity/descriptor.js';

export const tenorConventionDescriptor: EntityDescriptor = {
    component: 'refdata',
    entity: 'tenor_convention',
    meta: tenorConventionMeta,
    routeSegment: 'tenor-convention',
