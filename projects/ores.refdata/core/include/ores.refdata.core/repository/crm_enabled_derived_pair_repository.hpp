 ...
 */
#ifndef ORES_REFDATA_CORE_REPOSITORY_CRM_ENABLED_DERIVED_PAIR_REPOSITORY_HPP
#define ORES_REFDATA_CORE_REPOSITORY_CRM_ENABLED_DERIVED_PAIR_REPOSITORY_HPP
 ...
 */
class ORES_REFDATA_CORE_EXPORT crm_enabled_derived_pair_repository {
private:
    inline static std::string_view logger_name =
        "ores.refdata.repository.crm_enabled_derived_pair_repository";
...
public:
    ...
    /**
     * @brief Writes a CRM enabled derived pair, honouring the claim it states.
     *
    ...
    /**
     * @brief Writes a set of CRM enabled derived pairs, each honouring its own
    ...
    /**
     * @brief Reads latest CRM enabled derived pairs, possibly filtered by primary key.
     */
    /**@{*/
    ...
    /**
     * @brief Removes a CRM enabled derived pair, refusing a row that moved on.
     *
...
private:
     ...
     */
    domain::crm_enabled_derived_pair apply_claim(context ctx,
                                                 const domain::crm_enabled_derived_pair& v,
                                                 const ores::utility::domain::precondition& claim);
};
