...
/**
 * @brief Detail dialog for viewing and editing day count fraction type records.
 *
 * This dialog allows viewing, creating, and editing day count fraction types.
 * It supports both create mode (for new records) and edit mode (for
 * existing records).
 */
class DayCountFractionTypeDetailDialog final : public DetailDialogBase {
    Q_OBJECT
...
public:
    explicit DayCountFractionTypeDetailDialog(QWidget* parent = nullptr);
    ~DayCountFractionTypeDetailDialog() override;

    void setClientManager(ClientManager* clientManager);
    void setUsername(const std::string& username);
    void setType(const trading::domain::day_count_fraction_type& type);
...
private:
    ...
    Ui::DayCountFractionTypeDetailDialog* ui_;
    ClientManager* clientManager_;
    std::string username_;
    trading::domain::day_count_fraction_type type_;
