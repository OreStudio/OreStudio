...
| Next         | Once that task lands, resume the test scenario (steps 5-7) and revisit the Composite tab's UX to drill into per-child history instead of a flat list. |
