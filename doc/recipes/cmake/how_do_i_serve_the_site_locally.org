...
have changed in about a second each, which is the loop to use when
reviewing your own writing in the browser. Run the full
=compass build --direct site= when a change affects link resolution, or
before committing. See [[id:6930472B-222C-4621-AB37-CFEE3070A8BD][How do I deploy the site?]] for which to use when.
