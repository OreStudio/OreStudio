 ...
 *
 */
#ifndef ORES_ASSETS_SERVICE_APP_APPLICATION_HPP
#define ORES_ASSETS_SERVICE_APP_APPLICATION_HPP
...
/**
 * @brief Entry point for the ores.assets.service service.
 */
class application final {
private:
    inline static std::string_view logger_name = "ores.assets.service.app.application";
