...
cap_floor_instrument_mapper::map(const cap_floor_instrument_entity& v) {
...
cap_floor_instrument_entity
cap_floor_instrument_mapper::map(const domain::cap_floor_instrument& v) {
