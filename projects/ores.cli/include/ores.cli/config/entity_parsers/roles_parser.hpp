 ...
 *
 */
#ifndef ORES_CLI_CONFIG_ENTITY_PARSERS_ROLES_PARSER_HPP
#define ORES_CLI_CONFIG_ENTITY_PARSERS_ROLES_PARSER_HPP
...
/**
 * @brief Handles parsing of roles entity commands.
 */
