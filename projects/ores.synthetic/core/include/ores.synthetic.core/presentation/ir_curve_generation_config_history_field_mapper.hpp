 ...
 *
 */
#ifndef ORES_SYNTHETIC_CORE_PRESENTATION_IR_CURVE_GENERATION_CONFIG_HISTORY_FIELD_MAPPER_HPP
#define ORES_SYNTHETIC_CORE_PRESENTATION_IR_CURVE_GENERATION_CONFIG_HISTORY_FIELD_MAPPER_HPP
...
/**
 * @brief Renders a ir_curve_generation_config to an ordered field list for
