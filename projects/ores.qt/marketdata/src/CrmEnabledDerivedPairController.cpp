...
namespace {
constexpr std::string_view pair_event_name = eventing::domain::event_traits<
...
void CrmEnabledDerivedPairController::onShowDetails(
    const marketdata::domain::crm_enabled_derived_pair& pair) {
...
void CrmEnabledDerivedPairController::onOpenVersion(
    const marketdata::domain::crm_enabled_derived_pair& pair, int versionNumber) {
