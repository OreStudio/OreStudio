...
counterparty_contact_information_mapper::map(const counterparty_contact_information_entity& v) {
...
counterparty_contact_information_mapper::map(const domain::counterparty_contact_information& v) {
