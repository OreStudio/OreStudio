...
#+CAPTION: Clock summary at [2025-10-24 Fri 17:19], for Friday, October 24, 2025.
|      | <75>                          |        |      |      |       |
| Tags | Headline                      | Time   |      |      |     % |
|------+-------------------------------+--------+------+------+-------|
...
|      | Stories                       | 5:22   |      |      | 100.0 |
|      | Active                        |        | 5:22 |      | 100.0 |
| code | Add support for feature flags |        |      | 1:15 |  23.3 |
| code | Enable qt gui                 |        |      | 4:07 |  76.7 |
#+end:

#+begin: clocktable :maxlevel 3 :scope subtree :tags t :indent nil :emphasize nil :scope file :narrow 75 :formula %
#+TBLNAME: sprint_summary
#+CAPTION: Clock summary at [2025-10-24 Fri 17:19]
|       | <75>                                        |         |       |      |       |
| Tags  | Headline                                    | Time    |       |      |     % |
|-------+---------------------------------------------+---------+-------+------+-------|
|       | *Total time*                                | *10:02* |       |      | 100.0 |
|-------+---------------------------------------------+---------+-------+------+-------|
|       | Stories                                     | 10:02   |       |      | 100.0 |
|       | Active                                      |         | 10:02 |      | 100.0 |
| agile | Sprint and product backlog refinement       |         |       | 0:35 |   5.8 |
| code  | Investigate leaks from valgrind             |         |       | 0:46 |   7.6 |
| code  | Add locking up logic                        |         |       | 1:28 |  14.6 |
| code  | Add support for feature flags               |         |       | 1:25 |  14.1 |
| code  | Implement authentication bootstrap workflow |         |       | 0:25 |   4.2 |
| code  | Enable qt gui                               |         |       | 4:10 |  41.5 |
| code  | Add workspace as a container                |         |       | 1:13 |  12.1 |
#+end:
