...
/**
 * @brief Detail dialog for viewing and editing app version records.
 *
 * This dialog allows viewing, creating, and editing app versions.
 * It supports both create mode (for new records) and edit mode (for
 * existing records).
 */
class AppVersionDetailDialog final : public DetailDialogBase {
    Q_OBJECT
...
public:
    explicit AppVersionDetailDialog(QWidget* parent = nullptr);
    ~AppVersionDetailDialog() override;
