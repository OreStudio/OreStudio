...
- ores.security: Shared security primitives for cryptography (password hashing
...
- ores.connections: Client-side server connection bookmark manager. Hierarchical
