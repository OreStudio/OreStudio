...
| field              | widget                   | type          | is_key | is_required | placeholder                    | spin_min | spin_max | combo_domain_type                     | combo_fetch_include        | combo_fetch_fn              | combo_watcher_name    | combo_code_field | combo_tooltip_field | combo_sort_field | combo_label            | combo_setter_pascal |
|--------------------+---------------------------+---------------+--------+-------------+---------------------------------+----------+----------+----------------------------------------+-----------------------------+------------------------------+-----------------------+------------------+----------------------+------------------+------------------------+----------------------|
| iso_code           | isoCodeEdit               | line_edit     | true   | true        | Enter ISO 4217 code             |          |          |                                        |                             |                              |                        |                  |                      |                  |                        |                      |
| name               | nameEdit                  | line_edit     |        | true        | Enter currency name             |          |          |                                        |                             |                              |                        |                  |                      |                  |                        |                      |
| numeric_code       | numericCodeEdit           | line_edit     |        | true        | Enter numeric code              |          |          |                                        |                             |                              |                        |                  |                      |                  |                        |                      |
...
| symbol             | symbolEdit                | line_edit     |        | true        | Enter currency symbol           |          |          |                                        |                             |                              |                        |                  |                      |                  |                        |                      |
| fraction_symbol    | fractionSymbolEdit        | line_edit     |        | true        | Enter fraction symbol           |          |          |                                        |                             |                              |                        |                  |                      |                  |                        |                      |
| fractions_per_unit | fractionsPerUnitSpinBox   | spin_box      |        |             |                                  | 0        | 10000    |                                        |                             |                              |                        |                  |                      |                  |                        |                      |
| format             | formatEdit                | line_edit     |        | true        | Enter display format            |          |          |                                        |                             |                              |                        |                  |                      |                  |                        |                      |
...
| rounding_precision | roundingPrecisionSpinBox  | spin_box      |        |             |                                  | 0        | 10       |                                        |                             |                              |                        |                  |                      |                  |                        |                      |
...
*** Setting-gated actions

| action         | setting                          |
|----------------+-----------------------------------|
| generateAction | system.synthetic_data_generation  |
