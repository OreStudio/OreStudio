...
application::run(boost::asio::io_context& io_ctx,
    ...
    using context_extractor_fn = ores::scheduler::messaging::registrar::context_extractor_fn;
    ...
    auto subs = ores::scheduler::messaging::registrar::register_handlers(
    ...
    nats.drain();
    BOOST_LOG_SEV(lg(), info) << "Shutdown complete: ores.scheduler.service";
    co_return;
}
