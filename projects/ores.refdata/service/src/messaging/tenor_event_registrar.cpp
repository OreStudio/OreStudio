...
register_tenor_event_mapping(ev::service::postgres_event_source& event_source,
    ...
    event_source.register_entity_event_mapping<refdata::messaging::tenor_event>(
        "ores_refdata_tenors");

    return event_bus.subscribe<refdata::messaging::tenor_event>(
        [&nats](const refdata::messaging::tenor_event& e) {
            ...
            ev::service::publish_entity_event(
                nats, ev::domain::event_subject<refdata::messaging::tenor_event>(e.action), e);
        });
}
