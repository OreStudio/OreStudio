...
#+CAPTION: Clock summary at [2026-03-01 Sun 10:52], for Sunday, March 01, 2026.
|       | <75>                                     |        |      |      |       |
| Tags  | Headline                                 | Time   |      |      |     % |
|-------+------------------------------------------+--------+------+------+-------|
|       | *Total time*                             | *1:55* |      |      | 100.0 |
|-------+------------------------------------------+--------+------+------+-------|
|       | Stories                                  | 1:55   |      |      | 100.0 |
|       | Active                                   |        | 1:55 |      | 100.0 |
| agile | Sprint and product backlog refinement    |        |      | 0:05 |   4.3 |
| code  | Add trade import mapping dialog to Qt UI |        |      | 1:50 |  95.7 |
#+end:

#+begin: clocktable :maxlevel 3 :scope subtree :tags t :indent nil :emphasize nil :scope file :narrow 75 :formula %
#+TBLNAME: sprint_summary
#+CAPTION: Clock summary at [2026-03-01 Sun 10:52]
|       | <75>                                     |        |      |      |       |
| Tags  | Headline                                 | Time   |      |      |     % |
|-------+------------------------------------------+--------+------+------+-------|
...
|       | Stories                                  | 3:25   |      |      | 100.0 |
|       | Active                                   |        | 3:25 |      | 100.0 |
| agile | Sprint and product backlog refinement    |        |      | 1:35 |  46.3 |
| code  | Add trade import mapping dialog to Qt UI |        |      | 1:50 |  53.7 |
#+end:
