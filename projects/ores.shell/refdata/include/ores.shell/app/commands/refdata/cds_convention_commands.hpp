 ...
 */
#ifndef ORES_SHELL_APP_COMMANDS_CDS_CONVENTION_COMMANDS_HPP
#define ORES_SHELL_APP_COMMANDS_CDS_CONVENTION_COMMANDS_HPP
...
/**
 * @brief Every verb CDS conventions answer, as one command each.
 *
 ...
 */
class cds_convention_commands {
private:
    inline static std::string_view logger_name =
        "ores.shell.app.commands.refdata.cds_convention_commands";
...
public:
    /**
     * @brief Register the CDS conventions submenu.
     */
