...
Note: =bitemporal_operations.hpp= provides =execute_read_query= and
=execute_write_query= helpers. The =helpers.hpp= provides
=generate_create_table_sql= and other utilities.
