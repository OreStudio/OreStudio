...
#+description: The ores.cpp.protocol facet: request/response message struct definitions for an entity's NATS API — pure data shape, consumed by the C++ NATS pipeline and by UI clients.
#+type: knowledge
#+level: cross
...
[[id:483EBF89-6151-480E-8801-FC1ABB284A17][Presentation]]'s Naming/wiring knobs (=:get_request_class:=,
...
- [[id:483EBF89-6151-480E-8801-FC1ABB284A17][Presentation]] — references these class/subject names by name in its Naming/wiring knobs.
