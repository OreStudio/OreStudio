 ...
 *
 */
#ifndef ORES_ANALYTICS_API_EVENTING_PRICING_MODEL_CONFIG_CHANGED_EVENT_HPP
#define ORES_ANALYTICS_API_EVENTING_PRICING_MODEL_CONFIG_CHANGED_EVENT_HPP
...
struct pricing_model_config_changed_event final {
    ...
    /**
     * @brief Changed pricing model configuration UUIDs (as strings).
     */
...
/**
 * @brief Event traits specialization for pricing_model_config_changed_event.
 */
template <>
struct event_traits<ores::analytics::eventing::pricing_model_config_changed_event> {
    static constexpr std::string_view name = "ores.analytics.pricing_model_config_changed";
};
