 ...
 *
 */
#ifndef ORES_REFDATA_CORE_GENERATORS_PARTY_STATUS_GENERATOR_HPP
#define ORES_REFDATA_CORE_GENERATORS_PARTY_STATUS_GENERATOR_HPP
 ...
 */
ORES_REFDATA_API_EXPORT domain::party_status
generate_synthetic_party_status(utility::generation::generation_context& ctx);
