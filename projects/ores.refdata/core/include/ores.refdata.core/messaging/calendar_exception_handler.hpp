 ...
 *
 */
#ifndef ORES_REFDATA_CORE_MESSAGING_CALENDAR_EXCEPTION_HANDLER_HPP
#define ORES_REFDATA_CORE_MESSAGING_CALENDAR_EXCEPTION_HANDLER_HPP
...
namespace {
inline auto& calendar_exception_handler_lg() {
    static auto instance =
        ores::logging::make_logger("ores.refdata.messaging.calendar_exception_handler");
    return instance;
}
} // namespace
...
/**
 * @brief NATS message handler for calendar exception operations.
 */
class calendar_exception_handler {
public:
    calendar_exception_handler(ores::nats::service::client& nats,
