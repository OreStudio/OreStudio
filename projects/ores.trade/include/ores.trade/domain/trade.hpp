 ...
 *
 */
#ifndef ORES_TRADE_DOMAIN_TRADE_HPP
#define ORES_TRADE_DOMAIN_TRADE_HPP
 ...
 *
 * Temporal trade envelope. Each lifecycle event (New, Amendment, Novation,
...
struct trade final {
     ...
     *
     * Soft FK to ores_trade_lifecycle_events_tbl.
     */
