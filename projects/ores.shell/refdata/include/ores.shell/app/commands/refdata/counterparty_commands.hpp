 ...
 */
#ifndef ORES_SHELL_APP_COMMANDS_COUNTERPARTY_COMMANDS_HPP
#define ORES_SHELL_APP_COMMANDS_COUNTERPARTY_COMMANDS_HPP
...
/**
 * @brief Every verb counterparties answer, as one command each.
 *
 ...
 */
class counterparty_commands {
private:
    inline static std::string_view logger_name =
        "ores.shell.app.commands.refdata.counterparty_commands";
...
public:
    /**
     * @brief Register the counterparties submenu.
     */
    ...
    /**
     * @brief add <id> <short_code> <full_name> <transliterated_name> <party_type>
    ...
    /**
     * @brief set <id> <short_code> <full_name> <transliterated_name> <party_type>
     * <parent_counterparty_id> <business_center_code> <status> <image_id> <reason> <commentary>
     * [--version <n>]
     */
    ...
    /**
     * @brief put-many --count <n> <id> <short_code> <full_name> <transliterated_name> <party_type>
     * <parent_counterparty_id> <business_center_code> <status> <image_id> <reason> <commentary>
     */
