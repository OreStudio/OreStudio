...
#include "ores.synthetic.api/eventing/market_data_generation_config_event.hpp"
...
TEST_CASE("write_market_data_generation_config_publishes_an_event", tags) {
    ...
    using event_type = ores::synthetic::messaging::market_data_generation_config_event;
    ...
    // only growth is asserted, not an exact count.
    {
        ...
        svc.delete_market_data_generation_config(v.id);
        ...
        REQUIRE_FALSE(svc.get_market_data_generation_config(v.id).has_value());
