...
/**
 * @brief Represents a app version in the database.
 */
struct app_version_entity {
    constexpr static const char* schema = "public";
    constexpr static const char* tablename = "ores_compute_app_versions_tbl";
...
std::ostream& operator<<(std::ostream& s, const app_version_entity& v);
