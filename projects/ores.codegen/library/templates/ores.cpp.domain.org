...
| [[id:6D061F78-B9C2-461A-87A8-CCD65F73BA5F][ores.cpp.domain.json_io_header]] | JSON IO declarations. =domain= and =non-temporal-domain= profiles. |
| [[id:413A5590-0D39-46F7-8C3F-DB11E1149287][ores.cpp.domain.json_io_impl]] | reflect-cpp JSON round-trip implementation. =domain= and =non-temporal-domain= profiles. |
