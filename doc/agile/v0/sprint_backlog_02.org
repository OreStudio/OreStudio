...
#+CAPTION: Clock summary at [2025-02-11 Tue 23:45]
|       | <75>                                   |         |       |      |       |
| Tags  | Headline                               | Time    |       |      |     % |
|-------+----------------------------------------+---------+-------+------+-------|
...
|       | Stories                                | 12:54   |       |      | 100.0 |
|       | Active                                 |         | 12:54 |      | 100.0 |
| agile | Sprint and product backlog refinement  |         |       | 1:22 |  10.6 |
| infra | Fix broken builds                      |         |       | 0:36 |   4.7 |
| code  | Create a containing structure for data |         |       | 0:35 |   4.5 |
| code  | Add temporal support to currencies     |         |       | 2:59 |  23.1 |
| code  | Add command to dump currencies         |         |       | 3:30 |  27.1 |
| code  | Refactor code for currencies           |         |       | 3:52 |  30.0 |
#+end:
