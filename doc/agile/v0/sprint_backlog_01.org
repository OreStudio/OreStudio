...
#+CAPTION: Clock summary at [2024-07-13 Sat 09:59]
|       | <75>                                              |         |       |      |       |
| Tags  | Headline                                          | Time    |       |      |     % |
|-------+---------------------------------------------------+---------+-------+------+-------|
...
|       | Stories                                           | 64:26   |       |      | 100.0 |
|       | Active                                            |         | 64:26 |      | 100.0 |
| agile | Sprint and product backlog refinement             |         |       | 3:11 |   4.9 |
...
| infra | Create and upload a package                       |         |       | 3:28 |   5.4 |
| code  | Create a basic project structure                  |         |       | 2:10 |   3.4 |
| code  | Add a Qt hello world                              |         |       | 3:08 |   4.9 |
| code  | Add a splash screen to applciation                |         |       | 0:41 |   1.1 |
| infra | Add basic site                                    |         |       | 0:34 |   0.9 |
| code  | Add modeling infrastructure                       |         |       | 1:30 |   2.3 |
| infra | Fix code syntax highlighting in site              |         |       | 0:10 |   0.3 |
| doc   | Merge index with readme                           |         |       | 0:42 |   1.1 |
| doc   | Add project objective to readme                   |         |       | 2:24 |   3.7 |
| code  | Add basic logging support                         |         |       | 1:14 |   1.9 |
| infra | Add nightly support with memcheck                 |         |       | 3:21 |   5.2 |
| code  | Clean up toolchains and presets                   |         |       | 1:53 |   2.9 |
| doc   | Generate Doxygen documentation and add it to site |         |       | 0:51 |   1.3 |
| doc   | Copy domain notes on core concepts                |         |       | 4:41 |   7.3 |
| infra | Valgrind fails to run unit tests                  |         |       | 1:12 |   1.9 |
| infra | Initial sanity test generated packages            |         |       | 0:25 |   0.6 |
| code  | Add command line options support                  |         |       | 5:45 |   8.9 |
| infra | Unit tests show up twice in nightlies             |         |       | 0:13 |   0.3 |
| doc   | Add recipes for command line                      |         |       | 0:51 |   1.3 |
| agile | Use a bar chart for sprint resourcing cost        |         |       | 2:57 |   4.6 |
| agile | Classify stories by type                          |         |       | 0:34 |   0.9 |
| code  | Update C++ standard                               |         |       | 0:29 |   0.8 |
| infra | Setup laptop for development                      |         |       | 3:47 |   5.9 |
| infra | Add database support for currency                 |         |       | 1:19 |   2.0 |
| code  | Add XML parsing support for currency              |         |       | 6:32 |  10.1 |
| code  | Add JSON support for currency                     |         |       | 2:03 |   3.2 |
| code  | Add basic widgets to display currencies           |         |       | 1:50 |   2.8 |
...
| infra | Setup code quality actions                        |         |       | 0:14 |   0.4 |
| code  | Updates to Qt UI                                  |         |       | 0:52 |   1.3 |
#+end:
