...
ORE Studio is a graphical front-end for the [[https://www.opensourcerisk.org/][Open Source Risk Engine]] (ORE), which
itself builds on [[https://www.quantlib.org/][QuantLib]]. It provides a database-backed UI for configuring and
