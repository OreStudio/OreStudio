 ...
 *
 */
#ifndef ORES_TRADE_REPOSITORY_TRADE_IDENTIFIER_ENTITY_HPP
#define ORES_TRADE_REPOSITORY_TRADE_IDENTIFIER_ENTITY_HPP
...
struct trade_identifier_entity {
    ...
    constexpr static const char* tablename = "ores_trade_identifiers_tbl";
