 ...
 */
/**
 * Where the crm_enabled_derived_pair screens live and what they can do.
 *
 ...
 */
import { crmEnabledDerivedPairMeta } from '../ui/crm_enabled_derived_pair_ui.js';
import type { EntityDescriptor } from '../../../entity/descriptor.js';

export const crmEnabledDerivedPairDescriptor: EntityDescriptor = {
    component: 'refdata',
    entity: 'crm_enabled_derived_pair',
    meta: crmEnabledDerivedPairMeta,
    routeSegment: 'crm-enabled-derived-pair',
    apiBase: '/api/crm_enabled_derived_pairs',
    keyFields: [
        'id',
    ],
    capabilities: {
