 ...
 */
/**
 * Where the party_identifier screens live and what they can do.
 *
 ...
 */
import { partyIdentifierMeta } from '../ui/party_identifier_ui.js';
import type { EntityDescriptor } from '../../../entity/descriptor.js';

export const partyIdentifierDescriptor: EntityDescriptor = {
    component: 'refdata',
    entity: 'party_identifier',
    meta: partyIdentifierMeta,
    routeSegment: 'party-identifier',
    apiBase: '/api/party_identifiers',
    keyParam: 'id',
    icon: 'keyMultiple',
    capabilities: {
        create: true,
