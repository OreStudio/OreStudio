...
*File:* [[proj:projects/ores.service/include/ores.service/service/request_context.hpp][=projects/ores.service/include/ores.service/service/request_context.hpp=]]

Add a =roles= field (=std::vector<std::string>=) to the context struct.

*** Step 2d — =check_permission()= helper in handler_helpers

*File:* [[proj:projects/ores.service/include/ores.service/messaging/handler_helpers.hpp][=projects/ores.service/include/ores.service/messaging/handler_helpers.hpp=]]
...
| [[proj:projects/ores.sql/create/iam/iam_service_db_grants_create.sql][=projects/ores.sql/create/iam/iam_service_db_grants_create.sql=]]                   | New — GRANT matrix per Phase 1                   |
| [[proj:projects/ores.sql/populate/iam/iam_permissions_populate.sql][=projects/ores.sql/populate/iam/iam_permissions_populate.sql=]]                     | Replace with full permission scheme              |
| [[proj:projects/ores.sql/populate/iam/iam_roles_populate.sql][=projects/ores.sql/populate/iam/iam_roles_populate.sql=]]                           | New — one role per service                       |
| =projects/ores.sql/populate/iam/iam_role_permissions_populate.sql=                | New — role → permission assignments              |
| [[proj:projects/ores.sql/populate/iam/iam_service_account_roles_populate.sql][=projects/ores.sql/populate/iam/iam_service_account_roles_populate.sql=]]           | New — service account → role assignments         |
| =projects/ores.iam.core/include/ores.iam.core/messaging/auth_handler.hpp=         | Add roles to =service_login= JWT claims          |
| [[proj:projects/ores.service/include/ores.service/service/request_context.hpp][=projects/ores.service/include/ores.service/service/request_context.hpp=]]          | Add =roles= field                                |
| [[proj:projects/ores.service/src/service/request_context.cpp][=projects/ores.service/src/service/request_context.cpp=]]                           | Extract =roles= from JWT claims                  |
| [[proj:projects/ores.service/include/ores.service/messaging/handler_helpers.hpp][=projects/ores.service/include/ores.service/messaging/handler_helpers.hpp=]]        | Add =require_permission()= helper                |
...
1. Creates [[proj:build/keys/nats][=build/keys/nats/=]] directory (already git-ignored via
...
Certificates and keys are written under [[proj:build/keys/nats][=build/keys/nats/=]] and are never
committed (already covered by the existing =build/keys/*.pem= gitignore rule;
extend it to cover [[proj:build/keys/nats][=build/keys/nats/=]]).
...
*File:* [[proj:projects/ores.nats/include/ores.nats/config/nats_options.hpp][=projects/ores.nats/include/ores.nats/config/nats_options.hpp=]]
...
*File:* [[proj:projects/ores.nats/src/service/client.cpp][=projects/ores.nats/src/service/client.cpp=]]
...
*File:* [[proj:projects/ores.nats/src/config/nats_configuration.cpp][=projects/ores.nats/src/config/nats_configuration.cpp=]]
...
pointing each service at its own keypair under [[proj:build/keys/nats][=build/keys/nats/=]].
...
| =.gitignore=                                      | Extend to cover [[proj:build/keys/nats][=build/keys/nats/=]]                  |
| =projects/ores.nats/include/.../nats_options.hpp= | Add =tls_ca_cert=, =tls_client_cert=, =tls_client_key= |
| [[proj:projects/ores.nats/src/service/client.cpp][=projects/ores.nats/src/service/client.cpp=]]       | Apply TLS options via =natsOptions_*= API           |
| [[proj:projects/ores.nats/src/config/nats_configuration.cpp][=projects/ores.nats/src/config/nats_configuration.cpp=]] | Parse TLS CLI flags / env vars                 |
...
- [[proj:projects/ores.sql/setup_user.sql][=projects/ores.sql/setup_user.sql=]] :: rename variable and validation block
- [[proj:projects/ores.sql/recreate_database.sql][=projects/ores.sql/recreate_database.sql=]] :: rename =comms_user= blocks
- =projects/ores.sql/recreate_database.sh= :: rename variable names and help text
- =projects/ores.sql/setup_database.sh= :: rename =-v comms_user= flag
- [[proj:projects/ores.sql/setup_schema.sql][=projects/ores.sql/setup_schema.sql=]] :: rename if referenced (currently not)
- [[proj:projects/ores.sql/drop_roles.sql][=projects/ores.sql/drop_roles.sql=]] :: rename =comms_user= entry in user array
- [[proj:projects/ores.sql/populate/iam/iam_service_accounts_populate.sql][=projects/ores.sql/populate/iam/iam_service_accounts_populate.sql=]] :: rename
  the upsert call from =:'comms_user'= to =:'shell_user'=

*** Step 4b — Init script and .env

In =build/scripts/init-environment.sh=:

- Rename =ORES_DB_COMMS_USER= → =ORES_DB_SHELL_USER=
- Rename =ORES_DB_COMMS_PASSWORD= → =ORES_DB_SHELL_PASSWORD=
- Rename the emitted section from =ORES_COMMS_SHELL_DB_*= →
  =ORES_SHELL_DB_USER=, =ORES_SHELL_DB_PASSWORD=, =ORES_SHELL_DB_DATABASE=

*** Step 4c — C++ config

In [[proj:projects/ores.shell/src/config/parser.cpp][=projects/ores.shell/src/config/parser.cpp=]]:
...
- [[proj:projects/ores.sql/modeling/database_lifecycle.org][=projects/ores.sql/modeling/database_lifecycle.org=]]
- =doc/recipes/shell_recipes.org= (=ORES_COMMS_SHELL_LOGIN_PASSWORD= →
  =ORES_SHELL_LOGIN_PASSWORD=; =ores_comms_user= → =ores_shell_user=)
- Any [[proj:.claude/skills][=.claude/skills=]] or [[proj:doc/llm/skills][=doc/llm/skills=]] files referencing =COMMS_SHELL=

** Files Changed

| File                                                                 | Change                                        |
|----------------------------------------------------------------------+-----------------------------------------------|
| [[proj:projects/ores.sql/setup_user.sql][=projects/ores.sql/setup_user.sql=]]                                   | =comms_user= / =comms_password= → =shell_user= / =shell_password= |
| [[proj:projects/ores.sql/recreate_database.sql][=projects/ores.sql/recreate_database.sql=]]                            | Same rename                                   |
| =projects/ores.sql/recreate_database.sh=                             | Same rename + help text                       |
| =projects/ores.sql/setup_database.sh=                                | Same rename                                   |
| [[proj:projects/ores.sql/drop_roles.sql][=projects/ores.sql/drop_roles.sql=]]                                   | Same rename                                   |
| [[proj:projects/ores.sql/populate/iam/iam_service_accounts_populate.sql][=projects/ores.sql/populate/iam/iam_service_accounts_populate.sql=]]   | =comms_user= → =shell_user= upsert parameter  |
| =build/scripts/init-environment.sh=                                  | =ORES_DB_COMMS_*= → =ORES_DB_SHELL_*=         |
| [[proj:projects/ores.shell/src/config/parser.cpp][=projects/ores.shell/src/config/parser.cpp=]]                          | =make_mapper("COMMS_SHELL")= → =make_mapper("SHELL")= |
| =doc/recipes/shell_recipes.org=                                       | Update all =COMMS_SHELL= / =comms_user= refs  |
| [[proj:projects/ores.sql/modeling/database_lifecycle.org][=projects/ores.sql/modeling/database_lifecycle.org=]]                  | Update user table                             |
