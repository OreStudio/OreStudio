 ...
 */
#ifndef ORES_SHELL_APP_COMMANDS_SERIES_SUBCLASS_CODE_COMMANDS_HPP
#define ORES_SHELL_APP_COMMANDS_SERIES_SUBCLASS_CODE_COMMANDS_HPP
...
/**
 * @brief Every verb series subclass codes answer, as one command each.
 *
 ...
 */
class series_subclass_code_commands {
private:
    inline static std::string_view logger_name =
        "ores.shell.app.commands.refdata.series_subclass_code_commands";
...
public:
    /**
     * @brief Register the series subclass codes submenu.
     */
