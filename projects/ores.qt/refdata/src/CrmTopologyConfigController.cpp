...
constexpr std::string_view config_event_name =
    eventing::domain::event_traits<refdata::eventing::crm_topology_config_changed_event>::name;
}
...
void CrmTopologyConfigController::onShowDetails(
    const refdata::domain::crm_topology_config& config) {
...
void CrmTopologyConfigController::onOpenVersion(const refdata::domain::crm_topology_config& config,
                                                int versionNumber) {
