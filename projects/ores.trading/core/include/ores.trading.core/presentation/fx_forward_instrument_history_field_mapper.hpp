 ...
 *
 */
#ifndef ORES_TRADING_CORE_PRESENTATION_FX_FORWARD_INSTRUMENT_HISTORY_FIELD_MAPPER_HPP
#define ORES_TRADING_CORE_PRESENTATION_FX_FORWARD_INSTRUMENT_HISTORY_FIELD_MAPPER_HPP
...
/**
 * @brief Renders a fx_forward_instrument to an ordered field list for
