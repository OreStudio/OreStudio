...
| Now           | 4/9 tasks done. book_purpose_type lookup entity shipped and QA'd. |
| Waiting on    | Nothing.                               |
| Next          | Pick up the next BACKLOG task (ledger_feed_type, is_sweepable, or one of the investigation/rename tasks). |
...
| [[id:DC13CC83-2807-4AA9-B56E-BA7D6BA896D2][Add ledger_feed_type lookup entity to book]] | STARTED | 2026-07-13 | | Replace the originally-scoped is_ledger_book/is_manual_ledger_book boolean pair with one 3-state ledger_feed_type field (None/Automatic/Manual), following the regulatory_book_type lookup-entity pattern -- removes the invalid state where manual=true but ledger=false. |
