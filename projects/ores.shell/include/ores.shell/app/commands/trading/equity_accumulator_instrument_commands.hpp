 ...
 *
 */
#ifndef ORES_SHELL_APP_COMMANDS_TRADING_EQUITY_ACCUMULATOR_INSTRUMENT_COMMANDS_HPP
#define ORES_SHELL_APP_COMMANDS_TRADING_EQUITY_ACCUMULATOR_INSTRUMENT_COMMANDS_HPP
