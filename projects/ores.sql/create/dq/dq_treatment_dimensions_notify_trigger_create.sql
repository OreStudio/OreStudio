 ...
 *
 */
create or replace function ores_dq_treatment_dimensions_notify_fn()
returns trigger as $$
declare
...
create or replace trigger ores_dq_treatment_dimensions_notify_trg
after insert or update or delete on ores_dq_treatment_dimensions_tbl
for each row execute function ores_dq_treatment_dimensions_notify_fn();
