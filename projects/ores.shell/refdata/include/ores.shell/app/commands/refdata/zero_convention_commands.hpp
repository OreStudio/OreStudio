 ...
 */
#ifndef ORES_SHELL_APP_COMMANDS_ZERO_CONVENTION_COMMANDS_HPP
#define ORES_SHELL_APP_COMMANDS_ZERO_CONVENTION_COMMANDS_HPP
...
/**
 * @brief Every verb zero conventions answer, as one command each.
 *
 ...
 */
class zero_convention_commands {
private:
    inline static std::string_view logger_name =
        "ores.shell.app.commands.refdata.zero_convention_commands";
...
public:
    /**
     * @brief Register the zero conventions submenu.
     */
