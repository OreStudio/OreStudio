...
void print_app_version_table(std::ostream& s, const std::vector<app_version>& v) {
    s << std::endl << convert_to_table(v) << std::endl;
}

}

std::ostream& operator<<(std::ostream& s, const std::vector<app_version>& v) {
    print_app_version_table(s, v);
    return s;
}
