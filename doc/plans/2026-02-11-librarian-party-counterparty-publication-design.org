...
| File                                                          | Change                                         |
|---------------------------------------------------------------+------------------------------------------------|
| [[proj:projects/ores.sql/populate/lei/lei_dataset_dependency_populate.sql][=projects/ores.sql/populate/lei/lei_dataset_dependency_populate.sql=]] | Add missing dependencies                |
...
| File                                                           | Change                                  |
|----------------------------------------------------------------+-----------------------------------------|
| [[proj:projects/ores.sql/create/refdata/refdata_counterparties_create.sql][=projects/ores.sql/create/refdata/refdata_counterparties_create.sql=]] | Add =party_id= column + validation |
| [[proj:projects/ores.sql/create/refdata/refdata_counterparty_identifiers_create.sql][=projects/ores.sql/create/refdata/refdata_counterparty_identifiers_create.sql=]] | Add =party_id=         |
| [[proj:projects/ores.sql/create/refdata/refdata_counterparty_contact_informations_create.sql][=projects/ores.sql/create/refdata/refdata_counterparty_contact_informations_create.sql=]] | Add =party_id= |
...
| [[proj:projects/ores.sql/populate/dq/dq_artefact_types_populate.sql][=projects/ores.sql/populate/dq/dq_artefact_types_populate.sql=]] | Add params schema to =lei_counterparties= |
