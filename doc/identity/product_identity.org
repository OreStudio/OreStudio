...
delegating all quantitative mathematics to ORE and QuantLib, and keeping
...
textbooks, not by running spreadsheets: by modifying code, running ORE,
and observing what changes. A secondary audience is the developer already
familiar with ORE or QuantLib who wants a graphical environment for
exploration and experimentation.

ORE Studio is /independent of/ both ORE and QuantLib and has no
