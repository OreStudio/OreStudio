...
#+begin_src sh
export ORES_CLI_DB_PASSWORD
./ores.cli roles list ${db_args} ${log_args} --format json | jq .
#+end_src
...
#+begin_src sh :wrap src text
export ORES_CLI_DB_PASSWORD
./ores.cli roles delete ${db_args} ${log_args} \
  --key "test-role-id"
#+end_src
...
#+begin_src sh
export ORES_CLI_DB_PASSWORD
./ores.cli permissions list ${db_args} ${log_args} --format json | jq .
#+end_src
...
#+begin_src sh :wrap src text
export ORES_CLI_DB_PASSWORD
./ores.cli countries list ${db_args} ${log_args} --format table | head -n 10
#+end_src
...
#+begin_src sh
export ORES_CLI_DB_PASSWORD
./ores.cli change-reasons list ${db_args} ${log_args} --format json | jq .
#+end_src
...
./ores.cli change-reason-categories list ${db_args} ${log_args} \
  --format json --key "operational" | jq .
#+end_src
