...
private:
    inline static std::string_view logger_name = "ores.qt.party_history_dialog";
...
public:
    explicit PartyHistoryDialog(const boost::uuids::uuid& id,
                                const QString& code,
...
private:
    /**
     * @brief Fetches the party's composite state (identifiers, contact
     * information) as of the given version and populates the "Composite"
     * tab. See the "Temporal composite entity versioning" architecture doc.
     */
