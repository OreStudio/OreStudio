...
#+description: Codegen entity model for the trading =cap_floor_instrument= table. Drives the C++ domain class, mapper, repository, service, generator, and SQL schema generation from a single literate source.
