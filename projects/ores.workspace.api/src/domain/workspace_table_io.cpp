...
void print_workspace_table(std::ostream& s, const std::vector<workspace>& v) {
    s << std::endl << convert_to_table(v) << std::endl;
}

}

std::ostream& operator<<(std::ostream& s, const std::vector<workspace>& v) {
    print_workspace_table(s, v);
    return s;
}
