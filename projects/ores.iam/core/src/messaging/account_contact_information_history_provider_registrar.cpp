 ...
 *
 */
#include "ores.iam.core/messaging/account_contact_information_history_provider_registrar.hpp"
...
void register_account_contact_information_history_provider(
    ...
    registry.register_history_provider(
        ...
        [](const ores::database::context& scoped_ctx, const std::string& entity_id) {
            service::account_contact_information_service svc(scoped_ctx);
            auto versions = svc.get_account_contact_information_history(entity_id);
            return ores::history::service::build_entity_history_versions(
                versions, presentation::render_account_contact_information_fields);
        });
}
