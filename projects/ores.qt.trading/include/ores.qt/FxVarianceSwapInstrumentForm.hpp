...
/**
 * @brief IInstrumentForm for FX Variance Swap trades.
 *
 * Handles: FxVarianceSwap.
 */
class FxVarianceSwapInstrumentForm final : public IInstrumentForm {
    Q_OBJECT
...
public:
    explicit FxVarianceSwapInstrumentForm(QWidget* parent = nullptr);
    ~FxVarianceSwapInstrumentForm() override;
...
private:
    ...
    Ui::FxVarianceSwapInstrumentForm* ui_;
    ClientManager* clientManager_ = nullptr;
    ImageCache* imageCache_ = nullptr;
    std::string username_;
    trading::domain::fx_variance_swap_instrument instrument_;
    bool dirty_ = false;
    bool loaded_ = false;
};
