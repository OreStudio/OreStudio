...
| [[id:8DBD1BAE-EC77-4008-99CB-3C08C20CB575][Verify compute grid package SHA256 on download]] | DONE | 2026-07-31 | 2026-07-31 | ores.compute.wrapper should verify a downloaded engine package's checksum against a known-good SHA256 before extracting/running it. |
| [[id:0F768B80-184A-44C7-B725-A594A873AB4A][Design and build ACME compute package publishing (client lib, shell, Qt)]] | DONE | 2026-07-31 | 2026-08-01 | New ores.compute.client package_publisher shared by ores.shell and ores.qt; retarget AppProvisionerWizard to per-platform uploads on the seed's own key shape; vendor the ORE binary into the build. |
