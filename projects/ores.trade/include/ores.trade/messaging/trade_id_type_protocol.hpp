 ...
 *
 */
#ifndef ORES_TRADE_MESSAGING_TRADE_ID_TYPE_PROTOCOL_HPP
#define ORES_TRADE_MESSAGING_TRADE_ID_TYPE_PROTOCOL_HPP
...
/**
 * @brief Request to save a trade ID type (create or update).
 */
struct save_trade_id_type_request final {
    domain::trade_id_type id_type;
...
/**
 * @brief Response confirming trade ID type save operation.
 */
...
/**
 * @brief Result for a single trade ID type deletion.
 */
struct delete_trade_id_type_result final {
...
struct delete_trade_id_type_response final {
    std::vector<delete_trade_id_type_result> results;
...
template<>
struct message_traits<trade::messaging::get_trade_id_types_request> {
    using request_type = trade::messaging::get_trade_id_types_request;
    using response_type = trade::messaging::get_trade_id_types_response;
    static constexpr message_type request_message_type =
        message_type::get_trade_id_types_request;
};

template<>
struct message_traits<trade::messaging::save_trade_id_type_request> {
    using request_type = trade::messaging::save_trade_id_type_request;
    using response_type = trade::messaging::save_trade_id_type_response;
    static constexpr message_type request_message_type =
        message_type::save_trade_id_type_request;
};

template<>
struct message_traits<trade::messaging::delete_trade_id_type_request> {
    using request_type = trade::messaging::delete_trade_id_type_request;
    using response_type = trade::messaging::delete_trade_id_type_response;
    static constexpr message_type request_message_type =
        message_type::delete_trade_id_type_request;
};

template<>
struct message_traits<trade::messaging::get_trade_id_type_history_request> {
    using request_type = trade::messaging::get_trade_id_type_history_request;
    using response_type = trade::messaging::get_trade_id_type_history_response;
    static constexpr message_type request_message_type =
