...
#+description: Codegen entity model for the iam =tenant_type= table. Drives the C++ domain class, mapper, repository, service, generator, TypeScript UI metadata, and SQL schema generation from a single literate source.
...
:key_field:              type
:get_request_class:      iam::messaging::list_tenant_types_request
:get_response_class:     iam::messaging::list_tenant_types_response
:get_message_type:       list_tenant_types_request
:save_request_class:     iam::messaging::put_tenant_type_request
:save_response_class:    iam::messaging::put_tenant_type_response
:save_message_type:      put_tenant_type_request
...
:history_request_class:  iam::messaging::list_tenant_type_versions_request
:history_response_class: iam::messaging::list_tenant_type_versions_response
:history_message_type:   list_tenant_type_versions_request
