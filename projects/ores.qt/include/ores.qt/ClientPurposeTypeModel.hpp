 ...
 */
class ClientPurposeTypeModel final : public QAbstractTableModel {
    Q_OBJECT

private:
    inline static std::string_view logger_name =
        "ores.qt.client_purpose_type_model";
...
public:
    ...
    explicit ClientPurposeTypeModel(ClientManager* clientManager,
