...
register_party_identifier_event_mapping(ev::service::postgres_event_source& event_source,
    ...
    ev::service::registrar::register_mapping<refdata::eventing::party_identifier_changed_event>(
        event_source, "ores.refdata.party_identifier", "ores_refdata_party_identifiers");

    return event_bus.subscribe<refdata::eventing::party_identifier_changed_event>(
        [&nats](const refdata::eventing::party_identifier_changed_event& e) {
            ev::service::publish_entity_event(
                nats,
                std::string(ev::domain::event_traits<
                            refdata::eventing::party_identifier_changed_event>::name),
