...
#+CAPTION: Clock summary at [2026-02-12 Thu 23:09], for Thursday, February 12, 2026.
|       | <75>                                  |        |      |      |       |
| Tags  | Headline                              | Time   |      |      |     % |
|-------+---------------------------------------+--------+------+------+-------|
|       | *Total time*                          | *6:31* |      |      | 100.0 |
|-------+---------------------------------------+--------+------+------+-------|
|       | Stories                               | 6:31   |      |      | 100.0 |
|       | Active                                |        | 6:31 |      | 100.0 |
| agile | Sprint and product backlog refinement |        |      | 1:12 |  18.4 |
| code  | Fix OSX build                         |        |      | 0:19 |   4.9 |
| code  | Add pagination to counterparty        |        |      | 0:58 |  14.8 |
| code  | Add support for business centres      |        |      | 3:47 |  58.1 |
| code  | Add a setup new tenant wizard         |        |      | 0:15 |   3.8 |
#+end:

#+begin: clocktable :maxlevel 3 :scope subtree :tags t :indent nil :emphasize nil :scope file :narrow 75 :formula %
#+TBLNAME: sprint_summary
#+CAPTION: Clock summary at [2026-02-12 Thu 23:09]
|       | <75>                                               |         |       |      |       |
| Tags  | Headline                                           | Time    |       |      |     % |
|-------+----------------------------------------------------+---------+-------+------+-------|
|       | *Total time*                                       | *43:09* |       |      | 100.0 |
|-------+----------------------------------------------------+---------+-------+------+-------|
|       | Stories                                            | 43:09   |       |      | 100.0 |
|       | Active                                             |         | 43:09 |      | 100.0 |
| agile | Sprint and product backlog refinement              |         |       | 2:30 |   5.8 |
| code  | Add bound parameters to sqlgen                     |         |       | 0:51 |   2.0 |
| code  | Add roles to account via codes                     |         |       | 0:34 |   1.3 |
| code  | Implement party related entities at database level |         |       | 4:23 |  10.2 |
| code  | Add party related support at the domain level      |         |       | 0:23 |   0.9 |
| code  | Add party related support to Qt                    |         |       | 6:41 |  15.5 |
| code  | Add GLEIF data to datasets                         |         |       | 6:41 |  15.5 |
| code  | Brainstorm on multi-party support                  |         |       | 4:00 |   9.3 |
| code  | Improve code coverage                              |         |       | 0:14 |   0.5 |
| code  | Improve generators with FK-aware test data         |         |       | 1:44 |   4.0 |
| code  | Enable all skipped tests                           |         |       | 0:29 |   1.1 |
| code  | Add central bank related LEIs                      |         |       | 0:35 |   1.4 |
| code  | Expand unit test coverage for ORE codegened types  |         |       | 0:49 |   1.9 |
| code  | Add system party support                           |         |       | 3:58 |   9.2 |
| code  | Add customer party support                         |         |       | 1:33 |   3.6 |
| code  | Fix OSX build                                      |         |       | 0:19 |   0.7 |
| code  | Add pagination to counterparty                     |         |       | 0:58 |   2.2 |
| code  | Add support for business centres                   |         |       | 3:47 |   8.8 |
| code  | Add a setup new tenant wizard                      |         |       | 1:27 |   3.4 |
| code  | Add workspace as a container                       |         |       | 1:13 |   2.8 |
#+end:
...
*** STARTED Add support for business centres                           :code:
    :LOGBOOK:
...
*** Fix audit trail metadata for recorded_by and modified_by           :code:
...
*** Separate party identifiers (LEI, BIC) into dedicated table         :code:
...
*** Enforce root party uniqueness constraints                          :code:
...
*** Polish party and counterparty list UI                              :code:
...
*** Gate party and counterparty wizard steps by tenant type            :code:
...
*** Improve tenant provisioning wizard UX                              :code:
...
*** Add evaluation tenant onboarding wizard on first login             :code:
...
*** Add proper party short-codes                                       :code:
