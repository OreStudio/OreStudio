...
void BusinessUnitController::showHistoryWindow(
    ...
    auto* historyDialog =
        new BusinessUnitHistoryDialog(business_unit.id, code, clientManager_, mainWindow_);

    connect(historyDialog,
            &BusinessUnitHistoryDialog::statusChanged,
            this,
    ...
    connect(historyDialog,
            &BusinessUnitHistoryDialog::errorOccurred,
            this,
            [self = QPointer<BusinessUnitController>(this)](const QString& message) {
                if (!self)
                    return;
    ...
    connect(historyDialog,
            &BusinessUnitHistoryDialog::revertVersionRequested,
            this,
            &BusinessUnitController::onRevertVersion);
    connect(historyDialog,
            &BusinessUnitHistoryDialog::openVersionRequested,
            this,
            &BusinessUnitController::onOpenVersion);
