...
| [[id:A4F81E5E-6795-4533-AD3A-371EE4F01D41][Rename ledger_ccy to functional_currency]] | STARTED | 2026-07-14 | | ledger_ccy is described in the domain notes as the book's functional/accounting currency, designated by the ledger. Rename the field (and its Qt label, column header, etc.) to functional_currency to match domain terminology precisely. |
