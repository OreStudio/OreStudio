...
#+CAPTION: Clock summary at [2024-07-19 Fri 23:39]
|       | <75>                                               |         |       |      |       |
| Tags  | Headline                                           | Time    |       |      |     % |
|-------+----------------------------------------------------+---------+-------+------+-------|
...
|       | Stories                                            | 73:30   |       |      | 100.0 |
|       | Active                                             |         | 73:30 |      | 100.0 |
| agile | Sprint and product backlog refinement              |         |       | 3:26 |   4.7 |
...
| infra | Create and upload a package                        |         |       | 3:28 |   4.7 |
| code  | Create a basic project structure                   |         |       | 2:10 |   2.9 |
| code  | Add a Qt hello world                               |         |       | 3:08 |   4.3 |
...
| code  | Add XML parsing support for currency               |         |       | 6:32 |   8.9 |
| code  | Add JSON support for currency                      |         |       | 2:03 |   2.8 |
| code  | Add basic widgets to display currencies            |         |       | 1:50 |   2.5 |
