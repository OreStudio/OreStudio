...
service-registry consolidation discovered here is deferred follow-up,
captured in its own task (not a blocker for this story).
...
| [[id:9B8BB792-3562-4B52-B367-C94EF46BA100][Consolidate service registries into a single source of truth]] | DISCOVERED | | | Deferred follow-up (not part of this story's completion). Inventory + plan captured; to be promoted to its own story. Surfaced by the regroup breaking the directory glob; unblocked here by a stop-gap. |
