 ...
 *
 * Manages the lifecycle of feed binding list, detail, and history windows.
 * Handles event subscriptions and coordinates between windows.
 */
class FeedBindingController final : public EntityController {
    Q_OBJECT

private:
    inline static std::string_view logger_name = "ores.qt.feed_binding_controller";
