...
create table if not exists "ores"."dq_account_types_artefact_tbl" (
...
on "ores"."dq_account_types_artefact_tbl" (dataset_id);

create index if not exists dq_account_types_artefact_code_idx
on "ores"."dq_account_types_artefact_tbl" (code);

create index if not exists dq_account_types_artefact_coding_scheme_idx
on "ores"."dq_account_types_artefact_tbl" (coding_scheme_code);
