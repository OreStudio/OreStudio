 ...
 *
 */
#ifndef ORES_REFDATA_API_MESSAGING_CURRENCY_HISTORY_PROTOCOL_HPP
#define ORES_REFDATA_API_MESSAGING_CURRENCY_HISTORY_PROTOCOL_HPP
...
struct currency_version_history {
    std::vector<ores::refdata::domain::currency_version> versions;
};
...
struct get_currency_history_response {
    bool success = false;
    std::string message;
    currency_version_history history;
};
