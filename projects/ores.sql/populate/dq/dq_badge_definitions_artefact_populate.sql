...
values
    ...
    (ores_utility_system_tenant_id_fn(), :'v_dataset_id', 'purpose_type_client_reporting', 0, 'Client Reporting', 'Report generated for client-facing reporting.', '#3b82f6', '#ffffff', 'info', 'badge bg-info', 96),
    (ores_utility_system_tenant_id_fn(), :'v_dataset_id', 'purpose_type_internal', 0, 'Internal', 'Report generated for internal use.', '#14b8a6', '#ffffff', 'info', 'badge bg-info', 97),
    (ores_utility_system_tenant_id_fn(), :'v_dataset_id', 'purpose_type_regulatory', 0, 'Regulatory', 'Report generated for regulatory submission.', '#7c3aed', '#ffffff', 'primary', 'badge bg-primary', 98),
    (ores_utility_system_tenant_id_fn(), :'v_dataset_id', 'purpose_type_risk', 0, 'Risk', 'Report generated for risk management use.', '#8b5cf6', '#ffffff', 'primary', 'badge bg-primary', 99),
