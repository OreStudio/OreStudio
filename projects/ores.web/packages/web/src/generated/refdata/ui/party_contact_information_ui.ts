 ...
 */
export const partyContactInformationMessages = {
        party_contact_information: {
            title: 'Party Contact Information',
            singular: 'party contact information',
            newTitle: 'New party contact information',
            description: 'Contact details for parties organised by purpose (Legal, Operations, Settlement, Billing). Each party can have one contact record per type.',
            fldContactType: 'Type',
