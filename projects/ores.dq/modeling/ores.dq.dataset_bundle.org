...
#+description: Codegen entity model for the dq =dataset_bundle= table. Drives the C++ domain class, mapper, repository, service, generator, TypeScript UI metadata, and SQL schema generation from a single literate source.
...
** Presentation
:PROPERTIES:
:domain_include:         ores.dq.api/domain/dataset_bundle.hpp
:domain_class:           dq::domain::dataset_bundle
:protocol_include:       ores.dq.api/messaging/dataset_bundle_protocol.hpp
