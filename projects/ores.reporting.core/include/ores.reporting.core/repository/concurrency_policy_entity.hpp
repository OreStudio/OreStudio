...
/**
 * @brief Represents a concurrency policy in the database.
 */
struct concurrency_policy_entity {
...
std::ostream& operator<<(std::ostream& s, const concurrency_policy_entity& v);
