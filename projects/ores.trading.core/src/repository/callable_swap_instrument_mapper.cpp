...
callable_swap_instrument_mapper::map(const callable_swap_instrument_entity& v) {
...
callable_swap_instrument_entity
callable_swap_instrument_mapper::map(const domain::callable_swap_instrument& v) {
    BOOST_LOG_SEV(lg(), trace) << "Mapping domain entity: " << v;

    callable_swap_instrument_entity r;
