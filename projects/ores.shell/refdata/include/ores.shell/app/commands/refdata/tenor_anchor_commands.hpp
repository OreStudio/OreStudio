 ...
 */
#ifndef ORES_SHELL_APP_COMMANDS_TENOR_ANCHOR_COMMANDS_HPP
#define ORES_SHELL_APP_COMMANDS_TENOR_ANCHOR_COMMANDS_HPP
...
/**
 * @brief Every verb tenor anchors answer, as one command each.
 *
 ...
 */
class tenor_anchor_commands {
private:
    inline static std::string_view logger_name =
        "ores.shell.app.commands.refdata.tenor_anchor_commands";
...
public:
    /**
     * @brief Register the tenor anchors submenu.
     */
    ...
    /**
     * @brief add <code> <description> <display_order> <reason> <commentary>
     */
    ...
    /**
     * @brief set <code> <description> <display_order> <reason> <commentary> [--version <n>]
     */
    ...
    /**
     * @brief put-many --count <n> <code> <description> <display_order> <reason> <commentary>
     */
