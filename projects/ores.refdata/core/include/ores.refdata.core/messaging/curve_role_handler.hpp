 ...
 *
 */
#ifndef ORES_REFDATA_CORE_MESSAGING_CURVE_ROLE_HANDLER_HPP
#define ORES_REFDATA_CORE_MESSAGING_CURVE_ROLE_HANDLER_HPP
...
namespace {
inline auto& curve_role_handler_lg() {
    static auto instance = ores::logging::make_logger("ores.refdata.messaging.curve_role_handler");
    return instance;
}
} // namespace
...
/**
 * @brief NATS message handler for curve role operations.
 */
class curve_role_handler {
public:
    curve_role_handler(ores::nats::service::client& nats,
