 ...
 *
 */
#ifndef ORES_DQ_CORE_REPOSITORY_METHODOLOGY_ENTITY_HPP
#define ORES_DQ_CORE_REPOSITORY_METHODOLOGY_ENTITY_HPP
...
std::ostream& operator<<(std::ostream& s, const methodology_entity& v);
