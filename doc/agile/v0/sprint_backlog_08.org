...
#+CAPTION: Clock summary at [2025-12-31 Wed 11:26], for Wednesday, December 31, 2025.
|       | <75>                                  |        |      |      |       |
| Tags  | Headline                              | Time   |      |      |     % |
|-------+---------------------------------------+--------+------+------+-------|
...
|       | Stories                               | 1:05   |      |      | 100.0 |
|       | Active                                |        | 1:05 |      | 100.0 |
| agile | Sprint and product backlog refinement |        |      | 1:05 | 100.0 |
#+end:

#+begin: clocktable :maxlevel 3 :scope subtree :tags t :indent nil :emphasize nil :scope file :narrow 75 :formula %
#+TBLNAME: sprint_summary
#+CAPTION: Clock summary at [2025-12-31 Wed 11:26]
|       | <75>                                  |        |      |      |       |
| Tags  | Headline                              | Time   |      |      |     % |
|-------+---------------------------------------+--------+------+------+-------|
|       | *Total time*                          | *1:05* |      |      | 100.0 |
...
*** Rerun SQL scripts from scratch                                     :code:

We need to validate the scripts.
