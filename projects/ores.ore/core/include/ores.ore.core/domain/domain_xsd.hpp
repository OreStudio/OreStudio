...
public:
    ...
    vector()
        : impl_(new std::vector<T>()) {}

    vector(std::initializer_list<T> il)
        : impl_(new std::vector<T>(il)) {}

    vector(const vector& o)
        : impl_(new std::vector<T>(*o.impl_)) {}
...
public:
    ...
    void push_back(bool value) {
        std::vector<char>::push_back(value ? 1 : 0);
    }
    void emplace_back() {
        std::vector<char>::emplace_back(0);
    }
    bool& back() {
        return reinterpret_cast<bool&>(std::vector<char>::back());
    }
    const bool& back() const {
        return reinterpret_cast<const bool&>(std::vector<char>::back());
    }
};
...
public:
    ...
    friend bool operator==(const optional& lh, const T& rh) {
        return lh._data && *lh._data == rh;
    }
    friend bool operator!=(const optional& lh, const T& rh) {
        return !lh._data || *lh._data != rh;
    }
    friend bool operator==(const T& lh, const optional& rh) {
        return rh._data && lh == rh._data;
    }
    friend bool operator!=(const T& lh, const optional& rh) {
        return !rh._data || lh != rh._data;
    }
    friend bool operator==(const optional& lh, const optional& rh) {
