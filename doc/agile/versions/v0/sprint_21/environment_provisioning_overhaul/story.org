...
| [[id:FB164A88-BA47-4C6F-A1A2-DB582754AD1C][Remove last-sprint cmake vcpkg-bypass hacks and wire call-sites to new compass commands]] | STARTED | 2026-06-18 | | Last sprint, hacks were added to cmake to allow building certain targets without vcpkg. Now that the new direct-emacs compass commands exist (see add_direct_emacs_compass_commands task), remove all those cmake workarounds. Update any call-sites that previously invoked cmake for these targets to use the new compass commands instead, leaving cmake clean and purely responsible for C++ builds. |
