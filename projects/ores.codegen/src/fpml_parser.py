...
def generate_fpml_sql(output_dir: Path, dataset_files: list[str], artefact_files: list[str]):
    ...
    lines = [
        ...
        " *",
        " * Auto-generated by fpml_parser.py",
...
def generate_coding_schemes_sql(entities: list[MergedEntity], output_path: Path):
    ...
    lines = [
        ...
        f" *   SELECT * FROM ores_dq_coding_schemes_publish_fn(",
        f" *       (SELECT id FROM ores_dq_datasets_tbl WHERE code = '{dataset_code}' AND valid_to = ores_utility_infinity_timestamp_fn()),",
        " *       'upsert'",
        " *   );",
        " */",
        "",
        ...
        f"select id as v_dataset_id from ores_dq_datasets_tbl where code = '{dataset_code}' and valid_to = ores_utility_infinity_timestamp_fn() \\gset",
        "",
