...
drop role if exists ores_variability_service;
drop role if exists ores_assets_service;
drop role if exists ores_synthetic_service;
drop role if exists ores_scheduler_service;
