...
TEST_CASE("write_crm_topology_config_publishes_an_event", tags) {
    ...
    using event_type = ores::refdata::messaging::crm_topology_config_event;
    ...
    event_source.register_entity_event_mapping<event_type>("ores_refdata_crm_topology_configs");
