 ...
 *
 */
#ifndef ORES_DQ_CORE_MESSAGING_REPORT_DEFINITION_HANDLER_HPP
#define ORES_DQ_CORE_MESSAGING_REPORT_DEFINITION_HANDLER_HPP
...
inline auto& report_definition_handler_lg() {
    static auto instance =
        ores::logging::make_logger("ores.dq.messaging.report_definition_handler");
    return instance;
}
} // namespace
...
public:
    ...
    void save(ores::nats::message msg) {
        ...
        const auto& req_ctx = *req_ctx_expected;
        if (!has_permission(req_ctx, "dq::report_definitions:write")) {
    ...
    void remove(ores::nats::message msg) {
        ...
        const auto& req_ctx = *req_ctx_expected;
        if (!has_permission(req_ctx, "dq::report_definitions:delete")) {
            error_reply(nats_, msg, ores::service::error_code::forbidden);
            return;
        }
        service::report_definition_service svc(req_ctx);
