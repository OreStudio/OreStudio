 ...
 */
#ifndef ORES_SHELL_APP_COMMANDS_BUSINESS_UNIT_TYPE_COMMANDS_HPP
#define ORES_SHELL_APP_COMMANDS_BUSINESS_UNIT_TYPE_COMMANDS_HPP
...
/**
 * @brief Every verb business unit types answer, as one command each.
 *
 ...
 */
class business_unit_type_commands {
private:
    inline static std::string_view logger_name =
        "ores.shell.app.commands.refdata.business_unit_type_commands";
...
public:
    /**
     * @brief Register the business unit types submenu.
     */
    ...
    /**
     * @brief add <id> <coding_scheme_code> <code> <name> <level> <description> <reason>
     * <commentary>
     */
    ...
    /**
     * @brief set <id> <coding_scheme_code> <code> <name> <level> <description> <reason>
    ...
    /**
     * @brief put-many --count <n> <id> <coding_scheme_code> <code> <name> <level> <description>
     * <reason> <commentary>
     */
