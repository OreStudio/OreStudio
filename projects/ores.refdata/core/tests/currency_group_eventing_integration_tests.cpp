...
#include "ores.refdata.api/eventing/currency_group_event.hpp"
...
TEST_CASE("write_currency_group_publishes_an_event", tags) {
    ...
    using event_type = ores::refdata::messaging::currency_group_event;
    ...
    event_source.register_entity_event_mapping<event_type>("ores_refdata_currency_groups");
