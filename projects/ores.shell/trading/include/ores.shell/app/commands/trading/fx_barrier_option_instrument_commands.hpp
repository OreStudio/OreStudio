 ...
 *
 */
#ifndef ORES_SHELL_APP_COMMANDS_FX_BARRIER_OPTION_INSTRUMENT_COMMANDS_HPP
#define ORES_SHELL_APP_COMMANDS_FX_BARRIER_OPTION_INSTRUMENT_COMMANDS_HPP
...
public:
    ...
    /**
     * @brief Process the FX barrier option instrument history request.
     */
