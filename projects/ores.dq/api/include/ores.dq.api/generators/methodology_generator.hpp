 ...
 *
 */
#ifndef ORES_DQ_API_GENERATORS_METHODOLOGY_GENERATOR_HPP
#define ORES_DQ_API_GENERATORS_METHODOLOGY_GENERATOR_HPP
 ...
 */
ORES_DQ_API_EXPORT domain::methodology
generate_synthetic_methodology(utility::generation::generation_context& ctx);
