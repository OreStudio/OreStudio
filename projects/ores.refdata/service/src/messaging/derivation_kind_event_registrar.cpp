...
register_derivation_kind_event_mapping(ev::service::postgres_event_source& event_source,
    ...
    event_source.register_entity_event_mapping<refdata::messaging::derivation_kind_event>(
        "ores_refdata_derivation_kinds");

    return event_bus.subscribe<refdata::messaging::derivation_kind_event>(
        [&nats](const refdata::messaging::derivation_kind_event& e) {
            ...
            ev::service::publish_entity_event(
                nats,
                ev::domain::event_subject<refdata::messaging::derivation_kind_event>(e.action),
                e);
        });
}
