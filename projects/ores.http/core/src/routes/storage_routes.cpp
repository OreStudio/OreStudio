...
std::string storage_routes::resolve_path(const std::string& bucket, const std::string& key) const {
...
void storage_routes::write_file(const std::string& path, const std::string& data) {
