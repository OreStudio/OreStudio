 ...
 */
#ifndef ORES_SHELL_APP_COMMANDS_PURPOSE_TYPE_COMMANDS_HPP
#define ORES_SHELL_APP_COMMANDS_PURPOSE_TYPE_COMMANDS_HPP
...
/**
 * @brief Every verb purpose types answer, as one command each.
 *
 ...
 */
class purpose_type_commands {
private:
    inline static std::string_view logger_name =
        "ores.shell.app.commands.refdata.purpose_type_commands";
...
public:
    /**
     * @brief Register the purpose types submenu.
     */
