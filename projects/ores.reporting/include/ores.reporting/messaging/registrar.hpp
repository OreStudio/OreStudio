...
/**
 * @brief Register reporting subsystem message handlers with the server.
 *
 * Registers handlers for all reporting subsystem messages (0xA000-0xAFFF).
...
private:
    inline static std::string_view logger_name =
        "ores.reporting.messaging.registrar";
