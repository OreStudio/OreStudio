 ...
 */
/**
 * Where the day_count_fraction_type screens live and what they can do.
 *
 ...
 */
import { dayCountFractionTypeMeta } from '../ui/day_count_fraction_type_ui.js';
import type { EntityDescriptor } from '../../../entity/descriptor.js';

export const dayCountFractionTypeDescriptor: EntityDescriptor = {
    component: 'refdata',
    entity: 'day_count_fraction_type',
    meta: dayCountFractionTypeMeta,
    routeSegment: 'day-count-fraction-type',
    apiBase: '/api/types',
    keyFields: [
        'code',
    ],
