...
| Now           | Task 2 in progress: renaming protocol types and rewriting parse path.                         |
| Waiting on    | —                                                                                             |
| Next          | Task 3 (round-trip tests) once Task 2 PR merges.                                             |
...
| [[id:06C98C06-F950-483A-997B-89AED70D1238][Rename get_trade_detail → get_trade_instrument and rewrite parse path]]    | STARTED | 2026-05-29 |     | Rename protocol types, delete workarounds, rewrite client TU with dispatch.     |
