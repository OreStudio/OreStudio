...
public:
    ...
    static std::vector<domain::credit_instrument>
    map(const std::vector<credit_instrument_entity>& v);
    static std::vector<credit_instrument_entity>
    map(const std::vector<domain::credit_instrument>& v);
};
