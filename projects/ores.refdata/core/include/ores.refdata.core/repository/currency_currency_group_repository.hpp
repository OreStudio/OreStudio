...
public:
     ...
     */
    /**@{*/
    void write(const domain::currency_currency_group& v);
    void write(const std::vector<domain::currency_currency_group>& v);
    /**@}*/
    ...
    /**
     * @brief Writes a set of currency groups, each honouring its own claim, as
     * one statement.
     */
    void write(const std::vector<domain::currency_currency_group>& v,
    ...
    /**
     * @brief Reads the currency group rows for the given pair of keys.
     *
    ...
    read_latest(const std::string& currency_iso_code, const std::string& currency_group_code);
    ...
    /**
     * @brief Deletes a currency group by its pair of keys.
     */
    ...
    /**
     * @brief Deletes currency groups by their pairs of keys.
     */
...
private:
     ...
     */
    ores::utility::domain::precondition replace_claim(const domain::currency_currency_group& v);
     ...
     */
    domain::currency_currency_group apply_claim(const domain::currency_currency_group& v,
                                                const ores::utility::domain::precondition& claim);
};
