 ...
 */
#ifndef ORES_QT_BUSINESS_UNIT_MDI_WINDOW_HPP
#define ORES_QT_BUSINESS_UNIT_MDI_WINDOW_HPP
 ...
 *
 * Provides a table view of business units with toolbar actions
 * for reload, add, edit, delete, and viewing history.
 */
class BusinessUnitMdiWindow final : public EntityListMdiWindow {
    Q_OBJECT

private:
    inline static std::string_view logger_name = "ores.qt.business_unit_mdi_window";
...
public:
    explicit BusinessUnitMdiWindow(ClientManager* clientManager,
...
private:
    ...
    ClientBusinessUnitModel* model_;
