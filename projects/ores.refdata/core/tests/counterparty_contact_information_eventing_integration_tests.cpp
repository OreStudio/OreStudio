...
#include "ores.refdata.api/eventing/counterparty_contact_information_event.hpp"
...
TEST_CASE("write_counterparty_contact_information_publishes_an_event", tags) {
    ...
    using event_type = ores::refdata::messaging::counterparty_contact_information_event;
