 ...
 *
 * Provides a table view of badge severities with toolbar actions
 * for reload, add, edit, delete, and viewing history.
 */
class BadgeSeverityMdiWindow final : public EntityListMdiWindow {
    Q_OBJECT
...
signals:
    ...
    void showSeverityDetails(const dq::domain::badge_severity& severity);
...
private:
    ...
    ClientBadgeSeverityModel* model_;
