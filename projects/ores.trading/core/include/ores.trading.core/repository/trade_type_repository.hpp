 ...
 *
 */
#ifndef ORES_TRADING_CORE_REPOSITORY_TRADE_TYPE_REPOSITORY_HPP
#define ORES_TRADING_CORE_REPOSITORY_TRADE_TYPE_REPOSITORY_HPP
 ...
 */
class ORES_TRADING_CORE_EXPORT trade_type_repository {
private:
    inline static std::string_view logger_name = "ores.trading.repository.trade_type_repository";
...
public:
    ...
    /**
     * @brief Writes trade types to database.
     */
    /**@{*/
    ...
    /**
     * @brief Reads latest trade types, possibly filtered by primary key.
     */
    /**@{*/
     ...
     */
    std::vector<domain::trade_type> read_all(context ctx, const std::string& code);

    /**
     * @brief Reads a single trade type as it stood at a specific
    ...
    /**
     * @brief Reads latest trade types with pagination support.
     * @param ctx Repository context with database connection
    ...
    /**
     * @brief Deletes a trade type by closing its temporal validity.
     */
    void remove(context ctx, const std::string& code);

    /**
     * @brief Deletes trade types by closing their temporal validity.
     */
