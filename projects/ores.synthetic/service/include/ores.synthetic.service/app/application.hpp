 ...
 *
 */
#ifndef ORES_SYNTHETIC_SERVICE_APP_APPLICATION_HPP
#define ORES_SYNTHETIC_SERVICE_APP_APPLICATION_HPP
...
/**
 * @brief Entry point for the ores.synthetic.service service.
 */
class application final {
private:
    inline static std::string_view logger_name = "ores.synthetic.service.app.application";
