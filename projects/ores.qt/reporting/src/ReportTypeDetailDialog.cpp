...
QString ReportTypeDetailDialog::code() const {
...
void ReportTypeDetailDialog::setupConnections() {
    connect(ui_->saveButton, &QPushButton::clicked, this, &ReportTypeDetailDialog::onSaveClicked);
    connect(
        ui_->deleteButton, &QPushButton::clicked, this, &ReportTypeDetailDialog::onDeleteClicked);
    connect(ui_->closeButton, &QPushButton::clicked, this, &ReportTypeDetailDialog::onCloseClicked);

    connect(ui_->codeEdit, &QLineEdit::textChanged, this, &ReportTypeDetailDialog::onCodeChanged);
    connect(ui_->nameEdit, &QLineEdit::textChanged, this, &ReportTypeDetailDialog::onFieldChanged);
...
void ReportTypeDetailDialog::setType(const reporting::domain::report_type& type) {
    type_ = type;
    updateUiFromType();
}
...
void ReportTypeDetailDialog::markDirty() {
    hasChanges_ = true;
    updateSaveButtonState();
}
...
void ReportTypeDetailDialog::onSaveClicked() {
    if (!clientManager_ || !clientManager_->isConnected()) {
        MessageBoxHelper::warning(
            this, "Disconnected", "Cannot save report type while disconnected from server.");
        return;
    }
...
void ReportTypeDetailDialog::onDeleteClicked() {
    if (!clientManager_ || !clientManager_->isConnected()) {
        MessageBoxHelper::warning(
            this, "Disconnected", "Cannot delete report type while disconnected from server.");
        return;
    }
