 ...
 */
class business_day_convention_type_mapper {
private:
...
public:
    ...
    static std::vector<domain::business_day_convention_type>
    map(const std::vector<business_day_convention_type_entity>& v);
    static std::vector<business_day_convention_type_entity>
    map(const std::vector<domain::business_day_convention_type>& v);
};
