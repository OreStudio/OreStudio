 ...
 */
#ifndef ORES_QT_INSTRUMENT_CODE_MDI_WINDOW_HPP
#define ORES_QT_INSTRUMENT_CODE_MDI_WINDOW_HPP
 ...
 *
 * Provides a table view of instrument codes with toolbar actions
 * for reload, add, edit, delete, and viewing history.
 */
class InstrumentCodeMdiWindow final : public EntityListMdiWindow {
    Q_OBJECT

private:
    inline static std::string_view logger_name = "ores.qt.instrument_code_mdi_window";
...
signals:
    ...
    void showCodeDetails(const refdata::domain::instrument_code& code_);
    void addNewRequested();
    void code_Deleted(const QString& code);
    void showCodeHistory(const refdata::domain::instrument_code& code_);
...
protected:
    QString normalRefreshTooltip() const override {
        return tr("Refresh instrument codes");
    }
...
private:
    ...
    ClientInstrumentCodeModel* model_;
