...
| Now           | Second task: add component links and arch cross-references. |
| Waiting on    | Nothing.                                     |
| Next          | Complete task_add_component_links_and_arch_docs; raise PR. |
...
- [[id:C059C403-D888-4DB6-86B2-2FAD556DC55C][Rewrite system model with layer blurbs and component tables]]
- [[id:101A4A39-B452-4738-8BAD-2F8BF99686BF][Add component id-links and architectural cross-references to system model]]
