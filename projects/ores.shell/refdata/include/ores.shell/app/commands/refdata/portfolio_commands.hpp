 ...
 */
#ifndef ORES_SHELL_APP_COMMANDS_PORTFOLIO_COMMANDS_HPP
#define ORES_SHELL_APP_COMMANDS_PORTFOLIO_COMMANDS_HPP
...
/**
 * @brief Every verb portfolios answer, as one command each.
 *
 ...
 */
class portfolio_commands {
private:
    inline static std::string_view logger_name =
        "ores.shell.app.commands.refdata.portfolio_commands";
...
public:
    /**
     * @brief Register the portfolios submenu.
     */
    ...
    /**
     * @brief add <id> <name> <description> <parent_portfolio_id> <owner_unit_id> <purpose_type>
