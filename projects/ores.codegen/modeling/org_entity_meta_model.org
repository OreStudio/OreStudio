...
Use this for headers needed by types declared via the "NATS handler:
extra includes"-style private-member seam ([[id:F55CB64E-165A-4E15-A50A-5723C0320E97][F55CB64E]]) in this same
template — e.g. a hand-written helper class owned by the dialog as a
