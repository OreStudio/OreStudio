 ...
 *
 * Provides a table view of pricing model product parameters with toolbar actions
 * for reload, add, edit, delete, and viewing history.
 */
class PricingModelProductParameterMdiWindow final : public EntityListMdiWindow {
    Q_OBJECT

private:
    inline static std::string_view logger_name =
        "ores.qt.pricing_model_product_parameter_mdi_window";
...
signals:
    ...
    void showParameterDetails(const analytics::domain::pricing_model_product_parameter& parameter);
...
protected:
    QString normalRefreshTooltip() const override {
        return tr("Refresh pricing model product parameters");
    }
...
private:
    ...
    ClientPricingModelProductParameterModel* model_;
