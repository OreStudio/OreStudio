...
single parent directory under [[proj:projects][=projects/=]], with its sub-components
...
pilot moved =party= to [[proj:projects/ores.refdata/modeling][=projects/ores.refdata/modeling/=]], but
[[proj:projects/ores.refdata][=projects/ores.refdata/=]] is an orphan: it has no CMakeLists, no
...
- *Blocks* [[id:D85E2B30-8C64-46DF-819D-B50D2E70B73C][Codegen unified model — org-mode migration]] for per-group
  ...
  because [[proj:projects/ores.refdata/modeling][=projects/ores.refdata/modeling/=]] already exists.
...
story, [[id:6695E245-E789-40EC-8AC6-EB10276CA241][Consolidate standalone scripts into compass]] (not a blocker for
this story).
...
- All Qt UI components live under [[proj:projects/ores.qt][=projects/ores.qt/=]] (the host as
...
- CI workflows and presets: surveyed — none carried per-component paths.
  ...
  =build/scripts/init-environment.sh= globs =projects/ores.*.service= to
  discover NATS services, which the regroup broke (CI "Setup Database"
  failure). Fixed by reading the existing service registry instead;
  full consolidation tracked by [[id:6695E245-E789-40EC-8AC6-EB10276CA241][Consolidate standalone scripts into compass]].
...
parent. Example: [[proj:projects/ores.refdata/api][=projects/ores.refdata/api/=]], not
...
All Qt UI components are grouped under [[proj:projects/ores.qt][=projects/ores.qt/=]] rather than
...
[[proj:projects/ores.qt][=projects/ores.qt/=]]) moves to [[proj:projects/ores.qt/application][=projects/ores.qt/application/=]] as a
...
Not introduced. [[proj:projects/CMakeLists.txt][=projects/CMakeLists.txt=]] continues to =add_subdirectory=
...
- CI / presets: [[proj:.github/workflows][=.github/workflows/=]] and =CMakePresets.json= carry no
  per-component paths — nothing to change.
- [[proj:projects/CMakeLists.txt][=projects/CMakeLists.txt=]] was the only file holding the component
