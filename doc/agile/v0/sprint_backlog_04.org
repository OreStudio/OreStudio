...
#+CAPTION: Clock summary at [2025-11-15 Sat 21:26], for Saturday, November 15, 2025.
|       | <75>                                           |         |       |      |       |
| Tags  | Headline                                       | Time    |       |      |     % |
|-------+------------------------------------------------+---------+-------+------+-------|
...
|       | Stories                                        | 10:38   |       |      | 100.0 |
|       | Active                                         |         | 10:38 |      | 100.0 |
| agile | Sprint and product backlog refinement          |         |       | 0:27 |   4.2 |
| code  | Split JSON based =operator<<= from domain type |         |       | 0:53 |   8.3 |
| code  | Add a table representation of domain types     |         |       | 2:05 |  19.6 |
| code  | Add a comint based emacs mode for the client   |         |       | 0:24 |   3.8 |
| code  | Review all code created so far with an LLM     |         |       | 6:25 |  60.3 |
| code  | Fix broken windows build due to local time     |         |       | 0:24 |   3.8 |
#+end:

#+begin: clocktable :maxlevel 3 :scope subtree :tags t :indent nil :emphasize nil :scope file :narrow 75 :formula %
#+TBLNAME: sprint_summary
#+CAPTION: Clock summary at [2025-11-15 Sat 21:26]
|          | <75>                                                   |         |       |       |       |
| Tags     | Headline                                               | Time    |       |       |     % |
|----------+--------------------------------------------------------+---------+-------+-------+-------|
|          | *Total time*                                           | *77:15* |       |       | 100.0 |
|----------+--------------------------------------------------------+---------+-------+-------+-------|
|          | Stories                                                | 77:15   |       |       | 100.0 |
|          | Active                                                 |         | 77:15 |       | 100.0 |
| agile    | Sprint and product backlog refinement                  |         |       |  3:16 |   4.2 |
| code     | Clean up client parser                                 |         |       |  0:10 |   0.2 |
| code     | Add connect command line argument                      |         |       |  1:19 |   1.7 |
| infra    | Install Windows package on Windows machine             |         |       |  2:09 |   2.8 |
| code     | Ignore warnings on windows and osx                     |         |       |  0:33 |   0.7 |
| code     | Ensure applications work under OSX using github images |         |       |  0:14 |   0.3 |
| infra    | Create a splash screen and gray background             |         |       |  2:26 |   3.1 |
| code     | Use fluent icons                                       |         |       |  0:37 |   0.8 |
| code     | Add export functionality for currencies                |         |       |  1:30 |   1.9 |
| code     | Add currency editing support                           |         |       |  2:45 |   3.6 |
| code     | Add about to menu                                      |         |       |  1:02 |   1.3 |
| code     | Create a history dialog for currencies                 |         |       |  1:27 |   1.9 |
| code     | Allow MDI windows outside main window                  |         |       |  1:35 |   2.0 |
| code     | Add edit menu and export menu                          |         |       |  0:34 |   0.7 |
| code     | Implement adding new currencies                        |         |       |  3:17 |   4.3 |
| code     | Clean up product website                               |         |       |  4:42 |   6.1 |
| code     | Create a skill for plant uml documentation             |         |       |  2:48 |   3.6 |
| infra    | Add CMake targets for site and skills                  |         |       |  0:17 |   0.4 |
| infra    | Generalise the skill setup for ORE Studio              |         |       |  3:45 |   4.9 |
| infra    | Restructure components to follow the dogen approach    |         |       |  2:54 |   3.8 |
| infra    | Generate PlantUML diagrams for all components          |         |       |  1:05 |   1.4 |
...
| code     | Add a table representation of domain types             |         |       |  2:05 |   2.7 |
| code     | Add a comint based emacs mode for the client           |         |       |  0:24 |   0.5 |
| code     | Fix the valgrind leaks reported on sqlgen              |         |       |  4:54 |   6.3 |
| code     | Review all code created so far with an LLM             |         |       | 16:13 |  21.0 |
| code     | Make UI/UX look more professional                      |         |       | 11:07 |  14.4 |
| code     | Current issues with package install in debian          |         |       |  0:40 |   0.9 |
| code     | Resolve crash on shutdown problem                      |         |       |  0:50 |   1.1 |
...
*** BLOCKED Fix the valgrind leaks reported on sqlgen                  :code:
    :LOGBOOK:
...
*** STARTED Fix broken windows build due to local time                 :code:
    :LOGBOOK:
...
*** Add skill to create new project component                          :code:
