...
#+description: Tenant-scoped many-to-many association table, no independent lifecycle or UI surface of its own.
#+type: profile
#+level: cross
...
UI surface. Junctions default =has_tenant_id= to /false/ (the opposite
...
[[id:1DC67FAD-7543-4E63-A91D-9EE878A2EE8D][calendar_date]], additionally carries its own independent list
