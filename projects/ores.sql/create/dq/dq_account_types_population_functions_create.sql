 ...
 *   SELECT * FROM ores_dq_account_type_preview_fn(dataset_id);
 *
 *   -- Publish to production
 *   SELECT * FROM ores_dq_account_types_publish_fn(dataset_id, 'upsert');
 */
 ...
 */
create or replace function ores_dq_account_type_preview_fn(p_dataset_id uuid)
returns table (
    action text,
    code text,
 ...
 */
create or replace function ores_dq_account_types_publish_fn(
    p_dataset_id uuid,
