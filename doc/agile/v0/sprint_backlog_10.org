...
#+CAPTION: Clock summary at [2026-01-24 Sat 01:31], for Saturday, January 24, 2026.
|      | <75>                          |        |      |      |       |
| Tags | Headline                      | Time   |      |      |     % |
|------+-------------------------------+--------+------+------+-------|
...
|      | Stories                       | 1:04   |      |      | 100.0 |
|      | Active                        |        | 1:04 |      | 100.0 |
| code | Tidy-up external data storage |        |      | 1:04 | 100.0 |
#+end:

#+begin: clocktable :maxlevel 3 :scope subtree :tags t :indent nil :emphasize nil :scope file :narrow 75 :formula %
#+TBLNAME: sprint_summary
#+CAPTION: Clock summary at [2026-01-24 Sat 01:32]
|       | <75>                                                |         |       |      |       |
| Tags  | Headline                                            | Time    |       |      |     % |
|-------+-----------------------------------------------------+---------+-------+------+-------|
|       | *Total time*                                        | *30:41* |       |      | 100.0 |
|-------+-----------------------------------------------------+---------+-------+------+-------|
|       | Stories                                             | 30:41   |       |      | 100.0 |
|       | Active                                              |         | 30:41 |      | 100.0 |
| agile | Sprint and product backlog refinement               |         |       | 1:04 |   3.5 |
| infra | OCR scan notebooks for this sprint                  |         |       | 6:20 |  20.6 |
| code  | Create a simple code generator                      |         |       | 7:38 |  24.9 |
| code  | Party related schemes                               |         |       | 5:20 |  17.4 |
| code  | Image cache not reloading on new datasets           |         |       | 1:43 |   5.6 |
| code  | Create a script to download and split GLEIF data    |         |       | 0:25 |   1.4 |
| code  | Incremental image cache loading with modified_since |         |       | 0:31 |   1.7 |
| code  | Fix issues with misspell action                     |         |       | 2:47 |   9.1 |
| code  | Tidy-up external data storage                       |         |       | 3:33 |  11.6 |
| code  | Add code generation support for domain types SQL    |         |       | 1:20 |   4.3 |
#+end:
...
*** Coding schemes are in production tables                            :code:
