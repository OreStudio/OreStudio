 ...
 */
#ifndef ORES_SHELL_APP_COMMANDS_GMM_COMPONENT_COMMANDS_HPP
#define ORES_SHELL_APP_COMMANDS_GMM_COMPONENT_COMMANDS_HPP
...
/**
 * @brief Every verb GMM components answer, as one command each.
 *
...
public:
    /**
     * @brief Register the GMM components submenu.
     */
