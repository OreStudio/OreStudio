...
ORE Studio is a graphical front-end for the [[https://www.opensourcerisk.org/][Open Source Risk Engine]] (ORE),
which itself builds on [[https://www.quantlib.org/][QuantLib]]. It provides a database-backed UI for
configuring and running ORE — persistent storage for inputs and outputs,
CRUD management, and a simple three-layer architecture (client / service /
[[https://www.postgresql.org/][PostgreSQL]]) designed to be easy to understand and extend.
...
- *[[https://orestudio.github.io/OreStudio/doc/identity/product_identity.html][Product identity]]* — goals, audience, scope and what ORE Studio is not.
- *[[https://orestudio.github.io/OreStudio/doc/orientation.html][Orientation]]* — how to navigate the documentation.
...
To build from source on Ubuntu, Debian, or WSL:
...
Full build instructions, preset options, and platform notes are in the
[[https://orestudio.github.io/OreStudio/doc/recipes/cmake/cmake.html][CMake recipes]].
