 ...
 *
 */
#ifndef ORES_REFDATA_MESSAGING_CURRENCY_MARKET_TIER_HANDLER_HPP
#define ORES_REFDATA_MESSAGING_CURRENCY_MARKET_TIER_HANDLER_HPP
    ...
    void list(ores::nats::message msg) {
        ...
        try {
            ...
            resp.total_available_count =
                static_cast<int>(resp.currency_market_tiers.size());
            BOOST_LOG_SEV(currency_market_tier_handler_lg(), debug)
