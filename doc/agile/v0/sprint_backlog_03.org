...
#+CAPTION: Clock summary at [2025-11-06 Thu 17:51], for Thursday, November 06, 2025.
|       | <75>                                         |        |      |      |       |
| Tags  | Headline                                     | Time   |      |      |     % |
|-------+----------------------------------------------+--------+------+------+-------|
...
|       | Stories                                      | 8:05   |      |      | 100.0 |
|       | Active                                       |        | 8:05 |      | 100.0 |
| agile | Sprint and product backlog refinement        |        |      | 0:16 |   3.3 |
| code  | Add tests at test suite level to ctest       |        |      | 0:13 |   2.7 |
| code  | Cli tests are failing on github              |        |      | 0:58 |  12.0 |
| code  | Add generators for test data generation      |        |      | 5:48 |  71.8 |
| code  | CTest shows only one test per test suite     |        |      | 0:26 |   5.4 |
| code  | Resolve all of the OpenSSL leaks in valgrind |        |      | 0:21 |   4.3 |
| code  | Add connect command line argument            |        |      | 0:03 |   0.6 |
#+end:

#+begin: clocktable :maxlevel 3 :scope subtree :tags t :indent nil :emphasize nil :scope file :narrow 75 :formula %
#+TBLNAME: sprint_summary
#+CAPTION: Clock summary at [2025-11-06 Thu 17:51]
|       | <75>                                                   |         |       |       |       |
| Tags  | Headline                                               | Time    |       |       |     % |
|-------+--------------------------------------------------------+---------+-------+-------+-------|
...
|       | Stories                                                | 70:24   |       |       | 100.0 |
|       | Active                                                 |         | 70:24 |       | 100.0 |
| agile | Sprint and product backlog refinement                  |         |       |  1:46 |   2.5 |
| code  | Add locking up logic                                   |         |       |  1:28 |   2.1 |
| code  | Build using dynamic libraries                          |         |       |  7:24 |  10.5 |
| code  | Enable qt gui                                          |         |       |  4:13 |   6.0 |
| code  | Implement logging according to correct boost.log usage |         |       |  8:02 |  11.4 |
| code  | Fix broken Linux and OSX tests                         |         |       |  0:10 |   0.2 |
| code  | Fix broken windows builds                              |         |       |  2:35 |   3.7 |
| code  | Investigate leaks from valgrind                        |         |       |  0:51 |   1.2 |
| code  | Consider adding a postgres database to CI              |         |       | 14:13 |  20.2 |
...
| code  | Add command line arguments for database to service     |         |       |  3:34 |   5.1 |
| code  | Separate test database usage from application          |         |       |  3:33 |   5.0 |
| code  | Split test code from utility                           |         |       |  4:41 |   6.7 |
| code  | Add tests at test suite level to ctest                 |         |       |  0:13 |   0.3 |
| code  | Cli tests are failing on github                        |         |       |  0:58 |   1.4 |
| code  | Add generators for test data generation                |         |       |  5:48 |   8.2 |
| code  | CTest shows only one test per test suite               |         |       |  0:26 |   0.6 |
| code  | Resolve all of the OpenSSL leaks in valgrind           |         |       |  0:36 |   0.9 |
...
| code  | Add workspace as a container                           |         |       |  1:13 |   1.7 |
#+end:
...
*** Add write one to repository                                        :code:
