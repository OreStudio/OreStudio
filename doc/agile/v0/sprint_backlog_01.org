...
#+CAPTION: Clock summary at [2024-07-13 Sat 15:22]
|       | <75>                                              |         |       |      |       |
| Tags  | Headline                                          | Time    |       |      |     % |
|-------+---------------------------------------------------+---------+-------+------+-------|
|       | *Total time*                                      | *66:48* |       |      | 100.0 |
|-------+---------------------------------------------------+---------+-------+------+-------|
|       | Stories                                           | 66:48   |       |      | 100.0 |
|       | Active                                            |         | 66:48 |      | 100.0 |
| agile | Sprint and product backlog refinement             |         |       | 3:11 |   4.8 |
| infra | Create a basic git hub repository                 |         |       | 0:35 |   0.9 |
| infra | Setup a discord channel for the project           |         |       | 0:14 |   0.3 |
| infra | Setup vcpkg and cmake                             |         |       | 1:21 |   2.0 |
| infra | Setup github actions                              |         |       | 1:21 |   2.0 |
| infra | Create and upload a package                       |         |       | 3:28 |   5.2 |
| code  | Create a basic project structure                  |         |       | 2:10 |   3.2 |
| code  | Add a Qt hello world                              |         |       | 3:08 |   4.7 |
| code  | Add a splash screen to applciation                |         |       | 0:41 |   1.0 |
| infra | Add basic site                                    |         |       | 0:34 |   0.8 |
| code  | Add modeling infrastructure                       |         |       | 1:30 |   2.2 |
| infra | Fix code syntax highlighting in site              |         |       | 0:10 |   0.2 |
| doc   | Merge index with readme                           |         |       | 0:42 |   1.0 |
| doc   | Add project objective to readme                   |         |       | 2:24 |   3.6 |
| code  | Add basic logging support                         |         |       | 1:14 |   1.8 |
| infra | Add nightly support with memcheck                 |         |       | 3:21 |   5.0 |
| code  | Clean up toolchains and presets                   |         |       | 1:53 |   2.8 |
| doc   | Generate Doxygen documentation and add it to site |         |       | 0:51 |   1.3 |
| doc   | Copy domain notes on core concepts                |         |       | 4:41 |   7.0 |
| infra | Valgrind fails to run unit tests                  |         |       | 1:12 |   1.8 |
| infra | Initial sanity test generated packages            |         |       | 0:25 |   0.6 |
| code  | Add command line options support                  |         |       | 5:45 |   8.6 |
| infra | Unit tests show up twice in nightlies             |         |       | 0:13 |   0.3 |
| doc   | Add recipes for command line                      |         |       | 0:51 |   1.3 |
| agile | Use a bar chart for sprint resourcing cost        |         |       | 2:57 |   4.4 |
| agile | Classify stories by type                          |         |       | 0:34 |   0.8 |
| code  | Update C++ standard                               |         |       | 0:29 |   0.7 |
| infra | Setup laptop for development                      |         |       | 3:47 |   5.7 |
| infra | Add database support for currency                 |         |       | 1:19 |   2.0 |
| code  | Add XML parsing support for currency              |         |       | 6:32 |   9.8 |
| code  | Add JSON support for currency                     |         |       | 2:03 |   3.1 |
| code  | Add basic widgets to display currencies           |         |       | 1:50 |   2.7 |
| infra | Ignore vcpkg warnings                             |         |       | 0:21 |   0.5 |
| code  | Create a containing structure for data            |         |       | 0:28 |   0.7 |
| doc   | Convert plantuml diagrams to org-babel            |         |       | 1:05 |   1.6 |
| infra | Setup code quality actions                        |         |       | 0:14 |   0.3 |
| code  | Updates to Qt UI                                  |         |       | 3:14 |   4.8 |
#+end:
