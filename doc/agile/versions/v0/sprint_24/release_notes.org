...
- *Migrate to oresmd, delete market_series qualifier and ore_key* (ABANDONED): deferred.
...
- *Audit and standardize the display_order field across lookup/code-table entities* (ABANDONED): deferred.
