...
=--address= selects the technical space (SQL vs C++ vs TypeScript) to generate; no
...
|------+--------------+--------------------|
| refdata | projects/ores.refdata/modeling | |
...
| ore | projects/ores.ore/modeling | |
| history | projects/ores.history/modeling | |
| assets-cpp | projects/ores.assets/modeling | |
...
| shell | projects/ores.shell/modeling | |
