 ...
 *
 */
#ifndef ORES_VARIABILITY_SERVICE_CONFIG_PARSER_HPP
#define ORES_VARIABILITY_SERVICE_CONFIG_PARSER_HPP
...
/**
 * @brief Command-line parser for ores.variability.service.
 *
