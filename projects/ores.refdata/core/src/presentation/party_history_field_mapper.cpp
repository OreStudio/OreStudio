...
std::vector<ores::diff::domain::field_value> render_party_fields(const domain::party& v) {
    ...
    fields.push_back({.name = "Party Category", .value = v.party_category});
    fields.push_back({.name = "Party Type", .value = v.party_type});
    fields.push_back(
