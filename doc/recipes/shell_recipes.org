...
local 1abd80e1-dirty 2026/01/11 18:37:16
...
ores-shell> ✓ Initial admin account created successfully!
  Account ID: 019ba3a0-48bb-7924-96ae-686f0883cc9c
...
#+begin_src ores-shell :exports none
variability add-flag test.feature.flag "Test feature flag for recipes" false
exit
#+end_src
...
#+begin_src ores-shell :exports none
change-reasons add test_reason "Test reason for recipes" TEST_CATEGORY
exit
#+end_src
...
#+begin_src ores-shell :exports none
change-reasons history initial_setup
exit
#+end_src
...
#+begin_src ores-shell :exports none
change-reason-categories add TEST_CATEGORY "Test category for recipes"
exit
#+end_src
