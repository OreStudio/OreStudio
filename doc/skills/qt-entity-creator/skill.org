...
4. Rebase from main before starting the next phase.
...
2. Create new feature branch: =git checkout -b feature/<entity>_qt_phase_N=
...
Use the =icon-guidelines= skill to select an appropriate icon for the entity.
Common patterns:
...
After Phase 1 PR is merged, rebase from main and create a new branch for Phase 2.

#+begin_src shell
git checkout main && git pull
git checkout -b feature/<entity>_qt_phase_2
#+end_src
...
After Phase 2 PR is merged, rebase from main and create a new branch for Phase 3.

#+begin_src shell
git checkout main && git pull
git checkout -b feature/<entity>_qt_phase_3
#+end_src
...
After Phase 3 PR is merged, rebase from main and create a new branch for Phase 4.

#+begin_src shell
git checkout main && git pull
git checkout -b feature/<entity>_qt_phase_4
#+end_src
