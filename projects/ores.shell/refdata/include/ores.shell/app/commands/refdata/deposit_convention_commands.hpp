 ...
 */
#ifndef ORES_SHELL_APP_COMMANDS_DEPOSIT_CONVENTION_COMMANDS_HPP
#define ORES_SHELL_APP_COMMANDS_DEPOSIT_CONVENTION_COMMANDS_HPP
...
/**
 * @brief Every verb deposit conventions answer, as one command each.
 *
 ...
 */
class deposit_convention_commands {
private:
    inline static std::string_view logger_name =
        "ores.shell.app.commands.refdata.deposit_convention_commands";
...
public:
    /**
     * @brief Register the deposit conventions submenu.
     */
    ...
    /**
     * @brief add <id> <index_based> <index> <calendar> <convention> <end_of_month>
    ...
    /**
     * @brief set <id> <index_based> <index> <calendar> <convention> <end_of_month>
    ...
    /**
     * @brief put-many --count <n> <id> <index_based> <index> <calendar> <convention> <end_of_month>
     * <day_count_fraction> <settlement_days> <reason> <commentary>
     */
