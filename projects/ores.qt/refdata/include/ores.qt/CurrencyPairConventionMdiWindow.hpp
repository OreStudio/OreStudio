 ...
 */
#ifndef ORES_QT_CURRENCY_PAIR_CONVENTION_MDI_WINDOW_HPP
#define ORES_QT_CURRENCY_PAIR_CONVENTION_MDI_WINDOW_HPP
...
/**
 * @brief MDI window for displaying and managing currency pair conventions.
 *
 * Provides a table view of currency pair conventions with toolbar actions
 * for reload, add, edit, delete, and viewing history.
 */
class CurrencyPairConventionMdiWindow final : public EntityListMdiWindow {
    Q_OBJECT

private:
    inline static std::string_view logger_name = "ores.qt.currency_pair_convention_mdi_window";
...
public:
    explicit CurrencyPairConventionMdiWindow(ClientManager* clientManager,
                                             const QString& username,
                                             BadgeCache* badgeCache,
                                             ImageCache* imageCache,
                                             QWidget* parent = nullptr);
    ~CurrencyPairConventionMdiWindow() override = default;

signals:
    void statusChanged(const QString& message);
    void errorOccurred(const QString& error_message);
    void showConventionDetails(const refdata::domain::currency_pair_convention& convention);
...
protected:
    QString normalRefreshTooltip() const override {
        return tr("Refresh currency pair conventions");
    }
...
private:
    ...
    ClientCurrencyPairConventionModel* model_;
