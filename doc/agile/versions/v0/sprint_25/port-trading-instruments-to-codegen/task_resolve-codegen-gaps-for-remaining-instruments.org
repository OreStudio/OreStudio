...
#+description: Convert the remaining hand-crafted trading instrument families (commodity, composite with composite_leg, credit, scripted) to codegen, closing or working around the codegen gaps that block them and making the trading component drift-checkable first. Bond left the list on 2026-09-09: the data-oriented redesign (688959F0) supersedes its conversion in the atomised relational shape.
#+type: task
#+level: s1
...
Convert the remaining hand-crafted trading instrument families
(commodity, composite with its composite_leg child, credit,
...
a documented service exclusion, below. bond left the list on
2026-09-09: the data-oriented redesign story
[[id:688959F0-A1AB-4021-A57E-1103AD92773A][688959F0]] supersedes its
conversion and converts the family in the atomised relational shape
proposed by its analysis; see Notes. Each conversion follows the
...
| Now          | Gap (a) probed and decided 2026-09-08: the trade-style shape does not cover the bond domain; codegen must grow mid-group support. Probe org and evidence in Notes. Bond's conversion is superseded (2026-09-09): the data-oriented redesign converts it in the atomised shape; commodity, credit, scripted stay here. |
| Waiting on   | The gap-(a) codegen change (group-composition key in the domain template) before commodity/credit conversion; trading drift reconciliation before any conversion can verify zero-diff. |
...
- The =commodity_instrument=/=credit_instrument= shape is decided:
  either trade-style field-group orgs plus escape hatches cover the
  C1202 nesting and non-persisted members zero-diff, or the domain
  template grows arbitrary-group support and the models regenerate
  zero-diff. (bond_instrument's shape is the atomised relational model
  of the data-oriented redesign.)
...
- The composite/fra-class transactional service logic
  ...
  regeneration.
- All remaining families (commodity, composite with composite_leg,
  ...
  under a drift check that actually covers trading. Bond's conversion
  happens on the data-oriented redesign in the atomised shape.
...
data-oriented redesign ([[id:688959F0-A1AB-4021-A57E-1103AD92773A][688959F0]])
approved the bond relational pilot (analysis PR #2039, deliverable
=trading_bond_relational_model.org=) and its
