...
#+TBLNAME: summary
#+CAPTION: Clock summary at [2024-07-05 Fri 22:48]
| <75>                                              |         |       |      |       |
| Headline                                          | Time    |       |      |     % |
|---------------------------------------------------+---------+-------+------+-------|
...
| Stories                                           | 36:42   |       |      | 100.0 |
| Active                                            |         | 36:42 |      | 100.0 |
| Sprint and product backlog refinement             |         |       | 1:05 |   3.0 |
| Create a basic git hub repository                 |         |       | 0:35 |   1.6 |
| Setup a discord channel for the project           |         |       | 0:14 |   0.6 |
| Setup vcpkg and cmake                             |         |       | 1:21 |   3.7 |
| Setup github actions                              |         |       | 1:21 |   3.7 |
| Create and upload a package                       |         |       | 3:28 |   9.4 |
| Create a basic project structure                  |         |       | 2:10 |   5.9 |
| Add a Qt hello world                              |         |       | 3:08 |   8.5 |
| Add a splash screen to applciation                |         |       | 0:41 |   1.9 |
| Add basic site                                    |         |       | 0:34 |   1.5 |
| Add modeling infrastructure                       |         |       | 1:30 |   4.1 |
| Fix code syntax highlighting in site              |         |       | 0:10 |   0.5 |
| Merge index with readme                           |         |       | 0:42 |   1.9 |
| Add project objective to readme                   |         |       | 2:24 |   6.5 |
| Add basic logging support                         |         |       | 1:14 |   3.4 |
| Add nightly support with memcheck                 |         |       | 3:21 |   9.1 |
| Clean up toolchains and presets                   |         |       | 1:53 |   5.1 |
| Valgrind fails to run unit tests                  |         |       | 1:05 |   3.0 |
| Add command line options support                  |         |       | 1:47 |   4.9 |
| Generate Doxygen documentation and add it to site |         |       | 0:51 |   2.3 |
| Add XML parsing support for currency              |         |       | 1:24 |   3.8 |
| Create a containing structure for data            |         |       | 0:28 |   1.3 |
| Add basic widgets to display currencies           |         |       | 0:26 |   1.2 |
| Convert plantuml diagrams to org-babel            |         |       | 1:05 |   3.0 |
| Copy domain notes on core concepts                |         |       | 3:45 |  10.2 |
#+end:
...
*** STARTED Generate Doxygen documentation and add it to site         :story:
    :LOGBOOK:
