...
using ores::shell::app::commands::login_operations_commands;
...
TEST_CASE("login_operations_registers_every_declared_command", tags) {
...
TEST_CASE("login_operations_process_login_reports_the_expected_count", tags) {
    auto lg(make_logger(test_suite));
    ...
    login_operations_commands::process_login(out, session, {});
...
TEST_CASE("login_operations_process_login_reaches_the_transport", tags) {
    auto lg(make_logger(test_suite));
    ...
    command_feedback::reset();
    login_operations_commands::process_login(out, session, tokens(2));
...
TEST_CASE("login_operations_process_logout_requires_a_session", tags) {
    auto lg(make_logger(test_suite));
    ...
    command_feedback::reset();
    login_operations_commands::process_logout(out, session, tokens(0));
...
TEST_CASE("login_operations_process_logout_reaches_the_transport", tags) {
    auto lg(make_logger(test_suite));
...
TEST_CASE("login_operations_process_refresh_requires_a_session", tags) {
    auto lg(make_logger(test_suite));
    ...
    command_feedback::reset();
    login_operations_commands::process_refresh(out, session, tokens(0));
...
TEST_CASE("login_operations_process_refresh_reaches_the_transport", tags) {
    auto lg(make_logger(test_suite));
...
TEST_CASE("login_operations_process_service_login_reports_the_expected_count", tags) {
    auto lg(make_logger(test_suite));
    ...
    command_feedback::reset();
    login_operations_commands::process_service_login(out, session, {});
...
TEST_CASE("login_operations_process_service_login_reaches_the_transport", tags) {
    auto lg(make_logger(test_suite));
    ...
    command_feedback::reset();
    login_operations_commands::process_service_login(out, session, tokens(2));
