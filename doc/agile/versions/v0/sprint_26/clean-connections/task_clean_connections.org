...
with the diff and found one more stale reference, also fixed there. The
rebase onto trunk, after PR #2138 merged, surfaced one more. The icon
inventory still described the deleted Qt Connection Browser, and the
rebased branch corrects it.
