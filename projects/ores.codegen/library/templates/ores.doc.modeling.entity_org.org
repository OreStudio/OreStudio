...
:END:
#+title: ores.doc.modeling.entity_org
...
:get_request_class:       {{component}}::messaging::list_{{entity_plural}}_request
:get_response_class:      {{component}}::messaging::list_{{entity_plural}}_response
:get_message_type:        list_{{entity_plural}}_request
:save_request_class:      {{component}}::messaging::put_{{slug}}_request
:save_response_class:     {{component}}::messaging::put_{{slug}}_response
:save_message_type:       put_{{slug}}_request
...
:history_request_class:   {{component}}::messaging::list_{{slug}}_versions_request
:history_response_class:  {{component}}::messaging::list_{{slug}}_versions_response
:history_message_type:    list_{{slug}}_versions_request
{{#presentation_has_uuid_primary_key}}
:has_uuid_primary_key:    true
{{/presentation_has_uuid_primary_key}}
{{^presentation_has_uuid_primary_key}}
:has_uuid_primary_key:    false
{{/presentation_has_uuid_primary_key}}
{{#presentation_has_change_reason_cache}}
:has_change_reason_cache: true
{{/presentation_has_change_reason_cache}}
{{^presentation_has_change_reason_cache}}
:has_change_reason_cache: false
{{/presentation_has_change_reason_cache}}
{{#presentation_has_explorer_api}}
:has_explorer_api:        true
{{/presentation_has_explorer_api}}
{{#presentation_has_pagination}}
:has_pagination:          true
{{/presentation_has_pagination}}
{{#presentation_has_csv_xml_io}}
:has_csv_xml_io:          true
...
{{/presentation_has_csv_xml_io}}
{{#presentation_has_export_macro}}
:has_export_macro:        true
{{/presentation_has_export_macro}}
{{#presentation_has_version_navigation}}
