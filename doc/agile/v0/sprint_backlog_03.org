...
#+CAPTION: Clock summary at [2025-11-06 Thu 23:13], for Thursday, November 06, 2025.
|       | <75>                                         |         |       |      |       |
| Tags  | Headline                                     | Time    |       |      |     % |
|-------+----------------------------------------------+---------+-------+------+-------|
...
| code  | Add tests at test suite level to ctest       |         |       | 0:13 |   2.2 |
| code  | Cli tests are failing on github              |         |       | 0:58 |   9.7 |
| code  | Add generators for test data generation      |         |       | 7:40 |  76.5 |
| code  | CTest shows only one test per test suite     |         |       | 0:26 |   4.3 |
| code  | Resolve all of the OpenSSL leaks in valgrind |         |       | 0:21 |   3.5 |
| code  | Add connect command line argument            |         |       | 0:03 |   0.5 |
#+end:

#+begin: clocktable :maxlevel 3 :scope subtree :tags t :indent nil :emphasize nil :scope file :narrow 75 :formula %
#+TBLNAME: sprint_summary
#+CAPTION: Clock summary at [2025-11-06 Thu 23:13]
|       | <75>                                                   |         |       |       |       |
| Tags  | Headline                                               | Time    |       |       |     % |
|-------+--------------------------------------------------------+---------+-------+-------+-------|
|       | *Total time*                                           | *71:07* |       |       | 100.0 |
|-------+--------------------------------------------------------+---------+-------+-------+-------|
|       | Stories                                                | 71:07   |       |       | 100.0 |
|       | Active                                                 |         | 71:07 |       | 100.0 |
...
| code  | Consider adding a postgres database to CI              |         |       | 14:13 |  20.0 |
