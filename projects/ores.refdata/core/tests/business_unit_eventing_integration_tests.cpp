...
#include "ores.refdata.api/eventing/business_unit_event.hpp"
...
TEST_CASE("write_business_unit_publishes_an_event", tags) {
    ...
    using event_type = ores::refdata::messaging::business_unit_event;
    ...
    event_source.register_entity_event_mapping<event_type>("ores_refdata_business_units");
