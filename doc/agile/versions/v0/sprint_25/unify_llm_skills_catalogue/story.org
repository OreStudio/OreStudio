...
| [[id:294FFF1A-E70B-489A-B7A3-40F57528B46E][Resync the job_definition model with its hand-written code]] | BACKLOG | | | The scheduler model's column shapes do not match the hand-written struct, so regenerating emits wrong types rather than wrong formatting; the model must be corrected before any facet can be regenerated. |
...
| [[id:4B43941A-957B-4FC9-82BD-AB131F541825][Register composite parts in their component CMakeLists]] | STARTED | 2026-09-11 | | Eighteen composites still register each part in projects/CMakeLists.txt; the target shape adds the component there and its parts in the component's own CMakeLists. |
