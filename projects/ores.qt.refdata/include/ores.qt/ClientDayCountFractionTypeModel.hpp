 ...
 *
 */
#ifndef ORES_QT_CLIENT_DAY_COUNT_FRACTION_TYPE_MODEL_HPP
#define ORES_QT_CLIENT_DAY_COUNT_FRACTION_TYPE_MODEL_HPP
...
private:
    inline static std::string_view logger_name =
        "ores.qt.client_day_count_fraction_type_model";
...
public:
    ...
    ~ClientDayCountFractionTypeModel() override = default;
    ...
    /**
     * @brief Refresh day count fraction type data from server asynchronously.
     */
    void refresh();

    /**
     * @brief Get day count fraction type at the specified row.
     *
...
private:
    ...
    using DayCountFractionTypeKeyExtractor = std::string(*)(const trading::domain::day_count_fraction_type&);
    RecencyTracker<trading::domain::day_count_fraction_type, DayCountFractionTypeKeyExtractor> recencyTracker_;
