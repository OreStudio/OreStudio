...
|--------+-------|
| Status | FAIL |
| Notes  | on edits of the original artefact types, we get duplicates. all other types are fine. |
...
|--------+-------|
| Status | FAIL |
| Notes  | get duplicates when saving an existing bundle, check db |
...
|--------+-------|
| Status | FAIL |
| Notes  | does not come up, get an error: Repository error: Query execution failed: ERROR:  relation "public.ores_dq_lei_entities_tbl" does not exist; LINE 1: ...change_commentary", "valid_from", "valid_to" FROM "public"."... |
...
|---------------+-------|
| Status        | FAILED |
| Completed at  | 2026-08-08T17:19:40Z |
| Branch        | main |
| Commit        | ff3e91d79 |
