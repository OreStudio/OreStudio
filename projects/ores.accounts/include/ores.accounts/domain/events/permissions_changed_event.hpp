 ...
 *
 */
#ifndef ORES_ACCOUNTS_DOMAIN_EVENTS_PERMISSIONS_CHANGED_EVENT_HPP
#define ORES_ACCOUNTS_DOMAIN_EVENTS_PERMISSIONS_CHANGED_EVENT_HPP
 ...
 */
template<>
struct event_traits<ores::accounts::domain::events::permissions_changed_event> {
    static constexpr std::string_view name = "ores.accounts.permissions_changed";
};
