...
/**
 * Currency Asset Classes Population Script
 *
 * Populates valid currency asset class categories.
...
values
    (ores_iam_system_tenant_id_fn(), 'fiat', 0, 'Fiat Currency',
     ...
     1, current_user, current_user, 'system.initial_load', 'Initial population of currency asset classes'),
    (ores_iam_system_tenant_id_fn(), 'commodity', 0, 'Commodity Currency',
     ...
     2, current_user, current_user, 'system.initial_load', 'Initial population of currency asset classes'),
    (ores_iam_system_tenant_id_fn(), 'synthetic', 0, 'Synthetic Currency',
     'Artificially constructed currency or index',
     3, current_user, current_user, 'system.initial_load', 'Initial population of currency asset classes'),
    (ores_iam_system_tenant_id_fn(), 'supranational', 0, 'Supranational Currency',
     'Currency issued by a multi-national authority (e.g. XDR)',
     4, current_user, current_user, 'system.initial_load', 'Initial population of currency asset classes')
...
-- Summary
select 'refdata_currency_asset_classes' as entity, count(*) as count
