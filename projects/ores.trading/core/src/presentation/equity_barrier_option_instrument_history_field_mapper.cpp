 ...
 *
 */
#include "ores.trading.core/presentation/equity_barrier_option_instrument_history_field_mapper.hpp"
...
render_equity_barrier_option_instrument_fields(const domain::equity_barrier_option_instrument& v) {
