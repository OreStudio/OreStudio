...
| [[id:6B5BB82B-0A74-464B-9382-4D3275FFD4E2][Tick loop and process factory]] | STARTED | 2026-06-26 | | Implement the tick_loop with fixed-mode clock and a seeded GmmProcess; publish typed fx_spot_tick to marketdata.v1.tick.fx.rate.eur.usd (no DB write yet). Validates synthetic generation and NATS fan-out publishing in isolation — step 2 of the FX spot PoC implementation order. |
