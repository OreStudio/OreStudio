...
std::vector<domain::equity_accumulator_instrument> equity_accumulator_instrument_mapper::map(
    const std::vector<equity_accumulator_instrument_entity>& v) {
    return map_vector<equity_accumulator_instrument_entity, domain::equity_accumulator_instrument>(
        v, [](const auto& ve) { return map(ve); }, lg(), "db entities");
}

std::vector<equity_accumulator_instrument_entity> equity_accumulator_instrument_mapper::map(
    const std::vector<domain::equity_accumulator_instrument>& v) {
