 ...
 *
 */
create or replace function ores.dq_treatment_dimensions_notify_fn()
returns trigger as $$
declare
...
after insert or update or delete on ores.dq_treatment_dimensions_tbl
for each row execute function ores.dq_treatment_dimensions_notify_fn();
