 ...
 *
 */
#ifndef ORES_TRADING_CORE_REPOSITORY_EQUITY_SWAP_INSTRUMENT_ENTITY_HPP
#define ORES_TRADING_CORE_REPOSITORY_EQUITY_SWAP_INSTRUMENT_ENTITY_HPP
...
/**
 * @brief Represents a equity swap instrument in the database.
 */
