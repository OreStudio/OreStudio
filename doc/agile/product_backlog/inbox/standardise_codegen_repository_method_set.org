...
- Fix that restored the three methods: commit =f0a20a4c1=
  ("[codegen] Promote read_all/read_at_timepoint/convert_to_table-single
  to standard") on =feature/sync-cpp-core-codegen-currency=.
- Templates: =projects/ores.codegen/library/templates/cpp_domain_type_repository_{hpp,cpp}.org=,
  =cpp_domain_type_table_{hpp,cpp}.org=.
