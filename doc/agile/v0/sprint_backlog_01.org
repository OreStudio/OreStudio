...
#+CAPTION: Clock summary at [2024-06-29 Sat 00:33]
| <75>                                    |         |       |      |       |
| Headline                                | Time    |       |      |     % |
|-----------------------------------------+---------+-------+------+-------|
...
| Stories                                 | 20:50   |       |      | 100.0 |
| Active                                  |         | 20:50 |      | 100.0 |
| Sprint and product backlog refinement   |         |       | 0:47 |   3.8 |
| Create a basic git hub repository       |         |       | 0:35 |   2.8 |
| Setup a discord channel for the project |         |       | 0:14 |   1.1 |
| Setup vcpkg and cmake                   |         |       | 1:21 |   6.5 |
| Setup github actions                    |         |       | 1:21 |   6.5 |
| Create and upload a package             |         |       | 3:28 |  16.6 |
| Create a basic project structure        |         |       | 2:10 |  10.4 |
| Add a Qt hello world                    |         |       | 3:08 |  15.0 |
| Add a splash screen to applciation      |         |       | 0:41 |   3.3 |
| Add basic site                          |         |       | 0:34 |   2.7 |
| Add modeling infrastructure             |         |       | 1:19 |   6.3 |
| Add nightly support with memcheck       |         |       | 1:40 |   8.0 |
| Add XML parsing support for currency    |         |       | 1:24 |   6.7 |
| Create a containing structure for data  |         |       | 0:28 |   2.2 |
| Add basic widgets to display currencies |         |       | 0:26 |   2.1 |
| Add basic logging support               |         |       | 1:14 |   5.9 |
#+end:
