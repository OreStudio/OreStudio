...
=compass task start= introduced as the explicit clock-on command covering
new tasks, BACKLOG resume, and post-restart resume. Auto-stamp removed from
=story new= / =task new=. Runbooks and recipes updated. PR #1013 merged.
