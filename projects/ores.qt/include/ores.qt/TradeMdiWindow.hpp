...
/**
 * @brief MDI window for displaying and managing trades.
 *
 * Provides a table view of trades with toolbar actions
 * for reload, add, edit, delete, and viewing history.
 */
class TradeMdiWindow final : public EntityListMdiWindow {
    Q_OBJECT
