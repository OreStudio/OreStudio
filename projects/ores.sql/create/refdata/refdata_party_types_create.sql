...
create unique index if not exists party_types_version_uniq_idx
on "ores_refdata_party_types_tbl" (tenant_id, code, version)
where valid_to = ores_utility_infinity_timestamp_fn();

create unique index if not exists party_types_code_uniq_idx
on "ores_refdata_party_types_tbl" (tenant_id, code)
where valid_to = ores_utility_infinity_timestamp_fn();

create index if not exists party_types_tenant_idx
