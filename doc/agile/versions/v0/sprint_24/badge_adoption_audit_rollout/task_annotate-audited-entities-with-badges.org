...
#+owner: marco
#+branch: feature/badge-batch1-remaining-entities
#+pr: 1784
#+blocked_on:
#+blocked_since:
#+created: 2026-07-15
...
| Now          | Batch 1 fully done (all 11 entities self-badged, built, tested). |
| Waiting on   | Nothing.                               |
| Next         | Batch 2 (cross-component, same data-authoring approach); Batch 3 (plain-text documentation) after. |
...
Batch 1 fully shipped: all 11 refdata entities
...
Regenerated, built, tested throughout. Task stays STARTED -- Batch 2
(cross-component, same pattern) and Batch 3 (plain-text
