...
#+description: The * SQL section of an entity model: table naming, the has_parent_id hierarchy knob, and the masd.sql variability feature bundle (tenant-scoping policy, extra checks, soft-FK validations). Generates the bi-temporal table DDL, insert triggers, and notify triggers via the ores.sql.schema facet.
#+type: knowledge
#+level: cross
...
(=masd.sql= bundle) — authored on the model's =sql= section and read
...
Studio Variability Model]] § "Bundle: masd.sql" — this section is the
...
checked against =library/templates/sql_service_db_grants.mustache=, it
is emitted unconditionally today, matching [[id:897A7156-504D-4581-AD4C-026D643C0838][the evaluation checklist]]'s
...
- [[id:0BD6F9EC-34DD-44D9-8AA1-917EE5966396][ORE Studio Variability Model]] — the =masd.sql= bundle's classification and cross-facet index; this page is the narrative home for those knobs.
