...
:END:
#+title: ORE Studio Comms Shell Component
...
Studio]] server via the binary comms protocol.
...
#+caption: ORE Studio Comms Shell Component Diagram
[[file:ores.comms.shell.png][file:ores.comms.shell.png]]
