 ...
 *
 */
#ifndef ORES_SHELL_APP_COMMANDS_TRADING_FX_ASIAN_FORWARD_INSTRUMENT_COMMANDS_HPP
#define ORES_SHELL_APP_COMMANDS_TRADING_FX_ASIAN_FORWARD_INSTRUMENT_COMMANDS_HPP
...
private:
    inline static std::string_view logger_name =
        "ores.shell.app.commands.trading.fx_asian_forward_instrument_commands";
...
public:
     ...
     */
    static void process_delete_fx_asian_forward_instrument(std::ostream& out,
        ores::nats::service::nats_client& session,
        std::string instrument_id);

    /**
     * @brief Process an fx asian forward instrument history request.
     *
     ...
     */
    static void process_get_fx_asian_forward_instrument_history(std::ostream& out,
        ores::nats::service::nats_client& session,
        std::string instrument_id);
};
