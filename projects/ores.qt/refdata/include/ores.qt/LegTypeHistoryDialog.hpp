 ...
 *
 */
#ifndef ORES_QT_LEG_TYPE_HISTORY_DIALOG_HPP
#define ORES_QT_LEG_TYPE_HISTORY_DIALOG_HPP
...
/**
 * @brief Dialog for viewing the version history of a leg type.
 *
...
private:
    inline static std::string_view logger_name = "ores.qt.leg_type_history_dialog";
...
public:
    explicit LegTypeHistoryDialog(const QString& code,
