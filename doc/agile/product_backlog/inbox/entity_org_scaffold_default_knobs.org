...
- =projects/ores.synthetic/modeling/ores.synthetic.gmm_component.org= — the first synthetic model that hit this.
- =projects/ores.refdata/modeling/ores.refdata.country.org= — the reference model with the full knob set.
