 ...
 */
#ifndef ORES_SHELL_APP_COMMANDS_CURRENCY_PAIR_CLASSIFICATION_COMMANDS_HPP
#define ORES_SHELL_APP_COMMANDS_CURRENCY_PAIR_CLASSIFICATION_COMMANDS_HPP
...
/**
 * @brief Every verb currency pair classifications answer, as one command each.
 *
 ...
 */
class currency_pair_classification_commands {
private:
    inline static std::string_view logger_name =
        "ores.shell.app.commands.refdata.currency_pair_classification_commands";
...
public:
    /**
     * @brief Register the currency pair classifications submenu.
     */
    ...
    /**
     * @brief add <code> <name> <description> <display_order> <reason> <commentary>
     */
    ...
    /**
     * @brief set <code> <name> <description> <display_order> <reason> <commentary> [--version <n>]
     */
    ...
    /**
     * @brief put-many --count <n> <code> <name> <description> <display_order> <reason> <commentary>
     */
