...
public:
    explicit NatureDimensionDetailDialog(QWidget* parent = nullptr);
    ~NatureDimensionDetailDialog() override;

    void setClientManager(ClientManager* clientManager);
    void setUsername(const std::string& username);
    void setDimension(const dq::domain::nature_dimension& dimension);
...
private:
    ...
    Ui::NatureDimensionDetailDialog* ui_;
    ClientManager* clientManager_;
    std::string username_;
    dq::domain::nature_dimension dimension_;
