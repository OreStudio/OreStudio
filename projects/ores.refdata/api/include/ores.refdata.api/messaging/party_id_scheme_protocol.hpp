...
struct save_party_id_scheme_request {
    ...
    static constexpr std::string_view nats_subject = "refdata.v1.party_id_schemes.save";
...
struct get_party_id_scheme_history_request {
    ...
    static constexpr std::string_view nats_subject = "refdata.v1.party_id_schemes.history";
    std::string code;
};
