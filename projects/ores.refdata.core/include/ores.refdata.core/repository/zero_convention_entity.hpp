...
struct zero_convention_entity {
    ...
    std::optional<std::optional<std::string>> compounding;
    std::optional<std::optional<std::string>> compounding_frequency;
    std::optional<std::optional<std::string>> tenor_calendar;
    std::optional<std::optional<int>> spot_lag;
    std::optional<std::optional<std::string>> spot_calendar;
    std::optional<std::optional<std::string>> roll_convention;
    std::optional<std::optional<bool>> end_of_month;
