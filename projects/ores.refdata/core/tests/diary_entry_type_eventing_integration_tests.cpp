...
#include "ores.refdata.api/eventing/diary_entry_type_event.hpp"
...
TEST_CASE("write_diary_entry_type_publishes_an_event", tags) {
    ...
    using event_type = ores::refdata::messaging::diary_entry_type_event;
    ...
    event_source.register_entity_event_mapping<event_type>("ores_refdata_diary_entry_types");
