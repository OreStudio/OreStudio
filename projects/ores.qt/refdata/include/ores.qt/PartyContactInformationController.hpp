 ...
 */
#ifndef ORES_QT_PARTY_CONTACT_INFORMATION_CONTROLLER_HPP
#define ORES_QT_PARTY_CONTACT_INFORMATION_CONTROLLER_HPP
...
/**
 * @brief Controller for managing party contact information windows and operations.
 *
 * Manages the lifecycle of party contact information list, detail, and history windows.
 * Handles event subscriptions and coordinates between windows.
 */
class PartyContactInformationController final : public EntityController {
    Q_OBJECT

private:
    inline static std::string_view logger_name = "ores.qt.party_contact_information_controller";
...
public:
    PartyContactInformationController(QMainWindow* mainWindow,
                                      QMdiArea* mdiArea,
...
private slots:
    void onShowDetails(const refdata::domain::party_contact_information& partyContactInformation);
    void onAddNewRequested();
    void onShowHistory(const refdata::domain::party_contact_information& partyContactInformation);
