...
TEST_CASE("default_wire_codec defaults to msgpack and reflects set_default_wire_codec", tags) {
    ...
    // at by construction (msgpack) -- verify that, then verify
    // set_default_wire_codec() actually changes it, restoring msgpack
