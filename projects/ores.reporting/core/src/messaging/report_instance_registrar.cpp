 ...
 *
 */
#include "ores.reporting.core/messaging/report_instance_registrar.hpp"
...
register_report_instance_handlers(ores::nats::service::client& nats,
    ...
    subs.push_back(nats.queue_subscribe(save_report_instance_request::nats_subject,
                                        queue_group,
                                        [h](ores::nats::message msg) { h->save(std::move(msg)); }));
    subs.push_back(nats.queue_subscribe(
        delete_report_instance_request::nats_subject, queue_group, [h](ores::nats::message msg) {
