...
#+CAPTION: Clock summary at [2025-09-29 Mon 00:53], for Monday, September 29, 2025.
|       | <75>                                  |        |      |      |       |
| Tags  | Headline                              | Time   |      |      |     % |
|-------+---------------------------------------+--------+------+------+-------|
...
|       | Stories                               | 0:52   |      |      | 100.0 |
|       | Active                                |        | 0:52 |      | 100.0 |
| agile | Sprint and product backlog refinement |        |      | 0:03 |   5.8 |
| code  | Replace XML parsing with reflect cpp  |        |      | 0:49 |  94.2 |
#+end:

#+begin: clocktable :maxlevel 3 :scope subtree :tags t :indent nil :emphasize nil :scope file :narrow 75 :formula %
#+TBLNAME: sprint_summary
#+CAPTION: Clock summary at [2025-09-29 Mon 00:54]
|          | <75>                                               |         |       |      |       |
| Tags     | Headline                                           | Time    |       |      |     % |
|----------+----------------------------------------------------+---------+-------+------+-------|
...
| code     | Add temporal support to currencies                 |         |       | 2:59 |   4.9 |
...
| code     | Implement a 0MQ based RPC service and client       |         |       | 3:55 |   6.4 |
...
| code     | Refactor core into risk                            |         |       | 3:58 |   6.5 |
