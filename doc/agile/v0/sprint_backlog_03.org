...
#+CAPTION: Clock summary at [2025-11-02 Sun 12:19], for Sunday, November 02, 2025.
|      | <75>                  |        |      |      |       |
| Tags | Headline              | Time   |      |      |     % |
|------+-----------------------+--------+------+------+-------|
|      | *Total time*          | *2:31* |      |      | 100.0 |
|------+-----------------------+--------+------+------+-------|
|      | Stories               | 2:31   |      |      | 100.0 |
|      | Active                |        | 2:31 |      | 100.0 |
| code | Improve code coverage |        |      | 2:31 | 100.0 |
#+end:

#+begin: clocktable :maxlevel 3 :scope subtree :tags t :indent nil :emphasize nil :scope file :narrow 75 :formula %
#+TBLNAME: sprint_summary
#+CAPTION: Clock summary at [2025-11-02 Sun 12:19]
|       | <75>                                                   |         |       |       |       |
| Tags  | Headline                                               | Time    |       |       |     % |
|-------+--------------------------------------------------------+---------+-------+-------+-------|
|       | *Total time*                                           | *54:58* |       |       | 100.0 |
|-------+--------------------------------------------------------+---------+-------+-------+-------|
|       | Stories                                                | 54:58   |       |       | 100.0 |
|       | Active                                                 |         | 54:58 |       | 100.0 |
| agile | Sprint and product backlog refinement                  |         |       |  1:24 |   2.5 |
| code  | Add locking up logic                                   |         |       |  1:28 |   2.7 |
| code  | Build using dynamic libraries                          |         |       |  7:24 |  13.5 |
| code  | Enable qt gui                                          |         |       |  4:13 |   7.7 |
| code  | Add locking up logic                                   |         |       |  1:28 |   2.7 |
| code  | Build using dynamic libraries                          |         |       |  7:24 |  13.5 |
| code  | Implement logging according to correct boost.log usage |         |       |  8:02 |  14.6 |
...
| code  | Consider adding a postgres database to CI              |         |       | 14:13 |  25.9 |
...
| code  | Improve code coverage                                  |         |       |  2:31 |   4.6 |
