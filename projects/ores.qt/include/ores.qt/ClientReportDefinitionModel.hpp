...
/**
 * @brief Model for displaying report definitions fetched from the server.
 *
 * This model extends QAbstractTableModel and fetches report definition
 * data asynchronously using the ores.comms client.
 */
class ClientReportDefinitionModel final : public AbstractClientModel {
    Q_OBJECT
...
public:
     ...
     * @return The report definition, or nullptr if row is invalid.
     */
...
private:
    ...
    struct FetchResult {
        bool success;
        std::vector<reporting::domain::report_definition> definitions;
