:PROPERTIES:
:ID: 8c4f5b9a-3d2e-4c89-a7f1-9e8d6f2b5a4c
:END:
#+title: Semi Automated Developer
...
Use this skill when you want to autonomously work through stories in the sprint
backlog with minimal human intervention. This skill combines agile story
...
* Semi-Automated Developer Mode

** IMPORTANT: Explicit Mode Activation Required

This skill operates in two distinct modes, and the user MUST explicitly enable
or disable semi-automated developer mode:

*** When Semi-Automated Developer Mode is ENABLED

When the user explicitly enables this mode (e.g., "Enable semi-automated
developer mode" or "Use the semi-automated developer skill"), you should:
...
*** When Semi-Automated Developer Mode is DISABLED (Default)
...
- To enable: "Enable semi-automated developer mode" or "Use the semi-automated
  developer skill"
- To disable: "Disable semi-automated developer mode" or "Exit semi-automated
  mode" or "Switch to interactive mode"

*** Default Behavior

*By default, semi-automated developer mode is DISABLED.* You should only operate
in autonomous mode when the user has explicitly enabled it. When in doubt, ask
the user if they want to enable semi-automated developer mode.
