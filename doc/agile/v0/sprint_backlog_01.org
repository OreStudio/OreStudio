...
#+CAPTION: Clock summary at [2024-07-13 Sat 23:34]
|       | <75>                                              |         |       |      |       |
| Tags  | Headline                                          | Time    |       |      |     % |
|-------+---------------------------------------------------+---------+-------+------+-------|
|       | *Total time*                                      | *68:40* |       |      | 100.0 |
|-------+---------------------------------------------------+---------+-------+------+-------|
|       | Stories                                           | 68:40   |       |      | 100.0 |
|       | Active                                            |         | 68:40 |      | 100.0 |
| agile | Sprint and product backlog refinement             |         |       | 3:11 |   4.6 |
...
| infra | Create and upload a package                       |         |       | 3:28 |   5.0 |
| code  | Create a basic project structure                  |         |       | 2:10 |   3.2 |
| code  | Add a Qt hello world                              |         |       | 3:08 |   4.6 |
...
| code  | Updates to Qt UI                                  |         |       | 5:06 |   7.4 |
#+end:
