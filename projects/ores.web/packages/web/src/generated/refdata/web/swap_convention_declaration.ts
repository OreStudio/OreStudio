 ...
 */
/**
 * Where the swap_convention screens live and what they can do.
 *
 ...
 */
import { swapConventionMeta } from '../ui/swap_convention_ui.js';
import type { EntityDescriptor } from '../../../entity/descriptor.js';

export const swapConventionDescriptor: EntityDescriptor = {
    component: 'refdata',
    entity: 'swap_convention',
    meta: swapConventionMeta,
    routeSegment: 'swap-convention',
    apiBase: '/api/swap_conventions',
    keyFields: [
        'id',
    ],
    capabilities: {
