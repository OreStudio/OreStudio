 ...
 *
 */
#ifndef ORES_MARKETDATA_CORE_REPOSITORY_TENOR_ANCHOR_REPOSITORY_HPP
#define ORES_MARKETDATA_CORE_REPOSITORY_TENOR_ANCHOR_REPOSITORY_HPP
 ...
 */
class ORES_MARKETDATA_CORE_EXPORT tenor_anchor_repository {
private:
    inline static std::string_view logger_name =
        "ores.marketdata.repository.tenor_anchor_repository";
...
public:
    ...
    /**
     * @brief Reads latest tenor anchors, possibly filtered by code.
     */
    /**@{*/
    ...
    /**
     * @brief Reads all tenor anchors, possibly filtered by code.
     */
