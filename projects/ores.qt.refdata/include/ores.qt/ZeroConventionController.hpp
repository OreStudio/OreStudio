 ...
 *
 */
#ifndef ORES_QT_ZERO_CONVENTION_CONTROLLER_HPP
#define ORES_QT_ZERO_CONVENTION_CONTROLLER_HPP
 ...
 *
 * Manages the lifecycle of zero convention list, detail, and history windows.
 * Handles event subscriptions and coordinates between windows.
 */
class ZeroConventionController final : public EntityController {
    Q_OBJECT

private:
    inline static std::string_view logger_name =
        "ores.qt.zero_convention_controller";
...
private slots:
    ...
    void onOpenVersion(const refdata::domain::zero_convention& zc,
                       int versionNumber);
