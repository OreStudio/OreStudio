...
- Launch *three separate client instances*, one per role under test,
  ...
  #+end_src
  - *blue* — general verification + =tenant_admin@acmebank=.
...
- On the *blue* client, log in as =tenant_admin@acmebank= / password
  =Secure-Password-123=.
...
- On the *blue* client, log in as =tenant_admin@acmebank= and confirm
