...
domain::bond_leg_amount bond_leg_amount_mapper::map(const bond_leg_amount_entity& v) {
...
bond_leg_amount_entity bond_leg_amount_mapper::map(const domain::bond_leg_amount& v) {
...
bond_leg_amount_mapper::map(const std::vector<bond_leg_amount_entity>& v) {
    return map_vector<bond_leg_amount_entity, domain::bond_leg_amount>(
        v, [](const auto& ve) { return map(ve); }, lg(), "db entities");
}

std::vector<bond_leg_amount_entity>
bond_leg_amount_mapper::map(const std::vector<domain::bond_leg_amount>& v) {
    return map_vector<domain::bond_leg_amount, bond_leg_amount_entity>(
