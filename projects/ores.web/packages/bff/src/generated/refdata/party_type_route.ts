 ...
 */
/**
 * How the BFF reaches the party_type service.
 *
 ...
 */
import { subjects } from '@ores/wire-protocol/generated/refdata/protocol/party_type_protocol';
import type { EntityRouteDescriptor } from '../../entity-routes.js';

export const partyTypeRoute: EntityRouteDescriptor = {
  component: 'refdata',
  entity: 'party_type',
  collection: 'types',
  keyFields: ['code'],
  ...
  subjects: {
    list: subjects.list_party_types_request,
    get: subjects.get_party_type_request,
    save: subjects.put_party_type_request,
    remove: subjects.delete_party_type_request,
    history: subjects.list_party_type_versions_request,
  },
  rowsField: 'types',
  getRowField: 'party_type',
