 ...
 *
 */
#ifndef ORES_SHELL_APP_COMMANDS_EQUITY_DIGITAL_OPTION_INSTRUMENT_COMMANDS_HPP
#define ORES_SHELL_APP_COMMANDS_EQUITY_DIGITAL_OPTION_INSTRUMENT_COMMANDS_HPP
...
/**
 * @brief Manages commands related to Equity Digital Option instruments.
 */
class equity_digital_option_instrument_commands {
private:
    inline static std::string_view logger_name =
        "ores.shell.app.commands.trading.equity_digital_option_instrument_commands";
...
public:
    /**
     * @brief Register Equity Digital Option instrument related commands.
     */
    ...
    /**
     * @brief Process the Equity Digital Option instrument history request.
     */
