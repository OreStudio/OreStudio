...
#+description: Codegen entity model for the analytics =pricing_model_product= table. Drives the C++ domain class, mapper, repository, service, generator, and SQL schema generation from a single literate source.
