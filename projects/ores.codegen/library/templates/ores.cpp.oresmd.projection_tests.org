...
TEST_CASE("is_scalar_true_for_spot_and_fixing_identities", tags) {
    ...
    REQUIRE(oresmd_projections::is_scalar(parse("oresmd://ir/usd?index=libor&tenor=3m&type=fixing")));
    REQUIRE(oresmd_projections::is_scalar(parse("oresmd://equity/aapl?ccy=usd&type=quote&quote=spot")));
}
...
TEST_CASE("is_scalar_false_for_curves_vols_and_pointed_quotes", tags) {
    ...
    REQUIRE_FALSE(oresmd_projections::is_scalar(
        parse("oresmd://fx/eurusd?type=quote&quote=fwd&point=1y")));
}
#+end_src
