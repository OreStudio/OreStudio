...
begin
    ...
    perform pg_notify('ores_trading_rpa_instruments', notification_payload::text);

    return null;
end;
$$ language plpgsql;

create or replace trigger ores_trading_rpa_instruments_notify_trg
after insert or update or delete on ores_trading_rpa_instruments_tbl
for each row execute function ores_trading_rpa_instruments_notify_fn();
