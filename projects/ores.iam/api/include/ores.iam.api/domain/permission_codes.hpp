 ...
 *
 */
#ifndef ORES_IAM_API_DOMAIN_PERMISSION_CODES_HPP
#define ORES_IAM_API_DOMAIN_PERMISSION_CODES_HPP
 ...
 *
 * These codes must match the rows seeded in ores_iam_permissions_tbl. Kept
 * in its own hand-maintained header, separate from the generated
 * permission.hpp, since codegen has no way to express "also emit this extra
 * namespace of constants" -- a regeneration of permission.hpp would
