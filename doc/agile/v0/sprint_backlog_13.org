...
#+CAPTION: Clock summary at [2026-02-25 Wed 15:07], for Wednesday, February 25, 2026.
|      | <75>                                |        |      |      |       |
| Tags | Headline                            | Time   |      |      |     % |
|------+-------------------------------------+--------+------+------+-------|
...
|      | Stories                             | 4:21   |      |      | 100.0 |
|      | Active                              |        | 4:21 |      | 100.0 |
| code | Remove toolbars from detail dialogs |        |      | 4:21 | 100.0 |
#+end:

#+begin: clocktable :maxlevel 3 :scope subtree :tags t :indent nil :emphasize nil :scope file :narrow 75 :formula %
#+TBLNAME: sprint_summary
#+CAPTION: Clock summary at [2026-02-25 Wed 15:07]
|       | <75>                                                  |         |       |       |       |
| Tags  | Headline                                              | Time    |       |       |     % |
|-------+-------------------------------------------------------+---------+-------+-------+-------|
|       | *Total time*                                          | *44:27* |       |       | 100.0 |
|-------+-------------------------------------------------------+---------+-------+-------+-------|
|       | Stories                                               | 44:27   |       |       | 100.0 |
|       | Active                                                |         | 44:27 |       | 100.0 |
| agile | Sprint and product backlog refinement                 |         |       |  0:26 |   1.0 |
| infra | Generate release notes for previous sprint            |         |       |  1:16 |   2.8 |
| code  | Merge FSM into DQ                                     |         |       |  0:34 |   1.3 |
| code  | Make all details dialogs tabbed                       |         |       |  2:26 |   5.5 |
| code  | Provenance: Fix performed by and modified by stamping |         |       |  3:17 |   7.4 |
| code  | Add plotting of session data                          |         |       |  1:19 |   3.0 |
| code  | Add account-party management and login support        |         |       | 13:43 |  30.9 |
| code  | Add rounding type entity                              |         |       |  1:40 |   3.7 |
| code  | Polish business centre UI and data quality            |         |       |  0:58 |   2.2 |
| code  | Enhance currency taxonomy                             |         |       |  2:06 |   4.7 |
| code  | Books, portfolios and trades are not party specific   |         |       |  2:59 |   6.7 |
| code  | Minor improvements to connection browser              |         |       |  1:17 |   2.9 |
| code  | Rename currency asset classes                         |         |       |  1:05 |   2.4 |
| code  | Add portfolio explorer                                |         |       |  4:38 |  10.4 |
| code  | Add party level currency and country restrictions     |         |       |  0:46 |   1.7 |
| code  | Remove toolbars from detail dialogs                   |         |       |  5:57 |  13.4 |
#+end:
...
*** STARTED Add portfolio explorer                                     :code:
    :LOGBOOK:
...
*** STARTED Remove toolbars from detail dialogs                        :code:
    :LOGBOOK:
