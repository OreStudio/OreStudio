 ...
 *
 */
#ifndef ORES_SHELL_APP_COMMANDS_TRADING_BALANCE_GUARANTEED_SWAP_INSTRUMENT_COMMANDS_HPP
#define ORES_SHELL_APP_COMMANDS_TRADING_BALANCE_GUARANTEED_SWAP_INSTRUMENT_COMMANDS_HPP
...
/**
 * @brief Manages commands related to BALANCE GUARANTEED SWAP INSTRUMENTS.
 */
class balance_guaranteed_swap_instrument_commands {
private:
    inline static std::string_view logger_name =
        "ores.shell.app.commands.trading.balance_guaranteed_swap_instrument_commands";
...
public:
    /**
     * @brief Register balance-guaranteed-swap-instrument related commands.
     */
