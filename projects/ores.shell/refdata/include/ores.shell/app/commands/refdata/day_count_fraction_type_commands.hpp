 ...
 */
#ifndef ORES_SHELL_APP_COMMANDS_DAY_COUNT_FRACTION_TYPE_COMMANDS_HPP
#define ORES_SHELL_APP_COMMANDS_DAY_COUNT_FRACTION_TYPE_COMMANDS_HPP
...
/**
 * @brief Every verb day count fraction types answer, as one command each.
 *
 ...
 */
class day_count_fraction_type_commands {
private:
    inline static std::string_view logger_name =
        "ores.shell.app.commands.refdata.day_count_fraction_type_commands";
...
public:
    /**
     * @brief Register the day count fraction types submenu.
     */
