 ...
 */
#ifndef ORES_SHELL_APP_COMMANDS_ROUNDING_TYPE_COMMANDS_HPP
#define ORES_SHELL_APP_COMMANDS_ROUNDING_TYPE_COMMANDS_HPP
...
/**
 * @brief Every verb rounding types answer, as one command each.
 *
 ...
 */
class rounding_type_commands {
private:
    inline static std::string_view logger_name =
        "ores.shell.app.commands.refdata.rounding_type_commands";
...
public:
    /**
     * @brief Register the rounding types submenu.
     */
