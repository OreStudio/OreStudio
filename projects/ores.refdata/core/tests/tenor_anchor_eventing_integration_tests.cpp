...
#include "ores.refdata.api/eventing/tenor_anchor_event.hpp"
...
TEST_CASE("write_tenor_anchor_publishes_an_event", tags) {
    ...
    using event_type = ores::refdata::messaging::tenor_anchor_event;
    ...
    event_source.register_entity_event_mapping<event_type>("ores_refdata_tenor_anchors");
