...
public:
    ...
    static std::vector<connection_entity> to_entities(const std::vector<domain::connection>& conns);
    static std::vector<domain::connection>
    to_domain(const std::vector<connection_entity>& entities);
};
