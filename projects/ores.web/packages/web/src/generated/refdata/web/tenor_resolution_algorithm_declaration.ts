 ...
 */
/**
 * Where the tenor_resolution_algorithm screens live and what they can do.
 *
 ...
 */
import { tenorResolutionAlgorithmMeta } from '../ui/tenor_resolution_algorithm_ui.js';
import type { EntityDescriptor } from '../../../entity/descriptor.js';

export const tenorResolutionAlgorithmDescriptor: EntityDescriptor = {
    component: 'refdata',
    entity: 'tenor_resolution_algorithm',
    meta: tenorResolutionAlgorithmMeta,
    routeSegment: 'tenor-resolution-algorithm',
    apiBase: '/api/algorithms',
    keyParam: 'id',
    icon: 'tag',
    capabilities: {
        create: true,
