...
private:
    inline static std::string_view logger_name =
        "ores.iam.repository.tenant_type_mapper";
...
public:
    ...
    static std::vector<domain::tenant_type>
    map(const std::vector<tenant_type_entity>& v);
    static std::vector<tenant_type_entity>
    map(const std::vector<domain::tenant_type>& v);
};
