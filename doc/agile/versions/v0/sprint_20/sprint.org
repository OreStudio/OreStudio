...
| [[id:D7F3D19C-1E9C-4302-B661-12A28411425E][Migrate Claude memories to org-based memory system]] | BACKLOG | | | Audit harness memory files, port keepers to the org system, delete the harness files, update LLM instructions, disable auto-memory in Claude Code settings. |
