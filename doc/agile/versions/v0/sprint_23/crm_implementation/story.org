...
| [[id:C685A8BE-0DF9-4D23-8AAB-E9DF9069E482][CRM cross-rates matrix UI panel]] | BACKLOG | | | A Qt panel showing the full cross-rates matrix for a party via marketdata.v1.crm.rates, with a manual reload button (no auto-refresh/push) -- covers every currently-configured pair. |
