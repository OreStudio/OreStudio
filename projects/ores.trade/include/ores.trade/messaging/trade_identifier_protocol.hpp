 ...
 *
 */
#ifndef ORES_TRADE_MESSAGING_TRADE_IDENTIFIER_PROTOCOL_HPP
#define ORES_TRADE_MESSAGING_TRADE_IDENTIFIER_PROTOCOL_HPP
...
template<>
struct message_traits<trade::messaging::get_trade_identifiers_request> {
    using request_type = trade::messaging::get_trade_identifiers_request;
    using response_type = trade::messaging::get_trade_identifiers_response;
    static constexpr message_type request_message_type =
        message_type::get_trade_identifiers_request;
};

template<>
struct message_traits<trade::messaging::save_trade_identifier_request> {
    using request_type = trade::messaging::save_trade_identifier_request;
    using response_type = trade::messaging::save_trade_identifier_response;
    static constexpr message_type request_message_type =
        message_type::save_trade_identifier_request;
};

template<>
struct message_traits<trade::messaging::delete_trade_identifier_request> {
    using request_type = trade::messaging::delete_trade_identifier_request;
    using response_type = trade::messaging::delete_trade_identifier_response;
    static constexpr message_type request_message_type =
        message_type::delete_trade_identifier_request;
};

template<>
struct message_traits<trade::messaging::get_trade_identifier_history_request> {
    using request_type = trade::messaging::get_trade_identifier_history_request;
    using response_type = trade::messaging::get_trade_identifier_history_response;
    static constexpr message_type request_message_type =
