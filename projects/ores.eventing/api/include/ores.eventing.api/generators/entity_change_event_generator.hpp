 ...
 *
 */
#ifndef ORES_EVENTING_API_GENERATORS_ENTITY_CHANGE_EVENT_GENERATOR_HPP
#define ORES_EVENTING_API_GENERATORS_ENTITY_CHANGE_EVENT_GENERATOR_HPP
 ...
 */
class ORES_EVENTING_API_EXPORT entity_change_event_generator final {
public:
    /**
