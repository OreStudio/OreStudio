...
#include "ores.refdata.api/eventing/business_day_convention_type_event.hpp"
...
TEST_CASE("write_business_day_convention_type_publishes_an_event", tags) {
    ...
    using event_type = ores::refdata::messaging::business_day_convention_type_event;
