...
\echo '--- Yield Curve Process Types ---'

insert into ores_synthetic_yield_curve_process_types_tbl (
...
-- Summary
select 'synthetic_yield_curve_process_types' as entity, count(*) as count
