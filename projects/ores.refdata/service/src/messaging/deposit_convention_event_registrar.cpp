...
register_deposit_convention_event_mapping(ev::service::postgres_event_source& event_source,
    ...
    event_source.register_entity_event_mapping<refdata::messaging::deposit_convention_event>(
        "ores_refdata_deposit_conventions");

    return event_bus.subscribe<refdata::messaging::deposit_convention_event>(
        [&nats](const refdata::messaging::deposit_convention_event& e) {
            ...
            ev::service::publish_entity_event(
                nats,
                ev::domain::event_subject<refdata::messaging::deposit_convention_event>(e.action),
                e);
        });
}
