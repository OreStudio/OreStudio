 ...
 *
 */
#ifndef ORES_QT_CURRENCY_PAIR_DETAIL_DIALOG_HPP
#define ORES_QT_CURRENCY_PAIR_DETAIL_DIALOG_HPP
...
/**
 * @brief Detail dialog for viewing and editing currency pair records.
 *
 * This dialog allows viewing, creating, and editing currency pairs.
 * It supports both create mode (for new records) and edit mode (for
 * existing records).
 */
class CurrencyPairDetailDialog final : public DetailDialogBase {
    Q_OBJECT

private:
    inline static std::string_view logger_name = "ores.qt.currency_pair_detail_dialog";
...
public:
    explicit CurrencyPairDetailDialog(QWidget* parent = nullptr);
    ~CurrencyPairDetailDialog() override;

    void setClientManager(ClientManager* clientManager);
    void setUsername(const std::string& username);
    void setPair(const refdata::domain::currency_pair& pair);
...
private:
    ...
    void populateBaseCurrencyCombo();
    ...
    refdata::domain::currency_pair pair_;
