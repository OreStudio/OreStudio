...
comment on table ores_dq_dataset_publications_tbl is
    'Audit table for tracking dataset publication history.';

comment on column ores_dq_dataset_publications_tbl.id is
    'Unique identifier for this publication record.';

comment on column ores_dq_dataset_publications_tbl.dataset_id is
    'ID of the dataset that was published.';

comment on column ores_dq_dataset_publications_tbl.dataset_code is
    'Code of the dataset that was published (e.g., iso.currencies).';

comment on column ores_dq_dataset_publications_tbl.mode is
    'Publication mode used: upsert, insert_only, or replace_all.';

comment on column ores_dq_dataset_publications_tbl.target_table is
    'Name of the production table that received the data.';

comment on column ores_dq_dataset_publications_tbl.records_inserted is
    'Number of records inserted during publication.';

comment on column ores_dq_dataset_publications_tbl.records_updated is
    'Number of records updated during publication (upsert mode).';

comment on column ores_dq_dataset_publications_tbl.records_skipped is
    'Number of records skipped during publication.';

comment on column ores_dq_dataset_publications_tbl.records_deleted is
    'Number of records deleted during publication (replace_all mode).';

comment on column ores_dq_dataset_publications_tbl.published_by is
    'Username of the person who initiated the publication.';

comment on column ores_dq_dataset_publications_tbl.published_at is
