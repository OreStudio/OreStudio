 ...
 *
 */
#ifndef ORES_TRADING_API_MESSAGING_INFLATION_SWAP_INSTRUMENT_PROTOCOL_HPP
#define ORES_TRADING_API_MESSAGING_INFLATION_SWAP_INSTRUMENT_PROTOCOL_HPP
...
struct get_inflation_swap_instruments_response {
    std::vector<ores::trading::domain::inflation_swap_instrument> inflation_swap_instruments;
...
struct save_inflation_swap_instrument_request {
    ...
    static save_inflation_swap_instrument_request
    from(ores::trading::domain::inflation_swap_instrument v) {
