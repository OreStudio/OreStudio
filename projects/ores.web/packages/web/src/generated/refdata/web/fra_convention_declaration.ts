 ...
 */
/**
 * Where the fra_convention screens live and what they can do.
 *
 ...
 */
import { fraConventionMeta } from '../ui/fra_convention_ui.js';
import type { EntityDescriptor } from '../../../entity/descriptor.js';

export const fraConventionDescriptor: EntityDescriptor = {
    component: 'refdata',
    entity: 'fra_convention',
    meta: fraConventionMeta,
    routeSegment: 'fra-convention',
    apiBase: '/api/fra_conventions',
    keyParam: 'id',
    icon: 'chartMultiple',
    capabilities: {
        create: true,
