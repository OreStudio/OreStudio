 ...
 *
 */
#ifndef ORES_REFDATA_EVENTING_COUNTERPARTY_CONTACT_INFORMATION_CHANGED_EVENT_HPP
#define ORES_REFDATA_EVENTING_COUNTERPARTY_CONTACT_INFORMATION_CHANGED_EVENT_HPP
...
struct event_traits<ores::refdata::eventing::counterparty_contact_information_changed_event> {
    static constexpr std::string_view name = "ores.refdata.counterparty_contact_information_changed";
};
