...
- [[proj:.github/workflows/nightly-format.yml][=.github/workflows/nightly-format.yml=]] exists and triggers nightly
  at 02:00 UTC (plus =workflow_dispatch= for manual runs).
- Workflow installs =clang-format-18= via apt on Ubuntu 24.04.
- Runs =clang-format -i= on all =.cpp=, =.hpp=, =.h= under [[proj:projects][=projects/=]].
...
Created [[proj:.github/workflows/nightly-format.yml][=.github/workflows/nightly-format.yml=]]:
