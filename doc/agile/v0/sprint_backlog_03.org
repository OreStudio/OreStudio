...
#+CAPTION: Clock summary at [2025-11-01 Sat 23:35], for Saturday, November 01, 2025.
|      | <75>                                      |        |      |      |       |
| Tags | Headline                                  | Time   |      |      |     % |
|------+-------------------------------------------+--------+------+------+-------|
|      | *Total time*                              | *5:22* |      |      | 100.0 |
|------+-------------------------------------------+--------+------+------+-------|
|      | Stories                                   | 5:22   |      |      | 100.0 |
|      | Active                                    |        | 5:22 |      | 100.0 |
| code | Consider adding a postgres database to CI |        |      | 5:22 | 100.0 |
#+end:

#+begin: clocktable :maxlevel 3 :scope subtree :tags t :indent nil :emphasize nil :scope file :narrow 75 :formula %
#+TBLNAME: sprint_summary
#+CAPTION: Clock summary at [2025-11-01 Sat 23:35]
|       | <75>                                                   |         |       |       |       |
| Tags  | Headline                                               | Time    |       |       |     % |
|-------+--------------------------------------------------------+---------+-------+-------+-------|
|       | *Total time*                                           | *52:27* |       |       | 100.0 |
|-------+--------------------------------------------------------+---------+-------+-------+-------|
|       | Stories                                                | 52:27   |       |       | 100.0 |
|       | Active                                                 |         | 52:27 |       | 100.0 |
| agile | Sprint and product backlog refinement                  |         |       |  1:24 |   2.7 |
| code  | Add locking up logic                                   |         |       |  1:28 |   2.8 |
| code  | Build using dynamic libraries                          |         |       |  7:24 |  14.1 |
| code  | Enable qt gui                                          |         |       |  4:13 |   8.0 |
| code  | Add locking up logic                                   |         |       |  1:28 |   2.8 |
| code  | Build using dynamic libraries                          |         |       |  7:24 |  14.1 |
| code  | Implement logging according to correct boost.log usage |         |       |  8:02 |  15.3 |
| code  | Fix broken Linux and OSX tests                         |         |       |  0:10 |   0.3 |
| code  | Fix broken windows builds                              |         |       |  2:35 |   4.9 |
| code  | Investigate leaks from valgrind                        |         |       |  0:51 |   1.6 |
| code  | Consider adding a postgres database to CI              |         |       | 14:13 |  27.1 |
| code  | Fix misspell that causes build to break                |         |       |  0:12 |   0.4 |
| code  | Add support for feature flags                          |         |       |  1:25 |   2.7 |
