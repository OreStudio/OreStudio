 ...
 *
 */
#ifndef ORES_TRADE_MESSAGING_LIFECYCLE_EVENT_PROTOCOL_HPP
#define ORES_TRADE_MESSAGING_LIFECYCLE_EVENT_PROTOCOL_HPP
...
template<>
struct message_traits<trade::messaging::get_lifecycle_events_request> {
    using request_type = trade::messaging::get_lifecycle_events_request;
    using response_type = trade::messaging::get_lifecycle_events_response;
    static constexpr message_type request_message_type =
        message_type::get_lifecycle_events_request;
};

template<>
struct message_traits<trade::messaging::save_lifecycle_event_request> {
    using request_type = trade::messaging::save_lifecycle_event_request;
    using response_type = trade::messaging::save_lifecycle_event_response;
    static constexpr message_type request_message_type =
        message_type::save_lifecycle_event_request;
};

template<>
struct message_traits<trade::messaging::delete_lifecycle_event_request> {
    using request_type = trade::messaging::delete_lifecycle_event_request;
    using response_type = trade::messaging::delete_lifecycle_event_response;
    static constexpr message_type request_message_type =
        message_type::delete_lifecycle_event_request;
};

template<>
struct message_traits<trade::messaging::get_lifecycle_event_history_request> {
    using request_type = trade::messaging::get_lifecycle_event_history_request;
    using response_type = trade::messaging::get_lifecycle_event_history_response;
    static constexpr message_type request_message_type =
