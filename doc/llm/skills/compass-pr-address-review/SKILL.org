...
---
name: compass-pr-address-review
...
5. /Fix/ — one commit per logical fix; never amend on a branch under
   review. Classify the round's fix with the [[id:4DF9BFE8-DC28-4220-AFF0-68E0A7CD5D2B][compass-pr-raise]] rule table and
...
7. /Resolve threads/ — already recorded in the =* Review= table and
   ...
   before the PR was raised (see [[id:67FDB9A1-3EBE-45A5-97BD-5E5123661553][compass-agile-close-task]]) — merge immediately
   with [[id:D36BCA19-8926-4E06-8C0B-7F607BD3D4EC][compass-pr-merge]], no additional commits.
