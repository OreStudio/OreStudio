...
/**
 * @brief Model for displaying feed bindings fetched from the server.
 *
 * This model extends AbstractClientModel and fetches feed binding
 * data asynchronously using the ores.comms client.
 */
class ClientFeedBindingModel final : public AbstractClientModel {
    Q_OBJECT

private:
    inline static std::string_view logger_name = "ores.qt.client_feed_binding_model";
...
public:
    ...
    /**
     * @brief Refresh feed binding data from server asynchronously.
     */
    void refresh();

    /**
     * @brief Get feed binding at the specified row.
     *
