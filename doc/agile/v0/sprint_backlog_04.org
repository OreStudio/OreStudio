...
#+CAPTION: Clock summary at [2025-11-08 Sat 01:36], for Saturday, November 08, 2025.
|       | <75>                                  |        |      |      |       |
| Tags  | Headline                              | Time   |      |      |     % |
|-------+---------------------------------------+--------+------+------+-------|
...
|       | Stories                               | 1:34   |      |      | 100.0 |
|       | Active                                |        | 1:34 |      | 100.0 |
| agile | Sprint and product backlog refinement |        |      | 0:09 |   9.6 |
| code  | Use fluent icons                      |        |      | 0:27 |  28.7 |
| code  | Add currency editing support          |        |      | 0:58 |  61.7 |
#+end:

#+begin: clocktable :maxlevel 3 :scope subtree :tags t :indent nil :emphasize nil :scope file :narrow 75 :formula %
#+TBLNAME: sprint_summary
#+CAPTION: Clock summary at [2025-11-08 Sat 01:36]
|       | <75>                                                   |        |      |      |       |
| Tags  | Headline                                               | Time   |      |      |     % |
|-------+--------------------------------------------------------+--------+------+------+-------|
|       | *Total time*                                           | *9:09* |      |      | 100.0 |
|-------+--------------------------------------------------------+--------+------+------+-------|
|       | Stories                                                | 9:09   |      |      | 100.0 |
|       | Active                                                 |        | 9:09 |      | 100.0 |
| agile | Sprint and product backlog refinement                  |        |      | 0:43 |   7.8 |
| code  | Clean up client parser                                 |        |      | 0:10 |   1.8 |
| code  | Add connect command line argument                      |        |      | 1:19 |  14.4 |
| infra | Install Windows package on Windows machine             |        |      | 2:09 |  23.5 |
| code  | Ignore warnings on windows and osx                     |        |      | 0:33 |   6.0 |
| code  | Ensure applications work under OSX using github images |        |      | 0:14 |   2.6 |
| infra | Create a splash screen and gray background             |        |      | 2:26 |  26.6 |
| code  | Use fluent icons                                       |        |      | 0:37 |   6.7 |
| code  | Add currency editing support                           |        |      | 0:58 |  10.6 |
#+end:
