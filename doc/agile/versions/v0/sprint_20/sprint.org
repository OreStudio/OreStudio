...
| [[id:5C6AEFF8-989A-4890-8824-0A6D98213558][Backlog index regeneration skips the discarded bucket]] | =agile= =backlog= =compass= =tooling= =codegen= | regenerate_backlog_indexes.py rebuilds inbox/next/deferred but not discarded.org, which claims auto-generation. |
