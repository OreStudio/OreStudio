 ...
 *
 */
#ifndef ORES_QT_CLIENT_NATURE_DIMENSION_MODEL_HPP
#define ORES_QT_CLIENT_NATURE_DIMENSION_MODEL_HPP
...
class ClientNatureDimensionModel final : public AbstractClientModel {
    Q_OBJECT

private:
    inline static std::string_view logger_name = "ores.qt.client_nature_dimension_model";
...
public:
    ...
    /**
     * @brief Default window size for the nature dimension list window.
     */
     ...
     */
    static constexpr std::string_view kSettingsGroup = "NatureDimensionListWindow";
    /**
    ...
    explicit ClientNatureDimensionModel(ClientManager* clientManager, QObject* parent = nullptr);
    ~ClientNatureDimensionModel() override = default;
    ...
    void refresh();
    const dq::domain::nature_dimension* getDimension(int row) const;
...
private:
    ...
    struct FetchResult {
        bool success;
        std::vector<dq::domain::nature_dimension> dimensions;
        QString error_message;
        QString error_details;
    };

    ClientManager* clientManager_;
    std::vector<dq::domain::nature_dimension> dimensions_;
    QFutureWatcher<FetchResult>* watcher_;
    bool is_fetching_{false};

    using NatureDimensionKeyExtractor = std::string (*)(const dq::domain::nature_dimension&);
    RecencyTracker<dq::domain::nature_dimension, NatureDimensionKeyExtractor> recencyTracker_;
