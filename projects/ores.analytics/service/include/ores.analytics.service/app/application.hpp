 ...
 *
 */
#ifndef ORES_ANALYTICS_SERVICE_APP_APPLICATION_HPP
#define ORES_ANALYTICS_SERVICE_APP_APPLICATION_HPP
...
/**
 * @brief Entry point for the ores.analytics.service service.
 */
class application final {
private:
    inline static std::string_view logger_name = "ores.analytics.service.app.application";
