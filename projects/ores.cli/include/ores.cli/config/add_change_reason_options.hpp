 ...
 *
 */
#ifndef ORES_CLI_CONFIG_ADD_CHANGE_REASON_OPTIONS_HPP
#define ORES_CLI_CONFIG_ADD_CHANGE_REASON_OPTIONS_HPP
...
/**
 * @brief Configuration for adding a change reason entity via command-line arguments.
 */
struct add_change_reason_options final {
    std::string code;
