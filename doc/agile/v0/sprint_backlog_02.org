...
#+CAPTION: Clock summary at [2025-02-09 Sun 23:20]
|       | <75>                                   |        |      |      |       |
| Tags  | Headline                               | Time   |      |      |     % |
|-------+----------------------------------------+--------+------+------+-------|
|       | *Total time*                           | *8:39* |      |      | 100.0 |
|-------+----------------------------------------+--------+------+------+-------|
|       | Stories                                | 8:39   |      |      | 100.0 |
|       | Active                                 |        | 8:39 |      | 100.0 |
| agile | Sprint and product backlog refinement  |        |      | 1:22 |  15.8 |
| infra | Fix broken builds                      |        |      | 0:36 |   6.9 |
| code  | Create a containing structure for data |        |      | 0:35 |   6.7 |
| code  | Add temporal support to currencies     |        |      | 2:59 |  34.5 |
| code  | Refactor code for currencies           |        |      | 3:07 |  36.0 |
#+end:
