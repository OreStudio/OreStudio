...
QVariant ClientPartyTypeModel::data(
    ...
    if (role == Qt::DisplayRole) {
        ...
        case Version:
            return type.version;
        case RecordedBy:
            return QString::fromStdString(type.recorded_by);
        case RecordedAt:
...
void ClientPartyTypeModel::refresh() {
    ...
    BOOST_LOG_SEV(lg(), debug) << "Starting party type fetch";
    is_fetching_ = true;
    ...
    QFuture<FetchResult> future = QtConcurrent::run([self]() -> FetchResult {
        return exception_helper::wrap_async_fetch<FetchResult>([&]() -> FetchResult {
            ...
            auto response = refdata::messaging::get_party_types_response::
...
void ClientPartyTypeModel::onTypesLoaded() {
    ...
    BOOST_LOG_SEV(lg(), info) << "Loaded " << types_.size() << " party types";
    emit dataLoaded();
}
