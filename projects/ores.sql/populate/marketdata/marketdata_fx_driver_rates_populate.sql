 ...
 * table with real Federal Reserve H.10 FX spot rates for the 8-pair
 * USD-hub spanning tree (EUR/USD, GBP/USD, USD/CHF, USD/JPY, USD/SEK,
 * AUD/USD, USD/CAD, NZD/USD - covers EUR, USD, GBP, CHF, JPY, SEK, AUD,
 ...
 * for any future date/currency addition):
...
BEGIN
    PERFORM ores_dq_datasets_upsert_fn(ores_utility_system_tenant_id_fn(),
        ...
        '25 real Federal Reserve H.10 FX spot vintages across 2016 (start/end of each month, plus 2016-02-05 - ORE''s own bundled reference vintage date), a minimal USD-hub spanning tree over EUR/USD/GBP/CHF/JPY/SEK/AUD/CAD/NZD.',
        'ORESTUDIO',
