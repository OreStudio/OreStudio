 ...
 */
#ifndef ORES_SHELL_APP_COMMANDS_LEG_TYPE_COMMANDS_HPP
#define ORES_SHELL_APP_COMMANDS_LEG_TYPE_COMMANDS_HPP
...
/**
 * @brief Every verb leg types answer, as one command each.
 *
 ...
 */
class leg_type_commands {
private:
    inline static std::string_view logger_name =
        "ores.shell.app.commands.refdata.leg_type_commands";
...
public:
    /**
     * @brief Register the leg types submenu.
     */
