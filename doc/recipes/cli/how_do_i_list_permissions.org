...
:END:
#+title: How do I list permissions?
#+description: List permissions via =ores.cli=
#+type: recipe
#+version: 2
#+level: cross
...
List permissions via =ores.cli=. See the [[id:A1B2C3D4-E5F6-7890-ABCD-EF1234567890][CLI inventory]] for sibling recipes.
