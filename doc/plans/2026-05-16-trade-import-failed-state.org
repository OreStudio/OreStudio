...
- [[file:2026-05-17-workspace-design.org][Workspace Design]] (PROPOSED, PREREQUISITE for Track 1) — isolated
...
|-------+--------+--------+---------------------|
| 1 — Educational | ORE sample directory | Named workspace | Workspace (see [[file:2026-05-17-workspace-design.org][workspace plan]]) |
| 2 — Production | External trades (FpML, CSV) | Live (workspace 0) | Pending Book + ~is_live~ flags |

*Track 1 is blocked* on [[file:2026-05-17-workspace-design.org][Workspace]] implementation.  All phases below
