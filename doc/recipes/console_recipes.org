...
./ores.cli import ${log_args} ${db_args} --entity currencies --target ${data_dir}/currencies_API.xml | jq .
#+END_SRC
...
#+begin_src sh
export ORES_DB_PASSWORD
./ores.cli export ${log_args} ${db_args} ${format_args} --entity currencies | xmllint --format -
#+END_SRC
...
#+begin_src sh
export ORES_DB_PASSWORD
./ores.cli export ${log_args} ${db_args} ${format_args} --entity currencies --key 'AOA' | xmllint --format -
#+END_SRC
...
#+begin_src sh
export ORES_DB_PASSWORD
./ores.cli export ${log_args} ${db_args} ${format_args} --entity currencies --as-of "2025-09-29 00:06:09" | xmllint --format - | head -n 50
#+END_SRC
...
#+begin_src sh
export ORES_DB_PASSWORD
./ores.cli export ${log_args} ${db_args} ${format_args} --entity currencies --as-of "2025-09-29 00:08:06" --key 'AOA' | xmllint --format -
#+END_SRC
...
#+begin_src sh
export ORES_DB_PASSWORD
./ores.cli export ${log_args} ${db_args} ${format_args} --entity currencies --key 'AOA' --all-versions | xmllint --format -
#+END_SRC
...
#+begin_src sh
export ORES_DB_PASSWORD
./ores.cli export ${log_args} ${db_args} ${format_args} --entity currencies --all-versions | xmllint --format - | head -n 50
#+END_SRC
...
#+begin_src sh
export ORES_DB_PASSWORD
./ores.cli export ${log_args} ${db_args} ${format_args} --entity currencies | jq .
#+END_SRC
...
[
  {
    ...
    "currency_type": "",
    "modified_by": "ores",
    "valid_from": "2025-11-02 22:18:13",
    "valid_to": "2025-11-02 22:18:13"
  },
  {
    "iso_code": "AFN",
    "name": "Afghan afghani",
...
#+begin_src sh
export ORES_DB_PASSWORD
./ores.cli export ${log_args} ${db_args} ${format_args} --entity currencies --key 'AOA' | jq .
#+END_SRC
...
#+begin_src sh
export ORES_DB_PASSWORD
./ores.cli export ${log_args} ${db_args} ${format_args} --entity currencies --as-of "2025-09-29 00:06:09" | jq .[:3]
#+END_SRC
...
#+begin_src sh
export ORES_DB_PASSWORD
./ores.cli export ${log_args} ${db_args} ${format_args} --entity currencies --as-of "2025-09-29 00:08:06" --key 'AOA' | jq .
#+END_SRC
...
#+begin_src sh
export ORES_DB_PASSWORD
./ores.cli export ${log_args} ${db_args} ${format_args} --entity currencies --key 'AOA' --all-versions | jq .
#+END_SRC
...
[
  ...
  },
  {
    ...
    "currency_type": "",
    "modified_by": "ores",
    "valid_from": "2025-11-02 22:18:06",
    "valid_to": "2025-11-02 22:18:06"
  },
  {
    "iso_code": "AOA",
    "name": "Angolan kwanza",
    ...
    "currency_type": "",
    "modified_by": "ores",
    "valid_from": "2025-11-02 22:17:57",
    "valid_to": "2025-11-02 22:17:57"
  },
  {
    "iso_code": "AOA",
    "name": "Angolan kwanza",
    ...
    "currency_type": "",
    "modified_by": "ores",
    "valid_from": "2025-11-02 21:32:44",
    "valid_to": "2025-11-02 21:32:44"
  }
]
#+end_src
...
#+begin_src sh
export ORES_DB_PASSWORD
./ores.cli export ${log_args} ${db_args} ${format_args} --entity currencies --all-versions | jq .[:4]
#+END_SRC
