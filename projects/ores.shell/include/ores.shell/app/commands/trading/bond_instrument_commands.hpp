...
private:
    inline static std::string_view logger_name =
        "ores.shell.app.commands.trading.bond_instrument_commands";
...
public:
    ...
    /**
     * @brief Process a get bond instruments request.
     */
    static void process_get_bond_instruments(std::ostream& out,
                                             ores::nats::service::nats_client& session,
                                             pagination_context& pagination);
     ...
     */
    static void process_delete_bond_instrument(std::ostream& out,
                                               ores::nats::service::nats_client& session,
