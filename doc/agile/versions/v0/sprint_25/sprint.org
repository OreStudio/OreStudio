...
| [[id:0EFF1D57-4463-4BA4-ACE5-1B8FFCA33515][Clean up the ores.trading data model]] | BACKLOG | | | Repair the modelling defects found while building trade populations: types too wide for their meaning, integrity rules the schema does not declare, rules placed in procedures rather than in the schema, and shapes the model cannot express at all. |
