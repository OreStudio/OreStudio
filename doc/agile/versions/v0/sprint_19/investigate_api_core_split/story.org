...
| Now           | Eventing api/core split implemented; build verifying. |
| Waiting on    | Nothing.                               |
| Next          | Land the eventing split PR; close the story. |
...
| [[id:9800051F-8F04-4F2E-A143-4BFE2617816D][Split ores.eventing into api and core sub-components]] | STARTED | 2026-06-05 | | eventing links database PUBLIC and every api links eventing — the remaining transitive leak. api = domain + bus/registry; core = postgres_event_source. 18 consumers repointed. |
