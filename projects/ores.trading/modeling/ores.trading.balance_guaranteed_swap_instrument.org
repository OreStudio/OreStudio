...
#+description: Codegen entity model for the trading =balance_guaranteed_swap_instrument= table. Drives the C++ domain class, mapper, repository, service, generator, and SQL schema generation from a single literate source.
