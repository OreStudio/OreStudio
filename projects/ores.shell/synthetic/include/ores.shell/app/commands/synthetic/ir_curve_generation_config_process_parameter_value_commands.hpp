 ...
 */
#ifndef ORES_SHELL_APP_COMMANDS_IR_CURVE_GENERATION_CONFIG_PROCESS_PARAMETER_VALUE_COMMANDS_HPP
#define ORES_SHELL_APP_COMMANDS_IR_CURVE_GENERATION_CONFIG_PROCESS_PARAMETER_VALUE_COMMANDS_HPP
...
/**
 * @brief Every verb IR curve generation config process parameter values answer, as one command
 * each.
 *
...
public:
    /**
     * @brief Register the IR curve generation config process parameter values submenu.
     */
    ...
    /**
     * @brief add <id> <config_id> <parameter_definition_id> <parameter_value> <reason> <commentary>
     */
    ...
    /**
     * @brief set <id> <config_id> <parameter_definition_id> <parameter_value> <reason> <commentary>
     * [--version <n>]
     */
    ...
    /**
     * @brief put-many --count <n> <id> <config_id> <parameter_definition_id> <parameter_value>
     * <reason> <commentary>
     */
