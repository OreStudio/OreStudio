...
register_currency_pair_event_mapping(ev::service::postgres_event_source& event_source,
    ...
    event_source.register_entity_event_mapping<refdata::messaging::currency_pair_event>(
        "ores_refdata_currency_pairs");

    return event_bus.subscribe<refdata::messaging::currency_pair_event>(
        [&nats](const refdata::messaging::currency_pair_event& e) {
            ...
            ev::service::publish_entity_event(
                nats,
                ev::domain::event_subject<refdata::messaging::currency_pair_event>(e.action),
                e);
        });
}
