 ...
 *
 */
#ifndef ORES_COMMS_SHELL_APP_COMMANDS_RBAC_COMMANDS_HPP
#define ORES_COMMS_SHELL_APP_COMMANDS_RBAC_COMMANDS_HPP
...
private:
    inline static std::string_view logger_name =
        "ores.comms.shell.app.commands.rbac_commands";
