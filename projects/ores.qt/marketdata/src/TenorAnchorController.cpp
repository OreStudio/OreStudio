...
constexpr std::string_view anchor_event_name =
    eventing::domain::event_traits<marketdata::eventing::tenor_anchor_changed_event>::name;
}
...
void TenorAnchorController::onShowDetails(const marketdata::domain::tenor_anchor& anchor) {
...
void TenorAnchorController::onShowHistory(const marketdata::domain::tenor_anchor& anchor) {
...
void TenorAnchorController::showDetailWindow(const marketdata::domain::tenor_anchor& anchor) {
...
void TenorAnchorController::onOpenVersion(const marketdata::domain::tenor_anchor& anchor,
                                          int versionNumber) {
...
void TenorAnchorController::onRevertVersion(const marketdata::domain::tenor_anchor& anchor) {
