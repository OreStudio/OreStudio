...
register_fx_asian_forward_instrument_event_mapping(ev::service::postgres_event_source& event_source,
                                                   ev::service::event_bus& event_bus,
                                                   ores::nats::service::client& nats) {
    ev::service::registrar::register_mapping<
        trading::eventing::fx_asian_forward_instrument_changed_event>(
        event_source,
        "ores.trading.fx_asian_forward_instrument",
        "ores_trading_fx_asian_forward_instruments");

    return event_bus.subscribe<trading::eventing::fx_asian_forward_instrument_changed_event>(
        [&nats](const trading::eventing::fx_asian_forward_instrument_changed_event& e) {
            ev::service::publish_entity_event(
                nats,
                std::string(ev::domain::event_traits<
                            trading::eventing::fx_asian_forward_instrument_changed_event>::name),
