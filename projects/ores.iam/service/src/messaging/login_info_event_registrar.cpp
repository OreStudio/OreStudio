...
register_login_info_event_mapping(ev::service::postgres_event_source& event_source,
    ...
    event_source.register_entity_event_mapping<iam::messaging::login_info_event>(
        "ores_iam_login_info");

    return event_bus.subscribe<iam::messaging::login_info_event>(
        [&nats](const iam::messaging::login_info_event& e) {
            ...
            ev::service::publish_entity_event(
                nats, ev::domain::event_subject<iam::messaging::login_info_event>(e.action), e);
        });
}
