...
([[proj:projects/ores.sql/modeling/component_overview.org][=projects/ores.sql/modeling/component_overview.org=]]) documenting all
scripts in [[proj:projects/ores.sql][=projects/ores.sql/=]]. Organise into two subsections:
...
[[proj:doc/recipes/sql][=doc/recipes/sql/=]] via =[[id:UUID][Title]]=.
...
- [[proj:projects/ores.sql/modeling/component_overview.org][=projects/ores.sql/modeling/component_overview.org=]] has a =* Scripts= section.
...
- Related recipes in [[proj:doc/recipes/sql][=doc/recipes/sql/=]] are linked via Org-mode ID links.
