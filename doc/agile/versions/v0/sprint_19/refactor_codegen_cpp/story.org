...
| [[id:C8A4D7F1-2E6B-4C3A-8F9D-5B1E3C8D2F7A][Apply safe drift to refdata-cpp (pilot)]] | BACKLOG | | | Pilot. Add template flags refdata needs; update 12 refdata models; restore party_repository custom methods; build + test + zero-diff invariant. |
