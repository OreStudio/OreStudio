 ...
 *
 */
#ifndef ORES_TRADING_REPOSITORY_RPA_INSTRUMENT_MAPPER_HPP
#define ORES_TRADING_REPOSITORY_RPA_INSTRUMENT_MAPPER_HPP
...
/**
 * @brief Maps rpa_instrument domain entities to data storage layer and vice-versa.
 */
class rpa_instrument_mapper {
private:
