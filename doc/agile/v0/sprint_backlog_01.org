...
#+TBLNAME: summary
#+CAPTION: Clock summary at [2024-07-05 Fri 08:59]
| <75>                                    |         |       |      |       |
| Headline                                | Time    |       |      |     % |
|-----------------------------------------+---------+-------+------+-------|
| *Total time*                            | *35:51* |       |      | 100.0 |
|-----------------------------------------+---------+-------+------+-------|
| Stories                                 | 35:51   |       |      | 100.0 |
| Active                                  |         | 35:51 |      | 100.0 |
...
| Setup vcpkg and cmake                   |         |       | 1:21 |   3.8 |
| Setup github actions                    |         |       | 1:21 |   3.8 |
| Create and upload a package             |         |       | 3:28 |   9.7 |
| Create a basic project structure        |         |       | 2:10 |   6.0 |
| Add a Qt hello world                    |         |       | 3:08 |   8.7 |
| Add a splash screen to applciation      |         |       | 0:41 |   1.9 |
| Add basic site                          |         |       | 0:34 |   1.6 |
| Add modeling infrastructure             |         |       | 1:30 |   4.2 |
| Fix code syntax highlighting in site    |         |       | 0:10 |   0.5 |
| Merge index with readme                 |         |       | 0:42 |   2.0 |
| Add project objective to readme         |         |       | 2:24 |   6.7 |
| Add basic logging support               |         |       | 1:14 |   3.4 |
| Add nightly support with memcheck       |         |       | 3:21 |   9.3 |
| Clean up toolchains and presets         |         |       | 1:53 |   5.3 |
| Valgrind fails to run unit tests        |         |       | 1:05 |   3.0 |
| Add command line options support        |         |       | 1:47 |   5.0 |
| Add XML parsing support for currency    |         |       | 1:24 |   3.9 |
...
| Copy domain notes on core concepts      |         |       | 3:45 |  10.5 |
#+end:
