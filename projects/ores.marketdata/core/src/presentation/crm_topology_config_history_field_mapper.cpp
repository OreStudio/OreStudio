 ...
 *
 */
#include "ores.marketdata.core/presentation/crm_topology_config_history_field_mapper.hpp"
...
render_crm_topology_config_fields(const domain::crm_topology_config& v) {
    ...
    fields.push_back({.name = "Pivot Currency Code", .value = v.pivot_currency_code});
