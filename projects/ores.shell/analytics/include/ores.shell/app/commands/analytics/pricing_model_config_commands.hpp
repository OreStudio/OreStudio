 ...
 */
#ifndef ORES_SHELL_APP_COMMANDS_PRICING_MODEL_CONFIG_COMMANDS_HPP
#define ORES_SHELL_APP_COMMANDS_PRICING_MODEL_CONFIG_COMMANDS_HPP
...
/**
 * @brief Every verb pricing model configurations answer, as one command each.
 *
 ...
 */
class pricing_model_config_commands {
private:
    inline static std::string_view logger_name =
        "ores.shell.app.commands.analytics.pricing_model_config_commands";
...
public:
    /**
     * @brief Register the pricing model configurations submenu.
     */
    ...
    /**
     * @brief add <id> <name> <description> <config_variant> <reason> <commentary>
     */
