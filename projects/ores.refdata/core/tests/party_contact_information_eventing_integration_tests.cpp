...
#include "ores.refdata.api/eventing/party_contact_information_event.hpp"
...
TEST_CASE("write_party_contact_information_publishes_an_event", tags) {
    ...
    using event_type = ores::refdata::messaging::party_contact_information_event;
