 ...
 *
 */
#ifndef ORES_SHELL_APP_COMMANDS_EQUITY_VARIANCE_SWAP_INSTRUMENT_COMMANDS_HPP
#define ORES_SHELL_APP_COMMANDS_EQUITY_VARIANCE_SWAP_INSTRUMENT_COMMANDS_HPP
...
/**
 * @brief Manages commands related to equity variance swap instruments.
 */
class equity_variance_swap_instrument_commands {
private:
    inline static std::string_view logger_name =
        "ores.shell.app.commands.trading.equity_variance_swap_instrument_commands";
...
public:
    /**
     * @brief Register equity variance swap instrument related commands.
     */
    ...
    /**
     * @brief Process the equity variance swap instrument history request.
     */
