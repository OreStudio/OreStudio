...
register_currency_group_event_mapping(ev::service::postgres_event_source& event_source,
    ...
    event_source.register_entity_event_mapping<refdata::messaging::currency_group_event>(
        "ores_refdata_currency_groups");

    return event_bus.subscribe<refdata::messaging::currency_group_event>(
        [&nats](const refdata::messaging::currency_group_event& e) {
            ...
            ev::service::publish_entity_event(
                nats,
                ev::domain::event_subject<refdata::messaging::currency_group_event>(e.action),
                e);
        });
}
