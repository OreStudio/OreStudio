    ...
    connect(wizard, &TenantOnboardingWizard::onboardingCompleted,
        ...
        if (ctx_.status_bar)
            ctx_.status_bar->showMessage(
                QStringLiteral("Tenant '%1' onboarded successfully.").arg(tenantName));
    });
