...
| [[id:B8644955-8FF8-427C-8CDF-C0CD6B4EB064][SyntheticFxSpotChartWindow — live chart with backfill]] | STARTED | 2026-06-27 | | MDI chart window in ores.qt.mktdata: subscribes via fx_spot_subscription, backfills from marketdata.v1.observations.list, appends live ticks to a QLineSeries. Step 6 of the FX spot PoC. |
