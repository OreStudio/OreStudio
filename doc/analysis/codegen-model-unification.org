...
Which [[id:B079DA67-8408-4BD0-A93C-D108AC780872][facets]] fire is a function of the detected model type. The
...
model type. See the [[id:F556E446-EB91-4656-BEDC-15AE0F7B5ECD][commissioning process reference]]'s codegen output map
for the corresponding generation coverage per layer.
...
5. *Migrate content, one entity at a time.* For each of the 9 dual-file
   ...
   delete the table files. Use the [[id:F556E446-EB91-4656-BEDC-15AE0F7B5ECD][entity commissioning process
   reference]] (its =* Commissioning criteria by layer= section) to validate
   each migrated entity.
