 ...
 *
 */
#ifndef ORES_TRADING_REPOSITORY_INSTRUMENT_ENTITY_HPP
#define ORES_TRADING_REPOSITORY_INSTRUMENT_ENTITY_HPP
...
/**
 * @brief Represents an instrument in the database.
 */
struct instrument_entity {
    constexpr static const char* schema = "public";
    constexpr static const char* tablename = "ores_trading_instruments_tbl";
