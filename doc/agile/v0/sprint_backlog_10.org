...
#+CAPTION: Clock summary at [2026-01-23 Fri 00:53], for Friday, January 23, 2026.
|      | <75>                                                |        |      |      |       |
| Tags | Headline                                            | Time   |      |      |     % |
|------+-----------------------------------------------------+--------+------+------+-------|
...
|      | Stories                                             | 0:51   |      |      | 100.0 |
|      | Active                                              |        | 0:51 |      | 100.0 |
| code | Image cache not reloading on new datasets           |        |      | 0:20 |  39.2 |
| code | Incremental image cache loading with modified_since |        |      | 0:31 |  60.8 |
#+end:

#+begin: clocktable :maxlevel 3 :scope subtree :tags t :indent nil :emphasize nil :scope file :narrow 75 :formula %
#+TBLNAME: sprint_summary
#+CAPTION: Clock summary at [2026-01-23 Fri 00:53]
|       | <75>                                                |         |       |      |       |
| Tags  | Headline                                            | Time    |       |      |     % |
|-------+-----------------------------------------------------+---------+-------+------+-------|
|       | *Total time*                                        | *22:36* |       |      | 100.0 |
|-------+-----------------------------------------------------+---------+-------+------+-------|
|       | Stories                                             | 22:36   |       |      | 100.0 |
|       | Active                                              |         | 22:36 |      | 100.0 |
| agile | Sprint and product backlog refinement               |         |       | 1:04 |   4.7 |
| infra | OCR scan notebooks for this sprint                  |         |       | 5:00 |  22.1 |
| code  | Create a simple code generator                      |         |       | 7:38 |  33.8 |
| code  | Party related schemes                               |         |       | 5:20 |  23.6 |
| code  | Image cache not reloading on new datasets           |         |       | 1:43 |   7.6 |
| code  | Add code generation support for domain types SQL    |         |       | 1:20 |   5.9 |
| code  | Incremental image cache loading with modified_since |         |       | 0:31 |   2.3 |
#+end:
...
*** STARTED Incremental image cache loading with modified_since        :code:
    :LOGBOOK:
