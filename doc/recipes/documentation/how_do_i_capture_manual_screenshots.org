...
removed. No replacement exists yet: =ores.typescript= holds UI metadata
only and ships no runnable screen. Steps 1, 4 and 5 below are unchanged
and still correct for a capture taken by hand; steps 2 and 3 wait on a
