...
create or replace function .refdata_regulatory_corporate_sectors_notify_fn()
returns trigger as $$
declare
...
after insert or update or delete on .refdata_regulatory_corporate_sectors_tbl
for each row execute function .refdata_regulatory_corporate_sectors_notify_fn();
