 ...
 *
 */
#ifndef ORES_TRADING_CORE_REPOSITORY_FRA_INSTRUMENT_REPOSITORY_HPP
#define ORES_TRADING_CORE_REPOSITORY_FRA_INSTRUMENT_REPOSITORY_HPP
...
public:
    ...
    /**
     * @brief Writes FRA instruments to database.
     */
    /**@{*/
    void write(context ctx, const domain::fra_instrument& v);
    void write(context ctx, const std::vector<domain::fra_instrument>& v);
    /**@}*/

    /**
     * @brief Reads latest FRA instruments, possibly filtered by primary key.
     */
    /**@{*/
     ...
     */
    std::uint32_t get_total_fra_instrument_count(context ctx);
