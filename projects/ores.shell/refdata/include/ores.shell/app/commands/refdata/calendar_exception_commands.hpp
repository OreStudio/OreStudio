 ...
 */
#ifndef ORES_SHELL_APP_COMMANDS_CALENDAR_EXCEPTION_COMMANDS_HPP
#define ORES_SHELL_APP_COMMANDS_CALENDAR_EXCEPTION_COMMANDS_HPP
...
/**
 * @brief Every verb calendar exceptions answer, as one command each.
 *
 ...
 */
class calendar_exception_commands {
private:
    inline static std::string_view logger_name =
        "ores.shell.app.commands.refdata.calendar_exception_commands";
...
public:
    /**
     * @brief Register the calendar exceptions submenu.
     */
    ...
    /**
     * @brief set <id> <calendar_code> <exception_date> <is_business_day> <description> <reason>
    ...
    /**
     * @brief put-many --count <n> <id> <calendar_code> <exception_date> <is_business_day>
