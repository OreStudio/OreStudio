 ...
 */
#ifndef ORES_SHELL_APP_COMMANDS_CALENDAR_EVENT_COMMANDS_HPP
#define ORES_SHELL_APP_COMMANDS_CALENDAR_EVENT_COMMANDS_HPP
...
/**
 * @brief Every verb calendar events answer, as one command each.
 *
 ...
 */
class calendar_event_commands {
private:
    inline static std::string_view logger_name =
        "ores.shell.app.commands.refdata.calendar_event_commands";
...
public:
    /**
     * @brief Register the calendar events submenu.
     */
    ...
    /**
     * @brief set <id> <calendar_code> <event_date> <diary_entry_type> <name> <description> <source>
    ...
    /**
     * @brief put-many --count <n> <id> <calendar_code> <event_date> <diary_entry_type> <name>
