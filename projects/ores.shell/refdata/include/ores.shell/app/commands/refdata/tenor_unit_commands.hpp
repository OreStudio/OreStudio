 ...
 */
#ifndef ORES_SHELL_APP_COMMANDS_TENOR_UNIT_COMMANDS_HPP
#define ORES_SHELL_APP_COMMANDS_TENOR_UNIT_COMMANDS_HPP
...
/**
 * @brief Every verb tenor units answer, as one command each.
 *
 ...
 */
class tenor_unit_commands {
private:
    inline static std::string_view logger_name =
        "ores.shell.app.commands.refdata.tenor_unit_commands";
...
public:
    /**
     * @brief Register the tenor units submenu.
     */
