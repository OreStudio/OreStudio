 ...
 */
/**
 * How the BFF reaches the ledger_feed_type service.
 *
 ...
 */
import { subjects } from '@ores/wire-protocol/generated/refdata/protocol/ledger_feed_type_protocol';
...
export const ledgerFeedTypeRoute: EntityRouteDescriptor = {
  ...
  subjects: {
    ...
    save: subjects.put_ledger_feed_type_request,
    remove: subjects.delete_ledger_feed_type_request,
