...
#+CAPTION: Clock summary at [2025-10-21 Tue 01:22], for Tuesday, October 21, 2025.
|      | <75>                   |        |      |      |       |
| Tags | Headline               | Time   |      |      |     % |
|------+------------------------+--------+------+------+-------|
...
|      | Stories                | 1:21   |      |      | 100.0 |
|      | Active                 |        | 1:21 |      | 100.0 |
| code | Add messaging for risk |        |      | 0:35 |  43.2 |
| code | Clean up repl code     |        |      | 0:46 |  56.8 |
#+end:

#+begin: clocktable :maxlevel 3 :scope subtree :tags t :indent nil :emphasize nil :scope file :narrow 75 :formula %
#+TBLNAME: sprint_summary
#+CAPTION: Clock summary at [2025-10-21 Tue 01:22]
|          | <75>                                               |         |       |      |       |
| Tags     | Headline                                           | Time    |       |      |     % |
|----------+----------------------------------------------------+---------+-------+------+-------|
...
|          | Stories                                            | 78:40   |       |      | 100.0 |
|          | Active                                             |         | 78:40 |      | 100.0 |
| agile    | Sprint and product backlog refinement              |         |       | 2:36 |   3.3 |
| infra    | Fix broken builds                                  |         |       | 0:36 |   0.8 |
| code     | Create a containing structure for data             |         |       | 0:35 |   0.7 |
| code     | Add temporal support to currencies                 |         |       | 2:59 |   3.8 |
| code     | Add command to dump currencies                     |         |       | 4:18 |   5.5 |
| code     | Refactor code for currencies                       |         |       | 3:52 |   4.9 |
| code     | Restore qt setup                                   |         |       | 2:20 |   3.0 |
| code     | Add gemini action                                  |         |       | 0:05 |   0.1 |
| code     | Remove ImGui support                               |         |       | 0:08 |   0.2 |
| code     | Create a GRPC based service                        |         |       | 2:09 |   2.7 |
| code     | Implement a 0MQ based RPC service and client       |         |       | 3:55 |   5.0 |
...
| code     | Implement a cobalt based server and client         |         |       | 2:53 |   3.7 |
| code     | Add serialisation support for reflect-cpp          |         |       | 3:07 |   4.0 |
| analysis | White-boarding for new architecture                |         |       | 1:52 |   2.4 |
| code     | Use sqlgen for postgres                            |         |       | 7:23 |   9.4 |
| code     | Refactor cli to follow new project structure       |         |       | 4:47 |   6.1 |
| code     | Add tests to cli parser                            |         |       | 0:35 |   0.7 |
| code     | Add logging support for tests                      |         |       | 2:21 |   3.0 |
| code     | Replace XML parsing with reflect cpp               |         |       | 2:56 |   3.7 |
| code     | Fix windows and osx builds                         |         |       | 0:27 |   0.6 |
| code     | Completions in emacs org mode are incorrect        |         |       | 1:02 |   1.3 |
| analysis | Investigate bitemporal support from Postgres 18    |         |       | 1:47 |   2.3 |
| code     | Refactor core into risk                            |         |       | 4:10 |   5.3 |
| code     | Windows builds have cmake errors                   |         |       | 0:14 |   0.3 |
| infra    | Add suppression to valgrind errors                 |         |       | 0:38 |   0.8 |
| code     | Create a =comms= library                           |         |       | 8:05 |  10.3 |
| code     | Add messaging for risk                             |         |       | 8:00 |  10.2 |
| code     | Clean up repl code                                 |         |       | 0:46 |   1.0 |
...
| infra    | Fix broken builds                                  |         |       | 0:38 |   0.8 |
