 ...
 *
 */
#ifndef ORES_TRADING_CORE_PRESENTATION_INSTRUMENT_SCHEDULE_HISTORY_FIELD_MAPPER_HPP
#define ORES_TRADING_CORE_PRESENTATION_INSTRUMENT_SCHEDULE_HISTORY_FIELD_MAPPER_HPP
...
/**
 * @brief Renders a instrument_schedule to an ordered field list for
