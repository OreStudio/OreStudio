...
private slots:
    ...
    void onShowHistory(const dq::domain::change_reason& reason);
...
private:
     ...
     * existing per-entity dq::messaging::get_change_reason_history_request/
     * dq::messaging::get_change_reason_history_response, unrelated to the generic
