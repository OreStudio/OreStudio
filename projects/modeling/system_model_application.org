...
are both clients of the same domain services over [[id:C9C24C99-F16C-45BE-A262-1C0F4502765E][ores.nats]]; the compute
...
[[id:C9C24C99-F16C-45BE-A262-1C0F4502765E][ores.nats]] client that drives domain services without a GUI.
...
served as a web application using the same domain [[id:C9C24C99-F16C-45BE-A262-1C0F4502765E][ores.nats]] services.
...
Compute engine — receives ORE Engine computation requests via
[[id:C9C24C99-F16C-45BE-A262-1C0F4502765E][ores.nats]] (ores.compute.service), executes them by spawning ORE child
processes (ores.compute.wrapper), and publishes results.
ores.compute.core holds the domain model for run configurations,
chunking, and environment lifecycle.
