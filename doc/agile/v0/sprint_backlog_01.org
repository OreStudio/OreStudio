...
#+CAPTION: Clock summary at [2024-07-21 Sun 22:34]
|       | <75>                                               |         |       |      |       |
| Tags  | Headline                                           | Time    |       |      |     % |
|-------+----------------------------------------------------+---------+-------+------+-------|
|       | *Total time*                                       | *75:27* |       |      | 100.0 |
|-------+----------------------------------------------------+---------+-------+------+-------|
|       | Stories                                            | 75:27   |       |      | 100.0 |
|       | Active                                             |         | 75:27 |      | 100.0 |
| agile | Sprint and product backlog refinement              |         |       | 3:26 |   4.6 |
...
| code  | Add a Qt hello world                               |         |       | 3:08 |   4.2 |
...
| code  | Add XML parsing support for currency               |         |       | 6:32 |   8.7 |
