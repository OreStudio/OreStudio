 ...
 */
#ifndef ORES_REFDATA_CORE_REPOSITORY_FRA_CONVENTION_REPOSITORY_HPP
#define ORES_REFDATA_CORE_REPOSITORY_FRA_CONVENTION_REPOSITORY_HPP
 ...
 */
class ORES_REFDATA_CORE_EXPORT fra_convention_repository {
private:
...
public:
    ...
    /**
     * @brief Writes FRA conventions to database.
     *
    ...
    /**
     * @brief Writes a FRA convention, honouring the claim it states.
     *
    ...
    /**
     * @brief Writes a set of FRA conventions, each honouring its own
    ...
    /**
     * @brief Reads latest FRA conventions, possibly filtered by primary key.
     */
    /**@{*/
     ...
     */
    std::vector<domain::fra_convention> read_all(context ctx, const std::string& id);

    /**
     * @brief Reads a single FRA convention as it stood at a specific
     ...
     */
    std::uint32_t get_total_fra_convention_count(context ctx);

    /**
     * @brief Deletes a FRA convention by closing its temporal validity.
     */
    ...
    /**
     * @brief Removes a FRA convention, refusing a row that moved on.
     *
    ...
    /**
     * @brief Deletes FRA conventions by closing their temporal validity.
     */
...
private:
     ...
     */
    ores::utility::domain::precondition replace_claim(context ctx, const domain::fra_convention& v);
     ...
     */
    domain::fra_convention apply_claim(context ctx,
                                       const domain::fra_convention& v,
                                       const ores::utility::domain::precondition& claim);
};
