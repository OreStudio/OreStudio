...
register_calendar_rule_event_mapping(ev::service::postgres_event_source& event_source,
    ...
    event_source.register_entity_event_mapping<refdata::messaging::calendar_rule_event>(
        "ores_refdata_calendar_rules");

    return event_bus.subscribe<refdata::messaging::calendar_rule_event>(
        [&nats](const refdata::messaging::calendar_rule_event& e) {
            ...
            ev::service::publish_entity_event(
                nats,
                ev::domain::event_subject<refdata::messaging::calendar_rule_event>(e.action),
                e);
        });
}
