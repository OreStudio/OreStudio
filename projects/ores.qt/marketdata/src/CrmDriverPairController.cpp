...
constexpr std::string_view pair_event_name =
    eventing::domain::event_traits<marketdata::eventing::crm_driver_pair_changed_event>::name;
}
...
void CrmDriverPairController::onShowDetails(const marketdata::domain::crm_driver_pair& pair) {
...
void CrmDriverPairController::onShowHistory(const marketdata::domain::crm_driver_pair& pair) {
...
void CrmDriverPairController::showDetailWindow(const marketdata::domain::crm_driver_pair& pair) {
...
void CrmDriverPairController::showHistoryWindow(const marketdata::domain::crm_driver_pair& pair) {
    ...
    auto* historyDialog =
        new CrmDriverPairHistoryDialog(pair.id, code, clientManager_, mainWindow_);

    connect(historyDialog,
            &CrmDriverPairHistoryDialog::statusChanged,
            this,
    ...
    connect(historyDialog,
            &CrmDriverPairHistoryDialog::errorOccurred,
            this,
            [self = QPointer<CrmDriverPairController>(this)](const QString& message) {
                if (!self)
                    return;
    ...
    connect(historyDialog,
            &CrmDriverPairHistoryDialog::revertVersionRequested,
            this,
            &CrmDriverPairController::onRevertVersion);
    connect(historyDialog,
            &CrmDriverPairHistoryDialog::openVersionRequested,
            this,
            &CrmDriverPairController::onOpenVersion);
...
void CrmDriverPairController::onOpenVersion(const marketdata::domain::crm_driver_pair& pair,
                                            int versionNumber) {
...
void CrmDriverPairController::onRevertVersion(const marketdata::domain::crm_driver_pair& pair) {
