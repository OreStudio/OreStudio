...
#+description: Scaffold a v2 knowledge doc, fill in the content, and wire it into the knowledge index.
#+type: runbook
#+version: 2
#+level: cross
...
1. /Scaffold./ Use [[id:3153AA4B-23D4-4111-9710-5A4971102EDC][How do I create a new v2 doc?]]§"New knowledge document": =generate_v2_doc.sh --type knowledge=.
