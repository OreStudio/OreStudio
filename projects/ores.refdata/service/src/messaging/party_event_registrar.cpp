...
register_party_event_mapping(ev::service::postgres_event_source& event_source,
    ...
    event_source.register_entity_event_mapping<refdata::messaging::party_event>(
        "ores_refdata_parties");

    return event_bus.subscribe<refdata::messaging::party_event>(
        [&nats](const refdata::messaging::party_event& e) {
            ...
            ev::service::publish_entity_event(
                nats, ev::domain::event_subject<refdata::messaging::party_event>(e.action), e);
        });
}
