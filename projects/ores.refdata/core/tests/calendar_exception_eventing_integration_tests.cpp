...
TEST_CASE("write_calendar_exception_publishes_an_event", tags) {
    ...
    using event_type = ores::refdata::messaging::calendar_exception_event;
    ...
    event_source.register_entity_event_mapping<event_type>("ores_refdata_calendar_exceptions");
