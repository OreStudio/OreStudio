 ...
 *
 */
#ifndef ORES_TRADING_CORE_REPOSITORY_FX_BARRIER_OPTION_INSTRUMENT_ENTITY_HPP
#define ORES_TRADING_CORE_REPOSITORY_FX_BARRIER_OPTION_INSTRUMENT_ENTITY_HPP
...
/**
 * @brief Represents a fx barrier option instrument in the database.
 */
