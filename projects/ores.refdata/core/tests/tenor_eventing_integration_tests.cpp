...
#include "ores.refdata.api/eventing/tenor_event.hpp"
...
TEST_CASE("write_tenor_publishes_an_event", tags) {
    ...
    using event_type = ores::refdata::messaging::tenor_event;
    ...
    event_source.register_entity_event_mapping<event_type>("ores_refdata_tenors");
