 ...
 *
 */
#ifndef ORES_TRADING_CORE_PRESENTATION_TRADE_ENVELOPE_HISTORY_FIELD_MAPPER_HPP
#define ORES_TRADING_CORE_PRESENTATION_TRADE_ENVELOPE_HISTORY_FIELD_MAPPER_HPP
...
/**
 * @brief Renders a trade_envelope to an ordered field list for
