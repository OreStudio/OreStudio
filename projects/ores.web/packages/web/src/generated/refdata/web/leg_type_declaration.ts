 ...
 */
/**
 * Where the leg_type screens live and what they can do.
 *
 ...
 */
import { legTypeMeta } from '../ui/leg_type_ui.js';
import type { EntityDescriptor } from '../../../entity/descriptor.js';

export const legTypeDescriptor: EntityDescriptor = {
    component: 'refdata',
    entity: 'leg_type',
    meta: legTypeMeta,
    routeSegment: 'leg-type',
    apiBase: '/api/types',
    keyParam: 'id',
    icon: 'tag',
    capabilities: {
