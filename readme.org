...
ORE Studio is a graphical wrapper around the [[id:1cbdea40-5fae-4f04-bd21-2bb29172b5aa][Open Source Risk Engine]] (ORE),
which itself builds on [[id:0412444a-0a4c-4611-887c-09353a3cb253][QuantLib]]. Please note that this open source project
...
Clone with submodules, install the build dependencies, and initialise
the database:
...
Every CMake command — configuring with a preset, building, running the
test suite, deploying the site, deploying skills, generating PlantUML
diagrams — lives as an executable recipe under
=doc/recipes/cmake/=. Start from the [[id:654d4a70-e63d-4c18-b5a5-886066e36314][CMake Runner skill]], which
indexes the seven recipes plus the [[id:5aae6900-8488-4e22-9f31-a1b9d5320efb][CMake setup]] knowledge document
(preset menu, output directory layout, parallel-build configuration,
test-logging knobs).

The fastest path on Linux:
