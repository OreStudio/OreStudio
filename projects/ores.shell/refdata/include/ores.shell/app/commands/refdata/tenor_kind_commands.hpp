 ...
 */
#ifndef ORES_SHELL_APP_COMMANDS_TENOR_KIND_COMMANDS_HPP
#define ORES_SHELL_APP_COMMANDS_TENOR_KIND_COMMANDS_HPP
...
/**
 * @brief Every verb tenor kinds answer, as one command each.
 *
 ...
 */
class tenor_kind_commands {
private:
    inline static std::string_view logger_name =
        "ores.shell.app.commands.refdata.tenor_kind_commands";
...
public:
    /**
     * @brief Register the tenor kinds submenu.
     */
