...
:END:
#+title: Task: Add compass-code-review-comments skill
...
#+owner: marco
#+branch: feature/compass-code-review-comments
#+pr: 1951
#+blocked_on:
#+blocked_since:
#+created: 2026-08-11
...
- Skill doc exists at doc/llm/skills/compass-code-review-comments/SKILL.org with the comment rules, a reference file, and worked examples.
...
=doc/llm/skills/compass-code-review-comments/SKILL.org=, following the
=compass-doc-review-ste100= pattern: thin index in the skill, rule set in a
...
| PR | Title |
|----+-------|
| [[https://github.com/OreStudio/OreStudio/pull/1951][#1951]] | [docs] Add compass-code-review-comments skill |
...
Branch =feature/compass-code-review-comments= commits:

- =8ecd0199e= [docs] Add compass-code-review-comments skill
- =8bf47b67e= [agile] Add task for compass-code-review-comments skill to Documentation improvements
- =bb22c5f67= [agile] Record PR #1951 on task
- =96e699430= [docs] Fix compass-code-review-comments skill review findings
- =9a736eae0= [docs] Add how_do_i_clean_code_comments recipe
- =80eb28ecc= [docs] Regenerate skills catalogue
- =3756c4f01= [agile] Record PR #1951 review round on task and story
- =5eb71cf47= [docs] Fix recipe filetags for site validation

Status at close: Merged via PR #1951.
