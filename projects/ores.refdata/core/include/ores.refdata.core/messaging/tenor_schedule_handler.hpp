 ...
 *
 */
#ifndef ORES_REFDATA_CORE_MESSAGING_TENOR_SCHEDULE_HANDLER_HPP
#define ORES_REFDATA_CORE_MESSAGING_TENOR_SCHEDULE_HANDLER_HPP
...
namespace {
inline auto& tenor_schedule_handler_lg() {
    static auto instance =
        ores::logging::make_logger("ores.refdata.messaging.tenor_schedule_handler");
    return instance;
}
} // namespace
...
/**
 * @brief NATS message handler for tenor schedule operations.
 */
class tenor_schedule_handler {
public:
    tenor_schedule_handler(ores::nats::service::client& nats,
