...
#include "ores.refdata.api/eventing/asset_class_code_event.hpp"
...
TEST_CASE("write_asset_class_code_publishes_an_event", tags) {
    ...
    using event_type = ores::refdata::messaging::asset_class_code_event;
    ...
    event_source.register_entity_event_mapping<event_type>("ores_refdata_asset_class_codes");
