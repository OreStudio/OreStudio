 ...
 *
 */
#ifndef ORES_MARKETDATA_API_GENERATORS_MARKET_FIXING_GENERATOR_HPP
#define ORES_MARKETDATA_API_GENERATORS_MARKET_FIXING_GENERATOR_HPP
 ...
 */
ORES_MARKETDATA_API_EXPORT domain::market_fixing generate_synthetic_market_fixing(
