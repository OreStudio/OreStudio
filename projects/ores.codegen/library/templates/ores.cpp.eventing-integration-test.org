...
|-----------+-------------|
| [[id:5365DC63-A9BF-4C19-9822-C5BA9B6F9A23][ores.cpp.eventing-integration-test.nats_integration_test]] | Write an entity via its repository, assert the resulting NATS entity-changed notification is observed. =eventing-integration-test= profile. |
