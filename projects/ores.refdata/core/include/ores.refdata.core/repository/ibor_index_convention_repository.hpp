 ...
 */
class ORES_REFDATA_CORE_EXPORT ibor_index_convention_repository {
private:
...
public:
    ...
    /**
     * @brief Writes a IBOR index convention, honouring the claim it states.
     *
    ...
    /**
     * @brief Writes a set of IBOR index conventions, each honouring its own
    ...
    /**
     * @brief Removes a IBOR index convention, refusing a row that moved on.
     *
...
private:
     ...
     */
    domain::ibor_index_convention apply_claim(context ctx,
                                              const domain::ibor_index_convention& v,
                                              const ores::utility::domain::precondition& claim);
};
