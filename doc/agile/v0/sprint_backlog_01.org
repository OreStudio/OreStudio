...
#+CAPTION: Clock summary at [2024-06-28 Fri 08:16]
| <75>                                    |         |       |      |       |
| Headline                                | Time    |       |      |     % |
|-----------------------------------------+---------+-------+------+-------|
| *Total time*                            | *18:38* |       |      | 100.0 |
|-----------------------------------------+---------+-------+------+-------|
| Stories                                 | 18:38   |       |      | 100.0 |
| Active                                  |         | 18:38 |      | 100.0 |
| Sprint and product backlog refinement   |         |       | 0:47 |   4.2 |
| Create a basic git hub repository       |         |       | 0:35 |   3.1 |
| Setup a discord channel for the project |         |       | 0:14 |   1.3 |
| Setup vcpkg and cmake                   |         |       | 1:21 |   7.2 |
| Setup github actions                    |         |       | 1:21 |   7.2 |
| Create and upload a package             |         |       | 3:28 |  18.6 |
| Create a basic project structure        |         |       | 2:10 |  11.6 |
| Add a Qt hello world                    |         |       | 3:08 |  16.8 |
| Add a splash screen to applciation      |         |       | 0:41 |   3.7 |
| Add nightly support with memcheck       |         |       | 1:40 |   8.9 |
| Add XML parsing support for currency    |         |       | 1:24 |   7.5 |
| Create a containing structure for data  |         |       | 0:28 |   2.5 |
| Add basic widgets to display currencies |         |       | 0:26 |   2.3 |
| Add basic logging support               |         |       | 0:44 |   3.9 |
| Add basic site                          |         |       | 0:11 |   1.0 |
#+end:
