...
save_contact_type_request
save_contact_type_request::from(domain::contact_type type) {
    return save_contact_type_request{std::vector<domain::contact_type>{std::move(type)}};
}

save_contact_type_request
save_contact_type_request::from(std::vector<domain::contact_type> types) {
    return save_contact_type_request{std::move(types)};
}
