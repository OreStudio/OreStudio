...
domain::counterparty_contact_information counterparty_contact_information_repository::apply_claim(
    context ctx,
...
void counterparty_contact_information_repository::write(
    ...
    execute_write_query(ctx,
                        counterparty_contact_information_mapper::map(t),
                        lg(),
...
void counterparty_contact_information_repository::write(
    ...
    execute_write_query(ctx,
                        counterparty_contact_information_mapper::map(batch),
                        lg(),
...
std::vector<domain::counterparty_contact_information>
counterparty_contact_information_repository::read_latest_by_code(context ctx,
                                                                 const std::string& counterparty_id,
                                                                 const std::string& contact_type) {
    BOOST_LOG_SEV(lg(), debug)
        << "Reading latest counterparty contact information by counterparty_id/contact_type: "
...
counterparty_contact_information_repository::read_any_by_contact_type(
    ...
    BOOST_LOG_SEV(lg(), debug) << "Reading any counterparty contact information by contact_type: "
                               << contact_type;
    const auto tid = ctx.tenant_id().to_string();
    const auto query = sqlgen::read<std::vector<counterparty_contact_information_entity>> |
    ...
    return execute_read_query<counterparty_contact_information_entity,
        ...
        [](const auto& entities) { return counterparty_contact_information_mapper::map(entities); },
        lg(),
        "Reading any counterparty contact information by contact_type.");
}
...
std::vector<domain::counterparty_contact_information>
counterparty_contact_information_repository::read_by_counterparty_id_as_of(
    context ctx,
    const std::string& counterparty_id,
    std::chrono::system_clock::time_point valid_from_bound,
    std::chrono::system_clock::time_point valid_to_bound) {
    BOOST_LOG_SEV(lg(), debug)
        << "Reading counterparty contact informations as of window. counterparty_id: "
        << counterparty_id;
...
counterparty_contact_information_repository::remove_status
counterparty_contact_information_repository::remove(context ctx,
                                                    const std::string& id,
...
counterparty_contact_information_repository::read_latest(context ctx,
    ...
    auto result = execute_read_query<counterparty_contact_information_entity,
                                     domain::counterparty_contact_information>(
        ctx,
        query,
        [](const auto& entities) { return counterparty_contact_information_mapper::map(entities); },
        lg(),
        "Reading latest counterparty contact informations by ids.");
    return result;
}
