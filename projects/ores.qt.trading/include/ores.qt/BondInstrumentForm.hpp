 ...
 *
 */
#ifndef ORES_QT_BOND_INSTRUMENT_FORM_HPP
#define ORES_QT_BOND_INSTRUMENT_FORM_HPP
...
private:
    inline static std::string_view logger_name = "ores.qt.bond_instrument_form";
...
public:
    explicit BondInstrumentForm(QWidget* parent = nullptr);
    ~BondInstrumentForm() override;
