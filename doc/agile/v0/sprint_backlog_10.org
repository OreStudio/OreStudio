...
#+CAPTION: Clock summary at [2026-01-24 Sat 23:45], for Saturday, January 24, 2026.
|      | <75>                                         |         |       |      |       |
| Tags | Headline                                     | Time    |       |      |     % |
|------+----------------------------------------------+---------+-------+------+-------|
...
|      | Stories                                      | 11:11   |       |      | 100.0 |
|      | Active                                       |         | 11:11 |      | 100.0 |
| code | Tidy-up external data storage                |         |       | 1:04 |   9.5 |
| code | Coding schemes are in production tables      |         |       | 1:39 |  14.8 |
| code | Refactor SQL directories                     |         |       | 3:24 |  30.4 |
| code | Code-generate ER diagram                     |         |       | 3:01 |  27.0 |
| code | Add "words" to icons                         |         |       | 0:28 |   4.2 |
| code | Add mapping artefact to population functions |         |       | 1:35 |  14.2 |
#+end:

#+begin: clocktable :maxlevel 3 :scope subtree :tags t :indent nil :emphasize nil :scope file :narrow 75 :formula %
#+TBLNAME: sprint_summary
#+CAPTION: Clock summary at [2026-01-24 Sat 23:45]
|       | <75>                                                |         |       |      |       |
| Tags  | Headline                                            | Time    |       |      |     % |
|-------+-----------------------------------------------------+---------+-------+------+-------|
...
|       | Stories                                             | 40:48   |       |      | 100.0 |
|       | Active                                              |         | 40:48 |      | 100.0 |
| agile | Sprint and product backlog refinement               |         |       | 1:04 |   2.6 |
| infra | OCR scan notebooks for this sprint                  |         |       | 6:20 |  15.5 |
| code  | Create a simple code generator                      |         |       | 7:38 |  18.7 |
| code  | Party related schemes                               |         |       | 5:20 |  13.1 |
| code  | Image cache not reloading on new datasets           |         |       | 1:43 |   4.2 |
| code  | Create a script to download and split GLEIF data    |         |       | 0:25 |   1.0 |
| code  | Incremental image cache loading with modified_since |         |       | 0:31 |   1.3 |
| code  | Fix issues with misspell action                     |         |       | 2:47 |   6.8 |
| code  | Tidy-up external data storage                       |         |       | 3:33 |   8.7 |
| code  | Coding schemes are in production tables             |         |       | 1:39 |   4.0 |
| code  | Refactor SQL directories                            |         |       | 3:24 |   8.3 |
| code  | Code-generate ER diagram                            |         |       | 3:01 |   7.4 |
| code  | Add code generation support for domain types SQL    |         |       | 1:20 |   3.3 |
| code  | Add "words" to icons                                |         |       | 0:28 |   1.1 |
| code  | Add mapping artefact to population functions        |         |       | 1:35 |   3.9 |
#+end:
...
*** STARTED Add "words" to icons                                       :code:
    :LOGBOOK:
...
*** Add FPML export and import                                         :code:
