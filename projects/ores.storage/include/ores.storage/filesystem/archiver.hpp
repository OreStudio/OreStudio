...
public:
     ...
     *
     * Recursively packs all regular files in @p src_dir into a gzipped tar
     * archive at @p dest_archive. Entry paths stored in the archive are
     * relative to @p src_dir.
     *
     ...
     *
     * Extracts all entries from @p archive, rebasing them under @p dest_dir.
     *
     * @throws std::runtime_error on failure.
     */
