 ...
 */
/**
 * Where the counterparty_identifier screens live and what they can do.
 *
 ...
 */
import { counterpartyIdentifierMeta } from '../ui/counterparty_identifier_ui.js';
import type { EntityDescriptor } from '../../../entity/descriptor.js';

export const counterpartyIdentifierDescriptor: EntityDescriptor = {
    component: 'refdata',
    entity: 'counterparty_identifier',
    meta: counterpartyIdentifierMeta,
    routeSegment: 'counterparty-identifier',
    apiBase: '/api/counterparty_identifiers',
    keyParam: 'id',
    icon: 'keyMultiple',
    capabilities: {
        create: true,
