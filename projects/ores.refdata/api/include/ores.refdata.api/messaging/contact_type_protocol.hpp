...
struct save_contact_type_request {
    ...
    static constexpr std::string_view nats_subject = "refdata.v1.contact_types.save";
...
struct get_contact_type_history_request {
    ...
    static constexpr std::string_view nats_subject = "refdata.v1.contact_types.history";
    std::string code;
};
