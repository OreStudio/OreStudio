 ...
 *   SELECT * FROM ores_dq_regulatory_corporate_sector_preview_fn(dataset_id);
 *
 *   -- Publish to production
 *   SELECT * FROM ores_dq_regulatory_corporate_sectors_publish_fn(dataset_id, 'upsert');
 */
 ...
 */
create or replace function ores_dq_regulatory_corporate_sector_preview_fn(p_dataset_id uuid)
returns table (
    action text,
    code text,
 ...
 */
create or replace function ores_dq_regulatory_corporate_sectors_publish_fn(
    p_dataset_id uuid,
