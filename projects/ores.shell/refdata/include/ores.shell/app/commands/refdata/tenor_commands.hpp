 ...
 */
#ifndef ORES_SHELL_APP_COMMANDS_TENOR_COMMANDS_HPP
#define ORES_SHELL_APP_COMMANDS_TENOR_COMMANDS_HPP
...
/**
 * @brief Every verb tenors answer, as one command each.
 *
 ...
 */
class tenor_commands {
private:
    inline static std::string_view logger_name = "ores.shell.app.commands.refdata.tenor_commands";
...
public:
    /**
     * @brief Register the tenors submenu.
     */
    ...
    /**
     * @brief add <code> <display_name> <description> <sort_order> <kind> <unit> <multiplier>
     * <reason> <commentary>
     */
    ...
    /**
     * @brief set <code> <display_name> <description> <sort_order> <kind> <unit> <multiplier>
    ...
    /**
     * @brief put-many --count <n> <code> <display_name> <description> <sort_order> <kind> <unit>
