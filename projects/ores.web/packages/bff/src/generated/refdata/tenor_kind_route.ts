 ...
 */
/**
 * How the BFF reaches the tenor_kind service.
 *
 ...
 */
import { subjects } from '@ores/wire-protocol/generated/refdata/protocol/tenor_kind_protocol';
...
export const tenorKindRoute: EntityRouteDescriptor = {
  ...
  subjects: {
    ...
    save: subjects.put_tenor_kind_request,
    remove: subjects.delete_tenor_kind_request,
