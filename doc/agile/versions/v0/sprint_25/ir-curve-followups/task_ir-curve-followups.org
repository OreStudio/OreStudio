...
| PR | Title |
|----+-------|
| [[https://github.com/OreStudio/OreStudio/pull/1939][#1939]] | [ores.marketdata] Extend index_family enum to the 22 SQL CHECK families |
...
Follow-up #2 verified already resolved on main: commit b36839fd0 (Aug 8)
added the 16 new families to IrCurveGenerationConfigDetailDialog's index
family combo; nothing to do. The combo remains hand-patched, mirroring
the same 22-family SQL CHECK the enum now uses.
