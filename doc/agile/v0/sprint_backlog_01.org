...
#+CAPTION: Clock summary at [2024-07-24 Wed 23:23]
|       | <75>                                               |         |       |       |       |
| Tags  | Headline                                           | Time    |       |       |     % |
|-------+----------------------------------------------------+---------+-------+-------+-------|
|       | *Total time*                                       | *77:36* |       |       | 100.0 |
|-------+----------------------------------------------------+---------+-------+-------+-------|
|       | Stories                                            | 77:36   |       |       | 100.0 |
|       | Active                                             |         | 77:36 |       | 100.0 |
| agile | Sprint and product backlog refinement              |         |       |  3:26 |   4.4 |
...
| infra | Create and upload a package                        |         |       |  3:28 |   4.5 |
| code  | Create a basic project structure                   |         |       |  2:10 |   2.8 |
| code  | Add a Qt hello world                               |         |       |  3:08 |   4.0 |
...
| doc   | Add project objective to readme                    |         |       |  2:24 |   3.1 |
| code  | Add basic logging support                          |         |       |  1:14 |   1.6 |
| infra | Add nightly support with memcheck                  |         |       |  3:21 |   4.3 |
| code  | Clean up toolchains and presets                    |         |       |  1:53 |   2.4 |
| doc   | Generate Doxygen documentation and add it to site  |         |       |  0:51 |   1.1 |
| doc   | Copy domain notes on core concepts                 |         |       |  4:41 |   6.0 |
| infra | Valgrind fails to run unit tests                   |         |       |  1:12 |   1.5 |
| infra | Initial sanity test generated packages             |         |       |  0:25 |   0.5 |
| code  | Add command line options support                   |         |       |  5:45 |   7.4 |
| infra | Unit tests show up twice in nightlies              |         |       |  0:13 |   0.3 |
| doc   | Add recipes for command line                       |         |       |  0:51 |   1.1 |
| agile | Use a bar chart for sprint resourcing cost         |         |       |  2:57 |   3.8 |
| agile | Classify stories by type                           |         |       |  0:34 |   0.7 |
| code  | Update C++ standard                                |         |       |  0:29 |   0.6 |
| infra | Setup laptop for development                       |         |       |  3:47 |   4.9 |
| infra | Add database support for currency                  |         |       |  1:19 |   1.7 |
| code  | Add XML parsing support for currency               |         |       |  6:32 |   8.4 |
| code  | Add JSON support for currency                      |         |       |  2:03 |   2.6 |
| code  | Add basic widgets to display currencies            |         |       |  1:50 |   2.4 |
| infra | Ignore vcpkg warnings                              |         |       |  0:21 |   0.5 |
| infra | Add badges from JKQTPlotter                        |         |       |  0:13 |   0.3 |
| code  | Investigate other Qt Applications with similar UIs |         |       |  2:09 |   2.8 |
| code  | Refactor Qt UI                                     |         |       | 10:05 |  13.0 |
...
| infra | Use Qt SQL classes                                 |         |       |  0:36 |   0.8 |
#+end:

*** STARTED Sprint and product backlog refinement                    :agile:
    :LOGBOOK:
    CLOCK: [2024-07-14 Sun 23:26]--[2024-07-14 Sun 23:31] =>  0:05
    CLOCK: [2024-07-14 Sun 23:15]--[2024-07-14 Sun 23:25] =>  0:10
...
*** COMPLETED Investigate other Qt Applications with similar UIs       :code:
    :LOGBOOK:
    CLOCK: [2024-07-18 Thu 23:40]--[2024-07-18 Thu 23:47] =>  0:07
    CLOCK: [2024-07-18 Thu 23:20]--[2024-07-18 Thu 23:39] =>  0:19
    CLOCK: [2024-07-17 Wed 23:03]--[2024-07-17 Wed 23:28] =>  0:25
    CLOCK: [2024-07-15 Mon 23:26]--[2024-07-16 Tue 00:03] =>  0:37
...
- follow the approach of creating widgets in Qt Creator and then inheriting from
  the generated code to extend it with signals and slots, etc.
- copy code from fast track with themes, about, links to website, discord, etc.
- use remix icons. Follow the fast track approach to embed assets into the
  application.
- follow the fast track approach for the applications settings, including
  remembering window sizes, positions, etc.

Links:

- [[https://github.com/foldynl/QLog][QLog]]: use of flags, complex UI with widgets similar to what we are trying to
  do. Use of colours in grid view.
- [[https://github.com/search?q=qt6+language%3AC%2B%2B&type=repositories&l=C%2B%2B][Search GitHub for Qt6 apps]]
- [[https://github.com/soramimi/Guitar][Guitar]]: GUI for diffs, graph for the git trees. Interesting icons for the
  workspace / explorer. Shell / log for git actions.
- [[https://github.com/FastTrackOrg/FastTrack][FastTrack]]: complex UI with themes, tabs, docking widgets.
- [[https://github.com/Remix-Design/RemixIcon][RemixIcon]]: icons

*** COMPLETED Refactor Qt UI                                           :code:
    :LOGBOOK:
    CLOCK: [2024-07-23 Tue 22:30]--[2024-07-23 Tue 23:36] =>  1:06
    CLOCK: [2024-07-22 Mon 23:00]--[2024-07-22 Mon 23:27] =>  0:27
    CLOCK: [2024-07-21 Sun 22:01]--[2024-07-21 Sun 22:33] =>  0:32
    CLOCK: [2024-07-20 Sat 22:06]--[2024-07-20 Sat 22:51] =>  0:45
    CLOCK: [2024-07-20 Sat 21:21]--[2024-07-20 Sat 21:48] =>  0:27
    CLOCK: [2024-07-19 Fri 23:40]--[2024-07-19 Fri 23:53] =>  0:13
    CLOCK: [2024-07-19 Fri 22:30]--[2024-07-19 Fri 23:39] =>  1:09
...
- rename the tree widget after workspaces, worksets or some such. Left for later
  on its own story.
...
- spent some time analysing [[https://github.com/FastTrackOrg/FastTrack/][FastTrack]], a Qt application. Need to do a write up
  of the features we can copy across. Created its own story for this analysis.
...
*** STARTED Use Qt SQL classes                                        :infra:
    :LOGBOOK:
    CLOCK: [2024-07-24 Wed 23:20]--[2024-07-24 Wed 23:23] =>  0:00
    CLOCK: [2024-07-24 Wed 22:46]--[2024-07-24 Wed 23:19] =>  0:33
    :END:
...
- create a model inheriting from =QSqlRelationalTableModel=.
- to connect:
...
- [[https://evileg.com/en/post/67/][Qt/C++ - Lesson 005. QSqlRelationalTableModel - The work with relational
  tables]]
- [[https://github.com/drWebber/qt-qsqlrelationaltablemodel-example/tree/master][qt-qsqlrelationaltablemodel-example]]
- [[https://forum.qt.io/topic/33926/postgresql-and-trying-to-connect-using-qt][PostgreSQL and Trying to connect using Qt]]
- [[https://code.qt.io/cgit/qt/qtbase.git/tree/examples/sql/books?h=6.7][index : qt/qtbase.git]]
- [[https://doc.qt.io/qt-6/examples-sql.html][SQL Examples]]

*** Add progress bar to splash                                         :code:

Apparently its possible to add a progress bar to the splash.

Links:

- [[https://stackoverflow.com/questions/12682888/qt-c-aligning-qprogressbar-inside-a-qsplashscreen][Qt C++ - Aligning QProgressBar inside a QSplashScreen]]
