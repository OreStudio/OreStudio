...
register_overnight_index_convention_event_mapping(ev::service::postgres_event_source& event_source,
                                                  ev::service::event_bus& event_bus,
                                                  ores::nats::service::client& nats) {
    ev::service::registrar::register_mapping<
        refdata::eventing::overnight_index_convention_changed_event>(
        event_source,
        "ores.refdata.overnight_index_convention",
        "ores_refdata_overnight_index_conventions");

    return event_bus.subscribe<refdata::eventing::overnight_index_convention_changed_event>(
        [&nats](const refdata::eventing::overnight_index_convention_changed_event& e) {
