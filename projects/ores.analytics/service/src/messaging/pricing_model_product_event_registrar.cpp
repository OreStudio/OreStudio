...
register_pricing_model_product_event_mapping(ev::service::postgres_event_source& event_source,
    ...
    ev::service::registrar::register_mapping<
        analytics::eventing::pricing_model_product_changed_event>(
        event_source,
        "ores.analytics.pricing_model_product",
        "ores_analytics_pricing_model_products");

    return event_bus.subscribe<analytics::eventing::pricing_model_product_changed_event>(
        [&nats](const analytics::eventing::pricing_model_product_changed_event& e) {
            ev::service::publish_entity_event(
                nats,
                std::string(ev::domain::event_traits<
                            analytics::eventing::pricing_model_product_changed_event>::name),
