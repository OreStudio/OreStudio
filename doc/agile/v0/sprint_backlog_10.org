...
#+CAPTION: Clock summary at [2026-01-21 Wed 11:18], for Wednesday, January 21, 2026.
|       | <75>                               |        |      |      |       |
| Tags  | Headline                           | Time   |      |      |     % |
|-------+------------------------------------+--------+------+------+-------|
...
|       | Stories                            | 1:48   |      |      | 100.0 |
|       | Active                             |        | 1:48 |      | 100.0 |
| infra | OCR scan notebooks for this sprint |        |      | 1:48 | 100.0 |
#+end:

#+begin: clocktable :maxlevel 3 :scope subtree :tags t :indent nil :emphasize nil :scope file :narrow 75 :formula %
#+TBLNAME: sprint_summary
#+CAPTION: Clock summary at [2026-01-21 Wed 11:18]
|       | <75>                                  |        |      |      |       |
| Tags  | Headline                              | Time   |      |      |     % |
|-------+---------------------------------------+--------+------+------+-------|
...
|       | Stories                               | 2:52   |      |      | 100.0 |
|       | Active                                |        | 2:52 |      | 100.0 |
| agile | Sprint and product backlog refinement |        |      | 1:04 |  37.2 |
| infra | OCR scan notebooks for this sprint    |        |      | 1:48 |  62.8 |
#+end:
...
*** STARTED Create a simple code generator                             :code:
    :LOGBOOK:
    CLOCK: [2026-01-21 Wed 11:19]
    :END:
