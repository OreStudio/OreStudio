 ...
 *
 */
#ifndef ORES_TRADE_REPOSITORY_TRADE_ID_TYPE_ENTITY_HPP
#define ORES_TRADE_REPOSITORY_TRADE_ID_TYPE_ENTITY_HPP
...
struct trade_id_type_entity {
    ...
    constexpr static const char* tablename = "ores_trade_trade_id_types_tbl";
