 ...
 */
/**
 * Where the zero_convention screens live and what they can do.
 *
 ...
 */
import { zeroConventionMeta } from '../ui/zero_convention_ui.js';
import type { EntityDescriptor } from '../../../entity/descriptor.js';

export const zeroConventionDescriptor: EntityDescriptor = {
    component: 'refdata',
    entity: 'zero_convention',
    meta: zeroConventionMeta,
    routeSegment: 'zero-convention',
    apiBase: '/api/zero_conventions',
    keyFields: [
        'id',
    ],
    capabilities: {
