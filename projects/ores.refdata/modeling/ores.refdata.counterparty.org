...
#+description: Codegen entity model for the refdata =counterparty= table. Drives the C++ domain class, mapper, repository, service, generator, and SQL schema generation from a single literate source.
