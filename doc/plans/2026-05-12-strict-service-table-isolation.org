...
Two findings in
[[id:6F1A8C2E-9A4D-4F71-B6E0-2D5C8B9E7A41][Bootstrap and
...
2. Several service users hold cross-component table grants. The Service
   Account RBAC Design
   ([[id:DC79D8CE-FBEB-4FC9-9DB5-D39724F2DF86][2026-03-28-service-rbac-design.org]])
...
1. In [[proj:projects/ores.sql/create/refdata][~projects/ores.sql/create/refdata/~]] create a new file
...
| GRANT matrix                      | [[proj:projects/ores.sql/create/iam/iam_service_db_grants_create.sql][~projects/ores.sql/create/iam/iam_service_db_grants_create.sql~]]             |
| Tenant validator fn               | [[proj:projects/ores.sql/create/iam/iam_tenant_functions_create.sql][~projects/ores.sql/create/iam/iam_tenant_functions_create.sql~]]              |
| Change reason validator fn        | [[proj:projects/ores.sql/create/dq/dq_change_reason_functions_create.sql][~projects/ores.sql/create/dq/dq_change_reason_functions_create.sql~]]         |
| Trading trigger refdata SELECTs   | [[proj:projects/ores.sql/create/trading/trading_trades_create.sql][~projects/ores.sql/create/trading/trading_trades_create.sql~]] et al.         |
...
| Predecessor analysis              | [[proj:doc/analysis/bootstrap-and-architecture-violations.org][~doc/analysis/bootstrap-and-architecture-violations.org~]]                    |
| Deferred write-decoupling plan    | [[proj:doc/plans/2026-05-13-cross-service-write-decoupling.org][~doc/plans/2026-05-13-cross-service-write-decoupling.org~]]                   |
