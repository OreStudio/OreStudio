 ...
 *
 */
#ifndef ORES_DQ_REPOSITORY_TREATMENT_DIMENSION_REPOSITORY_HPP
#define ORES_DQ_REPOSITORY_TREATMENT_DIMENSION_REPOSITORY_HPP
...
public:
    ...
    explicit treatment_dimension_repository(context ctx);
