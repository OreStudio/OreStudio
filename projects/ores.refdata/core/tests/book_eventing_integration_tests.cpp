...
#include "ores.refdata.api/eventing/book_event.hpp"
...
TEST_CASE("write_book_publishes_an_event", tags) {
    ...
    using event_type = ores::refdata::messaging::book_event;
    ...
    event_source.register_entity_event_mapping<event_type>("ores_refdata_books");
