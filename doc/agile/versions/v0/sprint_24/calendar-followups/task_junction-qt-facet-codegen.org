...
| Now          | Investigating the junction-vs-domain_entity context shape. |
| Waiting on   | Nothing.                               |
| Next         | Extend org_loader.py/core.py so a junction's ** Qt drawer renders like a domain_entity's. |
