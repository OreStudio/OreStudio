...
#+CAPTION: Clock summary at [2024-06-28 Fri 08:05]
| <75>                                    |         |       |      |       |
| Headline                                | Time    |       |      |     % |
|-----------------------------------------+---------+-------+------+-------|
...
| Setup vcpkg and cmake                   |         |       | 1:21 |   7.3 |
| Setup github actions                    |         |       | 1:21 |   7.3 |
| Create and upload a package             |         |       | 3:28 |  18.8 |
| Create a basic project structure        |         |       | 2:10 |  11.7 |
| Add a Qt hello world                    |         |       | 3:08 |  17.0 |
| Add a splash screen to applciation      |         |       | 0:41 |   3.7 |
| Add nightly support with memcheck       |         |       | 1:40 |   9.0 |
| Add XML parsing support for currency    |         |       | 1:24 |   7.6 |
