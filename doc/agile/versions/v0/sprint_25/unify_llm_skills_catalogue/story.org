...
| [[id:2DF7DE1E-77CA-419E-90E6-E70DF5223314][Wire the codegen drift checks into CI and close the false claim]] | DONE | 2026-09-11 | 2026-09-11 | check_component_drift.py exists but no workflow runs it, while a nightly PR body tells readers it does; model drift has no checker at all. |
...
| [[id:A6DB4F4C-D4F5-4913-AFD3-CC791A921517][Clear the codegen drift in analytics, refdata and scheduler]] | DONE | 2026-09-11 | 2026-09-11 | Regenerating three components rewrites 116 checked-in files and creates 24 that were never committed; the generated tree and the generator disagree. |
...
| [[id:4CB973CA-86B7-4476-85F2-0F11626BFB27][Apply the unique suffix that requires_unique_suffix asks for]] | ABANDONED | 2026-09-11 | 2026-09-11 | Filed on a false premise. requires_unique_suffix is applied correctly wherever it is set; the unused counter that prompted it is drift in trade, recorded on the codegen drift task. |
...
| [[id:294FFF1A-E70B-489A-B7A3-40F57528B46E][Resync the job_definition model with its hand-written code]] | DONE | 2026-09-12 | 2026-09-12 | The scheduler model's column shapes do not match the hand-written struct, so regenerating emits wrong types rather than wrong formatting; the model must be corrected before any facet can be regenerated. |
| [[id:82B0DD7E-4DB1-4F99-AF73-6FBB6C258786][Nest quant under analytics and register the role]] | DONE | 2026-09-11 | 2026-09-11 | ores.analytics.quant sits as a dotted sibling where the signed-off layout is nested parts under a composite root, and quant is in neither the sub-component catalogue nor the signed-off folder catalogue. |
