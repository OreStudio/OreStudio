 ...
 *
 */
#ifndef ORES_TRADING_CORE_PRESENTATION_BOND_LEG_RATE_HISTORY_FIELD_MAPPER_HPP
#define ORES_TRADING_CORE_PRESENTATION_BOND_LEG_RATE_HISTORY_FIELD_MAPPER_HPP
...
/**
 * @brief Renders a bond_leg_rate to an ordered field list for
