...
#+CAPTION: Clock summary at [2025-09-30 Tue 09:50], for Tuesday, September 30, 2025.
|       | <75>                               |        |      |      |       |
| Tags  | Headline                           | Time   |      |      |     % |
|-------+------------------------------------+--------+------+------+-------|
...
|       | Stories                            | 0:08   |      |      | 100.0 |
|       | Active                             |        | 0:08 |      | 100.0 |
| infra | Add suppression to valgrind errors |        |      | 0:08 | 100.0 |
#+end:

#+begin: clocktable :maxlevel 3 :scope subtree :tags t :indent nil :emphasize nil :scope file :narrow 75 :formula %
#+TBLNAME: sprint_summary
#+CAPTION: Clock summary at [2025-09-30 Tue 09:50]
|          | <75>                                               |         |       |      |       |
| Tags     | Headline                                           | Time    |       |      |     % |
|----------+----------------------------------------------------+---------+-------+------+-------|
...
| code     | Implement a cobalt based server and client         |         |       | 2:53 |   4.6 |
...
| infra    | Add suppression to valgrind errors                 |         |       | 0:38 |   1.0 |
