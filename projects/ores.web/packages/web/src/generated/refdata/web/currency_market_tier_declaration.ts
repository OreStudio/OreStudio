 ...
 */
/**
 * Where the currency_market_tier screens live and what they can do.
 *
 ...
 */
import { currencyMarketTierMeta } from '../ui/currency_market_tier_ui.js';
import type { EntityDescriptor } from '../../../entity/descriptor.js';

export const currencyMarketTierDescriptor: EntityDescriptor = {
    component: 'refdata',
    entity: 'currency_market_tier',
    meta: currencyMarketTierMeta,
    routeSegment: 'currency-market-tier',
    apiBase: '/api/types',
    keyFields: [
        'code',
    ],
