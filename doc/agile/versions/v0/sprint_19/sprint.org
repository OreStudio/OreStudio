...
| [[id:746A337A-E96D-42E5-BC47-8EB1FCDD6A30][Add compass test run: build and run unit tests via compass]] | BACKLOG | | | Run all / composite-component / single-component tests or Catch2 name/tag filters; --build delegates to cmake; .env loaded for direct binary runs. |
