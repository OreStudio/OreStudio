 ...
 *
 */
#ifndef ORES_REFDATA_CORE_PRESENTATION_CALENDAR_RULE_HISTORY_FIELD_MAPPER_HPP
#define ORES_REFDATA_CORE_PRESENTATION_CALENDAR_RULE_HISTORY_FIELD_MAPPER_HPP
...
/**
 * @brief Renders a calendar_rule to an ordered field list for
