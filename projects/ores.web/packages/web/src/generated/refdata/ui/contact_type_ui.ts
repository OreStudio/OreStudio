...
export const contactTypeMessages = {
        contact_type: {
            ...
            newTitle: 'New contact type',
            description: 'Reference data table defining valid contact type classifications. Examples: \'Legal\', \'Operations\', \'Settlement\', \'Billing\'. Contact types are managed by the system tenant and are used to categorise contact information records for parties and counterparties.',
            fldCode: 'Code',
            codePh: 'e.g. Legal',
            fldName: 'Name',
            namePh: 'e.g. Legal Contact',
