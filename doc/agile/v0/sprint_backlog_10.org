...
#+CAPTION: Clock summary at [2026-01-23 Fri 11:46], for Friday, January 23, 2026.
|       | <75>                                                |        |      |      |       |
| Tags  | Headline                                            | Time   |      |      |     % |
|-------+-----------------------------------------------------+--------+------+------+-------|
...
|       | Stories                                             | 2:36   |      |      | 100.0 |
|       | Active                                              |        | 2:36 |      | 100.0 |
| infra | OCR scan notebooks for this sprint                  |        |      | 1:20 |  51.3 |
| code  | Image cache not reloading on new datasets           |        |      | 0:20 |  12.8 |
| code  | Create a script to download and split GLEIF data    |        |      | 0:25 |  16.0 |
| code  | Incremental image cache loading with modified_since |        |      | 0:31 |  19.9 |
#+end:

#+begin: clocktable :maxlevel 3 :scope subtree :tags t :indent nil :emphasize nil :scope file :narrow 75 :formula %
#+TBLNAME: sprint_summary
#+CAPTION: Clock summary at [2026-01-23 Fri 11:46]
|       | <75>                                                |         |       |      |       |
| Tags  | Headline                                            | Time    |       |      |     % |
|-------+-----------------------------------------------------+---------+-------+------+-------|
|       | *Total time*                                        | *24:21* |       |      | 100.0 |
|-------+-----------------------------------------------------+---------+-------+------+-------|
|       | Stories                                             | 24:21   |       |      | 100.0 |
|       | Active                                              |         | 24:21 |      | 100.0 |
| agile | Sprint and product backlog refinement               |         |       | 1:04 |   4.4 |
| infra | OCR scan notebooks for this sprint                  |         |       | 6:20 |  26.0 |
| code  | Create a simple code generator                      |         |       | 7:38 |  31.3 |
| code  | Party related schemes                               |         |       | 5:20 |  21.9 |
| code  | Image cache not reloading on new datasets           |         |       | 1:43 |   7.0 |
| code  | Create a script to download and split GLEIF data    |         |       | 0:25 |   1.7 |
| code  | Add code generation support for domain types SQL    |         |       | 1:20 |   5.5 |
| code  | Incremental image cache loading with modified_since |         |       | 0:31 |   2.1 |
#+end:
...
*** STARTED Tidy-up external data storage                              :code:
    :LOGBOOK:
    CLOCK: [2026-01-24 Sat 00:26]
