 ...
 *
 */
#ifndef ORES_REFDATA_REPOSITORY_PARTY_CURRENCY_REPOSITORY_HPP
#define ORES_REFDATA_REPOSITORY_PARTY_CURRENCY_REPOSITORY_HPP
...
#include "ores.refdata/domain/party_currency.hpp"

namespace ores::refdata::repository {

class party_currency_repository {
private:
...
public:
    ...
    void write(const domain::party_currency& party_currency);
