 ...
 *
 */
#ifndef ORES_WORKFLOW_REPOSITORY_WORKFLOW_INSTANCE_MAPPER_HPP
#define ORES_WORKFLOW_REPOSITORY_WORKFLOW_INSTANCE_MAPPER_HPP
 ...
 */
class ORES_WORKFLOW_EXPORT workflow_instance_mapper  {
private:
