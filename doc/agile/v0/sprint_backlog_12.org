...
#+CAPTION: Clock summary at [2026-02-13 Fri 01:29], for Friday, February 13, 2026.
|      | <75>                         |        |      |      |       |
| Tags | Headline                     | Time   |      |      |     % |
|------+------------------------------+--------+------+------+-------|
...
|      | Stories                      | 1:29   |      |      | 100.0 |
|      | Active                       |        | 1:29 |      | 100.0 |
| code | Add proper party short-codes |        |      | 1:29 | 100.0 |
#+end:

#+begin: clocktable :maxlevel 3 :scope subtree :tags t :indent nil :emphasize nil :scope file :narrow 75 :formula %
#+TBLNAME: sprint_summary
#+CAPTION: Clock summary at [2026-02-13 Fri 01:30]
|       | <75>                                               |         |       |      |       |
| Tags  | Headline                                           | Time    |       |      |     % |
|-------+----------------------------------------------------+---------+-------+------+-------|
...
|       | Stories                                            | 45:27   |       |      | 100.0 |
|       | Active                                             |         | 45:27 |      | 100.0 |
| agile | Sprint and product backlog refinement              |         |       | 2:30 |   5.5 |
| code  | Add bound parameters to sqlgen                     |         |       | 0:51 |   1.9 |
| code  | Add roles to account via codes                     |         |       | 0:34 |   1.2 |
| code  | Implement party related entities at database level |         |       | 4:23 |   9.6 |
| code  | Add party related support at the domain level      |         |       | 0:23 |   0.8 |
| code  | Add party related support to Qt                    |         |       | 6:41 |  14.7 |
| code  | Add GLEIF data to datasets                         |         |       | 6:41 |  14.7 |
| code  | Brainstorm on multi-party support                  |         |       | 4:00 |   8.8 |
| code  | Improve code coverage                              |         |       | 0:14 |   0.5 |
| code  | Improve generators with FK-aware test data         |         |       | 1:44 |   3.8 |
| code  | Enable all skipped tests                           |         |       | 0:29 |   1.1 |
| code  | Add central bank related LEIs                      |         |       | 0:35 |   1.3 |
| code  | Expand unit test coverage for ORE codegened types  |         |       | 0:49 |   1.8 |
| code  | Add system party support                           |         |       | 3:58 |   8.7 |
| code  | Add customer party support                         |         |       | 1:33 |   3.4 |
| code  | Fix OSX build                                      |         |       | 0:19 |   0.7 |
| code  | Add pagination to counterparty                     |         |       | 0:58 |   2.1 |
| code  | Add support for business centres                   |         |       | 3:47 |   8.3 |
| code  | Add a setup new tenant wizard                      |         |       | 1:27 |   3.2 |
| code  | Add proper party short-codes                       |         |       | 2:18 |   5.1 |
| code  | Add workspace as a container                       |         |       | 1:13 |   2.7 |
#+end:
...
*** STARTED Fix audit trail metadata for recorded_by and modified_by   :code:
...
*** STARTED Investigate how performed by is being set                  :code:

It should just be the database account.

*** STARTED Add "system" account                                       :code:
...
*** STARTED Add entity messages should not set modified by             :code:
...
*** Add generation context with KVP for audit trail fields             :code:
