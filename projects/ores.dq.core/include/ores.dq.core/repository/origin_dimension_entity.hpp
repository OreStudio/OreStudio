 ...
 *
 */
#ifndef ORES_DQ_CORE_REPOSITORY_ORIGIN_DIMENSION_ENTITY_HPP
#define ORES_DQ_CORE_REPOSITORY_ORIGIN_DIMENSION_ENTITY_HPP
...
std::ostream& operator<<(std::ostream& s, const origin_dimension_entity& v);
