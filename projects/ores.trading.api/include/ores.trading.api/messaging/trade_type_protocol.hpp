...
struct get_trade_types_request {
    ...
    static constexpr std::string_view nats_subject = "trading.v1.trade-types.list";
    int offset = 0;
    int limit = 200;
};
...
struct save_trade_type_request {
    ...
    static constexpr std::string_view nats_subject = "trading.v1.trade-types.save";
...
struct delete_trade_type_request {
    ...
    static constexpr std::string_view nats_subject = "trading.v1.trade-types.delete";
...
struct get_trade_type_history_request {
    ...
    static constexpr std::string_view nats_subject = "trading.v1.trade-types.history";
    std::string code;
};
