 ...
 */
#ifndef ORES_REFDATA_API_DOMAIN_CRM_TOPOLOGY_CONFIG_HPP
#define ORES_REFDATA_API_DOMAIN_CRM_TOPOLOGY_CONFIG_HPP
 ...
 * wiring task]]. UI metadata is deferred to a later task, as it is for market_series.
 *
...
[[nodiscard]] constexpr std::string_view entity_type_of(const crm_topology_config&) {
    return "ores.refdata.crm_topology_config";
}
