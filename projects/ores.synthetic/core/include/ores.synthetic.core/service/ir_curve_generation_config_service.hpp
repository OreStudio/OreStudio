...
public:
     ...
     */
    /**@{*/
    messaging::list_ir_curve_generation_configs_response list_ir_curve_generation_configs(
        const messaging::list_ir_curve_generation_configs_request& request);
    messaging::get_ir_curve_generation_config_response get_ir_curve_generation_config(
        const messaging::get_ir_curve_generation_config_request& request);
    messaging::get_many_ir_curve_generation_configs_response get_many_ir_curve_generation_configs(
        const messaging::get_many_ir_curve_generation_configs_request& request);
    messaging::put_ir_curve_generation_config_response put_ir_curve_generation_config(
        const messaging::put_ir_curve_generation_config_request& request);
    messaging::put_many_ir_curve_generation_configs_response put_many_ir_curve_generation_configs(
        const messaging::put_many_ir_curve_generation_configs_request& request);
    messaging::delete_ir_curve_generation_config_response delete_ir_curve_generation_config(
    ...
    delete_many_ir_curve_generation_configs(
    ...
    list_ir_curve_generation_config_versions(
    ...
    get_ir_curve_generation_config_version(
    ...
    get_ir_curve_generation_config_at_version(const boost::uuids::uuid& id, std::uint32_t version);
     ...
     */
    std::optional<domain::ir_curve_generation_config>
    get_ir_curve_generation_config(const boost::uuids::uuid& id);

    /**
     * @brief Retrieves a batch of IR curve generation configs by primary key.
     */
    std::vector<domain::ir_curve_generation_config>
    get_ir_curve_generation_configs(const std::vector<std::string>& ids);
     ...
     * @throws std::exception on failure.
     */
    void delete_ir_curve_generation_config(const boost::uuids::uuid& id);
...
private:
    ...
    prepare_change(const messaging::ir_curve_generation_config_change& change,
