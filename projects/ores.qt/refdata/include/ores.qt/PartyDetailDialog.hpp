 ...
 *
 */
#ifndef ORES_QT_PARTY_DETAIL_DIALOG_HPP
#define ORES_QT_PARTY_DETAIL_DIALOG_HPP
...
/**
 * @brief Detail dialog for viewing and editing party records.
 *
 * This dialog allows viewing, creating, and editing parties.
 * It supports both create mode (for new records) and edit mode (for
 * existing records).
 */
class PartyDetailDialog final : public DetailDialogBase {
    Q_OBJECT

private:
    inline static std::string_view logger_name = "ores.qt.party_detail_dialog";
...
public:
    explicit PartyDetailDialog(QWidget* parent = nullptr);
    ~PartyDetailDialog() override;

    void setClientManager(ClientManager* clientManager);
    void setUsername(const std::string& username);
    void setParty(const refdata::domain::party& party);
...
signals:
    void partySaved(const QString& code);
