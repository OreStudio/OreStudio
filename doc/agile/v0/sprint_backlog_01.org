...
#+CAPTION: Clock summary at [2024-06-25 Tue 18:32]
| <75>                                    |         |       |      |       |
| Headline                                | Time    |       |      |     % |
|-----------------------------------------+---------+-------+------+-------|
...
| Stories                                 | 15:15   |       |      | 100.0 |
| Active                                  |         | 15:15 |      | 100.0 |
| Sprint and product backlog refinement   |         |       | 0:26 |   2.8 |
| Create a basic git hub repository       |         |       | 0:35 |   3.8 |
| Setup a discord channel for the project |         |       | 0:14 |   1.5 |
| Setup vcpkg and cmake                   |         |       | 1:21 |   8.9 |
| Setup github actions                    |         |       | 1:21 |   8.9 |
| Create and upload a package             |         |       | 3:28 |  22.7 |
| Create a basic project structure        |         |       | 2:10 |  14.2 |
| Add a Qt hello world                    |         |       | 3:08 |  20.5 |
| Add a splash screen to applciation      |         |       | 0:41 |   4.5 |
| Add nightly support with memcheck       |         |       | 0:27 |   3.0 |
| Add XML parsing support for currency    |         |       | 1:24 |   9.2 |
#+end:
