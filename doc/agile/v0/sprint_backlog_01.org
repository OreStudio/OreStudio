...
#+CAPTION: Clock summary at [2024-06-29 Sat 00:52]
| <75>                                    |         |       |      |       |
| Headline                                | Time    |       |      |     % |
|-----------------------------------------+---------+-------+------+-------|
| *Total time*                            | *21:08* |       |      | 100.0 |
|-----------------------------------------+---------+-------+------+-------|
| Stories                                 | 21:08   |       |      | 100.0 |
| Active                                  |         | 21:08 |      | 100.0 |
| Sprint and product backlog refinement   |         |       | 0:54 |   4.3 |
| Create a basic git hub repository       |         |       | 0:35 |   2.8 |
| Setup a discord channel for the project |         |       | 0:14 |   1.1 |
| Setup vcpkg and cmake                   |         |       | 1:21 |   6.4 |
| Setup github actions                    |         |       | 1:21 |   6.4 |
| Create and upload a package             |         |       | 3:28 |  16.4 |
| Create a basic project structure        |         |       | 2:10 |  10.3 |
| Add a Qt hello world                    |         |       | 3:08 |  14.8 |
| Add a splash screen to applciation      |         |       | 0:41 |   3.2 |
| Add basic site                          |         |       | 0:34 |   2.7 |
| Add modeling infrastructure             |         |       | 1:30 |   7.1 |
| Add nightly support with memcheck       |         |       | 1:40 |   7.9 |
| Add XML parsing support for currency    |         |       | 1:24 |   6.6 |
| Create a containing structure for data  |         |       | 0:28 |   2.2 |
| Add basic widgets to display currencies |         |       | 0:26 |   2.1 |
| Add basic logging support               |         |       | 1:14 |   5.8 |
#+end:
