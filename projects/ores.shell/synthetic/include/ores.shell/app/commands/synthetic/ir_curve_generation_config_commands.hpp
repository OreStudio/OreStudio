 ...
 */
#ifndef ORES_SHELL_APP_COMMANDS_IR_CURVE_GENERATION_CONFIG_COMMANDS_HPP
#define ORES_SHELL_APP_COMMANDS_IR_CURVE_GENERATION_CONFIG_COMMANDS_HPP
...
/**
 * @brief Every verb IR curve generation configs answer, as one command each.
 *
...
public:
    /**
     * @brief Register the IR curve generation configs submenu.
     */
