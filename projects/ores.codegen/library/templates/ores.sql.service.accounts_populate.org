:PROPERTIES:
:ID: 4BB161A1-7C81-4C19-9FAA-AA0630B586AF
:END:
#+title: ores.sql.service.accounts_populate
#+description: IAM application accounts for the services (=email=, =description=, password via psql variable). Output =projects/ores.sql/populate/iam/iam_service_accounts_populate.sql=.
#+type: archetype
#+output: projects/ores.sql/populate/iam/iam_service_accounts_populate.sql
