...
| Now          | Fix implemented and building; needs manual QA. |
| Waiting on   | Nothing.                               |
| Next         | Test, then bundle into the same PR as the rest of this branch. |
...
- [ ] Saving a new Currency Pair, or editing/deleting an existing one,
