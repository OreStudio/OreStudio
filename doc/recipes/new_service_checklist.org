...
Add an entry to the [[id:DBB7FE01-0C33-4EF9-BB2A-039674E71AB1][Service registry]] (=projects/modeling/service_registry.org=):
...
See ~doc/plans/2026-05-18-codegen-iam-permissions.org~.
...
~projects/ores.compass/src/nats_certs.py~, then generate the certificate:
...
#+begin_src sh
projects/ores.sql/recreate_database.sh -k -y
#+end_src
...
Add it to ~projects/CMakeLists.txt~:
...
| 8 | Run ~recreate_database.sh -k -y~ | — |
...
(~doc/plans/2026-05-18-codegen-iam-permissions.org~) is complete.
