...
- [[id:1805BAFC-7E43-4D9C-822F-17C3455C6E00][Compute job lifecycle]] — how a job travels through the grid: engine
  registration, batch dispatch, worker execution, validation, and
  output collection.
