...
| SpotDays           | spot_days          | Spot Days       | int       | 70    |                |          |                       | true               | Business days to settlement for a spot trade in this currency. |
| DayBasis           | day_basis          | Day Basis       | string    | 80    |                |          |                       |                    | Day-count convention code applied to this currency (e.g. ACT/360, ACT/365). |
| BasePrecedence     | base_precedence    | Base Precedence | int       | 100   |                |          |                       | true               | Ordinal rank in the base-currency precedence table used to determine canonical base/quote order for a pair. |
