...
void BadgeSeverityHistoryDialog::setupConnections() {
    connect(ui_->versionListWidget, &QTableWidget::itemSelectionChanged,
            this, &BadgeSeverityHistoryDialog::onVersionSelected);
    connect(openVersionAction_, &QAction::triggered,
            this, &BadgeSeverityHistoryDialog::onOpenVersionClicked);
    connect(revertAction_, &QAction::triggered,
            this, &BadgeSeverityHistoryDialog::onRevertClicked);
...
void BadgeSeverityHistoryDialog::loadHistory() {
    ...
    auto task = [self, code = code_.toStdString()]() -> HistoryResult {
        ...
        comms::messaging::frame request_frame(
            comms::messaging::message_type::get_badge_severity_history_request,
            0, std::move(payload)
        );
        ...
        auto response = dq::messaging::get_badge_severity_history_response::
