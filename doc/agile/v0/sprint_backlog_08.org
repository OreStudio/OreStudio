...
#+CAPTION: Clock summary at [2026-01-11 Sun 18:36], for Sunday, January 11, 2026.
|      | <75>                                               |         |       |      |       |
| Tags | Headline                                           | Time    |       |      |     % |
|------+----------------------------------------------------+---------+-------+------+-------|
|      | *Total time*                                       | *10:13* |       |      | 100.0 |
|------+----------------------------------------------------+---------+-------+------+-------|
|      | Stories                                            | 10:13   |       |      | 100.0 |
|      | Active                                             |         | 10:13 |      | 100.0 |
| code | Change reasons UI fixes                            |         |       | 0:57 |   9.3 |
| code | Add UI for log viewing                             |         |       | 1:35 |  15.5 |
| code | Add key entity skills                              |         |       | 3:35 |  35.1 |
| code | Analysis on the entities necessary to create books |         |       | 3:05 |  30.2 |
| code | Finish missing entity features in shell            |         |       | 1:01 |  10.0 |
#+end:

#+begin: clocktable :maxlevel 3 :scope subtree :tags t :indent nil :emphasize nil :scope file :narrow 75 :formula %
#+TBLNAME: sprint_summary
#+CAPTION: Clock summary at [2026-01-11 Sun 18:36]
|       | <75>                                               |         |       |       |       |
| Tags  | Headline                                           | Time    |       |       |     % |
|-------+----------------------------------------------------+---------+-------+-------+-------|
...
|       | Stories                                            | 76:21   |       |       | 100.0 |
|       | Active                                             |         | 76:21 |       | 100.0 |
| agile | Sprint and product backlog refinement              |         |       |  1:50 |   2.4 |
| code  | Rerun SQL scripts from scratch                     |         |       |  7:52 |  10.3 |
| code  | Run qt client and validate all new features        |         |       |  1:19 |   1.7 |
| code  | Refactor options and parser                        |         |       |  0:27 |   0.6 |
| code  | Check functionality in =ores.wt=                   |         |       |  2:03 |   2.7 |
| code  | Rename =ores.shell= to =ores.comms.shell=          |         |       |  1:30 |   2.0 |
| code  | Review HTTP service                                |         |       |  7:24 |   9.7 |
| code  | Assorted fixes to currency dialog                  |         |       |  4:19 |   5.7 |
| code  | Add support for offsets in pagination              |         |       |  1:46 |   2.3 |
| code  | Assorted fixes to feature flags dialog             |         |       |  2:52 |   3.8 |
| code  | Add country support                                |         |       |  6:31 |   8.5 |
| code  | Amend and delete reasons base infrastructure       |         |       |  5:58 |   7.8 |
| code  | Change reasons UI fixes                            |         |       |  3:34 |   4.7 |
| code  | Assorted fixes to currencies dialog                |         |       |  7:52 |  10.3 |
| code  | Add UI for log viewing                             |         |       |  1:35 |   2.1 |
| code  | Add key entity skills                              |         |       |  3:35 |   4.7 |
| code  | Analysis on the entities necessary to create books |         |       |  3:05 |   4.0 |
| code  | Assorted fixes to accounts dialog                  |         |       |  1:10 |   1.5 |
| code  | Review comms analyser work                         |         |       |  0:27 |   0.6 |
| code  | Review telemetry work                              |         |       | 10:11 |  13.3 |
| code  | Finish missing entity features in shell            |         |       |  1:01 |   1.3 |
#+end:
...
*** STARTED Finish missing entity features in shell                    :code:
    :LOGBOOK:
