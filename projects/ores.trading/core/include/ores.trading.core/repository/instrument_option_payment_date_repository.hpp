 ...
 *
 */
#ifndef ORES_TRADING_CORE_REPOSITORY_INSTRUMENT_OPTION_PAYMENT_DATE_REPOSITORY_HPP
#define ORES_TRADING_CORE_REPOSITORY_INSTRUMENT_OPTION_PAYMENT_DATE_REPOSITORY_HPP
...
/**
 * @brief Reads and writes instrument option payment dates to data storage.
 */
class ORES_TRADING_CORE_EXPORT instrument_option_payment_date_repository {
private:
    inline static std::string_view logger_name =
        "ores.trading.repository.instrument_option_payment_date_repository";
...
public:
    ...
    /**
     * @brief Writes instrument option payment dates to database.
     */
    /**@{*/
    void write(context ctx, const domain::instrument_option_payment_date& v);
    void write(context ctx, const std::vector<domain::instrument_option_payment_date>& v);
    /**@}*/

    /**
     * @brief Reads latest instrument option payment dates, possibly filtered by primary key.
     */
    /**@{*/
     ...
     */
    std::uint32_t get_total_option_payment_date_count(context ctx);
