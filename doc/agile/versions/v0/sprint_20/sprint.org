...
| [[id:BF50E75B-EB90-42EA-AFCD-439F435C8E6B][Codegen Model Dashboard]] | BACKLOG | | | A JavaScript dashboard in ores.org-js that visualises the MASD codegen model: org-mode files filtered to codegen-relevant types, cross-reference graph coloured by Object Modeling in Color conventions, and HTML preview of mustache-template org files. Follows the agile dashboard approach. |
