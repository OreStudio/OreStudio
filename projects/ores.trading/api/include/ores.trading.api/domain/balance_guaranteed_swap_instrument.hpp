 ...
 *
 */
#ifndef ORES_TRADING_API_DOMAIN_BALANCE_GUARANTEED_SWAP_INSTRUMENT_HPP
#define ORES_TRADING_API_DOMAIN_BALANCE_GUARANTEED_SWAP_INSTRUMENT_HPP
...
/**
 * @brief Dispatch-key identifier for balance_guaranteed_swap_instrument, e.g. for the
 * generic history-diff request and action registries. Single source
 * of truth: every call site spells entity_type_of(value) regardless
 * of which entity it holds.
 */
[[nodiscard]] constexpr std::string_view entity_type_of(const balance_guaranteed_swap_instrument&) {
    return "ores.trading.balance_guaranteed_swap_instrument";
}
