 ...
 *
 */
#ifndef ORES_MARKETDATA_API_DOMAIN_TENOR_RESOLUTION_HPP
#define ORES_MARKETDATA_API_DOMAIN_TENOR_RESOLUTION_HPP
...
/**
 * @brief One row of the ores_marketdata_tenor_convention_resolutions_tbl join table (see
 * ores.marketdata.tenor_convention_resolution.org). Hand-authored: codegen's junction profile
 ...
 */
ORES_MARKETDATA_API_EXPORT std::chrono::year_month_day
