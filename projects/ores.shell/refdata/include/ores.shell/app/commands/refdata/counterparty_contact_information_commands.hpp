 ...
 */
#ifndef ORES_SHELL_APP_COMMANDS_COUNTERPARTY_CONTACT_INFORMATION_COMMANDS_HPP
#define ORES_SHELL_APP_COMMANDS_COUNTERPARTY_CONTACT_INFORMATION_COMMANDS_HPP
...
/**
 * @brief Every verb counterparty contact informations answer, as one command each.
 *
 ...
 */
class counterparty_contact_information_commands {
private:
    inline static std::string_view logger_name =
        "ores.shell.app.commands.refdata.counterparty_contact_information_commands";
...
public:
    /**
     * @brief Register the counterparty contact informations submenu.
     */
    ...
    /**
     * @brief set <id> <counterparty_id> <contact_type> <street_line_1> <street_line_2> <city>
     * <state> <country_code> <postal_code> <phone> <email> <web_page> <reason> <commentary>
     * [--version <n>]
     */
    ...
    /**
     * @brief put-many --count <n> <id> <counterparty_id> <contact_type> <street_line_1>
