 ...
 *
 */
#ifndef ORES_SHELL_APP_COMMANDS_SYNTHETIC_YIELD_CURVE_PROCESS_TYPE_COMMANDS_HPP
#define ORES_SHELL_APP_COMMANDS_SYNTHETIC_YIELD_CURVE_PROCESS_TYPE_COMMANDS_HPP
...
/**
 * @brief Manages commands related to YIELD CURVE PROCESS TYPE.
 */
...
public:
    /**
     * @brief Register Yield Curve Process Type related commands.
     */
