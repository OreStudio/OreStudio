 ...
 */
/**
 * How the BFF reaches the currency_market_tier service.
 *
 ...
 */
import { subjects } from '@ores/wire-protocol/generated/refdata/protocol/currency_market_tier_protocol';
...
export const currencyMarketTierRoute: EntityRouteDescriptor = {
  ...
  subjects: {
    ...
    save: subjects.put_currency_market_tier_request,
    remove: subjects.delete_currency_market_tier_request,
