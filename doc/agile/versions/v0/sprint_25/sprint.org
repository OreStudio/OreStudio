...
| [[id:CF4E06FF-CB08-484F-A354-91933CCCC7CD][Shared test database rerun safety]] | BACKLOG | | | An aborted fixture-writing test suite can leave synthetic rows open in the shared per-worktree test database; the next run then aborts on duplicate keys. CDash Experimental must be rerunnable without manual database surgery. |
