...
#+CAPTION: Clock summary at [2024-07-07 Sun 18:10]
|       | <75>                                              |         |       |      |       |
| Tags  | Headline                                          | Time    |       |      |     % |
|-------+---------------------------------------------------+---------+-------+------+-------|
|       | *Total time*                                      | *48:31* |       |      | 100.0 |
|-------+---------------------------------------------------+---------+-------+------+-------|
|       | Stories                                           | 48:31   |       |      | 100.0 |
|       | Active                                            |         | 48:31 |      | 100.0 |
| story | Sprint and product backlog refinement             |         |       | 1:29 |   3.1 |
| story | Create a basic git hub repository                 |         |       | 0:35 |   1.2 |
| story | Setup a discord channel for the project           |         |       | 0:14 |   0.5 |
| story | Setup vcpkg and cmake                             |         |       | 1:21 |   2.8 |
| story | Setup github actions                              |         |       | 1:21 |   2.8 |
| story | Create and upload a package                       |         |       | 3:28 |   7.1 |
| story | Create a basic project structure                  |         |       | 2:10 |   4.5 |
| story | Add a Qt hello world                              |         |       | 3:08 |   6.5 |
| story | Add a splash screen to applciation                |         |       | 0:41 |   1.4 |
| story | Add basic site                                    |         |       | 0:34 |   1.2 |
| story | Add modeling infrastructure                       |         |       | 1:30 |   3.1 |
| story | Fix code syntax highlighting in site              |         |       | 0:10 |   0.3 |
| story | Merge index with readme                           |         |       | 0:42 |   1.4 |
| story | Add project objective to readme                   |         |       | 2:24 |   4.9 |
| story | Add basic logging support                         |         |       | 1:14 |   2.5 |
| story | Add nightly support with memcheck                 |         |       | 3:21 |   6.9 |
| story | Clean up toolchains and presets                   |         |       | 1:53 |   3.9 |
| story | Generate Doxygen documentation and add it to site |         |       | 0:51 |   1.8 |
| story | Copy domain notes on core concepts                |         |       | 4:41 |   9.7 |
| story | Valgrind fails to run unit tests                  |         |       | 1:12 |   2.5 |
| story | Initial sanity test generated packages            |         |       | 0:25 |   0.9 |
| story | Add command line options support                  |         |       | 5:45 |  11.9 |
| story | Unit tests show up twice in nightlies             |         |       | 0:13 |   0.4 |
| story | Add recipes for command line                      |         |       | 0:51 |   1.8 |
| story | Use a bar chart for sprint resourcing cost        |         |       | 2:57 |   6.1 |
| story | Add XML parsing support for currency              |         |       | 3:18 |   6.8 |
| story | Create a containing structure for data            |         |       | 0:28 |   1.0 |
| story | Add basic widgets to display currencies           |         |       | 0:26 |   0.9 |
| story | Convert plantuml diagrams to org-babel            |         |       | 1:05 |   2.2 |
| story | Classify stories by type                          |         |       | 0:04 |   0.1 |
#+end:
...
*** COMPLETED Use a bar chart for sprint resourcing cost              :story:
    :LOGBOOK:
...
*** STARTED Classify stories by type                                  :story:
    :LOGBOOK:
    CLOCK: [2024-07-07 Sun 18:06]--[2024-07-07 Sun 18:10] =>  0:04
    :END:
...
But we could perhaps do it within R. We can raise a separate story for this.
