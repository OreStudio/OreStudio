 ...
 */
#ifndef ORES_SHELL_APP_COMMANDS_BOOK_PURPOSE_TYPE_COMMANDS_HPP
#define ORES_SHELL_APP_COMMANDS_BOOK_PURPOSE_TYPE_COMMANDS_HPP
...
/**
 * @brief Every verb book purpose types answer, as one command each.
 *
 ...
 */
class book_purpose_type_commands {
private:
    inline static std::string_view logger_name =
        "ores.shell.app.commands.refdata.book_purpose_type_commands";
...
public:
    /**
     * @brief Register the book purpose types submenu.
     */
