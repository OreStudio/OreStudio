...
{{#has_audit_columns}}
     ...
     *
     * @param {{primary_key.column}} The {{primary_key.column}} of the {{entity_singular_words}}.
     * @param version The version to fetch.
     * @return The {{entity_singular_words}} at that version if found, std::nullopt otherwise.
     */
    std::optional<domain::{{entity_singular}}>
    get_{{entity_singular_short}}_at_version(const std::string& {{primary_key.column}}, std::uint32_t version);
{{/has_audit_columns}}

    /**
     * @brief Retrieves a single {{entity_singular_words}} by its {{primary_key.column}}.
     *
     * @param {{primary_key.column}} The {{primary_key.column}} of the {{entity_singular_words}}.
    ...
    /**
     * @brief Deletes a {{entity_singular_words}} by its {{primary_key.column}}.
     *
     * @param {{primary_key.column}} The {{primary_key.column}} of the {{entity_singular_words}} to delete.
     * @throws std::exception on failure.
     */
    void delete_{{entity_singular_short}}(const std::string& {{primary_key.column}});

    /**
     * @brief Deletes {{entity_plural_words}} by their {{primary_key.column}}s.
     */
