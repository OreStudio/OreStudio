 ...
 *
 */
#ifndef ORES_TRADING_API_DOMAIN_BALANCE_GUARANTEED_SWAP_INSTRUMENT_JSON_IO_HPP
#define ORES_TRADING_API_DOMAIN_BALANCE_GUARANTEED_SWAP_INSTRUMENT_JSON_IO_HPP
...
ORES_TRADING_API_EXPORT std::ostream& operator<<(std::ostream& s,
                                                 const balance_guaranteed_swap_instrument& v);
