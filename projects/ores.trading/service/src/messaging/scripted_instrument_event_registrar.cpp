...
#include "ores.trading.api/eventing/scripted_instrument_changed_event.hpp"
...
register_scripted_instrument_event_mapping(ev::service::postgres_event_source& event_source,
    ...
    return event_bus.subscribe<trading::eventing::scripted_instrument_changed_event>(
        [&nats](const trading::eventing::scripted_instrument_changed_event& e) {
            ev::service::publish_entity_event(
                nats,
                std::string(ev::domain::event_traits<
                            trading::eventing::scripted_instrument_changed_event>::name),
                ev::domain::entity_change_event{.entity = "ores.trading.scripted_instrument",
                                                .timestamp = e.timestamp,
                                                .entity_ids = e.scripted_instrument_ids,
