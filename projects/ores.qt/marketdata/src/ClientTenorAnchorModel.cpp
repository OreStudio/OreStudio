...
namespace {
std::string tenor_anchor_key_extractor(const marketdata::domain::tenor_anchor& e) {
    return e.code;
}
}
    ...
    QFuture<FetchResult> future = QtConcurrent::run([self, offset, limit]() -> FetchResult {
        return exception_helper::wrap_async_fetch<FetchResult>(
            [&]() -> FetchResult {
                ...
                marketdata::messaging::get_tenor_anchors_request request;
...
const marketdata::domain::tenor_anchor* ClientTenorAnchorModel::getAnchor(int row) const {
