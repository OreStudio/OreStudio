...
#+CAPTION: Clock summary at [2026-01-11 Sun 19:18], for Sunday, January 11, 2026.
|      | <75>                                               |         |       |      |       |
| Tags | Headline                                           | Time    |       |      |     % |
|------+----------------------------------------------------+---------+-------+------+-------|
...
|      | Stories                                            | 13:00   |       |      | 100.0 |
|      | Active                                             |         | 13:00 |      | 100.0 |
| code | Change reasons UI fixes                            |         |       | 0:57 |   7.3 |
| code | Add UI for log viewing                             |         |       | 1:35 |  12.2 |
| code | Add key entity skills                              |         |       | 3:35 |  27.6 |
| code | Analysis on the entities necessary to create books |         |       | 3:05 |  23.7 |
| code | Finish missing entity features in shell            |         |       | 3:48 |  29.2 |
#+end:

#+begin: clocktable :maxlevel 3 :scope subtree :tags t :indent nil :emphasize nil :scope file :narrow 75 :formula %
#+TBLNAME: sprint_summary
#+CAPTION: Clock summary at [2026-01-11 Sun 19:18]
|       | <75>                                               |         |       |       |       |
| Tags  | Headline                                           | Time    |       |       |     % |
|-------+----------------------------------------------------+---------+-------+-------+-------|
|       | *Total time*                                       | *79:08* |       |       | 100.0 |
|-------+----------------------------------------------------+---------+-------+-------+-------|
|       | Stories                                            | 79:08   |       |       | 100.0 |
|       | Active                                             |         | 79:08 |       | 100.0 |
| agile | Sprint and product backlog refinement              |         |       |  1:50 |   2.3 |
| code  | Rerun SQL scripts from scratch                     |         |       |  7:52 |   9.9 |
| code  | Run qt client and validate all new features        |         |       |  1:19 |   1.7 |
| code  | Refactor options and parser                        |         |       |  0:27 |   0.6 |
| code  | Check functionality in =ores.wt=                   |         |       |  2:03 |   2.6 |
| code  | Rename =ores.shell= to =ores.comms.shell=          |         |       |  1:30 |   1.9 |
| code  | Review HTTP service                                |         |       |  7:24 |   9.4 |
| code  | Assorted fixes to currency dialog                  |         |       |  4:19 |   5.5 |
| code  | Add support for offsets in pagination              |         |       |  1:46 |   2.2 |
| code  | Assorted fixes to feature flags dialog             |         |       |  2:52 |   3.6 |
| code  | Add country support                                |         |       |  6:31 |   8.2 |
| code  | Amend and delete reasons base infrastructure       |         |       |  5:58 |   7.5 |
| code  | Change reasons UI fixes                            |         |       |  3:34 |   4.5 |
| code  | Assorted fixes to currencies dialog                |         |       |  7:52 |   9.9 |
| code  | Add UI for log viewing                             |         |       |  1:35 |   2.0 |
| code  | Add key entity skills                              |         |       |  3:35 |   4.5 |
| code  | Analysis on the entities necessary to create books |         |       |  3:05 |   3.9 |
| code  | Finish missing entity features in shell            |         |       |  3:48 |   4.8 |
| code  | Assorted fixes to accounts dialog                  |         |       |  1:10 |   1.5 |
| code  | Review comms analyser work                         |         |       |  0:27 |   0.6 |
| code  | Review telemetry work                              |         |       | 10:11 |  12.9 |
#+end:
