...
struct purpose_type final {
    ...
    /**
     * @brief Unique purpose type code.
     *
     * Examples: 'Hedging', 'Trading', 'Investment'.
     */
    std::string code;
    ...
    /**
     * @brief Human-readable name for the purpose type.
     */
    std::string name;

    /**
     * @brief Detailed description of the purpose type.
     */
...
/**
 * @brief Dispatch-key identifier for purpose_type, e.g. for the
 * generic history-diff request and action registries. Single source
 * of truth: every call site spells entity_type_of(value) regardless
 * of which entity it holds.
 */
[[nodiscard]] constexpr std::string_view entity_type_of(const purpose_type&) {
    return "ores.refdata.purpose_type";
}
