...
#+CAPTION: Clock summary at [2025-10-23 Thu 00:58], for Thursday, October 23, 2025.
|       | <75>                   |        |      |      |       |
| Tags  | Headline               | Time   |      |      |     % |
|-------+------------------------+--------+------+------+-------|
...
|       | Stories                | 0:57   |      |      | 100.0 |
|       | Active                 |        | 0:57 |      | 100.0 |
| infra | Update vcpkg to latest |        |      | 0:57 | 100.0 |
#+end:

#+begin: clocktable :maxlevel 3 :scope subtree :tags t :indent nil :emphasize nil :scope file :narrow 75 :formula %
#+TBLNAME: sprint_summary
#+CAPTION: Clock summary at [2025-10-23 Thu 00:59]
|          | <75>                                               |         |       |      |       |
| Tags     | Headline                                           | Time    |       |      |     % |
|----------+----------------------------------------------------+---------+-------+------+-------|
|          | *Total time*                                       | *92:03* |       |      | 100.0 |
|----------+----------------------------------------------------+---------+-------+------+-------|
|          | Stories                                            | 92:03   |       |      | 100.0 |
|          | Active                                             |         | 92:03 |      | 100.0 |
| agile    | Sprint and product backlog refinement              |         |       | 2:36 |   2.8 |
| infra    | Fix broken builds                                  |         |       | 0:36 |   0.7 |
| code     | Create a containing structure for data             |         |       | 0:35 |   0.6 |
| code     | Add temporal support to currencies                 |         |       | 2:59 |   3.2 |
| code     | Add command to dump currencies                     |         |       | 4:18 |   4.7 |
| code     | Refactor code for currencies                       |         |       | 3:52 |   4.2 |
| code     | Restore qt setup                                   |         |       | 2:20 |   2.5 |
| code     | Add gemini action                                  |         |       | 0:05 |   0.1 |
| code     | Remove ImGui support                               |         |       | 0:08 |   0.1 |
| code     | Create a GRPC based service                        |         |       | 2:09 |   2.3 |
...
| code     | Implement a cobalt based server and client         |         |       | 2:53 |   3.1 |
| code     | Add serialisation support for reflect-cpp          |         |       | 3:07 |   3.4 |
| analysis | White-boarding for new architecture                |         |       | 1:52 |   2.0 |
| code     | Use sqlgen for postgres                            |         |       | 7:23 |   8.0 |
| code     | Refactor cli to follow new project structure       |         |       | 4:47 |   5.2 |
...
| analysis | Investigate bitemporal support from Postgres 18    |         |       | 1:47 |   1.9 |
| code     | Refactor core into risk                            |         |       | 4:10 |   4.5 |
| code     | Windows builds have cmake errors                   |         |       | 0:14 |   0.3 |
| infra    | Add suppression to valgrind errors                 |         |       | 0:38 |   0.7 |
| code     | Create a =comms= library                           |         |       | 8:05 |   8.8 |
| code     | Add messaging for risk                             |         |       | 8:00 |   8.7 |
...
| code     | Add support for accounts and logins                |         |       | 7:44 |   8.4 |
| code     | Add workspace as a container                       |         |       | 1:13 |   1.3 |
#+end:
