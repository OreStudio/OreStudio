 ...
 */
#ifndef ORES_SHELL_APP_COMMANDS_BOOK_COMMANDS_HPP
#define ORES_SHELL_APP_COMMANDS_BOOK_COMMANDS_HPP
...
/**
 * @brief Every verb books answer, as one command each.
 *
...
class book_commands {
private:
    inline static std::string_view logger_name = "ores.shell.app.commands.refdata.book_commands";
...
public:
    /**
     * @brief Register the books submenu.
     */
    ...
    /**
     * @brief by-parent-portfolio-id <parent_portfolio_id> [--offset <n>] [--limit <n>] [--order
     * <field>] [--desc]
     */
    static void process_by_parent_portfolio_id(std::ostream& out,
                                               ores::nats::service::nats_client& session,
                                               const std::vector<std::string>& args);
