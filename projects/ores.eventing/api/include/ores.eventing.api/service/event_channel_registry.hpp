 ...
 *
 */
#ifndef ORES_EVENTING_API_SERVICE_EVENT_CHANNEL_REGISTRY_HPP
#define ORES_EVENTING_API_SERVICE_EVENT_CHANNEL_REGISTRY_HPP
 ...
 * @endcode
 */
class ORES_EVENTING_API_EXPORT event_channel_registry final {
public:
