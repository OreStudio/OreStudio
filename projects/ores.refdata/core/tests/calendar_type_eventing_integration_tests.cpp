...
#include "ores.refdata.api/eventing/calendar_type_event.hpp"
...
TEST_CASE("write_calendar_type_publishes_an_event", tags) {
    ...
    using event_type = ores::refdata::messaging::calendar_type_event;
    ...
    event_source.register_entity_event_mapping<event_type>("ores_refdata_calendar_types");
