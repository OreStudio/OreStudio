...
public:
    ...
    /**
     * @brief Writes a monetary nature, honouring the claim it states.
     *
    ...
    /**
     * @brief Writes a set of monetary natures, each honouring its own
    ...
    /**
     * @brief Reads latest monetary natures, possibly filtered by primary key.
     */
    /**@{*/
    ...
    /**
     * @brief Removes a monetary nature, refusing a row that moved on.
     *
...
private:
     ...
     */
    domain::monetary_nature apply_claim(context ctx,
                                        const domain::monetary_nature& v,
                                        const ores::utility::domain::precondition& claim);
};
