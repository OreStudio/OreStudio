...
#+description: Build the ORE Studio website locally: `compass site page` to publish and check the pages you have changed, in seconds, and `compass build --direct site` only for the first full build in a checkout.
#+type: recipe
#+level: cross
...
** Every check: publish what you changed
...
** First build in a checkout: publish everything
