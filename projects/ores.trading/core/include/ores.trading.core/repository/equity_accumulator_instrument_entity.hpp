 ...
 *
 */
#ifndef ORES_TRADING_CORE_REPOSITORY_EQUITY_ACCUMULATOR_INSTRUMENT_ENTITY_HPP
#define ORES_TRADING_CORE_REPOSITORY_EQUITY_ACCUMULATOR_INSTRUMENT_ENTITY_HPP
...
/**
 * @brief Represents a equity accumulator instrument in the database.
 */
