 ...
 */
#ifndef ORES_SHELL_APP_COMMANDS_PARTY_COMMANDS_HPP
#define ORES_SHELL_APP_COMMANDS_PARTY_COMMANDS_HPP
 ...
 */
class party_commands {
private:
    inline static std::string_view logger_name = "ores.shell.app.commands.refdata.party_commands";
