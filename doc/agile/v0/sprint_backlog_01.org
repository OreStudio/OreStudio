...
#+CAPTION: Clock summary at [2024-07-08 Mon 00:10]
|       | <75>                                              |         |       |      |       |
| Tags  | Headline                                          | Time    |       |      |     % |
|-------+---------------------------------------------------+---------+-------+------+-------|
...
|       | Stories                                           | 50:43   |       |      | 100.0 |
|       | Active                                            |         | 50:43 |      | 100.0 |
| agile | Sprint and product backlog refinement             |         |       | 1:29 |   2.9 |
...
| infra | Create and upload a package                       |         |       | 3:28 |   6.8 |
| code  | Create a basic project structure                  |         |       | 2:10 |   4.3 |
| code  | Add a Qt hello world                              |         |       | 3:08 |   6.2 |
| code  | Add a splash screen to applciation                |         |       | 0:41 |   1.3 |
| infra | Add basic site                                    |         |       | 0:34 |   1.1 |
| code  | Add modeling infrastructure                       |         |       | 1:30 |   3.0 |
