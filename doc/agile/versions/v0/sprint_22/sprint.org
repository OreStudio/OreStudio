...
| [[id:395AAFAD-9013-4DF8-BD60-E5B50ADA6385][Reconcile currency Qt custom features with codegen]] | BACKLOG | | | Triage currency's custom Qt functionality (CSV/XML import-export, synthetic data generation, version-nav UI) vs. the qt codegen profile before the Qt sync task can proceed. |
