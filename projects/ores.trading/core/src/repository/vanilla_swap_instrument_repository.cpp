...
std::string vanilla_swap_instrument_repository::sql() {
    return generate_create_table_sql<vanilla_swap_instrument_entity>(lg());
}
...
void vanilla_swap_instrument_repository::write(context ctx,
    ...
    execute_write_query(ctx,
                        vanilla_swap_instrument_mapper::map(v),
                        lg(),
                        "Writing vanilla swap instrument to database.");
}

void vanilla_swap_instrument_repository::write(
    context ctx, const std::vector<domain::vanilla_swap_instrument>& v) {
    BOOST_LOG_SEV(lg(), debug) << "Writing vanilla swap instruments. Count: " << v.size();
    execute_write_query(ctx,
                        vanilla_swap_instrument_mapper::map(v),
                        lg(),
                        "Writing vanilla swap instruments to database.");
}
...
vanilla_swap_instrument_repository::read_latest(context ctx) {
    ...
    return execute_read_query<vanilla_swap_instrument_entity, domain::vanilla_swap_instrument>(
        ...
        [](const auto& entities) { return vanilla_swap_instrument_mapper::map(entities); },
        lg(),
        "Reading latest vanilla swap instruments");
}

std::vector<domain::vanilla_swap_instrument>
vanilla_swap_instrument_repository::read_latest(context ctx, const std::string& instrument_id) {
    BOOST_LOG_SEV(lg(), debug) << "Reading latest vanilla swap instrument. "
    ...
    return execute_read_query<vanilla_swap_instrument_entity, domain::vanilla_swap_instrument>(
        ...
        [](const auto& entities) { return vanilla_swap_instrument_mapper::map(entities); },
        lg(),
        "Reading latest vanilla swap instrument by instrument_id.");
}


std::vector<domain::vanilla_swap_instrument>
vanilla_swap_instrument_repository::read_all(context ctx, const std::string& instrument_id) {
    ...
    return execute_read_query<vanilla_swap_instrument_entity, domain::vanilla_swap_instrument>(
        ...
        [](const auto& entities) { return vanilla_swap_instrument_mapper::map(entities); },
        lg(),
        "Reading all vanilla swap instrument versions by instrument_id.");
}

std::optional<domain::vanilla_swap_instrument> vanilla_swap_instrument_repository::read_at_version(
    ...
    const auto entities =
        execute_read_query<vanilla_swap_instrument_entity, domain::vanilla_swap_instrument>(
            ...
            [](const auto& entities) { return vanilla_swap_instrument_mapper::map(entities); },
            lg(),
            "Reading vanilla swap instrument at version.");
...
void vanilla_swap_instrument_repository::remove(context ctx, const std::string& instrument_id) {
...
std::vector<domain::vanilla_swap_instrument> vanilla_swap_instrument_repository::read_latest(
    context ctx, std::uint32_t offset, std::uint32_t limit) {
    BOOST_LOG_SEV(lg(), debug) << "Reading latest vanilla swap instruments with offset: " << offset
                               << " and limit: " << limit;
    static const auto max(make_timestamp(MAX_TIMESTAMP, lg()));
    const auto tid = ctx.tenant_id().to_string();
    const auto wid = ctx.workspace_id();
    ...
    return execute_read_query<vanilla_swap_instrument_entity, domain::vanilla_swap_instrument>(
        ...
        [](const auto& entities) { return vanilla_swap_instrument_mapper::map(entities); },
        lg(),
        "Reading latest vanilla swap instruments with pagination.");
}

std::uint32_t
vanilla_swap_instrument_repository::get_total_vanilla_swap_instrument_count(context ctx) {
    BOOST_LOG_SEV(lg(), debug) << "Retrieving total active vanilla swap instrument count";
    static const auto max(make_timestamp(MAX_TIMESTAMP, lg()));
    ...
    const auto wid = ctx.workspace_id();
    const auto query =
        sqlgen::select_from<vanilla_swap_instrument_entity>(sqlgen::count().as<"count">()) |
        where("tenant_id"_c == tid && "workspace_id"_c == wid && "valid_to"_c == max.value()) |
    ...
    BOOST_LOG_SEV(lg(), debug) << "Total active vanilla swap instrument count: " << count;
    return count;
}
...
vanilla_swap_instrument_repository::read_latest(context ctx,
    ...
    auto result =
        execute_read_query<vanilla_swap_instrument_entity, domain::vanilla_swap_instrument>(
            ...
            [](const auto& entities) { return vanilla_swap_instrument_mapper::map(entities); },
            lg(),
            "Reading latest vanilla swap instruments by ids.");
    return result;
}

void vanilla_swap_instrument_repository::remove(context ctx,
                                                const std::vector<std::string>& instrument_ids) {
    static const auto max(make_timestamp(MAX_TIMESTAMP, lg()));
    const auto tid = ctx.tenant_id().to_string();
    const auto wid = ctx.workspace_id();
