...
#+CAPTION: Clock summary at [2024-07-04 Thu 08:28]
| <75>                                    |         |       |      |       |
| Headline                                | Time    |       |      |     % |
|-----------------------------------------+---------+-------+------+-------|
| *Total time*                            | *33:08* |       |      | 100.0 |
|-----------------------------------------+---------+-------+------+-------|
| Stories                                 | 33:08   |       |      | 100.0 |
| Active                                  |         | 33:08 |      | 100.0 |
...
| Create and upload a package             |         |       | 3:28 |  10.5 |
| Create a basic project structure        |         |       | 2:10 |   6.5 |
| Add a Qt hello world                    |         |       | 3:08 |   9.5 |
| Add a splash screen to applciation      |         |       | 0:41 |   2.1 |
| Add basic site                          |         |       | 0:34 |   1.7 |
| Add modeling infrastructure             |         |       | 1:30 |   4.5 |
| Fix code syntax highlighting in site    |         |       | 0:10 |   0.5 |
| Merge index with readme                 |         |       | 0:42 |   2.1 |
| Add project objective to readme         |         |       | 2:17 |   6.9 |
| Add basic logging support               |         |       | 1:14 |   3.7 |
| Add nightly support with memcheck       |         |       | 3:21 |  10.1 |
| Clean up toolchains and presets         |         |       | 1:53 |   5.7 |
| Add command line options support        |         |       | 0:44 |   2.2 |
| Add XML parsing support for currency    |         |       | 1:24 |   4.2 |
...
| Copy domain notes on core concepts      |         |       | 2:31 |   7.6 |
| Valgrind fails to run unit tests        |         |       | 0:46 |   2.3 |
#+end:
