 ...
 */
#ifndef ORES_SHELL_APP_COMMANDS_CURRENCY_COMMANDS_HPP
#define ORES_SHELL_APP_COMMANDS_CURRENCY_COMMANDS_HPP
...
/**
 * @brief Every verb currencies answer, as one command each.
 *
 ...
 */
class currency_commands {
private:
    inline static std::string_view logger_name =
        "ores.shell.app.commands.refdata.currency_commands";
...
public:
    /**
     * @brief Register the currencies submenu.
     */
    ...
    /**
     * @brief delete <iso_code> <reason> <commentary> [--version <n>]
     */
    ...
    /**
     * @brief delete-many <iso_code> <reason> <commentary>
     */
    ...
    /**
     * @brief versions <iso_code> [--offset <n>] [--limit <n>] [--order <field>] [--desc]
     */
    ...
    /**
     * @brief version <iso_code> --version <n>
     */
