 ...
 *
 */
#ifndef ORES_SHELL_APP_COMMANDS_SYNTHETIC_YIELD_CURVE_PROCESS_PARAMETER_DEFINITION_COMMANDS_HPP
#define ORES_SHELL_APP_COMMANDS_SYNTHETIC_YIELD_CURVE_PROCESS_PARAMETER_DEFINITION_COMMANDS_HPP
...
/**
 * @brief Manages commands related to YIELD CURVE PROCESS PARAMETER DEFINITION.
 */
...
public:
    /**
     * @brief Register Yield Curve Process Parameter Definition related commands.
     */
