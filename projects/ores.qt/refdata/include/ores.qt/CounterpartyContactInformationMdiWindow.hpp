 ...
 */
#ifndef ORES_QT_COUNTERPARTY_CONTACT_INFORMATION_MDI_WINDOW_HPP
#define ORES_QT_COUNTERPARTY_CONTACT_INFORMATION_MDI_WINDOW_HPP
...
/**
 * @brief MDI window for displaying and managing counterparty contact informations.
 *
 * Provides a table view of counterparty contact informations with toolbar actions
 * for reload, add, edit, delete, and viewing history.
 */
class CounterpartyContactInformationMdiWindow final : public EntityListMdiWindow {
    Q_OBJECT

private:
    inline static std::string_view logger_name =
        "ores.qt.counterparty_contact_information_mdi_window";
...
public:
    explicit CounterpartyContactInformationMdiWindow(ClientManager* clientManager,
                                                     const QString& username,
                                                     ImageCache* imageCache,
                                                     QWidget* parent = nullptr);
    ~CounterpartyContactInformationMdiWindow() override = default;
...
protected:
    QString normalRefreshTooltip() const override {
        return tr("Refresh counterparty contact informations");
    }
...
private:
    ...
    ClientCounterpartyContactInformationModel* model_;
