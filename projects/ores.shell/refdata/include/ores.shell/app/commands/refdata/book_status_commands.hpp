 ...
 */
#ifndef ORES_SHELL_APP_COMMANDS_BOOK_STATUS_COMMANDS_HPP
#define ORES_SHELL_APP_COMMANDS_BOOK_STATUS_COMMANDS_HPP
...
/**
 * @brief Every verb book statuses answer, as one command each.
 *
 ...
 */
class book_status_commands {
private:
    inline static std::string_view logger_name =
        "ores.shell.app.commands.refdata.book_status_commands";
...
public:
    /**
     * @brief Register the book statuses submenu.
     */
