...
[[nodiscard]] ev::service::subscription register_counterparty_contact_information_event_mapping(
    ...
    return event_bus.subscribe<refdata::eventing::counterparty_contact_information_changed_event>(
        [&nats](const refdata::eventing::counterparty_contact_information_changed_event& e) {
