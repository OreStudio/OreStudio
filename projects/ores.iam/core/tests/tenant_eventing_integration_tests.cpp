...
#include "ores.iam.api/eventing/tenant_event.hpp"
...
TEST_CASE("write_tenant_publishes_an_event", tags) {
    ...
    using event_type = ores::iam::messaging::tenant_event;
    ...
    event_source.register_entity_event_mapping<event_type>("ores_iam_tenants");
