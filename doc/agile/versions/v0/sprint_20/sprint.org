...
| Story | State | Start | End | Description |
|-------+-------+-------+-----+-------------|
| [[id:A19D5B00-BEF3-4718-922D-16F58EEBAAB4][Run provisioners from the shell]] | STARTED | 2026-06-06 | | Shell equivalents for the system/tenant/party provisioner wizards (capability coverage, not 1-1 UI mapping); org-mode tangled script library with an end-to-end provisioning script (super_admin, base system, tenant_admin, party). |
