...
From the =projects/ores.codegen= directory, run once per part:

#+begin_src bash
./run_generator.sh models/COMPONENT/ores_COMPONENT_api_component.json --profile component
./run_generator.sh models/COMPONENT/ores_COMPONENT_core_component.json --profile component
./run_generator.sh models/COMPONENT/ores_COMPONENT_service_component.json --profile component
#+end_src

Each run generates the complete project scaffold under =projects/ores.COMPONENT.PART/=:
