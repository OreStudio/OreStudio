...
create or replace trigger ores_dq_subject_areas_notify_trg
after insert or update or delete on ores_dq_subject_areas_tbl
for each row execute function ores_dq_subject_areas_notify_fn();
