 ...
 */
#ifndef ORES_COMPUTE_API_DOMAIN_NODE_SAMPLE_TABLE_IO_HPP
#define ORES_COMPUTE_API_DOMAIN_NODE_SAMPLE_TABLE_IO_HPP
...
/**
 * @brief Dumps the node_sample objects to a stream in table format.
 */
ORES_COMPUTE_API_EXPORT std::ostream& operator<<(std::ostream& s,
                                                 const std::vector<node_sample>& v);
