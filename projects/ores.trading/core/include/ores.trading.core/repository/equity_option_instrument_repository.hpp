 ...
 *
 */
#ifndef ORES_TRADING_CORE_REPOSITORY_EQUITY_OPTION_INSTRUMENT_REPOSITORY_HPP
#define ORES_TRADING_CORE_REPOSITORY_EQUITY_OPTION_INSTRUMENT_REPOSITORY_HPP
 ...
 */
class ORES_TRADING_CORE_EXPORT equity_option_instrument_repository {
private:
...
public:
    ...
    /**
     * @brief Writes Equity Option instruments to database.
     */
    /**@{*/
    ...
    /**
     * @brief Reads latest Equity Option instruments, possibly filtered by primary key.
     */
    /**@{*/
    ...
    /**
     * @brief Reads all Equity Option instruments, possibly filtered by primary key.
     */
    std::vector<domain::equity_option_instrument> read_all(context ctx,
                                                           const std::string& instrument_id);

    /**
     * @brief Reads a single Equity Option instrument as it stood at a specific
    ...
    /**
     * @brief Reads latest Equity Option instruments with pagination support.
     * @param ctx Repository context with database connection
     ...
     */
    std::uint32_t get_total_equity_option_instrument_count(context ctx);
    ...
    /**
     * @brief Deletes Equity Option instruments by closing their temporal validity.
     */
