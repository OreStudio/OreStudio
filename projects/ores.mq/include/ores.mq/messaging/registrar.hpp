 ...
 *
 */
#ifndef ORES_MQ_MESSAGING_REGISTRAR_HPP
#define ORES_MQ_MESSAGING_REGISTRAR_HPP
...
/**
 * @brief Register MQ subsystem message handlers with the server.
 *
 * Registers handlers for all MQ subsystem messages (0xB000-0xBFFF).
