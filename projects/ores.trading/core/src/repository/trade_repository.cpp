...
trade_repository::read_at_version(context ctx, const std::string& id, std::uint32_t version) {
...
std::uint32_t trade_repository::get_total_trade_count(context ctx) {
