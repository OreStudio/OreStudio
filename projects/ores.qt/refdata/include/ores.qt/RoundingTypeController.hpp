...
/**
 * @brief Controller for managing rounding type windows and operations.
 *
 * Manages the lifecycle of rounding type list, detail, and history windows.
 * Handles event subscriptions and coordinates between windows.
 */
class RoundingTypeController final : public EntityController {
    Q_OBJECT
