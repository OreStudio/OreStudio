...
register_tenant_status_event_mapping(ev::service::postgres_event_source& event_source,
    ...
    event_source.register_entity_event_mapping<iam::messaging::tenant_status_event>(
        "ores_iam_tenant_statuses");

    return event_bus.subscribe<iam::messaging::tenant_status_event>(
        [&nats](const iam::messaging::tenant_status_event& e) {
            ...
            ev::service::publish_entity_event(
                nats, ev::domain::event_subject<iam::messaging::tenant_status_event>(e.action), e);
        });
}
