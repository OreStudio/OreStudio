...
register_rounding_type_event_mapping(ev::service::postgres_event_source& event_source,
    ...
    event_source.register_entity_event_mapping<refdata::messaging::rounding_type_event>(
        "ores_refdata_rounding_types");

    return event_bus.subscribe<refdata::messaging::rounding_type_event>(
        [&nats](const refdata::messaging::rounding_type_event& e) {
            ...
            ev::service::publish_entity_event(
                nats,
                ev::domain::event_subject<refdata::messaging::rounding_type_event>(e.action),
                e);
        });
}
