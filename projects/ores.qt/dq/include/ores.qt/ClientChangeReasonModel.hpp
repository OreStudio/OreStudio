 ...
 *
 * This model extends AbstractClientModel and fetches change reason
...
public:
    ...
    /**
     * @brief Refresh change reason data from server asynchronously.
     */
    void refresh();

    /**
     * @brief Get change reason at the specified row.
     *
     * @param row The row index.
     * @return The change reason, or nullptr if row is invalid.
     */
