...
public:
    ...
    /**
     * @brief Writes a market data generation config, honouring the claim it states.
     *
    ...
    /**
     * @brief Writes a set of market data generation configs, each honouring its own
    ...
    /**
     * @brief Removes a market data generation config, refusing a row that moved on.
     *
...
private:
    ...
    replace_claim(context ctx, const domain::market_data_generation_config& v);
