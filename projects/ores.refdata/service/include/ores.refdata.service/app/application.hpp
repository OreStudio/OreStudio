 ...
 *
 */
#ifndef ORES_REFDATA_SERVICE_APP_APPLICATION_HPP
#define ORES_REFDATA_SERVICE_APP_APPLICATION_HPP
...
/**
 * @brief Entry point for the ores.refdata.service service.
 */
class application final {
private:
    inline static std::string_view logger_name = "ores.refdata.service.app.application";
