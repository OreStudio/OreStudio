...
DatasetBundleController::DatasetBundleController(QMainWindow* mainWindow,
                                                 QMdiArea* mdiArea,
...
void DatasetBundleController::showListWindow() {
    ...
    // Connect signals
    connect(listWindow_,
            &DatasetBundleMdiWindow::statusChanged,
            this,
            &DatasetBundleController::statusMessage);
    connect(listWindow_,
            &DatasetBundleMdiWindow::errorOccurred,
            this,
            &DatasetBundleController::errorMessage);
    connect(listWindow_,
            &DatasetBundleMdiWindow::showBundleDetails,
            this,
            &DatasetBundleController::onShowDetails);
    connect(listWindow_,
            &DatasetBundleMdiWindow::addNewRequested,
            this,
            &DatasetBundleController::onAddNewRequested);
    connect(listWindow_,
            &DatasetBundleMdiWindow::showBundleHistory,
            this,
            &DatasetBundleController::onShowHistory);
    ...
    connect(listMdiSubWindow_,
            &QObject::destroyed,
            this,
            [self = QPointer<DatasetBundleController>(this), key]() {
                if (!self)
                    return;
...
void DatasetBundleController::wireDetailDialogCommon(DatasetBundleDetailDialog* detailDialog) {
    ...
    connect(detailDialog,
            &DatasetBundleDetailDialog::statusMessage,
            this,
            &DatasetBundleController::statusMessage);
    connect(detailDialog,
            &DatasetBundleDetailDialog::errorMessage,
            this,
            &DatasetBundleController::errorMessage);
}
...
void DatasetBundleController::showHistoryWindow(const dq::domain::dataset_bundle& item) {
    ...
    connect(historyDialog,
            ...
            this,
            [self = QPointer<DatasetBundleController>(this)](const QString& message) {
                if (!self)
                    return;
    ...
    connect(historyDialog,
            ...
            this,
            [self = QPointer<DatasetBundleController>(this)](
...
void DatasetBundleController::onOpenVersion(const dq::domain::dataset_bundle& item,
    ...
    detailWindow->setWindowTitle(
        QString("Dataset Bundle: %1 (Version %2)").arg(code).arg(versionNumber));
    detailWindow->setWindowIcon(
        IconUtils::createRecoloredIcon(Icon::History, IconUtils::DefaultIconColor));
...
void DatasetBundleController::onOpenHistoryVersion(const QString& entityId, int versionNumber) {
    QPointer<DatasetBundleController> self = this;
    fetchDatasetBundleHistory(
        entityId,
        [self, entityId, versionNumber](
            std::expected<std::vector<dq::domain::dataset_bundle>, QString> result) {
            if (!self)
                return;
            if (!result) {
...
void DatasetBundleController::onRevertHistoryVersion(const QString& entityId, int versionNumber) {
    QPointer<DatasetBundleController> self = this;
    fetchDatasetBundleHistory(
        entityId,
        [self, entityId, versionNumber](
    ...
    connect(detailDialog,
            ...
            [self = QPointer<DatasetBundleController>(this)](const QString& code) {
                ...
                emit self->statusMessage(
                    QString("Dataset Bundle '%1' reverted successfully").arg(code));
                self->handleEntitySaved();
            });
...
void DatasetBundleController::notifyOpenDialogs(const QStringList& entityIds) {
