 ...
 *
 */
#ifndef ORES_IAM_SERVICE_APP_APPLICATION_HPP
#define ORES_IAM_SERVICE_APP_APPLICATION_HPP
...
/**
 * @brief Entry point for the ores.iam.service service.
 */
class application final {
private:
    inline static std::string_view logger_name = "ores.iam.service.app.application";
