 ...
 *
 */
#ifndef ORES_TRADING_CORE_REPOSITORY_EQUITY_POSITION_INSTRUMENT_ENTITY_HPP
#define ORES_TRADING_CORE_REPOSITORY_EQUITY_POSITION_INSTRUMENT_ENTITY_HPP
...
/**
 * @brief Represents a equity position instrument in the database.
 */
