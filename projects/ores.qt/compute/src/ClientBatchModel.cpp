...
ClientBatchModel::ClientBatchModel(ClientManager* clientManager, QObject* parent)
    ...
    connect(
        watcher_, &QFutureWatcher<FetchResult>::finished, this, &ClientBatchModel::onBatchesLoaded);
    ...
    QFuture<FetchResult> future = QtConcurrent::run([self, offset, limit]() -> FetchResult {
        return exception_helper::wrap_async_fetch<FetchResult>(
            [&]() -> FetchResult {
                ...
                compute::messaging::get_batches_request request;
...
void ClientBatchModel::onBatchesLoaded() {
    is_fetching_ = false;
