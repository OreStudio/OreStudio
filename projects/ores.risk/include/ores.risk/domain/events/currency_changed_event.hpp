 ...
 *
 */
#ifndef ORES_RISK_DOMAIN_EVENTS_CURRENCY_CHANGED_EVENT_HPP
#define ORES_RISK_DOMAIN_EVENTS_CURRENCY_CHANGED_EVENT_HPP

#include <chrono>
#include "ores.eventing/domain/event_traits.hpp"

namespace ores::risk::domain::events {
 ...
 */
template<>
struct event_traits<ores::risk::domain::events::currency_changed_event> {
