...
/**
 * @brief Detail dialog for viewing and editing catalog records.
 *
 * This dialog allows viewing, creating, and editing catalogs.
 * It supports both create mode (for new records) and edit mode (for
 * existing records).
 */
class CatalogDetailDialog final : public DetailDialogBase {
    Q_OBJECT
