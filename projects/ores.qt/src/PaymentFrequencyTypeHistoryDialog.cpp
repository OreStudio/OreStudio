...
void PaymentFrequencyTypeHistoryDialog::setupConnections() {
    connect(ui_->versionListWidget, &QTableWidget::itemSelectionChanged,
            this, &PaymentFrequencyTypeHistoryDialog::onVersionSelected);
    connect(openVersionAction_, &QAction::triggered,
            this, &PaymentFrequencyTypeHistoryDialog::onOpenVersionClicked);
    connect(revertAction_, &QAction::triggered,
            this, &PaymentFrequencyTypeHistoryDialog::onRevertClicked);
...
void PaymentFrequencyTypeHistoryDialog::loadHistory() {
    ...
    BOOST_LOG_SEV(lg(), debug) << "Loading history for payment frequency type: " << code_.toStdString();
