:PROPERTIES:
:ID: 873C64B1-A5CC-4C72-B182-F8B0393E2A8D
:ores.cpp.eventing-integration-test.enabled: true
:END:
#+title: ores.trading.fx_vanilla_option_instrument
#+description: Codegen entity model for the trading =fx_vanilla_option_instrument= table. Drives the C++ domain class, mapper, repository, service, generator, and SQL schema generation from a single literate source.
#+type: ores.codegen.entity
#+component: trading
#+filetags: :model:entity:trading:
#+entity_singular: fx_vanilla_option_instrument
#+entity_plural: fx_vanilla_option_instruments
#+entity_title: FX Vanilla Option Instrument
...
Routes ORE product type: FxOption (European and American vanilla
options).
...
** Flags
:PROPERTIES:
:tablename: ores_trading_fx_vanilla_option_instruments_tbl
:END:
...
| "exercise_style" in ('European', 'American') |
...
** Repository
:PROPERTIES:
:entity_singular_short: fx_vanilla_option_instrument
:entity_plural_short:   fx_vanilla_option_instruments
:entity_singular_words: FX vanilla option instrument
:entity_plural_words:   FX vanilla option instruments
:END:
