 ...
 */
#ifndef ORES_SHELL_APP_COMMANDS_FOLDER_COMMANDS_HPP
#define ORES_SHELL_APP_COMMANDS_FOLDER_COMMANDS_HPP
...
/**
 * @brief Every verb folders answer, as one command each.
 *
...
public:
    /**
     * @brief Register the folders submenu.
     */
    ...
    /**
     * @brief add <id> <parent_id> <name> <kind> <collection_id> <reason> <commentary>
     */
    ...
    /**
     * @brief set <id> <parent_id> <name> <kind> <collection_id> <reason> <commentary> [--version
     * <n>]
     */
    ...
    /**
     * @brief put-many --count <n> <id> <parent_id> <name> <kind> <collection_id> <reason>
     * <commentary>
     */
