...
| [[id:1C0EF2C8-E952-4807-92EF-A217C8DFF49A][Wire cross-reference tables in story new / task new]] | BACKLOG | | | compass story new and task new scaffold the story/task docs but leave their cross-references unwired and their Goal/Acceptance as placeholders. Observed: the new task is not added to the story's * Tasks table; story new does not add the new story to the sprint's * Stories table (the tool prints both as manual 'next steps'); and neither accepts --goal/--acceptance, so docs are born without content. Make scaffolding wire the story<->task and sprint<->story table rows automatically, and accept --goal/--acceptance (matching the documented expectation that scaffolding wires the tables and is born with content). |
