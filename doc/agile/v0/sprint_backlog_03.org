...
#+CAPTION: Clock summary at [2025-11-04 Tue 22:49], for Tuesday, November 04, 2025.
|       | <75>                                               |        |      |      |       |
| Tags  | Headline                                           | Time   |      |      |     % |
|-------+----------------------------------------------------+--------+------+------+-------|
...
|       | Stories                                            | 4:53   |      |      | 100.0 |
|       | Active                                             |        | 4:53 |      | 100.0 |
| infra | vcpkg cannot apply patch on windowws               |        |      | 1:19 |  27.0 |
| code  | Add command line arguments for database to service |        |      | 3:34 |  73.0 |
#+end:

#+begin: clocktable :maxlevel 3 :scope subtree :tags t :indent nil :emphasize nil :scope file :narrow 75 :formula %
#+TBLNAME: sprint_summary
#+CAPTION: Clock summary at [2025-11-04 Tue 22:49]
|       | <75>                                                   |         |       |       |       |
| Tags  | Headline                                               | Time    |       |       |     % |
|-------+--------------------------------------------------------+---------+-------+-------+-------|
|       | *Total time*                                           | *64:08* |       |       | 100.0 |
|-------+--------------------------------------------------------+---------+-------+-------+-------|
|       | Stories                                                | 64:08   |       |       | 100.0 |
|       | Active                                                 |         | 64:08 |       | 100.0 |
| agile | Sprint and product backlog refinement                  |         |       |  1:24 |   2.2 |
| code  | Add locking up logic                                   |         |       |  1:28 |   2.3 |
| code  | Build using dynamic libraries                          |         |       |  7:24 |  11.5 |
| code  | Enable qt gui                                          |         |       |  4:13 |   6.6 |
| code  | Add locking up logic                                   |         |       |  1:28 |   2.3 |
| code  | Build using dynamic libraries                          |         |       |  7:24 |  11.5 |
| code  | Implement logging according to correct boost.log usage |         |       |  8:02 |  12.5 |
...
| code  | Consider adding a postgres database to CI              |         |       | 14:13 |  22.2 |
...
| code  | Patches for sqlgen are not applying on windows         |         |       |  0:20 |   0.5 |
| infra | vcpkg cannot apply patch on windowws                   |         |       |  1:19 |   2.1 |
| code  | Add command line arguments for database to service     |         |       |  3:34 |   5.6 |
| code  | Separate test database usage from application          |         |       |  2:13 |   3.5 |
...
*** STARTED Patches for sqlgen are not applying on windows             :code:
    :LOGBOOK:
...
*** STARTED vcpkg cannot apply patch on windowws                      :infra:
    :LOGBOOK:
...
*** STARTED Add command line arguments for database to service         :code:
    :LOGBOOK:
