:PROPERTIES:
:ID: B903843F-9A8D-4B47-BB80-16F701525E3F
:END:
#+title: ores.cpp.qt.mdi_window_impl
#+description: List view window hosted in the main MDI area.
#+type: archetype
#+output: projects/ores.qt/{component}/src/{EntityPascal}MdiWindow.cpp
#+facet: ores.cpp.qt
#+level: cross
...
- =18B9ED63-78C2-4259-93AC-CCDFBC88EFBD= — end of =setupToolbar()=,
  after the generated History action. Extra toolbar actions, e.g. a
  cross-navigation button to a related entity's list window.
...
{{/domain_entity.qt.has_csv_xml_io}}
      historyAction_(nullptr){{#domain_entity.qt.has_setting_gated_actions}},
