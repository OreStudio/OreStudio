 ...
 *
 */
#ifndef ORES_DQ_CORE_PRESENTATION_SYNTHETIC_FX_SPOT_CONFIG_HISTORY_FIELD_MAPPER_HPP
#define ORES_DQ_CORE_PRESENTATION_SYNTHETIC_FX_SPOT_CONFIG_HISTORY_FIELD_MAPPER_HPP
...
/**
 * @brief Renders a synthetic_fx_spot_config to an ordered field list for
