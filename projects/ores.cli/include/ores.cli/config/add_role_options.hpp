 ...
 *
 */
#ifndef ORES_CLI_CONFIG_ADD_ROLE_OPTIONS_HPP
#define ORES_CLI_CONFIG_ADD_ROLE_OPTIONS_HPP
...
/**
 * @brief Configuration for adding a role entity via command-line arguments.
 */
