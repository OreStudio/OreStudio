...
inflation_swap_instrument_mapper::map(const inflation_swap_instrument_entity& v) {
    BOOST_LOG_SEV(lg(), trace) << "Mapping db entity: " << v;

    domain::inflation_swap_instrument r;
    r.version = v.version;
...
inflation_swap_instrument_entity
inflation_swap_instrument_mapper::map(const domain::inflation_swap_instrument& v) {
    BOOST_LOG_SEV(lg(), trace) << "Mapping domain entity: " << v;

    inflation_swap_instrument_entity r;
