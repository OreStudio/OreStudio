 ...
 */
#ifndef ORES_SHELL_APP_COMMANDS_CRM_DRIVER_PAIR_COMMANDS_HPP
#define ORES_SHELL_APP_COMMANDS_CRM_DRIVER_PAIR_COMMANDS_HPP
...
/**
 * @brief Every verb CRM driver pairs answer, as one command each.
 *
 ...
 */
class crm_driver_pair_commands {
private:
    inline static std::string_view logger_name =
        "ores.shell.app.commands.refdata.crm_driver_pair_commands";
...
public:
    /**
     * @brief Register the CRM driver pairs submenu.
     */
