 ...
 * that cannot be null.
 */
struct instrument_option_exercise_fee final {
    /**
    ...
    /**
     * @brief Username of the person who last modified this instrument option exercise fee.
     */
...
/**
 * @brief Dispatch-key identifier for instrument_option_exercise_fee, e.g. for the
 * generic history-diff request and action registries. Single source
 * of truth: every call site spells entity_type_of(value) regardless
 * of which entity it holds.
 */
[[nodiscard]] constexpr std::string_view entity_type_of(const instrument_option_exercise_fee&) {
    return "ores.trading.instrument_option_exercise_fee";
}
