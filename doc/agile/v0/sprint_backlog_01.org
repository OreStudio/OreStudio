...
#+TBLNAME: summary
#+CAPTION: Clock summary at [2024-07-06 Sat 00:57]
| <75>                                              |         |       |      |       |
| Headline                                          | Time    |       |      |     % |
|---------------------------------------------------+---------+-------+------+-------|
...
| Stories                                           | 38:14   |       |      | 100.0 |
| Active                                            |         | 38:14 |      | 100.0 |
| Sprint and product backlog refinement             |         |       | 1:18 |   3.4 |
| Create a basic git hub repository                 |         |       | 0:35 |   1.5 |
| Setup a discord channel for the project           |         |       | 0:14 |   0.6 |
| Setup vcpkg and cmake                             |         |       | 1:21 |   3.5 |
| Setup github actions                              |         |       | 1:21 |   3.5 |
| Create and upload a package                       |         |       | 3:28 |   9.1 |
| Create a basic project structure                  |         |       | 2:10 |   5.7 |
| Add a Qt hello world                              |         |       | 3:08 |   8.2 |
| Add a splash screen to applciation                |         |       | 0:41 |   1.8 |
| Add basic site                                    |         |       | 0:34 |   1.5 |
| Add modeling infrastructure                       |         |       | 1:30 |   3.9 |
| Fix code syntax highlighting in site              |         |       | 0:10 |   0.4 |
| Merge index with readme                           |         |       | 0:42 |   1.8 |
| Add project objective to readme                   |         |       | 2:24 |   6.3 |
| Add basic logging support                         |         |       | 1:14 |   3.2 |
| Add nightly support with memcheck                 |         |       | 3:21 |   8.8 |
| Clean up toolchains and presets                   |         |       | 1:53 |   4.9 |
| Generate Doxygen documentation and add it to site |         |       | 0:51 |   2.2 |
| Copy domain notes on core concepts                |         |       | 3:45 |   9.8 |
| Valgrind fails to run unit tests                  |         |       | 1:05 |   2.8 |
| Add command line options support                  |         |       | 3:06 |   8.1 |
| Add XML parsing support for currency              |         |       | 1:24 |   3.7 |
