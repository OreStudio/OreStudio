...
:END:
#+title: ores.doc.knowledge.investigation
#+description: Investigation doc, scoped to the story that commissioned it: =Investigation:= title prefix, findings skeleton, and a snapshot framing.
#+type: archetype
...
A point-in-time record, written while the story that commissioned it was open, of an [[id:A7F8D9E2-3C4B-4A5D-B67C-8E9F0A1B2C3D][investigation]] into {{description}}.
