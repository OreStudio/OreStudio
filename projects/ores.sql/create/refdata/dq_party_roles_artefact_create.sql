...
create table if not exists "metadata"."dq_party_roles_artefact_tbl" (
...
on "metadata"."dq_party_roles_artefact_tbl" (dataset_id);

create index if not exists dq_party_roles_artefact_code_idx
on "metadata"."dq_party_roles_artefact_tbl" (code);

create index if not exists dq_party_roles_artefact_coding_scheme_idx
on "metadata"."dq_party_roles_artefact_tbl" (coding_scheme_code);
