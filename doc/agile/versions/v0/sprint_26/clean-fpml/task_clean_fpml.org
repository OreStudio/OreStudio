...
The review request =@claude review PR= is on the PR as comment 5841685082. This table is the local pass; the bot's findings arrive as PR comments and get handled as a review round.
