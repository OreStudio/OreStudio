...
-- =============================================================================
-- Hierarchy traversal for business_units.
...
-- =============================================================================
create or replace function ores_refdata_business_units_hierarchy_fn(
    p_tenant_id uuid,
    p_root_id uuid,
...
begin
    ...
    with recursive descendants as (
        ...
        select t.id, t.parent_business_unit_id as parent_id,
               t.unit_name::text as name
        from "ores_refdata_business_units_tbl" t
        join descendants d on t.parent_business_unit_id = d.id
        where t.tenant_id = p_tenant_id
          and t.valid_to = ores_utility_infinity_timestamp_fn()
    )
