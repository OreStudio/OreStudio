...
| Recipe | What it does |
|--------+--------------|
| [[id:CC928252-E0C5-4C3C-A7A8-D613593E4E37][How do I create a PR?]] | Open a pull request with =compass pr create= — title validation, the fixed Summary / Changes / Traceability / Testing body template with the mandatory Testing flags, Traceability table. |
...
| [[id:6930472B-222C-4621-AB37-CFEE3070A8BD][How do I deploy the site?]] | Publish and check the pages you changed with =compass site page=; the full =compass build --direct site= is for the first build in a checkout. |
