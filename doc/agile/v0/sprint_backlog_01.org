...
#+CAPTION: Clock summary at [2024-07-10 Wed 08:11]
|       | <75>                                              |         |       |      |       |
| Tags  | Headline                                          | Time    |       |      |     % |
|-------+---------------------------------------------------+---------+-------+------+-------|
|       | *Total time*                                      | *55:20* |       |      | 100.0 |
|-------+---------------------------------------------------+---------+-------+------+-------|
|       | Stories                                           | 55:20   |       |      | 100.0 |
|       | Active                                            |         | 55:20 |      | 100.0 |
...
| infra | Setup laptop for development                      |         |       | 2:52 |   5.2 |
| code  | Add XML parsing support for currency              |         |       | 4:52 |   8.8 |
