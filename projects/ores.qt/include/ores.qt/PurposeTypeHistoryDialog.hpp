 ...
 *
 */
#ifndef ORES_QT_PURPOSE_TYPE_HISTORY_DIALOG_HPP
#define ORES_QT_PURPOSE_TYPE_HISTORY_DIALOG_HPP
...
/**
 * @brief Dialog for viewing the version history of a purpose type.
 *
...
private:
    inline static std::string_view logger_name =
        "ores.qt.purpose_type_history_dialog";
...
public:
    explicit PurposeTypeHistoryDialog(
        const QString& code,
...
signals:
    ...
    void openVersionRequested(const refdata::domain::purpose_type& pt,
                              int versionNumber);
