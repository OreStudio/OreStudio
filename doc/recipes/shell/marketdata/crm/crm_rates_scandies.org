:PROPERTIES:
:ID: A2798131-D6A9-45BB-9B74-0D72607B88AF
:END:
#+title: How do I view scandies CRM rates from the shell?
#+description: List a party's 'scandies' FX cross-rates matrix (CRM) rates from ores.shell.
#+type: recipe
#+level: cross
...
Qt Cross-Rates Matrix window shows, via [[id:F4D45153-D81E-464D-8D9B-2DBFEE7CB670][the crm_commands shell
