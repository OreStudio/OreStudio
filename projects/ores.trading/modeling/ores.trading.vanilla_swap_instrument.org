:PROPERTIES:
:ID: 44ABB804-7286-43DF-8ACB-1520BE5737DE
:END:
#+title: ores.trading.vanilla_swap_instrument
#+description: Codegen entity model for the trading =vanilla_swap_instrument= table. Drives the C++ domain class, mapper, repository, service, generator, Qt UI, and SQL schema generation from a single literate source.
#+type: ores.codegen.entity
#+component: trading
#+filetags: :model:entity:trading:
#+brief: Vanilla interest rate swap or cross-currency swap instrument.
#+entity_singular: vanilla_swap_instrument
#+entity_plural: vanilla_swap_instruments
#+entity_title: Vanilla Swap Instrument
#+created: 2026-06-01
#+updated: 2026-06-01
...
** Flags
:PROPERTIES:
:tablename: ores_trading_vanilla_swap_instruments_tbl
:END:
...
** Repository
:PROPERTIES:
:entity_singular_short: vanilla_swap_instrument
:entity_plural_short:   vanilla_swap_instruments
:entity_singular_words: vanilla swap instrument
:entity_plural_words:   vanilla swap instruments
:END:
