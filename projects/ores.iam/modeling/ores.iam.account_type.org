...
#+description: Codegen entity model for the iam =account_type= table. Drives the C++ domain class, mapper, repository, service, generator, TypeScript UI metadata, and SQL schema generation from a single literate source.
...
** Presentation
:PROPERTIES:
:domain_include:         ores.iam.api/domain/account_type.hpp
:domain_class:           iam::domain::account_type
:protocol_include:       ores.iam.api/messaging/account_type_protocol.hpp
:collection_name:        account_types
:item_var:               account_type
:key_field:              type
:get_request_class:      iam::messaging::list_account_types_request
:get_response_class:     iam::messaging::list_account_types_response
:get_message_type:       list_account_types_request
:save_request_class:     iam::messaging::put_account_type_request
:save_response_class:    iam::messaging::put_account_type_response
:save_message_type:      put_account_type_request
...
:history_request_class:  iam::messaging::list_account_type_versions_request
:history_response_class: iam::messaging::list_account_type_versions_response
:history_message_type:   list_account_type_versions_request
