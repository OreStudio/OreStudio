...
#+TBLNAME: summary
#+CAPTION: Clock summary at [2024-07-06 Sat 23:11]
| <75>                                              |         |       |      |       |
| Headline                                          | Time    |       |      |     % |
|---------------------------------------------------+---------+-------+------+-------|
...
| Stories                                           | 42:55   |       |      | 100.0 |
| Active                                            |         | 42:55 |      | 100.0 |
| Sprint and product backlog refinement             |         |       | 1:18 |   3.0 |
| Create a basic git hub repository                 |         |       | 0:35 |   1.4 |
| Setup a discord channel for the project           |         |       | 0:14 |   0.5 |
| Setup vcpkg and cmake                             |         |       | 1:21 |   3.1 |
| Setup github actions                              |         |       | 1:21 |   3.1 |
| Create and upload a package                       |         |       | 3:28 |   8.1 |
| Create a basic project structure                  |         |       | 2:10 |   5.0 |
| Add a Qt hello world                              |         |       | 3:08 |   7.3 |
| Add a splash screen to applciation                |         |       | 0:41 |   1.6 |
| Add basic site                                    |         |       | 0:34 |   1.3 |
| Add modeling infrastructure                       |         |       | 1:30 |   3.5 |
| Fix code syntax highlighting in site              |         |       | 0:10 |   0.4 |
| Merge index with readme                           |         |       | 0:42 |   1.6 |
| Add project objective to readme                   |         |       | 2:24 |   5.6 |
| Add basic logging support                         |         |       | 1:14 |   2.9 |
| Add nightly support with memcheck                 |         |       | 3:21 |   7.8 |
| Clean up toolchains and presets                   |         |       | 1:53 |   4.4 |
| Generate Doxygen documentation and add it to site |         |       | 0:51 |   2.0 |
| Copy domain notes on core concepts                |         |       | 4:41 |  10.9 |
| Valgrind fails to run unit tests                  |         |       | 1:12 |   2.8 |
| Initial sanity test generated packages            |         |       | 0:25 |   1.0 |
| Clang tests show up twice in nightlies            |         |       | 0:04 |   0.2 |
| Add command line options support                  |         |       | 4:21 |  10.1 |
| Add XML parsing support for currency              |         |       | 3:18 |   7.7 |
| Create a containing structure for data            |         |       | 0:28 |   1.1 |
| Add basic widgets to display currencies           |         |       | 0:26 |   1.0 |
| Convert plantuml diagrams to org-babel            |         |       | 1:05 |   2.5 |
#+end:
