...
{{#left.replace_by}}
    /**
     * @brief Replaces the active {{name_words}} for a {{left.column_title_lower}}.
     *
     ...
     */
    void replace_by_{{left.column_short}}(
{{#left.is_uuid}}
        const boost::uuids::uuid& {{left.column}},
{{/left.is_uuid}}
{{^left.is_uuid}}
...
{{#right.replace_by}}
    /**
     * @brief Replaces the active {{name_words}} for a {{right.column_title_lower}}.
     *
     * Soft-closes the currently active rows for the given
     * {{right.column_title_lower}} and inserts the rows in @p {{name_short}},
     * so the active set exactly matches the caller's list.
     */
    void replace_by_{{right.column_short}}(
{{#right.is_uuid}}
        const boost::uuids::uuid& {{right.column}},
{{/right.is_uuid}}
{{^right.is_uuid}}
