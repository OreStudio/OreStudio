...
#+CAPTION: Clock summary at [2025-09-28 Sun 01:02], for Sunday, September 28, 2025.
|      | <75>                    |        |      |      |       |
| Tags | Headline                | Time   |      |      |     % |
|------+-------------------------+--------+------+------+-------|
...
|      | Stories                 | 1:02   |      |      | 100.0 |
|      | Active                  |        | 1:02 |      | 100.0 |
| code | Refactor core into risk |        |      | 1:02 | 100.0 |
#+end:

#+begin: clocktable :maxlevel 3 :scope subtree :tags t :indent nil :emphasize nil :scope file :narrow 75 :formula %
#+TBLNAME: sprint_summary
#+CAPTION: Clock summary at [2025-09-28 Sun 01:02]
|          | <75>                                               |         |       |      |       |
| Tags     | Headline                                           | Time    |       |      |     % |
|----------+----------------------------------------------------+---------+-------+------+-------|
...
|          | Stories                                            | 55:09   |       |      | 100.0 |
|          | Active                                             |         | 55:09 |      | 100.0 |
| agile    | Sprint and product backlog refinement              |         |       | 2:15 |   4.1 |
| infra    | Fix broken builds                                  |         |       | 0:36 |   1.1 |
| code     | Create a containing structure for data             |         |       | 0:35 |   1.1 |
| code     | Add temporal support to currencies                 |         |       | 2:59 |   5.4 |
| code     | Add command to dump currencies                     |         |       | 4:18 |   7.8 |
| code     | Refactor code for currencies                       |         |       | 3:52 |   7.0 |
| code     | Restore qt setup                                   |         |       | 2:20 |   4.2 |
| code     | Add gemini action                                  |         |       | 0:05 |   0.2 |
| code     | Remove ImGui support                               |         |       | 0:08 |   0.2 |
| code     | Create a GRPC based service                        |         |       | 2:09 |   3.9 |
| code     | Implement a 0MQ based RPC service and client       |         |       | 3:55 |   7.1 |
...
| code     | Implement a cobalt based server and client         |         |       | 2:53 |   5.2 |
| code     | Add serialisation support for reflect-cpp          |         |       | 3:07 |   5.7 |
| analysis | White-boarding for new architecture                |         |       | 1:52 |   3.4 |
| code     | Use sqlgen for postgres                            |         |       | 7:23 |  13.4 |
| code     | Refactor cli to follow new project structure       |         |       | 4:47 |   8.7 |
| code     | Add tests to cli parser                            |         |       | 0:35 |   1.1 |
| code     | Completions in emacs org mode are incorrect        |         |       | 1:02 |   1.9 |
| infra    | Investigate build warning for vcpkg binary caching |         |       | 0:25 |   0.8 |
| infra    | Investigate build warning for qtbase               |         |       | 0:10 |   0.3 |
| analysis | Investigate bitemporal support from Postgres 18    |         |       | 1:47 |   3.2 |
| code     | Fix windows and osx builds                         |         |       | 0:27 |   0.8 |
| code     | Fix gemini cli action                              |         |       | 0:45 |   1.4 |
| infra    | vcpkg caching seems disabled                       |         |       | 0:15 |   0.5 |
| code     | Create a =comms= library                           |         |       | 1:10 |   2.1 |
| code     | Refactor core into risk                            |         |       | 3:28 |   6.3 |
