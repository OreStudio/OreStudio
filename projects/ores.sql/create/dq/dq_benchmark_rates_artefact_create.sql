...
create table if not exists "metadata"."dq_benchmark_rates_artefact_tbl" (
...
on "metadata"."dq_benchmark_rates_artefact_tbl" (dataset_id);

create index if not exists dq_benchmark_rates_artefact_code_idx
on "metadata"."dq_benchmark_rates_artefact_tbl" (code);

create index if not exists dq_benchmark_rates_artefact_coding_scheme_idx
on "metadata"."dq_benchmark_rates_artefact_tbl" (coding_scheme_code);
