...
- [[id:720D74A0-DAD3-4F11-BC5F-AD78BF5A9DD2][Qt Plugin Architecture]] — established the plugin pattern where each plugin
  contributes menus via ~create_menus()~; any restructuring must stay within
  that contract.
- [[id:3125F901-7AC2-421C-8AEF-8C508B0E315B][Qt Plugin Isolation]] — ongoing work to sharpen plugin boundaries; menu
