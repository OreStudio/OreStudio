...
/**
 * @brief Detail dialog for viewing and editing party type records.
 *
 * This dialog allows viewing, creating, and editing party types.
 * It supports both create mode (for new records) and edit mode (for
 * existing records).
 */
class PartyTypeDetailDialog final : public DetailDialogBase {
    Q_OBJECT
...
public:
    explicit PartyTypeDetailDialog(QWidget* parent = nullptr);
    ~PartyTypeDetailDialog() override;

    void setClientManager(ClientManager* clientManager);
    void setUsername(const std::string& username);
    void setType(const refdata::domain::party_type& type);
...
private:
    ...
    Ui::PartyTypeDetailDialog* ui_;
    ClientManager* clientManager_;
    std::string username_;
    refdata::domain::party_type type_;
