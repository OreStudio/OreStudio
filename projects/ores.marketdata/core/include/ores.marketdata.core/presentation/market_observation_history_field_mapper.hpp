 ...
 *
 */
#ifndef ORES_MARKETDATA_CORE_PRESENTATION_MARKET_OBSERVATION_HISTORY_FIELD_MAPPER_HPP
#define ORES_MARKETDATA_CORE_PRESENTATION_MARKET_OBSERVATION_HISTORY_FIELD_MAPPER_HPP
...
/**
 * @brief Renders a market_observation to an ordered field list for
