 ...
 */
#ifndef ORES_ASSETS_API_GENERATORS_IMAGE_GENERATOR_HPP
#define ORES_ASSETS_API_GENERATORS_IMAGE_GENERATOR_HPP
 ...
 */
ORES_ASSETS_API_EXPORT domain::image
generate_synthetic_image(utility::generation::generation_context& ctx);

/**
 * @brief Generates N synthetic images.
 */
ORES_ASSETS_API_EXPORT std::vector<domain::image>
