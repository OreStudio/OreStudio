...
#include "ores.refdata.api/eventing/party_type_event.hpp"
...
TEST_CASE("write_party_type_publishes_an_event", tags) {
    ...
    using event_type = ores::refdata::messaging::party_type_event;
    ...
    event_source.register_entity_event_mapping<event_type>("ores_refdata_party_types");
