 ...
 *
 */
#ifndef ORES_QT_PARTY_DETAIL_OPERATIONS_HPP
#define ORES_QT_PARTY_DETAIL_OPERATIONS_HPP
...
/**
 * @brief Party-specific operations for the entity detail dialog.
 *
 * Implements entity_detail_operations using party protocol messages.
 */
class party_detail_operations final : public entity_detail_operations {
public:
