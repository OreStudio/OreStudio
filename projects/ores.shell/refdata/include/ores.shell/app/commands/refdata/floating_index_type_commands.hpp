 ...
 */
#ifndef ORES_SHELL_APP_COMMANDS_FLOATING_INDEX_TYPE_COMMANDS_HPP
#define ORES_SHELL_APP_COMMANDS_FLOATING_INDEX_TYPE_COMMANDS_HPP
...
/**
 * @brief Every verb floating index types answer, as one command each.
 *
 ...
 */
class floating_index_type_commands {
private:
    inline static std::string_view logger_name =
        "ores.shell.app.commands.refdata.floating_index_type_commands";
...
public:
    /**
     * @brief Register the floating index types submenu.
     */
    ...
    /**
     * @brief add <code> <description> <reason> <commentary>
     */
    ...
    /**
     * @brief set <code> <description> <reason> <commentary> [--version <n>]
     */
    ...
    /**
     * @brief put-many --count <n> <code> <description> <reason> <commentary>
     */
