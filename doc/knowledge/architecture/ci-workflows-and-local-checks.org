...
| code (C++)      | =projects/ores.*= C++ sources, headers, =*.cmake=, =CMakeLists.txt= | full build + ctest; cmake-sources-drift; codegen-drift; review; misspell; CDash experimental |
| ci              | =.github/*=, =projects/ores.codegen/library/templates/*=         | site; drift checks; review; misspell         |
