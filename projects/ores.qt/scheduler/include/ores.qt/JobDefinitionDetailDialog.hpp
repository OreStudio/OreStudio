 ...
 *
 */
#ifndef ORES_QT_JOB_DEFINITION_DETAIL_DIALOG_HPP
#define ORES_QT_JOB_DEFINITION_DETAIL_DIALOG_HPP
 ...
 *
 * This dialog allows viewing, creating, and editing job definitions.
 * It supports both create mode (for new records) and edit mode (for
 * existing records).
 */
class JobDefinitionDetailDialog final : public DetailDialogBase {
    Q_OBJECT

private:
    inline static std::string_view logger_name = "ores.qt.job_definition_detail_dialog";
...
public:
    explicit JobDefinitionDetailDialog(QWidget* parent = nullptr);
