...
using ores::shell::app::commands::image_tag_commands;
...
TEST_CASE("image_tag_commands_registers_every_derived_verb", tags) {
...
TEST_CASE("image_tag_commands_process_list_requires_a_session", tags) {
    ...
    image_tag_commands::process_list(out, session, tokens(0));
...
TEST_CASE("image_tag_commands_process_get_requires_a_session", tags) {
    auto lg(make_logger(test_suite));
    ...
    command_feedback::reset();
    image_tag_commands::process_get(out, session, tokens(2));
...
TEST_CASE("image_tag_commands_process_get_reports_the_expected_count", tags) {
    auto lg(make_logger(test_suite));
...
TEST_CASE("image_tag_commands_process_get_many_requires_a_session", tags) {
    auto lg(make_logger(test_suite));
    ...
    command_feedback::reset();
    image_tag_commands::process_get_many(out, session, tokens(2));
...
TEST_CASE("image_tag_commands_process_add_requires_a_session", tags) {
    auto lg(make_logger(test_suite));
    ...
    command_feedback::reset();
    image_tag_commands::process_add(out, session, tokens(4));
...
TEST_CASE("image_tag_commands_process_add_reports_the_expected_count", tags) {
    auto lg(make_logger(test_suite));
...
TEST_CASE("image_tag_commands_process_set_requires_a_session", tags) {
    auto lg(make_logger(test_suite));
    ...
    command_feedback::reset();
    image_tag_commands::process_set(out, session, tokens(4));
...
TEST_CASE("image_tag_commands_process_set_reports_the_expected_count", tags) {
    auto lg(make_logger(test_suite));
...
TEST_CASE("image_tag_commands_process_put_many_requires_a_session", tags) {
    auto lg(make_logger(test_suite));
    ...
    command_feedback::reset();
    image_tag_commands::process_put_many(out, session, tokens(4));
...
TEST_CASE("image_tag_commands_process_delete_requires_a_session", tags) {
    auto lg(make_logger(test_suite));
    ...
    command_feedback::reset();
    image_tag_commands::process_delete(out, session, tokens(2));
...
TEST_CASE("image_tag_commands_process_delete_reports_the_expected_count", tags) {
    auto lg(make_logger(test_suite));
...
TEST_CASE("image_tag_commands_process_delete_many_requires_a_session", tags) {
    auto lg(make_logger(test_suite));
    ...
    command_feedback::reset();
    image_tag_commands::process_delete_many(out, session, tokens(2));
...
TEST_CASE("image_tag_commands_process_by_image_id_requires_a_session", tags) {
    auto lg(make_logger(test_suite));
    ...
    command_feedback::reset();
    image_tag_commands::process_by_image_id(out, session, tokens(1));
...
TEST_CASE("image_tag_commands_process_by_image_id_reports_the_expected_count", tags) {
    auto lg(make_logger(test_suite));
