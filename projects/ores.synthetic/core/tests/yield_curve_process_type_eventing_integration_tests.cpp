...
#include "ores.synthetic.api/eventing/yield_curve_process_type_event.hpp"
...
TEST_CASE("write_yield_curve_process_type_publishes_an_event", tags) {
    ...
    using event_type = ores::synthetic::messaging::yield_curve_process_type_event;
    ...
    event_source.register_entity_event_mapping<event_type>(
        "ores_synthetic_yield_curve_process_types");
