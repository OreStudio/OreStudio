 ...
 *
 */
#ifndef ORES_TRADING_CORE_REPOSITORY_EQUITY_OPTION_INSTRUMENT_MAPPER_HPP
#define ORES_TRADING_CORE_REPOSITORY_EQUITY_OPTION_INSTRUMENT_MAPPER_HPP
 ...
 */
class ORES_TRADING_CORE_EXPORT equity_option_instrument_mapper {
private:
