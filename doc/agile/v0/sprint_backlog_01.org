...
#+CAPTION: Clock summary at [2024-07-02 Tue 21:58]
| <75>                                    |         |       |      |       |
| Headline                                | Time    |       |      |     % |
|-----------------------------------------+---------+-------+------+-------|
| *Total time*                            | *29:51* |       |      | 100.0 |
|-----------------------------------------+---------+-------+------+-------|
| Stories                                 | 29:51   |       |      | 100.0 |
| Active                                  |         | 29:51 |      | 100.0 |
...
| Create and upload a package             |         |       | 3:28 |  11.6 |
| Create a basic project structure        |         |       | 2:10 |   7.3 |
| Add a Qt hello world                    |         |       | 3:08 |  10.5 |
...
| Add nightly support with memcheck       |         |       | 3:21 |  11.2 |
| Clean up toolchains and presets         |         |       | 1:53 |   6.3 |
| Add command line options support        |         |       | 0:44 |   2.5 |
| Add XML parsing support for currency    |         |       | 1:24 |   4.7 |
