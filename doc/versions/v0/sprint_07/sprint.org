...
This page documents a [[id:0820b7fd-147c-4832-ac25-c043d38d5b61][sprint]] (*Sprint 07*) of ORE Studio v0. It captures the sprint's mission, current status, and the stories that compose it. For the surrounding context — version goals, sprint order, and product identity — see [[id:e6fd30ed-963e-4705-b414-91bf471c23d0][Version 0]].
...
| Story                                                                    | State | Theme                                                                                |
|--------------------------------------------------------------------------+-------+--------------------------------------------------------------------------------------|
| [[id:a5060b3b-a3c0-40ff-b5d3-36ed1e74b609][Sprint 07 housekeeping]]      | DONE  | recurring per-sprint chores: backlog, AI summary, notebook OCR.                      |
| [[id:bb39ecbd-1ea5-4d53-a117-a0c88e0463c1][Build platform follow-up]]    | DONE  | WSL setup, prebuilt Qt, Windows clang build breaks. Continues from sprint 04.        |
| [[id:818b6261-1780-4fb3-aa89-da02c91da363][Currencies history polish]]   | DONE  | visual distinction for the active version, revert action, country flags.             |
| [[id:72f723f4-378c-4e0a-b6f1-6ba3c29f5bea][Qt UX polish]]                | DONE  | account management UI, exit confirmation, relative-time formatting.                  |
| [[id:b306f938-f939-44ca-9d69-6faedbf91c08][Comms features]]              | DONE  | optional compression, =LISTEN=/=NOTIFY= through the shell, type traits for messages. |
| [[id:6b57c190-4bb7-4f63-bf3d-7fb6d81d8d94][Accounts to IAM]]             | DONE  | rename =ores.accounts= to =ores.iam=, add lock, password reset, sign-up.             |
| [[id:6255bc9f-95bc-4fc7-98c8-6060b8679b85][Roles and permissions]]       | DONE  | RBAC core, enforcement, Qt UI.                                                       |
| [[id:8c4c8429-9328-46dd-88ef-27689fb556f2][Observability and telemetry]] | DONE  | new components, MaxMind replacement.                                                 |
| [[id:db625c07-811a-4a61-8de8-910b29913744][Wt and HTTP introduction]]    | DONE  | Wt scaffolding, HTTP entry point.                                                    |
