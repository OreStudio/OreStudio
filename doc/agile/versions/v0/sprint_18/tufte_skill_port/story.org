...
A =tufte-viz= skill exists in [[proj:doc/llm/skills][=doc/llm/skills/=]] and is listed in the
...
- [[proj:doc/llm/skills/claude_code_skills.org][=doc/llm/skills/claude_code_skills.org=]] lists =tufte-viz= under
  =* Design= with a one-line description.
- The source files in [[proj:tmp][=tmp/=]] (=SKILL.md=,
