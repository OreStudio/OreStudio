...
register_crm_topology_config_event_mapping(ev::service::postgres_event_source& event_source,
    ...
    event_source.register_entity_event_mapping<refdata::messaging::crm_topology_config_event>(
        "ores_refdata_crm_topology_configs");

    return event_bus.subscribe<refdata::messaging::crm_topology_config_event>(
        [&nats](const refdata::messaging::crm_topology_config_event& e) {
            ...
            ev::service::publish_entity_event(
                nats,
                ev::domain::event_subject<refdata::messaging::crm_topology_config_event>(e.action),
                e);
        });
}
