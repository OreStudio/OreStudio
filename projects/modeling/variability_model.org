...
| Qt richness tier | none / basic / standard / rich | =has_qt= off, or on plus an increasing set of =has_change_reason_cache=/=has_pagination=/=has_csv_xml_io=/=has_version_navigation=/=has_explorer_api=/=has_export_macro= (=ores.cpp.qt=) |
