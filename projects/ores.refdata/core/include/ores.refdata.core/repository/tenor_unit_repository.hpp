...
public:
    ...
    /**
     * @brief Writes a tenor unit, honouring the claim it states.
     *
    ...
    /**
     * @brief Writes a set of tenor units, each honouring its own
    ...
    /**
     * @brief Reads latest tenor units, possibly filtered by primary key.
     */
    /**@{*/
    ...
    std::vector<domain::tenor_unit> read_latest(context ctx, const std::vector<std::string>& codes);
    /**@}*/


    /**
     * @brief Reads all tenor units, possibly filtered by primary key.
     */
    ...
    /**
     * @brief Removes a tenor unit, refusing a row that moved on.
     *
...
private:
     ...
     */
    ores::utility::domain::precondition replace_claim(context ctx, const domain::tenor_unit& v);
     ...
     */
    domain::tenor_unit apply_claim(context ctx,
                                   const domain::tenor_unit& v,
                                   const ores::utility::domain::precondition& claim);
};
