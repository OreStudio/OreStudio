...
counterparty_identifier_mapper::map(const counterparty_identifier_entity& v) {
...
counterparty_identifier_entity
counterparty_identifier_mapper::map(const domain::counterparty_identifier& v) {
