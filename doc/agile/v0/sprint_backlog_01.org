...
#+CAPTION: Clock summary at [2024-06-27 Thu 23:21]
| <75>                                    |         |       |      |       |
| Headline                                | Time    |       |      |     % |
|-----------------------------------------+---------+-------+------+-------|
...
| Stories                                 | 17:17   |       |      | 100.0 |
| Active                                  |         | 17:17 |      | 100.0 |
| Sprint and product backlog refinement   |         |       | 0:47 |   4.5 |
| Create a basic git hub repository       |         |       | 0:35 |   3.4 |
| Setup a discord channel for the project |         |       | 0:14 |   1.4 |
| Setup vcpkg and cmake                   |         |       | 1:21 |   7.8 |
| Setup github actions                    |         |       | 1:21 |   7.8 |
| Create and upload a package             |         |       | 3:28 |  20.1 |
| Create a basic project structure        |         |       | 2:10 |  12.5 |
| Add a Qt hello world                    |         |       | 3:08 |  18.1 |
| Add a splash screen to applciation      |         |       | 0:41 |   4.0 |
| Add nightly support with memcheck       |         |       | 1:21 |   7.8 |
| Add XML parsing support for currency    |         |       | 1:24 |   8.1 |
| Create a containing structure for data  |         |       | 0:21 |   2.0 |
| Add basic widgets to display currencies |         |       | 0:26 |   2.5 |
#+end:
