...
[[nodiscard]] ev::service::subscription register_business_day_convention_type_event_mapping(
    ...
    ev::service::registrar::register_mapping<
        refdata::eventing::business_day_convention_type_changed_event>(
        event_source,
        "ores.refdata.business_day_convention_type",
        "ores_refdata_business_day_convention_types");

    return event_bus.subscribe<refdata::eventing::business_day_convention_type_changed_event>(
        [&nats](const refdata::eventing::business_day_convention_type_changed_event& e) {
