...
#+begin_src sh
export ORES_CLI_DB_PASSWORD
./ores.cli accounts add --username admin3 --password 123 --email \
  admin3@example.com --is-admin 1 --modified-by system ${log_args} ${db_args}
#+END_SRC

#+RESULTS:
#+begin_src json
Successfully added account: admin3 (ID: e5c1b08b-e781-45dc-880e-a3c04526737d)
#+end_src
