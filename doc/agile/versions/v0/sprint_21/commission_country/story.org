...
| Now           | SQL, CLI, shell, and codegen back-out all DONE. Qt verification (9B0CA32A) is next. |
| Waiting on    | Nothing.                               |
| Next          | Qt end-to-end verification (9B0CA32A). |
...
| [[id:3E63E209-518B-4555-8482-D1DE0B9479F3][Back out country via codegen and verify zero-diff]] | DONE | 2026-06-25 | 2026-06-25 | Table model created (country_table.org); SQL regenerated with documented deviations (index rename, security definer placement). C++ remains hand-written (no domain entity org model yet). |
