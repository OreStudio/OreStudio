...
ores::utility::domain::precondition business_day_convention_type_repository::replace_claim(
    context ctx, const domain::business_day_convention_type& v) {
...
domain::business_day_convention_type business_day_convention_type_repository::apply_claim(
    context ctx,
...
void business_day_convention_type_repository::write(
    ...
    execute_write_query(ctx,
                        business_day_convention_type_mapper::map(t),
                        lg(),
                        "Writing business day convention type to database.");
}
...
void business_day_convention_type_repository::write(
    ...
    execute_write_query(ctx,
                        business_day_convention_type_mapper::map(batch),
                        lg(),
                        "Writing business day convention types to database.");
}
...
business_day_convention_type_repository::read_latest(context ctx) {
    ...
    return execute_read_query<business_day_convention_type_entity,
        ...
        lg(),
        "Reading latest business day convention types");
}
...
business_day_convention_type_repository::read_latest(context ctx,
    ...
    auto result = execute_read_query<business_day_convention_type_entity,
                                     domain::business_day_convention_type>(
        ctx,
        query,
        [](const auto& entities) { return business_day_convention_type_mapper::map(entities); },
        lg(),
        "Reading latest business day convention types by ids.");
    return result;
}
