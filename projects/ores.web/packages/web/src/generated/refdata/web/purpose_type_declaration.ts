 ...
 */
/**
 * Where the purpose_type screens live and what they can do.
 *
 ...
 */
import { purposeTypeMeta } from '../ui/purpose_type_ui.js';
import type { EntityDescriptor } from '../../../entity/descriptor.js';

export const purposeTypeDescriptor: EntityDescriptor = {
    component: 'refdata',
    entity: 'purpose_type',
    meta: purposeTypeMeta,
    routeSegment: 'purpose-type',
    apiBase: '/api/types',
    keyFields: [
        'code',
    ],
