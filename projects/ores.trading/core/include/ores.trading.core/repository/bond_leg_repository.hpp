 ...
 *
 */
#ifndef ORES_TRADING_CORE_REPOSITORY_BOND_LEG_REPOSITORY_HPP
#define ORES_TRADING_CORE_REPOSITORY_BOND_LEG_REPOSITORY_HPP
...
/**
 * @brief Reads and writes bond legs to data storage.
 */
class ORES_TRADING_CORE_EXPORT bond_leg_repository {
private:
    inline static std::string_view logger_name = "ores.trading.repository.bond_leg_repository";
...
public:
    ...
    /**
     * @brief Writes bond legs to database.
     */
    /**@{*/
    void write(context ctx, const domain::bond_leg& v);
    void write(context ctx, const std::vector<domain::bond_leg>& v);
    /**@}*/

    /**
     * @brief Reads latest bond legs, possibly filtered by primary key.
     */
    /**@{*/
    ...
    /**
     * @brief Reads a single bond leg as it stood at a specific
     ...
     */
    std::uint32_t get_total_bond_leg_count(context ctx);
