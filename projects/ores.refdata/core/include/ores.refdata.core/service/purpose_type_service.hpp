...
public:
    ...
    list_purpose_types(const messaging::list_purpose_types_request& request);
    messaging::get_purpose_type_response
    get_purpose_type(const messaging::get_purpose_type_request& request);
    messaging::get_many_purpose_types_response
    get_many_purpose_types(const messaging::get_many_purpose_types_request& request);
    messaging::put_purpose_type_response
    put_purpose_type(const messaging::put_purpose_type_request& request);
    messaging::put_many_purpose_types_response
    put_many_purpose_types(const messaging::put_many_purpose_types_request& request);
    messaging::delete_purpose_type_response
    delete_purpose_type(const messaging::delete_purpose_type_request& request);
    messaging::delete_many_purpose_types_response
    delete_many_purpose_types(const messaging::delete_many_purpose_types_request& request);
    messaging::list_purpose_type_versions_response
    list_purpose_type_versions(const messaging::list_purpose_type_versions_request& request);
    messaging::get_purpose_type_version_response
    get_purpose_type_version(const messaging::get_purpose_type_version_request& request);
    /**@}*/
    ...
    /**
     * @brief Retrieves a batch of purpose types by primary key.
     */
    std::vector<domain::purpose_type> get_types(const std::vector<std::string>& codes);
...
private:
     ...
     */
    ores::utility::domain::result prepare_change(const messaging::purpose_type_change& change,
