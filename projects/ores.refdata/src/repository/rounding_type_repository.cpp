 ...
 *
 */
#include "ores.refdata/repository/rounding_type_repository.hpp"

#include <sqlgen/postgres.hpp>
#include "ores.database/repository/helpers.hpp"
#include "ores.database/repository/bitemporal_operations.hpp"
#include "ores.refdata/domain/rounding_type_json_io.hpp" // IWYU pragma: keep.
#include "ores.refdata/repository/rounding_type_entity.hpp"
#include "ores.refdata/repository/rounding_type_mapper.hpp"
...
void rounding_type_repository::write(context ctx, const domain::rounding_type& v) {
    ...
    execute_write_query(ctx, rounding_type_mapper::map(v),
