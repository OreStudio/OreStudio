 ...
 *   SELECT * FROM metadata.dq_populate_entity_classifications(dataset_id, 'upsert');
 */
...
begin
    ...
    from metadata.dq_entity_classifications_artefact_tbl dq
    left join production.refdata_entity_classifications_tbl existing
 ...
 */
create or replace function metadata.dq_populate_entity_classifications(
    p_dataset_id uuid,
...
begin
    ...
    loop
        ...
        select exists (
            select 1 from production.refdata_entity_classifications_tbl existing
        ...
        insert into production.refdata_entity_classifications_tbl (
