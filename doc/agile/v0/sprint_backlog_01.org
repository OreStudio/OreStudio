...
#+TBLNAME: summary
#+CAPTION: Clock summary at [2024-07-06 Sat 20:23]
| <75>                                              |         |       |      |       |
| Headline                                          | Time    |       |      |     % |
|---------------------------------------------------+---------+-------+------+-------|
...
| Add command line options support                  |         |       | 3:06 |   7.5 |
| Add XML parsing support for currency              |         |       | 3:18 |   8.0 |
