...
#+CAPTION: Clock summary at [2026-01-24 Sat 09:04], for Saturday, January 24, 2026.
|      | <75>                                    |        |      |      |       |
| Tags | Headline                                | Time   |      |      |     % |
|------+-----------------------------------------+--------+------+------+-------|
...
|      | Stories                                 | 4:25   |      |      | 100.0 |
|      | Active                                  |        | 4:25 |      | 100.0 |
| code | Tidy-up external data storage           |        |      | 1:04 |  24.2 |
| code | Coding schemes are in production tables |        |      | 1:39 |  37.4 |
| code | Refactor schema directories             |        |      | 1:42 |  38.5 |
#+end:

#+begin: clocktable :maxlevel 3 :scope subtree :tags t :indent nil :emphasize nil :scope file :narrow 75 :formula %
#+TBLNAME: sprint_summary
#+CAPTION: Clock summary at [2026-01-24 Sat 09:04]
|       | <75>                                                |         |       |      |       |
| Tags  | Headline                                            | Time    |       |      |     % |
|-------+-----------------------------------------------------+---------+-------+------+-------|
|       | *Total time*                                        | *34:02* |       |      | 100.0 |
|-------+-----------------------------------------------------+---------+-------+------+-------|
|       | Stories                                             | 34:02   |       |      | 100.0 |
|       | Active                                              |         | 34:02 |      | 100.0 |
| agile | Sprint and product backlog refinement               |         |       | 1:04 |   3.1 |
| infra | OCR scan notebooks for this sprint                  |         |       | 6:20 |  18.6 |
| code  | Create a simple code generator                      |         |       | 7:38 |  22.4 |
| code  | Party related schemes                               |         |       | 5:20 |  15.7 |
| code  | Image cache not reloading on new datasets           |         |       | 1:43 |   5.0 |
| code  | Create a script to download and split GLEIF data    |         |       | 0:25 |   1.2 |
| code  | Incremental image cache loading with modified_since |         |       | 0:31 |   1.5 |
| code  | Fix issues with misspell action                     |         |       | 2:47 |   8.2 |
| code  | Tidy-up external data storage                       |         |       | 3:33 |  10.4 |
| code  | Coding schemes are in production tables             |         |       | 1:39 |   4.8 |
| code  | Add code generation support for domain types SQL    |         |       | 1:20 |   3.9 |
| code  | Refactor schema directories                         |         |       | 1:42 |   5.0 |
#+end:
...
*** STARTED Refactor schema directories                                :code:
    :LOGBOOK:
