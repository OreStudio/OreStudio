...
#+CAPTION: Clock summary at [2025-02-11 Tue 21:15]
|       | <75>                                   |         |       |      |       |
| Tags  | Headline                               | Time    |       |      |     % |
|-------+----------------------------------------+---------+-------+------+-------|
|       | *Total time*                           | *11:01* |       |      | 100.0 |
|-------+----------------------------------------+---------+-------+------+-------|
|       | Stories                                | 11:01   |       |      | 100.0 |
|       | Active                                 |         | 11:01 |      | 100.0 |
| agile | Sprint and product backlog refinement  |         |       | 1:22 |  12.4 |
| infra | Fix broken builds                      |         |       | 0:36 |   5.4 |
| code  | Create a containing structure for data |         |       | 0:35 |   5.3 |
| code  | Add temporal support to currencies     |         |       | 2:59 |  27.1 |
| code  | Add command to dump currencies         |         |       | 2:02 |  18.5 |
| code  | Refactor code for currencies           |         |       | 3:27 |  31.3 |
#+end:
