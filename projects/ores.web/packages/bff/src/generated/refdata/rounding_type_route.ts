 ...
 */
/**
 * How the BFF reaches the rounding_type service.
 *
 ...
 */
import { subjects } from '@ores/wire-protocol/generated/refdata/protocol/rounding_type_protocol';
...
export const roundingTypeRoute: EntityRouteDescriptor = {
  ...
  subjects: {
    ...
    save: subjects.put_rounding_type_request,
    remove: subjects.delete_rounding_type_request,
