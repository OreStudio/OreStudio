...
#include "ores.refdata.api/eventing/overnight_index_convention_event.hpp"
...
TEST_CASE("write_overnight_index_convention_publishes_an_event", tags) {
    ...
    using event_type = ores::refdata::messaging::overnight_index_convention_event;
