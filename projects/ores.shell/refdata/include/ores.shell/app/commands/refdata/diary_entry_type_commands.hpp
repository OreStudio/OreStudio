 ...
 */
#ifndef ORES_SHELL_APP_COMMANDS_DIARY_ENTRY_TYPE_COMMANDS_HPP
#define ORES_SHELL_APP_COMMANDS_DIARY_ENTRY_TYPE_COMMANDS_HPP
...
/**
 * @brief Every verb diary entry types answer, as one command each.
 *
 ...
 */
class diary_entry_type_commands {
private:
    inline static std::string_view logger_name =
        "ores.shell.app.commands.refdata.diary_entry_type_commands";
...
public:
    /**
     * @brief Register the diary entry types submenu.
     */
