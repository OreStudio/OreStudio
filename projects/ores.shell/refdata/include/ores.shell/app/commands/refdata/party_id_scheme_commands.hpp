 ...
 */
#ifndef ORES_SHELL_APP_COMMANDS_PARTY_ID_SCHEME_COMMANDS_HPP
#define ORES_SHELL_APP_COMMANDS_PARTY_ID_SCHEME_COMMANDS_HPP
...
/**
 * @brief Every verb party ID schemes answer, as one command each.
 *
 ...
 */
class party_id_scheme_commands {
private:
    inline static std::string_view logger_name =
        "ores.shell.app.commands.refdata.party_id_scheme_commands";
...
public:
    /**
     * @brief Register the party ID schemes submenu.
     */
    ...
    /**
     * @brief add <code> <name> <description> <coding_scheme_code> <display_order> <max_cardinality>
     * <reason> <commentary>
     */
    ...
    /**
     * @brief set <code> <name> <description> <coding_scheme_code> <display_order> <max_cardinality>
    ...
    /**
     * @brief put-many --count <n> <code> <name> <description> <coding_scheme_code> <display_order>
