...
#include "ores.iam.api/eventing/account_event.hpp"
...
register_account_event_mapping(ev::service::postgres_event_source& event_source,
    ...
    event_source.register_entity_event_mapping<iam::messaging::account_event>("ores_iam_accounts");

    return event_bus.subscribe<iam::messaging::account_event>(
        [&nats](const iam::messaging::account_event& e) {
            ...
            ev::service::publish_entity_event(
                nats, ev::domain::event_subject<iam::messaging::account_event>(e.action), e);
        });
}
