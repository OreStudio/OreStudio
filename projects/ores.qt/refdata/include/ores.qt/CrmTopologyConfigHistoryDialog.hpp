...
signals:
    void openVersionRequested(const refdata::domain::crm_topology_config& config,
                              int versionNumber);
    void revertVersionRequested(const refdata::domain::crm_topology_config& config);
...
private:
    ...
    std::vector<refdata::domain::crm_topology_config> versions_;
};
