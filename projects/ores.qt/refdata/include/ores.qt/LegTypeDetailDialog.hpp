 ...
 *
 */
#ifndef ORES_QT_LEG_TYPE_DETAIL_DIALOG_HPP
#define ORES_QT_LEG_TYPE_DETAIL_DIALOG_HPP
...
/**
 * @brief Detail dialog for viewing and editing leg type records.
 *
 * This dialog allows viewing, creating, and editing leg types.
 * It supports both create mode (for new records) and edit mode (for
 * existing records).
 */
class LegTypeDetailDialog final : public DetailDialogBase {
    Q_OBJECT

private:
    inline static std::string_view logger_name = "ores.qt.leg_type_detail_dialog";
...
public:
    explicit LegTypeDetailDialog(QWidget* parent = nullptr);
    ~LegTypeDetailDialog() override;
