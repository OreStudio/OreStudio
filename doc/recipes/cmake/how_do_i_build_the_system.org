...
dash-truncated template drop-in (same mechanism as [[id:3FED1AAE-009B-4307-866C-E1C092EA17BE][How do I launch
...
#+begin_src sh :results verbatim
systemd-cgls --user-unit=app-build-<env>.slice
systemctl --user show app-build-<env>.slice -p MemoryMax -p CPUWeight
#+end_src
...
syncing
[[proj:projects/ores.compass/src/systemd/app-build-.slice.d/50-limits.conf][=projects/ores.compass/src/systemd/app-build-.slice.d/50-limits.conf=]].
