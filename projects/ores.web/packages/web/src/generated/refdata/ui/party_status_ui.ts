 ...
 */
export const partyStatusMessages = {
        party_status: {
            title: 'Party Statuses',
            singular: 'party status',
            newTitle: 'New party status',
            description: 'Reference data table defining valid party status values. Examples: \'Active\', \'Inactive\', \'Suspended\'. Party statuses are managed by the system tenant and are used to track the lifecycle of party and counterparty records.',
            fldCode: 'Code',
            codePh: 'Enter status code',
            fldName: 'Name',
            namePh: 'Enter status name',
