 ...
 *
 */
#ifndef ORES_TRADING_API_MESSAGING_SWAPTION_INSTRUMENT_PROTOCOL_HPP
#define ORES_TRADING_API_MESSAGING_SWAPTION_INSTRUMENT_PROTOCOL_HPP
...
struct get_swaption_instruments_response {
    std::vector<ores::trading::domain::swaption_instrument> swaption_instruments;
...
struct save_swaption_instrument_request {
    ...
    static save_swaption_instrument_request from(ores::trading::domain::swaption_instrument v) {
