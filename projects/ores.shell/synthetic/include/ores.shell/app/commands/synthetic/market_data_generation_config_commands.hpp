 ...
 */
#ifndef ORES_SHELL_APP_COMMANDS_MARKET_DATA_GENERATION_CONFIG_COMMANDS_HPP
#define ORES_SHELL_APP_COMMANDS_MARKET_DATA_GENERATION_CONFIG_COMMANDS_HPP
...
/**
 * @brief Every verb market data generation configs answer, as one command each.
 *
 ...
 */
class market_data_generation_config_commands {
private:
    inline static std::string_view logger_name =
        "ores.shell.app.commands.synthetic.market_data_generation_config_commands";
...
public:
    /**
     * @brief Register the market data generation configs submenu.
     */
    ...
    /**
     * @brief set <id> <scope> <binding_mode> <name> <description> <enabled> <dataset_id> <reason>
    ...
    /**
     * @brief put-many --count <n> <id> <scope> <binding_mode> <name> <description> <enabled>
