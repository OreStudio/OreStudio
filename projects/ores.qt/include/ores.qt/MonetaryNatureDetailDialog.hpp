 ...
 * existing records).
 */
class MonetaryNatureDetailDialog final : public DetailDialogBase {
    Q_OBJECT
...
public:
    explicit MonetaryNatureDetailDialog(QWidget* parent = nullptr);
    ~MonetaryNatureDetailDialog() override;
...
private:
    ...
    refdata::domain::monetary_nature type_;
