...
TEST_CASE("write_pricing_engine_type_publishes_an_event", tags) {
    ...
    using event_type = ores::analytics::messaging::pricing_engine_type_event;
    ...
    event_source.register_entity_event_mapping<event_type>("ores_analytics_pricing_engine_types");
