 ...
 *
 */
#ifndef ORES_REPORTING_CORE_REPOSITORY_REPORT_TYPE_MAPPER_HPP
#define ORES_REPORTING_CORE_REPOSITORY_REPORT_TYPE_MAPPER_HPP
...
/**
 * @brief Maps report_type domain entities to data storage layer and vice-versa.
 */
