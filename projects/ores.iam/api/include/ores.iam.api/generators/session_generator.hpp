 ...
 */
#ifndef ORES_IAM_API_GENERATORS_SESSION_GENERATOR_HPP
#define ORES_IAM_API_GENERATORS_SESSION_GENERATOR_HPP
 ...
 */
ORES_IAM_API_EXPORT domain::session
generate_synthetic_session(utility::generation::generation_context& ctx);
