...
register_folder_event_mapping(ev::service::postgres_event_source& event_source,
    ...
    event_source.register_entity_event_mapping<synthetic::messaging::folder_event>(
        "ores_synthetic_folders");

    return event_bus.subscribe<synthetic::messaging::folder_event>(
        [&nats](const synthetic::messaging::folder_event& e) {
            ...
            ev::service::publish_entity_event(
                nats, ev::domain::event_subject<synthetic::messaging::folder_event>(e.action), e);
        });
}
