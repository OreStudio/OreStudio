...
register_business_centre_event_mapping(ev::service::postgres_event_source& event_source,
    ...
    ev::service::registrar::register_mapping<refdata::eventing::business_centre_changed_event>(
        event_source, "ores.refdata.business_centre", "ores_refdata_business_centres");

    return event_bus.subscribe<refdata::eventing::business_centre_changed_event>(
        [&nats](const refdata::eventing::business_centre_changed_event& e) {
            ev::service::publish_entity_event(
                nats,
                std::string(ev::domain::event_traits<
                            refdata::eventing::business_centre_changed_event>::name),
