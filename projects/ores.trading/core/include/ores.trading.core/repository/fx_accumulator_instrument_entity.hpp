 ...
 *
 */
#ifndef ORES_TRADING_CORE_REPOSITORY_FX_ACCUMULATOR_INSTRUMENT_ENTITY_HPP
#define ORES_TRADING_CORE_REPOSITORY_FX_ACCUMULATOR_INSTRUMENT_ENTITY_HPP
...
/**
 * @brief Represents a fx accumulator instrument in the database.
 */
