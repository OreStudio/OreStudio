...
- Invoking the skill reads [[proj:doc/llm/runbooks/runbooks.org][=doc/llm/runbooks/runbooks.org=]], matches the user's request to the closest runbook, and executes it step by step.
