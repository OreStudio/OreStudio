...
#+description: Codegen entity model for the database =database_info= table. Drives the C++ domain class, mapper, repository, service, generator, and SQL schema generation from a single literate source.
