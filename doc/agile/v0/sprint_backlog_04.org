...
#+CAPTION: Clock summary at [2025-11-09 Sun 02:21], for Sunday, November 09, 2025.
|      | <75>                                   |        |      |      |       |
| Tags | Headline                               | Time   |      |      |     % |
|------+----------------------------------------+--------+------+------+-------|
...
|      | Stories                                | 1:34   |      |      | 100.0 |
|      | Active                                 |        | 1:34 |      | 100.0 |
| code | Add about to menu                      |        |      | 0:07 |   7.4 |
| code | Create a history dialog for currencies |        |      | 1:27 |  92.6 |
#+end:

#+begin: clocktable :maxlevel 3 :scope subtree :tags t :indent nil :emphasize nil :scope file :narrow 75 :formula %
#+TBLNAME: sprint_summary
#+CAPTION: Clock summary at [2025-11-09 Sun 02:21]
|       | <75>                                                   |         |       |       |       |
| Tags  | Headline                                               | Time    |       |       |     % |
|-------+--------------------------------------------------------+---------+-------+-------+-------|
...
|       | Stories                                                | 26:02   |       |       | 100.0 |
|       | Active                                                 |         | 26:02 |       | 100.0 |
| agile | Sprint and product backlog refinement                  |         |       |  0:43 |   2.8 |
| code  | Clean up client parser                                 |         |       |  0:10 |   0.6 |
| code  | Add connect command line argument                      |         |       |  1:19 |   5.1 |
| infra | Install Windows package on Windows machine             |         |       |  2:09 |   8.3 |
| code  | Ignore warnings on windows and osx                     |         |       |  0:33 |   2.1 |
| code  | Ensure applications work under OSX using github images |         |       |  0:14 |   0.9 |
| infra | Create a splash screen and gray background             |         |       |  2:26 |   9.3 |
| code  | Use fluent icons                                       |         |       |  0:37 |   2.4 |
| code  | Add export functionality for currencies                |         |       |  1:30 |   5.8 |
| code  | Add currency editing support                           |         |       |  2:45 |  10.6 |
| code  | Add about to menu                                      |         |       |  1:02 |   4.0 |
| code  | Create a history dialog for currencies                 |         |       |  1:27 |   5.6 |
| code  | Make UI/UX look more professional                      |         |       | 11:07 |  42.7 |
#+end:
...
Users should be able to select multiple currencies and delete them.
...
one go directly in the grid.

*** Do not auto maximise windows                                       :code:

Every time we select currencies or history the new window is maximised. If there
is a previous window we should just reuse it.

*** Allow MDI windows outside main window                              :code:
