...
nest. NOTE: the entity templates do not consume these annotations yet;
until that lands, regeneration of the domain/repository profiles would
emit the obsolete flat shape — do not regenerate those profiles for
instruments.
