 ...
 *
 */
#ifndef ORES_TRADE_EVENTING_TRADE_CHANGED_EVENT_HPP
#define ORES_TRADE_EVENTING_TRADE_CHANGED_EVENT_HPP
 ...
 */
template<>
struct event_traits<ores::trade::eventing::trade_changed_event> {
    static constexpr std::string_view name = "ores.trade.trade_changed";
};
