...
#+CAPTION: Clock summary at [2026-01-08 Thu 13:48], for Thursday, January 08, 2026.
|       | <75>                                   |        |      |      |       |
| Tags  | Headline                               | Time   |      |      |     % |
|-------+----------------------------------------+--------+------+------+-------|
|       | *Total time*                           | *5:32* |      |      | 100.0 |
|-------+----------------------------------------+--------+------+------+-------|
|       | Stories                                | 5:32   |      |      | 100.0 |
|       | Active                                 |        | 5:32 |      | 100.0 |
| agile | Sprint and product backlog refinement  |        |      | 0:33 |   9.9 |
| code  | Assorted fixes to feature flags dialog |        |      | 2:52 |  51.8 |
| code  | Assorted fixes to currencies dialog    |        |      | 2:07 |  38.3 |
#+end:

#+begin: clocktable :maxlevel 3 :scope subtree :tags t :indent nil :emphasize nil :scope file :narrow 75 :formula %
#+TBLNAME: sprint_summary
#+CAPTION: Clock summary at [2026-01-08 Thu 13:48]
|       | <75>                                        |         |       |       |       |
| Tags  | Headline                                    | Time    |       |       |     % |
|-------+---------------------------------------------+---------+-------+-------+-------|
|       | *Total time*                                | *48:13* |       |       | 100.0 |
|-------+---------------------------------------------+---------+-------+-------+-------|
|       | Stories                                     | 48:13   |       |       | 100.0 |
|       | Active                                      |         | 48:13 |       | 100.0 |
| agile | Sprint and product backlog refinement       |         |       |  1:50 |   3.8 |
| code  | Rerun SQL scripts from scratch              |         |       |  7:52 |  16.3 |
| code  | Run qt client and validate all new features |         |       |  1:19 |   2.7 |
| code  | Refactor options and parser                 |         |       |  0:27 |   0.9 |
| code  | Check functionality in =ores.wt=            |         |       |  2:03 |   4.3 |
| code  | Rename =ores.shell= to =ores.comms.shell=   |         |       |  1:30 |   3.1 |
| code  | Review HTTP service                         |         |       |  7:24 |  15.3 |
| code  | Assorted fixes to currency dialog           |         |       |  4:19 |   9.0 |
| code  | Add support for offsets in pagination       |         |       |  1:46 |   3.7 |
| code  | Assorted fixes to feature flags dialog      |         |       |  2:52 |   5.9 |
| code  | Assorted fixes to currencies dialog         |         |       |  4:36 |   9.5 |
| code  | Add country support                         |         |       |  1:37 |   3.4 |
| code  | Review comms analyser work                  |         |       |  0:27 |   0.9 |
| code  | Review telemetry work                       |         |       | 10:11 |  21.1 |
#+end:
...
- updating flag does not seem to update after reload.
- can't see flag changes in history.
...
*** STARTED Add country support                                        :code:
    :LOGBOOK:
