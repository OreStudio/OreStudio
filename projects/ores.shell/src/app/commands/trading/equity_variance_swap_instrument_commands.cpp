...
void equity_variance_swap_instrument_commands::register_commands(cli::Menu& root_menu,
    ...
    equity_variance_swap_instruments_menu->Insert(
        ...
        [&session](std::ostream& out,
            ...
            process_add_equity_variance_swap_instrument(std::ref(out),
                                                        std::ref(session),
        ...
        "Add an Equity variance swap instrument (trade_type_code underlying_name currency notional "
        "variance_strike start_date maturity_date long_short [description] change_reason_code "
        "\"change_commentary\")",
        {"trade_type_code underlying_name currency notional variance_strike start_date "
         "maturity_date long_short description change_reason_code change_commentary"});
...
void equity_variance_swap_instrument_commands::process_get_equity_variance_swap_instruments(
    ...
    BOOST_LOG_SEV(lg(), debug) << "Initiating get Equity variance swap instruments request.";
...
void equity_variance_swap_instrument_commands::process_add_equity_variance_swap_instrument(
    ...
    v.notional = notional;
    v.variance_strike = variance_strike;
