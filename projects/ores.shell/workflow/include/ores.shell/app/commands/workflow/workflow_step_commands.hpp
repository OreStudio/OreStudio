 ...
 */
#ifndef ORES_SHELL_APP_COMMANDS_WORKFLOW_STEP_COMMANDS_HPP
#define ORES_SHELL_APP_COMMANDS_WORKFLOW_STEP_COMMANDS_HPP
...
/**
 * @brief Every verb workflow steps answer, as one command each.
 *
 ...
 */
class workflow_step_commands {
private:
    inline static std::string_view logger_name =
        "ores.shell.app.commands.workflow.workflow_step_commands";
...
public:
    /**
     * @brief Register the workflow steps submenu.
     */
    ...
    /**
     * @brief by-workflow-id <workflow_id> [--offset <n>] [--limit <n>] [--order <field>] [--desc]
     */
    static void process_by_workflow_id(std::ostream& out,
                                       ores::nats::service::nats_client& session,
                                       const std::vector<std::string>& args);
