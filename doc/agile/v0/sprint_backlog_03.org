...
#+CAPTION: Clock summary at [2025-10-31 Fri 22:15], for Friday, October 31, 2025.
|      | <75>                                      |        |      |      |       |
| Tags | Headline                                  | Time   |      |      |     % |
|------+-------------------------------------------+--------+------+------+-------|
...
|      | Stories                                   | 2:06   |      |      | 100.0 |
|      | Active                                    |        | 2:06 |      | 100.0 |
| code | Consider adding a postgres database to CI |        |      | 2:06 | 100.0 |
#+end:

#+begin: clocktable :maxlevel 3 :scope subtree :tags t :indent nil :emphasize nil :scope file :narrow 75 :formula %
#+TBLNAME: sprint_summary
#+CAPTION: Clock summary at [2025-10-31 Fri 22:16]
|       | <75>                                                   |         |       |      |       |
| Tags  | Headline                                               | Time    |       |      |     % |
|-------+--------------------------------------------------------+---------+-------+------+-------|
...
|       | Stories                                                | 47:05   |       |      | 100.0 |
|       | Active                                                 |         | 47:05 |      | 100.0 |
| agile | Sprint and product backlog refinement                  |         |       | 1:24 |   3.0 |
| code  | Add locking up logic                                   |         |       | 1:28 |   3.1 |
| code  | Build using dynamic libraries                          |         |       | 7:24 |  15.7 |
| code  | Enable qt gui                                          |         |       | 4:13 |   9.0 |
| code  | Add locking up logic                                   |         |       | 1:28 |   3.1 |
| code  | Build using dynamic libraries                          |         |       | 7:24 |  15.7 |
| code  | Implement logging according to correct boost.log usage |         |       | 8:02 |  17.1 |
| code  | Fix broken Linux and OSX tests                         |         |       | 0:10 |   0.4 |
| code  | Fix broken windows builds                              |         |       | 2:35 |   5.5 |
| code  | Investigate leaks from valgrind                        |         |       | 0:51 |   1.8 |
| code  | Fix misspell that causes build to break                |         |       | 0:12 |   0.4 |
| code  | Add support for feature flags                          |         |       | 1:25 |   3.0 |
| code  | Implement authentication bootstrap workflow            |         |       | 0:25 |   0.9 |
| code  | Consider adding a postgres database to CI              |         |       | 8:51 |  18.8 |
...
*** STARTED Consider adding a postgres database to CI                  :code:
    :LOGBOOK:
