...
private:
    inline static std::string_view logger_name =
        "ores.qt.client_pricing_model_product_parameter_model";
...
public:
    ...
    /**
     * @brief Get pricing model product parameter at the specified row.
     *
...
private:
    ...
    void fetch_parameters(std::uint32_t offset, std::uint32_t limit);

    ClientManager* clientManager_;
    std::vector<analytics::domain::pricing_model_product_parameter> parameters_;
