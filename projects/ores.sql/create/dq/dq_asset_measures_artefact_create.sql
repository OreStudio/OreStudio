...
create table if not exists "ores"."dq_asset_measures_artefact_tbl" (
...
on "ores"."dq_asset_measures_artefact_tbl" (dataset_id);

create index if not exists dq_asset_measures_artefact_code_idx
on "ores"."dq_asset_measures_artefact_tbl" (code);

create index if not exists dq_asset_measures_artefact_coding_scheme_idx
on "ores"."dq_asset_measures_artefact_tbl" (coding_scheme_code);
