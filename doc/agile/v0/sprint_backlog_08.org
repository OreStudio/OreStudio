...
#+CAPTION: Clock summary at [2026-01-06 Tue 11:47], for Tuesday, January 06, 2026.
|      | <75>                              |        |      |      |       |
| Tags | Headline                          | Time   |      |      |     % |
|------+-----------------------------------+--------+------+------+-------|
...
|      | Stories                           | 4:54   |      |      | 100.0 |
|      | Active                            |        | 4:54 |      | 100.0 |
| code | Review HTTP service               |        |      | 3:10 |  64.6 |
| code | Assorted fixes to currency dialog |        |      | 1:44 |  35.4 |
#+end:

#+begin: clocktable :maxlevel 3 :scope subtree :tags t :indent nil :emphasize nil :scope file :narrow 75 :formula %
#+TBLNAME: sprint_summary
#+CAPTION: Clock summary at [2026-01-06 Tue 11:47]
|       | <75>                                        |         |       |      |       |
| Tags  | Headline                                    | Time    |       |      |     % |
|-------+---------------------------------------------+---------+-------+------+-------|
...
|       | Stories                                     | 26:11   |       |      | 100.0 |
|       | Active                                      |         | 26:11 |      | 100.0 |
| agile | Sprint and product backlog refinement       |         |       | 1:17 |   4.9 |
| code  | Rerun SQL scripts from scratch              |         |       | 7:52 |  30.0 |
| code  | Run qt client and validate all new features |         |       | 1:19 |   5.0 |
| code  | Refactor options and parser                 |         |       | 0:27 |   1.7 |
| code  | Check functionality in =ores.wt=            |         |       | 2:03 |   7.8 |
| code  | Rename =ores.shell= to =ores.comms.shell=   |         |       | 1:30 |   5.7 |
| code  | Review HTTP service                         |         |       | 7:24 |  28.3 |
| code  | Assorted fixes to currency dialog           |         |       | 4:19 |  16.5 |
#+end:
