 ...
 *
 */
#ifndef ORES_QT_CLIENT_MARKET_DATA_GENERATION_CONFIG_MODEL_HPP
#define ORES_QT_CLIENT_MARKET_DATA_GENERATION_CONFIG_MODEL_HPP
...
private:
    inline static std::string_view logger_name =
        "ores.qt.client_market_data_generation_config_model";
...
public:
    ...
    ~ClientMarketDataGenerationConfigModel() override = default;
    ...
    /**
     * @brief Refresh market data generation config data from server asynchronously.
     */
    void refresh();
