...
#+CAPTION: Clock summary at [2026-01-08 Thu 10:32], for Thursday, January 08, 2026.
|       | <75>                                  |        |      |      |       |
| Tags  | Headline                              | Time   |      |      |     % |
|-------+---------------------------------------+--------+------+------+-------|
|       | *Total time*                          | *2:40* |      |      | 100.0 |
|-------+---------------------------------------+--------+------+------+-------|
|       | Stories                               | 2:40   |      |      | 100.0 |
|       | Active                                |        | 2:40 |      | 100.0 |
| agile | Sprint and product backlog refinement |        |      | 0:33 |  20.6 |
| code  | Assorted fixes to currencies dialog   |        |      | 2:07 |  79.4 |
#+end:

#+begin: clocktable :maxlevel 3 :scope subtree :tags t :indent nil :emphasize nil :scope file :narrow 75 :formula %
#+TBLNAME: sprint_summary
#+CAPTION: Clock summary at [2026-01-08 Thu 10:32]
|       | <75>                                        |         |       |       |       |
| Tags  | Headline                                    | Time    |       |       |     % |
|-------+---------------------------------------------+---------+-------+-------+-------|
...
|       | Stories                                     | 45:21   |       |       | 100.0 |
|       | Active                                      |         | 45:21 |       | 100.0 |
| agile | Sprint and product backlog refinement       |         |       |  1:50 |   4.0 |
| code  | Rerun SQL scripts from scratch              |         |       |  7:52 |  17.3 |
| code  | Run qt client and validate all new features |         |       |  1:19 |   2.9 |
| code  | Refactor options and parser                 |         |       |  0:27 |   1.0 |
| code  | Check functionality in =ores.wt=            |         |       |  2:03 |   4.5 |
| code  | Rename =ores.shell= to =ores.comms.shell=   |         |       |  1:30 |   3.3 |
| code  | Review HTTP service                         |         |       |  7:24 |  16.3 |
| code  | Assorted fixes to currency dialog           |         |       |  4:19 |   9.5 |
| code  | Add support for offsets in pagination       |         |       |  1:46 |   3.9 |
| code  | Assorted fixes to currencies dialog         |         |       |  4:36 |  10.1 |
| code  | Add country support                         |         |       |  1:37 |   3.6 |
| code  | Review comms analyser work                  |         |       |  0:27 |   1.0 |
| code  | Review telemetry work                       |         |       | 10:11 |  22.5 |
#+end:
