 ...
 *
 */
#ifndef ORES_COMMS_SERVICE_APP_APPLICATION_HPP
#define ORES_COMMS_SERVICE_APP_APPLICATION_HPP
...
private:
    inline static std::string_view logger_name = "ores.comms.service.app.application";
