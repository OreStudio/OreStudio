 ...
 *
 */
#ifndef ORES_REFDATA_CORE_REPOSITORY_CONTACT_TYPE_ENTITY_HPP
#define ORES_REFDATA_CORE_REPOSITORY_CONTACT_TYPE_ENTITY_HPP
...
/**
 * @brief Represents a contact type in the database.
 */
struct contact_type_entity {
    constexpr static const char* schema = "public";
    constexpr static const char* tablename = "ores_refdata_contact_types_tbl";
