 ...
 *
 */
#ifndef ORES_TRADE_REPOSITORY_TRADE_IDENTIFIER_MAPPER_HPP
#define ORES_TRADE_REPOSITORY_TRADE_IDENTIFIER_MAPPER_HPP
...
/**
 * @brief Maps trade_identifier domain entities to data storage layer and vice-versa.
 */
class trade_identifier_mapper {
private:
    inline static std::string_view logger_name =
        "ores.trade.repository.trade_identifier_mapper";
