...
{{#is_date}}
    std::string {{name}};
{{/is_date}}
{{^is_uuid}}{{^is_optional_uuid}}{{^is_optional_timestamp}}{{^is_required_timestamp}}{{^is_date}}
    {{{cpp_type}}} {{name}}{{#default_value}} = {{{default_value}}}{{/default_value}};
{{/is_date}}{{/is_required_timestamp}}{{/is_optional_timestamp}}{{/is_optional_uuid}}{{/is_uuid}}
{{/columns}}
    std::string modified_by;
    std::string performed_by;
    std::string change_reason_code;
