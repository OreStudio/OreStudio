...
public:
    ...
    /**
     * @brief Writes a calendar event, honouring the claim it states.
     *
    ...
    /**
     * @brief Writes a set of calendar events, each honouring its own
    ...
    /**
     * @brief Removes a calendar event, refusing a row that moved on.
     *
...
private:
     ...
     */
    ores::utility::domain::precondition replace_claim(context ctx, const domain::calendar_event& v);
     ...
     */
    domain::calendar_event apply_claim(context ctx,
                                       const domain::calendar_event& v,
                                       const ores::utility::domain::precondition& claim);
};
