...
Write [[proj:doc/llm/llm_first.org][=doc/llm/llm_first.org=]] — a knowledge page that articulates
...
- [[proj:doc/llm/llm_first.org][=doc/llm/llm_first.org=]] exists with v2 frontmatter and org-roam ID.
...
PR #906 merged. [[proj:doc/llm/llm_first.org][=doc/llm/llm_first.org=]] written and wired into =llm.org=.
One Gemini comment accepted: removed duplicated [[proj:.claude][=.claude/=]] paths in favour
