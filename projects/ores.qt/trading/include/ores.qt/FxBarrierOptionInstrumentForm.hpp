 ...
 *
 */
#ifndef ORES_QT_FX_BARRIER_OPTION_INSTRUMENT_FORM_HPP
#define ORES_QT_FX_BARRIER_OPTION_INSTRUMENT_FORM_HPP
...
/**
 * @brief IInstrumentForm for FX Barrier Option trades.
 *
 * Handles: FxBarrierOption, FxDoubleBarrierOption, FxEuropeanBarrierOption,
 * FxKIKOBarrierOption, FxGenericBarrierOption.
 */
class FxBarrierOptionInstrumentForm final : public IInstrumentForm {
    Q_OBJECT

private:
    inline static std::string_view logger_name = "ores.qt.fx_barrier_option_instrument_form";
...
public:
    explicit FxBarrierOptionInstrumentForm(QWidget* parent = nullptr);
    ~FxBarrierOptionInstrumentForm() override;
...
private:
    ...
    Ui::FxBarrierOptionInstrumentForm* ui_;
    ClientManager* clientManager_ = nullptr;
    ImageCache* imageCache_ = nullptr;
    std::string username_;
    trading::domain::fx_barrier_option_instrument instrument_;
    bool dirty_ = false;
    bool loaded_ = false;
};
