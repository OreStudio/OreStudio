...
values
    ...
    (ores_utility_system_tenant_id_fn(), :'v_dataset_id', 'asset_class', 0, 'Asset Class', 'Top-level product classification codes (fx, interest_rates, credit, equity, commodity, inflation, bond), shown on instrument_code and asset_class_code.', 30),
