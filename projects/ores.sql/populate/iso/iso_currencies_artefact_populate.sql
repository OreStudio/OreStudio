...
begin
    ...
    from (values
        ...
        ('CLP', 'Chilean Peso', '152', '$', '', 0, 'Closest', 0, '$#,##0', 'fiat.emerging', 'cl', 2, false, 'ACT/360', 100, null),
        ('COP', 'Colombian Peso', '170', '$', '¢', 100, 'Closest', 2, '$#,##0.00', 'fiat.emerging', 'co', 2, false, 'ACT/360', 100, null),
        ('PEN', 'Peruvian Sol', '604', 'S/', '¢', 100, 'Closest', 2, 'S/#,##0.00', 'fiat.emerging', 'pe', 2, false, 'ACT/360', 100, null),
        ...
        ('UAH', 'Ukrainian Hryvnia', '980', '₴', 'к', 100, 'Closest', 2, '#,##0.00 ₴', 'fiat.emerging', 'ua', 2, false, 'ACT/360', 100, null),
        ...
        ('GHS', 'Ghanaian Cedi', '936', 'GH₵', 'p', 100, 'Closest', 2, 'GH₵#,##0.00', 'fiat.emerging', 'gh', 2, false, 'ACT/360', 100, null),
        ...
        ('ZMW', 'Zambian Kwacha', '967', 'ZK', 'n', 100, 'Closest', 2, 'ZK#,##0.00', 'fiat.emerging', 'zm', 2, false, 'ACT/360', 100, null),
