 ...
 */
#ifndef ORES_IAM_API_EVENTING_ACCOUNT_CHANGED_EVENT_HPP
#define ORES_IAM_API_EVENTING_ACCOUNT_CHANGED_EVENT_HPP
 ...
 *
 * Published when any account entity is created, updated, or
...
struct account_changed_event final {
    ...
    /**
     * @brief Changed account UUIDs (as strings).
     */
