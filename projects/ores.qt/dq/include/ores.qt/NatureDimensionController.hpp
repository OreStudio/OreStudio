 ...
 *
 */
#ifndef ORES_QT_NATURE_DIMENSION_CONTROLLER_HPP
#define ORES_QT_NATURE_DIMENSION_CONTROLLER_HPP
...
private:
    inline static std::string_view logger_name = "ores.qt.nature_dimension_controller";
...
public:
    NatureDimensionController(QMainWindow* mainWindow,
                              QMdiArea* mdiArea,
...
private slots:
    ...
    void onOpenVersion(const dq::domain::nature_dimension& dimension, int versionNumber);
