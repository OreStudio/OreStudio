...
public:
    ...
    list_account_types(const messaging::list_account_types_request& request);
    messaging::get_account_type_response
    get_account_type(const messaging::get_account_type_request& request);
    messaging::get_many_account_types_response
    get_many_account_types(const messaging::get_many_account_types_request& request);
    messaging::put_account_type_response
    put_account_type(const messaging::put_account_type_request& request);
    messaging::put_many_account_types_response
    put_many_account_types(const messaging::put_many_account_types_request& request);
    messaging::delete_account_type_response
    delete_account_type(const messaging::delete_account_type_request& request);
    messaging::delete_many_account_types_response
    delete_many_account_types(const messaging::delete_many_account_types_request& request);
    messaging::list_account_type_versions_response
    list_account_type_versions(const messaging::list_account_type_versions_request& request);
    messaging::get_account_type_version_response
    get_account_type_version(const messaging::get_account_type_version_request& request);
    /**@}*/
    ...
    /**
     * @brief Retrieves a batch of account types by primary key.
     */
    std::vector<domain::account_type> get_types(const std::vector<std::string>& types);
...
private:
     ...
     */
    ores::utility::domain::result prepare_change(const messaging::account_type_change& change,
