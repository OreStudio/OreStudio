:PROPERTIES:
:ID: F4E2C689-4175-4FC0-9B48-A1F32E2F7FE5
:END:
#+title: ores.cpp.non-temporal-repository
#+description: Non-temporal repository variant.
#+type: facet
#+level: cross
...
This page is the literate source for the =ores.cpp.non-temporal-repository= facet of the
...
* The ores.cpp.non-temporal-repository facet
...
|-----------+-------------|
| [[id:621ACCCA-FEB3-499F-B759-6B86715553A9][ores.cpp.non-temporal-repository.entity_non_temporal_header]] | Non-temporal twin of the entity header. =non-temporal-repository= profile. |
| [[id:58DA0C72-B2FA-43FE-BB38-F7BDBE4320FA][ores.cpp.non-temporal-repository.entity_non_temporal_impl]] | Non-temporal twin of the entity impl. =non-temporal-repository= profile. |
| [[id:4CCF4AEE-2435-4272-A84C-5960836214A0][ores.cpp.non-temporal-repository.mapper_non_temporal_header]] | Non-temporal mapper declarations. =non-temporal-repository= profile. |
| [[id:E573F433-A2F4-4F3F-8C10-9C4F1AA68D1A][ores.cpp.non-temporal-repository.mapper_non_temporal_impl]] | Non-temporal mapper implementation. =non-temporal-repository= profile. |
| [[id:19581485-AA07-4571-859C-077FAEE4843D][ores.cpp.non-temporal-repository.repository_non_temporal_header]] | Non-temporal repository declarations. =non-temporal-repository= profile. |
| [[id:A280EC2D-13BE-4E4C-8A95-D355E1D971D0][ores.cpp.non-temporal-repository.repository_non_temporal_impl]] | Non-temporal repository implementation. =non-temporal-repository= profile. |
