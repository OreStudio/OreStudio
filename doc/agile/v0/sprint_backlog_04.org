...
#+CAPTION: Clock summary at [2025-11-11 Tue 18:15], for Tuesday, November 11, 2025.
|       | <75>                                                |         |       |      |       |
| Tags  | Headline                                            | Time    |       |      |     % |
|-------+-----------------------------------------------------+---------+-------+------+-------|
|       | *Total time*                                        | *10:34* |       |      | 100.0 |
|-------+-----------------------------------------------------+---------+-------+------+-------|
|       | Stories                                             | 10:34   |       |      | 100.0 |
|       | Active                                              |         | 10:34 |      | 100.0 |
| agile | Sprint and product backlog refinement               |         |       | 0:02 |   0.3 |
| code  | Create a skill for plant uml documentation          |         |       | 2:31 |  23.8 |
| infra | Add CMake targets for site and skills               |         |       | 0:17 |   2.7 |
| infra | Generalise the skill setup for ORE Studio           |         |       | 3:45 |  35.5 |
| infra | Restructure components to follow the dogen approach |         |       | 2:54 |  27.4 |
| infra | Generate PlantUML diagrams for all components       |         |       | 1:05 |  10.3 |
#+end:

#+begin: clocktable :maxlevel 3 :scope subtree :tags t :indent nil :emphasize nil :scope file :narrow 75 :formula %
#+TBLNAME: sprint_summary
#+CAPTION: Clock summary at [2025-11-11 Tue 18:16]
|          | <75>                                                   |         |       |       |       |
| Tags     | Headline                                               | Time    |       |       |     % |
|----------+--------------------------------------------------------+---------+-------+-------+-------|
|          | *Total time*                                           | *50:34* |       |       | 100.0 |
|----------+--------------------------------------------------------+---------+-------+-------+-------|
|          | Stories                                                | 50:34   |       |       | 100.0 |
|          | Active                                                 |         | 50:34 |       | 100.0 |
| agile    | Sprint and product backlog refinement                  |         |       |  2:02 |   4.0 |
| code     | Clean up client parser                                 |         |       |  0:10 |   0.3 |
| code     | Add connect command line argument                      |         |       |  1:19 |   2.6 |
| infra    | Install Windows package on Windows machine             |         |       |  2:09 |   4.3 |
| code     | Ignore warnings on windows and osx                     |         |       |  0:33 |   1.1 |
| code     | Ensure applications work under OSX using github images |         |       |  0:14 |   0.5 |
| infra    | Create a splash screen and gray background             |         |       |  2:26 |   4.8 |
| code     | Use fluent icons                                       |         |       |  0:37 |   1.2 |
| code     | Add export functionality for currencies                |         |       |  1:30 |   3.0 |
| code     | Add currency editing support                           |         |       |  2:45 |   5.4 |
| code     | Add about to menu                                      |         |       |  1:02 |   2.0 |
| code     | Create a history dialog for currencies                 |         |       |  1:27 |   2.9 |
| code     | Allow MDI windows outside main window                  |         |       |  1:35 |   3.1 |
| code     | Add edit menu and export menu                          |         |       |  0:34 |   1.1 |
| code     | Implement adding new currencies                        |         |       |  3:17 |   6.5 |
| code     | Clean up product website                               |         |       |  4:42 |   9.3 |
| code     | Create a skill for plant uml documentation             |         |       |  2:48 |   5.5 |
| infra    | Add CMake targets for site and skills                  |         |       |  0:17 |   0.6 |
| infra    | Generalise the skill setup for ORE Studio              |         |       |  3:45 |   7.4 |
| infra    | Restructure components to follow the dogen approach    |         |       |  2:54 |   5.7 |
| infra    | Generate PlantUML diagrams for all components          |         |       |  1:05 |   2.1 |
| code     | Make UI/UX look more professional                      |         |       | 11:07 |  22.0 |
| code     | Current issues with package install in debian          |         |       |  0:40 |   1.3 |
| code     | Resolve crash on shutdown problem                      |         |       |  0:50 |   1.6 |
| analysis | Weaving skills and documentation together              |         |       |  0:46 |   1.5 |
#+end:
...
*** Generate a pie chart for tasks in org via R                        :code:
