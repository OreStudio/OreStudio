 ...
 */
#ifndef ORES_SHELL_APP_COMMANDS_PARTY_STATUS_COMMANDS_HPP
#define ORES_SHELL_APP_COMMANDS_PARTY_STATUS_COMMANDS_HPP
...
/**
 * @brief Every verb party statuses answer, as one command each.
 *
 ...
 */
class party_status_commands {
private:
    inline static std::string_view logger_name =
        "ores.shell.app.commands.refdata.party_status_commands";
...
public:
    /**
     * @brief Register the party statuses submenu.
     */
