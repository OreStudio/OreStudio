 ...
 *
 */
#ifndef ORES_TRADE_REPOSITORY_LIFECYCLE_EVENT_ENTITY_HPP
#define ORES_TRADE_REPOSITORY_LIFECYCLE_EVENT_ENTITY_HPP
...
struct lifecycle_event_entity {
    ...
    constexpr static const char* tablename = "ores_trade_lifecycle_events_tbl";
