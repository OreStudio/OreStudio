...
| [[id:68FFB616-C71D-4701-AEA1-52DE4973D2AB][Show blocked story dependency tree in compass where]] | BACKLOG | | | compass where shows STARTED items but not blocked chains (story C blocked by B blocked by A); surface the dependency tree with root causes in the Orient output. |
