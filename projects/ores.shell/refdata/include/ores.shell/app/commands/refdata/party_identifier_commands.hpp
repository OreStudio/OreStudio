 ...
 */
#ifndef ORES_SHELL_APP_COMMANDS_PARTY_IDENTIFIER_COMMANDS_HPP
#define ORES_SHELL_APP_COMMANDS_PARTY_IDENTIFIER_COMMANDS_HPP
...
/**
 * @brief Every verb party identifiers answer, as one command each.
 *
 ...
 */
class party_identifier_commands {
private:
    inline static std::string_view logger_name =
        "ores.shell.app.commands.refdata.party_identifier_commands";
...
public:
    /**
     * @brief Register the party identifiers submenu.
     */
