 ...
 *
 */
#ifndef ORES_DQ_CORE_REPOSITORY_CHANGE_REASON_MAPPER_HPP
...
/**
 * @brief Maps change_reason domain entities to data storage layer and vice-versa.
 */
class ORES_DQ_CORE_EXPORT change_reason_mapper {
private:
    inline static std::string_view logger_name = "ores.dq.repository.change_reason_mapper";
