...
#+CAPTION: Clock summary at [2025-09-28 Sun 22:27], for Sunday, September 28, 2025.
|       | <75>                               |        |      |      |       |
| Tags  | Headline                           | Time   |      |      |     % |
|-------+------------------------------------+--------+------+------+-------|
...
|       | Stories                            | 5:33   |      |      | 100.0 |
|       | Active                             |        | 5:33 |      | 100.0 |
| code  | Add logging support for tests      |        |      | 2:21 |  42.3 |
| infra | Add suppression to valgrind errors |        |      | 0:30 |   9.0 |
| code  | Refactor core into risk            |        |      | 2:42 |  48.6 |
#+end:

#+begin: clocktable :maxlevel 3 :scope subtree :tags t :indent nil :emphasize nil :scope file :narrow 75 :formula %
#+TBLNAME: sprint_summary
#+CAPTION: Clock summary at [2025-09-28 Sun 22:27]
|          | <75>                                               |         |       |      |       |
| Tags     | Headline                                           | Time    |       |      |     % |
|----------+----------------------------------------------------+---------+-------+------+-------|
|          | *Total time*                                       | *59:40* |       |      | 100.0 |
|----------+----------------------------------------------------+---------+-------+------+-------|
|          | Stories                                            | 59:40   |       |      | 100.0 |
|          | Active                                             |         | 59:40 |      | 100.0 |
| agile    | Sprint and product backlog refinement              |         |       | 2:15 |   3.8 |
| infra    | Fix broken builds                                  |         |       | 0:36 |   1.0 |
| code     | Create a containing structure for data             |         |       | 0:35 |   1.0 |
| code     | Add temporal support to currencies                 |         |       | 2:59 |   5.0 |
| code     | Add command to dump currencies                     |         |       | 4:18 |   7.2 |
| code     | Refactor code for currencies                       |         |       | 3:52 |   6.5 |
| code     | Restore qt setup                                   |         |       | 2:20 |   3.9 |
| code     | Add gemini action                                  |         |       | 0:05 |   0.1 |
| code     | Remove ImGui support                               |         |       | 0:08 |   0.2 |
| code     | Create a GRPC based service                        |         |       | 2:09 |   3.6 |
| code     | Implement a 0MQ based RPC service and client       |         |       | 3:55 |   6.6 |
...
| code     | Implement a cobalt based server and client         |         |       | 2:53 |   4.8 |
| code     | Add serialisation support for reflect-cpp          |         |       | 3:07 |   5.2 |
| analysis | White-boarding for new architecture                |         |       | 1:52 |   3.1 |
| code     | Use sqlgen for postgres                            |         |       | 7:23 |  12.4 |
| code     | Refactor cli to follow new project structure       |         |       | 4:47 |   8.0 |
| code     | Add tests to cli parser                            |         |       | 0:35 |   1.0 |
| code     | Add logging support for tests                      |         |       | 2:21 |   3.9 |
...
| analysis | Investigate bitemporal support from Postgres 18    |         |       | 1:47 |   3.0 |
...
| code     | Refactor core into risk                            |         |       | 5:08 |   8.6 |
