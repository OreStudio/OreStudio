...
#+CAPTION: Clock summary at [2026-01-22 Thu 17:18], for Thursday, January 22, 2026.
|       | <75>                               |        |      |      |       |
| Tags  | Headline                           | Time   |      |      |     % |
|-------+------------------------------------+--------+------+------+-------|
|       | *Total time*                       | *5:28* |      |      | 100.0 |
|-------+------------------------------------+--------+------+------+-------|
|       | Stories                            | 5:28   |      |      | 100.0 |
|       | Active                             |        | 5:28 |      | 100.0 |
| infra | OCR scan notebooks for this sprint |        |      | 3:12 |  58.5 |
| code  | Party related schemes              |        |      | 2:16 |  41.5 |
#+end:

#+begin: clocktable :maxlevel 3 :scope subtree :tags t :indent nil :emphasize nil :scope file :narrow 75 :formula %
#+TBLNAME: sprint_summary
#+CAPTION: Clock summary at [2026-01-22 Thu 17:18]
|       | <75>                                             |         |       |      |       |
| Tags  | Headline                                         | Time    |       |      |     % |
|-------+--------------------------------------------------+---------+-------+------+-------|
|       | *Total time*                                     | *16:07* |       |      | 100.0 |
|-------+--------------------------------------------------+---------+-------+------+-------|
|       | Stories                                          | 16:07   |       |      | 100.0 |
|       | Active                                           |         | 16:07 |      | 100.0 |
| agile | Sprint and product backlog refinement            |         |       | 1:04 |   6.6 |
| infra | OCR scan notebooks for this sprint               |         |       | 5:00 |  31.0 |
| code  | Create a simple code generator                   |         |       | 7:38 |  47.4 |
| code  | Add code generation support for domain types SQL |         |       | 0:09 |   0.9 |
| code  | Party related schemes                            |         |       | 2:16 |  14.1 |
#+end:
...
*** STARTED Party related schemes                                      :code:
    :LOGBOOK:
...
- entity type: https://www.fpml.org/coding-scheme/entity-type-1-0.xml
- party role: https://www.fpml.org/coding-scheme/party-role-4-1.xml
- local jurisdiction: https://www.fpml.org/coding-scheme/local-jurisdiction-1-1.xml
- business center: https://www.fpml.org/coding-scheme/business-center-9-4.xml
- party identifier scheme: we need a way to list the schemes which are accepted
  as party identifiers, and which ones are mandatory. Joins table
  dq_coding_schemes_tbl. This is probably a DQ requirement. A party can then
  have a "mandatory IDs". We already have "subject areas".
- person-role: https://www.fpml.org/coding-scheme/person-role-1-3.xml
- account-types
...
*** Add party identifier scheme entity                                 :code:
