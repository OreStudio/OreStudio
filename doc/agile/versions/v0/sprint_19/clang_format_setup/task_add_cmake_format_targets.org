...
- =cmake --build --preset <preset> --target format= runs
  =clang-format -i= on all =.cpp=, =.hpp=, =.h= files under [[proj:projects][=projects/=]].
...
Updated [[proj:build/cmake/modules/FindClangTools.cmake][=build/cmake/modules/FindClangTools.cmake=]] to search versions
