 ...
 */
#ifndef ORES_REFDATA_CORE_REPOSITORY_PARTY_STATUS_REPOSITORY_HPP
#define ORES_REFDATA_CORE_REPOSITORY_PARTY_STATUS_REPOSITORY_HPP
...
/**
 * @brief Reads and writes party statuses to data storage.
 */
class ORES_REFDATA_CORE_EXPORT party_status_repository {
private:
    inline static std::string_view logger_name = "ores.refdata.repository.party_status_repository";
...
public:
    ...
    /**
     * @brief Writes a party status, honouring the claim it states.
     *
    ...
    /**
     * @brief Writes a set of party statuses, each honouring its own
    ...
    /**
     * @brief Reads latest party statuses, possibly filtered by primary key.
     */
    /**@{*/
    ...
    /**
     * @brief Removes a party status, refusing a row that moved on.
     *
    ...
    /**
     * @brief Deletes party statuses by closing their temporal validity.
     */
...
private:
     ...
     */
    ores::utility::domain::precondition replace_claim(context ctx, const domain::party_status& v);
     ...
     */
    domain::party_status apply_claim(context ctx,
                                     const domain::party_status& v,
                                     const ores::utility::domain::precondition& claim);
};
