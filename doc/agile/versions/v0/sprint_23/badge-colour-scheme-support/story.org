...
| Now           | Mapping-browser task (98AC38DD) DONE -- fixed a real ores.dq.service crash, protocol drift, and a duplicate-rows bug (missing tenant filter on badge_mapping, root-caused to a missing junction codegen flag), PR #1622. Portfolios badge colours confirmed correct; unblocked [[id:72E90BAE-657B-4AA8-8F18-CB5AB6B5F57C][Commission: portfolio]]'s manual-chapter task. |
| Waiting on    | Nothing.                               |
| Next          | Move to the palette-swatch/self-badging/coverage-audit tasks. |
