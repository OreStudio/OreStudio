...
#+description: Grants each service role its DML surface: per-service =dml_prefixes= list the table-name prefixes the service may touch. Output =projects/ores.sql/create/iam/iam_service_db_grants_create.sql=.
#+type: archetype
