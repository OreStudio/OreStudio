...
#+CAPTION: Clock summary at [2024-07-17 Wed 23:28]
|       | <75>                                              |         |       |      |       |
| Tags  | Headline                                          | Time    |       |      |     % |
|-------+---------------------------------------------------+---------+-------+------+-------|
|       | *Total time*                                      | *71:55* |       |      | 100.0 |
|-------+---------------------------------------------------+---------+-------+------+-------|
|       | Stories                                           | 71:55   |       |      | 100.0 |
|       | Active                                            |         | 71:55 |      | 100.0 |
| agile | Sprint and product backlog refinement             |         |       | 3:26 |   4.8 |
...
| code  | Add command line options support                  |         |       | 5:45 |   8.0 |
...
| infra | Setup laptop for development                      |         |       | 3:47 |   5.3 |
| infra | Add database support for currency                 |         |       | 1:19 |   1.8 |
| code  | Add XML parsing support for currency              |         |       | 6:32 |   9.1 |
...
- spent some time analysing [[https://github.com/FastTrackOrg/FastTrack/][FastTrack]], a Qt application. Need to do a write up
  of the features we can copy across.
