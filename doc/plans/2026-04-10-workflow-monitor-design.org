...
- Standard toolbar icons from the icon registry defined in
  [[id:C6ADAC80-F4E6-44E8-9525-3760CB98C41D][Qt Entity Creator Skill]].
...
Register in [[proj:projects/CMakeLists.txt][=projects/CMakeLists.txt=]] after line 98 (=ores.qt.trading=):
#+begin_src cmake
...
In [[proj:projects/CMakeLists.txt][=projects/CMakeLists.txt=]] add after line 98:
