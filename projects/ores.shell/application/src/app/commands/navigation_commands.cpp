...
void navigation_commands::process_prev(std::ostream& out, pagination_context& pagination) {
    const auto& entity = pagination.last_entity();
    if (entity.empty()) {
        out << "No previous list command to paginate." << std::endl;
        return;
...
void navigation_commands::process_first(std::ostream& out, pagination_context& pagination) {
    const auto& entity = pagination.last_entity();
    if (entity.empty()) {
        out << "No previous list command to paginate." << std::endl;
        return;
...
void navigation_commands::process_last(std::ostream& out, pagination_context& pagination) {
    const auto& entity = pagination.last_entity();
    if (entity.empty()) {
        out << "No previous list command to paginate." << std::endl;
        return;
...
void navigation_commands::process_page_size(std::ostream& out,
