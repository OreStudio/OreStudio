...
| Now           | Task 3 in progress: writing round-trip tests for instrument parse dispatch.                   |
| Waiting on    | —                                                                                             |
| Next          | Task 4 (IInstrumentForm refactor) once Task 3 merges.                                        |
...
| [[id:F9E5967D-77E7-49E3-9806-74AF22D26191][Write round-trip tests for instrument parse dispatch]]                      | STARTED | 2026-05-30 |     | One test per instrument family; serialize server-side, verify client dispatch.  |
