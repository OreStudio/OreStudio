...
#+CAPTION: Clock summary at [2025-11-06 Thu 23:27], for Thursday, November 06, 2025.
|       | <75>                                         |         |       |      |       |
| Tags  | Headline                                     | Time    |       |      |     % |
|-------+----------------------------------------------+---------+-------+------+-------|
...
|       | Stories                                      | 10:13   |       |      | 100.0 |
|       | Active                                       |         | 10:13 |      | 100.0 |
| agile | Sprint and product backlog refinement        |         |       | 0:20 |   3.3 |
| code  | Add tests at test suite level to ctest       |         |       | 0:13 |   2.1 |
| code  | Cli tests are failing on github              |         |       | 0:58 |   9.5 |
| code  | Add generators for test data generation      |         |       | 7:40 |  75.0 |
| code  | Tidy-up tests after refactor                 |         |       | 0:12 |   2.0 |
| code  | CTest shows only one test per test suite     |         |       | 0:26 |   4.2 |
| code  | Resolve all of the OpenSSL leaks in valgrind |         |       | 0:21 |   3.4 |
| code  | Add connect command line argument            |         |       | 0:03 |   0.5 |
#+end:

#+begin: clocktable :maxlevel 3 :scope subtree :tags t :indent nil :emphasize nil :scope file :narrow 75 :formula %
#+TBLNAME: sprint_summary
#+CAPTION: Clock summary at [2025-11-06 Thu 23:27]
|       | <75>                                                   |         |       |       |       |
| Tags  | Headline                                               | Time    |       |       |     % |
|-------+--------------------------------------------------------+---------+-------+-------+-------|
|       | *Total time*                                           | *71:19* |       |       | 100.0 |
|-------+--------------------------------------------------------+---------+-------+-------+-------|
|       | Stories                                                | 71:19   |       |       | 100.0 |
|       | Active                                                 |         | 71:19 |       | 100.0 |
| agile | Sprint and product backlog refinement                  |         |       |  1:50 |   2.6 |
| code  | Add locking up logic                                   |         |       |  1:28 |   2.1 |
| code  | Build using dynamic libraries                          |         |       |  7:24 |  10.4 |
| code  | Enable qt gui                                          |         |       |  4:13 |   5.9 |
| code  | Implement logging according to correct boost.log usage |         |       |  8:02 |  11.3 |
...
| code  | Consider adding a postgres database to CI              |         |       | 14:13 |  19.9 |
| code  | Fix misspell that causes build to break                |         |       |  0:12 |   0.3 |
| code  | Improve code coverage                                  |         |       |  4:15 |   6.0 |
...
| code  | Separate test database usage from application          |         |       |  3:33 |   5.0 |
| code  | Split test code from utility                           |         |       |  4:41 |   6.6 |
| code  | Add tests at test suite level to ctest                 |         |       |  0:13 |   0.3 |
| code  | Cli tests are failing on github                        |         |       |  0:58 |   1.4 |
| code  | Add generators for test data generation                |         |       |  7:40 |  10.8 |
