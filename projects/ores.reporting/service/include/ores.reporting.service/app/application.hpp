 ...
 *
 */
#ifndef ORES_REPORTING_SERVICE_APP_APPLICATION_HPP
#define ORES_REPORTING_SERVICE_APP_APPLICATION_HPP
...
/**
 * @brief Entry point for the ores.reporting.service service.
 */
class application final {
private:
    inline static std::string_view logger_name = "ores.reporting.service.app.application";
