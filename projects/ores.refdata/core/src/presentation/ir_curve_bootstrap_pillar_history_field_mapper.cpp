 ...
 *
 */
#include "ores.refdata.core/presentation/ir_curve_bootstrap_pillar_history_field_mapper.hpp"
...
render_ir_curve_bootstrap_pillar_fields(const domain::ir_curve_bootstrap_pillar& v) {
    ...
    fields.push_back(
        {.name = "Bootstrap Config ID", .value = boost::uuids::to_string(v.bootstrap_config_id)});
    ...
    fields.push_back({.name = "Curve Role Code", .value = v.curve_role_code});
