...
private:
    inline static std::string_view logger_name = "ores.qt.client_swap_convention_model";
...
public:
    ...
    explicit ClientSwapConventionModel(ClientManager* clientManager, QObject* parent = nullptr);
