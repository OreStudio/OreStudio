...
Every Claude Code skill this project authors is named =<domain>-<verb>[-<object>]=, in
...
than copied ([[id:0203A855-EF0F-485F-BEDC-CB1EB6C0E9EC][The pstack Collection]]), so there is no local artefact to rename,
and renaming a referenced skill would break the reference for no gain. A reader
meeting =unslop= or =arena= is meeting the upstream name deliberately.
