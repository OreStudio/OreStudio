...
begin
    if not exists (
        ...
        insert into ores_iam_tenants_tbl (
            ...
            'system',
            'Root Tenant',
            'The foundational platform tenant. Owns shared governance data, reference lookups, and administrative configuration. All other tenants are provisioned from this base.',
            'localhost',
            'active',
            current_user,
            current_user,
