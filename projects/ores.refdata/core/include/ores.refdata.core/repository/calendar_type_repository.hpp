...
public:
    ...
    /**
     * @brief Writes a calendar type, honouring the claim it states.
     *
    ...
    /**
     * @brief Writes a set of calendar types, each honouring its own
    ...
    /**
     * @brief Reads latest calendar types, possibly filtered by primary key.
     */
    /**@{*/
    ...
    /**
     * @brief Reads all calendar types, possibly filtered by primary key.
     */
    ...
    /**
     * @brief Removes a calendar type, refusing a row that moved on.
     *
...
private:
     ...
     */
    ores::utility::domain::precondition replace_claim(context ctx, const domain::calendar_type& v);
     ...
     */
    domain::calendar_type apply_claim(context ctx,
                                      const domain::calendar_type& v,
                                      const ores::utility::domain::precondition& claim);
};
