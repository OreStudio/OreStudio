 ...
 *
 */
#ifndef ORES_QT_BOOK_HISTORY_DIALOG_HPP
#define ORES_QT_BOOK_HISTORY_DIALOG_HPP
...
/**
 * @brief Dialog for viewing the version history of a book.
 *
...
private:
    inline static std::string_view logger_name = "ores.qt.book_history_dialog";
...
public:
    explicit BookHistoryDialog(const boost::uuids::uuid& id,
                               const QString& code,
