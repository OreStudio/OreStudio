...
|-------+-----------+-------------|
| [[id:C024DB5C-C108-4A6B-8B0A-4E779163194D][Asset templates]] | 4 | Singleton auxiliary artefacts: Qt Designer .ui XML for detail and history dialogs, the PlantUML ER diagram scaffold, and the per-service shell variables file. |
