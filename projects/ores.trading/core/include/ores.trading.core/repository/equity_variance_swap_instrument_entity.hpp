 ...
 *
 */
#ifndef ORES_TRADING_CORE_REPOSITORY_EQUITY_VARIANCE_SWAP_INSTRUMENT_ENTITY_HPP
#define ORES_TRADING_CORE_REPOSITORY_EQUITY_VARIANCE_SWAP_INSTRUMENT_ENTITY_HPP
...
/**
 * @brief Represents a equity variance swap instrument in the database.
 */
