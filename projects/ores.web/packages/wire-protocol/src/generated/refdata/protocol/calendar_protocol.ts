...
export interface GetCalendarHistoryRequest {
    code: string;
}

export interface GetCalendarHistoryResponse {
    history: Calendar[];
    success: boolean;
    message: string;
}
...
export const subjects = {
    get_calendars_request: "refdata.v1.calendars.list",
    save_calendar_request: "refdata.v1.calendars.save",
    delete_calendar_request: "refdata.v1.calendars.delete",
    get_calendar_history_request: "refdata.v1.calendars.history",
} as const;
