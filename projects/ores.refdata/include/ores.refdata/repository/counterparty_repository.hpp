 ...
 *
 */
#ifndef ORES_REFDATA_REPOSITORY_COUNTERPARTY_REPOSITORY_HPP
#define ORES_REFDATA_REPOSITORY_COUNTERPARTY_REPOSITORY_HPP
...
public:
    ...
    explicit counterparty_repository(context ctx);

    std::string sql();

    void write(const domain::counterparty& counterparty);
