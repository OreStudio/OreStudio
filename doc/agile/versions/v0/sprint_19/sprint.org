...
| Story | State | Start | End | Description |
|-------+-------+-------+-----+-------------|
| [[id:30BC3B04-E85D-4A0C-A6FD-01E6E4B80D6C][Compass session journal]] | BACKLOG | | | Per-machine .journal.org (gitignored) recording each Claude environment's story/task journey; compass journal commands; compass fleet refactor. |
...
| [[id:88113E9B-DBD4-4E08-8CD9-49B8A709B871][Codegen unified model — Phase 2: single model file per entity]] | BACKLOG | | | Merge _table.json and _domain_entity.json into one _entity.json; single source of truth for all facets. |
...
| [[id:F3CB848E-72C1-4F81-AAE4-1265F41D47C1][Fix knowledge graph issues]]                         | STARTED | 2026-05-30 | | Fix knowledge graph: images not displaying and left-panel controls missing. |
