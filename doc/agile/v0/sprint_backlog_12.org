...
#+CAPTION: Clock summary at [2026-02-18 Wed 23:08], for Wednesday, February 18, 2026.
|      | <75>                         |        |      |      |       |
| Tags | Headline                     | Time   |      |      |     % |
|------+------------------------------+--------+------+------+-------|
|      | *Total time*                 | *1:34* |      |      | 100.0 |
|------+------------------------------+--------+------+------+-------|
|      | Stories                      | 1:34   |      |      | 100.0 |
|      | Active                       |        | 1:34 |      | 100.0 |
| code | Advanced counterparty dialog |        |      | 1:34 | 100.0 |
#+end:

#+begin: clocktable :maxlevel 3 :scope subtree :tags t :indent nil :emphasize nil :scope file :narrow 75 :formula %
#+TBLNAME: sprint_summary
#+CAPTION: Clock summary at [2026-02-18 Wed 23:08]
|       | <75>                                               |         |       |       |       |
| Tags  | Headline                                           | Time    |       |       |     % |
|-------+----------------------------------------------------+---------+-------+-------+-------|
|       | *Total time*                                       | *60:51* |       |       | 100.0 |
|-------+----------------------------------------------------+---------+-------+-------+-------|
|       | Stories                                            | 60:51   |       |       | 100.0 |
|       | Active                                             |         | 60:51 |       | 100.0 |
| agile | Sprint and product backlog refinement              |         |       |  2:43 |   4.5 |
| code  | Add bound parameters to sqlgen                     |         |       |  0:51 |   1.4 |
| code  | Add roles to account via codes                     |         |       |  0:34 |   0.9 |
| code  | Implement party related entities at database level |         |       |  4:23 |   7.2 |
| code  | Add party related support at the domain level      |         |       |  0:23 |   0.6 |
| code  | Add party related support to Qt                    |         |       |  6:41 |  11.0 |
| code  | Add GLEIF data to datasets                         |         |       |  6:41 |  11.0 |
| code  | Brainstorm on multi-party support                  |         |       |  4:00 |   6.6 |
| code  | Improve code coverage                              |         |       |  0:14 |   0.4 |
| code  | Improve generators with FK-aware test data         |         |       |  1:44 |   2.8 |
| code  | Enable all skipped tests                           |         |       |  0:29 |   0.8 |
| code  | Add central bank related LEIs                      |         |       |  0:35 |   1.0 |
| code  | Expand unit test coverage for ORE codegened types  |         |       |  0:49 |   1.3 |
| code  | Add system party support                           |         |       |  3:58 |   6.5 |
| code  | Add customer party support                         |         |       |  1:33 |   2.5 |
| code  | Fix OSX build                                      |         |       |  0:19 |   0.5 |
| code  | Add pagination to counterparty                     |         |       |  0:58 |   1.6 |
| code  | Add support for business centres                   |         |       |  3:47 |   6.2 |
| code  | Add LEI to BIC dataset                             |         |       |  0:27 |   0.7 |
| code  | Add proper party short-codes                       |         |       |  2:18 |   3.8 |
| code  | Polish party and counterparty list UI              |         |       |  1:25 |   2.3 |
| code  | Implement party-level RLS isolation                |         |       |  2:33 |   4.2 |
| code  | Add a setup new tenant wizard                      |         |       |  1:27 |   2.4 |
| code  | Advanced counterparty dialog                       |         |       | 10:46 |  17.7 |
| code  | Analyse caching at dialog level                    |         |       |  1:13 |   2.0 |
#+end:

*** STARTED Sprint and product backlog refinement                     :agile:
    :LOGBOOK:
    CLOCK: [2026-02-18 Wed 23:24]--[2026-02-19 Thu 10:00] => 10:36
