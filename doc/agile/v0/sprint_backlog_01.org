...
#+CAPTION: Clock summary at [2024-06-27 Thu 23:29]
| <75>                                    |         |       |      |       |
| Headline                                | Time    |       |      |     % |
|-----------------------------------------+---------+-------+------+-------|
| *Total time*                            | *17:24* |       |      | 100.0 |
|-----------------------------------------+---------+-------+------+-------|
| Stories                                 | 17:24   |       |      | 100.0 |
| Active                                  |         | 17:24 |      | 100.0 |
...
| Create and upload a package             |         |       | 3:28 |  19.9 |
| Create a basic project structure        |         |       | 2:10 |  12.5 |
| Add a Qt hello world                    |         |       | 3:08 |  18.0 |
| Add a splash screen to applciation      |         |       | 0:41 |   3.9 |
| Add nightly support with memcheck       |         |       | 1:21 |   7.8 |
| Add XML parsing support for currency    |         |       | 1:24 |   8.0 |
| Create a containing structure for data  |         |       | 0:28 |   2.7 |
