...
| [[id:3545641D-96DD-41DA-B4FF-B5FE43D56CA2][Canary CI: near-zero sccache hit rate makes every build a cold rebuild]] | STARTED | 2026-07-03 | | canary-linux.yml's sccache hit rate is 1.36% on a small PR; investigate cache-invalidation cause (vcpkg.json churn vs. other) and fix. |
