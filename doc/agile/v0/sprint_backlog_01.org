...
#+CAPTION: Clock summary at [2024-06-22 Sat 23:09]
| <75>                                    |        |      |      |       |
| Headline                                | Time   |      |      |     % |
|-----------------------------------------+--------+------+------+-------|
...
| Stories                                 | 9:14   |      |      | 100.0 |
| Active                                  |        | 9:14 |      | 100.0 |
| Create a basic git hub repository       |        |      | 0:35 |   6.3 |
| Sprint and product backlog refinement   |        |      | 0:05 |   0.9 |
| Setup a discord channel for the project |        |      | 0:14 |   2.5 |
| Setup vcpkg and cmake                   |        |      | 1:21 |  14.6 |
| Setup github actions                    |        |      | 1:21 |  14.6 |
| Create and upload a package             |        |      | 3:28 |  37.5 |
| Create a basic project structure        |        |      | 2:10 |  23.5 |
#+end:
...
*** STARTED Create and upload a package                               :story:
    :LOGBOOK:
...
*** Add nightly support with memcheck                                 :story:
