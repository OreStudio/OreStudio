 ...
 */
/**
 * Where the overnight_index_convention screens live and what they can do.
 *
 ...
 */
import { overnightIndexConventionMeta } from '../ui/overnight_index_convention_ui.js';
import type { EntityDescriptor } from '../../../entity/descriptor.js';

export const overnightIndexConventionDescriptor: EntityDescriptor = {
    component: 'refdata',
    entity: 'overnight_index_convention',
    meta: overnightIndexConventionMeta,
    routeSegment: 'overnight-index-convention',
    apiBase: '/api/overnight_index_conventions',
    keyFields: [
        'id',
    ],
    capabilities: {
