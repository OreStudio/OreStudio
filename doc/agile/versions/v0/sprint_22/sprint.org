...
| [[id:E4A4D94A-C9B9-4075-931E-94AA5D8044FE][QA Validation Runner: in-app test tracking for the multi-worktree fleet]] | BACKLOG | | | Qt-side dockable panel turning a scenario checklist into a guided test session; results recorded next to the driving story/task, not in a standalone JSON file. Fleet has grown to 10 worktrees with one human tester. |
