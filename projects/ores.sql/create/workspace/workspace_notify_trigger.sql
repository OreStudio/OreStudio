...
create or replace function ores_workspaces_notify_fn()
returns trigger as $$
declare
    notification_payload jsonb;
    entity_name text := 'ores.workspace.workspace';
...
create or replace trigger ores_workspaces_notify_trg
after insert or update or delete on ores_workspaces_tbl
for each row execute function ores_workspaces_notify_fn();
