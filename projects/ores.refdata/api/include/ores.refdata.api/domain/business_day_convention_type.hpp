 ...
 * [[id:1B88215B-1FE0-4CAF-B6AB-53F471963CA6][currency_pair_convention]] — lives in ores.refdata,
 * not ores.trading.
 */
...
/**
 * @brief Dispatch-key identifier for business_day_convention_type, e.g. for the
 * generic history-diff request and action registries. Single source
 * of truth: every call site spells entity_type_of(value) regardless
 * of which entity it holds.
 */
[[nodiscard]] constexpr std::string_view entity_type_of(const business_day_convention_type&) {
    return "ores.refdata.business_day_convention_type";
}
