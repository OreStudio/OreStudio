 ...
 */
/**
 * Where the calendar_type screens live and what they can do.
 *
 ...
 */
import { calendarTypeMeta } from '../ui/calendar_type_ui.js';
import type { EntityDescriptor } from '../../../entity/descriptor.js';

export const calendarTypeDescriptor: EntityDescriptor = {
    component: 'refdata',
    entity: 'calendar_type',
    meta: calendarTypeMeta,
    routeSegment: 'calendar-type',
    apiBase: '/api/types',
    keyParam: 'id',
    icon: 'classification',
    capabilities: {
