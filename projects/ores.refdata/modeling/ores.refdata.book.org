...
| field                | label                | widget                   | type          | is_key | is_required | placeholder                | flag_source | combo_fetch_fn                | combo_fetch_include       | combo_type                              | combo_value | combo_display | badge_key            |
|----------------------+----------------------+--------------------------+---------------+--------+-------------+-----------------------------+--------------+---------------------------------+----------------------------+-------------------------------------------+-------------+---------------+-----------------------|
...
| book_status          | Status               | bookStatusCombo          | dynamic_combo |        |             |                              |              | fetch_book_statuses            | ores.qt/LookupFetcher.hpp | refdata::domain::book_status            | code        | code          | book_status           |
| regulatory_book_type | Regulatory Book Type | regulatoryBookTypeCombo  | dynamic_combo |        |             |                              |              | fetch_regulatory_book_types    | ores.qt/LookupFetcher.hpp | refdata::domain::regulatory_book_type   | code        | code          | regulatory_book_type |
