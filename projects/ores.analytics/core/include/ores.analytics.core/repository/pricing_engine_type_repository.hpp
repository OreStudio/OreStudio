...
public:
    ...
    /**
     * @brief Writes a pricing engine type, honouring the claim it states.
     *
    ...
    /**
     * @brief Writes a set of pricing engine types, each honouring its own
    ...
    /**
     * @brief Removes a pricing engine type, refusing a row that moved on.
     *
...
private:
     ...
     */
    domain::pricing_engine_type apply_claim(context ctx,
                                            const domain::pricing_engine_type& v,
                                            const ores::utility::domain::precondition& claim);
};
