...
- [[id:5DAEC346-CB22-4CE1-8293-12A1986AFDB6][Data Import Session and Workflow Partial-Success]] — import design that
  depends on workspaces for Track 1 (educational/sample import).  Track 2
  (production live import) is independent.
- [[id:A3F7C812-5E2D-4B9A-8C1F-6D0E3A7B2F4C][Reporting Component Design]] — defines ~report_definition~ and
...
- [[id:7E4B1C93-2F8A-4D56-B3E7-9A0C5F812D6E][Badge System Design]] — badge infrastructure reused for workspace
  ~status_code~ rendering.
- [[id:847AECEA-D0E6-4D4F-870A-F0E720B49256][Codegen IAM Permissions]] — will eventually auto-generate the workspace
  permission entries added in this revision.

* Dependencies

- [[id:AD2D6529-4870-4BD0-9B68-6DF3CCAAFBCA][Virtual Portfolio Design]] (PROPOSED, *soft* dependency) — the workspace
...
The [[id:5DAEC346-CB22-4CE1-8293-12A1986AFDB6][Data Import Session]] design identified two fundamentally different import
use cases:
...
to [[id:5DAEC346-CB22-4CE1-8293-12A1986AFDB6][Provisional Blotter Design]], where it sits alongside Track 2 (production
