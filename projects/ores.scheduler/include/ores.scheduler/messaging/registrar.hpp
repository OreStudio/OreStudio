 ...
 *
 */
#ifndef ORES_SCHEDULER_MESSAGING_REGISTRAR_HPP
#define ORES_SCHEDULER_MESSAGING_REGISTRAR_HPP
...
/**
 * @brief Register scheduler subsystem message handlers with the server.
 *
 * Registers handlers for all scheduler subsystem messages (0x9000-0x9FFF).
...
private:
    inline static std::string_view logger_name =
        "ores.scheduler.messaging.registrar";
