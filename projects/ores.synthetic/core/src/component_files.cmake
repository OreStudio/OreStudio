...
set(files
    ...
    "messaging/folder_history_provider_registrar.cpp"
    "messaging/folder_registrar.cpp"
    "messaging/fx_spot_generation_config_history_provider_registrar.cpp"
    "messaging/fx_spot_generation_config_registrar.cpp"
    "messaging/gmm_component_history_provider_registrar.cpp"
    "messaging/gmm_component_registrar.cpp"
    "messaging/ir_curve_generation_config_history_provider_registrar.cpp"
    "messaging/ir_curve_generation_config_process_parameter_value_history_provider_registrar.cpp"
    "messaging/ir_curve_generation_config_process_parameter_value_registrar.cpp"
    "messaging/ir_curve_generation_config_registrar.cpp"
    "messaging/ir_curve_template_entry_history_provider_registrar.cpp"
    "messaging/ir_curve_template_entry_registrar.cpp"
    "messaging/market_data_generation_config_history_provider_registrar.cpp"
    "messaging/market_data_generation_config_registrar.cpp"
    "messaging/publish_from_dq_handler.cpp"
    "messaging/registrar.cpp"
    "messaging/yield_curve_process_parameter_definition_history_provider_registrar.cpp"
    "messaging/yield_curve_process_parameter_definition_registrar.cpp"
    "messaging/yield_curve_process_type_history_provider_registrar.cpp"
    "messaging/yield_curve_process_type_registrar.cpp"
    "presentation/folder_history_field_mapper.cpp"
    "presentation/fx_spot_generation_config_history_field_mapper.cpp"
    "presentation/gmm_component_history_field_mapper.cpp"
    "presentation/ir_curve_generation_config_history_field_mapper.cpp"
    "presentation/ir_curve_generation_config_process_parameter_value_history_field_mapper.cpp"
    "presentation/ir_curve_template_entry_history_field_mapper.cpp"
    "presentation/market_data_generation_config_history_field_mapper.cpp"
    "presentation/yield_curve_process_parameter_definition_history_field_mapper.cpp"
    ...
    "repository/ir_curve_generation_config_process_parameter_value_entity.cpp"
    "repository/ir_curve_generation_config_process_parameter_value_mapper.cpp"
    "repository/ir_curve_generation_config_process_parameter_value_repository.cpp"
    ...
    "repository/yield_curve_process_parameter_definition_entity.cpp"
    "repository/yield_curve_process_parameter_definition_mapper.cpp"
    "repository/yield_curve_process_parameter_definition_repository.cpp"
    ...
    "service/ir_curve_generation_config_process_parameter_value_service.cpp"
...
set(HEADERS
    ...
    "${CMAKE_CURRENT_SOURCE_DIR}/../include/ores.synthetic.core/messaging/folder_history_provider_registrar.hpp"
    ...
    "${CMAKE_CURRENT_SOURCE_DIR}/../include/ores.synthetic.core/messaging/fx_spot_generation_config_history_provider_registrar.hpp"
    "${CMAKE_CURRENT_SOURCE_DIR}/../include/ores.synthetic.core/messaging/fx_spot_generation_config_registrar.hpp"
    "${CMAKE_CURRENT_SOURCE_DIR}/../include/ores.synthetic.core/messaging/gmm_component_handler.hpp"
    "${CMAKE_CURRENT_SOURCE_DIR}/../include/ores.synthetic.core/messaging/gmm_component_history_provider_registrar.hpp"
    "${CMAKE_CURRENT_SOURCE_DIR}/../include/ores.synthetic.core/messaging/gmm_component_registrar.hpp"
    "${CMAKE_CURRENT_SOURCE_DIR}/../include/ores.synthetic.core/messaging/ir_curve_generation_config_handler.hpp"
    "${CMAKE_CURRENT_SOURCE_DIR}/../include/ores.synthetic.core/messaging/ir_curve_generation_config_history_provider_registrar.hpp"
    "${CMAKE_CURRENT_SOURCE_DIR}/../include/ores.synthetic.core/messaging/ir_curve_generation_config_process_parameter_value_handler.hpp"
    "${CMAKE_CURRENT_SOURCE_DIR}/../include/ores.synthetic.core/messaging/ir_curve_generation_config_process_parameter_value_history_provider_registrar.hpp"
    "${CMAKE_CURRENT_SOURCE_DIR}/../include/ores.synthetic.core/messaging/ir_curve_generation_config_process_parameter_value_registrar.hpp"
    ...
    "${CMAKE_CURRENT_SOURCE_DIR}/../include/ores.synthetic.core/messaging/ir_curve_template_entry_history_provider_registrar.hpp"
    ...
    "${CMAKE_CURRENT_SOURCE_DIR}/../include/ores.synthetic.core/messaging/yield_curve_process_parameter_definition_history_provider_registrar.hpp"
    "${CMAKE_CURRENT_SOURCE_DIR}/../include/ores.synthetic.core/messaging/yield_curve_process_parameter_definition_registrar.hpp"
    "${CMAKE_CURRENT_SOURCE_DIR}/../include/ores.synthetic.core/messaging/yield_curve_process_type_handler.hpp"
    "${CMAKE_CURRENT_SOURCE_DIR}/../include/ores.synthetic.core/messaging/yield_curve_process_type_history_provider_registrar.hpp"
    ...
    "${CMAKE_CURRENT_SOURCE_DIR}/../include/ores.synthetic.core/presentation/folder_history_field_mapper.hpp"
    "${CMAKE_CURRENT_SOURCE_DIR}/../include/ores.synthetic.core/presentation/fx_spot_generation_config_history_field_mapper.hpp"
    "${CMAKE_CURRENT_SOURCE_DIR}/../include/ores.synthetic.core/presentation/gmm_component_history_field_mapper.hpp"
    "${CMAKE_CURRENT_SOURCE_DIR}/../include/ores.synthetic.core/presentation/ir_curve_generation_config_history_field_mapper.hpp"
    "${CMAKE_CURRENT_SOURCE_DIR}/../include/ores.synthetic.core/presentation/ir_curve_generation_config_process_parameter_value_history_field_mapper.hpp"
    "${CMAKE_CURRENT_SOURCE_DIR}/../include/ores.synthetic.core/presentation/ir_curve_template_entry_history_field_mapper.hpp"
    "${CMAKE_CURRENT_SOURCE_DIR}/../include/ores.synthetic.core/presentation/market_data_generation_config_history_field_mapper.hpp"
    "${CMAKE_CURRENT_SOURCE_DIR}/../include/ores.synthetic.core/presentation/yield_curve_process_parameter_definition_history_field_mapper.hpp"
    ...
    "${CMAKE_CURRENT_SOURCE_DIR}/../include/ores.synthetic.core/repository/ir_curve_generation_config_process_parameter_value_entity.hpp"
    "${CMAKE_CURRENT_SOURCE_DIR}/../include/ores.synthetic.core/repository/ir_curve_generation_config_process_parameter_value_mapper.hpp"
    "${CMAKE_CURRENT_SOURCE_DIR}/../include/ores.synthetic.core/repository/ir_curve_generation_config_process_parameter_value_repository.hpp"
    ...
    "${CMAKE_CURRENT_SOURCE_DIR}/../include/ores.synthetic.core/repository/yield_curve_process_parameter_definition_entity.hpp"
    "${CMAKE_CURRENT_SOURCE_DIR}/../include/ores.synthetic.core/repository/yield_curve_process_parameter_definition_mapper.hpp"
    "${CMAKE_CURRENT_SOURCE_DIR}/../include/ores.synthetic.core/repository/yield_curve_process_parameter_definition_repository.hpp"
    ...
    "${CMAKE_CURRENT_SOURCE_DIR}/../include/ores.synthetic.core/service/ir_curve_generation_config_process_parameter_value_service.hpp"
