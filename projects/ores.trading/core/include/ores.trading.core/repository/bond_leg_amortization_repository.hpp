 ...
 *
 */
#ifndef ORES_TRADING_CORE_REPOSITORY_BOND_LEG_AMORTIZATION_REPOSITORY_HPP
#define ORES_TRADING_CORE_REPOSITORY_BOND_LEG_AMORTIZATION_REPOSITORY_HPP
...
/**
 * @brief Reads and writes bond leg amortizations to data storage.
 */
class ORES_TRADING_CORE_EXPORT bond_leg_amortization_repository {
private:
    inline static std::string_view logger_name =
        "ores.trading.repository.bond_leg_amortization_repository";
...
public:
    ...
    /**
     * @brief Writes bond leg amortizations to database.
     */
    /**@{*/
    void write(context ctx, const domain::bond_leg_amortization& v);
    void write(context ctx, const std::vector<domain::bond_leg_amortization>& v);
    /**@}*/

    /**
     * @brief Reads latest bond leg amortizations, possibly filtered by primary key.
     */
    /**@{*/
    ...
    /**
     * @brief Reads a single bond leg amortization as it stood at a specific
