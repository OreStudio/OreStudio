 ...
 *
 */
#include "ores.marketdata.api/domain/tenor_resolution.hpp"
#include <catch2/catch_test_macros.hpp>

namespace {

using ores::marketdata::domain::resolve_end_date;
using ores::marketdata::domain::resolve_window;
using ores::marketdata::domain::tenor;
using ores::marketdata::domain::tenor_convention;
using ores::marketdata::domain::tenor_convention_resolution;
using ores::marketdata::domain::windows_overlap;
