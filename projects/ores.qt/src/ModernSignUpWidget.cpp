...
ModernSignUpWidget::ModernSignUpWidget(QWidget* parent)
    : QWidget(parent) {
    setupUI();
...
QSize ModernSignUpWidget::sizeHint() const {
    return {400, 620};
}

void ModernSignUpWidget::keyPressEvent(QKeyEvent* event) {
...
void ModernSignUpWidget::setServer(const QString& server) {
    hostEdit_->setText(server);
}

void ModernSignUpWidget::setPort(int port) {
    portSpinBox_->setValue(port);
}

QString ModernSignUpWidget::getServer() const {
    return hostEdit_->text().trimmed();
}

int ModernSignUpWidget::getPort() const {
    return portSpinBox_->value();
}

void ModernSignUpWidget::setClientManager(ClientManager* clientManager) {
    clientManager_ = clientManager;
}

QString ModernSignUpWidget::getRegisteredUsername() const {
    return registeredUsername_;
}

void ModernSignUpWidget::enableForm(bool enabled) {
...
bool ModernSignUpWidget::validateInput() {
...
void ModernSignUpWidget::setupUI() {
...
void ModernSignUpWidget::setupPanel(QWidget* parent) {
    ...
    connect(passwordEdit_, &QLineEdit::textChanged,
            this, &ModernSignUpWidget::updatePasswordMatchIndicator);
    ...
    connect(showPasswordCheck_, &QCheckBox::toggled,
            this, &ModernSignUpWidget::onShowPasswordToggled);
    ...
    connect(signUpButton_, &QPushButton::clicked,
            this, &ModernSignUpWidget::onSignUpClicked);
    ...
    connect(loginButton_, &QPushButton::clicked,
            this, &ModernSignUpWidget::onLoginClicked);
...
void ModernSignUpWidget::onSignUpClicked() {
...
void ModernSignUpWidget::onSignUpResult(const SignupResult& result) {
...
void ModernSignUpWidget::onLoginClicked() {
    emit loginRequested();
}

void ModernSignUpWidget::onShowPasswordToggled(bool checked) {
...
void ModernSignUpWidget::updatePasswordMatchIndicator() {
