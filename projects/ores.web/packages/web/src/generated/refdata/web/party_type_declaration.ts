 ...
 */
/**
 * Where the party_type screens live and what they can do.
 *
 ...
 */
import { partyTypeMeta } from '../ui/party_type_ui.js';
import type { EntityDescriptor } from '../../../entity/descriptor.js';

export const partyTypeDescriptor: EntityDescriptor = {
    component: 'refdata',
    entity: 'party_type',
    meta: partyTypeMeta,
    routeSegment: 'party-type',
    apiBase: '/api/types',
    keyFields: [
        'code',
    ],
