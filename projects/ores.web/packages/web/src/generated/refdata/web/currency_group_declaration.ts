 ...
 */
/**
 * Where the currency_group screens live and what they can do.
 *
 ...
 */
import { currencyGroupMeta } from '../ui/currency_group_ui.js';
import type { EntityDescriptor } from '../../../entity/descriptor.js';

export const currencyGroupDescriptor: EntityDescriptor = {
    component: 'refdata',
    entity: 'currency_group',
    meta: currencyGroupMeta,
    routeSegment: 'currency-group',
    apiBase: '/api/groups',
    keyParam: 'id',
    icon: 'chartMultiple',
    capabilities: {
