 ...
 *
 */
#ifndef ORES_SHELL_APP_COMMANDS_EQUITY_ASIAN_OPTION_INSTRUMENT_COMMANDS_HPP
#define ORES_SHELL_APP_COMMANDS_EQUITY_ASIAN_OPTION_INSTRUMENT_COMMANDS_HPP
...
/**
 * @brief Manages commands related to Equity Asian Option instruments.
 */
class equity_asian_option_instrument_commands {
private:
    inline static std::string_view logger_name =
        "ores.shell.app.commands.trading.equity_asian_option_instrument_commands";
...
public:
    /**
     * @brief Register Equity Asian Option instrument related commands.
     */
    ...
    /**
     * @brief Process the Equity Asian Option instrument history request.
     */
