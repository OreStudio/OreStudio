...
public:
    ...
    /**
     * @brief Writes a currency pair classification, honouring the claim it states.
     *
    ...
    /**
     * @brief Writes a set of currency pair classifications, each honouring its own
    ...
    /**
     * @brief Reads latest currency pair classifications, possibly filtered by primary key.
     */
    /**@{*/
    ...
    /**
     * @brief Reads a single currency pair classification as it stood at a specific
    ...
    /**
     * @brief Removes a currency pair classification, refusing a row that moved on.
     *
...
private:
    ...
    replace_claim(context ctx, const domain::currency_pair_classification& v);
