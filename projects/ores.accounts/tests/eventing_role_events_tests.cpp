...
using ores::accounts::eventing::role_assigned_event;
using ores::accounts::eventing::role_revoked_event;
using ores::accounts::eventing::permissions_changed_event;
using ores::eventing::domain::event_traits;
using ores::eventing::domain::has_event_traits;
using namespace ores::accounts::domain::permissions;
...
TEST_CASE("event_traits_role_assigned_event", tags) {
    ...
    REQUIRE(event_traits<role_assigned_event>::name == "ores.accounts.role_assigned");
...
TEST_CASE("event_traits_role_revoked_event", tags) {
    ...
    REQUIRE(event_traits<role_revoked_event>::name == "ores.accounts.role_revoked");
...
TEST_CASE("event_traits_permissions_changed_event", tags) {
    ...
    REQUIRE(event_traits<permissions_changed_event>::name == "ores.accounts.permissions_changed");
