...
#+CAPTION: Clock summary at [2026-02-24 Tue 16:39], for Tuesday, February 24, 2026.
|      | <75>                                                |        |      |      |       |
| Tags | Headline                                            | Time   |      |      |     % |
|------+-----------------------------------------------------+--------+------+------+-------|
|      | *Total time*                                        | *6:22* |      |      | 100.0 |
|------+-----------------------------------------------------+--------+------+------+-------|
|      | Stories                                             | 6:22   |      |      | 100.0 |
|      | Active                                              |        | 6:22 |      | 100.0 |
| code | Enhance currency taxonomy                           |        |      | 2:06 |  33.0 |
| code | Books, portfolios and trades are not party specific |        |      | 2:59 |  46.9 |
| code | Minor improvements to connection browser            |        |      | 1:17 |  20.2 |
#+end:

#+begin: clocktable :maxlevel 3 :scope subtree :tags t :indent nil :emphasize nil :scope file :narrow 75 :formula %
#+TBLNAME: sprint_summary
#+CAPTION: Clock summary at [2026-02-24 Tue 16:39]
|       | <75>                                                  |         |       |       |       |
| Tags  | Headline                                              | Time    |       |       |     % |
|-------+-------------------------------------------------------+---------+-------+-------+-------|
|       | *Total time*                                          | *32:24* |       |       | 100.0 |
|-------+-------------------------------------------------------+---------+-------+-------+-------|
|       | Stories                                               | 32:24   |       |       | 100.0 |
|       | Active                                                |         | 32:24 |       | 100.0 |
| agile | Sprint and product backlog refinement                 |         |       |  0:26 |   1.3 |
| infra | Generate release notes for previous sprint            |         |       |  1:16 |   3.9 |
| code  | Merge FSM into DQ                                     |         |       |  0:34 |   1.7 |
| code  | Make all details dialogs tabbed                       |         |       |  2:26 |   7.5 |
| code  | Provenance: Fix performed by and modified by stamping |         |       |  3:17 |  10.1 |
| code  | Add plotting of session data                          |         |       |  1:19 |   4.1 |
| code  | Add account-party management and login support        |         |       | 13:43 |  42.3 |
| code  | Add rounding type entity                              |         |       |  1:40 |   5.1 |
| code  | Polish business centre UI and data quality            |         |       |  0:58 |   3.0 |
| code  | Enhance currency taxonomy                             |         |       |  2:06 |   6.5 |
| code  | Books, portfolios and trades are not party specific   |         |       |  2:59 |   9.2 |
| code  | Minor improvements to connection browser              |         |       |  1:17 |   4.0 |
| code  | Add portfolio book tree widget                        |         |       |  0:23 |   1.2 |
#+end:
...
*** STARTED Minor improvements to connection browser                   :code:
    :LOGBOOK:
...
*** Add concept of "named environments" to connection manager          :code:
