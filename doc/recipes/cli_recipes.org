...
./ores.cli accounts list ${log_args} ${db_args} | jq .[:3]
#+END_SRC
...
[
  {
    "version": 0,
    "is_admin": false,
    "id": "019aa8d3-5fb9-7a74-b16c-ff7ae9248a5b",
    "modified_by": "ores",
    "username": "newuser23",
    "password_hash": "$scrypt$ln=14,r=8,p=1$e02x3YQSSIQpxJd6/KX1ww==$mQyWju2nbi4gm4SwZmjPSmxOZjhZhB1snq579a0rteTBQegRSgPkAWy8EpuuxcFl6QRXGOvYnLlXg8H+hsXgnA==",
    "password_salt": "",
    "totp_secret": "",
  ...
  },
  {
    "version": 0,
    "is_admin": false,
    "id": "019aa8d3-5f61-7e8b-b6d1-7074277c0739",
    "modified_by": "ores",
    "username": "newuser22",
    "password_hash": "$scrypt$ln=14,r=8,p=1$r2gRi8G1fWoVWzqYzpWFiw==$CXa3mGj4sX9K+HtUnwGPA3aYluMOYZdHCCESXil1uQ75VBJoejKvxC89YQK/rNIwVKOSN1uMBkbSWvmoWW15/A==",
    "password_salt": "",
    "totp_secret": "",
  ...
  },
  {
    "version": 0,
    "is_admin": false,
    "id": "019aa79f-24ba-725e-be98-7cd92914e22d",
    "modified_by": "ores",
    "username": "newuser21",
    "password_hash": "$scrypt$ln=14,r=8,p=1$3qdD9DR+RkBA6FuwB33jng==$BKNIvidvO+JfMQVPTUon40A/8locDcdw8p6GzZzMvf2WN0FdxEC+ByS5GcVqhITOsJogCvbtCXv/RasNJkcMsg==",
    "password_salt": "",
    "totp_secret": "",
...
#+begin_src sh
export ORES_CLI_DB_PASSWORD
./ores.cli accounts add --username admin8 --password 123 --email \
  admin8@example.com --is-admin 1 --modified-by system ${log_args} ${db_args}
#+END_SRC

#+RESULTS:
#+begin_src json
System is currently in bootstrap mode.
Successfully added account: admin8 (ID: d9039936-bf0f-405c-a362-25f3550dad81)
...
#+begin_src sh
export ORES_CLI_DB_PASSWORD
./ores.cli currencies import ${log_args} ${db_args} --target ${data_dir}/currencies_API.xml | jq .[:3]
#+END_SRC
...
#+begin_src sh
export ORES_CLI_DB_PASSWORD
./ores.cli currencies export ${log_args} ${db_args} ${format_args} | xmllint --format - | head -n 20
#+END_SRC
...
#+begin_src sh
export ORES_CLI_DB_PASSWORD
./ores.cli currencies export ${log_args} ${db_args} ${format_args} --key 'AOA' | xmllint --format -
#+END_SRC
...
#+begin_src sh
export ORES_CLI_DB_PASSWORD
./ores.cli currencies export ${log_args} ${db_args} ${format_args} --as-of "2025-11-27 00:06:09" | xmllint --format - | head -n 25
#+END_SRC
...
<CurrencyConfig>
  <Currency>
    ...
    <ISOCode>ABCDE</ISOCode>
    <NumericCode>1234</NumericCode>
    <Symbol/>
    <FractionSymbol/>
    <FractionsPerUnit>100</FractionsPerUnit>
    <RoundingType>Closest</RoundingType>
...
#+begin_src sh
export ORES_CLI_DB_PASSWORD
./ores.cli currencies export ${log_args} ${db_args} ${format_args} --as-of "2025-11-27 00:08:06" --key 'AOA' | xmllint --format -
#+END_SRC
...
#+begin_src sh
export ORES_CLI_DB_PASSWORD
./ores.cli currencies export ${log_args} ${db_args} ${format_args} --key 'AOA' --all-versions | xmllint --format - | head -n 25
#+END_SRC
...
#+begin_src sh
export ORES_CLI_DB_PASSWORD
./ores.cli currencies export ${log_args} ${db_args} ${format_args} --all-versions | xmllint --format - | head -n 50
#+END_SRC
...
#+begin_src sh
export ORES_CLI_DB_PASSWORD
./ores.cli currencies export ${log_args} ${db_args} ${format_args} | jq .
#+END_SRC
...
[
  {
    ...
    "currency_type": "",
    "modified_by": "ores",
    "valid_from": "2025-11-27 15:24:11",
    "valid_to": "2025-11-27 15:24:11"
  },
  {
    "iso_code": "AED",
    "name": "United Arab Emirates dirham",
  ...
  },
  {
    ...
    "modified_by": "newuser3",
    "valid_from": "2025-11-26 23:42:24",
    "valid_to": "2025-11-26 23:42:24"
  },
  {
    "iso_code": "ABCDE",
    "name": "New Currency",
    ...
    "currency_type": "major",
    "modified_by": "test",
    "valid_from": "2025-11-18 22:35:29",
    "valid_to": "2025-11-18 22:35:29"
  }
]
#+end_src
...
#+begin_src sh
export ORES_CLI_DB_PASSWORD
./ores.cli currencies export ${log_args} ${db_args} ${format_args} --key 'AOA' | jq .
#+END_SRC
...
#+begin_src sh
export ORES_CLI_DB_PASSWORD
./ores.cli currencies export ${log_args} ${db_args} ${format_args} --as-of "2025-11-27 00:06:09" | jq .[:3]
#+END_SRC
...
#+begin_src sh
export ORES_CLI_DB_PASSWORD
./ores.cli currencies export ${log_args} ${db_args} ${format_args} --as-of "2025-11-27 00:08:06" --key 'AOA' | jq .
#+END_SRC
...
#+begin_src sh
export ORES_CLI_DB_PASSWORD
./ores.cli currencies export ${log_args} ${db_args} ${format_args} --key 'AOA' --all-versions | jq .[:3]
#+END_SRC
...
[
  ...
  },
  {
    ...
    "currency_type": "",
    "modified_by": "ores",
    "valid_from": "2025-11-27 15:20:51",
    "valid_to": "2025-11-27 15:20:51"
  },
  {
    "iso_code": "AOA",
    "name": "Angolan kwanza",
    ...
    "currency_type": "",
    "modified_by": "ores",
    "valid_from": "2025-11-27 15:20:45",
    "valid_to": "2025-11-27 15:20:45"
  }
]
#+end_src
...
#+begin_src sh
export ORES_CLI_DB_PASSWORD
./ores.cli currencies export ${log_args} ${db_args} ${format_args} --entity currencies --all-versions | jq .[:4]
#+END_SRC
