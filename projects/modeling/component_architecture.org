...
The tree is part-way through that change. =ores.analytics= and
=ores.eventing= are component-level; the other 18 composites still
register each part in =projects/CMakeLists.txt=.
