 ...
 *
 */
#ifndef ORES_DQ_API_EVENTING_CATALOG_CHANGED_EVENT_HPP
#define ORES_DQ_API_EVENTING_CATALOG_CHANGED_EVENT_HPP
...
/**
 * @brief Event traits specialization for catalog_changed_event.
 */
template<>
struct event_traits<ores::dq::eventing::catalog_changed_event> {
    static constexpr std::string_view name = "ores.dq.catalog_changed";
};
