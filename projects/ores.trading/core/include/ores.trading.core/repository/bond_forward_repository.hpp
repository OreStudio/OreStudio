 ...
 *
 */
#ifndef ORES_TRADING_CORE_REPOSITORY_BOND_FORWARD_REPOSITORY_HPP
#define ORES_TRADING_CORE_REPOSITORY_BOND_FORWARD_REPOSITORY_HPP
...
/**
 * @brief Reads and writes bond forwards to data storage.
 */
class ORES_TRADING_CORE_EXPORT bond_forward_repository {
private:
    inline static std::string_view logger_name = "ores.trading.repository.bond_forward_repository";
...
public:
    ...
    /**
     * @brief Writes bond forwards to database.
     */
    /**@{*/
    void write(context ctx, const domain::bond_forward& v);
    void write(context ctx, const std::vector<domain::bond_forward>& v);
    /**@}*/

    /**
     * @brief Reads latest bond forwards, possibly filtered by primary key.
     */
    /**@{*/
