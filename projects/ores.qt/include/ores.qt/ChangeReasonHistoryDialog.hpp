...
signals:
     ...
     */
    void openVersionRequested(const iam::domain::change_reason& reason,
        int versionNumber);
     ...
     */
    void revertVersionRequested(const iam::domain::change_reason& reason);
...
private:
    ...
    DiffResult calculateDiff(
        const iam::domain::change_reason& current,
    ...
    QString code_;
    std::vector<iam::domain::change_reason> versions_;
