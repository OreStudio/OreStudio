...
-   Update the skill dependencies diagram `doc/skills/modeling/skill_dependencies.puml` to add the new skill and its dependencies on other skills. See [Skill dependencies diagram](#org52b3ec1) for details.
