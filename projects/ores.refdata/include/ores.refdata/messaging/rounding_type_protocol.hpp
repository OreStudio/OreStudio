...
struct get_rounding_types_request {
    ...
    static constexpr std::string_view nats_subject = "ores.refdata.v1.rounding-types.list";
    int offset = 0;
    int limit = 100;
};
...
struct save_rounding_type_request {
    ...
    static constexpr std::string_view nats_subject = "ores.refdata.v1.rounding-types.save";
...
struct delete_rounding_type_request {
    ...
    static constexpr std::string_view nats_subject = "ores.refdata.v1.rounding-types.delete";
    std::string type;
};
...
struct get_rounding_type_history_request {
    ...
    static constexpr std::string_view nats_subject = "ores.refdata.v1.rounding-types.history";
    std::string type;
};
