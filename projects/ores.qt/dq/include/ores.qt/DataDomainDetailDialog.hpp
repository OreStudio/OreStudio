...
/**
 * @brief Detail dialog for viewing and editing data domain records.
 *
 * This dialog allows viewing, creating, and editing data domains.
...
private:
    inline static std::string_view logger_name = "ores.qt.data_domain_detail_dialog";
