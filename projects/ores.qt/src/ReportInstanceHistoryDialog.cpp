...
void ReportInstanceHistoryDialog::setupConnections() {
    connect(ui_->versionListWidget, &QTableWidget::itemSelectionChanged,
            this, &ReportInstanceHistoryDialog::onVersionSelected);
    connect(openVersionAction_, &QAction::triggered,
            this, &ReportInstanceHistoryDialog::onOpenVersionClicked);
    connect(revertAction_, &QAction::triggered,
            this, &ReportInstanceHistoryDialog::onRevertClicked);
