...
cp ".../Arrow Upload/SVG/ic_fluent_arrow_upload_20_regular.svg" \
   projects/ores.web/packages/web/src/assets/icons/regular/

cp ".../Arrow Upload/SVG/ic_fluent_arrow_upload_20_filled.svg" \
   projects/ores.web/packages/web/src/assets/icons/filled/
...
# The icons are copied into the surviving set. The Qt resource file
# that used to list them went with the ores.qt tree.
