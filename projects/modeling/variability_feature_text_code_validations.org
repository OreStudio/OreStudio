:PROPERTIES:
:ID: 57D55D45-AA9A-48CD-8A23-A4738368279B
:END:
#+title: Feature: text_code_validations
#+description: FK validations against a text lookup column.
#+type: feature
#+level: cross
...
| Field | Value |
|-------+-------|
| Literal name | =:text_code_validations:= |
...
FK validations against a text lookup column (rather than a uuid FK).

* Structural consequence

Yes — adds a validation call to the insert trigger.
