...
#+CAPTION: Clock summary at [2024-06-29 Sat 18:14]
| <75>                                    |         |       |      |       |
| Headline                                | Time    |       |      |     % |
|-----------------------------------------+---------+-------+------+-------|
| *Total time*                            | *22:28* |       |      | 100.0 |
|-----------------------------------------+---------+-------+------+-------|
| Stories                                 | 22:28   |       |      | 100.0 |
| Active                                  |         | 22:28 |      | 100.0 |
| Sprint and product backlog refinement   |         |       | 0:55 |   4.1 |
| Create a basic git hub repository       |         |       | 0:35 |   2.6 |
| Setup a discord channel for the project |         |       | 0:14 |   1.0 |
| Setup vcpkg and cmake                   |         |       | 1:21 |   6.0 |
| Setup github actions                    |         |       | 1:21 |   6.0 |
| Create and upload a package             |         |       | 3:28 |  15.4 |
| Create a basic project structure        |         |       | 2:10 |   9.6 |
| Add a Qt hello world                    |         |       | 3:08 |  13.9 |
| Add a splash screen to applciation      |         |       | 0:41 |   3.0 |
| Add basic site                          |         |       | 0:34 |   2.5 |
| Add modeling infrastructure             |         |       | 1:30 |   6.7 |
| Fix code syntax highlighting in site    |         |       | 0:10 |   0.7 |
| Merge index with readme                 |         |       | 0:24 |   1.8 |
| Add nightly support with memcheck       |         |       | 2:25 |  10.8 |
| Add XML parsing support for currency    |         |       | 1:24 |   6.2 |
| Create a containing structure for data  |         |       | 0:28 |   2.1 |
| Add basic widgets to display currencies |         |       | 0:26 |   1.9 |
| Add basic logging support               |         |       | 1:14 |   5.5 |
#+end:
