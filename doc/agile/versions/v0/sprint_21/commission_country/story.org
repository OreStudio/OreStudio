...
| Now           | CLI verification done (recipes fixed + results refreshed). Shell verification in progress — regression in =countries get= (parse error on v0.0.21). |
| Waiting on    | Nothing.                               |
| Next          | Diagnose and fix =countries get= parse regression in shell; then codegen back-out. |
...
| [[id:D960E38F-78CB-491E-B792-20D20C4C27B0][Verify country shell commands post-NATS]] | STARTED | 2026-06-25 | | Run the five shell submenu commands (help, get, add, delete, history) against live services; fix or file regressions; refresh recipe captured results. Regression found: countries get returns parse error on v0.0.21 — needs diagnosis. |
