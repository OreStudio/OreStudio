 ...
 *
 */
#ifndef ORES_REFDATA_API_DOMAIN_LEG_TYPE_HPP
#define ORES_REFDATA_API_DOMAIN_LEG_TYPE_HPP
...
struct leg_type final {
    ...
    /**
     * @brief Username of the person who last modified this leg type.
     */
...
/**
 * @brief Dispatch-key identifier for leg_type, e.g. for the
 * generic history-diff request and action registries. Single source
 * of truth: every call site spells entity_type_of(value) regardless
 * of which entity it holds.
 */
[[nodiscard]] constexpr std::string_view entity_type_of(const leg_type&) {
    return "ores.refdata.leg_type";
}
