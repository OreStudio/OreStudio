...
create or replace function ores_refdata_account_types_insert_fn()
returns trigger as $$
declare
...
before insert on "ores_refdata_account_types_tbl"
for each row
execute function ores_refdata_account_types_insert_fn();

create or replace rule ores_refdata_account_types_delete_rule as
on delete to "ores_refdata_account_types_tbl"
do instead
  update "ores_refdata_account_types_tbl"
  set valid_to = current_timestamp
