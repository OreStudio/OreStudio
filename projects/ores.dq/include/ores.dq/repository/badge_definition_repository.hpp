 ...
 *
 */
#ifndef ORES_DQ_REPOSITORY_BADGE_DEFINITION_REPOSITORY_HPP
#define ORES_DQ_REPOSITORY_BADGE_DEFINITION_REPOSITORY_HPP
 ...
 */
class badge_definition_repository {
private:
    inline static std::string_view logger_name =
        "ores.dq.repository.badge_definition_repository";
