 ...
 *
 */
#include "ores.marketdata.core/messaging/crm_driver_pair_registrar.hpp"
#include "ores.marketdata.api/messaging/crm_driver_pair_protocol.hpp"
#include "ores.marketdata.core/messaging/crm_driver_pair_handler.hpp"
#include <memory>
...
register_crm_driver_pair_handlers(ores::nats::service::client& nats,
