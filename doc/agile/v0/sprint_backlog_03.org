...
#+CAPTION: Clock summary at [2025-10-24 Fri 01:24], for Friday, October 24, 2025.
|      | <75>                                        |        |      |      |       |
| Tags | Headline                                    | Time   |      |      |     % |
|------+---------------------------------------------+--------+------+------+-------|
...
|      | Stories                                     | 1:20   |      |      | 100.0 |
|      | Active                                      |        | 1:20 |      | 100.0 |
| code | Add support for feature flags               |        |      | 0:25 |  31.2 |
| code | Implement authentication bootstrap workflow |        |      | 0:41 |  51.2 |
| code | Enable qt gui                               |        |      | 0:14 |  17.5 |
#+end:

#+begin: clocktable :maxlevel 3 :scope subtree :tags t :indent nil :emphasize nil :scope file :narrow 75 :formula %
#+TBLNAME: sprint_summary
#+CAPTION: Clock summary at [2025-10-24 Fri 01:24]
|       | <75>                                        |        |      |      |       |
| Tags  | Headline                                    | Time   |      |      |     % |
|-------+---------------------------------------------+--------+------+------+-------|
...
|       | Stories                                     | 6:00   |      |      | 100.0 |
|       | Active                                      |        | 6:00 |      | 100.0 |
| agile | Sprint and product backlog refinement       |        |      | 0:35 |   9.7 |
| code  | Investigate leaks from valgrind             |        |      | 0:46 |  12.8 |
| code  | Add locking up logic                        |        |      | 1:28 |  24.4 |
| code  | Add support for feature flags               |        |      | 0:35 |   9.7 |
| code  | Implement authentication bootstrap workflow |        |      | 1:06 |  18.3 |
| code  | Enable qt gui                               |        |      | 0:17 |   4.7 |
| code  | Add workspace as a container                |        |      | 1:13 |  20.3 |
#+end:
