...
#+CAPTION: Clock summary at [2024-07-12 Fri 00:24]
|       | <75>                                              |         |       |      |       |
| Tags  | Headline                                          | Time    |       |      |     % |
|-------+---------------------------------------------------+---------+-------+------+-------|
|       | *Total time*                                      | *61:38* |       |      | 100.0 |
|-------+---------------------------------------------------+---------+-------+------+-------|
|       | Stories                                           | 61:38   |       |      | 100.0 |
|       | Active                                            |         | 61:38 |      | 100.0 |
| agile | Sprint and product backlog refinement             |         |       | 2:53 |   4.7 |
...
| infra | Create and upload a package                       |         |       | 3:28 |   5.6 |
| code  | Create a basic project structure                  |         |       | 2:10 |   3.5 |
| code  | Add a Qt hello world                              |         |       | 3:08 |   5.1 |
...
*** STARTED Add database support for currency                         :infra:
    :LOGBOOK:
