...
begin
    ...
    from (values
        ...
        ('ARA', 'Arcturian Aurum', 10002, '€', 'c', 100, 'Closest', 2, '€#,##0.00', 'fiat.g10', 'ar'),
        ('BAF', 'Balthorian Florin', 10003, '£', 'p', 100, 'Closest', 2, '£#,##0.00', 'fiat.g10', 'ba'),
        ('BEB', 'Bellorian Bezant', 10004, '¥', '', 0, 'Closest', 0, '¥#,##0', 'fiat.emerging', 'be'),
        ('CAC', 'Calandrian Crown', 10005, 'kr', 'ø', 100, 'Closest', 2, 'kr #,##0.00', 'fiat.g10', 'ca'),
        ...
        ('HEF', 'Helvetian Florin', 10015, '€', 'c', 100, 'Closest', 2, '€#,##0.00', 'fiat.g10', 'he'),
        ('HYH', 'Hydronian Helix', 10016, '£', 'p', 100, 'Closest', 2, '£#,##0.00', 'fiat.g10', 'hy'),
        ('IRD', 'Iridian Ducat', 10017, '¥', '', 0, 'Closest', 0, '¥#,##0', 'fiat.emerging', 'ir'),
        ('ITI', 'Ithacan Ion', 10018, 'kr', 'ø', 100, 'Closest', 2, 'kr #,##0.00', 'fiat.g10', 'it'),
        ...
        ('NTN', 'Netharian Naira', 10028, '€', 'c', 100, 'Closest', 2, '€#,##0.00', 'fiat.g10', 'nt'),
        ('ORB', 'Orinocan Bolivar', 10029, '£', 'p', 100, 'Closest', 2, '£#,##0.00', 'fiat.g10', 'or'),
        ('OLO', 'Orlanthian Orb', 10030, '¥', '', 0, 'Closest', 0, '¥#,##0', 'fiat.emerging', 'ol'),
        ('PAP', 'Paldorian Pound', 10031, 'kr', 'ø', 100, 'Closest', 2, 'kr #,##0.00', 'fiat.g10', 'pa'),
        ...
        ('ULU', 'Uldorian Unit', 10041, '€', 'c', 100, 'Closest', 2, '€#,##0.00', 'fiat.g10', 'ul'),
        ('UTU', 'Utopian Utopia', 10042, '£', 'p', 100, 'Closest', 2, '£#,##0.00', 'fiat.g10', 'ut'),
        ('VAV', 'Valorian Valor', 10043, '¥', '', 0, 'Closest', 0, '¥#,##0', 'fiat.emerging', 'va'),
        ('VLV', 'Valtarian Vault', 10044, 'kr', 'ø', 100, 'Closest', 2, 'kr #,##0.00', 'fiat.g10', 'vl'),
        ...
        ('AKA', 'Akorian Akka', 10054, '€', 'c', 100, 'Closest', 2, '€#,##0.00', 'fiat.g10', 'ak'),
        ('AMA', 'Amethian Amethyst', 10055, '£', 'p', 100, 'Closest', 2, '£#,##0.00', 'fiat.g10', 'am'),
        ('ANA', 'Andorian Andar', 10056, '¥', '', 0, 'Closest', 0, '¥#,##0', 'fiat.emerging', 'an'),
        ('AOA', 'Aorlandian Aureole', 10057, 'kr', 'ø', 100, 'Closest', 2, 'kr #,##0.00', 'fiat.g10', 'ao'),
        ...
        ('BUB', 'Burandian Bur', 10067, '€', 'c', 100, 'Closest', 2, '€#,##0.00', 'fiat.g10', 'bu'),
        ('BYB', 'Byzantian Byzant', 10068, '£', 'p', 100, 'Closest', 2, '£#,##0.00', 'fiat.g10', 'by'),
        ('CEC', 'Celestian Celestial', 10069, '¥', '', 0, 'Closest', 0, '¥#,##0', 'fiat.emerging', 'ce'),
        ('CHC', 'Chronian Chron', 10070, 'kr', 'ø', 100, 'Closest', 2, 'kr #,##0.00', 'fiat.g10', 'ch'),
        ...
        ('DUD', 'Dulcorian Dulce', 10080, '€', 'c', 100, 'Closest', 2, '€#,##0.00', 'fiat.g10', 'du'),
        ('DYD', 'Dystopian Dyst', 10081, '£', 'p', 100, 'Closest', 2, '£#,##0.00', 'fiat.g10', 'dy'),
        ('EBE', 'Ebonian Ebony', 10082, '¥', '', 0, 'Closest', 0, '¥#,##0', 'fiat.emerging', 'eb'),
        ('ECE', 'Echorian Echo', 10083, 'kr', 'ø', 100, 'Closest', 2, 'kr #,##0.00', 'fiat.g10', 'ec'),
        ...
        ('EQE', 'Equatorian Equus', 10093, '€', 'c', 100, 'Closest', 2, '€#,##0.00', 'fiat.g10', 'eq'),
        ('ETE', 'Etherian Ether', 10094, '£', 'p', 100, 'Closest', 2, '£#,##0.00', 'fiat.g10', 'et'),
        ('EUE', 'Eudorian Eudox', 10095, '¥', '', 0, 'Closest', 0, '¥#,##0', 'fiat.emerging', 'eu'),
        ('EVE', 'Everonian Ever', 10096, 'kr', 'ø', 100, 'Closest', 2, 'kr #,##0.00', 'fiat.g10', 'ev'),
