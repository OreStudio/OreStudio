...
create or replace trigger ores_reporting_report_types_notify_trg
after insert or update or delete on ores_reporting_report_types_tbl
for each row execute function ores_reporting_report_types_notify_fn();
