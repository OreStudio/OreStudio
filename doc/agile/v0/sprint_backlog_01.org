...
#+CAPTION: Clock summary at [2024-06-29 Sat 14:12]
| <75>                                    |         |       |      |       |
| Headline                                | Time    |       |      |     % |
|-----------------------------------------+---------+-------+------+-------|
...
| Create and upload a package             |         |       | 3:28 |  15.8 |
| Create a basic project structure        |         |       | 2:10 |   9.9 |
| Add a Qt hello world                    |         |       | 3:08 |  14.3 |
| Add a splash screen to applciation      |         |       | 0:41 |   3.1 |
| Add basic site                          |         |       | 0:34 |   2.6 |
| Add modeling infrastructure             |         |       | 1:30 |   6.8 |
| Add nightly support with memcheck       |         |       | 2:25 |  11.0 |
| Add XML parsing support for currency    |         |       | 1:24 |   6.4 |
| Create a containing structure for data  |         |       | 0:28 |   2.1 |
| Add basic widgets to display currencies |         |       | 0:26 |   2.0 |
| Add basic logging support               |         |       | 1:14 |   5.6 |
#+end:
