...
The =<<paste:5E47F108-1350-4540-B3C2-E83DD5379B2D>>= marker is replaced
with any entity-model-defined extra drop statements (e.g. the
validate function generated by the companion =_table.org= model). If no
entity implements the kind the marker expands to an empty string.
