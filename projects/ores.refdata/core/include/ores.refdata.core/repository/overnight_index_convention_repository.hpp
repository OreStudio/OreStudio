 ...
 */
#ifndef ORES_REFDATA_CORE_REPOSITORY_OVERNIGHT_INDEX_CONVENTION_REPOSITORY_HPP
#define ORES_REFDATA_CORE_REPOSITORY_OVERNIGHT_INDEX_CONVENTION_REPOSITORY_HPP
 ...
 */
class ORES_REFDATA_CORE_EXPORT overnight_index_convention_repository {
private:
...
public:
    ...
    /**
     * @brief Writes overnight index conventions to database.
     *
    ...
    /**
     * @brief Writes a overnight index convention, honouring the claim it states.
     *
    ...
    /**
     * @brief Writes a set of overnight index conventions, each honouring its own
    ...
    /**
     * @brief Reads latest overnight index conventions, possibly filtered by primary key.
     */
    /**@{*/
    ...
    /**
     * @brief Reads all overnight index conventions, possibly filtered by primary key.
     */
    std::vector<domain::overnight_index_convention> read_all(context ctx, const std::string& id);

    /**
     * @brief Reads a single overnight index convention as it stood at a specific
    ...
    /**
     * @brief Reads latest overnight index conventions with pagination support.
     * @param ctx Repository context with database connection
     ...
     */
    std::uint32_t get_total_overnight_index_convention_count(context ctx);

    /**
     * @brief Deletes a overnight index convention by closing its temporal validity.
     */
    ...
    /**
     * @brief Removes a overnight index convention, refusing a row that moved on.
     *
    ...
    /**
     * @brief Deletes overnight index conventions by closing their temporal validity.
     */
