...
| [[id:10E43A2D-3388-4F4F-A949-736B2A291B76][Entity classification and drift baseline: ores.synthetic]] | BACKLOG | | | Run the codegen-fix-drift method: bind synthetic entities to profiles, verify zero-diff regen, extend the drift gate. |
