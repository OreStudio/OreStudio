...
register_party_contact_information_event_mapping(ev::service::postgres_event_source& event_source,
    ...
    return event_bus.subscribe<refdata::eventing::party_contact_information_changed_event>(
        [&nats](const refdata::eventing::party_contact_information_changed_event& e) {
