...
#+description: Use generate_doc.sh to scaffold a component_overview.org and fill in each required section.
#+type: recipe
#+version: 2
#+level: cross
...
=projects/ores.codegen/generate_doc.sh= — the Mustache-based
