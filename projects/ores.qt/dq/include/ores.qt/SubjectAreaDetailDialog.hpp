...
/**
 * @brief Detail dialog for viewing and editing subject area records.
 *
 * This dialog allows viewing, creating, and editing subject areas.
...
private:
    ...
    void updateUiFromArea();
    void updateAreaFromUi();
