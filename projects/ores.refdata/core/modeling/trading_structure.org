...
| =functional_currency=    | Functional currency for the book (designated by the ledger)                         |
| =regulatory_book_type= | =Trading= or =Banking= (FRTB classification)          |
...
- The =regulatory_book_type= field on the book distinguishes trading from banking
  book positions.
