...
#+CAPTION: Clock summary at [2026-01-05 Mon 23:30], for Monday, January 05, 2026.
|      | <75>                              |        |      |      |       |
| Tags | Headline                          | Time   |      |      |     % |
|------+-----------------------------------+--------+------+------+-------|
...
|      | Stories                           | 4:36   |      |      | 100.0 |
|      | Active                            |        | 4:36 |      | 100.0 |
| code | Review HTTP service               |        |      | 2:01 |  43.8 |
| code | Assorted fixes to currency dialog |        |      | 2:35 |  56.2 |
#+end:

#+begin: clocktable :maxlevel 3 :scope subtree :tags t :indent nil :emphasize nil :scope file :narrow 75 :formula %
#+CAPTION: Clock summary at [2026-01-05 Mon 23:30]
|       | <75>                                        |         |       |      |       |
| Tags  | Headline                                    | Time    |       |      |     % |
|-------+---------------------------------------------+---------+-------+------+-------|
|       | *Total time*                                | *20:48* |       |      | 100.0 |
|-------+---------------------------------------------+---------+-------+------+-------|
|       | Stories                                     | 20:48   |       |      | 100.0 |
|       | Active                                      |         | 20:48 |      | 100.0 |
| agile | Sprint and product backlog refinement       |         |       | 1:17 |   6.2 |
| code  | Rerun SQL scripts from scratch              |         |       | 7:52 |  37.8 |
| code  | Run qt client and validate all new features |         |       | 1:19 |   6.3 |
| code  | Refactor options and parser                 |         |       | 0:27 |   2.2 |
| code  | Check functionality in =ores.wt=            |         |       | 2:03 |   9.9 |
| code  | Rename =ores.shell= to =ores.comms.shell=   |         |       | 1:30 |   7.2 |
| code  | Review HTTP service                         |         |       | 3:45 |  18.0 |
| code  | Assorted fixes to currency dialog           |         |       | 2:35 |  12.4 |
#+end:
...
*** STARTED Assorted fixes to currency dialog                          :code:
    :LOGBOOK:
...
*** Review comms analyser work                                         :code:
