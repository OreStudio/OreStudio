...
|------+-------+-------+-----+-------------|
| [[id:1D7A5AA2-3F1F-49F5-855A-EB69AECBEDB8][Verify country shell and CLI commands post-NATS]] | STARTED | 2026-06-25 | | Run the countries shell submenu (list, add, get, delete, history) and the four CLI recipes against live services; fix or file what breaks; refresh recipe captured results where stale. |
