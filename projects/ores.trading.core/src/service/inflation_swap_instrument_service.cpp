...
inflation_swap_instrument_service::inflation_swap_instrument_service(
    context ctx)
    : ctx_(std::move(ctx)) {}
...
inflation_swap_instrument_service::list_inflation_swap_instruments(
    ...
    BOOST_LOG_SEV(lg(), debug)
        << "Listing inflation_swap_instruments with offset="
        << offset << ", limit=" << limit;
...
std::uint32_t
inflation_swap_instrument_service::count_inflation_swap_instruments() {
...
inflation_swap_instrument_service::get_inflation_swap_instrument_history(
    const std::string& id) {
    BOOST_LOG_SEV(lg(), debug)
        << "Getting history for inflation_swap_instrument: " << id;
