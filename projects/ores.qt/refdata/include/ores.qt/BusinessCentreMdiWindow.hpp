 ...
 *
 * Provides a table view of business centres with toolbar actions
 * for reload, add, edit, delete, and viewing history.
 */
class BusinessCentreMdiWindow final : public EntityListMdiWindow {
    Q_OBJECT
...
protected:
    QString normalRefreshTooltip() const override {
        return tr("Refresh business centres");
    }
