 ...
 *
 */
#ifndef ORES_TRADING_REPOSITORY_BALANCE_GUARANTEED_SWAP_INSTRUMENT_REPOSITORY_HPP
#define ORES_TRADING_REPOSITORY_BALANCE_GUARANTEED_SWAP_INSTRUMENT_REPOSITORY_HPP
