...
|--------+-------|
| Status | FAIL |
| Notes  | - can you set the logo in the system party as well; ; [[file:scenario_acme_readiness_step2_20260730_110542.png]]; ; - logo not rendering in details; ; [[file:scenario_acme_readiness_step2_20260730_110627.png]] |
...
|--------+-------|
| Status | PASS |
| Notes  | ok still confused. i thought the holding company would be more or less empty, just a shell to contain the other parties. then the;   london party would be quite filled in. but when i see org structure it looks a bit messy. noticed the unassigned.; ; [[file:scenario_acme_readiness_step3_20260729_173213.png]]; ; also portfolio explorer ; ; [[file:scenario_acme_readiness_step3_20260729_173239.png]] |
...
|--------+-------|
| Status | FAIL |
| Notes  | we did not install CRMs into ACME |
...
|--------+-------|
| Status | PENDING |
| Notes  | Split out into a separate persona/RBAC test scenario, run independently of the provisioning-readiness pass this scenario verifies. Candidate login: molly.quinn@acme_corporation (Senior Trader, ACME Corporation UK plc), password Secure-Password-123. |
...
|--------+-------|
| Status | PENDING |
| Notes  | Split out into a separate persona/RBAC test scenario, run independently of the provisioning-readiness pass this scenario verifies. Candidate login: lawrence.davis@acme_corporation (Head of Middle Office, ACME Corporation UK plc), password Secure-Password-123. |
...
|---------------+-------|
| Status        | FAILED |
| Completed at  | 2026-07-30T10:15:16Z |
