...
#+CAPTION: Clock summary at [2024-07-11 Thu 23:03]
|       | <75>                                              |         |       |      |       |
| Tags  | Headline                                          | Time    |       |      |     % |
|-------+---------------------------------------------------+---------+-------+------+-------|
...
|       | Stories                                           | 60:19   |       |      | 100.0 |
|       | Active                                            |         | 60:19 |      | 100.0 |
| agile | Sprint and product backlog refinement             |         |       | 2:53 |   4.8 |
| infra | Create a basic git hub repository                 |         |       | 0:35 |   1.0 |
| infra | Setup a discord channel for the project           |         |       | 0:14 |   0.4 |
| infra | Setup vcpkg and cmake                             |         |       | 1:21 |   2.2 |
| infra | Setup github actions                              |         |       | 1:21 |   2.2 |
| infra | Create and upload a package                       |         |       | 3:28 |   5.7 |
| code  | Create a basic project structure                  |         |       | 2:10 |   3.6 |
| code  | Add a Qt hello world                              |         |       | 3:08 |   5.2 |
| code  | Add a splash screen to applciation                |         |       | 0:41 |   1.1 |
| infra | Add basic site                                    |         |       | 0:34 |   0.9 |
| code  | Add modeling infrastructure                       |         |       | 1:30 |   2.5 |
| infra | Fix code syntax highlighting in site              |         |       | 0:10 |   0.3 |
| doc   | Merge index with readme                           |         |       | 0:42 |   1.2 |
| doc   | Add project objective to readme                   |         |       | 2:24 |   4.0 |
| code  | Add basic logging support                         |         |       | 1:14 |   2.0 |
| infra | Add nightly support with memcheck                 |         |       | 3:21 |   5.6 |
| code  | Clean up toolchains and presets                   |         |       | 1:53 |   3.1 |
| doc   | Generate Doxygen documentation and add it to site |         |       | 0:51 |   1.4 |
| doc   | Copy domain notes on core concepts                |         |       | 4:41 |   7.8 |
| infra | Valgrind fails to run unit tests                  |         |       | 1:12 |   2.0 |
| infra | Initial sanity test generated packages            |         |       | 0:25 |   0.7 |
| code  | Add command line options support                  |         |       | 5:45 |   9.5 |
| infra | Unit tests show up twice in nightlies             |         |       | 0:13 |   0.4 |
| doc   | Add recipes for command line                      |         |       | 0:51 |   1.4 |
| agile | Use a bar chart for sprint resourcing cost        |         |       | 2:57 |   4.9 |
| agile | Classify stories by type                          |         |       | 0:34 |   0.9 |
| code  | Update C++ standard                               |         |       | 0:29 |   0.8 |
| infra | Setup laptop for development                      |         |       | 3:47 |   6.3 |
| code  | Add XML parsing support for currency              |         |       | 6:32 |  10.8 |
| code  | Add JSON support for currency                     |         |       | 2:03 |   3.4 |
| code  | Create a containing structure for data            |         |       | 0:28 |   0.8 |
| code  | Add basic widgets to display currencies           |         |       | 0:26 |   0.7 |
| doc   | Convert plantuml diagrams to org-babel            |         |       | 1:05 |   1.8 |
...
*** STARTED Add JSON support for currency                              :code:
    :LOGBOOK:
