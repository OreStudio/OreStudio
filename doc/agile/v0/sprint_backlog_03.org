...
#+CAPTION: Clock summary at [2025-10-28 Tue 00:45], for Tuesday, October 28, 2025.
|      | <75>                                                   |        |      |      |       |
| Tags | Headline                                               | Time   |      |      |     % |
|------+--------------------------------------------------------+--------+------+------+-------|
...
|      | Stories                                                | 0:45   |      |      | 100.0 |
|      | Active                                                 |        | 0:45 |      | 100.0 |
| code | Implement logging according to correct boost.log usage |        |      | 0:45 | 100.0 |
#+end:

#+begin: clocktable :maxlevel 3 :scope subtree :tags t :indent nil :emphasize nil :scope file :narrow 75 :formula %
#+TBLNAME: sprint_summary
#+CAPTION: Clock summary at [2025-10-28 Tue 00:45]
|       | <75>                                                   |         |       |      |       |
| Tags  | Headline                                               | Time    |       |      |     % |
|-------+--------------------------------------------------------+---------+-------+------+-------|
|       | *Total time*                                           | *35:08* |       |      | 100.0 |
|-------+--------------------------------------------------------+---------+-------+------+-------|
|       | Stories                                                | 35:08   |       |      | 100.0 |
|       | Active                                                 |         | 35:08 |      | 100.0 |
| agile | Sprint and product backlog refinement                  |         |       | 1:11 |   3.4 |
| code  | Add locking up logic                                   |         |       | 1:28 |   4.2 |
| code  | Build using dynamic libraries                          |         |       | 7:24 |  21.1 |
| code  | Enable qt gui                                          |         |       | 4:13 |  12.0 |
| code  | Add locking up logic                                   |         |       | 1:28 |   4.2 |
| code  | Build using dynamic libraries                          |         |       | 7:24 |  21.1 |
| code  | Implement logging according to correct boost.log usage |         |       | 8:02 |  22.9 |
| code  | Investigate leaks from valgrind                        |         |       | 0:46 |   2.2 |
| code  | Add support for feature flags                          |         |       | 1:25 |   4.0 |
| code  | Implement authentication bootstrap workflow            |         |       | 0:25 |   1.2 |
| code  | Fix broken windows builds                              |         |       | 0:09 |   0.4 |
| code  | Add workspace as a container                           |         |       | 1:13 |   3.5 |
#+end:
...
*** Fix broken Linux and OSX tests                                     :code:
