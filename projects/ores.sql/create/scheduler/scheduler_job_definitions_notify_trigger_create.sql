...
begin
    ...
    notification_payload := jsonb_build_object(
        ...
        'entity', 'ores.scheduler.job_definition',
    ...
    perform pg_notify('ores_scheduler_job_definitions', notification_payload::text);

    return null;
end;
$$ language plpgsql;

create or replace trigger ores_scheduler_job_definitions_notify_trg
after insert or update or delete on ores_scheduler_job_definitions_tbl
for each row execute function ores_scheduler_job_definitions_notify_fn();
