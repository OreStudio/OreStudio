 ...
 *
 */
#ifndef ORES_DQ_CORE_REPOSITORY_CHANGE_REASON_ENTITY_HPP
#define ORES_DQ_CORE_REPOSITORY_CHANGE_REASON_ENTITY_HPP
...
/**
 * @brief Represents a change reason in the database.
 */
struct change_reason_entity {
    constexpr static const char* schema = "public";
    constexpr static const char* tablename = "ores_dq_change_reasons_tbl";
