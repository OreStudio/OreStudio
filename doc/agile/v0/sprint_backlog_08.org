...
#+CAPTION: Clock summary at [2026-01-04 Sun 01:34], for Sunday, January 04, 2026.
|      | <75>                |        |      |      |       |
| Tags | Headline            | Time   |      |      |     % |
|------+---------------------+--------+------+------+-------|
...
|      | Stories             | 1:34   |      |      | 100.0 |
|      | Active              |        | 1:34 |      | 100.0 |
| code | Review HTTP service |        |      | 1:34 | 100.0 |
#+end:

#+begin: clocktable :maxlevel 3 :scope subtree :tags t :indent nil :emphasize nil :scope file :narrow 75 :formula %
#+TBLNAME: sprint_summary
#+CAPTION: Clock summary at [2026-01-04 Sun 01:34]
|       | <75>                                        |         |       |      |       |
| Tags  | Headline                                    | Time    |       |      |     % |
|-------+---------------------------------------------+---------+-------+------+-------|
|       | *Total time*                                | *16:12* |       |      | 100.0 |
|-------+---------------------------------------------+---------+-------+------+-------|
|       | Stories                                     | 16:12   |       |      | 100.0 |
|       | Active                                      |         | 16:12 |      | 100.0 |
| agile | Sprint and product backlog refinement       |         |       | 1:17 |   7.9 |
| code  | Rerun SQL scripts from scratch              |         |       | 7:52 |  48.6 |
| code  | Run qt client and validate all new features |         |       | 1:19 |   8.1 |
| code  | Refactor options and parser                 |         |       | 0:27 |   2.8 |
| code  | Check functionality in =ores.wt=            |         |       | 2:03 |  12.7 |
| code  | Rename =ores.shell= to =ores.comms.shell=   |         |       | 1:30 |   9.3 |
| code  | Review HTTP service                         |         |       | 1:44 |  10.7 |
#+end:
