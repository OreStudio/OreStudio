...
private:
    inline static std::string_view logger_name = "ores.qt.client_methodology_model";
...
public:
    enum Column { Name, Description, LogicReference, Version, ModifiedBy, RecordedAt, ColumnCount };
    ...
    explicit ClientMethodologyModel(ClientManager* clientManager, QObject* parent = nullptr);
