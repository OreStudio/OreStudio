...
private:
    inline static std::string_view logger_name = "ores.qt.dataset_bundle_controller";
...
public:
    DatasetBundleController(QMainWindow* mainWindow,
                            QMdiArea* mdiArea,
...
private:
     ...
     * DatasetBundleDetailDialog needs regardless of which
     ...
     */
    void fetchDatasetBundleHistory(
        const QString& entityId,
        std::function<void(std::expected<std::vector<dq::domain::dataset_bundle>, QString>)>
            callback);
