:PROPERTIES:
:ID: 6EF42145-CEE7-4035-806A-A4200A3E003A
:END:
#+title: Icon guidelines
#+description: ORE Studio's visual language reference — variants, sizes, the full icon inventory grouped by semantic category.
#+type: knowledge
#+level: cross
...
variant (Regular for default / Filled for active) to the UI state.
Qt and UI skills drive icon selection from this catalogue; for the broader
UI design context see [[id:6743F6E3-578C-4E4B-9DD6-D5A0DF6734C8][UI design principles]]. Return to [[id:7474935C-95D1-3034-B833-83DCD9FB3A09][Knowledge]].
...
- Regular: [[proj:projects/ores.qt/resources/icons/fluentui/regular/ic_fluent_copy_20_regular.svg]]
- Filled: [[proj:projects/ores.qt/resources/icons/fluentui/filled/ic_fluent_copy_20_filled.svg]]

*Usage*: "Copy" toolbar buttons and context menu actions that create a
copy of the selected item (e.g. folder, environment, connection). The copy
gets the original name suffixed with " (copy)".
...
- Regular: [[proj:projects/ores.qt/resources/icons/ic_fluent_delete_dismiss_20_regular.svg]]
- Filled: [[proj:projects/ores.qt/resources/icons/ic_fluent_delete_dismiss_20_filled.svg]]
...
*Usage*: Tenor Anchor reference data (SPOT, TODAY, TOMORROW, NEAR_LEG,
IMM_ROLL) and its window/menu/toolbar icon wherever referenced. Neither
Fluent UI nor Solar has a literal nautical-anchor glyph; Pin conveys the
same "fixed reference location" concept.
...
- Regular: [[proj:projects/ores.qt/resources/icons/ic_fluent_key_multiple_20_regular.svg]]
- Filled: [[proj:projects/ores.qt/resources/icons/ic_fluent_key_multiple_20_filled.svg]]
...
- Regular: [[proj:projects/ores.qt/resources/icons/fluentui/regular/ic_fluent_keyboard_20_regular.svg]]
- Filled: [[proj:projects/ores.qt/resources/icons/fluentui/filled/ic_fluent_keyboard_20_filled.svg]]

*Usage*: Manual entry options in combo boxes or dialogs where the user will
type all values themselves (as opposed to selecting from a saved connection or
environment). Conveys "I will type this myself".
...
- Regular: [[proj:projects/ores.qt/resources/icons/ic_fluent_server_link_20_regular.svg]]
- Filled: [[proj:projects/ores.qt/resources/icons/ic_fluent_server_link_20_filled.svg]]
...
*Usage*: "Logs" toolbar button in the Compute Console Tasks tab and any other
action that opens a log or text-output viewer. Distinct from Terminal
(interactive shell), DocumentCode (source code), and DocumentTable (tabular
data).
...
*Usage*: Party management (internal legal entities). Shows an org-chart/hierarchy
symbol representing corporate structure.
...
*Usage*: Business unit management. Shows a team/group of people, distinct from the
building icons used for centres and tenants.
...
*Usage*: Business centre reference data. A bank/institutional building representing
financial centres where business operations occur.
...
*Usage*: Tenant management (admin). A tall building/skyscraper representing an
...
*Usage*: Reserved for generic building contexts. Avoid using for specific entity
types; prefer the specialised variants above.
...
*Usage*: Portfolio management. A briefcase representing a collection of investments
...
*Usage*: Book management. An open book representing trading/accounting books. Distinct
from the closed Book icon used for methodologies and reference materials.
...
-   Regular: [[proj:projects/ores.qt/resources/icons/fluentui/regular/ic_fluent_calendar_clock_20_regular.svg]]
-   Filled: [[proj:projects/ores.qt/resources/icons/fluentui/filled/ic_fluent_calendar_clock_20_filled.svg]]

*Usage*: Scheduler menu entries, job definition list window title, any UI
element representing scheduled/recurring work. Solar fallback: `calendar.svg`.

*** Calendar Add

Schedule a new job, create a scheduled task.

-   Regular: [[proj:projects/ores.qt/resources/icons/fluentui/regular/ic_fluent_calendar_add_20_regular.svg]]
-   Filled: [[proj:projects/ores.qt/resources/icons/fluentui/filled/ic_fluent_calendar_add_20_filled.svg]]

*Usage*: "Schedule Job" button in job definition list toolbar. Use instead of
generic `Add` when the action specifically creates a scheduled task. Solar
fallback: `calendar-add.svg`.

*** Calendar Cancel

Unschedule a job, deactivate a scheduled task.

-   Regular: [[proj:projects/ores.qt/resources/icons/fluentui/regular/ic_fluent_calendar_cancel_20_regular.svg]]
-   Filled: [[proj:projects/ores.qt/resources/icons/fluentui/filled/ic_fluent_calendar_cancel_20_filled.svg]]

*Usage*: "Unschedule" button in job definition list toolbar and detail dialog.
Semantically distinct from `Delete` (which implies permanent removal) —
unschedule removes from pg_cron while retaining the definition. Solar fallback:
`alarm-remove.svg`.
...
cp ".../Arrow Upload/SVG/ic_fluent_arrow_upload_20_regular.svg" \
   projects/ores.qt/application/resources/icons/fluentui/regular/

cp ".../Arrow Upload/SVG/ic_fluent_arrow_upload_20_filled.svg" \
   projects/ores.qt/application/resources/icons/fluentui/filled/

# Solar icons (Linear and Bold variants)
cp ".../arrows-action/Linear/upload-square.svg" \
   projects/ores.qt/application/resources/icons/solarized/Linear/

cp ".../arrows-action/Bold/upload-square.svg" \
   projects/ores.qt/application/resources/icons/solarized/Bold/
#+end_example

** Step 3: Update Resource File

Add the new icons to =projects/ores.qt/application/resources/resources.qrc=:

#+begin_src xml
<!-- Fluent UI icons -->
<file>icons/fluentui/regular/ic_fluent_arrow_upload_20_regular.svg</file>
<file>icons/fluentui/filled/ic_fluent_arrow_upload_20_filled.svg</file>
