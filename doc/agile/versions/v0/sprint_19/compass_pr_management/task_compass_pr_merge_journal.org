...
Shipped in PR [[https://github.com/OreStudio/OreStudio/pull/1095][#1095]] (merged 2026-06-05): after a successful merge the
command maps the head branch to its task doc and stamps the journal
with DONE — proven on its own merge, where the 📓 line appeared
automatically. The close-out prompt now carries only the judgement
work.
