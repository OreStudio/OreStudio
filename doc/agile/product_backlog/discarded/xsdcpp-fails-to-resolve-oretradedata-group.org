...
- [[id:2DB7C1A3-3191-4D6E-8355-B8BE30BB7809][xsdcpp]] — the tool, its pin, and how the bindings are generated.
...
The durable fix is the pin: the tool is a sibling checkout that no
dependency file names, so its version is now recorded in the knowledge
page above rather than in a backlog item.
