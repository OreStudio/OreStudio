 ...
 *
 */
#ifndef ORES_REFDATA_REPOSITORY_PARTY_COUNTERPARTY_REPOSITORY_HPP
#define ORES_REFDATA_REPOSITORY_PARTY_COUNTERPARTY_REPOSITORY_HPP
...
class party_counterparty_repository {
private:
