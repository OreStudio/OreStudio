...
#+CAPTION: Clock summary at [2026-02-16 Mon 12:33], for Monday, February 16, 2026.
|       | <75>                                  |        |      |      |       |
| Tags  | Headline                              | Time   |      |      |     % |
|-------+---------------------------------------+--------+------+------+-------|
...
|       | Stories                               | 0:13   |      |      | 100.0 |
|       | Active                                |        | 0:13 |      | 100.0 |
| agile | Sprint and product backlog refinement |        |      | 0:13 | 100.0 |
#+end:

#+begin: clocktable :maxlevel 3 :scope subtree :tags t :indent nil :emphasize nil :scope file :narrow 75 :formula %
#+TBLNAME: sprint_summary
#+CAPTION: Clock summary at [2026-02-16 Mon 12:33]
|       | <75>                                               |         |       |      |       |
| Tags  | Headline                                           | Time    |       |      |     % |
|-------+----------------------------------------------------+---------+-------+------+-------|
...
|       | Stories                                            | 50:05   |       |      | 100.0 |
|       | Active                                             |         | 50:05 |      | 100.0 |
| agile | Sprint and product backlog refinement              |         |       | 2:43 |   5.4 |
| code  | Add bound parameters to sqlgen                     |         |       | 0:51 |   1.7 |
| code  | Add roles to account via codes                     |         |       | 0:34 |   1.1 |
| code  | Implement party related entities at database level |         |       | 4:23 |   8.8 |
| code  | Add party related support at the domain level      |         |       | 0:23 |   0.8 |
| code  | Add party related support to Qt                    |         |       | 6:41 |  13.3 |
| code  | Add GLEIF data to datasets                         |         |       | 6:41 |  13.3 |
| code  | Brainstorm on multi-party support                  |         |       | 4:00 |   8.0 |
| code  | Improve code coverage                              |         |       | 0:14 |   0.5 |
| code  | Improve generators with FK-aware test data         |         |       | 1:44 |   3.5 |
| code  | Enable all skipped tests                           |         |       | 0:29 |   1.0 |
| code  | Add central bank related LEIs                      |         |       | 0:35 |   1.2 |
| code  | Expand unit test coverage for ORE codegened types  |         |       | 0:49 |   1.6 |
| code  | Add system party support                           |         |       | 3:58 |   7.9 |
| code  | Add customer party support                         |         |       | 1:33 |   3.1 |
| code  | Fix OSX build                                      |         |       | 0:19 |   0.6 |
| code  | Add pagination to counterparty                     |         |       | 0:58 |   1.9 |
| code  | Add support for business centres                   |         |       | 3:47 |   7.6 |
| code  | Add LEI to BIC dataset                             |         |       | 0:27 |   0.9 |
| code  | Add proper party short-codes                       |         |       | 2:18 |   4.6 |
| code  | Polish party and counterparty list UI              |         |       | 1:25 |   2.8 |
| code  | Implement party-level RLS isolation                |         |       | 2:33 |   5.1 |
| code  | Add a setup new tenant wizard                      |         |       | 1:27 |   2.9 |
...
*** STARTED Gate party and counterparty wizard steps by tenant type    :code:
...
*** STARTED Improve tenant provisioning wizard UX                      :code:
...
*** STARTED Add evaluation tenant onboarding wizard on first login     :code:
