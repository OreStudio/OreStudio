...
create or replace function public.refdata_party_relationships_notify_fn()
returns trigger as $$
declare
...
after insert or update or delete on public.refdata_party_relationships_tbl
for each row execute function public.refdata_party_relationships_notify_fn();
