...
#+CAPTION: Clock summary at [2025-11-11 Tue 23:09], for Tuesday, November 11, 2025.
|       | <75>                                                |         |       |      |       |
| Tags  | Headline                                            | Time    |       |      |     % |
|-------+-----------------------------------------------------+---------+-------+------+-------|
...
|       | Stories                                             | 11:05   |       |      | 100.0 |
|       | Active                                              |         | 11:05 |      | 100.0 |
| agile | Sprint and product backlog refinement               |         |       | 0:33 |   5.0 |
| code  | Create a skill for plant uml documentation          |         |       | 2:31 |  22.7 |
| infra | Add CMake targets for site and skills               |         |       | 0:17 |   2.6 |
| infra | Generalise the skill setup for ORE Studio           |         |       | 3:45 |  33.8 |
| infra | Restructure components to follow the dogen approach |         |       | 2:54 |  26.2 |
| infra | Generate PlantUML diagrams for all components       |         |       | 1:05 |   9.8 |
#+end:

#+begin: clocktable :maxlevel 3 :scope subtree :tags t :indent nil :emphasize nil :scope file :narrow 75 :formula %
#+TBLNAME: sprint_summary
#+CAPTION: Clock summary at [2025-11-11 Tue 23:09]
|          | <75>                                                   |         |       |       |       |
| Tags     | Headline                                               | Time    |       |       |     % |
|----------+--------------------------------------------------------+---------+-------+-------+-------|
...
|          | Stories                                                | 51:05   |       |       | 100.0 |
|          | Active                                                 |         | 51:05 |       | 100.0 |
| agile    | Sprint and product backlog refinement                  |         |       |  2:33 |   5.0 |
| code     | Clean up client parser                                 |         |       |  0:10 |   0.3 |
| code     | Add connect command line argument                      |         |       |  1:19 |   2.6 |
| infra    | Install Windows package on Windows machine             |         |       |  2:09 |   4.2 |
...
| code     | Make UI/UX look more professional                      |         |       | 11:07 |  21.8 |
