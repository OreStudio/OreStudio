...
public:
    ...
    /**
     * @brief Writes a party contact information, honouring the claim it states.
     *
    ...
    /**
     * @brief Writes a set of party contact informations, each honouring its own
    ...
    /**
     * @brief Reads latest party contact informations, possibly filtered by primary key.
     */
    /**@{*/
    ...
    /**
     * @brief Removes a party contact information, refusing a row that moved on.
     *
...
private:
     ...
     */
    domain::party_contact_information apply_claim(context ctx,
                                                  const domain::party_contact_information& v,
                                                  const ores::utility::domain::precondition& claim);
};
