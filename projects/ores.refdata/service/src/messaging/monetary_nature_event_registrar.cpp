...
register_monetary_nature_event_mapping(ev::service::postgres_event_source& event_source,
    ...
    ev::service::registrar::register_mapping<refdata::eventing::monetary_nature_changed_event>(
        event_source, "ores.refdata.monetary_nature", "ores_refdata_monetary_natures");

    return event_bus.subscribe<refdata::eventing::monetary_nature_changed_event>(
        [&nats](const refdata::eventing::monetary_nature_changed_event& e) {
            ev::service::publish_entity_event(
                nats,
                std::string(ev::domain::event_traits<
                            refdata::eventing::monetary_nature_changed_event>::name),
