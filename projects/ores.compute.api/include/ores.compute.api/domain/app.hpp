...
struct app final {
    ...
    /**
     * @brief UUID primary key for the app.
     */
    boost::uuids::uuid id;

    /**
     * @brief Unique application identifier, e.g. 'ORE_STUDIO', 'LLAMA_CPP', 'LEDGER'.
     */
    std::string name;

    /**
     * @brief Human-readable description of the application engine.
     */
    std::string description;

    /**
     * @brief Username of the person who last modified this compute app.
     */
