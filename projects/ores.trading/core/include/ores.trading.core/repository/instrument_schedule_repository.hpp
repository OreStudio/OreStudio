 ...
 *
 */
#ifndef ORES_TRADING_CORE_REPOSITORY_INSTRUMENT_SCHEDULE_REPOSITORY_HPP
#define ORES_TRADING_CORE_REPOSITORY_INSTRUMENT_SCHEDULE_REPOSITORY_HPP
...
/**
 * @brief Reads and writes instrument schedules to data storage.
 */
class ORES_TRADING_CORE_EXPORT instrument_schedule_repository {
private:
    inline static std::string_view logger_name =
        "ores.trading.repository.instrument_schedule_repository";
...
public:
    ...
    /**
     * @brief Writes instrument schedules to database.
     */
    /**@{*/
    void write(context ctx, const domain::instrument_schedule& v);
    void write(context ctx, const std::vector<domain::instrument_schedule>& v);
    /**@}*/

    /**
     * @brief Reads latest instrument schedules, possibly filtered by primary key.
     */
    /**@{*/
     ...
     */
    std::uint32_t get_total_instrument_schedule_count(context ctx);
