 ...
 *
 */
#ifndef ORES_TELEMETRY_CORE_EXPORTING_LOG_EXPORTER_HPP
#define ORES_TELEMETRY_CORE_EXPORTING_LOG_EXPORTER_HPP
 ...
 */
class ORES_TELEMETRY_CORE_EXPORT log_exporter {
public:
