...
#+CAPTION: Clock summary at [2025-11-13 Thu 12:34], for Thursday, November 13, 2025.
|      | <75>                                       |        |      |      |       |
| Tags | Headline                                   | Time   |      |      |     % |
|------+--------------------------------------------+--------+------+------+-------|
...
|      | Stories                                    | 2:35   |      |      | 100.0 |
|      | Active                                     |        | 2:35 |      | 100.0 |
| code | Fix the valgrind leaks reported on sqlgen  |        |      | 1:07 |  43.2 |
| code | Review all code created so far with an LLM |        |      | 1:28 |  56.8 |
#+end:

#+begin: clocktable :maxlevel 3 :scope subtree :tags t :indent nil :emphasize nil :scope file :narrow 75 :formula %
#+TBLNAME: sprint_summary
#+CAPTION: Clock summary at [2025-11-13 Thu 12:34]
|          | <75>                                                   |         |       |       |       |
| Tags     | Headline                                               | Time    |       |       |     % |
|----------+--------------------------------------------------------+---------+-------+-------+-------|
...
|          | Stories                                                | 59:59   |       |       | 100.0 |
|          | Active                                                 |         | 59:59 |       | 100.0 |
| agile    | Sprint and product backlog refinement                  |         |       |  2:49 |   4.7 |
| code     | Clean up client parser                                 |         |       |  0:10 |   0.3 |
| code     | Add connect command line argument                      |         |       |  1:19 |   2.2 |
| infra    | Install Windows package on Windows machine             |         |       |  2:09 |   3.6 |
| code     | Ignore warnings on windows and osx                     |         |       |  0:33 |   0.9 |
| code     | Ensure applications work under OSX using github images |         |       |  0:14 |   0.4 |
| infra    | Create a splash screen and gray background             |         |       |  2:26 |   4.1 |
| code     | Use fluent icons                                       |         |       |  0:37 |   1.0 |
| code     | Add export functionality for currencies                |         |       |  1:30 |   2.5 |
| code     | Add currency editing support                           |         |       |  2:45 |   4.6 |
| code     | Add about to menu                                      |         |       |  1:02 |   1.7 |
| code     | Create a history dialog for currencies                 |         |       |  1:27 |   2.4 |
| code     | Allow MDI windows outside main window                  |         |       |  1:35 |   2.6 |
| code     | Add edit menu and export menu                          |         |       |  0:34 |   0.9 |
| code     | Implement adding new currencies                        |         |       |  3:17 |   5.5 |
| code     | Clean up product website                               |         |       |  4:42 |   7.8 |
| code     | Create a skill for plant uml documentation             |         |       |  2:48 |   4.7 |
| infra    | Add CMake targets for site and skills                  |         |       |  0:17 |   0.5 |
| infra    | Generalise the skill setup for ORE Studio              |         |       |  3:45 |   6.3 |
| infra    | Restructure components to follow the dogen approach    |         |       |  2:54 |   4.8 |
| infra    | Generate PlantUML diagrams for all components          |         |       |  1:05 |   1.8 |
| code     | Fix the valgrind leaks reported on sqlgen              |         |       |  3:00 |   5.0 |
| code     | Make UI/UX look more professional                      |         |       | 11:07 |  18.5 |
| code     | Current issues with package install in debian          |         |       |  0:40 |   1.1 |
| code     | Resolve crash on shutdown problem                      |         |       |  0:50 |   1.4 |
| analysis | Weaving skills and documentation together              |         |       |  0:46 |   1.3 |
| code     | Review all code created so far with an LLM             |         |       |  5:38 |   9.4 |
#+end:
