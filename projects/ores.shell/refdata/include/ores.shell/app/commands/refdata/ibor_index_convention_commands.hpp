 ...
 */
#ifndef ORES_SHELL_APP_COMMANDS_IBOR_INDEX_CONVENTION_COMMANDS_HPP
#define ORES_SHELL_APP_COMMANDS_IBOR_INDEX_CONVENTION_COMMANDS_HPP
...
/**
 * @brief Every verb IBOR index conventions answer, as one command each.
 *
 ...
 */
class ibor_index_convention_commands {
private:
    inline static std::string_view logger_name =
        "ores.shell.app.commands.refdata.ibor_index_convention_commands";
...
public:
    /**
     * @brief Register the IBOR index conventions submenu.
     */
