...
#+type: archetype
#+output: projects/ores.qt/{qt_component}/include/ores.qt/{EntityPascal}Controller.hpp
#+facet: ores.cpp.qt
#+level: cross
...
- =66E078FB-D6A6-4DF6-814B-65995D948090= — in =signals:=, after the
  ...
  matching seam in [[id:B903843F-9A8D-4B47-BB80-16F701525E3F][ores.cpp.qt.mdi_window_impl]]), or a signal relayed
  from the detail dialog (see =DF72DFCF-FD65-4FE5-98BA-CB8168CE0FDF=
  in [[id:4E39C3B2-05E2-48B7-84D4-D97304CA25D7][ores.cpp.qt.controller_impl]] and the paired dialog-side seam in
  [[id:0264FF98-86B8-4C43-AFE5-DF93567C63D2][ores.cpp.qt.detail_dialog_header]]).
