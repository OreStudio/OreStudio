...
struct contact_type final {
    ...
    /**
     * @brief Unique contact type code.
     *
    ...
    /**
     * @brief Human-readable name for the contact type.
     */
    std::string name;

    /**
     * @brief Detailed description of the contact type.
     */
...
/**
 * @brief Dispatch-key identifier for contact_type, e.g. for the
 * generic history-diff request and action registries. Single source
 * of truth: every call site spells entity_type_of(value) regardless
 * of which entity it holds.
 */
[[nodiscard]] constexpr std::string_view entity_type_of(const contact_type&) {
    return "ores.refdata.contact_type";
}
