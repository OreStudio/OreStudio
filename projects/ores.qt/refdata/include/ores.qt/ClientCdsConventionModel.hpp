...
private:
    inline static std::string_view logger_name = "ores.qt.client_cds_convention_model";
...
public:
    ...
    explicit ClientCdsConventionModel(ClientManager* clientManager, QObject* parent = nullptr);
