...
** What a curve is, and how one is built
...
** What it is made of, and what fills the gaps
...
** Why there is more than one curve
...
[[id:576D0E28-E783-44D4-9C0F-C7ADD307539E][Volatility]] surfaces are a separate cluster with their own structure
note, even though both are term structures built from quoted pillars. The
