...
#+TBLNAME: summary
#+CAPTION: Clock summary at [2024-07-07 Sun 01:16]
| <75>                                              |         |       |      |       |
| Headline                                          | Time    |       |      |     % |
|---------------------------------------------------+---------+-------+------+-------|
| *Total time*                                      | *44:19* |       |      | 100.0 |
|---------------------------------------------------+---------+-------+------+-------|
| Stories                                           | 44:19   |       |      | 100.0 |
| Active                                            |         | 44:19 |      | 100.0 |
| Sprint and product backlog refinement             |         |       | 1:18 |   2.9 |
| Create a basic git hub repository                 |         |       | 0:35 |   1.3 |
| Setup a discord channel for the project           |         |       | 0:14 |   0.5 |
| Setup vcpkg and cmake                             |         |       | 1:21 |   3.0 |
| Setup github actions                              |         |       | 1:21 |   3.0 |
| Create and upload a package                       |         |       | 3:28 |   7.8 |
| Create a basic project structure                  |         |       | 2:10 |   4.9 |
| Add a Qt hello world                              |         |       | 3:08 |   7.1 |
| Add a splash screen to applciation                |         |       | 0:41 |   1.5 |
| Add basic site                                    |         |       | 0:34 |   1.3 |
| Add modeling infrastructure                       |         |       | 1:30 |   3.4 |
| Fix code syntax highlighting in site              |         |       | 0:10 |   0.4 |
| Merge index with readme                           |         |       | 0:42 |   1.6 |
| Add project objective to readme                   |         |       | 2:24 |   5.4 |
| Add basic logging support                         |         |       | 1:14 |   2.8 |
| Add nightly support with memcheck                 |         |       | 3:21 |   7.6 |
| Clean up toolchains and presets                   |         |       | 1:53 |   4.2 |
| Generate Doxygen documentation and add it to site |         |       | 0:51 |   1.9 |
| Copy domain notes on core concepts                |         |       | 4:41 |  10.6 |
| Valgrind fails to run unit tests                  |         |       | 1:12 |   2.7 |
| Initial sanity test generated packages            |         |       | 0:25 |   0.9 |
| Add command line options support                  |         |       | 5:45 |  13.0 |
| Clang tests show up twice in nightlies            |         |       | 0:04 |   0.2 |
| Add XML parsing support for currency              |         |       | 3:18 |   7.4 |
| Create a containing structure for data            |         |       | 0:28 |   1.1 |
| Add basic widgets to display currencies           |         |       | 0:26 |   1.0 |
