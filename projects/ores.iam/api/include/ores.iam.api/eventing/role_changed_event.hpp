 ...
 */
#ifndef ORES_IAM_API_EVENTING_ROLE_CHANGED_EVENT_HPP
#define ORES_IAM_API_EVENTING_ROLE_CHANGED_EVENT_HPP
 ...
 *
 * Published when any role entity is created, updated, or
...
struct role_changed_event final {
    ...
    /**
     * @brief Changed role UUIDs (as strings).
     */
