...
register_counterparty_identifier_event_mapping(ev::service::postgres_event_source& event_source,
    ...
    return event_bus.subscribe<refdata::eventing::counterparty_identifier_changed_event>(
        [&nats](const refdata::eventing::counterparty_identifier_changed_event& e) {
            ev::service::publish_entity_event(
                nats,
                std::string(ev::domain::event_traits<
                            refdata::eventing::counterparty_identifier_changed_event>::name),
