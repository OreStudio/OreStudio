...
For background on entity metatypes and the physical-space graph, see
...
country  (domain_entity, refdata)
  ...
  ⚠️   projects/ores.web/packages/wire-protocol/src/generated/refdata/protocol/country_protocol.ts  ←  ts_protocol.ts.mustache
...
To restrict to a single facet:

#+begin_src sh
./compass.sh codegen entity show country --address ores.sql.schema
#+end_src
