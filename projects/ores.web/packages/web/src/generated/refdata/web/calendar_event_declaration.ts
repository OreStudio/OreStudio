 ...
 */
/**
 * Where the calendar_event screens live and what they can do.
 *
 ...
 */
import { calendarEventMeta } from '../ui/calendar_event_ui.js';
import type { EntityDescriptor } from '../../../entity/descriptor.js';

export const calendarEventDescriptor: EntityDescriptor = {
    component: 'refdata',
    entity: 'calendar_event',
    meta: calendarEventMeta,
    routeSegment: 'calendar-event',
    apiBase: '/api/calendar_events',
    keyFields: [
        'id',
    ],
    capabilities: {
