 ...
 *
 */
create or replace function ores_dq_catalogs_notify_fn()
returns trigger as $$
declare
...
begin
    ...
    perform pg_notify('ores_dq_catalogs', notification_payload::text);

    return null;
end;
$$ language plpgsql;

create or replace trigger ores_dq_catalogs_notify_trg
after insert or update or delete on ores_dq_catalogs_tbl
for each row execute function ores_dq_catalogs_notify_fn();
