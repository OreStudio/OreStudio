 ...
 */
#ifndef ORES_REFDATA_CORE_REPOSITORY_TENOR_RESOLUTION_ALGORITHM_REPOSITORY_HPP
#define ORES_REFDATA_CORE_REPOSITORY_TENOR_RESOLUTION_ALGORITHM_REPOSITORY_HPP
...
/**
 * @brief Reads and writes tenor resolution algorithms to data storage.
 */
class ORES_REFDATA_CORE_EXPORT tenor_resolution_algorithm_repository {
private:
    inline static std::string_view logger_name =
        "ores.refdata.repository.tenor_resolution_algorithm_repository";
...
public:
    ...
    /**
     * @brief Writes tenor resolution algorithms to database.
     *
     ...
     */
    /**@{*/
    void write(context ctx, const domain::tenor_resolution_algorithm& v);
    void write(context ctx, const std::vector<domain::tenor_resolution_algorithm>& v);
    /**@}*/

    /**
     * @brief Writes a tenor resolution algorithm, honouring the claim it states.
     *
    ...
    /**
     * @brief Writes a set of tenor resolution algorithms, each honouring its own
    ...
    /**
     * @brief Reads a single tenor resolution algorithm as it stood at a specific
     ...
     */
    std::uint32_t get_total_algorithm_count(context ctx);

    /**
     * @brief Deletes a tenor resolution algorithm by closing its temporal validity.
     */
    ...
    /**
     * @brief Removes a tenor resolution algorithm, refusing a row that moved on.
     *
    ...
    /**
     * @brief Deletes tenor resolution algorithms by closing their temporal validity.
     */
