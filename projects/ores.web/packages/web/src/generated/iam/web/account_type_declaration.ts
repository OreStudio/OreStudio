 ...
 */
/**
 * Where the account_type screens live and what they can do.
 *
 ...
 */
import { accountTypeMeta } from '../ui/account_type_ui.js';
import type { EntityDescriptor } from '../../../entity/descriptor.js';

export const accountTypeDescriptor: EntityDescriptor = {
    component: 'iam',
    entity: 'account_type',
