 ...
 *
 */
#ifndef ORES_TRADING_CORE_REPOSITORY_FX_ASIAN_FORWARD_INSTRUMENT_MAPPER_HPP
#define ORES_TRADING_CORE_REPOSITORY_FX_ASIAN_FORWARD_INSTRUMENT_MAPPER_HPP
 ...
 */
class ORES_TRADING_CORE_EXPORT fx_asian_forward_instrument_mapper {
private:
