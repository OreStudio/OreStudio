 ...
 *
 */
#ifndef ORES_SYNTHETIC_CORE_PRESENTATION_FOLDER_HISTORY_FIELD_MAPPER_HPP
#define ORES_SYNTHETIC_CORE_PRESENTATION_FOLDER_HISTORY_FIELD_MAPPER_HPP
...
/**
 * @brief Renders a folder to an ordered field list for
...
render_folder_fields(const domain::folder& v);
