 ...
 *
 */
#ifndef ORES_RISK_EVENTING_COUNTRY_CHANGED_EVENT_HPP
#define ORES_RISK_EVENTING_COUNTRY_CHANGED_EVENT_HPP
 ...
 */
template<>
struct event_traits<ores::risk::eventing::country_changed_event> {
