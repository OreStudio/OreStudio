...
--
UPDATE refdata_currencies_tbl c
...
JOIN assets_images_tbl i ON i.key = v.flag_key AND i.valid_to = ores.utility_infinity_timestamp_fn()
WHERE c.iso_code = v.currency_code AND c.valid_to = ores.utility_infinity_timestamp_fn();
