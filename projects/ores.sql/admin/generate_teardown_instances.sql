 ...
 *
 * OUTPUT:
 *   Creates/overwrites teardown_instances.sql with explicit DROP statements.
 *
 * WORKFLOW:
...
\qecho  *
\qecho  * This file was generated by admin/generate_teardown_instances.sql
\qecho  * Review carefully before running teardown_all.sql
\qecho  *
\qecho  * To regenerate:
\qecho  *   psql -U postgres -f admin/generate_teardown_instances.sql
\qecho  */
\qecho
