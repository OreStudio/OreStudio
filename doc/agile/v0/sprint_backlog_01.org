...
#+CAPTION: Clock summary at [2024-06-23 Sun 22:34]
| <75>                                    |         |       |      |       |
| Headline                                | Time    |       |      |     % |
|-----------------------------------------+---------+-------+------+-------|
...
| Stories                                 | 14:52   |       |      | 100.0 |
| Active                                  |         | 14:52 |      | 100.0 |
| Sprint and product backlog refinement   |         |       | 0:26 |   2.9 |
| Create a basic git hub repository       |         |       | 0:35 |   3.9 |
| Setup a discord channel for the project |         |       | 0:14 |   1.6 |
| Setup vcpkg and cmake                   |         |       | 1:21 |   9.1 |
| Setup github actions                    |         |       | 1:21 |   9.1 |
| Create and upload a package             |         |       | 3:28 |  23.3 |
| Create a basic project structure        |         |       | 2:10 |  14.6 |
| Add a Qt hello world                    |         |       | 3:08 |  21.1 |
| Add a splash screen to applciation      |         |       | 0:41 |   4.6 |
| Add nightly support with memcheck       |         |       | 0:04 |   0.4 |
| Add XML parsing support for currency    |         |       | 1:24 |   9.4 |
#+end:
