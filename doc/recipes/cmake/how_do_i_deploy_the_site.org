...
A full build on a tree with three changed pages publishes three pages
and re-stats five thousand files to do it. That takes upward of ten
minutes against about five seconds, so reach for it because you want
the graph or the sweep, not as a precaution before committing.
