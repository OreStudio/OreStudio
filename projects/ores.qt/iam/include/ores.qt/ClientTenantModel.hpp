 ...
 *
 * This model extends AbstractClientModel and fetches tenant
...
public:
    ...
    explicit ClientTenantModel(ClientManager* clientManager, QObject* parent = nullptr);
...
private:
    ...
    void fetch_tenants(std::uint32_t offset, std::uint32_t limit);
