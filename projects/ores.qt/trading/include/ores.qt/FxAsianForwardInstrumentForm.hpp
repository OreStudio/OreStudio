 ...
 *
 */
#ifndef ORES_QT_FX_ASIAN_FORWARD_INSTRUMENT_FORM_HPP
#define ORES_QT_FX_ASIAN_FORWARD_INSTRUMENT_FORM_HPP
...
/**
 * @brief IInstrumentForm for FX Asian Forward trades.
 *
 * Handles: FxAverageForward, FxTaRF.
 */
class FxAsianForwardInstrumentForm final : public IInstrumentForm {
    Q_OBJECT

private:
    inline static std::string_view logger_name = "ores.qt.fx_asian_forward_instrument_form";
...
public:
    explicit FxAsianForwardInstrumentForm(QWidget* parent = nullptr);
    ~FxAsianForwardInstrumentForm() override;
...
private:
    ...
    Ui::FxAsianForwardInstrumentForm* ui_;
    ClientManager* clientManager_ = nullptr;
    ImageCache* imageCache_ = nullptr;
    std::string username_;
    trading::domain::fx_asian_forward_instrument instrument_;
    bool dirty_ = false;
    bool loaded_ = false;
};
