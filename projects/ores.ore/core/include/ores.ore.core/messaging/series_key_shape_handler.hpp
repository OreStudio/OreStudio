 ...
 */
#ifndef ORES_ORE_CORE_MESSAGING_SERIES_KEY_SHAPE_HANDLER_HPP
#define ORES_ORE_CORE_MESSAGING_SERIES_KEY_SHAPE_HANDLER_HPP
...
namespace {
inline auto& series_key_shape_handler_lg() {
    static auto instance =
        ores::logging::make_logger("ores.ore.messaging.series_key_shape_handler");
    return instance;
}
} // namespace
...
/**
 * @brief NATS message handler for series key shape operations.
 */
class series_key_shape_handler {
public:
    series_key_shape_handler(ores::nats::service::client& nats,
