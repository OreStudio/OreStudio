 ...
 */
#ifndef ORES_SHELL_APP_COMMANDS_CONTACT_TYPE_COMMANDS_HPP
#define ORES_SHELL_APP_COMMANDS_CONTACT_TYPE_COMMANDS_HPP
...
/**
 * @brief Every verb contact types answer, as one command each.
 *
 ...
 */
class contact_type_commands {
private:
    inline static std::string_view logger_name =
        "ores.shell.app.commands.refdata.contact_type_commands";
...
public:
    /**
     * @brief Register the contact types submenu.
     */
