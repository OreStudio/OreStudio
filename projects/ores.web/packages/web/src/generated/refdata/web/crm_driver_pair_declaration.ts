 ...
 */
/**
 * Where the crm_driver_pair screens live and what they can do.
 *
 ...
 */
import { crmDriverPairMeta } from '../ui/crm_driver_pair_ui.js';
import type { EntityDescriptor } from '../../../entity/descriptor.js';

export const crmDriverPairDescriptor: EntityDescriptor = {
    component: 'refdata',
    entity: 'crm_driver_pair',
    meta: crmDriverPairMeta,
    routeSegment: 'crm-driver-pair',
    apiBase: '/api/crm_driver_pairs',
    keyFields: [
        'id',
    ],
    capabilities: {
