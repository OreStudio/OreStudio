...
#+CAPTION: Clock summary at [2026-02-15 Sun 00:33], for Sunday, February 15, 2026.
|      | <75>                                |        |      |      |       |
| Tags | Headline                            | Time   |      |      |     % |
|------+-------------------------------------+--------+------+------+-------|
...
|      | Stories                             | 0:33   |      |      | 100.0 |
|      | Active                              |        | 0:33 |      | 100.0 |
| code | Implement party-level RLS isolation |        |      | 0:33 | 100.0 |
#+end:

#+begin: clocktable :maxlevel 3 :scope subtree :tags t :indent nil :emphasize nil :scope file :narrow 75 :formula %
#+TBLNAME: sprint_summary
#+CAPTION: Clock summary at [2026-02-15 Sun 00:33]
|       | <75>                                               |         |       |      |       |
| Tags  | Headline                                           | Time    |       |      |     % |
|-------+----------------------------------------------------+---------+-------+------+-------|
|       | *Total time*                                       | *49:52* |       |      | 100.0 |
|-------+----------------------------------------------------+---------+-------+------+-------|
|       | Stories                                            | 49:52   |       |      | 100.0 |
|       | Active                                             |         | 49:52 |      | 100.0 |
| agile | Sprint and product backlog refinement              |         |       | 2:30 |   5.0 |
...
| code  | Add party related support to Qt                    |         |       | 6:41 |  13.4 |
| code  | Add GLEIF data to datasets                         |         |       | 6:41 |  13.4 |
...
| code  | Add system party support                           |         |       | 3:58 |   8.0 |
