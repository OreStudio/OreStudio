...
Whether cash in this currency can be delivered offshore. false for
currencies subject to capital controls (e.g. CNY, INR, KRW), which
forces any pair involving them to be non-deliverable (NDF).
...
Named holiday calendar identifier (e.g. "TARGET", "US", "UK"). Free-text
pending [[id:E1196536-38E8-4365-B0E6-A269F7CA3923][Model calendars as proper ORE Studio reference data]].
...
:history_protocol_include:    ores.refdata.api/messaging/currency_history_protocol.hpp
...
All 11 fields currently exposed in =CurrencyDetailDialog.ui= (5 new
domain columns — =spot_days=, =deliverable=, =day_basis=,
=base_precedence=, =holiday_calendar= — aren't in the UI yet; out of
scope for this sync, tracked separately). =image_id= isn't a detail
field either (handled generically via =has_flag_icon=, matching
every other flag entity).

| field              | label               | widget                   | type          | is_key | is_required | placeholder                    | spin_min | spin_max | combo_domain_type                     | combo_fetch_include        | combo_fetch_fn              | combo_watcher_name    | combo_code_field | combo_tooltip_field | combo_sort_field | combo_label            | combo_setter_pascal |
|--------------------+----------------------+---------------------------+---------------+--------+-------------+---------------------------------+----------+----------+----------------------------------------+-----------------------------+------------------------------+-----------------------+------------------+----------------------+------------------+------------------------+----------------------|
| iso_code           | ISO Code            | isoCodeEdit               | line_edit     | true   | true        | Enter ISO 4217 code             |          |          |                                        |                             |                              |                        |                  |                      |                  |                        |                      |
| name               | Name                | nameEdit                  | line_edit     |        | true        | Enter currency name             |          |          |                                        |                             |                              |                        |                  |                      |                  |                        |                      |
| numeric_code       | Numeric Code        | numericCodeEdit           | line_edit     |        | true        | Enter numeric code              |          |          |                                        |                             |                              |                        |                  |                      |                  |                        |                      |
| monetary_nature    | Asset Class         | monetaryNatureCombo       | dynamic_combo |        |             |                                  |          |          | refdata::domain::monetary_nature       | ores.qt/LookupFetcher.hpp   | fetch_monetary_natures       | monetaryNatureWatcher | code             | description          | display_order    | monetary natures       | MonetaryNatureCombo  |
| market_tier        | Market Tier         | marketTierCombo           | dynamic_combo |        |             |                                  |          |          | refdata::domain::currency_market_tier  | ores.qt/LookupFetcher.hpp   | fetch_currency_market_tiers  | marketTierWatcher     | code             | description          | display_order    | currency market tiers  | MarketTierCombo      |
| symbol             | Symbol              | symbolEdit                | line_edit     |        | true        | Enter currency symbol           |          |          |                                        |                             |                              |                        |                  |                      |                  |                        |                      |
| fraction_symbol    | Fraction Symbol     | fractionSymbolEdit        | line_edit     |        | true        | Enter fraction symbol           |          |          |                                        |                             |                              |                        |                  |                      |                  |                        |                      |
| fractions_per_unit | Fractions Per Unit  | fractionsPerUnitSpinBox   | spin_box      |        |             |                                  | 0        | 10000    |                                        |                             |                              |                        |                  |                      |                  |                        |                      |
| format             | Format              | formatEdit                | line_edit     |        | true        | Enter display format            |          |          |                                        |                             |                              |                        |                  |                      |                  |                        |                      |
| rounding_type      | Rounding Type       | roundingTypeCombo         | dynamic_combo |        |             |                                  |          |          | refdata::domain::rounding_type         | ores.qt/LookupFetcher.hpp   | fetch_rounding_types         | roundingTypeWatcher   | code             | description          | display_order    | rounding types         | RoundingTypeCombo    |
| rounding_precision | Rounding Precision  | roundingPrecisionSpinBox  | spin_box      |        |             |                                  | 0        | 10       |                                        |                             |                              |                        |                  |                      |                  |                        |                      |
...
| FractionSymbol     | fraction_symbol    | Fraction        | string    | 60    | true           |
| FractionsPerUnit   | fractions_per_unit | Per Unit        | int       | 70    | true           |
...
| SpotDays           | spot_days          | Spot Days       | int       | 70    |                |
| Deliverable        | deliverable        | Deliverable     | bool      | 80    |                |
| DayBasis           | day_basis          | Day Basis       | string    | 80    |                |
| BasePrecedence     | base_precedence    | Base Precedence | int       | 100   |                |
| HolidayCalendar    | holiday_calendar   | Holiday Calendar| string    | auto  |                |
