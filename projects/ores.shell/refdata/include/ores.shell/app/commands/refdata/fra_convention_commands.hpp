 ...
 */
#ifndef ORES_SHELL_APP_COMMANDS_FRA_CONVENTION_COMMANDS_HPP
#define ORES_SHELL_APP_COMMANDS_FRA_CONVENTION_COMMANDS_HPP
...
/**
 * @brief Every verb FRA conventions answer, as one command each.
 *
 ...
 */
class fra_convention_commands {
private:
    inline static std::string_view logger_name =
        "ores.shell.app.commands.refdata.fra_convention_commands";
...
public:
    /**
     * @brief Register the FRA conventions submenu.
     */
    ...
    /**
     * @brief add <id> <index> <reason> <commentary>
     */
    ...
    /**
     * @brief set <id> <index> <reason> <commentary> [--version <n>]
     */
    ...
    /**
     * @brief put-many --count <n> <id> <index> <reason> <commentary>
     */
