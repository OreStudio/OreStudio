...
=currency_history_protocol.hpp=:

| Subject | Request type | Request fields | Response type | Response fields |
|---------+--------------+----------------+---------------+-----------------|
| =...currencies.list= | =get_currencies_request= | =offset= (int, 0), =limit= (int, 100) | =get_currencies_response= | =currencies= ([[id:A165DCB3-690D-4F19-A2A3-EC63D5148F1F][currency]][]), =total_available_count= (int) |
