...
/**
 * @brief Detail dialog for viewing and editing tenant records.
 *
 * This dialog allows viewing, creating, and editing tenants.
...
private:
    inline static std::string_view logger_name = "ores.qt.tenant_detail_dialog";
