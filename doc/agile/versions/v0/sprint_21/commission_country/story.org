...
| [[id:9B0CA32A-B48D-4F02-938B-D49A6380E3BE][Verify country Qt UI end-to-end post-NATS]] | STARTED | 2026-06-27 | | List window, detail dialog, history dialog (HistoryDialogBase), delete, and eventing against live services. History likely shares the epoch-timestamp blocker (story 71116F94) — confirm and mark BLOCKED if so. |
