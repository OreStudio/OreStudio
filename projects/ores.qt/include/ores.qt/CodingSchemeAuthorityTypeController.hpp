...
class CodingSchemeAuthorityTypeMdiWindow;
class DetachableMdiSubWindow;

class CodingSchemeAuthorityTypeController final : public EntityController {
    Q_OBJECT
...
private slots:
    void onShowDetails(const dq::domain::coding_scheme_authority_type& authorityType);
    void onAddNewRequested();
    void onShowHistory(const QString& code);
    void onRevertVersion(const dq::domain::coding_scheme_authority_type& authorityType);
