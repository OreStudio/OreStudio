...
namespace {
inline auto& bond_future_delivery_basket_handler_lg() {
    static auto instance =
        ores::logging::make_logger("ores.trading.messaging.bond_future_delivery_basket_handler");
    return instance;
}
} // namespace
...
/**
 * @brief NATS message handler for bond future delivery basket identifier operations.
 */
class bond_future_delivery_basket_handler {
public:
    bond_future_delivery_basket_handler(
