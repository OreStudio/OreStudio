 ...
 *
 */
#ifndef ORES_TRADING_CORE_REPOSITORY_BALANCE_GUARANTEED_SWAP_INSTRUMENT_MAPPER_HPP
#define ORES_TRADING_CORE_REPOSITORY_BALANCE_GUARANTEED_SWAP_INSTRUMENT_MAPPER_HPP
...
public:
    ...
    static std::vector<balance_guaranteed_swap_instrument_entity>
    map(const std::vector<domain::balance_guaranteed_swap_instrument>& v);
};
