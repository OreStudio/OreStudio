...
The screen's declaration. A role is addressed by its =name=, the natural key,
which is what the route's path segment carries and what the BFF asks the entity
by; the surrogate =id= is generated and the form does not offer it.
