 ...
 */
/**
 * Where the ledger_feed_type screens live and what they can do.
 *
 ...
 */
import { ledgerFeedTypeMeta } from '../ui/ledger_feed_type_ui.js';
import type { EntityDescriptor } from '../../../entity/descriptor.js';

export const ledgerFeedTypeDescriptor: EntityDescriptor = {
    component: 'refdata',
    entity: 'ledger_feed_type',
    meta: ledgerFeedTypeMeta,
    routeSegment: 'ledger-feed-type',
    apiBase: '/api/types',
    keyFields: [
        'code',
    ],
