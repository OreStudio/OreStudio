 ...
 *
 */
#include "ores.marketdata.core/repository/tenor_anchor_repository.hpp"
#include "ores.database/repository/bitemporal_operations.hpp"
#include "ores.database/repository/helpers.hpp"
#include "ores.marketdata.api/domain/tenor_anchor_json_io.hpp" // IWYU pragma: keep.
#include "ores.marketdata.core/repository/tenor_anchor_entity.hpp"
#include "ores.marketdata.core/repository/tenor_anchor_mapper.hpp"
...
void tenor_anchor_repository::write(context ctx, const std::vector<domain::tenor_anchor>& v) {
    ...
    execute_write_query(
        ctx, tenor_anchor_mapper::map(v), lg(), "Writing tenor anchors to database.");
}
