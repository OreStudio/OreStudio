 ...
 */
#ifndef ORES_SHELL_APP_COMMANDS_CALENDAR_RULE_COMMANDS_HPP
#define ORES_SHELL_APP_COMMANDS_CALENDAR_RULE_COMMANDS_HPP
...
/**
 * @brief Every verb calendar rules answer, as one command each.
 *
 ...
 */
class calendar_rule_commands {
private:
    inline static std::string_view logger_name =
        "ores.shell.app.commands.refdata.calendar_rule_commands";
...
public:
    /**
     * @brief Register the calendar rules submenu.
     */
    ...
    /**
     * @brief set <id> <calendar_code> <kind> <month> <day> <weekday> <occurrence> <day_offset>
     * <shift> <effective_from> <effective_to> <reason> <commentary> [--version <n>]
     */
    ...
    /**
     * @brief put-many --count <n> <id> <calendar_code> <kind> <month> <day> <weekday> <occurrence>
