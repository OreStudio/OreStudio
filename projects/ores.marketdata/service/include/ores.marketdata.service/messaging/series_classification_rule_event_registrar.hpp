 ...
 */
#ifndef ORES_MARKETDATA_SERVICE_MESSAGING_SERIES_CLASSIFICATION_RULE_EVENT_REGISTRAR_HPP
#define ORES_MARKETDATA_SERVICE_MESSAGING_SERIES_CLASSIFICATION_RULE_EVENT_REGISTRAR_HPP
...
register_series_classification_rule_event_mapping(
