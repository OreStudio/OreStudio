 ...
 *
 */
#ifndef ORES_TRADING_CORE_PRESENTATION_BOND_FORWARD_HISTORY_FIELD_MAPPER_HPP
#define ORES_TRADING_CORE_PRESENTATION_BOND_FORWARD_HISTORY_FIELD_MAPPER_HPP
...
/**
 * @brief Renders a bond_forward to an ordered field list for
