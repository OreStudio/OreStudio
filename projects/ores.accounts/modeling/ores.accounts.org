...
:END:
#+title: ORE Studio Accounts Component
#+author: Marco Craveiro
#+options: <:nil c:nil todo:nil ^:nil d:nil date:nil author:nil toc:nil html-postamble:nil
#+startup: inlineimages

Account management component for [[id:D04D3476-D7C5-3954-A33B-C641EBCB43F6][ORE Studio]].
...
[[file:ores.accounts.png][file:ores.accounts.png]]
...
The module is organized into namespaces: domain (core entities), repository ([[https://en.wikipedia.org/wiki/Object%E2%80%93relational_mapping][ORM]]
