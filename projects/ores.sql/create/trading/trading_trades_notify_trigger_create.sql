...
create or replace trigger ores_trading_trades_notify_trg
after insert or update or delete on ores_trading_trades_tbl
for each row execute function ores_trading_trades_notify_fn();
