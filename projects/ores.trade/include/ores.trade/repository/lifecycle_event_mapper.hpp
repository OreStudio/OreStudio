 ...
 *
 */
#ifndef ORES_TRADE_REPOSITORY_LIFECYCLE_EVENT_MAPPER_HPP
#define ORES_TRADE_REPOSITORY_LIFECYCLE_EVENT_MAPPER_HPP
...
/**
 * @brief Maps lifecycle_event domain entities to data storage layer and vice-versa.
 */
class lifecycle_event_mapper {
private:
    inline static std::string_view logger_name =
        "ores.trade.repository.lifecycle_event_mapper";
