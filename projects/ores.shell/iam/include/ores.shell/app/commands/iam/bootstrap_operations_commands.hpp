 ...
 */
#ifndef ORES_SHELL_APP_COMMANDS_BOOTSTRAP_OPERATIONS_COMMANDS_HPP
#define ORES_SHELL_APP_COMMANDS_BOOTSTRAP_OPERATIONS_COMMANDS_HPP
...
/**
 * @brief The operations bootstrap declares that no entity's CRUD verbs state.
 *
 ...
 */
class bootstrap_operations_commands {
private:
    inline static std::string_view logger_name =
        "ores.shell.app.commands.iam.bootstrap_operations_commands";
...
public:
    /**
     * @brief Register the bootstrap operations on the root menu.
     */
