 ...
 */
/**
 * Where the monetary_nature screens live and what they can do.
 *
 ...
 */
import { monetaryNatureMeta } from '../ui/monetary_nature_ui.js';
import type { EntityDescriptor } from '../../../entity/descriptor.js';

export const monetaryNatureDescriptor: EntityDescriptor = {
    component: 'refdata',
    entity: 'monetary_nature',
    meta: monetaryNatureMeta,
    routeSegment: 'monetary-nature',
    apiBase: '/api/types',
    keyParam: 'id',
    icon: 'classification',
    capabilities: {
