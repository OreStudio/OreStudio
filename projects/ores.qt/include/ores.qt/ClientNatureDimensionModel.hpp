...
class ClientNatureDimensionModel final : public QAbstractTableModel {
    Q_OBJECT

private:
    inline static std::string_view logger_name =
        "ores.qt.client_nature_dimension_model";
...
public:
    ...
    explicit ClientNatureDimensionModel(ClientManager* clientManager,
