...
void FloatingIndexTypeHistoryDialog::setupConnections() {
    connect(ui_->versionListWidget, &QTableWidget::itemSelectionChanged,
            this, &FloatingIndexTypeHistoryDialog::onVersionSelected);
    connect(openVersionAction_, &QAction::triggered,
            this, &FloatingIndexTypeHistoryDialog::onOpenVersionClicked);
    connect(revertAction_, &QAction::triggered,
            this, &FloatingIndexTypeHistoryDialog::onRevertClicked);
...
void FloatingIndexTypeHistoryDialog::loadHistory() {
    ...
    BOOST_LOG_SEV(lg(), debug) << "Loading history for floating index type: " << code_.toStdString();
