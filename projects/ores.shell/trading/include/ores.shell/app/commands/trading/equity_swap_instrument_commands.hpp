 ...
 *
 */
#ifndef ORES_SHELL_APP_COMMANDS_EQUITY_SWAP_INSTRUMENT_COMMANDS_HPP
#define ORES_SHELL_APP_COMMANDS_EQUITY_SWAP_INSTRUMENT_COMMANDS_HPP
...
public:
    ...
    /**
     * @brief Process the equity swap instrument history request.
     */
