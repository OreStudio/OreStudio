 ...
 *
 */
create or replace function metadata.dq_data_domains_notify_fn()
returns trigger as $$
declare
...
after insert or update or delete on metadata.dq_data_domains_tbl
for each row execute function metadata.dq_data_domains_notify_fn();
