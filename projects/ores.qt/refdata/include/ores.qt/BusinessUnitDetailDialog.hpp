 ...
 *
 * This dialog allows viewing, creating, and editing business units.
 * It supports both create mode (for new records) and edit mode (for
 * existing records).
 */
class BusinessUnitDetailDialog final : public DetailDialogBase {
    Q_OBJECT
...
public:
    explicit BusinessUnitDetailDialog(QWidget* parent = nullptr);
    ~BusinessUnitDetailDialog() override;

    void setClientManager(ClientManager* clientManager);
    void setUsername(const std::string& username);
    void setUnit(const refdata::domain::business_unit& business_unit);
...
signals:
    void business_unitSaved(const QString& code);
