...
create or replace function ores.variability_feature_flags_notify_fn()
returns trigger as $$
declare
...
after insert or update or delete on ores.variability_feature_flags_tbl
for each row execute function ores.variability_feature_flags_notify_fn();
