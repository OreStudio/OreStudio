 ...
 *
 */
#ifndef ORES_COMPUTE_REPOSITORY_WORKUNIT_REPOSITORY_HPP
#define ORES_COMPUTE_REPOSITORY_WORKUNIT_REPOSITORY_HPP
...
public:
    ...
    std::vector<domain::workunit> read_by_batch(context ctx, const std::string& batch_id);
