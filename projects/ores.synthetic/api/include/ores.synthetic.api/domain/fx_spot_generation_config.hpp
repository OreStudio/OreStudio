...
struct fx_spot_generation_config final {
    ...
    /**
     * @brief Price-process engine: "geometric" (multiplicative), "arithmetic" (additive), or
     * "ornstein_uhlenbeck" (Ornstein-Uhlenbeck, mean-reverting).
     */
     ...
     */
    friend bool operator==(const fx_spot_generation_config&,
                           const fx_spot_generation_config&) = default;
};
