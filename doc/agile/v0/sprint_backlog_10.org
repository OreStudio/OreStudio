...
#+CAPTION: Clock summary at [2026-01-24 Sat 03:11], for Saturday, January 24, 2026.
|      | <75>                                    |        |      |      |       |
| Tags | Headline                                | Time   |      |      |     % |
|------+-----------------------------------------+--------+------+------+-------|
|      | *Total time*                            | *2:43* |      |      | 100.0 |
|------+-----------------------------------------+--------+------+------+-------|
|      | Stories                                 | 2:43   |      |      | 100.0 |
|      | Active                                  |        | 2:43 |      | 100.0 |
| code | Tidy-up external data storage           |        |      | 1:04 |  39.3 |
| code | Coding schemes are in production tables |        |      | 1:39 |  60.7 |
#+end:

#+begin: clocktable :maxlevel 3 :scope subtree :tags t :indent nil :emphasize nil :scope file :narrow 75 :formula %
#+TBLNAME: sprint_summary
#+CAPTION: Clock summary at [2026-01-24 Sat 03:11]
|       | <75>                                                |         |       |      |       |
| Tags  | Headline                                            | Time    |       |      |     % |
|-------+-----------------------------------------------------+---------+-------+------+-------|
|       | *Total time*                                        | *32:20* |       |      | 100.0 |
|-------+-----------------------------------------------------+---------+-------+------+-------|
|       | Stories                                             | 32:20   |       |      | 100.0 |
|       | Active                                              |         | 32:20 |      | 100.0 |
| agile | Sprint and product backlog refinement               |         |       | 1:04 |   3.3 |
| infra | OCR scan notebooks for this sprint                  |         |       | 6:20 |  19.6 |
| code  | Create a simple code generator                      |         |       | 7:38 |  23.6 |
| code  | Party related schemes                               |         |       | 5:20 |  16.5 |
| code  | Image cache not reloading on new datasets           |         |       | 1:43 |   5.3 |
| code  | Create a script to download and split GLEIF data    |         |       | 0:25 |   1.3 |
| code  | Incremental image cache loading with modified_since |         |       | 0:31 |   1.6 |
| code  | Fix issues with misspell action                     |         |       | 2:47 |   8.6 |
| code  | Tidy-up external data storage                       |         |       | 3:33 |  11.0 |
| code  | Coding schemes are in production tables             |         |       | 1:39 |   5.1 |
| code  | Add code generation support for domain types SQL    |         |       | 1:20 |   4.1 |
#+end:
...
*** Refactor schema directories                                        :code:
