...
a restricted but better defined range of applications. MASD’s problem space is a
...
- The key attributes of the logical element we intend to model are kept within
  ...
  [[id:F663DF66-4F62-0884-DB23-BB2D6A42B644][skill]].
- However, because NLP is so flexible, we bundled together a number of facets
  within that skill:
