...
#+CAPTION: Clock summary at [2025-11-09 Sun 22:12], for Sunday, November 09, 2025.
|      | <75>                                          |        |      |      |       |
| Tags | Headline                                      | Time   |      |      |     % |
|------+-----------------------------------------------+--------+------+------+-------|
...
|      | Stories                                       | 8:30   |      |      | 100.0 |
|      | Active                                        |        | 8:30 |      | 100.0 |
| code | Add about to menu                             |        |      | 0:07 |   1.4 |
| code | Create a history dialog for currencies        |        |      | 1:27 |  17.1 |
| code | Allow MDI windows outside main window         |        |      | 1:35 |  18.6 |
| code | Add edit menu and export menu                 |        |      | 0:34 |   6.7 |
| code | Implement adding new currencies               |        |      | 3:17 |  38.6 |
| code | Current issues with package install in debian |        |      | 0:40 |   7.8 |
| code | Resolve crash on shutdown problem             |        |      | 0:50 |   9.8 |
#+end:

#+begin: clocktable :maxlevel 3 :scope subtree :tags t :indent nil :emphasize nil :scope file :narrow 75 :formula %
#+TBLNAME: sprint_summary
#+CAPTION: Clock summary at [2025-11-09 Sun 22:12]
|       | <75>                                                   |         |       |       |       |
| Tags  | Headline                                               | Time    |       |       |     % |
|-------+--------------------------------------------------------+---------+-------+-------+-------|
|       | *Total time*                                           | *32:58* |       |       | 100.0 |
|-------+--------------------------------------------------------+---------+-------+-------+-------|
|       | Stories                                                | 32:58   |       |       | 100.0 |
|       | Active                                                 |         | 32:58 |       | 100.0 |
| agile | Sprint and product backlog refinement                  |         |       |  0:43 |   2.2 |
| code  | Clean up client parser                                 |         |       |  0:10 |   0.5 |
| code  | Add connect command line argument                      |         |       |  1:19 |   4.0 |
| infra | Install Windows package on Windows machine             |         |       |  2:09 |   6.5 |
| code  | Ignore warnings on windows and osx                     |         |       |  0:33 |   1.7 |
| code  | Ensure applications work under OSX using github images |         |       |  0:14 |   0.7 |
| infra | Create a splash screen and gray background             |         |       |  2:26 |   7.4 |
| code  | Use fluent icons                                       |         |       |  0:37 |   1.9 |
| code  | Add export functionality for currencies                |         |       |  1:30 |   4.6 |
| code  | Add currency editing support                           |         |       |  2:45 |   8.3 |
| code  | Add about to menu                                      |         |       |  1:02 |   3.1 |
| code  | Create a history dialog for currencies                 |         |       |  1:27 |   4.4 |
| code  | Allow MDI windows outside main window                  |         |       |  1:35 |   4.8 |
| code  | Add edit menu and export menu                          |         |       |  0:34 |   1.7 |
| code  | Implement adding new currencies                        |         |       |  3:17 |  10.0 |
| code  | Make UI/UX look more professional                      |         |       | 11:07 |  33.7 |
| code  | Current issues with package install in debian          |         |       |  0:40 |   2.0 |
| code  | Resolve crash on shutdown problem                      |         |       |  0:50 |   2.5 |
#+end:
