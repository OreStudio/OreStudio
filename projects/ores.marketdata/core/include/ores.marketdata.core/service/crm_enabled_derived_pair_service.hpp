 ...
 *
 */
#ifndef ORES_MARKETDATA_CORE_SERVICE_CRM_ENABLED_DERIVED_PAIR_SERVICE_HPP
#define ORES_MARKETDATA_CORE_SERVICE_CRM_ENABLED_DERIVED_PAIR_SERVICE_HPP
 ...
 */
class ORES_MARKETDATA_CORE_EXPORT crm_enabled_derived_pair_service {
private:
    inline static std::string_view logger_name =
        "ores.marketdata.service.crm_enabled_derived_pair_service";
