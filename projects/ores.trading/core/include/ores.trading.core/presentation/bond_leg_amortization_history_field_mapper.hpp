 ...
 *
 */
#ifndef ORES_TRADING_CORE_PRESENTATION_BOND_LEG_AMORTIZATION_HISTORY_FIELD_MAPPER_HPP
#define ORES_TRADING_CORE_PRESENTATION_BOND_LEG_AMORTIZATION_HISTORY_FIELD_MAPPER_HPP
...
/**
 * @brief Renders a bond_leg_amortization to an ordered field list for
