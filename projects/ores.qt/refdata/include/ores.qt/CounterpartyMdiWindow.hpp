 ...
 */
#ifndef ORES_QT_COUNTERPARTY_MDI_WINDOW_HPP
#define ORES_QT_COUNTERPARTY_MDI_WINDOW_HPP
 ...
 *
 * Provides a table view of counterparties with toolbar actions
 * for reload, add, edit, delete, and viewing history.
 */
class CounterpartyMdiWindow final : public EntityListMdiWindow {
    Q_OBJECT

private:
    inline static std::string_view logger_name = "ores.qt.counterparty_mdi_window";
...
signals:
    ...
    void showCounterpartyDetails(const refdata::domain::counterparty& counterparty);
