...
#+CAPTION: Clock summary at [2025-08-07 Thu 20:32]
|       | <75>                                   |         |       |      |       |
| Tags  | Headline                               | Time    |       |      |     % |
|-------+----------------------------------------+---------+-------+------+-------|
...
|       | Stories                                | 17:20   |       |      | 100.0 |
|       | Active                                 |         | 17:20 |      | 100.0 |
| agile | Sprint and product backlog refinement  |         |       | 1:22 |   7.9 |
| infra | Fix broken builds                      |         |       | 0:36 |   3.5 |
| code  | Create a containing structure for data |         |       | 0:35 |   3.4 |
| code  | Add temporal support to currencies     |         |       | 2:59 |  17.2 |
| code  | Add command to dump currencies         |         |       | 4:18 |  24.8 |
| code  | Refactor code for currencies           |         |       | 3:52 |  22.3 |
| code  | Restore qt setup                       |         |       | 2:20 |  13.5 |
| code  | Add gemini action                      |         |       | 0:05 |   0.5 |
| code  | Add workspace as a container           |         |       | 1:13 |   7.0 |
#+end:
