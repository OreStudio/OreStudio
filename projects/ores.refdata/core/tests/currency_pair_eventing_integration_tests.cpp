...
#include "ores.refdata.api/eventing/currency_pair_event.hpp"
...
TEST_CASE("write_currency_pair_publishes_an_event", tags) {
    ...
    using event_type = ores::refdata::messaging::currency_pair_event;
    ...
    event_source.register_entity_event_mapping<event_type>("ores_refdata_currency_pairs");
