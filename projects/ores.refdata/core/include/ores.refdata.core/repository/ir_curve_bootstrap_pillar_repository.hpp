...
public:
    ...
    /**
     * @brief Writes a IR curve bootstrap pillar, honouring the claim it states.
     *
    ...
    /**
     * @brief Writes a set of IR curve bootstrap pillars, each honouring its own
    ...
    /**
     * @brief Removes a IR curve bootstrap pillar, refusing a row that moved on.
     *
...
private:
     ...
     */
    domain::ir_curve_bootstrap_pillar apply_claim(context ctx,
                                                  const domain::ir_curve_bootstrap_pillar& v,
                                                  const ores::utility::domain::precondition& claim);
};
