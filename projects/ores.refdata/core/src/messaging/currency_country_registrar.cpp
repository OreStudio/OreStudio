...
register_currency_country_handlers(ores::nats::service::client& nats,
    ...
    subs.push_back(nats.queue_subscribe(get_currency_countries_request::nats_subject,
                                        queue_group,
                                        [h](ores::nats::message msg) { h->list(std::move(msg)); }));
    subs.push_back(nats.queue_subscribe(
        get_currency_countries_by_currency_request::nats_subject,
        queue_group,
        [h](ores::nats::message msg) { h->list_by_currency(std::move(msg)); }));
    subs.push_back(nats.queue_subscribe(save_currency_country_request::nats_subject,
                                        queue_group,
    ...
    subs.push_back(nats.queue_subscribe(
        count_currency_countries_by_currency_request::nats_subject,
        queue_group,
        [h](ores::nats::message msg) { h->count_by_currency(std::move(msg)); }));
    subs.push_back(nats.queue_subscribe(
        count_currency_countries_by_country_request::nats_subject,
        queue_group,
