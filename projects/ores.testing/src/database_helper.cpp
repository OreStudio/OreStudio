...
void database_helper::seed_rbac() {
    ...
    const std::vector<std::string> statements = {
        ...
        WHERE NOT EXISTS (
            SELECT 1 FROM production.iam_permissions_tbl
        ...
        SELECT gen_random_uuid(), 1, 'Admin', 'Full administrative access', 'test',
               ...
               current_timestamp, '9999-12-31 23:59:59'::timestamptz
        WHERE NOT EXISTS (
            SELECT 1 FROM production.iam_roles_tbl
        ...
        FROM production.iam_roles_tbl r, production.iam_permissions_tbl p
        WHERE r.name = 'Admin' AND r.valid_to = '9999-12-31 23:59:59'::timestamptz
          ...
          AND NOT EXISTS (
              SELECT 1 FROM production.iam_role_permissions_tbl rp
