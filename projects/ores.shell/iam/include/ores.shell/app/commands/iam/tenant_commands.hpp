 ...
 */
#ifndef ORES_SHELL_APP_COMMANDS_TENANT_COMMANDS_HPP
#define ORES_SHELL_APP_COMMANDS_TENANT_COMMANDS_HPP
...
/**
 * @brief Every verb tenants answer, as one command each.
 *
 ...
 */
class tenant_commands {
private:
    inline static std::string_view logger_name = "ores.shell.app.commands.iam.tenant_commands";
...
public:
    /**
     * @brief Register the tenants submenu.
     */
    ...
    /**
     * @brief add <id> <code> <name> <type> <description> <hostname> <status> <reason> <commentary>
     */
    ...
    /**
     * @brief set <id> <code> <name> <type> <description> <hostname> <status> <reason> <commentary>
     * [--version <n>]
     */
    ...
    /**
     * @brief put-many --count <n> <id> <code> <name> <type> <description> <hostname> <status>
     * <reason> <commentary>
     */
