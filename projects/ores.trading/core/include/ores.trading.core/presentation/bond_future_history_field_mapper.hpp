 ...
 *
 */
#ifndef ORES_TRADING_CORE_PRESENTATION_BOND_FUTURE_HISTORY_FIELD_MAPPER_HPP
#define ORES_TRADING_CORE_PRESENTATION_BOND_FUTURE_HISTORY_FIELD_MAPPER_HPP
...
/**
 * @brief Renders a bond_future to an ordered field list for
