...
#include "ores.refdata/domain/monetary_nature_json_io.hpp" // IWYU pragma: keep.
#include "ores.refdata/repository/monetary_nature_entity.hpp"
#include "ores.refdata/repository/monetary_nature_mapper.hpp"
...
void monetary_nature_repository::write(context ctx, const domain::monetary_nature& v) {
    ...
    execute_write_query(ctx, monetary_nature_mapper::map(v),
