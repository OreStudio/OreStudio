 ...
 */
/**
 * Where the cds_convention screens live and what they can do.
 *
 ...
 */
import { cdsConventionMeta } from '../ui/cds_convention_ui.js';
import type { EntityDescriptor } from '../../../entity/descriptor.js';

export const cdsConventionDescriptor: EntityDescriptor = {
    component: 'refdata',
    entity: 'cds_convention',
    meta: cdsConventionMeta,
    routeSegment: 'cds-convention',
    apiBase: '/api/cds_conventions',
    keyParam: 'id',
    icon: 'chartMultiple',
    capabilities: {
        create: true,
