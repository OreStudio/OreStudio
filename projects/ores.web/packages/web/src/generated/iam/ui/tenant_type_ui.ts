 ...
 */
export const tenantTypeMessages = {
        tenant_type: {
            title: 'Tenant Types',
            singular: 'tenant type',
            newTitle: 'New tenant type',
            description: 'Reference data table defining valid tenant type classifications. Examples: \'organisation\', \'platform\', \'sandbox\'. Tenant types are managed by the system tenant and are used to categorise tenants for different purposes.',
            fldType: 'Type',
            typePh: 'Enter tenant type code',
            fldName: 'Name',
