...
#+CAPTION: Clock summary at [2025-11-02 Sun 22:45], for Sunday, November 02, 2025.
|      | <75>                                           |        |      |      |       |
| Tags | Headline                                       | Time   |      |      |     % |
|------+------------------------------------------------+--------+------+------+-------|
|      | *Total time*                                   | *6:21* |      |      | 100.0 |
|------+------------------------------------------------+--------+------+------+-------|
|      | Stories                                        | 6:21   |      |      | 100.0 |
|      | Active                                         |        | 6:21 |      | 100.0 |
| code | Improve code coverage                          |        |      | 4:15 |  66.9 |
| code | Patches for sqlgen are not applying on windows |        |      | 0:20 |   5.2 |
| code | Separate test database usage from application  |        |      | 1:46 |  27.8 |
#+end:

#+begin: clocktable :maxlevel 3 :scope subtree :tags t :indent nil :emphasize nil :scope file :narrow 75 :formula %
#+TBLNAME: sprint_summary
#+CAPTION: Clock summary at [2025-11-02 Sun 22:45]
|       | <75>                                                   |         |       |       |       |
| Tags  | Headline                                               | Time    |       |       |     % |
|-------+--------------------------------------------------------+---------+-------+-------+-------|
|       | *Total time*                                           | *58:48* |       |       | 100.0 |
|-------+--------------------------------------------------------+---------+-------+-------+-------|
|       | Stories                                                | 58:48   |       |       | 100.0 |
|       | Active                                                 |         | 58:48 |       | 100.0 |
| agile | Sprint and product backlog refinement                  |         |       |  1:24 |   2.4 |
| code  | Add locking up logic                                   |         |       |  1:28 |   2.5 |
| code  | Build using dynamic libraries                          |         |       |  7:24 |  12.6 |
| code  | Enable qt gui                                          |         |       |  4:13 |   7.2 |
| code  | Add locking up logic                                   |         |       |  1:28 |   2.5 |
| code  | Build using dynamic libraries                          |         |       |  7:24 |  12.6 |
| code  | Implement logging according to correct boost.log usage |         |       |  8:02 |  13.7 |
| code  | Fix broken Linux and OSX tests                         |         |       |  0:10 |   0.3 |
| code  | Fix broken windows builds                              |         |       |  2:35 |   4.4 |
| code  | Investigate leaks from valgrind                        |         |       |  0:51 |   1.4 |
| code  | Consider adding a postgres database to CI              |         |       | 14:13 |  24.2 |
| code  | Fix misspell that causes build to break                |         |       |  0:12 |   0.3 |
| code  | Improve code coverage                                  |         |       |  4:15 |   7.2 |
| code  | Add support for feature flags                          |         |       |  1:25 |   2.4 |
| code  | Implement authentication bootstrap workflow            |         |       |  0:25 |   0.7 |
| code  | Patches for sqlgen are not applying on windows         |         |       |  0:20 |   0.6 |
| code  | Separate test database usage from application          |         |       |  1:46 |   3.0 |
