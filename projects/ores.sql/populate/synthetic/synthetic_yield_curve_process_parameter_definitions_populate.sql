...
insert into ores_synthetic_yield_curve_process_parameter_definitions_tbl (
    tenant_id, version, process_type_code, parameter_name, description,
    data_type, default_value, min_value, max_value, display_order,
    modified_by, performed_by, change_reason_code, change_commentary
)
values
    -- Vasicek
    (ores_utility_system_tenant_id_fn(), 0, 'VASICEK', 'kappa',
    ...
    (ores_utility_system_tenant_id_fn(), 0, 'VASICEK', 'theta',
     ...
     'Initial population of yield curve process parameter definitions'),
    (ores_utility_system_tenant_id_fn(), 0, 'VASICEK', 'sigma',
     ...
     'Initial population of yield curve process parameter definitions'),
    (ores_utility_system_tenant_id_fn(), 0, 'VASICEK', 'initial_rate',
    ...
    -- Cox-Ingersoll-Ross
    (ores_utility_system_tenant_id_fn(), 0, 'COX_INGERSOLL_ROSS', 'kappa',
     'Mean reversion speed: how strongly the short rate is pulled back toward the long-term mean theta. Must be non-negative.',
     'double', 0.5, 0, null, 1, current_user, current_user, 'system.initial_load',
     'Initial population of yield curve process parameter definitions'),
    (ores_utility_system_tenant_id_fn(), 0, 'COX_INGERSOLL_ROSS', 'theta',
     ...
     'double', 0.03, null, null, 2, current_user, current_user, 'system.initial_load',
     'Initial population of yield curve process parameter definitions'),
    (ores_utility_system_tenant_id_fn(), 0, 'COX_INGERSOLL_ROSS', 'sigma',
     ...
     'double', 0.01, 0, null, 3, current_user, current_user, 'system.initial_load',
     'Initial population of yield curve process parameter definitions'),
    (ores_utility_system_tenant_id_fn(), 0, 'COX_INGERSOLL_ROSS', 'initial_rate',
    ...
    -- Hull-White
    (ores_utility_system_tenant_id_fn(), 0, 'HULL_WHITE', 'kappa',
     ...
     'double', 0.5, 0, null, 1, current_user, current_user, 'system.initial_load',
     'Initial population of yield curve process parameter definitions'),
    (ores_utility_system_tenant_id_fn(), 0, 'HULL_WHITE', 'theta',
     'Long-term mean: the mean-reversion target around which the short rate evolves (held constant for the generated curve).',
     'double', 0.03, null, null, 2, current_user, current_user, 'system.initial_load',
     'Initial population of yield curve process parameter definitions'),
    (ores_utility_system_tenant_id_fn(), 0, 'HULL_WHITE', 'sigma',
     'Volatility: the constant annualised standard deviation of the short-rate increments. Must be non-negative.',
     'double', 0.01, 0, null, 3, current_user, current_user, 'system.initial_load',
     'Initial population of yield curve process parameter definitions'),
    (ores_utility_system_tenant_id_fn(), 0, 'HULL_WHITE', 'initial_rate',
     'Initial short rate: the level of the short rate at the simulation start date (time zero).',
     'double', 0.03, null, null, 4, current_user, current_user, 'system.initial_load',
     'Initial population of yield curve process parameter definitions'),

    -- Two-Factor Gaussian (G2++)
    (ores_utility_system_tenant_id_fn(), 0, 'TWO_FACTOR_GAUSSIAN', 'kappa_x',
     ...
     'double', 0.5, 0, null, 1, current_user, current_user, 'system.initial_load',
     'Initial population of yield curve process parameter definitions'),
    (ores_utility_system_tenant_id_fn(), 0, 'TWO_FACTOR_GAUSSIAN', 'kappa_y',
     ...
     'Initial population of yield curve process parameter definitions'),
    (ores_utility_system_tenant_id_fn(), 0, 'TWO_FACTOR_GAUSSIAN', 'theta',
     ...
     'Initial population of yield curve process parameter definitions'),
    (ores_utility_system_tenant_id_fn(), 0, 'TWO_FACTOR_GAUSSIAN', 'sigma_x',
     ...
     'Initial population of yield curve process parameter definitions'),
    (ores_utility_system_tenant_id_fn(), 0, 'TWO_FACTOR_GAUSSIAN', 'sigma_y',
     ...
     'Initial population of yield curve process parameter definitions'),
    (ores_utility_system_tenant_id_fn(), 0, 'TWO_FACTOR_GAUSSIAN', 'rho',
     ...
     'Initial population of yield curve process parameter definitions'),
    (ores_utility_system_tenant_id_fn(), 0, 'TWO_FACTOR_GAUSSIAN', 'initial_rate',
     'Initial short rate: the level of the short rate at the simulation start date (time zero).',
