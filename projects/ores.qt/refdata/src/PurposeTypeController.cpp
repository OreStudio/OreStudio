...
void PurposeTypeController::showHistoryWindow(const QString& code) {
    ...
    auto* historyDialog =
        new HistoryDialog(std::string(entity_type_of(refdata::domain::purpose_type{})),
                          code.toStdString(),
                          clientManager_,
                          mainWindow_);
    ...
    connect(historyDialog,
            ...
            this,
            [self = QPointer<PurposeTypeController>(this)](
...
void PurposeTypeController::fetchPurposeTypeHistory(
    ...
    using FetchResult = std::expected<std::vector<refdata::domain::purpose_type>, QString>;
...
void PurposeTypeController::onOpenHistoryVersion(const QString& entityId, int versionNumber) {
    QPointer<PurposeTypeController> self = this;
    fetchPurposeTypeHistory(
        entityId,
        [self, entityId, versionNumber](
            std::expected<std::vector<refdata::domain::purpose_type>, QString> result) {
            if (!self)
                return;
            if (!result) {
...
void PurposeTypeController::onRevertHistoryVersion(const QString& entityId, int versionNumber) {
    QPointer<PurposeTypeController> self = this;
    fetchPurposeTypeHistory(
        entityId,
        [self, entityId, versionNumber](
...
void PurposeTypeController::notifyOpenDialogs(const QStringList& entityIds) {
