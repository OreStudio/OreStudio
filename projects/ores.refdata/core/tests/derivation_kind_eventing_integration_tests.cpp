...
#include "ores.refdata.api/eventing/derivation_kind_event.hpp"
...
TEST_CASE("write_derivation_kind_publishes_an_event", tags) {
    ...
    using event_type = ores::refdata::messaging::derivation_kind_event;
    ...
    event_source.register_entity_event_mapping<event_type>("ores_refdata_derivation_kinds");
