...
- Keep =ores.cli=/=ores.shell='s =host.cpp= bespoke, do not force
  ...
  Filed [[id:80C2A6CC-1CAF-4250-A807-85390C798266][Extract a sync sibling of run_host_async for ores.cli/ores.shell]]
  for the real remaining duplication between just these two, rather
  than implementing it as part of this investigation.
