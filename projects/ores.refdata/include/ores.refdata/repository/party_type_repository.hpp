 ...
 *
 */
#ifndef ORES_REFDATA_REPOSITORY_PARTY_TYPE_REPOSITORY_HPP
#define ORES_REFDATA_REPOSITORY_PARTY_TYPE_REPOSITORY_HPP
...
public:
    ...
    void write(context ctx, const domain::party_type& type);
