...
{{#has_audit_columns}}
     ...
     * @param {{primary_key.column}} The {{primary_key.column}} to look up
     * @param version The version to fetch
     */
    std::optional<domain::{{entity_singular}}>
    read_at_version(context ctx, const std::string& {{primary_key.column}}, std::uint32_t version);
{{/has_audit_columns}}
...
{{#has_parent_id}}
     ...
     * parent_id, name} rows, via {{product}}_{{component}}_{{entity_plural}}_hierarchy_fn.
     *
