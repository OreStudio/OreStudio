...
public:
    static domain::market_observation map(const market_observation_entity& v);
    static market_observation_entity map(const domain::market_observation& v);

    static std::vector<domain::market_observation>
    map(const std::vector<market_observation_entity>& v);
    static std::vector<market_observation_entity>
    map(const std::vector<domain::market_observation>& v);
};
