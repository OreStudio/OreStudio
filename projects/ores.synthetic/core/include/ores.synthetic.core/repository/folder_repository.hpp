...
public:
    ...
    /**
     * @brief Writes a folder, honouring the claim it states.
     *
     ...
     */
    void
    write(context ctx, const domain::folder& v, const ores::utility::domain::precondition& claim);

    /**
     * @brief Writes a set of folders, each honouring its own
    ...
    std::vector<domain::folder> read_latest(context ctx, const std::vector<std::string>& ids);
    /**@}*/
    ...
    /**
     * @brief Removes a folder, refusing a row that moved on.
     *
...
private:
     ...
     */
    ores::utility::domain::precondition replace_claim(context ctx, const domain::folder& v);
     ...
     */
    domain::folder apply_claim(context ctx,
