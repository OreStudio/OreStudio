 ...
 */
#ifndef ORES_QT_LEDGER_FEED_TYPE_MDI_WINDOW_HPP
#define ORES_QT_LEDGER_FEED_TYPE_MDI_WINDOW_HPP
 ...
 *
 * Provides a table view of ledger feed types with toolbar actions
 * for reload, add, edit, delete, and viewing history.
 */
class LedgerFeedTypeMdiWindow final : public EntityListMdiWindow {
    Q_OBJECT

private:
    inline static std::string_view logger_name = "ores.qt.ledger_feed_type_mdi_window";
...
signals:
    ...
    void showTypeDetails(const refdata::domain::ledger_feed_type& type);
    void addNewRequested();
    void typeDeleted(const QString& code);
    void showTypeHistory(const refdata::domain::ledger_feed_type& type);
...
protected:
    QString normalRefreshTooltip() const override {
        return tr("Refresh ledger feed types");
    }
...
private:
    ...
    ClientLedgerFeedTypeModel* model_;
