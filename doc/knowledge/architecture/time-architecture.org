...
- [[id:B28747DF-A735-1C84-4E43-11ADFA8B05E3][PostgreSQL Row-Level Security]] — the only current PostgreSQL
  architecture document; covers RLS, tenant isolation, and role
  assignment. A broader PostgreSQL conventions document does not yet
  exist; it should be created and linked here once written.
