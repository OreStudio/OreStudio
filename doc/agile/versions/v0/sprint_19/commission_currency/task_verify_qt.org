...
| Now          | Code review done; one bug fixed; manual run-through needed. |
| Waiting on   | Manual test session against live service.              |
| Next         | Start services; open Qt app; run through checklist.    |
