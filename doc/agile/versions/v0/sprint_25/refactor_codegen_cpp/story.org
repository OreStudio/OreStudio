...
| [[id:98D0B4FD-EBF9-4DB4-863F-CF0EACD2A1B2][Fix profile binding: single canonical point in * Flags section]] | STARTED | 2026-08-08 | | read_physical_space_overrides reads :profile: from file-level :PROPERTIES: drawer for Physical-space facet enablement, but every entity model declares :profile: in * Flags. Unify to a single binding point in * Flags, add validation that throws if :profile: is in the wrong place, and revert the workaround on reporting entities. |
