...
/**
 * @brief Represents a scripted instrument in the database.
 */
struct scripted_instrument_entity {
    ...
    std::optional<std::string> underlyings_json;
...
std::ostream& operator<<(std::ostream& s, const scripted_instrument_entity& v);
