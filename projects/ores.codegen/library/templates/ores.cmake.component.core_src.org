:PROPERTIES:
:ID: 4D32964F-B890-4B12-8AD6-B3ADB0E79335
:END:
#+title: ores.cmake.component.core_src
#+description: =src/CMakeLists.txt= for a =.core= component (=component-core= profile): links its sibling api library (={{api_full_name}}.lib=) publicly plus the NATS/service stack privately. Output =projects/{component_full}/src/CMakeLists.txt=.
#+type: archetype
