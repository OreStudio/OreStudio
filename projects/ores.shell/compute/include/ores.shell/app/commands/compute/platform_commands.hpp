 ...
 */
#ifndef ORES_SHELL_APP_COMMANDS_PLATFORM_COMMANDS_HPP
#define ORES_SHELL_APP_COMMANDS_PLATFORM_COMMANDS_HPP
...
/**
 * @brief Every verb compute platforms answer, as one command each.
 *
 ...
 */
class platform_commands {
private:
    inline static std::string_view logger_name =
        "ores.shell.app.commands.compute.platform_commands";
...
public:
    /**
     * @brief Register the compute platforms submenu.
     */
    ...
    /**
     * @brief add <id> <code> <display_name> <description> <os_family> <cpu_arch> <abi> <is_active>
     * <reason> <commentary>
     */
    ...
    /**
     * @brief set <id> <code> <display_name> <description> <os_family> <cpu_arch> <abi> <is_active>
    ...
    /**
     * @brief put-many --count <n> <id> <code> <display_name> <description> <os_family> <cpu_arch>
