...
| Now           | Phase B2: currency pilot for server-side diffs. |
| Waiting on    | Nothing.                               |
...
| [[id:D575DCF0-2341-4630-9C47-F428F82C2FCE][Pilot server-side history diffs end to end on currency]] | DONE | 2026-06-05 | 2026-06-05 | Phase B2: currency mapper, extended response, handler compose, dialog renders server rows. |
...
| [[id:F455B2BE-5562-4561-B8D2-9D85E218B669][Show history as a unified diff in ores.shell]] | BACKLOG | | | Unified-diff rendering of the changes rows in the shell; no comparison logic client-side. |
