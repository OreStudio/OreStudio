...
register_party_id_scheme_event_mapping(ev::service::postgres_event_source& event_source,
    ...
    event_source.register_entity_event_mapping<refdata::messaging::party_id_scheme_event>(
        "ores_refdata_party_id_schemes");

    return event_bus.subscribe<refdata::messaging::party_id_scheme_event>(
        [&nats](const refdata::messaging::party_id_scheme_event& e) {
            ...
            ev::service::publish_entity_event(
                nats,
                ev::domain::event_subject<refdata::messaging::party_id_scheme_event>(e.action),
                e);
        });
}
