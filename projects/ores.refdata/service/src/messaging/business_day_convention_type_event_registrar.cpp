...
[[nodiscard]] ev::service::subscription register_business_day_convention_type_event_mapping(
    ...
    event_source
        .register_entity_event_mapping<refdata::messaging::business_day_convention_type_event>(
            "ores_refdata_business_day_convention_types");

    return event_bus.subscribe<refdata::messaging::business_day_convention_type_event>(
        [&nats](const refdata::messaging::business_day_convention_type_event& e) {
            ...
            ev::service::publish_entity_event(
                nats,
                ev::domain::event_subject<refdata::messaging::business_day_convention_type_event>(
                    e.action),
                e);
        });
}
