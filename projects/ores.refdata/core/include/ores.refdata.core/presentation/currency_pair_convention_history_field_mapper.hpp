 ...
 *
 */
#ifndef ORES_REFDATA_CORE_PRESENTATION_CURRENCY_PAIR_CONVENTION_HISTORY_FIELD_MAPPER_HPP
#define ORES_REFDATA_CORE_PRESENTATION_CURRENCY_PAIR_CONVENTION_HISTORY_FIELD_MAPPER_HPP
...
/**
 * @brief Renders a currency_pair_convention to an ordered field list for
