...
public:
    static domain::equity_asian_option_instrument
    map(const equity_asian_option_instrument_entity& v);
    static equity_asian_option_instrument_entity
    map(const domain::equity_asian_option_instrument& v);
