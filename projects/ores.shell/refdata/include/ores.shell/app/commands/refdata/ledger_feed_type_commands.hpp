 ...
 */
#ifndef ORES_SHELL_APP_COMMANDS_LEDGER_FEED_TYPE_COMMANDS_HPP
#define ORES_SHELL_APP_COMMANDS_LEDGER_FEED_TYPE_COMMANDS_HPP
...
/**
 * @brief Every verb ledger feed types answer, as one command each.
 *
 ...
 */
class ledger_feed_type_commands {
private:
    inline static std::string_view logger_name =
        "ores.shell.app.commands.refdata.ledger_feed_type_commands";
...
public:
    /**
     * @brief Register the ledger feed types submenu.
     */
