...
| [[proj:projects/CMakeLists.txt][=projects/CMakeLists.txt=]] | Remove =add_subdirectory(ores.mq.broker)= |
...
| [[proj:projects/ores.nats][=projects/ores.nats/=]] | New library project |
...
| [[proj:projects/CMakeLists.txt][=projects/CMakeLists.txt=]] | Add =add_subdirectory(ores.nats)= |
...
- Update [[proj:projects/CMakeLists.txt][=projects/CMakeLists.txt=]]
...
|-----------|----------|---------|
| =ores.nats= library | [[proj:projects/ores.nats][=projects/ores.nats/=]] | RAII cnats wrappers + service/client base |
