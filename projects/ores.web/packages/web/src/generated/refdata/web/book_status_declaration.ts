 ...
 */
/**
 * Where the book_status screens live and what they can do.
 *
 ...
 */
import { bookStatusMeta } from '../ui/book_status_ui.js';
import type { EntityDescriptor } from '../../../entity/descriptor.js';

export const bookStatusDescriptor: EntityDescriptor = {
    component: 'refdata',
    entity: 'book_status',
    meta: bookStatusMeta,
    routeSegment: 'book-status',
