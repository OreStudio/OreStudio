 ...
 *
 */
#ifndef ORES_SYNTHETIC_CORE_MESSAGING_YIELD_CURVE_PROCESS_PARAMETER_DEFINITION_HANDLER_HPP
#define ORES_SYNTHETIC_CORE_MESSAGING_YIELD_CURVE_PROCESS_PARAMETER_DEFINITION_HANDLER_HPP
...
namespace {
inline auto& yield_curve_process_parameter_definition_handler_lg() {
...
public:
    yield_curve_process_parameter_definition_handler(
