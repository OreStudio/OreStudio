...
#+description: Codegen entity model for the refdata =currency_pair= table. Drives the C++ domain class, mapper, repository, service, generator, and SQL schema generation from a single literate source.
