...
register_concurrency_policy_event_mapping(ev::service::postgres_event_source& event_source,
                                          ev::service::event_bus& event_bus,
                                          ores::nats::service::client& nats) {
    ev::service::registrar::register_mapping<reporting::eventing::concurrency_policy_changed_event>(
        event_source, "ores.reporting.concurrency_policy", "ores_reporting_concurrency_policies");

    return event_bus.subscribe<reporting::eventing::concurrency_policy_changed_event>(
        [&nats](const reporting::eventing::concurrency_policy_changed_event& e) {
            ev::service::publish_entity_event(
                nats,
                std::string(ev::domain::event_traits<
                            reporting::eventing::concurrency_policy_changed_event>::name),
