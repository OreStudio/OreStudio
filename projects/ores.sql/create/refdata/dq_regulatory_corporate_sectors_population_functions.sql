 ...
 *   SELECT * FROM ores_dq_preview_regulatory_corporate_sector_population(dataset_id);
 *
 *   -- Publish to production
 *   SELECT * FROM ores_dq_populate_regulatory_corporate_sectors(dataset_id, 'upsert');
 */
 ...
 */
create or replace function ores_dq_preview_regulatory_corporate_sector_population(p_dataset_id uuid)
returns table (
    action text,
    code text,
...
begin
    ...
    left join ores_refdata_regulatory_corporate_sectors_tbl existing
...
/**
 * Populate ores_refdata_regulatory_corporate_sectors_tbl from a DQ regulatory_corporate_sectors dataset.
 *
 * @param p_dataset_id  The DQ dataset to populate from.
 * @param p_mode        Population mode: 'upsert', 'insert_only', or 'replace_all'.
 */
create or replace function ores_dq_populate_regulatory_corporate_sectors(
    p_dataset_id uuid,
