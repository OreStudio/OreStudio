...
#+CAPTION: Clock summary at [2025-02-11 Tue 23:00]
|       | <75>                                   |         |       |      |       |
| Tags  | Headline                               | Time    |       |      |     % |
|-------+----------------------------------------+---------+-------+------+-------|
...
|       | Stories                                | 12:13   |       |      | 100.0 |
|       | Active                                 |         | 12:13 |      | 100.0 |
| agile | Sprint and product backlog refinement  |         |       | 1:22 |  11.2 |
| infra | Fix broken builds                      |         |       | 0:36 |   4.9 |
| code  | Create a containing structure for data |         |       | 0:35 |   4.8 |
| code  | Add temporal support to currencies     |         |       | 2:59 |  24.4 |
| code  | Add command to dump currencies         |         |       | 2:02 |  16.6 |
| code  | Refactor code for currencies           |         |       | 4:39 |  38.1 |
#+end:
