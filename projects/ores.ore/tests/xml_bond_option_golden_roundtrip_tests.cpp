...
/**
 * @file xml_bond_option_golden_roundtrip_tests.cpp
 * @brief Thing 1: XSD serialization fidelity golden file tests for BondOption.
 */

namespace {

const std::string_view test_suite("ores.ore.bond.option.golden.roundtrip.tests");
const std::string tags("[ore][xml][roundtrip][golden][bond][option]");
...
TEST_CASE("golden_roundtrip_bond_option_strike_price_strike_yield", tags) {
    run_golden_test("BondOption_StrikePrice_StrikeYield.xml");
}
