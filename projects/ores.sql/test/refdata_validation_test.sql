...
select is(
    ores_refdata_validate_rounding_type_fn(ores_utility_system_tenant_id_fn(), NULL),
    'Closest',
...
select is(
    ores_refdata_validate_rounding_type_fn(ores_utility_system_tenant_id_fn(), ''),
    'Closest',
...
select is(
    ores_refdata_validate_rounding_type_fn(ores_utility_system_tenant_id_fn(), 'Up'),
    'Up',
...
select is(
    ores_refdata_validate_rounding_type_fn(ores_utility_system_tenant_id_fn(), 'Down'),
    'Down',
...
select is(
    ores_refdata_validate_rounding_type_fn(ores_utility_system_tenant_id_fn(), 'Floor'),
    'Floor',
...
select is(
    ores_refdata_validate_rounding_type_fn(ores_utility_system_tenant_id_fn(), 'Ceiling'),
    'Ceiling',
...
select throws_ok(
    $$select ores_refdata_validate_rounding_type_fn(ores_utility_system_tenant_id_fn(), 'INVALID')$$,
    '23503',
    NULL,
...
select is(
    ores_dq_validate_change_reason_fn(ores_utility_system_tenant_id_fn(), NULL),
    'system.new_record',
...
select is(
    ores_dq_validate_change_reason_fn(ores_utility_system_tenant_id_fn(), ''),
    'system.new_record',
...
select is(
    ores_dq_validate_change_reason_fn(ores_utility_system_tenant_id_fn(), 'system.initial_load'),
    'system.initial_load',
...
select is(
    ores_dq_validate_change_reason_fn(ores_utility_system_tenant_id_fn(), 'common.rectification'),
...
select throws_ok(
    $$select ores_dq_validate_change_reason_fn(ores_utility_system_tenant_id_fn(), 'INVALID_REASON')$$,
    '23503',
    NULL,
