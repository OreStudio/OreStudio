...
| [[id:294FFF1A-E70B-489A-B7A3-40F57528B46E][Resync the job_definition model with its hand-written code]] | STARTED | 2026-09-12 | | The scheduler model's column shapes do not match the hand-written struct, so regenerating emits wrong types rather than wrong formatting; the model must be corrected before any facet can be regenerated. |
