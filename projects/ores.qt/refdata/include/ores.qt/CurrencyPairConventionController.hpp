 ...
 */
#ifndef ORES_QT_CURRENCY_PAIR_CONVENTION_CONTROLLER_HPP
#define ORES_QT_CURRENCY_PAIR_CONVENTION_CONTROLLER_HPP
 ...
 *
 * Manages the lifecycle of currency pair convention list, detail, and history windows.
 * Handles event subscriptions and coordinates between windows.
 */
class CurrencyPairConventionController final : public EntityController {
    Q_OBJECT

private:
    inline static std::string_view logger_name = "ores.qt.currency_pair_convention_controller";
...
private slots:
    ...
    void onShowHistory(const refdata::domain::currency_pair_convention& convention);
...
private:
     ...
     * CurrencyPairConventionDetailDialog needs regardless of which
     * window opened it (add/edit/history-version/revert) -- kept in one
     * place so those four call sites can't drift from each other.
     */
    void wireDetailDialogCommon(CurrencyPairConventionDetailDialog* detailDialog);
