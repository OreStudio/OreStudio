 ...
 *
 */
#ifndef ORES_TRADING_API_GENERATORS_BALANCE_GUARANTEED_SWAP_INSTRUMENT_GENERATOR_HPP
#define ORES_TRADING_API_GENERATORS_BALANCE_GUARANTEED_SWAP_INSTRUMENT_GENERATOR_HPP
