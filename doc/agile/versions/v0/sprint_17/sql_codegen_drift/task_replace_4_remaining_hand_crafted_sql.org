...
- Extends =sql_schema_domain_entity_create.mustache= and =generator.py= with
  ...
  were previously marked DEFERRED in [[proj:doc/plans/2026-05-14-codegen-sql-debt.org][=doc/plans/2026-05-14-codegen-sql-debt.org=]]
- All four files now carry the =AUTO-GENERATED FILE= header; every
  =*_create.sql= file in [[proj:projects/ores.sql/create][=projects/ores.sql/create/=]] is now codegen-managed
...
- [[proj:projects/ores.sql/utility/validate_schemas.sh][=projects/ores.sql/utility/validate_schemas.sh=]] — passed (211 tables, 0 warnings)
