...
|------+-------+-------+-----+-------------|
| [[id:EAE34F82-2564-472C-BDBF-026C5EE0D4C4][Audit harness memory files and classify each entry]] | STARTED | 2026-06-11 | | Read every .md file in the two populated OreStudio harness memory dirs and classify each as: port to org, already covered, or discard. |
