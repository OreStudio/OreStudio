...
composite_instrument_mapper::map(const composite_instrument_entity& v) {
...
composite_instrument_entity
composite_instrument_mapper::map(const domain::composite_instrument& v) {
