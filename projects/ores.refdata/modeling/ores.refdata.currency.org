...
All 11 fields currently exposed in =CurrencyDetailDialog.ui= (4 new
domain columns — =spot_days=, =day_basis=, =base_precedence=,
=holiday_calendar= — aren't in the UI yet; out of scope for this sync,
tracked separately). =image_id= isn't a detail field either (handled
generically via =has_flag_icon=, matching every other flag entity).
...
| fraction_symbol    | Fraction Symbol     | fractionSymbolEdit        | line_edit     |        | true        | Enter fraction symbol           |          |          |                                        |                             |                              |                        |                  |                      |                  |                        |                      |                        | Formatting  |
| fractions_per_unit | Fractions Per Unit  | fractionsPerUnitSpinBox   | spin_box      |        |             |                                  | 0        | 10000    |                                        |                             |                              |                        |                  |                      |                  |                        |                      |                        | Formatting  |
| format             | Format              | formatEdit                | line_edit     |        | true        | Enter display format            |          |          |                                        |                             |                              |                        |                  |                      |                  |                        |                      |                        | Formatting  |
...
| HolidayCalendar    | holiday_calendar   | Holiday Calendar| string    | auto  |                |          |                       | true               |
