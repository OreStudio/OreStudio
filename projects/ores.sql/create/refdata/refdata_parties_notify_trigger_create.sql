 ...
 *
 */
create or replace function ores_refdata_parties_notify_fn()
returns trigger as $$
declare
    notification_payload jsonb;
    entity_name text := 'ores.refdata.party';
...
create or replace trigger ores_refdata_parties_notify_trg
after insert or update or delete on ores_refdata_parties_tbl
for each row execute function ores_refdata_parties_notify_fn();
