...
| [[id:4CB973CA-86B7-4476-85F2-0F11626BFB27][Apply the unique suffix that requires_unique_suffix asks for]] | BACKLOG | | | A column marked requires_unique_suffix turns the synthetic counter on but never receives a suffix, so repeated generation collides on the unique index. |
