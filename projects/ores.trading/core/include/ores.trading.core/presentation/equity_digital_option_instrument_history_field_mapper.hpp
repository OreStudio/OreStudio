 ...
 *
 */
#ifndef ORES_TRADING_CORE_PRESENTATION_EQUITY_DIGITAL_OPTION_INSTRUMENT_HISTORY_FIELD_MAPPER_HPP
#define ORES_TRADING_CORE_PRESENTATION_EQUITY_DIGITAL_OPTION_INSTRUMENT_HISTORY_FIELD_MAPPER_HPP
...
/**
 * @brief Renders a equity_digital_option_instrument to an ordered field list for
