...
| Now           | Per-environment resource limits task STARTED -- all unprivileged workstreams (WS-7, WS-1, WS-5 unpriv, WS-4) merged/in flight; WS-3 and WS-2 both discovered already implemented (predate this story, Sprint 24 PR #1806). |
| Waiting on    | Someone with root, for WS-5's root half.  |
| Next          | WS-5 (root half) and the plan's explicit deliberate-OOM acceptance test; WS-6 stays deferred. |
