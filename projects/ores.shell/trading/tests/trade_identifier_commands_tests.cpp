...
using ores::shell::app::commands::trade_identifier_commands;
...
TEST_CASE("trade_identifier_commands_register_commands_registers_the_pagination_callback", tags) {
    ...
    BOOST_LOG_SEV(lg, debug) << "Looking up the pagination callback for trade_identifiers.";
    CHECK(pagination.get_list_callback("trade_identifiers") != nullptr);
}

TEST_CASE("trade_identifier_commands_process_add_requires_a_logged_in_session", tags) {
    auto lg(make_logger(test_suite));
    ...
    trade_identifier_commands::process_add_trade_identifier(out, session, add_tokens());
...
TEST_CASE("trade_identifier_commands_process_add_reports_the_expected_argument_count", tags) {
    auto lg(make_logger(test_suite));
    ...
    command_feedback::reset();
    trade_identifier_commands::process_add_trade_identifier(out, session, {"sample"});
...
TEST_CASE("trade_identifier_commands_process_add_names_the_field_of_a_malformed_token", tags) {
    auto lg(make_logger(test_suite));
    ...
    command_feedback::reset();
    trade_identifier_commands::process_add_trade_identifier(out, session, tokens);
...
TEST_CASE("trade_identifier_commands_process_add_sends_a_valid_token_vector_to_the_server", tags) {
    auto lg(make_logger(test_suite));
...
TEST_CASE("trade_identifier_commands_process_delete_requires_a_logged_in_session", tags) {
    auto lg(make_logger(test_suite));
    ...
    command_feedback::reset();
    trade_identifier_commands::process_delete_trade_identifier(out, session, "missing-key");
...
TEST_CASE("trade_identifier_commands_process_history_requires_a_logged_in_session", tags) {
    auto lg(make_logger(test_suite));
    ...
    command_feedback::reset();
    trade_identifier_commands::process_get_trade_identifier_history(out, session, {"missing-key"});
...
TEST_CASE("trade_identifier_commands_process_history_rejects_a_version_without_diff", tags) {
    auto lg(make_logger(test_suite));
    ...
    command_feedback::reset();
    trade_identifier_commands::process_get_trade_identifier_history(
