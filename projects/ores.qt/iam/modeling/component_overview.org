...
#+attr_html: :width 100% :alt ores.qt.iam component diagram
#+caption: ores.qt.iam
[[file:ores.qt.iam.png][file:ores.qt.iam.png]]

* Summary

=ores.qt.iam= is the Qt plugin for identity and access management UI.
...
- =include/ores.qt/IamPlugin.hpp= — plugin class; contributes to System menu.
