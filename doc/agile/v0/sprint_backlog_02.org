...
#+CAPTION: Clock summary at [2025-09-26 Fri 19:10], for Friday, September 26, 2025.
|      | <75>                    |        |      |      |       |
| Tags | Headline                | Time   |      |      |     % |
|------+-------------------------+--------+------+------+-------|
...
|      | Stories                 | 4:33   |      |      | 100.0 |
|      | Active                  |        | 4:33 |      | 100.0 |
| code | Use sqlgen for postgres |        |      | 4:33 | 100.0 |
#+end:

#+begin: clocktable :maxlevel 3 :scope subtree :tags t :indent nil :emphasize nil :scope file :narrow 75 :formula %
#+TBLNAME: sprint_summary
#+CAPTION: Clock summary at [2025-09-26 Fri 19:10]
|          | <75>                                               |         |       |      |       |
| Tags     | Headline                                           | Time    |       |      |     % |
|----------+----------------------------------------------------+---------+-------+------+-------|
|          | *Total time*                                       | *46:19* |       |      | 100.0 |
|----------+----------------------------------------------------+---------+-------+------+-------|
|          | Stories                                            | 46:19   |       |      | 100.0 |
|          | Active                                             |         | 46:19 |      | 100.0 |
| agile    | Sprint and product backlog refinement              |         |       | 2:15 |   4.9 |
| infra    | Fix broken builds                                  |         |       | 0:36 |   1.3 |
| code     | Create a containing structure for data             |         |       | 0:35 |   1.3 |
| code     | Add temporal support to currencies                 |         |       | 2:59 |   6.4 |
| code     | Add command to dump currencies                     |         |       | 4:18 |   9.3 |
| code     | Refactor code for currencies                       |         |       | 3:52 |   8.3 |
| code     | Restore qt setup                                   |         |       | 2:20 |   5.0 |
| code     | Add gemini action                                  |         |       | 0:05 |   0.2 |
| code     | Remove ImGui support                               |         |       | 0:08 |   0.3 |
| code     | Create a GRPC based service                        |         |       | 2:09 |   4.6 |
| code     | Implement a 0MQ based RPC service and client       |         |       | 3:55 |   8.5 |
...
| code     | Implement a cobalt based server and client         |         |       | 2:53 |   6.2 |
| code     | Add serialisation support for reflect-cpp          |         |       | 3:07 |   6.7 |
| analysis | White-boarding for new architecture                |         |       | 1:52 |   4.0 |
| code     | Use sqlgen for postgres                            |         |       | 7:23 |  15.9 |
| code     | Completions in emacs org mode are incorrect        |         |       | 1:02 |   2.2 |
| infra    | Investigate build warning for vcpkg binary caching |         |       | 0:25 |   0.9 |
| infra    | Investigate build warning for qtbase               |         |       | 0:10 |   0.4 |
| analysis | Investigate bitemporal support from Postgres 18    |         |       | 1:47 |   3.9 |
| code     | Fix windows and osx builds                         |         |       | 0:27 |   1.0 |
| code     | Fix gemini cli action                              |         |       | 0:45 |   1.6 |
| infra    | vcpkg caching seems disabled                       |         |       | 0:15 |   0.5 |
| code     | Create a =comms= library                           |         |       | 1:10 |   2.5 |
| code     | Add workspace as a container                       |         |       | 1:13 |   2.6 |
#+end:
