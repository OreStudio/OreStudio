 ...
 */
#ifndef ORES_SHELL_APP_COMMANDS_TENOR_RESOLUTION_ALGORITHM_COMMANDS_HPP
#define ORES_SHELL_APP_COMMANDS_TENOR_RESOLUTION_ALGORITHM_COMMANDS_HPP
...
/**
 * @brief Every verb tenor resolution algorithms answer, as one command each.
 *
 ...
 */
class tenor_resolution_algorithm_commands {
private:
    inline static std::string_view logger_name =
        "ores.shell.app.commands.refdata.tenor_resolution_algorithm_commands";
...
public:
    /**
     * @brief Register the tenor resolution algorithms submenu.
     */
