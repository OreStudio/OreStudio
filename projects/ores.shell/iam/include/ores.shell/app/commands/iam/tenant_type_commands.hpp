 ...
 */
#ifndef ORES_SHELL_APP_COMMANDS_TENANT_TYPE_COMMANDS_HPP
#define ORES_SHELL_APP_COMMANDS_TENANT_TYPE_COMMANDS_HPP
...
/**
 * @brief Every verb tenant types answer, as one command each.
 *
 ...
 */
class tenant_type_commands {
private:
    inline static std::string_view logger_name = "ores.shell.app.commands.iam.tenant_type_commands";
...
public:
    /**
     * @brief Register the tenant types submenu.
     */
    ...
    /**
     * @brief add <type> <name> <description> <display_order> <reason> <commentary>
     */
    ...
    /**
     * @brief set <type> <name> <description> <display_order> <reason> <commentary> [--version <n>]
     */
    ...
    /**
     * @brief put-many --count <n> <type> <name> <description> <display_order> <reason> <commentary>
     */
    ...
    /**
     * @brief delete <type> <reason> <commentary> [--version <n>]
     */
    ...
    /**
     * @brief delete-many <type> <reason> <commentary>
     */
    ...
    /**
     * @brief versions <type> [--offset <n>] [--limit <n>] [--order <field>] [--desc]
     */
