 ...
 *
 */
#ifndef ORES_REFDATA_CORE_REPOSITORY_FLOATING_INDEX_TYPE_REPOSITORY_HPP
#define ORES_REFDATA_CORE_REPOSITORY_FLOATING_INDEX_TYPE_REPOSITORY_HPP
...
/**
 * @brief Reads and writes floating index types to data storage.
 */
class ORES_REFDATA_CORE_EXPORT floating_index_type_repository {
private:
    inline static std::string_view logger_name =
        "ores.refdata.repository.floating_index_type_repository";
...
public:
    ...
    /**
     * @brief Reads latest floating index types, possibly filtered by code.
     */
    /**@{*/
    ...
    /**
     * @brief Reads all floating index types, possibly filtered by code.
     */
    std::vector<domain::floating_index_type> read_all(context ctx, const std::string& code);

    /**
     * @brief Reads a single floating index type as it stood at a specific
    ...
    /**
     * @brief Deletes a floating index type by closing its temporal validity.
     */
