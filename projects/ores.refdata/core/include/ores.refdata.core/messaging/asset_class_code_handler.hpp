 ...
 *
 */
#ifndef ORES_REFDATA_CORE_MESSAGING_ASSET_CLASS_CODE_HANDLER_HPP
#define ORES_REFDATA_CORE_MESSAGING_ASSET_CLASS_CODE_HANDLER_HPP
...
namespace {
inline auto& asset_class_code_handler_lg() {
    static auto instance =
        ores::logging::make_logger("ores.refdata.messaging.asset_class_code_handler");
    return instance;
}
} // namespace
...
/**
 * @brief NATS message handler for asset class code operations.
 */
class asset_class_code_handler {
public:
    asset_class_code_handler(ores::nats::service::client& nats,
