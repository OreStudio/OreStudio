...
export header.  This is the canonical approach for every shared library
in the tree.
...
by service executables or test binaries.  Entity structs
...
Test binaries are executables.  They may link against
=ores.X.core= to exercise the DB layer directly, but they do not
export symbols.
...
Linking an HTTP handler directly to =ores.X.core= is an architectural
violation: it bypasses the service boundary and couples HTTP code to
database implementation details.

* See also

- [[id:720D74A0-DAD3-4F11-BC5F-AD78BF5A9DD2][Qt QPluginLoader Architecture Migration]] — the retired desktop
  client's plugin pattern, kept as history.
