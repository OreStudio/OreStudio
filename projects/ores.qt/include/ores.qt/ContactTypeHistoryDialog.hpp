 ...
 *
 */
#ifndef ORES_QT_CONTACT_TYPE_HISTORY_DIALOG_HPP
#define ORES_QT_CONTACT_TYPE_HISTORY_DIALOG_HPP
...
/**
 * @brief Dialog for viewing the version history of a contact type.
 *
...
private:
    inline static std::string_view logger_name =
        "ores.qt.contact_type_history_dialog";
...
public:
    explicit ContactTypeHistoryDialog(
        const QString& code,
...
signals:
    ...
    void openVersionRequested(const refdata::domain::contact_type& type,
                              int versionNumber);
