 ...
 */
#ifndef ORES_SHELL_APP_COMMANDS_ACCOUNT_COMMANDS_HPP
#define ORES_SHELL_APP_COMMANDS_ACCOUNT_COMMANDS_HPP
...
/**
 * @brief Every verb accounts answer, as one command each.
 *
 ...
 */
class account_commands {
private:
    inline static std::string_view logger_name = "ores.shell.app.commands.iam.account_commands";
...
public:
    /**
     * @brief Register the accounts submenu.
     */
