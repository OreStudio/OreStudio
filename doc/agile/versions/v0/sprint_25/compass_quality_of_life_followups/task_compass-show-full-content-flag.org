...
Fixed body-extraction to split at first * heading instead of :END:,
eliminating header/blurb duplication. Removed redundant Path import
and used errors="replace" for consistency.
