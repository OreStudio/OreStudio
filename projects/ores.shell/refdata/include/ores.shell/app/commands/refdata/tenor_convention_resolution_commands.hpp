 ...
 */
#ifndef ORES_SHELL_APP_COMMANDS_TENOR_CONVENTION_RESOLUTION_COMMANDS_HPP
#define ORES_SHELL_APP_COMMANDS_TENOR_CONVENTION_RESOLUTION_COMMANDS_HPP
...
/**
 * @brief Every verb tenor_convention_resolutions answer, as one command each.
 *
 ...
 */
class tenor_convention_resolution_commands {
private:
    inline static std::string_view logger_name =
        "ores.shell.app.commands.refdata.tenor_convention_resolution_commands";
...
public:
    /**
     * @brief Register the tenor_convention_resolutions submenu.
     */
    ...
    /**
     * @brief get <convention_code> <tenor_code>
     */
    ...
    /**
     * @brief get-many <convention_code> <tenor_code>
     */
     ...
     * [--desc]
     */
    static void process_by_convention_code(std::ostream& out,
                                           ores::nats::service::nats_client& session,
                                           const std::vector<std::string>& args);
};
