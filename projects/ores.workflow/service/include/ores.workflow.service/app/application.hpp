 ...
 *
 */
#ifndef ORES_WORKFLOW_SERVICE_APP_APPLICATION_HPP
#define ORES_WORKFLOW_SERVICE_APP_APPLICATION_HPP
...
/**
 * @brief Entry point for the ores.workflow.service service.
 */
class application final {
private:
    inline static std::string_view logger_name = "ores.workflow.service.app.application";
