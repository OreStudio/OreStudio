...
| [[id:D575DCF0-2341-4630-9C47-F428F82C2FCE][Pilot server-side history diffs end to end on currency]] | STARTED | 2026-06-05 | | Phase B2: currency mapper, extended response, handler compose, dialog renders server rows. |
