 ...
 */
#ifndef ORES_SHELL_APP_COMMANDS_CRM_ENABLED_DERIVED_PAIR_COMMANDS_HPP
#define ORES_SHELL_APP_COMMANDS_CRM_ENABLED_DERIVED_PAIR_COMMANDS_HPP
...
/**
 * @brief Every verb CRM enabled derived pairs answer, as one command each.
 *
 ...
 */
class crm_enabled_derived_pair_commands {
private:
    inline static std::string_view logger_name =
        "ores.shell.app.commands.refdata.crm_enabled_derived_pair_commands";
...
public:
    /**
     * @brief Register the CRM enabled derived pairs submenu.
     */
    ...
    /**
     * @brief set <id> <config_id> <base_currency_code> <quote_currency_code> <enabled> <reason>
