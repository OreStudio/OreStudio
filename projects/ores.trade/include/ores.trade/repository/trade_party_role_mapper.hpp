 ...
 *
 */
#ifndef ORES_TRADE_REPOSITORY_TRADE_PARTY_ROLE_MAPPER_HPP
#define ORES_TRADE_REPOSITORY_TRADE_PARTY_ROLE_MAPPER_HPP

#include "ores.trade/domain/trade_party_role.hpp"
#include "ores.trade/repository/trade_party_role_entity.hpp"
#include "ores.logging/make_logger.hpp"

namespace ores::trade::repository {

/**
 * @brief Maps trade_party_role domain entities to data storage layer and vice-versa.
 */
class trade_party_role_mapper {
private:
    inline static std::string_view logger_name =
        "ores.trade.repository.trade_party_role_mapper";
