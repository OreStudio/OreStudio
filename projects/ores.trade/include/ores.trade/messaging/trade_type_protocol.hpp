 ...
 *
 */
#ifndef ORES_TRADE_MESSAGING_TRADE_TYPE_PROTOCOL_HPP
#define ORES_TRADE_MESSAGING_TRADE_TYPE_PROTOCOL_HPP
...
// Trade Type traits
template<>
struct message_traits<trade::messaging::get_trade_types_request> {
    using request_type = trade::messaging::get_trade_types_request;
    using response_type = trade::messaging::get_trade_types_response;
    static constexpr message_type request_message_type =
        message_type::get_trade_types_request;
};

template<>
struct message_traits<trade::messaging::save_trade_type_request> {
    using request_type = trade::messaging::save_trade_type_request;
    using response_type = trade::messaging::save_trade_type_response;
    static constexpr message_type request_message_type =
        message_type::save_trade_type_request;
};

template<>
struct message_traits<trade::messaging::delete_trade_type_request> {
    using request_type = trade::messaging::delete_trade_type_request;
    using response_type = trade::messaging::delete_trade_type_response;
    static constexpr message_type request_message_type =
        message_type::delete_trade_type_request;
};

template<>
struct message_traits<trade::messaging::get_trade_type_history_request> {
    using request_type = trade::messaging::get_trade_type_history_request;
    using response_type = trade::messaging::get_trade_type_history_response;
    static constexpr message_type request_message_type =
