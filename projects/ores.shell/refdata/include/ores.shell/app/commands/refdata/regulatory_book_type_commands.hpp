 ...
 */
#ifndef ORES_SHELL_APP_COMMANDS_REGULATORY_BOOK_TYPE_COMMANDS_HPP
#define ORES_SHELL_APP_COMMANDS_REGULATORY_BOOK_TYPE_COMMANDS_HPP
...
/**
 * @brief Every verb regulatory book types answer, as one command each.
 *
 ...
 */
class regulatory_book_type_commands {
private:
    inline static std::string_view logger_name =
        "ores.shell.app.commands.refdata.regulatory_book_type_commands";
...
public:
    /**
     * @brief Register the regulatory book types submenu.
     */
