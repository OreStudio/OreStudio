...
#+CAPTION: Clock summary at [2024-06-23 Sun 00:46]
| <75>                                    |         |       |      |       |
| Headline                                | Time    |       |      |     % |
|-----------------------------------------+---------+-------+------+-------|
...
| Stories                                 | 10:13   |       |      | 100.0 |
| Active                                  |         | 10:13 |      | 100.0 |
| Sprint and product backlog refinement   |         |       | 0:14 |   2.3 |
| Create a basic git hub repository       |         |       | 0:35 |   5.7 |
| Setup a discord channel for the project |         |       | 0:14 |   2.3 |
| Setup vcpkg and cmake                   |         |       | 1:21 |  13.2 |
| Setup github actions                    |         |       | 1:21 |  13.2 |
| Create and upload a package             |         |       | 3:28 |  33.9 |
| Create a basic project structure        |         |       | 2:10 |  21.2 |
| Add a Qt hello world                    |         |       | 0:46 |   7.5 |
| Add nightly support with memcheck       |         |       | 0:04 |   0.7 |
#+end:
