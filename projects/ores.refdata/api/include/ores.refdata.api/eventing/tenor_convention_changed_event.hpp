 ...
 *
 */
#ifndef ORES_REFDATA_API_EVENTING_TENOR_CONVENTION_CHANGED_EVENT_HPP
#define ORES_REFDATA_API_EVENTING_TENOR_CONVENTION_CHANGED_EVENT_HPP
 ...
 */
template <>
struct event_traits<ores::refdata::eventing::tenor_convention_changed_event> {
    static constexpr std::string_view name = "ores.refdata.tenor_convention_changed";
};
