...
#+CAPTION: Clock summary at [2024-06-23 Sun 10:29]
| <75>                                    |         |       |      |       |
| Headline                                | Time    |       |      |     % |
|-----------------------------------------+---------+-------+------+-------|
| *Total time*                            | *12:22* |       |      | 100.0 |
|-----------------------------------------+---------+-------+------+-------|
| Stories                                 | 12:22   |       |      | 100.0 |
| Active                                  |         | 12:22 |      | 100.0 |
| Sprint and product backlog refinement   |         |       | 0:14 |   1.9 |
| Create a basic git hub repository       |         |       | 0:35 |   4.7 |
| Setup a discord channel for the project |         |       | 0:14 |   1.9 |
| Setup vcpkg and cmake                   |         |       | 1:21 |  10.9 |
| Setup github actions                    |         |       | 1:21 |  10.9 |
| Create and upload a package             |         |       | 3:28 |  28.0 |
| Create a basic project structure        |         |       | 2:10 |  17.5 |
| Add a Qt hello world                    |         |       | 2:55 |  23.6 |
