...
values
    (ores_utility_system_tenant_id_fn(), 'LEI', 0, 'Legal Entity Identifier',
    ...
    (ores_utility_system_tenant_id_fn(), 'BIC', 0, 'Business Identifier Code',
    ...
    (ores_utility_system_tenant_id_fn(), 'MIC', 0, 'Market Identifier Code',
    ...
    (ores_utility_system_tenant_id_fn(), 'NATIONAL_ID', 0, 'National Identifier',
    ...
    (ores_utility_system_tenant_id_fn(), 'CEDB', 0, 'CFTC Entity Directory',
    ...
    (ores_utility_system_tenant_id_fn(), 'NATURAL_PERSON', 0, 'Natural Person',
    ...
    (ores_utility_system_tenant_id_fn(), 'ACER', 0, 'EU Agency for Energy Regulation',
    ...
    (ores_utility_system_tenant_id_fn(), 'DTCC_PARTICIPANT_ID', 0, 'DTCC Participant ID',
    ...
    (ores_utility_system_tenant_id_fn(), 'MPID', 0, 'Market Participant ID',
