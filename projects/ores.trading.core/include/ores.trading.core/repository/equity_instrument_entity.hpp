 ...
 *
 */
#ifndef ORES_TRADING_REPOSITORY_EQUITY_INSTRUMENT_ENTITY_HPP
#define ORES_TRADING_REPOSITORY_EQUITY_INSTRUMENT_ENTITY_HPP
...
/**
 * @brief Represents an equity instrument in the database.
 */
struct equity_instrument_entity {
    constexpr static const char* schema = "public";
    constexpr static const char* tablename = "ores_trading_equity_instruments_tbl";
    ...
    std::optional<std::string> cliquet_frequency_code;
...
std::ostream& operator<<(std::ostream& s, const equity_instrument_entity& v);
