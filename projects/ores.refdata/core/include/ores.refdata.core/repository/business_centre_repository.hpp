...
public:
    ...
    /**
     * @brief Writes a business centre, honouring the claim it states.
     *
    ...
    /**
     * @brief Writes a set of business centres, each honouring its own
    ...
    /**
     * @brief Reads latest business centres, possibly filtered by primary key.
     */
    /**@{*/
    ...
    /**
     * @brief Removes a business centre, refusing a row that moved on.
     *
...
private:
     ...
     */
    domain::business_centre apply_claim(context ctx,
                                        const domain::business_centre& v,
                                        const ores::utility::domain::precondition& claim);
};
