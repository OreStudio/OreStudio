...
select ores.upsert_dq_image_tags_artefact('Country Flags from lipis/flag-icons');

-- =============================================================================
-- Cleanup
-- =============================================================================

drop function ores.upsert_dq_image_tags_artefact(text);

-- =============================================================================
-- Summary
-- =============================================================================

select 'dq_image_tags_artefact' as entity, count(*) as count
from ores.dq_image_tags_artefact_tbl;
