...
public:
    ...
    list_rounding_types(const messaging::list_rounding_types_request& request);
    messaging::get_rounding_type_response
    get_rounding_type(const messaging::get_rounding_type_request& request);
    messaging::get_many_rounding_types_response
    get_many_rounding_types(const messaging::get_many_rounding_types_request& request);
    messaging::put_rounding_type_response
    put_rounding_type(const messaging::put_rounding_type_request& request);
    messaging::put_many_rounding_types_response
    put_many_rounding_types(const messaging::put_many_rounding_types_request& request);
    messaging::delete_rounding_type_response
    delete_rounding_type(const messaging::delete_rounding_type_request& request);
    messaging::delete_many_rounding_types_response
    delete_many_rounding_types(const messaging::delete_many_rounding_types_request& request);
    messaging::list_rounding_type_versions_response
    list_rounding_type_versions(const messaging::list_rounding_type_versions_request& request);
    messaging::get_rounding_type_version_response
    get_rounding_type_version(const messaging::get_rounding_type_version_request& request);
    /**@}*/
    ...
    /**
     * @brief Retrieves a batch of rounding types by primary key.
     */
    std::vector<domain::rounding_type> get_types(const std::vector<std::string>& codes);
...
private:
     ...
     */
    ores::utility::domain::result prepare_change(const messaging::rounding_type_change& change,
