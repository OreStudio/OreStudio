...
void ReportTypeController::showListWindow() {
    ...
    listMdiSubWindow_->setWindowIcon(
        IconUtils::createRecoloredIcon(Icon::FileBarChart, IconUtils::DefaultIconColor));
...
void ReportTypeController::wireDetailDialogCommon(ReportTypeDetailDialog* detailDialog) {
...
void ReportTypeController::showHistoryWindow(const QString& code) {
    ...
    auto* historyDialog =
        new HistoryDialog(std::string(entity_type_of(reporting::domain::report_type{})),
                          code.toStdString(),
                          clientManager_,
                          mainWindow_);
    ...
    connect(historyDialog,
            ...
            this,
            [self = QPointer<ReportTypeController>(this)](
...
void ReportTypeController::fetchReportTypeHistory(
    ...
    using FetchResult = std::expected<std::vector<reporting::domain::report_type>, QString>;
...
void ReportTypeController::onOpenHistoryVersion(const QString& entityId, int versionNumber) {
    QPointer<ReportTypeController> self = this;
    fetchReportTypeHistory(
        entityId,
        [self, entityId, versionNumber](
            std::expected<std::vector<reporting::domain::report_type>, QString> result) {
            if (!self)
                return;
            if (!result) {
...
void ReportTypeController::onRevertHistoryVersion(const QString& entityId, int versionNumber) {
    QPointer<ReportTypeController> self = this;
    fetchReportTypeHistory(
        entityId,
        [self, entityId, versionNumber](
...
void ReportTypeController::notifyOpenDialogs(const QStringList& entityIds) {
