...
| [[id:87C25143-65CC-4568-95D9-11127B160DAA][Manage trading entities from the shell]] | BACKLOG | | | Minimal per-entity ores.shell trading verbs - list, get, add, delete and history over trade_type, party_role_type, trade_id_type, lifecycle_event and trade - built as codegen-ready per-entity command units in a per-component folder, so the ores.trading bind post-merge system test can run without a UI. |
