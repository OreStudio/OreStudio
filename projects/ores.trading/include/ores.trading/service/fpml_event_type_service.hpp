...
#include "ores.trading/domain/fpml_event_type.hpp"
#include "ores.trading/repository/fpml_event_type_repository.hpp"

namespace ores::trading::service {

/**
 * @brief Service for managing FpML event types.
 */
class fpml_event_type_service {
private:
...
public:
    ...
    explicit fpml_event_type_service(context ctx);
    ...
    void save_types(const std::vector<domain::fpml_event_type>& v);

    void remove_type(const std::string& code);

    /**
     * @brief Removes multiple FpML event types.
     */
...
private:
    context ctx_;
    repository::fpml_event_type_repository repo_;
};
