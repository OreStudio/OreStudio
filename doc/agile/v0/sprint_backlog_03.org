...
#+CAPTION: Clock summary at [2025-11-02 Sun 12:37], for Sunday, November 02, 2025.
|      | <75>                  |        |      |      |       |
| Tags | Headline              | Time   |      |      |     % |
|------+-----------------------+--------+------+------+-------|
...
|      | Stories               | 3:06   |      |      | 100.0 |
|      | Active                |        | 3:06 |      | 100.0 |
| code | Improve code coverage |        |      | 3:06 | 100.0 |
#+end:

#+begin: clocktable :maxlevel 3 :scope subtree :tags t :indent nil :emphasize nil :scope file :narrow 75 :formula %
#+TBLNAME: sprint_summary
#+CAPTION: Clock summary at [2025-11-02 Sun 12:37]
|       | <75>                                                   |         |       |       |       |
| Tags  | Headline                                               | Time    |       |       |     % |
|-------+--------------------------------------------------------+---------+-------+-------+-------|
...
| code  | Build using dynamic libraries                          |         |       |  7:24 |  13.3 |
| code  | Enable qt gui                                          |         |       |  4:13 |   7.6 |
| code  | Add locking up logic                                   |         |       |  1:28 |   2.6 |
| code  | Build using dynamic libraries                          |         |       |  7:24 |  13.3 |
| code  | Implement logging according to correct boost.log usage |         |       |  8:02 |  14.5 |
| code  | Fix broken Linux and OSX tests                         |         |       |  0:10 |   0.3 |
| code  | Fix broken windows builds                              |         |       |  2:35 |   4.7 |
| code  | Investigate leaks from valgrind                        |         |       |  0:51 |   1.5 |
| code  | Consider adding a postgres database to CI              |         |       | 14:13 |  25.6 |
| code  | Fix misspell that causes build to break                |         |       |  0:12 |   0.4 |
| code  | Add support for feature flags                          |         |       |  1:25 |   2.6 |
| code  | Implement authentication bootstrap workflow            |         |       |  0:25 |   0.8 |
| code  | Improve code coverage                                  |         |       |  3:06 |   5.6 |
| code  | Add workspace as a container                           |         |       |  1:13 |   2.2 |
#+end:
