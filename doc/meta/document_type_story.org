...
- Required sections (in this order) ::
  ...
  - =* Documents= — /optional; required once the story produces any
    document beyond its own tasks./ A table naming every document the
    story produced or reasons from, with its kind and purpose. Durable
    documents deliberately do not link back to the story, so this table
    is the only way in when the history is genuinely needed. See
    [[id:7ADECB4C-3C03-4B8D-BB2F-A9753EFDA866][design]] § "The story is the hub".
