...
public:
    ...
    /**
     * @brief Writes a ledger feed type, honouring the claim it states.
     *
    ...
    /**
     * @brief Writes a set of ledger feed types, each honouring its own
    ...
    /**
     * @brief Reads latest ledger feed types, possibly filtered by primary key.
     */
    /**@{*/
    ...
    /**
     * @brief Removes a ledger feed type, refusing a row that moved on.
     *
...
private:
     ...
     */
    domain::ledger_feed_type apply_claim(context ctx,
                                         const domain::ledger_feed_type& v,
                                         const ores::utility::domain::precondition& claim);
};
