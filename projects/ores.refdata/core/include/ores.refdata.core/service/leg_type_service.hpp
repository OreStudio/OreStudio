...
public:
    ...
    list_leg_types(const messaging::list_leg_types_request& request);
    messaging::get_leg_type_response get_leg_type(const messaging::get_leg_type_request& request);
    messaging::get_many_leg_types_response
    get_many_leg_types(const messaging::get_many_leg_types_request& request);
    messaging::put_leg_type_response put_leg_type(const messaging::put_leg_type_request& request);
    messaging::put_many_leg_types_response
    put_many_leg_types(const messaging::put_many_leg_types_request& request);
    messaging::delete_leg_type_response
    delete_leg_type(const messaging::delete_leg_type_request& request);
    messaging::delete_many_leg_types_response
    delete_many_leg_types(const messaging::delete_many_leg_types_request& request);
    messaging::list_leg_type_versions_response
    list_leg_type_versions(const messaging::list_leg_type_versions_request& request);
    messaging::get_leg_type_version_response
    get_leg_type_version(const messaging::get_leg_type_version_request& request);
    /**@}*/
    ...
    /**
     * @brief Retrieves a single leg type by its primary key.
     *
    ...
    /**
     * @brief Retrieves a batch of leg types by primary key.
     */
    std::vector<domain::leg_type> get_types(const std::vector<std::string>& codes);
    ...
    /**
     * @brief Deletes a leg type by its primary key.
     *
     * @throws std::exception on failure.
     */
    ...
    /**
     * @brief Deletes leg types by their primary keys.
     */
...
private:
     ...
     */
    ores::utility::domain::result prepare_change(const messaging::leg_type_change& change,
