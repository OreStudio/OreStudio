...
namespace {
std::string crm_topology_config_key_extractor(const marketdata::domain::crm_topology_config& e) {
    return e.name;
}
}
    ...
    QFuture<FetchResult> future = QtConcurrent::run([self, offset, limit]() -> FetchResult {
        return exception_helper::wrap_async_fetch<FetchResult>(
            [&]() -> FetchResult {
                ...
                marketdata::messaging::get_crm_topology_configs_request request;
...
const marketdata::domain::crm_topology_config*
ClientCrmTopologyConfigModel::getConfig(int row) const {
