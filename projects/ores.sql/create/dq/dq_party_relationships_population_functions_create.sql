 ...
 *   SELECT * FROM metadata.dq_preview_party_relationship_population(dataset_id);
 *
 ...
 */
create or replace function metadata.dq_preview_party_relationship_population(p_dataset_id uuid)
returns table (
    action text,
    code text,
