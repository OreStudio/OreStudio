...
domain::ois_convention ois_convention_mapper::map(const ois_convention_entity& v) {
...
ois_convention_entity ois_convention_mapper::map(const domain::ois_convention& v) {
