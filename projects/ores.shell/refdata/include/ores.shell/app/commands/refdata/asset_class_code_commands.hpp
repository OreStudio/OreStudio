 ...
 */
#ifndef ORES_SHELL_APP_COMMANDS_ASSET_CLASS_CODE_COMMANDS_HPP
#define ORES_SHELL_APP_COMMANDS_ASSET_CLASS_CODE_COMMANDS_HPP
...
/**
 * @brief Every verb asset class codes answer, as one command each.
 *
 ...
 */
class asset_class_code_commands {
private:
    inline static std::string_view logger_name =
        "ores.shell.app.commands.refdata.asset_class_code_commands";
...
public:
    /**
     * @brief Register the asset class codes submenu.
     */
