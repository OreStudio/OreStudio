...
void BusinessDayConventionTypeHistoryDialog::setupConnections() {
    connect(ui_->versionListWidget, &QTableWidget::itemSelectionChanged,
            this, &BusinessDayConventionTypeHistoryDialog::onVersionSelected);
    connect(openVersionAction_, &QAction::triggered,
            this, &BusinessDayConventionTypeHistoryDialog::onOpenVersionClicked);
    connect(revertAction_, &QAction::triggered,
            this, &BusinessDayConventionTypeHistoryDialog::onRevertClicked);
...
void BusinessDayConventionTypeHistoryDialog::loadHistory() {
    ...
    BOOST_LOG_SEV(lg(), debug) << "Loading history for business day convention type: " << code_.toStdString();
