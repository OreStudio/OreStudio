...
With 9 entities today and the [[id:A3F8C2D1-7E4B-4F9A-B2C5-8D1E6A3F0B7C][entity coverage matrix]] showing dozens more to be
...
Add a new header [[proj:projects/ores.cli/include/ores.cli/config/domain.hpp][=projects/ores.cli/include/ores.cli/config/domain.hpp=]] to
...
Files:
- [[proj:projects/ores.cli/include/ores.cli/config/domain.hpp][=projects/ores.cli/include/ores.cli/config/domain.hpp=]] (new)
- [[proj:projects/ores.cli/include/ores.cli/config/ores.cli.config.hpp][=projects/ores.cli/include/ores.cli/config/ores.cli.config.hpp=]] (add include)

* Phase 2: Add Domain-Level Parser Helpers

Add [[proj:projects/ores.cli/include/ores.cli/config/domain_parsers][=projects/ores.cli/include/ores.cli/config/domain_parsers/=]] and the
...
[[proj:projects/ores.cli/CMakeLists.txt][=projects/ores.cli/CMakeLists.txt=]].

Files:
- [[proj:projects/ores.cli/CMakeLists.txt][=projects/ores.cli/CMakeLists.txt=]] (add 4 new =.cpp= sources)
...
Files:
- [[proj:projects/ores.cli/tests/parser_tests.cpp][=projects/ores.cli/tests/parser_tests.cpp=]]
...
- Requires the entity coverage matrix ([[proj:doc/analysis/entity_coverage_matrix.org][=doc/analysis/entity_coverage_matrix.org=]])
