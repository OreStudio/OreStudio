...
read_one(repository::pricing_model_product_parameter_repository& repo,
         const ores::database::context& ctx,
         const messaging::pricing_model_product_parameter_key& key) {
    return repo.read_latest_by_parameter_name(ctx, key.parameter_name);
}
 ...
 */
messaging::pricing_model_product_parameter_key
key_from(const domain::pricing_model_product_parameter& v) {
    messaging::pricing_model_product_parameter_key key;
    key.parameter_name = v.parameter_name;
    return key;
}
...
to_domain(const messaging::pricing_model_product_parameter_write& write) {
    domain::pricing_model_product_parameter v;
    v.id = write.id;
    v.pricing_model_config_id = write.pricing_model_config_id;
    v.pricing_model_product_id = write.pricing_model_product_id;
...
pricing_model_product_parameter_service::list_pricing_model_product_parameters(
    ...
    messaging::list_pricing_model_product_parameters_response response;
...
messaging::get_pricing_model_product_parameter_response
pricing_model_product_parameter_service::get_pricing_model_product_parameter(
    const messaging::get_pricing_model_product_parameter_request& request) {
    messaging::get_pricing_model_product_parameter_response response;
    ...
    response.pricing_model_product_parameter = std::move(found.front());
    return response;
}

messaging::get_many_pricing_model_product_parameters_response
pricing_model_product_parameter_service::get_many_pricing_model_product_parameters(
    const messaging::get_many_pricing_model_product_parameters_request& request) {
    messaging::get_many_pricing_model_product_parameters_response response;
    // One entry per requested key, in the order asked for, so the reply is
    // positional and a caller reads absence from an empty entry rather than
    // from a missing one.
    response.entries.reserve(request.keys.size());
    for (const auto& k : request.keys) {
        messaging::pricing_model_product_parameter_lookup entry;
        entry.key = k;
        auto found = read_one(repo_, ctx_, k);
        if (!found.empty())
            entry.pricing_model_product_parameter = std::move(found.front());
        response.entries.push_back(std::move(entry));
    }
    return response;
}

messaging::put_pricing_model_product_parameter_response
pricing_model_product_parameter_service::put_pricing_model_product_parameter(
    const messaging::put_pricing_model_product_parameter_request& request) {
    messaging::put_pricing_model_product_parameter_response response;
    domain::pricing_model_product_parameter value;
    ...
    if (!written.empty())
        response.pricing_model_product_parameter = std::move(written.front());
    return response;
}

messaging::put_many_pricing_model_product_parameters_response
pricing_model_product_parameter_service::put_many_pricing_model_product_parameters(
    const messaging::put_many_pricing_model_product_parameters_request& request) {
    messaging::put_many_pricing_model_product_parameters_response response;
    std::vector<domain::pricing_model_product_parameter> batch;
    ...
    response.parameters.reserve(batch.size());
    for (const auto& value : batch) {
        auto written = read_one(repo_, ctx_, key_from(value));
        response.parameters.push_back(written.empty() ? value : std::move(written.front()));
    }
    return response;
}

messaging::delete_pricing_model_product_parameter_response
pricing_model_product_parameter_service::delete_pricing_model_product_parameter(
    const messaging::delete_pricing_model_product_parameter_request& request) {
    messaging::delete_pricing_model_product_parameter_response response;
    ...
    switch (repo_.remove(ctx_, boost::uuids::to_string(row.id), expected)) {
        case repository::pricing_model_product_parameter_repository::remove_status::removed:
            break;
        case repository::pricing_model_product_parameter_repository::remove_status::missing:
            response.result.outcome = outcome::missing;
            response.result.code = "not_found";
            break;
        case repository::pricing_model_product_parameter_repository::remove_status::conflicting:
            response.result.outcome = outcome::conflict;
            response.result.code = "version_conflict";
            break;
        case repository::pricing_model_product_parameter_repository::remove_status::unsupported:
            response.result.outcome = outcome::invalid;
            response.result.code = "precondition_not_supported";
...
pricing_model_product_parameter_service::delete_many_pricing_model_product_parameters(
    const messaging::delete_many_pricing_model_product_parameters_request& request) {
    messaging::delete_many_pricing_model_product_parameters_response response;
    using ores::utility::domain::outcome;
    using ores::utility::domain::precondition_kind;
    ...
    // failure.
    std::vector<domain::pricing_model_product_parameter> resolved;
...
pricing_model_product_parameter_service::list_pricing_model_product_parameter_versions(
    const messaging::list_pricing_model_product_parameter_versions_request& request) {
    messaging::list_pricing_model_product_parameter_versions_response response;
    if (!request.order.field.empty() || request.order.descending) {
        response.result.outcome = ores::utility::domain::outcome::invalid;
        response.result.code = "order_not_supported";
        response.result.message =
...
pricing_model_product_parameter_service::get_pricing_model_product_parameter_version(
    const messaging::get_pricing_model_product_parameter_version_request& request) {
    messaging::get_pricing_model_product_parameter_version_response response;
    ...
    const auto named = read_one(repo_, ctx_, request.key.pricing_model_product_parameter);
    if (named.empty()) {
        response.result.outcome = ores::utility::domain::outcome::missing;
        response.result.code = "not_found";
        return response;
...
ores::utility::domain::result pricing_model_product_parameter_service::prepare_change(
    const messaging::pricing_model_product_parameter_change& change,
...
pricing_model_product_parameter_service::get_parameter_at_version(const boost::uuids::uuid& id,
...
std::optional<domain::pricing_model_product_parameter>
pricing_model_product_parameter_service::get_parameter(const boost::uuids::uuid& id) {
...
std::optional<domain::pricing_model_product_parameter>
pricing_model_product_parameter_service::get_parameter_by_parameter_name(
    const std::string& parameter_name) {
    BOOST_LOG_SEV(lg(), debug) << "Getting pricing model product parameter by parameter_name: "
                               << parameter_name;
    messaging::pricing_model_product_parameter_key k;
    k.parameter_name = parameter_name;
    auto found = read_one(repo_, ctx_, k);
    if (found.empty())
        return std::nullopt;
    return found.front();
...
std::vector<domain::pricing_model_product_parameter>
pricing_model_product_parameter_service::get_parameters(const std::vector<std::string>& ids) {
...
void pricing_model_product_parameter_service::delete_parameter(const boost::uuids::uuid& id) {
...
std::vector<domain::pricing_model_product_parameter>
pricing_model_product_parameter_service::get_parameter_history(const std::string& key) {
    BOOST_LOG_SEV(lg(), debug) << "Getting history for pricing model product parameter. key: "
                               << key;
    ...
    const auto found = repo_.read_any_by_parameter_name(ctx_, k.parameter_name);
    if (found.empty())
        return {};
