...
#+CAPTION: Clock summary at [2026-01-06 Tue 01:33], for Tuesday, January 06, 2026.
|      | <75>                |        |      |      |       |
| Tags | Headline            | Time   |      |      |     % |
|------+---------------------+--------+------+------+-------|
...
|      | Stories             | 1:32   |      |      | 100.0 |
|      | Active              |        | 1:32 |      | 100.0 |
| code | Review HTTP service |        |      | 1:32 | 100.0 |
#+end:

#+begin: clocktable :maxlevel 3 :scope subtree :tags t :indent nil :emphasize nil :scope file :narrow 75 :formula %
#+TBLNAME: sprint_summary
#+CAPTION: Clock summary at [2026-01-06 Tue 01:32]
|       | <75>                                        |         |       |      |       |
| Tags  | Headline                                    | Time    |       |      |     % |
|-------+---------------------------------------------+---------+-------+------+-------|
...
|       | Stories                                     | 22:49   |       |      | 100.0 |
|       | Active                                      |         | 22:49 |      | 100.0 |
| agile | Sprint and product backlog refinement       |         |       | 1:17 |   5.6 |
| code  | Rerun SQL scripts from scratch              |         |       | 7:52 |  34.5 |
| code  | Run qt client and validate all new features |         |       | 1:19 |   5.8 |
| code  | Refactor options and parser                 |         |       | 0:27 |   2.0 |
| code  | Check functionality in =ores.wt=            |         |       | 2:03 |   9.0 |
| code  | Rename =ores.shell= to =ores.comms.shell=   |         |       | 1:30 |   6.6 |
| code  | Review HTTP service                         |         |       | 5:46 |  25.3 |
| code  | Assorted fixes to currency dialog           |         |       | 2:35 |  11.3 |
#+end:
...
*** STARTED Review HTTP service                                        :code:
    :LOGBOOK:
