...
/**
 * @brief Model for displaying contact types fetched from the server.
 *
 * This model extends QAbstractTableModel and fetches contact type
 * data asynchronously using the ores.comms client.
 */
class ClientContactTypeModel final : public QAbstractTableModel {
    Q_OBJECT
...
public:
    ...
    /**
     * @brief Default window size for the contact type list window.
     */
     ...
     */
    static constexpr std::string_view kSettingsGroup = "ContactTypeListWindow";
    /**
    ...
    /**
     * @brief Get contact type at the specified row.
     *
     * @param row The row index.
     * @return The contact type, or nullptr if row is invalid.
     */
    const refdata::domain::contact_type* getType(int row) const;
...
private:
    ...
    struct FetchResult {
        bool success;
        std::vector<refdata::domain::contact_type> types;
        QString error_message;
        QString error_details;
    };

    ClientManager* clientManager_;
    std::vector<refdata::domain::contact_type> types_;
