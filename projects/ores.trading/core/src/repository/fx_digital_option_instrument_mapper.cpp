...
std::vector<domain::fx_digital_option_instrument> fx_digital_option_instrument_mapper::map(
    const std::vector<fx_digital_option_instrument_entity>& v) {
    return map_vector<fx_digital_option_instrument_entity, domain::fx_digital_option_instrument>(
        v, [](const auto& ve) { return map(ve); }, lg(), "db entities");
}

std::vector<fx_digital_option_instrument_entity> fx_digital_option_instrument_mapper::map(
    const std::vector<domain::fx_digital_option_instrument>& v) {
