 ...
 *
 */
#ifndef ORES_IAM_EVENTING_CHANGE_REASON_CHANGED_EVENT_HPP
#define ORES_IAM_EVENTING_CHANGE_REASON_CHANGED_EVENT_HPP
 ...
 */
template<>
struct event_traits<ores::iam::eventing::change_reason_changed_event> {
