...
domain::bond_trs bond_trs_mapper::map(const bond_trs_entity& v) {
...
bond_trs_entity bond_trs_mapper::map(const domain::bond_trs& v) {
...
std::vector<domain::bond_trs> bond_trs_mapper::map(const std::vector<bond_trs_entity>& v) {
    return map_vector<bond_trs_entity, domain::bond_trs>(
        v, [](const auto& ve) { return map(ve); }, lg(), "db entities");
}

std::vector<bond_trs_entity> bond_trs_mapper::map(const std::vector<domain::bond_trs>& v) {
    return map_vector<domain::bond_trs, bond_trs_entity>(
