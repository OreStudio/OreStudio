...
compass review list, reply and resolve all work correctly when the automated reviewer is the Claude bot (issue-level comments) rather than a human reviewer (GitHub review threads). The compass-pr-address-review skill and runbook reflect the updated behaviour.
