...
#+description: Codegen entity model for the trading =trade_identifier= table. Drives the C++ domain class, mapper, repository, service, generator, and SQL schema generation from a single literate source.
