...
#+CAPTION: Clock summary at [2026-01-07 Wed 23:20], for Wednesday, January 07, 2026.
|      | <75>                                  |        |      |      |       |
| Tags | Headline                              | Time   |      |      |     % |
|------+---------------------------------------+--------+------+------+-------|
...
|      | Stories                               | 9:39   |      |      | 100.0 |
|      | Active                                |        | 9:39 |      | 100.0 |
| code | Add support for offsets in pagination |        |      | 1:46 |  18.3 |
| code | Assorted fixes to currencies dialog   |        |      | 1:50 |  19.0 |
| code | Add country support                   |        |      | 1:37 |  16.8 |
| code | Review telemetry work                 |        |      | 4:26 |  45.9 |
#+end:

#+begin: clocktable :maxlevel 3 :scope subtree :tags t :indent nil :emphasize nil :scope file :narrow 75 :formula %
#+TBLNAME: sprint_summary
#+CAPTION: Clock summary at [2026-01-07 Wed 23:20]
|       | <75>                                        |         |       |       |       |
| Tags  | Headline                                    | Time    |       |       |     % |
|-------+---------------------------------------------+---------+-------+-------+-------|
|       | *Total time*                                | *42:02* |       |       | 100.0 |
|-------+---------------------------------------------+---------+-------+-------+-------|
|       | Stories                                     | 42:02   |       |       | 100.0 |
|       | Active                                      |         | 42:02 |       | 100.0 |
| agile | Sprint and product backlog refinement       |         |       |  1:17 |   3.1 |
| code  | Rerun SQL scripts from scratch              |         |       |  7:52 |  18.7 |
| code  | Run qt client and validate all new features |         |       |  1:19 |   3.1 |
| code  | Refactor options and parser                 |         |       |  0:27 |   1.1 |
| code  | Check functionality in =ores.wt=            |         |       |  2:03 |   4.9 |
| code  | Rename =ores.shell= to =ores.comms.shell=   |         |       |  1:30 |   3.6 |
| code  | Review HTTP service                         |         |       |  7:24 |  17.6 |
| code  | Assorted fixes to currency dialog           |         |       |  4:19 |  10.3 |
| code  | Add support for offsets in pagination       |         |       |  1:46 |   4.2 |
| code  | Assorted fixes to currencies dialog         |         |       |  1:50 |   4.4 |
| code  | Add country support                         |         |       |  1:37 |   3.8 |
| code  | Review comms analyser work                  |         |       |  0:27 |   1.1 |
| code  | Review telemetry work                       |         |       | 10:11 |  24.2 |
#+end:
