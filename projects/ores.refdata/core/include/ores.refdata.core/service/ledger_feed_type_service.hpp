...
public:
     ...
     */
    /**@{*/
    messaging::list_ledger_feed_types_response
    list_ledger_feed_types(const messaging::list_ledger_feed_types_request& request);
    messaging::get_ledger_feed_type_response
    get_ledger_feed_type(const messaging::get_ledger_feed_type_request& request);
    messaging::get_many_ledger_feed_types_response
    get_many_ledger_feed_types(const messaging::get_many_ledger_feed_types_request& request);
    messaging::put_ledger_feed_type_response
    put_ledger_feed_type(const messaging::put_ledger_feed_type_request& request);
    messaging::put_many_ledger_feed_types_response
    put_many_ledger_feed_types(const messaging::put_many_ledger_feed_types_request& request);
    messaging::delete_ledger_feed_type_response
    delete_ledger_feed_type(const messaging::delete_ledger_feed_type_request& request);
    messaging::delete_many_ledger_feed_types_response
    delete_many_ledger_feed_types(const messaging::delete_many_ledger_feed_types_request& request);
    messaging::list_ledger_feed_type_versions_response list_ledger_feed_type_versions(
        const messaging::list_ledger_feed_type_versions_request& request);
    messaging::get_ledger_feed_type_version_response
    get_ledger_feed_type_version(const messaging::get_ledger_feed_type_version_request& request);
    /**@}*/
    ...
    /**
     * @brief Retrieves a single ledger feed type by its primary key.
     *
    ...
    /**
     * @brief Retrieves a batch of ledger feed types by primary key.
     */
    std::vector<domain::ledger_feed_type> get_types(const std::vector<std::string>& codes);
    ...
    /**
     * @brief Deletes a ledger feed type by its primary key.
     *
     * @throws std::exception on failure.
     */
    ...
    /**
     * @brief Deletes ledger feed types by their primary keys.
     */
...
private:
     ...
     */
    ores::utility::domain::result prepare_change(const messaging::ledger_feed_type_change& change,
