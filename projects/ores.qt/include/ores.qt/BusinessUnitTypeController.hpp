...
private:
    inline static std::string_view logger_name =
        "ores.qt.business_unit_type_controller";
...
private slots:
    void onShowDetails(const refdata::domain::business_unit_type& type);
    void onAddNewRequested();
    void onShowHistory(const refdata::domain::business_unit_type& type);
    void onRevertVersion(const refdata::domain::business_unit_type& type);
    void onOpenVersion(const refdata::domain::business_unit_type& type,
                       int versionNumber);

private:
    void showAddWindow();
    void showDetailWindow(const refdata::domain::business_unit_type& type);
    void showHistoryWindow(const refdata::domain::business_unit_type& type);
