...
/**
 * @brief Controller for managing data domain windows and operations.
 *
 * Manages the lifecycle of data domain list, detail, and history windows.
...
private:
    inline static std::string_view logger_name = "ores.qt.data_domain_controller";
...
public:
    DataDomainController(QMainWindow* mainWindow,
                         QMdiArea* mdiArea,
