 ...
 */
/**
 * Where the series_subclass_code screens live and what they can do.
 *
 ...
 */
import { seriesSubclassCodeMeta } from '../ui/series_subclass_code_ui.js';
import type { EntityDescriptor } from '../../../entity/descriptor.js';

export const seriesSubclassCodeDescriptor: EntityDescriptor = {
    component: 'refdata',
    entity: 'series_subclass_code',
    meta: seriesSubclassCodeMeta,
    routeSegment: 'series-subclass-code',
    apiBase: '/api/subclasses',
    keyParam: 'id',
    icon: 'classification',
    capabilities: {
        create: true,
