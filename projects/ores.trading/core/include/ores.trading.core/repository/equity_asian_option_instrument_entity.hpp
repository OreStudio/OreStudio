 ...
 *
 */
#ifndef ORES_TRADING_CORE_REPOSITORY_EQUITY_ASIAN_OPTION_INSTRUMENT_ENTITY_HPP
#define ORES_TRADING_CORE_REPOSITORY_EQUITY_ASIAN_OPTION_INSTRUMENT_ENTITY_HPP
...
/**
 * @brief Represents a equity asian option instrument in the database.
 */
