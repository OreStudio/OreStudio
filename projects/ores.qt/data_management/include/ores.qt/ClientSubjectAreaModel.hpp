...
public:
    enum Column { Name, DomainName, Description, Version, ModifiedBy, RecordedAt, ColumnCount };
    ...
    static constexpr std::array<ColumnMetadata, kColumnCount> kColumns = {
        {{.column = Name,
         ...
         {.column = DomainName,
          .header = std::string_view("Domain Name"),
          .style = column_style::text_left,
          .hidden_by_default = false,
          .default_width = kColumnWidthAuto},
         {.column = Description,
    ...
    /**
     * @brief Default window size for the subject area list window.
     */
     ...
     */
    static constexpr std::string_view kSettingsGroup = "SubjectAreaMdiWindow";
    /**
