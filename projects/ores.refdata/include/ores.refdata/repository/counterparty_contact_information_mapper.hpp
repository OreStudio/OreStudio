 ...
 *
 */
#ifndef ORES_REFDATA_REPOSITORY_COUNTERPARTY_CONTACT_INFORMATION_MAPPER_HPP
#define ORES_REFDATA_REPOSITORY_COUNTERPARTY_CONTACT_INFORMATION_MAPPER_HPP
...
public:
    ...
    static std::vector<counterparty_contact_information_entity>
    map(const std::vector<domain::counterparty_contact_information>& v);
};
