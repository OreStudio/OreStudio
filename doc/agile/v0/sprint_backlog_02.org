...
#+CAPTION: Clock summary at [2025-09-27 Sat 10:33], for Saturday, September 27, 2025.
|      | <75>                                         |        |      |      |       |
| Tags | Headline                                     | Time   |      |      |     % |
|------+----------------------------------------------+--------+------+------+-------|
...
|      | Stories                                      | 1:33   |      |      | 100.0 |
|      | Active                                       |        | 1:33 |      | 100.0 |
| code | Refactor cli to follow new project structure |        |      | 1:33 | 100.0 |
#+end:

#+begin: clocktable :maxlevel 3 :scope subtree :tags t :indent nil :emphasize nil :scope file :narrow 75 :formula %
#+TBLNAME: sprint_summary
#+CAPTION: Clock summary at [2025-09-27 Sat 10:33]
|          | <75>                                               |         |       |      |       |
| Tags     | Headline                                           | Time    |       |      |     % |
|----------+----------------------------------------------------+---------+-------+------+-------|
|          | *Total time*                                       | *51:06* |       |      | 100.0 |
|----------+----------------------------------------------------+---------+-------+------+-------|
|          | Stories                                            | 51:06   |       |      | 100.0 |
|          | Active                                             |         | 51:06 |      | 100.0 |
...
| code     | Add command to dump currencies                     |         |       | 4:18 |   8.4 |
| code     | Refactor code for currencies                       |         |       | 3:52 |   7.6 |
| code     | Restore qt setup                                   |         |       | 2:20 |   4.6 |
| code     | Add gemini action                                  |         |       | 0:05 |   0.2 |
| code     | Remove ImGui support                               |         |       | 0:08 |   0.3 |
| code     | Create a GRPC based service                        |         |       | 2:09 |   4.2 |
| code     | Implement a 0MQ based RPC service and client       |         |       | 3:55 |   7.7 |
...
| code     | Add serialisation support for reflect-cpp          |         |       | 3:07 |   6.1 |
| analysis | White-boarding for new architecture                |         |       | 1:52 |   3.7 |
| code     | Use sqlgen for postgres                            |         |       | 7:23 |  14.4 |
| code     | Refactor cli to follow new project structure       |         |       | 4:47 |   9.4 |
