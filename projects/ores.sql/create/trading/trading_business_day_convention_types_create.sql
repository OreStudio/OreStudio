...
create unique index if not exists ores_trading_business_day_convention_types_version_uniq_idx
on "ores_trading_business_day_convention_types_tbl" (tenant_id, code, version)
where valid_to = ores_utility_infinity_timestamp_fn();

create unique index if not exists ores_trading_business_day_convention_types_code_uniq_idx
on "ores_trading_business_day_convention_types_tbl" (tenant_id, code)
where valid_to = ores_utility_infinity_timestamp_fn();

create index if not exists ores_trading_business_day_convention_types_tenant_idx
