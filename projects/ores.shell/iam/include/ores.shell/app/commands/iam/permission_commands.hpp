 ...
 */
#ifndef ORES_SHELL_APP_COMMANDS_PERMISSION_COMMANDS_HPP
#define ORES_SHELL_APP_COMMANDS_PERMISSION_COMMANDS_HPP
...
/**
 * @brief Every verb permissions answer, as one command each.
 *
...
private:
    inline static std::string_view logger_name = "ores.shell.app.commands.iam.permission_commands";
...
public:
    /**
     * @brief Register the permissions submenu.
     */
    ...
    /**
     * @brief add <id> <code> <description> <reason> <commentary>
     */
    ...
    /**
     * @brief set <id> <code> <description> <reason> <commentary> [--version <n>]
     */
    ...
    /**
     * @brief put-many --count <n> <id> <code> <description> <reason> <commentary>
     */
