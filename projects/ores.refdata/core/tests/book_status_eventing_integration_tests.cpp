...
TEST_CASE("write_book_status_publishes_an_event", tags) {
    ...
    using event_type = ores::refdata::messaging::book_status_event;
    ...
    event_source.register_entity_event_mapping<event_type>("ores_refdata_book_statuses");
