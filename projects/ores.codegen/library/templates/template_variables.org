...
| =cache_component=         | Consumer component for a =nats-event-cache= archetype (from =cached_by=; defaults to =component=). | =iam= |
| =cache_component_upper=   | =cache_component= uppercased (underscores, all caps).           | =IAM=                            |
