 ...
 *
 */
#ifndef ORES_SCHEDULER_SERVICE_APP_APPLICATION_HPP
#define ORES_SCHEDULER_SERVICE_APP_APPLICATION_HPP
...
/**
 * @brief Entry point for the ores.scheduler.service service.
 */
class application final {
private:
    inline static std::string_view logger_name = "ores.scheduler.service.app.application";
