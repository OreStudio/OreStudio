...
| Now           | Designing the child-entity Qt facet (task 1). |
| Waiting on    | Nothing.                               |
| Next          | Build the standalone HierarchyTreeWidget (task 2). |
