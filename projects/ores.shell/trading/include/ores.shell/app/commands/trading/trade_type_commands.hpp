 ...
 *
 */
#ifndef ORES_SHELL_APP_COMMANDS_TRADE_TYPE_COMMANDS_HPP
#define ORES_SHELL_APP_COMMANDS_TRADE_TYPE_COMMANDS_HPP
...
public:
    ...
    /**
     * @brief Process the trade type history request.
     *
