...
CREATE OR REPLACE FUNCTION ores_utility_summary_foundation_layer_fn()
RETURNS SETOF ores_utility_layer_summary_row AS $$
BEGIN
    RETURN QUERY
...
COMMENT ON FUNCTION ores_utility_summary_foundation_layer_fn() IS
...
CREATE OR REPLACE FUNCTION ores_utility_summary_governance_layer_fn()
RETURNS SETOF ores_utility_layer_summary_row AS $$
BEGIN
    RETURN QUERY
    ...
    FROM ores_dq_nature_dimensions_tbl
    WHERE valid_to = ores_utility_infinity_timestamp_fn()
    UNION ALL
...
COMMENT ON FUNCTION ores_utility_summary_governance_layer_fn() IS
...
CREATE OR REPLACE FUNCTION ores_utility_summary_catalogues_layer_fn()
RETURNS SETOF ores_utility_layer_summary_row AS $$
BEGIN
    RETURN QUERY
...
COMMENT ON FUNCTION ores_utility_summary_catalogues_layer_fn() IS
...
CREATE OR REPLACE FUNCTION ores_utility_summary_production_layer_fn()
RETURNS SETOF ores_utility_layer_summary_row AS $$
BEGIN
    RETURN QUERY
...
COMMENT ON FUNCTION ores_utility_summary_production_layer_fn() IS
...
CREATE OR REPLACE FUNCTION ores_utility_summary_all_layers_fn()
RETURNS SETOF ores_utility_layer_summary_row AS $$
BEGIN
    RETURN QUERY
    SELECT * FROM ores_utility_summary_foundation_layer_fn()
    UNION ALL
    SELECT * FROM ores_utility_summary_governance_layer_fn()
    UNION ALL
    SELECT * FROM ores_utility_summary_catalogues_layer_fn()
    UNION ALL
    SELECT * FROM ores_utility_summary_production_layer_fn()
    ORDER BY 1, 2;
END;
$$ LANGUAGE plpgsql STABLE;

COMMENT ON FUNCTION ores_utility_summary_all_layers_fn() IS
