...
#+CAPTION: Clock summary at [2024-07-07 Sun 18:05]
| <75>                                              |         |       |      |       |
| Headline                                          | Time    |       |      |     % |
|---------------------------------------------------+---------+-------+------+-------|
| *Total time*                                      | *48:27* |       |      | 100.0 |
|---------------------------------------------------+---------+-------+------+-------|
| Stories                                           | 48:27   |       |      | 100.0 |
| Active                                            |         | 48:27 |      | 100.0 |
| Sprint and product backlog refinement             |         |       | 1:29 |   3.1 |
...
| Merge index with readme                           |         |       | 0:42 |   1.4 |
| Add project objective to readme                   |         |       | 2:24 |   5.0 |
| Add basic logging support                         |         |       | 1:14 |   2.5 |
| Add nightly support with memcheck                 |         |       | 3:21 |   6.9 |
...
| Add command line options support                  |         |       | 5:45 |  11.9 |
| Unit tests show up twice in nightlies             |         |       | 0:13 |   0.4 |
| Add recipes for command line                      |         |       | 0:51 |   1.8 |
| Use a bar chart for sprint resourcing cost        |         |       | 2:57 |   6.1 |
| Add XML parsing support for currency              |         |       | 3:18 |   6.8 |
| Create a containing structure for data            |         |       | 0:28 |   1.0 |
| Add basic widgets to display currencies           |         |       | 0:26 |   0.9 |
| Convert plantuml diagrams to org-babel            |         |       | 1:05 |   2.2 |
#+end:
...
*** Classify stories by type                                          :story:
