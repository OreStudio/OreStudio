 ...
 *
 */
#ifndef ORES_TRADING_CORE_PRESENTATION_FX_BARRIER_OPTION_INSTRUMENT_HISTORY_FIELD_MAPPER_HPP
#define ORES_TRADING_CORE_PRESENTATION_FX_BARRIER_OPTION_INSTRUMENT_HISTORY_FIELD_MAPPER_HPP
...
/**
 * @brief Renders a fx_barrier_option_instrument to an ordered field list for
