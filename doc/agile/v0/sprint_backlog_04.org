...
#+CAPTION: Clock summary at [2025-11-13 Thu 23:34], for Thursday, November 13, 2025.
|      | <75>                                       |        |      |      |       |
| Tags | Headline                                   | Time   |      |      |     % |
|------+--------------------------------------------+--------+------+------+-------|
|      | *Total time*                               | *6:39* |      |      | 100.0 |
|------+--------------------------------------------+--------+------+------+-------|
|      | Stories                                    | 6:39   |      |      | 100.0 |
|      | Active                                     |        | 6:39 |      | 100.0 |
| code | Fix the valgrind leaks reported on sqlgen  |        |      | 1:07 |  16.8 |
| code | Review all code created so far with an LLM |        |      | 5:32 |  83.2 |
#+end:

#+begin: clocktable :maxlevel 3 :scope subtree :tags t :indent nil :emphasize nil :scope file :narrow 75 :formula %
#+TBLNAME: sprint_summary
#+CAPTION: Clock summary at [2025-11-13 Thu 23:34]
|          | <75>                                                   |         |       |       |       |
| Tags     | Headline                                               | Time    |       |       |     % |
|----------+--------------------------------------------------------+---------+-------+-------+-------|
...
|          | Stories                                                | 64:03   |       |       | 100.0 |
|          | Active                                                 |         | 64:03 |       | 100.0 |
| agile    | Sprint and product backlog refinement                  |         |       |  2:49 |   4.4 |
| code     | Clean up client parser                                 |         |       |  0:10 |   0.3 |
| code     | Add connect command line argument                      |         |       |  1:19 |   2.1 |
| infra    | Install Windows package on Windows machine             |         |       |  2:09 |   3.4 |
| code     | Ignore warnings on windows and osx                     |         |       |  0:33 |   0.9 |
| code     | Ensure applications work under OSX using github images |         |       |  0:14 |   0.4 |
| infra    | Create a splash screen and gray background             |         |       |  2:26 |   3.8 |
| code     | Use fluent icons                                       |         |       |  0:37 |   1.0 |
| code     | Add export functionality for currencies                |         |       |  1:30 |   2.3 |
| code     | Add currency editing support                           |         |       |  2:45 |   4.3 |
| code     | Add about to menu                                      |         |       |  1:02 |   1.6 |
| code     | Create a history dialog for currencies                 |         |       |  1:27 |   2.3 |
| code     | Allow MDI windows outside main window                  |         |       |  1:35 |   2.5 |
| code     | Add edit menu and export menu                          |         |       |  0:34 |   0.9 |
| code     | Implement adding new currencies                        |         |       |  3:17 |   5.1 |
| code     | Clean up product website                               |         |       |  4:42 |   7.3 |
| code     | Create a skill for plant uml documentation             |         |       |  2:48 |   4.4 |
| infra    | Add CMake targets for site and skills                  |         |       |  0:17 |   0.4 |
| infra    | Generalise the skill setup for ORE Studio              |         |       |  3:45 |   5.9 |
| infra    | Restructure components to follow the dogen approach    |         |       |  2:54 |   4.5 |
| infra    | Generate PlantUML diagrams for all components          |         |       |  1:05 |   1.7 |
| code     | Fix the valgrind leaks reported on sqlgen              |         |       |  3:00 |   4.7 |
| code     | Make UI/UX look more professional                      |         |       | 11:07 |  17.4 |
...
| code     | Review all code created so far with an LLM             |         |       |  9:42 |  15.1 |
#+end:
...
*** Consider adding tags to catch2 tests                               :code:
