 ...
 *
 * This dialog allows viewing, creating, and editing report definitions.
 * It supports both create mode (for new records) and edit mode (for
 * existing records).
 */
class ReportDefinitionDetailDialog final : public DetailDialogBase {
    Q_OBJECT

private:
    inline static std::string_view logger_name = "ores.qt.report_definition_detail_dialog";
...
public:
    explicit ReportDefinitionDetailDialog(QWidget* parent = nullptr);
    ~ReportDefinitionDetailDialog() override;
...
private:
    ...
    void populateConcurrencyPolicyCombo(
