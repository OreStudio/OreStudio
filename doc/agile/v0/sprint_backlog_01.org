...
#+CAPTION: Clock summary at [2024-07-10 Wed 08:55]
|       | <75>                                              |         |       |      |       |
| Tags  | Headline                                          | Time    |       |      |     % |
|-------+---------------------------------------------------+---------+-------+------+-------|
|       | *Total time*                                      | *55:41* |       |      | 100.0 |
|-------+---------------------------------------------------+---------+-------+------+-------|
|       | Stories                                           | 55:41   |       |      | 100.0 |
|       | Active                                            |         | 55:41 |      | 100.0 |
| agile | Sprint and product backlog refinement             |         |       | 2:53 |   5.2 |
| infra | Create a basic git hub repository                 |         |       | 0:35 |   1.0 |
| infra | Setup a discord channel for the project           |         |       | 0:14 |   0.4 |
| infra | Setup vcpkg and cmake                             |         |       | 1:21 |   2.4 |
| infra | Setup github actions                              |         |       | 1:21 |   2.4 |
| infra | Create and upload a package                       |         |       | 3:28 |   6.2 |
| code  | Create a basic project structure                  |         |       | 2:10 |   3.9 |
| code  | Add a Qt hello world                              |         |       | 3:08 |   5.6 |
...
| doc   | Add project objective to readme                   |         |       | 2:24 |   4.3 |
| code  | Add basic logging support                         |         |       | 1:14 |   2.2 |
| infra | Add nightly support with memcheck                 |         |       | 3:21 |   6.0 |
| code  | Clean up toolchains and presets                   |         |       | 1:53 |   3.4 |
| doc   | Generate Doxygen documentation and add it to site |         |       | 0:51 |   1.5 |
| doc   | Copy domain notes on core concepts                |         |       | 4:41 |   8.4 |
| infra | Valgrind fails to run unit tests                  |         |       | 1:12 |   2.2 |
| infra | Initial sanity test generated packages            |         |       | 0:25 |   0.7 |
| code  | Add command line options support                  |         |       | 5:45 |  10.3 |
| infra | Unit tests show up twice in nightlies             |         |       | 0:13 |   0.4 |
| doc   | Add recipes for command line                      |         |       | 0:51 |   1.5 |
| agile | Use a bar chart for sprint resourcing cost        |         |       | 2:57 |   5.3 |
| agile | Classify stories by type                          |         |       | 0:34 |   1.0 |
| code  | Update C++ standard                               |         |       | 0:29 |   0.9 |
| infra | Setup laptop for development                      |         |       | 2:52 |   5.1 |
| code  | Add XML parsing support for currency              |         |       | 4:52 |   8.7 |
