...
struct gmm_component final {
     ...
     */
    friend bool operator==(const gmm_component&, const gmm_component&) = default;
};

/**
 * @brief Dispatch-key identifier for gmm_component, e.g. for the
 * generic history-diff request and action registries. Single source
 * of truth: every call site spells entity_type_of(value) regardless
 * of which entity it holds.
 */
[[nodiscard]] constexpr std::string_view entity_type_of(const gmm_component&) {
    return "ores.synthetic.gmm_component";
}
