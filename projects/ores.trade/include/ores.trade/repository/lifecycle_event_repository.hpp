 ...
 *
 */
#ifndef ORES_TRADE_REPOSITORY_LIFECYCLE_EVENT_REPOSITORY_HPP
#define ORES_TRADE_REPOSITORY_LIFECYCLE_EVENT_REPOSITORY_HPP
...
private:
    inline static std::string_view logger_name =
        "ores.trade.repository.lifecycle_event_repository";
