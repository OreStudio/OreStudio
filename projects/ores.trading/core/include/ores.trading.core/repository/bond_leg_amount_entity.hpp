 ...
 *
 */
#ifndef ORES_TRADING_CORE_REPOSITORY_BOND_LEG_AMOUNT_ENTITY_HPP
#define ORES_TRADING_CORE_REPOSITORY_BOND_LEG_AMOUNT_ENTITY_HPP
...
/**
 * @brief Represents a bond leg amount in the database.
 */
struct bond_leg_amount_entity {
...
std::ostream& operator<<(std::ostream& s, const bond_leg_amount_entity& v);
