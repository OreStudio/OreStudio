...
| [[id:21E5D45B-9CAD-4146-8ECF-1ACDB6398508][Verify party_type Qt UI end-to-end post-NATS]] | BLOCKED | 2026-07-02 | | Blocked on ores.controller.service crash (memory corruption, see inbox capture); verify the Qt list window, detail dialog, history dialog, delete, and eventing for party_type against a live environment post-NATS migration; fix any regressions found. |
