 ...
 *
 */
#include "ores.analytics.service/config/parser.hpp"

#include <ostream>
#include <boost/program_options.hpp>
#include <boost/throw_exception.hpp>
#include "ores.analytics.service/config/parser_exception.hpp"
...
const std::string product_version("ores.analytics.service v" ORES_VERSION);
...
using ores::analytics::service::config::options;
using ores::analytics::service::config::parser_exception;
...
options_description make_options_description() {
    ...
    r.add(logging_configuration::make_options_description("ores.analytics.service.log"));
...
void print_help(const options_description& od, std::ostream& info) {
    info << "Analytics pricing service" << std::endl << std::endl
         << "Usage: ores.analytics.service [options]" << std::endl << std::endl
         << od << std::endl;
}
...
parse_arguments(const std::vector<std::string>& arguments, std::ostream& info) {
    ...
    const auto name_mapper(environment_mapper_factory::make_mapper("ANALYTICS_SERVICE"));
