 ...
 *
 */
#ifndef ORES_TRADING_CORE_REPOSITORY_EQUITY_VARIANCE_SWAP_INSTRUMENT_REPOSITORY_HPP
#define ORES_TRADING_CORE_REPOSITORY_EQUITY_VARIANCE_SWAP_INSTRUMENT_REPOSITORY_HPP
 ...
 */
class ORES_TRADING_CORE_EXPORT equity_variance_swap_instrument_repository {
private:
...
public:
    ...
    /**
     * @brief Writes equity variance swap instruments to database.
     */
    /**@{*/
    ...
    /**
     * @brief Reads latest equity variance swap instruments, possibly filtered by primary key.
     */
    /**@{*/
    ...
    /**
     * @brief Reads all equity variance swap instruments, possibly filtered by primary key.
     */
    std::vector<domain::equity_variance_swap_instrument> read_all(context ctx,
                                                                  const std::string& instrument_id);

    /**
     * @brief Reads a single equity variance swap instrument as it stood at a specific
    ...
    /**
     * @brief Reads latest equity variance swap instruments with pagination support.
     * @param ctx Repository context with database connection
     ...
     */
    std::uint32_t get_total_equity_variance_swap_instrument_count(context ctx);

    /**
     * @brief Deletes a equity variance swap instrument by closing its temporal validity.
     */
    void remove(context ctx, const std::string& instrument_id);

    /**
     * @brief Deletes equity variance swap instruments by closing their temporal validity.
     */
