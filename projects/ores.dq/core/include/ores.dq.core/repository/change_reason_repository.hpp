 ...
 *
 */
#ifndef ORES_DQ_CORE_REPOSITORY_CHANGE_REASON_REPOSITORY_HPP
#define ORES_DQ_CORE_REPOSITORY_CHANGE_REASON_REPOSITORY_HPP
...
public:
    ...
    /**
     * @brief Reads latest change reasons, possibly filtered by primary key.
     */
    /**@{*/
    ...
    /**
     * @brief Reads all change reasons, possibly filtered by primary key.
     */
