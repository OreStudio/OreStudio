...
=Y*= — partial: =party= shell has =list= only, =add=/=remove= not yet implemented.
...
- =ores.refdata=: =account_type=, =counterparty_contact_information=,
  =counterparty_identifier=, =currency_market_tier=, =monetary_nature=,
  =party_contact_information=, =party_counterparty=, =party_identifier=
...
- [[id:897A7156-504D-4581-AD4C-026D643C0838][Domain entity evaluation checklist]] — per-layer commissioning criteria (DB through manual) for any domain entity; Domain/Aux columns show what applies to each meta-type
