 ...
 */
/**
 * Where the contact_type screens live and what they can do.
 *
 ...
 */
import { contactTypeMeta } from '../ui/contact_type_ui.js';
import type { EntityDescriptor } from '../../../entity/descriptor.js';

export const contactTypeDescriptor: EntityDescriptor = {
    component: 'refdata',
    entity: 'contact_type',
    meta: contactTypeMeta,
    routeSegment: 'contact-type',
    apiBase: '/api/types',
    keyFields: [
        'code',
    ],
