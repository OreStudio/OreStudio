...
|---+-----------------+------+----------+-------|
| 1 | Task state should be DONE, fill in Result section before merging | task_fix_msvc_scope_label_ambiguous_identifier.org | Accepted | Will close task via compass-agile-close-task after review round |
