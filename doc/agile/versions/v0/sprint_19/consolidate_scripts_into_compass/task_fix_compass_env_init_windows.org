...
| Now          | nats_certs.py ported to Python; compass nats certs exposed; PR #1034 open. |
| Waiting on   | Windows CI green on PR #1034.                                               |
...
| [[https://github.com/OreStudio/OreStudio/pull/1034][#1034]] | [compass] Port NATS cert generation to Python; expose as compass nats certs        |
