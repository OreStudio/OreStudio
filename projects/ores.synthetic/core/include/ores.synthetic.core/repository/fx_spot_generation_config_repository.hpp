...
public:
    ...
    /**
     * @brief Writes a FX spot generation config, honouring the claim it states.
     *
    ...
    /**
     * @brief Writes a set of FX spot generation configs, each honouring its own
    ...
    /**
     * @brief Reads latest FX spot generation configs, possibly filtered by primary key.
     */
    /**@{*/
    ...
    /**
     * @brief Reads all FX spot generation configs, possibly filtered by primary key.
     */
    ...
    /**
     * @brief Removes a FX spot generation config, refusing a row that moved on.
     *
...
private:
     ...
     */
    domain::fx_spot_generation_config apply_claim(context ctx,
                                                  const domain::fx_spot_generation_config& v,
                                                  const ores::utility::domain::precondition& claim);
};
