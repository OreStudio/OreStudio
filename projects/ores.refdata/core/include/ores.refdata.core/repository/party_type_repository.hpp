...
public:
    ...
    /**
     * @brief Writes a party type, honouring the claim it states.
     *
    ...
    /**
     * @brief Writes a set of party types, each honouring its own
    ...
    /**
     * @brief Reads latest party types, possibly filtered by primary key.
     */
    /**@{*/
    ...
    std::vector<domain::party_type> read_latest(context ctx, const std::vector<std::string>& codes);
    /**@}*/


    /**
     * @brief Reads all party types, possibly filtered by primary key.
     */
    std::vector<domain::party_type> read_all(context ctx, const std::string& code);

    /**
     * @brief Reads a single party type as it stood at a specific
    ...
    /**
     * @brief Removes a party type, refusing a row that moved on.
     *
...
private:
     ...
     */
    ores::utility::domain::precondition replace_claim(context ctx, const domain::party_type& v);
     ...
     */
    domain::party_type apply_claim(context ctx,
                                   const domain::party_type& v,
                                   const ores::utility::domain::precondition& claim);
};
