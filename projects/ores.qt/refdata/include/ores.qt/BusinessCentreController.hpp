 ...
 */
#ifndef ORES_QT_BUSINESS_CENTRE_CONTROLLER_HPP
#define ORES_QT_BUSINESS_CENTRE_CONTROLLER_HPP
 ...
 *
 * Manages the lifecycle of business centre list, detail, and history windows.
 * Handles event subscriptions and coordinates between windows.
 */
class BusinessCentreController final : public EntityController {
    Q_OBJECT

private:
    inline static std::string_view logger_name = "ores.qt.business_centre_controller";
...
public:
    BusinessCentreController(QMainWindow* mainWindow,
                             QMdiArea* mdiArea,
...
private:
     ...
     * BusinessCentreDetailDialog needs regardless of which
     * window opened it (add/edit/history-version/revert) -- kept in one
     * place so those four call sites can't drift from each other.
     */
    void wireDetailDialogCommon(BusinessCentreDetailDialog* detailDialog);
