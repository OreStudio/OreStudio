...
#+type: runbook
#+level: cross
#+filetags: :llm:hotfix:git:agile:runbook:
#+created: 2026-05-28
#+updated: 2026-05-28
...
- =compass=, =gh=, and the session's SSH agent are available (see
  [[id:F7E4C41F-AF34-43E5-ADC3-1D837126B3DE][Do not interfere with SSH session variables]]).
...
11. /Open a PR./ Leave the SSH session variables alone, per the [[id:F7E4C41F-AF34-43E5-ADC3-1D837126B3DE][SSH memory]],
