...
TEST_CASE("write_series_key_shape_publishes_an_event", tags) {
    ...
    using event_type = ores::ore::messaging::series_key_shape_event;
    ...
    event_source.register_entity_event_mapping<event_type>("ores_ore_series_key_shapes");
