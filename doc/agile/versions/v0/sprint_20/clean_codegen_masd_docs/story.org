...
| [[id:62A7D749-835E-497A-836F-6217C8894611][Audit and update the MASD document]] | STARTED | 2026-06-07 | | Review and update projects/modeling/masd.org: update facet catalogue to link to literate template org files; align transformation model section with the LLM-based approach. |
