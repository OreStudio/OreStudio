 ...
 *
 */
#ifndef ORES_TRADING_REPOSITORY_FX_INSTRUMENT_ENTITY_HPP
#define ORES_TRADING_REPOSITORY_FX_INSTRUMENT_ENTITY_HPP
...
/**
 * @brief Represents an FX instrument in the database.
 */
struct fx_instrument_entity {
    constexpr static const char* schema = "public";
    constexpr static const char* tablename = "ores_trading_fx_instruments_tbl";
...
std::ostream& operator<<(std::ostream& s, const fx_instrument_entity& v);
