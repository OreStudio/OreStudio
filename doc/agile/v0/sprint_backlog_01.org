...
#+CAPTION: Clock summary at [2024-07-18 Thu 23:47]
|       | <75>                                               |         |       |      |       |
| Tags  | Headline                                           | Time    |       |      |     % |
|-------+----------------------------------------------------+---------+-------+------+-------|
|       | *Total time*                                       | *72:21* |       |      | 100.0 |
|-------+----------------------------------------------------+---------+-------+------+-------|
|       | Stories                                            | 72:21   |       |      | 100.0 |
|       | Active                                             |         | 72:21 |      | 100.0 |
...
| infra | Create and upload a package                        |         |       | 3:28 |   4.8 |
| code  | Create a basic project structure                   |         |       | 2:10 |   3.0 |
...
| code  | Investigate other Qt Applications with similar UIs |         |       | 2:09 |   3.0 |
