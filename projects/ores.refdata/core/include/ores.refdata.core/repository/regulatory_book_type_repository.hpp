...
public:
    ...
    /**
     * @brief Writes a regulatory book type, honouring the claim it states.
     *
    ...
    /**
     * @brief Writes a set of regulatory book types, each honouring its own
    ...
    /**
     * @brief Removes a regulatory book type, refusing a row that moved on.
     *
...
private:
     ...
     */
    domain::regulatory_book_type apply_claim(context ctx,
                                             const domain::regulatory_book_type& v,
                                             const ores::utility::domain::precondition& claim);
};
