 ...
 */
#ifndef ORES_SHELL_APP_COMMANDS_IR_CURVE_TEMPLATE_ENTRY_COMMANDS_HPP
#define ORES_SHELL_APP_COMMANDS_IR_CURVE_TEMPLATE_ENTRY_COMMANDS_HPP
...
/**
 * @brief Every verb IR curve template entries answer, as one command each.
 *
...
public:
    /**
     * @brief Register the IR curve template entries submenu.
     */
