 ...
 *
 */
#ifndef ORES_ACCOUNTS_EVENTING_ROLE_ASSIGNED_EVENT_HPP
#define ORES_ACCOUNTS_EVENTING_ROLE_ASSIGNED_EVENT_HPP
 ...
 */
template<>
struct event_traits<ores::accounts::eventing::role_assigned_event> {
