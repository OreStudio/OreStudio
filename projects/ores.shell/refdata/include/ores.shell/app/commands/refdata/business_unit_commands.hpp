 ...
 */
#ifndef ORES_SHELL_APP_COMMANDS_BUSINESS_UNIT_COMMANDS_HPP
#define ORES_SHELL_APP_COMMANDS_BUSINESS_UNIT_COMMANDS_HPP
...
/**
 * @brief Every verb business units answer, as one command each.
 *
 ...
 */
class business_unit_commands {
private:
    inline static std::string_view logger_name =
        "ores.shell.app.commands.refdata.business_unit_commands";
...
public:
    /**
     * @brief Register the business units submenu.
     */
