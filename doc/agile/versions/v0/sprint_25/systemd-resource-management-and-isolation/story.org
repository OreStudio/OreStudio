...
Status at close: Nothing. All unprivileged workstreams (WS-7, WS-1, WS-5 unpriv, WS-4) merged; WS-3 and WS-2 both discovered already implemented (predate this story, Sprint 24 PR #1806); the client-migration and controller-decommission investigation tasks closed (abandoned/done).
