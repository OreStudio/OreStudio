 ...
 */
/**
 * Where the diary_entry_type screens live and what they can do.
 *
 ...
 */
import { diaryEntryTypeMeta } from '../ui/diary_entry_type_ui.js';
import type { EntityDescriptor } from '../../../entity/descriptor.js';

export const diaryEntryTypeDescriptor: EntityDescriptor = {
    component: 'refdata',
    entity: 'diary_entry_type',
    meta: diaryEntryTypeMeta,
    routeSegment: 'diary-entry-type',
    apiBase: '/api/entry_types',
    keyParam: 'id',
    icon: 'tag',
    capabilities: {
        create: true,
