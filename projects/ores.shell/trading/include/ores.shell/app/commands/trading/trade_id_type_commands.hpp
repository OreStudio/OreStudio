 ...
 *
 */
#ifndef ORES_SHELL_APP_COMMANDS_TRADE_ID_TYPE_COMMANDS_HPP
#define ORES_SHELL_APP_COMMANDS_TRADE_ID_TYPE_COMMANDS_HPP
...
/**
 * @brief Manages commands related to trade ID types.
 */
class trade_id_type_commands {
private:
    inline static std::string_view logger_name =
        "ores.shell.app.commands.trading.trade_id_type_commands";
...
public:
    /**
     * @brief Register trade ID type related commands.
     */
    ...
    /**
     * @brief Process the trade ID type history request.
     *
