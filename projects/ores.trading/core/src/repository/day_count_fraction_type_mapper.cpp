...
day_count_fraction_type_mapper::map(const day_count_fraction_type_entity& v) {
...
day_count_fraction_type_entity
day_count_fraction_type_mapper::map(const domain::day_count_fraction_type& v) {
    BOOST_LOG_SEV(lg(), trace) << "Mapping domain entity: " << v;

    day_count_fraction_type_entity r;
    r.code = v.code;
