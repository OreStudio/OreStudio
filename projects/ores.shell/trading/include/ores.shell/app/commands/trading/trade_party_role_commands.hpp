 ...
 *
 */
#ifndef ORES_SHELL_APP_COMMANDS_TRADE_PARTY_ROLE_COMMANDS_HPP
#define ORES_SHELL_APP_COMMANDS_TRADE_PARTY_ROLE_COMMANDS_HPP
...
public:
    ...
    /**
     * @brief Process the trade party role history request.
     *
