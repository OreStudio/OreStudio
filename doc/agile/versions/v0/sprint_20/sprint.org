...
| Story | State | Start | End | Description |
|-------+-------+-------+-----+-------------|
| [[id:A19D5B00-BEF3-4718-922D-16F58EEBAAB4][Provisioners from the shell — analysis and design]] | STARTED | 2026-06-06 | | Map the three provisioner wizards to the shell command surface; brainstorm the idiomatic ores-shell interface; decide implementation approach and scope follow-up stories. Implementation descoped to backlog. |
...
| [[id:C1813B64-1647-4B49-B856-A8345850001C][Distinguish creating from picking up in compass]] | BACKLOG | | | Decouple scaffolding from branch creation: create scaffolds docs only; pick-up branches, marks STARTED, stamps journal. |
...
| Story | State | Start | End | Description |
|-------+-------+-------+-----+-------------|
| [[id:EE8D63CB-D468-4D91-A1D8-CDE5A70D3B38][Compass quality of life]] | BACKLOG | | | Second QoL round: SSH_AUTH_SOCK from .env, dashboard services invocation bug, auto-authorise compass in Claude Code settings. |
