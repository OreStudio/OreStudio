 ...
 */
/**
 * Where the payment_frequency screens live and what they can do.
 *
 ...
 */
import { paymentFrequencyMeta } from '../ui/payment_frequency_ui.js';
import type { EntityDescriptor } from '../../../entity/descriptor.js';

export const paymentFrequencyDescriptor: EntityDescriptor = {
    component: 'refdata',
    entity: 'payment_frequency',
    meta: paymentFrequencyMeta,
    routeSegment: 'payment-frequency',
    apiBase: '/api/payment_frequencies',
    keyParam: 'id',
    icon: 'clock',
    capabilities: {
        create: true,
