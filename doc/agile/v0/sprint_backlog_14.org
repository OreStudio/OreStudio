...
#+CAPTION: Clock summary at [2026-03-01 Sun 13:41], for Sunday, March 01, 2026.
|       | <75>                                     |        |      |      |       |
| Tags  | Headline                                 | Time   |      |      |     % |
|-------+------------------------------------------+--------+------+------+-------|
|       | *Total time*                             | *4:44* |      |      | 100.0 |
|-------+------------------------------------------+--------+------+------+-------|
|       | Stories                                  | 4:44   |      |      | 100.0 |
|       | Active                                   |        | 4:44 |      | 100.0 |
| agile | Sprint and product backlog refinement    |        |      | 0:05 |   1.8 |
| code  | Add trade import mapping dialog to Qt UI |        |      | 4:39 |  98.2 |
#+end:

#+begin: clocktable :maxlevel 3 :scope subtree :tags t :indent nil :emphasize nil :scope file :narrow 75 :formula %
#+TBLNAME: sprint_summary
#+CAPTION: Clock summary at [2026-03-01 Sun 13:41]
|       | <75>                                     |        |      |      |       |
| Tags  | Headline                                 | Time   |      |      |     % |
|-------+------------------------------------------+--------+------+------+-------|
|       | *Total time*                             | *6:14* |      |      | 100.0 |
|-------+------------------------------------------+--------+------+------+-------|
|       | Stories                                  | 6:14   |      |      | 100.0 |
|       | Active                                   |        | 6:14 |      | 100.0 |
| agile | Sprint and product backlog refinement    |        |      | 1:35 |  25.4 |
| code  | Add trade import mapping dialog to Qt UI |        |      | 4:39 |  74.6 |
#+end:
