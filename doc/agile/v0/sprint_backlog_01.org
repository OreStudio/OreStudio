...
#+CAPTION: Clock summary at [2024-06-29 Sat 09:15]
| <75>                                    |         |       |      |       |
| Headline                                | Time    |       |      |     % |
|-----------------------------------------+---------+-------+------+-------|
...
| Stories                                 | 21:42   |       |      | 100.0 |
| Active                                  |         | 21:42 |      | 100.0 |
| Sprint and product backlog refinement   |         |       | 0:55 |   4.2 |
| Create a basic git hub repository       |         |       | 0:35 |   2.7 |
| Setup a discord channel for the project |         |       | 0:14 |   1.1 |
| Setup vcpkg and cmake                   |         |       | 1:21 |   6.2 |
| Setup github actions                    |         |       | 1:21 |   6.2 |
| Create and upload a package             |         |       | 3:28 |  16.0 |
| Create a basic project structure        |         |       | 2:10 |  10.0 |
| Add a Qt hello world                    |         |       | 3:08 |  14.4 |
| Add a splash screen to applciation      |         |       | 0:41 |   3.1 |
| Add basic site                          |         |       | 0:34 |   2.6 |
| Add modeling infrastructure             |         |       | 1:30 |   6.9 |
| Add nightly support with memcheck       |         |       | 2:13 |  10.2 |
| Add XML parsing support for currency    |         |       | 1:24 |   6.5 |
| Create a containing structure for data  |         |       | 0:28 |   2.2 |
| Add basic widgets to display currencies |         |       | 0:26 |   2.0 |
| Add basic logging support               |         |       | 1:14 |   5.7 |
#+end:
