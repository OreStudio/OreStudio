...
It is not a widening of what a caller may see. The row that filter excluded is
the caller's own tenant, and a tenant admin is the one person who should see it.
