 ...
 */
/**
 * How the BFF reaches the calendar_type service.
 *
 ...
 */
import { subjects } from '@ores/wire-protocol/generated/refdata/protocol/calendar_type_protocol';
import type { EntityRouteDescriptor } from '../../entity-routes.js';

export const calendarTypeRoute: EntityRouteDescriptor = {
  component: 'refdata',
  ...
  subjects: {
    list: subjects.list_calendar_types_request,
    get: subjects.get_calendar_type_request,
    save: subjects.put_calendar_type_request,
    remove: subjects.delete_calendar_type_request,
    history: subjects.list_calendar_type_versions_request,
  },
  rowsField: 'types',
  getRowField: 'calendar_type',
