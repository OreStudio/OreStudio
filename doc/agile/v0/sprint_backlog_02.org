...
#+CAPTION: Clock summary at [2025-10-22 Wed 01:24], for Wednesday, October 22, 2025.
|      | <75>                                |        |      |      |       |
| Tags | Headline                            | Time   |      |      |     % |
|------+-------------------------------------+--------+------+------+-------|
|      | *Total time*                        | *1:24* |      |      | 100.0 |
|------+-------------------------------------+--------+------+------+-------|
|      | Stories                             | 1:24   |      |      | 100.0 |
|      | Active                              |        | 1:24 |      | 100.0 |
| code | Add support for accounts and logins |        |      | 1:24 | 100.0 |
#+end:

#+begin: clocktable :maxlevel 3 :scope subtree :tags t :indent nil :emphasize nil :scope file :narrow 75 :formula %
#+TBLNAME: sprint_summary
#+CAPTION: Clock summary at [2025-10-22 Wed 01:24]
|          | <75>                                               |         |       |      |       |
| Tags     | Headline                                           | Time    |       |      |     % |
|----------+----------------------------------------------------+---------+-------+------+-------|
...
|          | Stories                                            | 86:28   |       |      | 100.0 |
|          | Active                                             |         | 86:28 |      | 100.0 |
| agile    | Sprint and product backlog refinement              |         |       | 2:36 |   3.0 |
| infra    | Fix broken builds                                  |         |       | 0:36 |   0.7 |
| code     | Create a containing structure for data             |         |       | 0:35 |   0.7 |
| code     | Add temporal support to currencies                 |         |       | 2:59 |   3.5 |
| code     | Add command to dump currencies                     |         |       | 4:18 |   5.0 |
| code     | Refactor code for currencies                       |         |       | 3:52 |   4.5 |
| code     | Restore qt setup                                   |         |       | 2:20 |   2.7 |
| code     | Add gemini action                                  |         |       | 0:05 |   0.1 |
| code     | Remove ImGui support                               |         |       | 0:08 |   0.2 |
| code     | Create a GRPC based service                        |         |       | 2:09 |   2.5 |
| code     | Implement a 0MQ based RPC service and client       |         |       | 3:55 |   4.5 |
...
| code     | Implement a cobalt based server and client         |         |       | 2:53 |   3.3 |
| code     | Add serialisation support for reflect-cpp          |         |       | 3:07 |   3.6 |
| analysis | White-boarding for new architecture                |         |       | 1:52 |   2.2 |
| code     | Use sqlgen for postgres                            |         |       | 7:23 |   8.5 |
| code     | Refactor cli to follow new project structure       |         |       | 4:47 |   5.5 |
| code     | Add tests to cli parser                            |         |       | 0:35 |   0.7 |
| code     | Add logging support for tests                      |         |       | 2:21 |   2.7 |
| code     | Replace XML parsing with reflect cpp               |         |       | 2:56 |   3.4 |
| code     | Fix windows and osx builds                         |         |       | 0:27 |   0.5 |
| code     | Completions in emacs org mode are incorrect        |         |       | 1:02 |   1.2 |
| analysis | Investigate bitemporal support from Postgres 18    |         |       | 1:47 |   2.1 |
| code     | Refactor core into risk                            |         |       | 4:10 |   4.8 |
| code     | Windows builds have cmake errors                   |         |       | 0:14 |   0.3 |
| infra    | Add suppression to valgrind errors                 |         |       | 0:38 |   0.7 |
| code     | Create a =comms= library                           |         |       | 8:05 |   9.3 |
| code     | Add messaging for risk                             |         |       | 8:00 |   9.3 |
...
| code     | Add support for accounts and logins                |         |       | 7:28 |   8.6 |
| code     | Add workspace as a container                       |         |       | 1:13 |   1.4 |
#+end:
