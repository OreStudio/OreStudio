...
ir_curve_generation_config_repository::replace_claim(context ctx,
...
domain::ir_curve_generation_config ir_curve_generation_config_repository::apply_claim(
    context ctx,
    const domain::ir_curve_generation_config& v,
...
void ir_curve_generation_config_repository::write(
    ...
    execute_write_query(ctx,
                        ir_curve_generation_config_mapper::map(t),
                        lg(),
...
void ir_curve_generation_config_repository::write(
    ...
    execute_write_query(ctx,
                        ir_curve_generation_config_mapper::map(batch),
                        lg(),
...
ir_curve_generation_config_repository::remove_status ir_curve_generation_config_repository::remove(
...
ir_curve_generation_config_repository::read_latest(context ctx,
    ...
    auto result =
        execute_read_query<ir_curve_generation_config_entity, domain::ir_curve_generation_config>(
            ...
            [](const auto& entities) { return ir_curve_generation_config_mapper::map(entities); },
            lg(),
            "Reading latest IR curve generation configs by ids.");
    return result;
}
