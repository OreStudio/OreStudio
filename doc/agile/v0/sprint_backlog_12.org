...
#+CAPTION: Clock summary at [2026-02-12 Thu 22:01], for Thursday, February 12, 2026.
|       | <75>                                  |        |      |      |       |
| Tags  | Headline                              | Time   |      |      |     % |
|-------+---------------------------------------+--------+------+------+-------|
|       | *Total time*                          | *5:43* |      |      | 100.0 |
|-------+---------------------------------------+--------+------+------+-------|
|       | Stories                               | 5:43   |      |      | 100.0 |
|       | Active                                |        | 5:43 |      | 100.0 |
| agile | Sprint and product backlog refinement |        |      | 0:24 |   7.0 |
| code  | Fix OSX build                         |        |      | 0:19 |   5.5 |
| code  | Add pagination to counterparty        |        |      | 0:58 |  16.9 |
| code  | Add support for business centres      |        |      | 3:47 |  66.2 |
| code  | Add a setup new tenant wizard         |        |      | 0:15 |   4.4 |
#+end:

#+begin: clocktable :maxlevel 3 :scope subtree :tags t :indent nil :emphasize nil :scope file :narrow 75 :formula %
#+TBLNAME: sprint_summary
#+CAPTION: Clock summary at [2026-02-12 Thu 22:01]
|       | <75>                                               |         |       |      |       |
| Tags  | Headline                                           | Time    |       |      |     % |
|-------+----------------------------------------------------+---------+-------+------+-------|
...
|       | Stories                                            | 42:21   |       |      | 100.0 |
|       | Active                                             |         | 42:21 |      | 100.0 |
| agile | Sprint and product backlog refinement              |         |       | 1:42 |   4.0 |
| code  | Add bound parameters to sqlgen                     |         |       | 0:51 |   2.0 |
| code  | Add roles to account via codes                     |         |       | 0:34 |   1.3 |
| code  | Implement party related entities at database level |         |       | 4:23 |  10.4 |
| code  | Add party related support at the domain level      |         |       | 0:23 |   0.9 |
| code  | Add party related support to Qt                    |         |       | 6:41 |  15.8 |
| code  | Add GLEIF data to datasets                         |         |       | 6:41 |  15.8 |
| code  | Brainstorm on multi-party support                  |         |       | 4:00 |   9.4 |
| code  | Improve code coverage                              |         |       | 0:14 |   0.6 |
| code  | Improve generators with FK-aware test data         |         |       | 1:44 |   4.1 |
...
| code  | Add system party support                           |         |       | 3:58 |   9.4 |
| code  | Add customer party support                         |         |       | 1:33 |   3.7 |
| code  | Fix OSX build                                      |         |       | 0:19 |   0.7 |
| code  | Add pagination to counterparty                     |         |       | 0:58 |   2.3 |
| code  | Add support for business centres                   |         |       | 3:47 |   8.9 |
| code  | Add a setup new tenant wizard                      |         |       | 1:27 |   3.4 |
| code  | Add workspace as a container                       |         |       | 1:13 |   2.9 |
#+end:
...
*** Understanding Settlements and SSI                                 :agile:
