...
/**
 * @brief Detail dialog for viewing and editing change reason records.
 *
 * This dialog allows viewing, creating, and editing change reasons.
 * It supports both create mode (for new records) and edit mode (for
 * existing records).
 */
class ChangeReasonDetailDialog final : public DetailDialogBase {
    Q_OBJECT
...
private:
    ...
    void updateUiFromReason();
    void updateReasonFromUi();
