 ...
 *
 */
#ifndef ORES_REFDATA_EVENTING_ROUNDING_TYPE_CHANGED_EVENT_HPP
#define ORES_REFDATA_EVENTING_ROUNDING_TYPE_CHANGED_EVENT_HPP
...
struct rounding_type_changed_event final {
    ...
    /**
     * @brief Codes of rounding types that changed.
     */
    std::vector<std::string> rounding_type_codes;
...
struct event_traits<ores::refdata::eventing::rounding_type_changed_event> {
    static constexpr std::string_view name = "ores.refdata.rounding_type_changed";
};
