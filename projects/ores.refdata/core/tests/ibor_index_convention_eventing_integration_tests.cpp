...
#include "ores.refdata.api/eventing/ibor_index_convention_event.hpp"
...
TEST_CASE("write_ibor_index_convention_publishes_an_event", tags) {
    ...
    using event_type = ores::refdata::messaging::ibor_index_convention_event;
    ...
    event_source.register_entity_event_mapping<event_type>("ores_refdata_ibor_index_conventions");
