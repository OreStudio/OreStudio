...
#+CAPTION: Clock summary at [2025-10-15 Wed 17:58], for Wednesday, October 15, 2025.
|      | <75>                     |        |      |      |       |
| Tags | Headline                 | Time   |      |      |     % |
|------+--------------------------+--------+------+------+-------|
...
|      | Stories                  | 3:53   |      |      | 100.0 |
|      | Active                   |        | 3:53 |      | 100.0 |
| code | Create a =comms= library |        |      | 3:53 | 100.0 |
#+end:

#+begin: clocktable :maxlevel 3 :scope subtree :tags t :indent nil :emphasize nil :scope file :narrow 75 :formula %
#+TBLNAME: sprint_summary
#+CAPTION: Clock summary at [2025-10-15 Wed 17:58]
|          | <75>                                               |         |       |      |       |
| Tags     | Headline                                           | Time    |       |      |     % |
|----------+----------------------------------------------------+---------+-------+------+-------|
|          | *Total time*                                       | *69:16* |       |      | 100.0 |
|----------+----------------------------------------------------+---------+-------+------+-------|
|          | Stories                                            | 69:16   |       |      | 100.0 |
|          | Active                                             |         | 69:16 |      | 100.0 |
| agile    | Sprint and product backlog refinement              |         |       | 2:36 |   3.8 |
...
| code     | Refactor code for currencies                       |         |       | 3:52 |   5.6 |
| code     | Restore qt setup                                   |         |       | 2:20 |   3.4 |
| code     | Add gemini action                                  |         |       | 0:05 |   0.1 |
| code     | Remove ImGui support                               |         |       | 0:08 |   0.2 |
| code     | Create a GRPC based service                        |         |       | 2:09 |   3.1 |
| code     | Implement a 0MQ based RPC service and client       |         |       | 3:55 |   5.7 |
...
| code     | Implement a cobalt based server and client         |         |       | 2:53 |   4.2 |
| code     | Add serialisation support for reflect-cpp          |         |       | 3:07 |   4.5 |
| analysis | White-boarding for new architecture                |         |       | 1:52 |   2.7 |
| code     | Use sqlgen for postgres                            |         |       | 7:23 |  10.7 |
| code     | Refactor cli to follow new project structure       |         |       | 4:47 |   6.9 |
...
| code     | Create a =comms= library                           |         |       | 8:05 |  11.7 |
...
| code     | Add workspace as a container                       |         |       | 1:13 |   1.8 |
#+end:
