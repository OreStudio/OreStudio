...
| [[id:7E113DC6-2C6C-401B-B52E-76E2C912C835][Add compass task move: relocate a task between stories]] | STARTED | 2026-06-06 | | Add a compass command to move a task between stories. Today there is no 'task move': relocating a task means reverting the old story's wiring, re-running compass add with --id into the new parent, deleting the old file, and hand-editing tables. A 'compass task move <slug> --story <target>' should rehome the file, rewire both Tasks tables, and update the task's parent links. |
