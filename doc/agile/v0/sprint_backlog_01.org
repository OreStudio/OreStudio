...
#+TBLNAME: summary
#+CAPTION: Clock summary at [2024-07-04 Thu 23:04]
| <75>                                    |         |       |      |       |
| Headline                                | Time    |       |      |     % |
|-----------------------------------------+---------+-------+------+-------|
...
| Stories                                 | 33:57   |       |      | 100.0 |
| Active                                  |         | 33:57 |      | 100.0 |
| Sprint and product backlog refinement   |         |       | 1:05 |   3.2 |
| Create a basic git hub repository       |         |       | 0:35 |   1.7 |
| Setup a discord channel for the project |         |       | 0:14 |   0.7 |
| Setup vcpkg and cmake                   |         |       | 1:21 |   4.0 |
| Setup github actions                    |         |       | 1:21 |   4.0 |
| Create and upload a package             |         |       | 3:28 |  10.2 |
| Create a basic project structure        |         |       | 2:10 |   6.4 |
| Add a Qt hello world                    |         |       | 3:08 |   9.2 |
| Add a splash screen to applciation      |         |       | 0:41 |   2.0 |
| Add basic site                          |         |       | 0:34 |   1.7 |
| Add modeling infrastructure             |         |       | 1:30 |   4.4 |
| Fix code syntax highlighting in site    |         |       | 0:10 |   0.5 |
| Merge index with readme                 |         |       | 0:42 |   2.1 |
| Add project objective to readme         |         |       | 2:24 |   7.1 |
| Add basic logging support               |         |       | 1:14 |   3.6 |
| Add nightly support with memcheck       |         |       | 3:21 |   9.9 |
| Clean up toolchains and presets         |         |       | 1:53 |   5.5 |
| Valgrind fails to run unit tests        |         |       | 0:53 |   2.6 |
| Add command line options support        |         |       | 0:44 |   2.2 |
| Add XML parsing support for currency    |         |       | 1:24 |   4.1 |
| Create a containing structure for data  |         |       | 0:28 |   1.4 |
| Add basic widgets to display currencies |         |       | 0:26 |   1.3 |
| Convert plantuml diagrams to org-babel  |         |       | 1:05 |   3.2 |
| Copy domain notes on core concepts      |         |       | 3:06 |   9.1 |
#+end:

#+name: piechart
#+begin_src R :results file graphics :file sprint_backlog_01.png :var summary=summary :width 1000 :height 600
