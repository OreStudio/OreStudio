 ...
 */
/**
 * Where the book_purpose_type screens live and what they can do.
 *
 ...
 */
import { bookPurposeTypeMeta } from '../ui/book_purpose_type_ui.js';
import type { EntityDescriptor } from '../../../entity/descriptor.js';

export const bookPurposeTypeDescriptor: EntityDescriptor = {
    component: 'refdata',
    entity: 'book_purpose_type',
    meta: bookPurposeTypeMeta,
    routeSegment: 'book-purpose-type',
    apiBase: '/api/types',
    keyFields: [
        'code',
    ],
