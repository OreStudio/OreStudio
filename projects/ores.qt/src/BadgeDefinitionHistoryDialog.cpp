...
void BadgeDefinitionHistoryDialog::setupConnections() {
    connect(ui_->versionListWidget, &QTableWidget::itemSelectionChanged,
            this, &BadgeDefinitionHistoryDialog::onVersionSelected);
    connect(openVersionAction_, &QAction::triggered,
            this, &BadgeDefinitionHistoryDialog::onOpenVersionClicked);
    connect(revertAction_, &QAction::triggered,
            this, &BadgeDefinitionHistoryDialog::onRevertClicked);
...
void BadgeDefinitionHistoryDialog::loadHistory() {
    ...
    auto task = [self, code = code_.toStdString()]() -> HistoryResult {
        ...
        comms::messaging::frame request_frame(
            comms::messaging::message_type::get_badge_definition_history_request,
            0, std::move(payload)
        );
        ...
        auto response = dq::messaging::get_badge_definition_history_response::
