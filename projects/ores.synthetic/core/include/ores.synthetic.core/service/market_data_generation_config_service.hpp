...
public:
     ...
     */
    /**@{*/
    messaging::list_market_data_generation_configs_response list_market_data_generation_configs(
        const messaging::list_market_data_generation_configs_request& request);
    messaging::get_market_data_generation_config_response get_market_data_generation_config(
    ...
    get_many_market_data_generation_configs(
        const messaging::get_many_market_data_generation_configs_request& request);
    messaging::put_market_data_generation_config_response put_market_data_generation_config(
    ...
    put_many_market_data_generation_configs(
        const messaging::put_many_market_data_generation_configs_request& request);
    messaging::delete_market_data_generation_config_response delete_market_data_generation_config(
    ...
    delete_many_market_data_generation_configs(
    ...
    list_market_data_generation_config_versions(
    ...
    get_market_data_generation_config_version(
    ...
    get_market_data_generation_config_at_version(const boost::uuids::uuid& id,
     ...
     */
    std::optional<domain::market_data_generation_config>
    get_market_data_generation_config(const boost::uuids::uuid& id);

    /**
     * @brief Retrieves a batch of market data generation configs by primary key.
     */
    std::vector<domain::market_data_generation_config>
    get_market_data_generation_configs(const std::vector<std::string>& ids);
     ...
     * @throws std::exception on failure.
     */
    void delete_market_data_generation_config(const boost::uuids::uuid& id);
...
private:
    ...
    prepare_change(const messaging::market_data_generation_config_change& change,
