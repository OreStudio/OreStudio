...
#+CAPTION: Clock summary at [2024-07-03 Wed 23:50]
| <75>                                    |         |       |      |       |
| Headline                                | Time    |       |      |     % |
|-----------------------------------------+---------+-------+------+-------|
...
| Stories                                 | 32:39   |       |      | 100.0 |
| Active                                  |         | 32:39 |      | 100.0 |
| Sprint and product backlog refinement   |         |       | 1:05 |   3.3 |
| Create a basic git hub repository       |         |       | 0:35 |   1.8 |
| Setup a discord channel for the project |         |       | 0:14 |   0.7 |
| Setup vcpkg and cmake                   |         |       | 1:21 |   4.1 |
| Setup github actions                    |         |       | 1:21 |   4.1 |
| Create and upload a package             |         |       | 3:28 |  10.6 |
| Create a basic project structure        |         |       | 2:10 |   6.6 |
| Add a Qt hello world                    |         |       | 3:08 |   9.6 |
| Add a splash screen to applciation      |         |       | 0:41 |   2.1 |
| Add basic site                          |         |       | 0:34 |   1.7 |
| Add modeling infrastructure             |         |       | 1:30 |   4.6 |
| Fix code syntax highlighting in site    |         |       | 0:10 |   0.5 |
| Merge index with readme                 |         |       | 0:42 |   2.1 |
| Add project objective to readme         |         |       | 2:17 |   7.0 |
| Add basic logging support               |         |       | 1:14 |   3.8 |
| Add nightly support with memcheck       |         |       | 3:21 |  10.3 |
| Clean up toolchains and presets         |         |       | 1:53 |   5.8 |
| Add command line options support        |         |       | 0:44 |   2.2 |
| Add XML parsing support for currency    |         |       | 1:24 |   4.3 |
| Create a containing structure for data  |         |       | 0:28 |   1.4 |
| Add basic widgets to display currencies |         |       | 0:26 |   1.3 |
| Convert plantuml diagrams to org-babel  |         |       | 1:05 |   3.3 |
| Copy domain notes on core concepts      |         |       | 2:31 |   7.7 |
| Valgrind fails to run unit tests        |         |       | 0:17 |   0.9 |
#+end:
...
We still get the error with DWARF2 v4. Try v3.
