...
register_payment_frequency_event_mapping(ev::service::postgres_event_source& event_source,
    ...
    event_source.register_entity_event_mapping<refdata::messaging::payment_frequency_event>(
        "ores_refdata_payment_frequencies");

    return event_bus.subscribe<refdata::messaging::payment_frequency_event>(
        [&nats](const refdata::messaging::payment_frequency_event& e) {
            ...
            ev::service::publish_entity_event(
                nats,
                ev::domain::event_subject<refdata::messaging::payment_frequency_event>(e.action),
                e);
        });
}
