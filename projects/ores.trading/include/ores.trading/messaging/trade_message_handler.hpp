 ...
 *
 */
#ifndef ORES_TRADING_MESSAGING_TRADE_MESSAGE_HANDLER_HPP
#define ORES_TRADING_MESSAGING_TRADE_MESSAGE_HANDLER_HPP
...
private:
    [[nodiscard]] static auto& lg() {
        ...
        static auto instance = make_logger(
            "ores.trading.messaging.trade_message_handler");
        return instance;
    }
