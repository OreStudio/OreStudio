...
public:
    ...
    /**
     * @brief Reads a single synthetic FX spot config as it stood at a specific
    ...
    /**
     * @brief Deletes a synthetic FX spot config by closing its temporal validity.
     */
    void remove(context ctx, const std::string& id);

    /**
     * @brief Deletes synthetic FX spot configs by closing their temporal validity.
     */
