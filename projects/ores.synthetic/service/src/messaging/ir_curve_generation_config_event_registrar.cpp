...
register_ir_curve_generation_config_event_mapping(ev::service::postgres_event_source& event_source,
    ...
    event_source
        .register_entity_event_mapping<synthetic::messaging::ir_curve_generation_config_event>(
            "ores_synthetic_ir_curve_generation_configs");

    return event_bus.subscribe<synthetic::messaging::ir_curve_generation_config_event>(
        [&nats](const synthetic::messaging::ir_curve_generation_config_event& e) {
            ...
            ev::service::publish_entity_event(
                nats,
                ev::domain::event_subject<synthetic::messaging::ir_curve_generation_config_event>(
                    e.action),
                e);
        });
}
