...
using ores::shell::app::commands::session_operations_commands;
...
TEST_CASE("session_operations_registers_every_declared_command", tags) {
...
TEST_CASE("session_operations_process_list_sessions_requires_a_session", tags) {
    auto lg(make_logger(test_suite));
    ...
    session_operations_commands::process_list_sessions(out, session, tokens(1));
...
TEST_CASE("session_operations_process_list_sessions_reports_the_expected_count", tags) {
    auto lg(make_logger(test_suite));
    ...
    command_feedback::reset();
    session_operations_commands::process_list_sessions(out, session, {});
...
TEST_CASE("session_operations_process_list_sessions_reaches_the_transport", tags) {
    auto lg(make_logger(test_suite));
...
TEST_CASE("session_operations_process_get_active_sessions_requires_a_session", tags) {
    auto lg(make_logger(test_suite));
    ...
    command_feedback::reset();
    session_operations_commands::process_get_active_sessions(out, session, tokens(0));
...
TEST_CASE("session_operations_process_get_active_sessions_reaches_the_transport", tags) {
    auto lg(make_logger(test_suite));
