...
#+CAPTION: Clock summary at [2025-10-23 Thu 17:59], for Thursday, October 23, 2025.
|       | <75>                                               |        |      |      |       |
| Tags  | Headline                                           | Time   |      |      |     % |
|-------+----------------------------------------------------+--------+------+------+-------|
|       | *Total time*                                       | *3:17* |      |      | 100.0 |
|-------+----------------------------------------------------+--------+------+------+-------|
|       | Stories                                            | 3:17   |      |      | 100.0 |
|       | Active                                             |        | 3:17 |      | 100.0 |
| agile | Sprint and product backlog refinement              |        |      | 0:35 |  17.8 |
| code  | Investigate leaks from valgrind                    |        |      | 0:46 |  23.4 |
| code  | Add locking up logic                               |        |      | 1:28 |  44.7 |
| code  | Ensure user is logged in for certain message types |        |      | 0:25 |  12.7 |
| code  | Enable qt gui                                      |        |      | 0:03 |   1.5 |
#+end:

#+begin: clocktable :maxlevel 3 :scope subtree :tags t :indent nil :emphasize nil :scope file :narrow 75 :formula %
#+TBLNAME: sprint_summary
#+CAPTION: Clock summary at [2025-10-23 Thu 17:59]
|       | <75>                                               |        |      |      |       |
| Tags  | Headline                                           | Time   |      |      |     % |
|-------+----------------------------------------------------+--------+------+------+-------|
...
|       | Stories                                            | 4:30   |      |      | 100.0 |
|       | Active                                             |        | 4:30 |      | 100.0 |
| agile | Sprint and product backlog refinement              |        |      | 0:35 |  13.0 |
| code  | Investigate leaks from valgrind                    |        |      | 0:46 |  17.0 |
| code  | Add locking up logic                               |        |      | 1:28 |  32.6 |
| code  | Ensure user is logged in for certain message types |        |      | 0:25 |   9.3 |
| code  | Enable qt gui                                      |        |      | 0:03 |   1.1 |
| code  | Add workspace as a container                       |        |      | 1:13 |  27.0 |
#+end:
...
*** STARTED Ensure user is logged in for certain message types         :code:
    :LOGBOOK:
