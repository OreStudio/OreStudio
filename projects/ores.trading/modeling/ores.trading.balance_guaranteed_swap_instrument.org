...
#+description: Codegen entity model for the trading =balance_guaranteed_swap_instrument= table. Drives the C++ domain class, mapper, repository, service, generator, TypeScript UI metadata, and SQL schema generation from a single literate source.
...
| "lockout_days" is null or "lockout_days" >= 0 |
...
** Repository
:PROPERTIES:
:entity_singular_short: balance_guaranteed_swap_instrument
:entity_plural_short:   balance_guaranteed_swap_instruments
