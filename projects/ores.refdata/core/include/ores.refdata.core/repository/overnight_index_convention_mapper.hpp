 ...
 *
 */
#ifndef ORES_REFDATA_CORE_REPOSITORY_OVERNIGHT_INDEX_CONVENTION_MAPPER_HPP
#define ORES_REFDATA_CORE_REPOSITORY_OVERNIGHT_INDEX_CONVENTION_MAPPER_HPP
 ...
 */
class ORES_REFDATA_CORE_EXPORT overnight_index_convention_mapper {
private:
