...
| [[id:F0FC905B-6A70-486F-A23F-0064B6A3EE75][Commission: country]] | STARTED | 2026-06-06 | | Verify Qt + shell + CLI (existing); manual; Wt/HTTP captures. |
...
| Story | State | Start | End | Description |
|-------+-------+-------+-----+-------------|
| [[id:E9CC8354-318C-4B08-B307-25910F536F2E][Hotfix: shell bundles gcc build]] | STARTED | 2026-06-06 | | linux-gcc-debug-ninja red: bundles_commands.cpp builds std::string from std::vector<std::byte> iterators; use ores::nats::as_string_view. |
