:PROPERTIES:
:ID: EB5E6878-28F3-4D63-BD92-2FD67595D388
:END:
#+title: ores.sql.service.db_grants
#+description: Grants each service role its DML surface: per-service =dml_prefixes=/=select_prefixes=/=execute_prefixes= list the table/function-name prefixes the service may touch. Output =projects/ores.sql/create/iam/iam_service_db_grants_create.sql=.
#+type: archetype
#+output: projects/ores.sql/create/iam/iam_service_db_grants_create.sql
...
{{/select_prefixes}}
{{#execute_prefixes}}
select _ores_grant_execute_fn('{{prefix}}', :'{{psql_var}}_user');
{{/execute_prefixes}}
