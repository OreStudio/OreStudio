...
#+CAPTION: Clock summary at [2026-01-25 Sun 02:10], for Sunday, January 25, 2026.
|       | <75>                                         |        |      |      |       |
| Tags  | Headline                                     | Time   |      |      |     % |
|-------+----------------------------------------------+--------+------+------+-------|
|       | *Total time*                                 | *1:44* |      |      | 100.0 |
|-------+----------------------------------------------+--------+------+------+-------|
|       | Stories                                      | 1:44   |      |      | 100.0 |
|       | Active                                       |        | 1:44 |      | 100.0 |
| agile | Sprint and product backlog refinement        |        |      | 0:13 |  12.5 |
| code  | Add mapping artefact to population functions |        |      | 0:30 |  28.8 |
| code  | Add FPML export and import                   |        |      | 0:19 |  18.3 |
| code  | Add a ORE component for import/export        |        |      | 0:24 |  23.1 |
| code  | Base the compute approach on BOINC           |        |      | 0:18 |  17.3 |
#+end:

#+begin: clocktable :maxlevel 3 :scope subtree :tags t :indent nil :emphasize nil :scope file :narrow 75 :formula %
#+TBLNAME: sprint_summary
#+CAPTION: Clock summary at [2026-01-25 Sun 02:10]
|       | <75>                                                |         |       |      |       |
| Tags  | Headline                                            | Time    |       |      |     % |
|-------+-----------------------------------------------------+---------+-------+------+-------|
|       | *Total time*                                        | *42:46* |       |      | 100.0 |
|-------+-----------------------------------------------------+---------+-------+------+-------|
|       | Stories                                             | 42:46   |       |      | 100.0 |
|       | Active                                              |         | 42:46 |      | 100.0 |
| agile | Sprint and product backlog refinement               |         |       | 1:17 |   3.0 |
| infra | OCR scan notebooks for this sprint                  |         |       | 6:20 |  14.8 |
| code  | Create a simple code generator                      |         |       | 7:38 |  17.8 |
| code  | Party related schemes                               |         |       | 5:20 |  12.5 |
| code  | Image cache not reloading on new datasets           |         |       | 1:43 |   4.0 |
| code  | Create a script to download and split GLEIF data    |         |       | 0:25 |   1.0 |
| code  | Incremental image cache loading with modified_since |         |       | 0:31 |   1.2 |
| code  | Fix issues with misspell action                     |         |       | 2:47 |   6.5 |
| code  | Tidy-up external data storage                       |         |       | 3:33 |   8.3 |
| code  | Coding schemes are in production tables             |         |       | 1:39 |   3.9 |
| code  | Refactor SQL directories                            |         |       | 3:24 |   8.0 |
| code  | Code-generate ER diagram                            |         |       | 3:01 |   7.1 |
| code  | Add "words" to icons                                |         |       | 0:28 |   1.1 |
| code  | Add code generation support for domain types SQL    |         |       | 1:20 |   3.1 |
| code  | Add mapping artefact to population functions        |         |       | 2:19 |   5.4 |
| code  | Add FPML export and import                          |         |       | 0:19 |   0.7 |
| code  | Add a ORE component for import/export               |         |       | 0:24 |   0.9 |
| code  | Base the compute approach on BOINC                  |         |       | 0:18 |   0.7 |
#+end:
...
*** STARTED Add mapping artefact to population functions               :code:
    :LOGBOOK:
...
*** STARTED Add a ORE component for import/export                      :code:
    :LOGBOOK:
    CLOCK: [2026-01-25 Sun 00:51]--[2026-01-25 Sun 01:15] =>  0:24
    :END:
