...
|------+-------+-------+-----+-------------|
| [[id:D8DD4E78-0B21-4286-A82C-9FE65E79097B][Bind ores.workflow entities to profiles; verify zero-diff regen]] | ABANDONED | | 2026-09-23 | Implement profile binding for the workflow-cpp catalogue entry, rebind every matching entity, regenerate, and confirm byte-identical output, following the compass-codegen-fix-drift skill. Known starting point: no model changes; only stateful-to-stateless repository migration via regeneration. |
