...
#+CAPTION: Clock summary at [2025-10-28 Tue 15:39], for Tuesday, October 28, 2025.
|      | <75>                                                   |        |      |      |       |
| Tags | Headline                                               | Time   |      |      |     % |
|------+--------------------------------------------------------+--------+------+------+-------|
...
|      | Stories                                                | 1:29   |      |      | 100.0 |
|      | Active                                                 |        | 1:29 |      | 100.0 |
| code | Implement logging according to correct boost.log usage |        |      | 0:45 |  50.6 |
| code | Fix broken Linux and OSX tests                         |        |      | 0:10 |  11.2 |
| code | Investigate leaks from valgrind                        |        |      | 0:05 |   5.6 |
| code | Fix broken windows builds                              |        |      | 0:29 |  32.6 |
#+end:

#+begin: clocktable :maxlevel 3 :scope subtree :tags t :indent nil :emphasize nil :scope file :narrow 75 :formula %
#+TBLNAME: sprint_summary
#+CAPTION: Clock summary at [2025-10-28 Tue 15:39]
|       | <75>                                                   |         |       |      |       |
| Tags  | Headline                                               | Time    |       |      |     % |
|-------+--------------------------------------------------------+---------+-------+------+-------|
...
|       | Stories                                                | 35:52   |       |      | 100.0 |
|       | Active                                                 |         | 35:52 |      | 100.0 |
| agile | Sprint and product backlog refinement                  |         |       | 1:11 |   3.3 |
| code  | Add locking up logic                                   |         |       | 1:28 |   4.1 |
| code  | Build using dynamic libraries                          |         |       | 7:24 |  20.6 |
| code  | Enable qt gui                                          |         |       | 4:13 |  11.8 |
| code  | Add locking up logic                                   |         |       | 1:28 |   4.1 |
| code  | Build using dynamic libraries                          |         |       | 7:24 |  20.6 |
| code  | Implement logging according to correct boost.log usage |         |       | 8:02 |  22.4 |
| code  | Fix broken Linux and OSX tests                         |         |       | 0:10 |   0.5 |
| code  | Investigate leaks from valgrind                        |         |       | 0:51 |   2.4 |
| code  | Add support for feature flags                          |         |       | 1:25 |   3.9 |
| code  | Implement authentication bootstrap workflow            |         |       | 0:25 |   1.2 |
| code  | Fix broken windows builds                              |         |       | 0:38 |   1.8 |
| code  | Add workspace as a container                           |         |       | 1:13 |   3.4 |
#+end:
