 ...
 */
#ifndef ORES_MARKETDATA_CORE_MESSAGING_SERIES_CLASSIFICATION_RULE_HANDLER_HPP
#define ORES_MARKETDATA_CORE_MESSAGING_SERIES_CLASSIFICATION_RULE_HANDLER_HPP
...
namespace {
inline auto& series_classification_rule_handler_lg() {
...
/**
 * @brief NATS message handler for series classification rule operations.
 */
class series_classification_rule_handler {
public:
    series_classification_rule_handler(
