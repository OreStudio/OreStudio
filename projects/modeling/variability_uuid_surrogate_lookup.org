...
#+description: UUID surrogate key, tenant-scoped, standard presentation tier, no relationships -- the UUID-keyed counterpart to Simple lookup.
#+type: profile
#+level: cross
...
exposing. Same tenant scope and presentation tier as [[id:1D0B00E4-6032-4DCA-9B66-571DE9F131FC][Simple lookup]] -- change-reason
...
full standard presentation tier (change-reason cache, pagination), no
