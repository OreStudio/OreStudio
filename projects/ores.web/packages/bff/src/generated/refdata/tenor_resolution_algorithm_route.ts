 ...
 */
/**
 * How the BFF reaches the tenor_resolution_algorithm service.
 *
 ...
 */
import { subjects } from '@ores/wire-protocol/generated/refdata/protocol/tenor_resolution_algorithm_protocol';
...
export const tenorResolutionAlgorithmRoute: EntityRouteDescriptor = {
  ...
  subjects: {
    ...
    save: subjects.put_tenor_resolution_algorithm_request,
    remove: subjects.delete_tenor_resolution_algorithm_request,
