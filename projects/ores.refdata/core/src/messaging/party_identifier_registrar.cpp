...
register_party_identifier_handlers(ores::nats::service::client& nats,
    ...
    subs.push_back(nats.queue_subscribe(get_party_identifiers_request::nats_subject,
                                        queue_group,
                                        [h](ores::nats::message msg) { h->list(std::move(msg)); }));
    subs.push_back(nats.queue_subscribe(save_party_identifier_request::nats_subject,
                                        queue_group,
    ...
    subs.push_back(
        nats.queue_subscribe(get_party_identifier_history_request::nats_subject,
                             queue_group,
