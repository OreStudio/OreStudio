...
register_purpose_type_handlers(ores::nats::service::client& nats,
    ...
    subs.push_back(nats.queue_subscribe(get_purpose_types_request::nats_subject,
                                        queue_group,
                                        [h](ores::nats::message msg) { h->list(std::move(msg)); }));
    subs.push_back(nats.queue_subscribe(save_purpose_type_request::nats_subject,
                                        queue_group,
    ...
    subs.push_back(nats.queue_subscribe(
        get_purpose_type_history_request::nats_subject, queue_group, [h](ores::nats::message msg) {
