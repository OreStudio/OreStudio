 ...
 *
 */
#ifndef ORES_QT_GMM_COMPONENT_DETAIL_DIALOG_HPP
#define ORES_QT_GMM_COMPONENT_DETAIL_DIALOG_HPP
...
public:
    explicit GmmComponentDetailDialog(QWidget* parent = nullptr);
    ~GmmComponentDetailDialog() override;
