 ...
 *
 */
#ifndef ORES_QT_TENOR_MDI_WINDOW_HPP
#define ORES_QT_TENOR_MDI_WINDOW_HPP
 ...
 *
 * Provides a table view of tenors with toolbar actions
 * for reload, add, edit, delete, and viewing history.
 */
class TenorMdiWindow final : public EntityListMdiWindow {
    Q_OBJECT

private:
    inline static std::string_view logger_name = "ores.qt.tenor_mdi_window";
...
signals:
    ...
    void showTenorDetails(const marketdata::domain::tenor& tenor);
    void addNewRequested();
    void tenorDeleted(const QString& code);
    void showTenorHistory(const marketdata::domain::tenor& tenor);
