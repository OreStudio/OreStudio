 ...
 */
#ifndef ORES_SHELL_APP_COMMANDS_PARTY_CONTACT_INFORMATION_COMMANDS_HPP
#define ORES_SHELL_APP_COMMANDS_PARTY_CONTACT_INFORMATION_COMMANDS_HPP
...
/**
 * @brief Every verb party contact informations answer, as one command each.
 *
 ...
 */
class party_contact_information_commands {
private:
    inline static std::string_view logger_name =
        "ores.shell.app.commands.refdata.party_contact_information_commands";
...
public:
    /**
     * @brief Register the party contact informations submenu.
     */
    ...
    /**
     * @brief add <id> <contact_type> <street_line_1> <street_line_2> <city> <state> <country_code>
