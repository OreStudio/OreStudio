 ...
 *
 */
#ifndef ORES_QT_FX_ACCUMULATOR_INSTRUMENT_FORM_HPP
#define ORES_QT_FX_ACCUMULATOR_INSTRUMENT_FORM_HPP
...
/**
 * @brief IInstrumentForm for FX Accumulator trades.
 *
 * Handles: FxAccumulator.
 */
class FxAccumulatorInstrumentForm final : public IInstrumentForm {
    Q_OBJECT

private:
    inline static std::string_view logger_name = "ores.qt.fx_accumulator_instrument_form";
...
public:
    explicit FxAccumulatorInstrumentForm(QWidget* parent = nullptr);
    ~FxAccumulatorInstrumentForm() override;
...
private:
    ...
    Ui::FxAccumulatorInstrumentForm* ui_;
    ClientManager* clientManager_ = nullptr;
    ImageCache* imageCache_ = nullptr;
    std::string username_;
    trading::domain::fx_accumulator_instrument instrument_;
    bool dirty_ = false;
    bool loaded_ = false;
};
