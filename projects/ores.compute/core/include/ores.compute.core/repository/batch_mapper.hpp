 ...
 *
 */
#ifndef ORES_COMPUTE_CORE_REPOSITORY_BATCH_MAPPER_HPP
#define ORES_COMPUTE_CORE_REPOSITORY_BATCH_MAPPER_HPP
 ...
 */
class ORES_COMPUTE_CORE_EXPORT batch_mapper {
private:
    inline static std::string_view logger_name = "ores.compute.repository.batch_mapper";
