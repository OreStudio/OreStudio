 ...
 *
 */
#ifndef ORES_SYNTHETIC_CORE_MESSAGING_FOLDER_HANDLER_HPP
#define ORES_SYNTHETIC_CORE_MESSAGING_FOLDER_HANDLER_HPP
...
namespace {
inline auto& folder_handler_lg() {
    static auto instance = ores::logging::make_logger("ores.synthetic.messaging.folder_handler");
    return instance;
}
} // namespace
...
/**
 * @brief NATS message handler for folder operations.
 */
class folder_handler {
public:
    folder_handler(ores::nats::service::client& nats,
