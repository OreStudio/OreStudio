...
| [[id:45AB05B7-45D4-4F94-8011-8F293B9C676B][Run sandboxed synthetic configs end-to-end under a distinct namespace]] | BACKLOG | | | Wire ores.synthetic.service to generate and publish data for sandboxed configs under a namespace distinct from bound feeds, and prove the bound-feed resolution path used by real consumers never picks up sandboxed output. No consumer-side selection UI in this task. |
