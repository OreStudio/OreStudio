...
#+CAPTION: Clock summary at [2024-07-14 Sun 10:14]
|       | <75>                                              |         |       |      |       |
| Tags  | Headline                                          | Time    |       |      |     % |
|-------+---------------------------------------------------+---------+-------+------+-------|
|       | *Total time*                                      | *69:24* |       |      | 100.0 |
|-------+---------------------------------------------------+---------+-------+------+-------|
|       | Stories                                           | 69:24   |       |      | 100.0 |
|       | Active                                            |         | 69:24 |      | 100.0 |
...
| code  | Add a Qt hello world                              |         |       | 3:08 |   4.5 |
...
| code  | Add XML parsing support for currency              |         |       | 6:32 |   9.4 |
...
| code  | Updates to Qt UI                                  |         |       | 5:06 |   7.3 |
#+end:
