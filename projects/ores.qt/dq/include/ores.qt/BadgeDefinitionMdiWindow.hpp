 ...
 *
 */
#ifndef ORES_QT_BADGE_DEFINITION_MDI_WINDOW_HPP
#define ORES_QT_BADGE_DEFINITION_MDI_WINDOW_HPP
 ...
 *
 * Provides a table view of badge definitions with toolbar actions
 * for reload, add, edit, delete, and viewing history.
 */
class BadgeDefinitionMdiWindow final : public EntityListMdiWindow {
    Q_OBJECT

private:
    inline static std::string_view logger_name = "ores.qt.badge_definition_mdi_window";
...
public:
    explicit BadgeDefinitionMdiWindow(ClientManager* clientManager,
...
signals:
    ...
    void showDefinitionDetails(const dq::domain::badge_definition& definition);
...
private:
    ...
    ClientBadgeDefinitionModel* model_;
