...
public:
     ...
     */
    /**@{*/
    messaging::list_ois_conventions_response
    list_ois_conventions(const messaging::list_ois_conventions_request& request);
    messaging::get_ois_convention_response
    get_ois_convention(const messaging::get_ois_convention_request& request);
    messaging::get_many_ois_conventions_response
    get_many_ois_conventions(const messaging::get_many_ois_conventions_request& request);
    messaging::put_ois_convention_response
    put_ois_convention(const messaging::put_ois_convention_request& request);
    messaging::put_many_ois_conventions_response
    put_many_ois_conventions(const messaging::put_many_ois_conventions_request& request);
    messaging::delete_ois_convention_response
    delete_ois_convention(const messaging::delete_ois_convention_request& request);
    messaging::delete_many_ois_conventions_response
    delete_many_ois_conventions(const messaging::delete_many_ois_conventions_request& request);
    messaging::list_ois_convention_versions_response
    list_ois_convention_versions(const messaging::list_ois_convention_versions_request& request);
    messaging::get_ois_convention_version_response
    get_ois_convention_version(const messaging::get_ois_convention_version_request& request);
    /**@}*/
    ...
    /**
     * @brief Retrieves a batch of OIS conventions by primary key.
     */
    std::vector<domain::ois_convention> get_ois_conventions(const std::vector<std::string>& ids);
...
private:
     ...
     */
    ores::utility::domain::result prepare_change(const messaging::ois_convention_change& change,
