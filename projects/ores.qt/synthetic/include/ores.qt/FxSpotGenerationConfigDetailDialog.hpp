 ...
 *
 */
#ifndef ORES_QT_FX_SPOT_GENERATION_CONFIG_DETAIL_DIALOG_HPP
#define ORES_QT_FX_SPOT_GENERATION_CONFIG_DETAIL_DIALOG_HPP
...
private:
    inline static std::string_view logger_name = "ores.qt.fx_spot_generation_config_detail_dialog";
...
public:
    explicit FxSpotGenerationConfigDetailDialog(QWidget* parent = nullptr);
    ~FxSpotGenerationConfigDetailDialog() override;
