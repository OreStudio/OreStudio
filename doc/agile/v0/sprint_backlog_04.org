...
#+CAPTION: Clock summary at [2025-11-12 Wed 10:53], for Wednesday, November 12, 2025.
|      | <75>                                      |        |      |      |       |
| Tags | Headline                                  | Time   |      |      |     % |
|------+-------------------------------------------+--------+------+------+-------|
...
|      | Stories                                   | 1:53   |      |      | 100.0 |
|      | Active                                    |        | 1:53 |      | 100.0 |
| code | Fix the valgrind leaks reported on sqlgen |        |      | 1:53 | 100.0 |
#+end:

#+begin: clocktable :maxlevel 3 :scope subtree :tags t :indent nil :emphasize nil :scope file :narrow 75 :formula %
#+TBLNAME: sprint_summary
#+CAPTION: Clock summary at [2025-11-12 Wed 10:53]
|          | <75>                                                   |         |       |       |       |
| Tags     | Headline                                               | Time    |       |       |     % |
|----------+--------------------------------------------------------+---------+-------+-------+-------|
|          | *Total time*                                           | *52:58* |       |       | 100.0 |
|----------+--------------------------------------------------------+---------+-------+-------+-------|
|          | Stories                                                | 52:58   |       |       | 100.0 |
|          | Active                                                 |         | 52:58 |       | 100.0 |
| agile    | Sprint and product backlog refinement                  |         |       |  2:33 |   4.8 |
| code     | Clean up client parser                                 |         |       |  0:10 |   0.3 |
| code     | Add connect command line argument                      |         |       |  1:19 |   2.5 |
| infra    | Install Windows package on Windows machine             |         |       |  2:09 |   4.1 |
| code     | Ignore warnings on windows and osx                     |         |       |  0:33 |   1.0 |
| code     | Ensure applications work under OSX using github images |         |       |  0:14 |   0.4 |
| infra    | Create a splash screen and gray background             |         |       |  2:26 |   4.6 |
| code     | Use fluent icons                                       |         |       |  0:37 |   1.2 |
| code     | Add export functionality for currencies                |         |       |  1:30 |   2.8 |
| code     | Add currency editing support                           |         |       |  2:45 |   5.2 |
| code     | Add about to menu                                      |         |       |  1:02 |   2.0 |
| code     | Create a history dialog for currencies                 |         |       |  1:27 |   2.7 |
| code     | Allow MDI windows outside main window                  |         |       |  1:35 |   3.0 |
| code     | Add edit menu and export menu                          |         |       |  0:34 |   1.1 |
| code     | Implement adding new currencies                        |         |       |  3:17 |   6.2 |
| code     | Clean up product website                               |         |       |  4:42 |   8.9 |
| code     | Create a skill for plant uml documentation             |         |       |  2:48 |   5.3 |
| infra    | Add CMake targets for site and skills                  |         |       |  0:17 |   0.5 |
| infra    | Generalise the skill setup for ORE Studio              |         |       |  3:45 |   7.1 |
| infra    | Restructure components to follow the dogen approach    |         |       |  2:54 |   5.5 |
| infra    | Generate PlantUML diagrams for all components          |         |       |  1:05 |   2.0 |
| code     | Fix the valgrind leaks reported on sqlgen              |         |       |  1:53 |   3.6 |
| code     | Make UI/UX look more professional                      |         |       | 11:07 |  21.0 |
