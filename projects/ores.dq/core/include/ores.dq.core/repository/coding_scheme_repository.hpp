 ...
 *
 */
#ifndef ORES_DQ_CORE_REPOSITORY_CODING_SCHEME_REPOSITORY_HPP
#define ORES_DQ_CORE_REPOSITORY_CODING_SCHEME_REPOSITORY_HPP
 ...
 */
class ORES_DQ_CORE_EXPORT coding_scheme_repository {
private:
    inline static std::string_view logger_name = "ores.dq.repository.coding_scheme_repository";
...
public:
    ...
    std::vector<domain::coding_scheme> read_latest(std::uint32_t offset, std::uint32_t limit);
