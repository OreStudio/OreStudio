...
#+CAPTION: Clock summary at [2026-01-23 Fri 00:21], for Friday, January 23, 2026.
|      | <75>                                      |        |      |      |       |
| Tags | Headline                                  | Time   |      |      |     % |
|------+-------------------------------------------+--------+------+------+-------|
...
|      | Stories                                   | 0:20   |      |      | 100.0 |
|      | Active                                    |        | 0:20 |      | 100.0 |
| code | Image cache not reloading on new datasets |        |      | 0:20 | 100.0 |
#+end:

#+begin: clocktable :maxlevel 3 :scope subtree :tags t :indent nil :emphasize nil :scope file :narrow 75 :formula %
#+TBLNAME: sprint_summary
#+CAPTION: Clock summary at [2026-01-23 Fri 00:21]
|       | <75>                                             |         |       |      |       |
| Tags  | Headline                                         | Time    |       |      |     % |
|-------+--------------------------------------------------+---------+-------+------+-------|
...
|       | Stories                                          | 22:05   |       |      | 100.0 |
|       | Active                                           |         | 22:05 |      | 100.0 |
| agile | Sprint and product backlog refinement            |         |       | 1:04 |   4.8 |
| infra | OCR scan notebooks for this sprint               |         |       | 5:00 |  22.6 |
| code  | Create a simple code generator                   |         |       | 7:38 |  34.6 |
| code  | Party related schemes                            |         |       | 5:20 |  24.2 |
| code  | Image cache not reloading on new datasets        |         |       | 1:43 |   7.8 |
| code  | Add code generation support for domain types SQL |         |       | 1:20 |   6.0 |
#+end:
...
*** Incremental image cache loading with modified_since                :code:
