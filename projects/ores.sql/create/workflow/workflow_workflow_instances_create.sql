...
create unique index if not exists workflow_instances_version_uniq_idx
on "ores_workflow_workflow_instances_tbl" (tenant_id, id, version)
where valid_to = ores_utility_infinity_timestamp_fn();

create unique index if not exists workflow_instances_id_uniq_idx
on "ores_workflow_workflow_instances_tbl" (tenant_id, id)
where valid_to = ores_utility_infinity_timestamp_fn();
...
begin
    ...
    from "ores_workflow_workflow_instances_tbl"
    ...
    if found then
        ...
        update "ores_workflow_workflow_instances_tbl"
...
create or replace trigger ores_workflow_workflow_instances_insert_trg
before insert on "ores_workflow_workflow_instances_tbl"
for each row execute function ores_workflow_workflow_instances_insert_fn();

create or replace rule ores_workflow_workflow_instances_delete_rule as
on delete to "ores_workflow_workflow_instances_tbl" do instead (
    update "ores_workflow_workflow_instances_tbl"
    set valid_to = clock_timestamp()
