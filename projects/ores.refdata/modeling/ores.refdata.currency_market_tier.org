...
#+description: Codegen entity model for the refdata =currency_market_tier= table. Drives the C++ domain class, mapper, repository, service, generator, TypeScript UI metadata, and SQL schema generation from a single literate source.
...
|--------------+---------------+-------------+-----------+-------+----------+-----------------------|
| Code         | code          | Code        | string    | 150   | true     | currency_market_tier |
