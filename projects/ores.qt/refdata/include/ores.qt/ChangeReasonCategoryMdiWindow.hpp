...
/**
 * @brief MDI window for displaying and managing change reason categories.
 *
...
private:
    inline static std::string_view logger_name = "ores.qt.change_reason_category_mdi_window";
...
public:
    explicit ChangeReasonCategoryMdiWindow(ClientManager* clientManager,
...
private:
    ...
    ClientChangeReasonCategoryModel* model_;
