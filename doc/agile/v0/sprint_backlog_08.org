...
#+CAPTION: Clock summary at [2026-01-11 Sun 13:10], for Sunday, January 11, 2026.
|      | <75>                    |        |      |      |       |
| Tags | Headline                | Time   |      |      |     % |
|------+-------------------------+--------+------+------+-------|
...
|      | Stories                 | 6:07   |      |      | 100.0 |
|      | Active                  |        | 6:07 |      | 100.0 |
| code | Change reasons UI fixes |        |      | 0:57 |  15.5 |
| code | Add UI for log viewing  |        |      | 1:35 |  25.9 |
| code | Add key entity skills   |        |      | 3:35 |  58.6 |
#+end:

#+begin: clocktable :maxlevel 3 :scope subtree :tags t :indent nil :emphasize nil :scope file :narrow 75 :formula %
#+TBLNAME: sprint_summary
#+CAPTION: Clock summary at [2026-01-11 Sun 13:11]
|       | <75>                                         |         |       |       |       |
| Tags  | Headline                                     | Time    |       |       |     % |
|-------+----------------------------------------------+---------+-------+-------+-------|
|       | *Total time*                                 | *72:15* |       |       | 100.0 |
|-------+----------------------------------------------+---------+-------+-------+-------|
|       | Stories                                      | 72:15   |       |       | 100.0 |
|       | Active                                       |         | 72:15 |       | 100.0 |
| agile | Sprint and product backlog refinement        |         |       |  1:50 |   2.5 |
| code  | Rerun SQL scripts from scratch               |         |       |  7:52 |  10.9 |
| code  | Run qt client and validate all new features  |         |       |  1:19 |   1.8 |
| code  | Refactor options and parser                  |         |       |  0:27 |   0.6 |
| code  | Check functionality in =ores.wt=             |         |       |  2:03 |   2.8 |
| code  | Rename =ores.shell= to =ores.comms.shell=    |         |       |  1:30 |   2.1 |
| code  | Review HTTP service                          |         |       |  7:24 |  10.2 |
| code  | Assorted fixes to currency dialog            |         |       |  4:19 |   6.0 |
| code  | Add support for offsets in pagination        |         |       |  1:46 |   2.4 |
| code  | Assorted fixes to feature flags dialog       |         |       |  2:52 |   4.0 |
| code  | Add country support                          |         |       |  6:31 |   9.0 |
| code  | Amend and delete reasons base infrastructure |         |       |  5:58 |   8.3 |
| code  | Change reasons UI fixes                      |         |       |  3:34 |   4.9 |
| code  | Assorted fixes to currencies dialog          |         |       |  7:52 |  10.9 |
| code  | Add UI for log viewing                       |         |       |  1:35 |   2.2 |
| code  | Add key entity skills                        |         |       |  3:35 |   5.0 |
| code  | Assorted fixes to accounts dialog            |         |       |  1:10 |   1.6 |
| code  | Review comms analyser work                   |         |       |  0:27 |   0.6 |
| code  | Review telemetry work                        |         |       | 10:11 |  14.1 |
#+end:
