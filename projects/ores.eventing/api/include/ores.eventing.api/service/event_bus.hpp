 ...
 *
 */
#ifndef ORES_EVENTING_API_SERVICE_EVENT_BUS_HPP
#define ORES_EVENTING_API_SERVICE_EVENT_BUS_HPP
 ...
 */
class ORES_EVENTING_API_EXPORT subscription final {
public:
 ...
 * @endcode
 */
class ORES_EVENTING_API_EXPORT event_bus final {
private:
