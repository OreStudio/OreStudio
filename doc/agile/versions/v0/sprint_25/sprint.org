...
| [[id:3085B911-3030-4AB8-976F-0F037D4332E7][Show the current agile work item inside DSH]] | BACKLOG | | | A DSH plugin that reports the sprint, story, and task this work tree is working on, shows them inside the live DSH session, and lets the user interact with that state. |
