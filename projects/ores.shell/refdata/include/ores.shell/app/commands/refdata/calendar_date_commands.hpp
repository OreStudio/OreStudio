 ...
 */
#ifndef ORES_SHELL_APP_COMMANDS_CALENDAR_DATE_COMMANDS_HPP
#define ORES_SHELL_APP_COMMANDS_CALENDAR_DATE_COMMANDS_HPP
...
/**
 * @brief Every verb dates answer, as one command each.
 *
 ...
 */
class calendar_date_commands {
private:
    inline static std::string_view logger_name =
        "ores.shell.app.commands.refdata.calendar_date_commands";
...
public:
    /**
     * @brief Register the dates submenu.
     */
    ...
    /**
     * @brief get-many <calendar_code> <date>
     */
