...
#+CAPTION: Clock summary at [2026-01-24 Sat 01:19], for Saturday, January 24, 2026.
|      | <75>                          |        |      |      |       |
| Tags | Headline                      | Time   |      |      |     % |
|------+-------------------------------+--------+------+------+-------|
...
|      | Stories                       | 0:52   |      |      | 100.0 |
|      | Active                        |        | 0:52 |      | 100.0 |
| code | Tidy-up external data storage |        |      | 0:52 | 100.0 |
#+end:

#+begin: clocktable :maxlevel 3 :scope subtree :tags t :indent nil :emphasize nil :scope file :narrow 75 :formula %
#+TBLNAME: sprint_summary
#+CAPTION: Clock summary at [2026-01-24 Sat 01:19]
|       | <75>                                                |         |       |      |       |
| Tags  | Headline                                            | Time    |       |      |     % |
|-------+-----------------------------------------------------+---------+-------+------+-------|
...
| infra | OCR scan notebooks for this sprint                  |         |       | 6:20 |  20.8 |
| code  | Create a simple code generator                      |         |       | 7:38 |  25.0 |
| code  | Party related schemes                               |         |       | 5:20 |  17.5 |
...
| code  | Tidy-up external data storage                       |         |       | 3:21 |  11.0 |
| code  | Add code generation support for domain types SQL    |         |       | 1:20 |   4.4 |
#+end:
