 ...
 */
export const tenantStatusMessages = {
        tenant_status: {
            title: 'Tenant Statuses',
            singular: 'tenant status',
            newTitle: 'New tenant status',
            description: 'Reference data table defining valid tenant lifecycle statuses. Examples: \'active\', \'suspended\', \'terminated\'. Tenant statuses are managed by the system tenant and control tenant access and capabilities.',
            fldStatus: 'Status',
            statusPh: 'Enter status code',
            fldName: 'Name',
