...
| Waiting on    | Nothing.                               |
| Next          | Generalize hierarchy into a codegen facet (task 4) -- task 3 (binding) depends on the NATS hierarchy message this produces. |
