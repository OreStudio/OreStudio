 ...
 *
 */
#ifndef ORES_TRADING_API_MESSAGING_KNOCK_OUT_SWAP_INSTRUMENT_PROTOCOL_HPP
#define ORES_TRADING_API_MESSAGING_KNOCK_OUT_SWAP_INSTRUMENT_PROTOCOL_HPP
...
struct get_knock_out_swap_instruments_response {
    std::vector<ores::trading::domain::knock_out_swap_instrument> knock_out_swap_instruments;
...
struct save_knock_out_swap_instrument_request {
    ...
    static save_knock_out_swap_instrument_request
    from(ores::trading::domain::knock_out_swap_instrument v) {
