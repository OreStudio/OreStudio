...
public:
    ...
    /**
     * @brief Get pricing model configuration at the specified row.
     *
...
private:
    ...
    struct FetchResult {
        bool success;
        std::vector<analytics::domain::pricing_model_config> configs;
    ...
    std::vector<analytics::domain::pricing_model_config> configs_;
