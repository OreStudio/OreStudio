 ...
 */
#ifndef ORES_SHELL_APP_COMMANDS_TENANT_STATUS_COMMANDS_HPP
#define ORES_SHELL_APP_COMMANDS_TENANT_STATUS_COMMANDS_HPP
...
/**
 * @brief Every verb tenant statuses answer, as one command each.
 *
 ...
 */
class tenant_status_commands {
private:
    inline static std::string_view logger_name =
        "ores.shell.app.commands.iam.tenant_status_commands";
...
public:
    /**
     * @brief Register the tenant statuses submenu.
     */
    ...
    /**
     * @brief add <status> <name> <description> <display_order> <reason> <commentary>
     */
    ...
    /**
     * @brief set <status> <name> <description> <display_order> <reason> <commentary> [--version
     * <n>]
     */
    ...
    /**
     * @brief put-many --count <n> <status> <name> <description> <display_order> <reason>
     * <commentary>
     */
    ...
    /**
     * @brief delete <status> <reason> <commentary> [--version <n>]
     */
    ...
    /**
     * @brief delete-many <status> <reason> <commentary>
     */
    ...
    /**
     * @brief versions <status> [--offset <n>] [--limit <n>] [--order <field>] [--desc]
     */
    ...
    /**
     * @brief version <status> --version <n>
     */
