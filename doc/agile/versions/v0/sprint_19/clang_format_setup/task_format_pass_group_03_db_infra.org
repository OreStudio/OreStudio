:PROPERTIES:
:ID: 2F7B9CE1-4FFA-4F2F-A37A-1B912373FCA4
:END:
#+title: Task: Format pass: connections, database, workspace, variability
#+description: Apply clang-format to ores.connections, ores.database, ores.workspace, ores.variability (163 files).
#+type: task
#+level: s1
