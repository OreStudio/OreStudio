 ...
 *
 */
#ifndef ORES_MARKETDATA_SERVICE_APP_APPLICATION_HPP
#define ORES_MARKETDATA_SERVICE_APP_APPLICATION_HPP
...
/**
 * @brief Entry point for the ores.marketdata.service service.
 */
class application final {
private:
    inline static std::string_view logger_name = "ores.marketdata.service.app.application";
