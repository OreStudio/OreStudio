 ...
 *
 */
#ifndef ORES_REFDATA_CORE_PRESENTATION_TENOR_ANCHOR_HISTORY_FIELD_MAPPER_HPP
#define ORES_REFDATA_CORE_PRESENTATION_TENOR_ANCHOR_HISTORY_FIELD_MAPPER_HPP
