 ...
 *
 */
#ifndef ORES_DQ_REPOSITORY_BADGE_SEVERITY_REPOSITORY_HPP
#define ORES_DQ_REPOSITORY_BADGE_SEVERITY_REPOSITORY_HPP
 ...
 */
class badge_severity_repository {
private:
    inline static std::string_view logger_name =
        "ores.dq.repository.badge_severity_repository";
