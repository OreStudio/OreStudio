 ...
 *
 */
#ifndef ORES_TRADING_CORE_REPOSITORY_FX_VANILLA_OPTION_INSTRUMENT_MAPPER_HPP
#define ORES_TRADING_CORE_REPOSITORY_FX_VANILLA_OPTION_INSTRUMENT_MAPPER_HPP
 ...
 */
class ORES_TRADING_CORE_EXPORT fx_vanilla_option_instrument_mapper {
private:
