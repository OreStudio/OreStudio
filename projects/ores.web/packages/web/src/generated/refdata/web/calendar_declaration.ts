 ...
 */
/**
 * Where the calendar screens live and what they can do.
 *
 ...
 */
import { calendarMeta } from '../ui/calendar_ui.js';
import type { EntityDescriptor } from '../../../entity/descriptor.js';

export const calendarDescriptor: EntityDescriptor = {
    component: 'refdata',
    entity: 'calendar',
    meta: calendarMeta,
    routeSegment: 'calendar',
    apiBase: '/api/calendars',
    keyParam: 'id',
    icon: 'calendarClock',
    capabilities: {
        create: true,
