 ...
 *
 */
#ifndef ORES_WT_SERVICE_CONFIG_OPTIONS_HPP
#define ORES_WT_SERVICE_CONFIG_OPTIONS_HPP
...
/**
 * @brief All configuration options required by ores.wt.service web application.
 */
