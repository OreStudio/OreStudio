...
| [[id:F1827F31-5E88-4058-994B-546A5CC10B9A][ores.cpp.nats-event-registrar.nats_event_registrar_implementation]] | Per-entity event-mapping registrar implementation wiring the entity's changed-event to the Postgres LISTEN/NOTIFY channel and re-publishing it to NATS. nats-event-registrar profile. |
