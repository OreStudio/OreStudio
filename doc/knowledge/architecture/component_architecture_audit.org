...
and not every consumer reads it there, so compare against the
namespace the reader uses rather than the one the catalogue declares.
...
method, handler and service. [[id:689F92F1-39F4-4956-B6CC-F105A3C1B2E9][Fix the has_parent_id feature
