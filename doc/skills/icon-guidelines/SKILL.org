...
Duplicate an item, create a copy with the same content.
...
*Usage*: "Duplicate" toolbar buttons and context menu actions that create a
...
| Copy/Duplicate       | copy_20                          | Default | Active |
