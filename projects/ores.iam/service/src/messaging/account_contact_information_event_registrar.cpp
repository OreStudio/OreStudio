...
register_account_contact_information_event_mapping(ev::service::postgres_event_source& event_source,
                                                   ev::service::event_bus& event_bus,
                                                   ores::nats::service::client& nats) {
    ev::service::registrar::register_mapping<
        iam::eventing::account_contact_information_changed_event>(
        event_source,
        "ores.iam.account_contact_information",
        "ores_iam_account_contact_informations");

    return event_bus.subscribe<iam::eventing::account_contact_information_changed_event>(
        [&nats](const iam::eventing::account_contact_information_changed_event& e) {
            ev::service::publish_entity_event(
                nats,
                std::string(ev::domain::event_traits<
                            iam::eventing::account_contact_information_changed_event>::name),
