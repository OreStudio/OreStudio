...
namespace {
inline auto& instrument_option_payment_date_handler_lg() {
    static auto instance =
        ores::logging::make_logger("ores.trading.messaging.instrument_option_payment_date_handler");
    return instance;
}
} // namespace
...
/**
 * @brief NATS message handler for instrument option payment date operations.
 */
class instrument_option_payment_date_handler {
public:
    instrument_option_payment_date_handler(
