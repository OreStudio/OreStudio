...
:END:
#+title: Data Quality
#+description: The DQ-6 dimensions, related industry bodies, and the provenance fields every reference-data entity carries — the conceptual foundation for the ores.dq.* subsystem.
#+type: knowledge
#+version: 2
#+level: cross
#+filetags: :knowledge:domain:dq:data_quality:
#+created: 2024-06-15
#+updated: 2026-05-21

Data Quality (DQ) is the measure of how well a dataset satisfies the
requirements of its intended business use. In financial markets,
high-quality data is defined as being accurate, complete, timely, and
traceable, ensuring that automated trading decisions and risk
calculations are based on a "single version of the truth" rather than
corrupted or ambiguous artefacts. The patterns described here back
[[id:D3A9F7C2-8B14-4E5D-A6C9-1F7E2B0D8C4A][ores.dq.core]] (domain logic) and its service / API siblings
([[id:FA64A6DE-7010-4FD8-A1F8-D153B3CD96A9][ores.dq.service]], [[id:FFCFC860-204D-4F48-AE34-D3E382D7A02B][ores.dq.api]]). Return to [[id:7474935C-95D1-3034-B833-83DCD9FB3A09][Knowledge]].
