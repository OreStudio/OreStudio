...
- =party='s SQL is explicitly flagged hand-maintained (BLOCKED
  ...
  reverted that commit. The revert took the =:flag_icon_column:=
  property with it and the described Qt-only re-run didn't actually
  happen until PR review caught it (see Review #1) -- reapplied in
  f7773b2f9.
