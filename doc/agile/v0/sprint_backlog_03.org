...
#+CAPTION: Clock summary at [2025-10-26 Sun 19:21], for Sunday, October 26, 2025.
|      | <75>                          |        |      |      |       |
| Tags | Headline                      | Time   |      |      |     % |
|------+-------------------------------+--------+------+------+-------|
...
|      | Stories                       | 1:37   |      |      | 100.0 |
|      | Active                        |        | 1:37 |      | 100.0 |
| code | Build using dynamic libraries |        |      | 1:37 | 100.0 |
#+end:

#+begin: clocktable :maxlevel 3 :scope subtree :tags t :indent nil :emphasize nil :scope file :narrow 75 :formula %
#+TBLNAME: sprint_summary
#+CAPTION: Clock summary at [2025-10-26 Sun 19:21]
|       | <75>                                        |         |       |      |       |
| Tags  | Headline                                    | Time    |       |      |     % |
|-------+---------------------------------------------+---------+-------+------+-------|
...
|       | Stories                                     | 15:06   |       |      | 100.0 |
|       | Active                                      |         | 15:06 |      | 100.0 |
| agile | Sprint and product backlog refinement       |         |       | 0:35 |   3.9 |
| code  | Investigate leaks from valgrind             |         |       | 0:46 |   5.1 |
| code  | Add locking up logic                        |         |       | 1:28 |   9.7 |
| code  | Add support for feature flags               |         |       | 1:25 |   9.4 |
| code  | Implement authentication bootstrap workflow |         |       | 0:25 |   2.8 |
| code  | Build using dynamic libraries               |         |       | 5:04 |  33.6 |
| code  | Enable qt gui                               |         |       | 4:10 |  27.6 |
| code  | Add workspace as a container                |         |       | 1:13 |   8.1 |
#+end:
