...
| Now           | PoC verified hands-on and approved — deploying to production.      |
| Waiting on    | Nothing.                                                           |
| Next          | Merge the PR; site CI deploys the board to GitHub Pages.           |
...
- /Single data artefact/ :: The agile app reads =graphdata.json= — the
  ...
  intermediary.
- /No build step/ :: Preact + htm over ESM CDN; hand-rolled org parser
  tailored to our codegen-regular docs (uniorg/orga would pull a bundler
  into the repo; org-mode-parser is abandoned).
