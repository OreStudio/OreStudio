...
inline constexpr std::array<std::string_view, 30> gb_surnames = {
    {"Rutherford", "Whitfield",  "Crawford", "Henderson", "Ashworth",  "Pemberton",
     "Thornton",   "Hargreaves", "Kingsley", "Montague",  "Blackwell", "Cavendish",
     "Fitzroy",    "Drummond",   "Baring",   "Coutts",    "Hambro",    "Schroeder",
     "Warburg",    "Rothschild", "Fleming",  "Guinness",  "Lloyds",    "Jardine",
     "Matheson",   "Laidlaw",    "Gresham",  "Dunbar",    "Sinclair",  "Mackenzie"}};

inline constexpr std::array<std::string_view, 30> us_surnames = {
    {"Hamilton",   "Jefferson", "Morgan",  "Rockefeller", "Carnegie", "Vanderbilt",
     "Astor",      "Whitney",   "Mellon",  "Harriman",    "Goldman",  "Lehman",
     "Merrill",    "Salomon",   "Warburg", "Loeb",        "Kuhn",     "Schiff",
     "Stillman",   "Baker",     "Aldrich", "Peabody",     "Perkins",  "Sears",
     "Wainwright", "Prescott",  "Thayer",  "Cabot",       "Forbes",   "Fidelity"}};
...
inline constexpr std::array<std::string_view, 20> us_street_names = {
    {"Wall Street",    "Broadway",     "Park Avenue",    "Madison Avenue",  "Lexington Avenue",
     "Fifth Avenue",   "Sixth Avenue", "Water Street",   "Broad Street",    "Pine Street",
     "Liberty Street", "Maiden Lane",  "Exchange Place", "Fulton Street",   "William Street",
     "Nassau Street",  "State Street", "Federal Street", "Congress Street", "Franklin Street"}};

/**
 * @brief BIC code prefixes for deterministic BIC generation.
 */
inline constexpr std::array<std::string_view, 10> bic_prefixes = {
    {"RUTH", "WHIT", "CRAW", "HEND", "ASHW", "PEMB", "THOR", "HARG", "KING", "MONT"}};
 ...
 */
inline constexpr std::array<std::string_view, 8> gb_party_suffixes = {{"Bank Plc",
                                                                       "Capital Ltd",
                                                                       "Securities Ltd",
 ...
 */
inline constexpr std::array<std::string_view, 8> us_party_suffixes = {{"Financial Inc",
                                                                       "Capital LLC",
                                                                       "Securities Corp",
