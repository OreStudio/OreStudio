 ...
 *
 */
#ifndef ORES_DQ_API_EVENTING_DATA_DOMAIN_CHANGED_EVENT_HPP
#define ORES_DQ_API_EVENTING_DATA_DOMAIN_CHANGED_EVENT_HPP
 ...
 *
 * Published when any data domain entity is created, updated, or
...
struct data_domain_changed_event final {
    ...
    /**
     * @brief Changed data domain codes.
     */
