 ...
 */
#ifndef ORES_SHELL_APP_COMMANDS_TENOR_CONVENTION_COMMANDS_HPP
#define ORES_SHELL_APP_COMMANDS_TENOR_CONVENTION_COMMANDS_HPP
...
/**
 * @brief Every verb tenor conventions answer, as one command each.
 *
 ...
 */
class tenor_convention_commands {
private:
    inline static std::string_view logger_name =
        "ores.shell.app.commands.refdata.tenor_convention_commands";
...
public:
    /**
     * @brief Register the tenor conventions submenu.
     */
