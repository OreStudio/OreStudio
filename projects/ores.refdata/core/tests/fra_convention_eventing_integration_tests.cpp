...
#include "ores.refdata.api/eventing/fra_convention_event.hpp"
...
TEST_CASE("write_fra_convention_publishes_an_event", tags) {
    ...
    using event_type = ores::refdata::messaging::fra_convention_event;
    ...
    event_source.register_entity_event_mapping<event_type>("ores_refdata_fra_conventions");
