...
|----------------------+------+-------------------+-----------------------------------|
| BookStatuses         | Tag  | Statuses          | Open Book Statuses list          |
| RegulatoryBookTypes  | Tag  | Regulatory Types  | Open Regulatory Book Types list   |
| BookPurposeTypes     | Tag  | Purpose Types     | Open Book Purpose Types list      |
| LedgerFeedTypes      | Tag  | Ledger Feed Types | Open Ledger Feed Types list       |
