...
| Target dialog | =CatalogDetailDialog= / =DataDomainDetailDialog= / =ChangeReasonDetailDialog= / =ChangeReasonCategoryDetailDialog= / =ArtefactTypeDetailDialog= / =DatasetBundleDetailDialog= / =LeiEntityMdiWindow= / =LeiRelationshipMdiWindow= — all reached via the Data Quality menu |
| Clients       | blue, red                                                  |
| State         | PENDING                                                    |
...
- Navigate: Data Quality > Governance > Catalogs.
...
|--------+-------|
| Status | FAIL |
| Notes  | create works but we don't seem to have any eventing. |
...
|--------+-------|
| Status | FAIL |
| Notes  | seems to create a new entry instead of adding a new version. see Visual Assets.; ; ; ; ; [[file:scenario_verify_dq_entity_commissioning_step4_20260806_115155.png]] |
...
|--------+-------|
| Status | FAIL |
| Notes  | "Failed to load history:; No history provider registered for entity_type: ores.dq.catalog" |

*** Create and save a data domain

- Navigate: Data Quality > Governance > Data Domains.
...
- Navigate: Data Quality > Governance > Change Reason Categories.
...
- Navigate: Data Quality > Governance > Change Reasons.
...
- Navigate: Data Quality > Governance > Artefact Types.
...
- Navigate: Data Quality > Dataset Bundles.
...
- Open every submenu under Data Quality (Badges, Classifications
  entry under Reference Data, Governance, LEI Registry, and any
  top-level items) and search for "Report Definition".
...
- Reopen any data domain record saved earlier in this scenario (Data
  Quality > Governance > Data Domains) and change its Description to
  a new, distinctive value, then Save.
...
|---------------+-------|
| Status        | FAILED |
| Completed at  | 2026-08-06T10:52:27Z |
