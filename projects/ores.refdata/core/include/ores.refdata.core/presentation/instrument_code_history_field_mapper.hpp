 ...
 *
 */
#ifndef ORES_REFDATA_CORE_PRESENTATION_INSTRUMENT_CODE_HISTORY_FIELD_MAPPER_HPP
#define ORES_REFDATA_CORE_PRESENTATION_INSTRUMENT_CODE_HISTORY_FIELD_MAPPER_HPP
...
/**
 * @brief Renders a instrument_code to an ordered field list for
