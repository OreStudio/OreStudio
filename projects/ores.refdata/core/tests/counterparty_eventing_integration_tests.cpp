...
#include "ores.refdata.api/eventing/counterparty_event.hpp"
...
TEST_CASE("write_counterparty_publishes_an_event", tags) {
    ...
    using event_type = ores::refdata::messaging::counterparty_event;
    ...
    event_source.register_entity_event_mapping<event_type>("ores_refdata_counterparties");
