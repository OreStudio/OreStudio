 ...
 */
#ifndef ORES_SHELL_APP_COMMANDS_ACCOUNT_TYPE_COMMANDS_HPP
#define ORES_SHELL_APP_COMMANDS_ACCOUNT_TYPE_COMMANDS_HPP
...
/**
 * @brief Every verb account types answer, as one command each.
 *
 ...
 */
class account_type_commands {
private:
    inline static std::string_view logger_name =
        "ores.shell.app.commands.iam.account_type_commands";
...
public:
    /**
     * @brief Register the account types submenu.
     */
