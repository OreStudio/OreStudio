 ...
 *
 */
#include "ores.refdata.core/presentation/counterparty_contact_information_history_field_mapper.hpp"
...
render_counterparty_contact_information_fields(const domain::counterparty_contact_information& v) {
    ...
    fields.push_back({.name = "Contact Type", .value = v.contact_type});
