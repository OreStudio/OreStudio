...
domain::instrument_option_premium
instrument_option_premium_mapper::map(const instrument_option_premium_entity& v) {
...
instrument_option_premium_entity
instrument_option_premium_mapper::map(const domain::instrument_option_premium& v) {
...
instrument_option_premium_mapper::map(const std::vector<instrument_option_premium_entity>& v) {
    return map_vector<instrument_option_premium_entity, domain::instrument_option_premium>(
        v, [](const auto& ve) { return map(ve); }, lg(), "db entities");
}

std::vector<instrument_option_premium_entity>
instrument_option_premium_mapper::map(const std::vector<domain::instrument_option_premium>& v) {
    return map_vector<domain::instrument_option_premium, instrument_option_premium_entity>(
