...
create unique index if not exists cap_floor_instruments_version_uniq_idx
...
create index if not exists cap_floor_instruments_workspace_idx
on "ores_trading_cap_floor_instruments_tbl" (workspace_id)
where valid_to = ores_utility_infinity_timestamp_fn();
