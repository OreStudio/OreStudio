 ...
 *   SELECT * FROM metadata.dq_business_process_preview_fn(dataset_id);
 *
 *   -- Publish to production
 *   SELECT * FROM metadata.dq_business_processes_publish_fn(dataset_id, 'upsert');
 */
 ...
 */
create or replace function metadata.dq_business_process_preview_fn(p_dataset_id uuid)
returns table (
    action text,
    code text,
 ...
 */
create or replace function metadata.dq_business_processes_publish_fn(
    p_dataset_id uuid,
