...
| [[id:468387DD-0D6F-49B4-9F82-BD179DCB1CC1][ores.compass Locate — temporal orientation]] | BACKLOG | | | =where=/=status=: report current version, sprint, and in-flight stories and tasks from the graph. |
