 ...
 */
class ORES_QT_MARKETDATA_EXPORT CrmEnabledDerivedPairController final : public EntityController {
    Q_OBJECT
...
private slots:
    void onShowDetails(const marketdata::domain::crm_enabled_derived_pair& pair);
    void onAddNewRequested();
    void onShowHistory(const marketdata::domain::crm_enabled_derived_pair& pair);
    void onRevertVersion(const marketdata::domain::crm_enabled_derived_pair& pair);
    void onOpenVersion(const marketdata::domain::crm_enabled_derived_pair& pair, int versionNumber);

private:
    void showAddWindow();
    void showDetailWindow(const marketdata::domain::crm_enabled_derived_pair& pair);
    void showHistoryWindow(const marketdata::domain::crm_enabled_derived_pair& pair);
