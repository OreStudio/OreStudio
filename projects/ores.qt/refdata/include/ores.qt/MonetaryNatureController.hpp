 ...
 */
#ifndef ORES_QT_MONETARY_NATURE_CONTROLLER_HPP
#define ORES_QT_MONETARY_NATURE_CONTROLLER_HPP
...
private:
    inline static std::string_view logger_name = "ores.qt.monetary_nature_controller";
...
public:
    MonetaryNatureController(QMainWindow* mainWindow,
                             QMdiArea* mdiArea,
...
private:
     ...
     * MonetaryNatureDetailDialog needs regardless of which
     * window opened it (add/edit/history-version/revert) -- kept in one
     * place so those four call sites can't drift from each other.
     */
    void wireDetailDialogCommon(MonetaryNatureDetailDialog* detailDialog);
