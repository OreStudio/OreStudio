...
class ClientTreatmentDimensionModel final : public AbstractClientModel {
    Q_OBJECT

private:
    inline static std::string_view logger_name = "ores.qt.client_treatment_dimension_model";
...
public:
    ...
    explicit ClientTreatmentDimensionModel(ClientManager* clientManager, QObject* parent = nullptr);
