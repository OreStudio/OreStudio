...
std::string payment_frequency_type_repository::sql() {
...
payment_frequency_type_repository::read_latest(context ctx) {
...
std::vector<domain::payment_frequency_type>
payment_frequency_type_repository::read_latest(context ctx, const std::string& code) {
...
std::vector<domain::payment_frequency_type>
payment_frequency_type_repository::read_all(context ctx, const std::string& code) {
