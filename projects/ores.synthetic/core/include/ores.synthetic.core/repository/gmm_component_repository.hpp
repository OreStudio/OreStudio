...
public:
    ...
    /**
     * @brief Writes a GMM component, honouring the claim it states.
     *
    ...
    /**
     * @brief Writes a set of GMM components, each honouring its own
    ...
    /**
     * @brief Reads latest GMM components, possibly filtered by primary key.
     */
    /**@{*/
    ...
    /**
     * @brief Reads a single GMM component as it stood at a specific
    ...
    /**
     * @brief Removes a GMM component, refusing a row that moved on.
     *
...
private:
     ...
     */
    ores::utility::domain::precondition replace_claim(context ctx, const domain::gmm_component& v);
     ...
     */
    domain::gmm_component apply_claim(context ctx,
                                      const domain::gmm_component& v,
                                      const ores::utility::domain::precondition& claim);
};
