 ...
 *
 */
#ifndef ORES_TRADE_REPOSITORY_PARTY_ROLE_TYPE_MAPPER_HPP
#define ORES_TRADE_REPOSITORY_PARTY_ROLE_TYPE_MAPPER_HPP

#include "ores.trade/domain/party_role_type.hpp"
#include "ores.trade/repository/party_role_type_entity.hpp"
...
private:
    inline static std::string_view logger_name =
        "ores.trade.repository.party_role_type_mapper";
