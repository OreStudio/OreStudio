...
TEST_CASE("write_curve_role_publishes_an_event", tags) {
    ...
    using event_type = ores::refdata::messaging::curve_role_event;
    ...
    event_source.register_entity_event_mapping<event_type>("ores_refdata_curve_roles");
