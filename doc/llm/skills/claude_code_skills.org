...
| Name | Title | Description |
|------+-------+-------------|
| [[id:D3767A34-DC32-4366-ADAB-534D6FC4C607][doc-add]] | Doc Add | Create a document of any type — story, task, capture, knowledge, recipe, memory and the rest. Scaffold it,... |
...
| [[id:0F8DE59C-9CD1-463A-9148-0B452A985C23][doc-show]] | Doc Show | Show the current state of anything — a document, the sprint, the fleet, the journal, services, CI checks, a... |
...
| [[id:809AAE41-950C-4E0C-85B7-0D50BC4A775F][codegen-add-surface-entity]] | Codegen Add Surface Entity | Add an entity to a user-facing surface — the CLI, the HTTP API, the shell REPL, or the Wt web UI. One three... |
