...
#include "ores.refdata.api/eventing/floating_index_type_event.hpp"
...
TEST_CASE("write_floating_index_type_publishes_an_event", tags) {
    ...
    using event_type = ores::refdata::messaging::floating_index_type_event;
    ...
    event_source.register_entity_event_mapping<event_type>("ores_refdata_floating_index_types");
