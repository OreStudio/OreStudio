...
register_business_unit_handlers(ores::nats::service::client& nats,
    ...
    subs.push_back(nats.queue_subscribe(get_business_units_request::nats_subject,
                                        queue_group,
                                        [h](ores::nats::message msg) { h->list(std::move(msg)); }));
    subs.push_back(nats.queue_subscribe(save_business_unit_request::nats_subject,
                                        queue_group,
