...
The profile does not yet deliver the whole shape. An audit =recorded_at= member
survives every feature it sets, and it cannot reach =:no_audit_columns:= at all.
Until both are closed, a model bound to it generates a struct with a timestamp
the record has no use for. See
[[id:E4174872-13EA-4ECD-AD46-1E52C176701F][Give a table-less record a way to suppress the audit envelope]].
