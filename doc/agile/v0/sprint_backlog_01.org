...
#+CAPTION: Clock summary at [2024-06-23 Sun 09:49]
| <75>                                    |         |       |      |       |
| Headline                                | Time    |       |      |     % |
|-----------------------------------------+---------+-------+------+-------|
...
| Stories                                 | 11:45   |       |      | 100.0 |
| Active                                  |         | 11:45 |      | 100.0 |
| Sprint and product backlog refinement   |         |       | 0:14 |   2.0 |
| Create a basic git hub repository       |         |       | 0:35 |   5.0 |
| Setup a discord channel for the project |         |       | 0:14 |   2.0 |
| Setup vcpkg and cmake                   |         |       | 1:21 |  11.5 |
| Setup github actions                    |         |       | 1:21 |  11.5 |
| Create and upload a package             |         |       | 3:28 |  29.5 |
| Create a basic project structure        |         |       | 2:10 |  18.4 |
| Add a Qt hello world                    |         |       | 2:18 |  19.6 |
| Add nightly support with memcheck       |         |       | 0:04 |   0.6 |
#+end:
