...
#+CAPTION: Clock summary at [2026-01-08 Thu 20:51], for Thursday, January 08, 2026.
|       | <75>                                   |        |      |      |       |
| Tags  | Headline                               | Time   |      |      |     % |
|-------+----------------------------------------+--------+------+------+-------|
|       | *Total time*                           | *8:26* |      |      | 100.0 |
|-------+----------------------------------------+--------+------+------+-------|
|       | Stories                                | 8:26   |      |      | 100.0 |
|       | Active                                 |        | 8:26 |      | 100.0 |
| agile | Sprint and product backlog refinement  |        |      | 0:33 |   6.5 |
| code  | Assorted fixes to feature flags dialog |        |      | 2:52 |  34.0 |
| code  | Assorted fixes to currencies dialog    |        |      | 2:07 |  25.1 |
| code  | Add country support                    |        |      | 2:54 |  34.4 |
#+end:

#+begin: clocktable :maxlevel 3 :scope subtree :tags t :indent nil :emphasize nil :scope file :narrow 75 :formula %
#+TBLNAME: sprint_summary
#+CAPTION: Clock summary at [2026-01-08 Thu 20:51]
|       | <75>                                        |         |       |       |       |
| Tags  | Headline                                    | Time    |       |       |     % |
|-------+---------------------------------------------+---------+-------+-------+-------|
|       | *Total time*                                | *51:07* |       |       | 100.0 |
|-------+---------------------------------------------+---------+-------+-------+-------|
|       | Stories                                     | 51:07   |       |       | 100.0 |
|       | Active                                      |         | 51:07 |       | 100.0 |
| agile | Sprint and product backlog refinement       |         |       |  1:50 |   3.6 |
| code  | Rerun SQL scripts from scratch              |         |       |  7:52 |  15.4 |
| code  | Run qt client and validate all new features |         |       |  1:19 |   2.6 |
| code  | Refactor options and parser                 |         |       |  0:27 |   0.9 |
| code  | Check functionality in =ores.wt=            |         |       |  2:03 |   4.0 |
| code  | Rename =ores.shell= to =ores.comms.shell=   |         |       |  1:30 |   2.9 |
| code  | Review HTTP service                         |         |       |  7:24 |  14.5 |
| code  | Assorted fixes to currency dialog           |         |       |  4:19 |   8.4 |
| code  | Add support for offsets in pagination       |         |       |  1:46 |   3.5 |
| code  | Assorted fixes to feature flags dialog      |         |       |  2:52 |   5.6 |
| code  | Assorted fixes to currencies dialog         |         |       |  4:36 |   9.0 |
| code  | Add country support                         |         |       |  4:31 |   8.8 |
| code  | Review comms analyser work                  |         |       |  0:27 |   0.9 |
| code  | Review telemetry work                       |         |       | 10:11 |  19.9 |
#+end:
