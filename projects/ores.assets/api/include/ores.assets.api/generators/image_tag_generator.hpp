 ...
 */
#ifndef ORES_ASSETS_API_GENERATORS_IMAGE_TAG_GENERATOR_HPP
#define ORES_ASSETS_API_GENERATORS_IMAGE_TAG_GENERATOR_HPP
...
/**
 * @brief Generates a synthetic image_tag.
 */
ORES_ASSETS_API_EXPORT domain::image_tag
generate_synthetic_image_tag(utility::generation::generation_context& ctx);

/**
 * @brief Generates N synthetic image_tags.
 */
ORES_ASSETS_API_EXPORT std::vector<domain::image_tag>
