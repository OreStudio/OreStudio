 ...
 */
#ifndef ORES_SCHEDULER_CORE_MESSAGING_JOB_DEFINITION_HISTORY_PROVIDER_REGISTRAR_HPP
#define ORES_SCHEDULER_CORE_MESSAGING_JOB_DEFINITION_HISTORY_PROVIDER_REGISTRAR_HPP
