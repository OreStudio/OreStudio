 ...
 *
 */
#ifndef ORES_REFDATA_CORE_PRESENTATION_IBOR_INDEX_CONVENTION_HISTORY_FIELD_MAPPER_HPP
#define ORES_REFDATA_CORE_PRESENTATION_IBOR_INDEX_CONVENTION_HISTORY_FIELD_MAPPER_HPP
...
/**
 * @brief Renders a ibor_index_convention to an ordered field list for
