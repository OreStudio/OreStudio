...
/**
 * @brief Dialog for viewing the version history of a country.
 *
 * Shows all historical versions of a country with ability
...
public:
    explicit CountryHistoryDialog(const QString& code,
...
private:
    Ui::CountryHistoryDialog* ui_;
    QString code_;
    ClientManager* clientManager_;
    std::vector<refdata::domain::country> versions_;
};
