 ...
 */
#ifndef ORES_SHELL_APP_COMMANDS_OVERNIGHT_INDEX_CONVENTION_COMMANDS_HPP
#define ORES_SHELL_APP_COMMANDS_OVERNIGHT_INDEX_CONVENTION_COMMANDS_HPP
...
/**
 * @brief Every verb overnight index conventions answer, as one command each.
 *
 ...
 */
class overnight_index_convention_commands {
private:
    inline static std::string_view logger_name =
        "ores.shell.app.commands.refdata.overnight_index_convention_commands";
...
public:
    /**
     * @brief Register the overnight index conventions submenu.
     */
