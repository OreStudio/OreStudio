...
domain::instrument_schedule_date
instrument_schedule_date_mapper::map(const instrument_schedule_date_entity& v) {
    BOOST_LOG_SEV(lg(), trace) << "Mapping db entity: " << v;

    domain::instrument_schedule_date r;
    r.version = v.version;
...
instrument_schedule_date_entity
instrument_schedule_date_mapper::map(const domain::instrument_schedule_date& v) {
...
instrument_schedule_date_mapper::map(const std::vector<instrument_schedule_date_entity>& v) {
    return map_vector<instrument_schedule_date_entity, domain::instrument_schedule_date>(
        v, [](const auto& ve) { return map(ve); }, lg(), "db entities");
}

std::vector<instrument_schedule_date_entity>
instrument_schedule_date_mapper::map(const std::vector<domain::instrument_schedule_date>& v) {
    return map_vector<domain::instrument_schedule_date, instrument_schedule_date_entity>(
