...
void DatasetBundleController::showHistoryWindow(const dq::domain::dataset_bundle& bundle) {
    ...
    auto* historyDialog =
        new DatasetBundleHistoryDialog(bundle.id, code, clientManager_, mainWindow_);

    connect(historyDialog,
            &DatasetBundleHistoryDialog::statusChanged,
            this,
    ...
    connect(historyDialog,
            &DatasetBundleHistoryDialog::errorOccurred,
            this,
            [self = QPointer<DatasetBundleController>(this)](const QString& message) {
                if (!self)
                    return;
    ...
    connect(historyDialog,
            &DatasetBundleHistoryDialog::revertVersionRequested,
            this,
            &DatasetBundleController::onRevertVersion);
    connect(historyDialog,
            &DatasetBundleHistoryDialog::openVersionRequested,
            this,
            &DatasetBundleController::onOpenVersion);
