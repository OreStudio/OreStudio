...
** Qt
:PROPERTIES:
:domain_include:         ores.dq.api/domain/badge_definition.hpp
:domain_class:           dq::domain::badge_definition
:protocol_include:       ores.dq.api/messaging/badge_definition_protocol.hpp
...
| severity_code      | Severity     | severityCodeCombo      | dynamic_combo |        | true        |                         |              | dq::domain::badge_severity | ores.qt/LookupFetcher.hpp        | fetch_badge_severities  | severityCodeWatcher    | code               | description          | display_order      | badge severities   | SeverityCodeCombo     |           |
