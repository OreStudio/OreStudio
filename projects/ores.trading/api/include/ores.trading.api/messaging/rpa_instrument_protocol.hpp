 ...
 *
 */
#ifndef ORES_TRADING_API_MESSAGING_RPA_INSTRUMENT_PROTOCOL_HPP
#define ORES_TRADING_API_MESSAGING_RPA_INSTRUMENT_PROTOCOL_HPP
...
struct get_rpa_instruments_response {
    std::vector<ores::trading::domain::rpa_instrument> rpa_instruments;
...
struct save_rpa_instrument_request {
    ...
    static save_rpa_instrument_request from(ores::trading::domain::rpa_instrument v) {
