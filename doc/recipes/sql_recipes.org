...
* Initial Setup
  ...
  :header-args+: :var project_sql_dir=(concat (or (ignore-errors (project-root (project-current))) "./") "projects/sql")
  :END:
...
After creating a database instance, you can optionally seed data using the
population scripts (see [[*Population Scripts]] section).
...
** Database Management
   :PROPERTIES:
   :header-args+: :database ores_admin
   :END:
...
** Accounts
    :PROPERTIES:
    :header-args+: :database ores_delicate_violet
    :END:
...
CREATE FUNCTION
upsert_role
dd2ecaec-138b-453c-a110-77441a60583e
upsert_role
a74f8a4e-f331-4179-aecb-cda61e472805
upsert_role
d48b608d-c894-4346-887d-228e342d36c6
upsert_role
b898350f-f704-4e97-b8ec-36c3481af052
upsert_role
d533c93f-bf3c-4d1f-bba8-4e949b976a8a
upsert_role
6e4ee358-1970-400f-a3cb-fbcfe8296f52
