 ...
 */
#ifndef ORES_SHELL_APP_COMMANDS_APP_COMMANDS_HPP
#define ORES_SHELL_APP_COMMANDS_APP_COMMANDS_HPP
...
/**
 * @brief Every verb compute apps answer, as one command each.
 *
...
class app_commands {
private:
    inline static std::string_view logger_name = "ores.shell.app.commands.compute.app_commands";
...
public:
    /**
     * @brief Register the compute apps submenu.
     */
    ...
    /**
     * @brief add <id> <name> <description> <reason> <commentary>
     */
