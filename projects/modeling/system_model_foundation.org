...
=variability.v1.= [[id:C9C24C99-F16C-45BE-A262-1C0F4502765E][ores.nats]] namespace. Consumers read flags without
polling the database; the service propagates changes so flag updates are
visible system-wide without a restart.
...
triggers use =SECURITY DEFINER=; cross-service writes go through
[[id:C9C24C99-F16C-45BE-A262-1C0F4502765E][ores.nats]].
