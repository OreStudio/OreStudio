...
create or replace function ores_refdata_cashflow_types_notify_fn()
returns trigger as $$
declare
...
create or replace trigger ores_refdata_cashflow_types_notify_trg
after insert or update or delete on ores_refdata_cashflow_types_tbl
for each row execute function ores_refdata_cashflow_types_notify_fn();
