 ...
 *
 */
#ifndef ORES_REFDATA_CORE_PRESENTATION_IR_CURVE_BOOTSTRAP_CONFIG_HISTORY_FIELD_MAPPER_HPP
#define ORES_REFDATA_CORE_PRESENTATION_IR_CURVE_BOOTSTRAP_CONFIG_HISTORY_FIELD_MAPPER_HPP
...
/**
 * @brief Renders a ir_curve_bootstrap_config to an ordered field list for
