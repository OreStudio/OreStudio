...
| [[id:2EA448B4-FC73-48B0-B8BC-DF47EC0FCE85][Add compass entity pillar: list, add, generate, show, diff]] | BACKLOG | | | High-level entity management commands in compass: list entities, scaffold a new entity, regenerate an entity across all profiles, show per-file staleness, and diff after regeneration. |
