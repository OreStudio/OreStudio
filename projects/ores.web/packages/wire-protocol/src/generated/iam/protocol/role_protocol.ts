...
export const requiresSession = {
    list_roles_request: true,
    get_role_request: true,
    get_many_roles_request: true,
    put_role_request: true,
    put_many_roles_request: true,
    delete_role_request: true,
    delete_many_roles_request: true,
    list_role_versions_request: true,
    get_role_version_request: true,
} as const;
