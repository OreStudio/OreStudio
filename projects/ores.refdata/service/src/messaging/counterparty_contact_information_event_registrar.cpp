...
[[nodiscard]] ev::service::subscription register_counterparty_contact_information_event_mapping(
    ...
    event_source
        .register_entity_event_mapping<refdata::messaging::counterparty_contact_information_event>(
            "ores_refdata_counterparty_contact_informations");

    return event_bus.subscribe<refdata::messaging::counterparty_contact_information_event>(
        [&nats](const refdata::messaging::counterparty_contact_information_event& e) {
            ...
            ev::service::publish_entity_event(
                ...
                ev::domain::event_subject<
                    refdata::messaging::counterparty_contact_information_event>(e.action),
                e);
        });
}
