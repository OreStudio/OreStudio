...
public:
     ...
     */
    std::optional<domain::bond_issue> get_issue_at_version(const std::string& issue_id,
     ...
     */
    std::optional<domain::bond_issue> get_issue(const std::string& issue_id);
     ...
     * @throws std::exception on failure.
     */
    void delete_issue(const std::string& issue_id);
