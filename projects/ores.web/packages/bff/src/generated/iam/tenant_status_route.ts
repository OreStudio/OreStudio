...
export const tenantStatusRoute: EntityRouteDescriptor = {
  ...
  key: 'id',
  keyField: 'status',
  deleteKeysField: 'statuss',
  subjects: {
    list: subjects.get_tenant_statuses_request,
    save: subjects.save_tenant_status_request,
    remove: subjects.delete_tenant_status_request,
    history: subjects.get_tenant_status_history_request,
  },
  rowsField: 'statuses',
