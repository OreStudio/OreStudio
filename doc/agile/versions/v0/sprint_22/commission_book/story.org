...
|------+-------+-------+-----+-------------|
| [[id:9AB461BD-AD46-4980-A801-BE6104270C52][Sync C++ core codegen output for book]] | STARTED | 2026-07-03 | | Regenerate book's api/core/sql from the new graph-based codegen and land a build-consistent core sync. |
