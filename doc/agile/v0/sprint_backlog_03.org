...
#+CAPTION: Clock summary at [2025-11-03 Mon 23:27], for Monday, November 03, 2025.
|      | <75>                                          |        |      |      |       |
| Tags | Headline                                      | Time   |      |      |     % |
|------+-----------------------------------------------+--------+------+------+-------|
...
|      | Stories                                       | 1:34   |      |      | 100.0 |
|      | Active                                        |        | 1:34 |      | 100.0 |
| code | Separate test database usage from application |        |      | 1:34 | 100.0 |
#+end:

#+begin: clocktable :maxlevel 3 :scope subtree :tags t :indent nil :emphasize nil :scope file :narrow 75 :formula %
#+TBLNAME: sprint_summary
#+CAPTION: Clock summary at [2025-11-03 Mon 23:27]
|       | <75>                                                   |         |       |       |       |
| Tags  | Headline                                               | Time    |       |       |     % |
|-------+--------------------------------------------------------+---------+-------+-------+-------|
|       | *Total time*                                           | *60:22* |       |       | 100.0 |
|-------+--------------------------------------------------------+---------+-------+-------+-------|
|       | Stories                                                | 60:22   |       |       | 100.0 |
|       | Active                                                 |         | 60:22 |       | 100.0 |
| agile | Sprint and product backlog refinement                  |         |       |  1:24 |   2.3 |
| code  | Add locking up logic                                   |         |       |  1:28 |   2.4 |
| code  | Build using dynamic libraries                          |         |       |  7:24 |  12.3 |
| code  | Enable qt gui                                          |         |       |  4:13 |   7.0 |
| code  | Add locking up logic                                   |         |       |  1:28 |   2.4 |
| code  | Build using dynamic libraries                          |         |       |  7:24 |  12.3 |
| code  | Implement logging according to correct boost.log usage |         |       |  8:02 |  13.3 |
| code  | Fix broken Linux and OSX tests                         |         |       |  0:10 |   0.3 |
| code  | Fix broken windows builds                              |         |       |  2:35 |   4.3 |
| code  | Investigate leaks from valgrind                        |         |       |  0:51 |   1.4 |
| code  | Consider adding a postgres database to CI              |         |       | 14:13 |  23.6 |
| code  | Fix misspell that causes build to break                |         |       |  0:12 |   0.3 |
| code  | Improve code coverage                                  |         |       |  4:15 |   7.0 |
...
| code  | Separate test database usage from application          |         |       |  3:20 |   5.5 |
...
*** STARTED Separate test database usage from application              :code:
    :LOGBOOK:
    CLOCK: [2025-11-03 Mon 21:52]--[2025-11-03 Mon 23:26] =>  1:34
